...
# Source: https://api.apis.guru/v2/specs/azure.com/sql-ManagedBackupShortTermRetention/2017-03-01-preview/swagger.json
...
export def commands []: nothing -> table {
  ...
  let mod_name = (scope modules | where { $in.commands | any { $in.name == "subscriptions-resource-groups-providers-microsoft-sql-managed-instances-databases-backup-short-term-retention-policies list" } } | get name | first)
...
export def "subscriptions-resource-groups-providers-microsoft-sql-managed-instances-databases-backup-short-term-retention-policies list" [
...
export def "subscriptions-resource-groups-providers-microsoft-sql-managed-instances-databases-backup-short-term-retention-policies get" [
  subscription_id: string
  resource_group_name: string
  managed_instance_name: string
  database_name: string
  ...
  let qp = [(serialize-qp "api-version" $api_version "scalar")] | flatten | str join "&"
  let full_url = (build-url $base ({subscription_id: (encode-path-segment $subscription_id), resource_group_name: (encode-path-segment $resource_group_name), managed_instance_name: (encode-path-segment $managed_instance_name), database_name: (encode-path-segment $database_name), policy_name: (encode-path-segment $policy_name)} | format pattern "/subscriptions/{subscription_id}/resourceGroups/{resource_group_name}/providers/Microsoft.Sql/managedInstances/{managed_instance_name}/databases/{database_name}/backupShortTermRetentionPolicies/{policy_name}") $qp $auth.query)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "get"
...
export def "subscriptions-resource-groups-providers-microsoft-sql-managed-instances-databases-backup-short-term-retention-policies update" [
  subscription_id: string
  resource_group_name: string
  managed_instance_name: string
  database_name: string
...
# --properties shape: {retentionDays?: int}
export def "subscriptions-resource-groups-providers-microsoft-sql-managed-instances-databases-backup-short-term-retention-policies create-or-update" [
  subscription_id: string
  resource_group_name: string
  managed_instance_name: string
  database_name: string
