...
def textFormat-completer [] { ["Html" "Raw"] }
...
export def "search Search" [
  ...
  let qp = [(serialize-qp "answerCount" $answerCount "scalar") (serialize-qp "cc" $cc "scalar") (serialize-qp "count" $count "scalar") (serialize-qp "freshness" $freshness "scalar") (serialize-qp "mkt" $mkt "scalar") (serialize-qp "offset" $offset "scalar") (serialize-qp "promote" $promote "csv") (serialize-qp "q" $q "scalar") (serialize-qp "responseFilter" $responseFilter "csv") (serialize-qp "safeSearch" $safeSearch "scalar") (serialize-qp "setLang" $setLang "scalar") (serialize-qp "textDecorations" $textDecorations "scalar") (serialize-qp "textFormat" $textFormat "scalar")] | flatten | str join "&"
