# Auto-generated client for MLB v3 RotoBaller Articles v1.0
# Source: https://api.apis.guru/v2/specs/sportsdata.io/mlb-v3-rotoballer-articles/1.0/openapi.json
# Auth: --token flag or $env.MLB_V3_ROTOBALLER_ARTICLES_TOKEN

const BASE_URL = "http://azure-api.sportsdata.io/v3/mlb/articles-rotoballer"

# Build auth: returns {scheme: string, headers: record, query: string, location: string}.
# `location` is "header" | "query" | "cookie" | "none" and tells dry-run callers
# where the token went without inspecting headers/query themselves.
def build-auth [token?: string, auth_scheme?: string]: nothing -> record {
  let token_val = if ($token | is-not-empty) { $token } else { $env | get -o MLB_V3_ROTOBALLER_ARTICLES_TOKEN | default "" }
...
def base-url-completer [] { ["http://azure-api.sportsdata.io/v3/mlb/articles-rotoballer" "https://azure-api.sportsdata.io/v3/mlb/articles-rotoballer"] }
