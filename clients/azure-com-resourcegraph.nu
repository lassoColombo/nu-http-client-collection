...
def build-auth [token?: string, auth_scheme?: string]: nothing -> record {
  let token_val = if ($token != null) and ($token | is-not-empty) { $token } else { $env | get -o AZURE_RESOURCE_GRAPH_TOKEN | default "" }
...
export def "providers-microsoft-resource-graph-operations list" [
  ...
  let full_url = (build-url $base "/providers/Microsoft.ResourceGraph/operations" $qp)
