# Auto-generated client for MLB v3 Scores v1.0
# Source: https://api.apis.guru/v2/specs/sportsdata.io/mlb-v3-scores/1.0/openapi.json
...
def build-auth [token?: string, auth_scheme?: string]: nothing -> record {
  let token_val = if ($token | is-not-empty) { $token } else { $env | get -o MLB_V3_SCORES_TOKEN | default "" }
...
def base-url-completer [] { ["http://azure-api.sportsdata.io/v3/mlb/scores" "https://azure-api.sportsdata.io/v3/mlb/scores"] }
