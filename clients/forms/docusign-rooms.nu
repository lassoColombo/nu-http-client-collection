...
export def "accounts-offices GetOffices" [
  ...
  --onlyAccessible: oneof<nothing, bool> # When **true,** the response only includes the offices that are accessible to the current user. (default: false)
...
export def "accounts-regions GetRegions" [
  ...
  --count: int # The number of results to return. This value must be a number between `1` and `100` (default). (format: int32, default: 100)
  --startPosition: int # The starting zero-based index position of the results set from which to begin returning values. The default value is `0`. (format: int32, default: 0)
  --managedOnly: oneof<nothing, bool> # When **true,** only the regions that the current user manages are returned. The default value is **false.** (default: false)
...
export def "accounts-rooms-documents AddDocumentToRoom" [
  ...
  --isSigned: oneof<nothing, bool> # When **true,** indicates that the document is signed.
  --contentType: string
...
export def "accounts-rooms-documents GetDocuments" [
  ...
  --count: int # The number of results to return. This value must be a number between `1` and `100` (default). (format: int32, default: 100)
  --startPosition: int # The index position within the total result set from which to start returning values. The default value is `0`. (format: int32, default: 0)
  --requireContentForDynamicDocuments: oneof<nothing, bool> # When **true,** dynamic documents without content will not be returned. The default value is **false.** (default: false)
  ...
  --includeArchived: oneof<nothing, bool> # Filters results by `isArchived`. For example, when **true,** only documents with the property `isArchived=true` will be returned. If this property is not set, no filtering is applied. (default: true)
...
export def "accounts-room-templates GetRoomTemplates" [
  ...
  --onlyEnabled: oneof<nothing, bool> # When true, only returns room templates that are not disabled. (default: true)
  --count: int # The number of results. When this property is used as a request parameter specifying the number of results to return, the value must be a number between `1` and `100` (default). (format: int32, default: 100)
  --startPosition: int # The index position within the total result set from which to start returning values. The default value is `0`. (format: int32, default: 0)
...
export def "accounts-users GetUsers" [
  ...
  --lockedOnly: oneof<nothing, bool> # When **true,** filters for users whose accounts are locked.
...
export def "accounts-users-invite-user InviteUser" [
  ...
  --subscribeToRoomsActivityNotifications: oneof<nothing, bool> # default: true
