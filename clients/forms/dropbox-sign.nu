...
export def "embedded-edit-url embeddedEditUrl" [
  ...
  --raw(-r) # Fetch as text
  --allow-errors(-e) # Return full response without error handling
  --allow-edit-ccs: string@bool-completer # This allows the requester to enable/disable to add or change CC roles when editing the template. (default: false)
  ...
  --force-signer-roles: string@bool-completer # Provide users the ability to review/edit the template signer roles. (default: false)
  --force-subject-message: string@bool-completer # Provide users the ability to review/edit the template subject and message. (default: false)
  ...
  --preview-only: string@bool-completer # This allows the requester to enable the preview experience (i.e. does not allow the requester's end user to add any additional fields via the editor).  **NOTE:** This parameter overwrites `show_preview=true` (if set). (default: false)
  --show-preview: string@bool-completer # This allows the requester to enable the editor/preview experience. (default: false)
  --show-progress-stepper: string@bool-completer # When only one step remains in the signature request process and this parameter is set to `false` then the progress stepper will be hidden. (default: true)
  --test-mode: string@bool-completer # Whether this is a test, locked templates will only be available for editing if this is set to `true`. Defaults to `false`. (default: false)
...
export def "fax-line-list faxLineList" [
  ...
  --show-team-lines: string@bool-completer # Include Fax Lines belonging to team members in the list
...
export def "fax-send faxSend" [
  ...
  --test-mode: string@bool-completer # API Test Mode Setting (default: false)
...
export def "signature-request-bulk-create-embedded-with-template signatureRequestBulkCreateEmbeddedWithTemplate" [
  ...
  --allow-decline: string@bool-completer # Allows signers to decline to sign a document if `true`. Defaults to `false`. (default: false)
  ...
  --test-mode: string@bool-completer # Whether this is a test, the signature request will not be legally binding if set to `true`. Defaults to `false`. (default: false)
...
export def "signature-request-create-embedded signatureRequestCreateEmbedded" [
  ...
  --allow-decline: string@bool-completer # Allows signers to decline to sign a document if `true`. Defaults to `false`. (default: false)
  --allow-reassign: string@bool-completer # Allows signers to reassign their signature requests to other signers if set to `true`. Defaults to `false`.  **NOTE:** Only available for Premium plan. (default: false)
  ...
  --test-mode: string@bool-completer # Whether this is a test, the signature request will not be legally binding if set to `true`. Defaults to `false`. (default: false)
  --title: string # The title you want to assign to the SignatureRequest.
  --use-text-tags: string@bool-completer # Send with a value of `true` if you wish to enable [Text Tags](https://app.hellosign.com/api/textTagsWalkthrough#TextTagIntro) parsing in your document. Defaults to disabled, or `false`. (default: false)
  --populate-auto-fill-fields: string@bool-completer # Controls whether [auto fill fields](https://faq.hellosign.com/hc/en-us/articles/360051467511-Auto-Fill-Fields) can automatically populate a signer's information during signing.  **NOTE:** Keep your signer's information safe by ensuring that the _signer on your signature request is the intended party_ before using this feature. (default: false)
...
export def "signature-request-edit signatureRequestEdit" [
  ...
  --grouped-signers: list # Add Grouped Signers to your Signature Request.  This endpoint requires either **signers** or **grouped_signers**, but not both. — item shape: {group: string, order?: int, signers: list}
  --allow-decline: string@bool-completer # Allows signers to decline to sign a document if `true`. Defaults to `false`. (default: false)
  --allow-reassign: string@bool-completer # Allows signers to reassign their signature requests to other signers if set to `true`. Defaults to `false`.  **NOTE:** Only available for Premium plan and higher. (default: false)
  --attachments: list # A list describing the attachments — item shape: {instructions?: string, name: string, required?: bool, signer_index: int}
  --cc-email-addresses: list # The email addresses that should be CCed.
  --client-id: string # The client id of the API App you want to associate with this request. Used to apply the branding and callback url defined for the app.
  --custom-fields: list # When used together with merge fields, `custom_fields` allows users to add pre-filled data to their signature requests.  Pre-filled data can be used with "send-once" signature requests by adding merge fields with `form_fields_per_document` or [Text Tags](https://app.hellosign.com/api/textTagsWalkthrough#TextTagIntro) while passing values back with `custom_fields` together in one API call.  For using pre-filled on repeatable signature requests, merge fields are added to templates in the Dropbox Sign UI or by calling [/template/create_embedded_draft](/api/reference/operation/templateCreateEmbeddedDraft) and then passing `custom_fields` on subsequent signature requests referencing that template. — item shape: {editor?: string, name: string, required?: bool, value?: string}
  ...
  --form-fields-per-document: list # The fields that should appear on the document, expressed as an array of objects. (For more details you can read about it here: [Using Form Fields per Document](/docs/openapi/form-fields-per-document).)  **NOTE:** Fields like **text**, **dropdown**, **checkbox**, **radio**, and **hyperlink** have additional required and optional parameters. Check out the list of [additional parameters](/api/reference/constants/#form-fields-per-document) for these field types.  * Text Field use `SubFormFieldsPerDocumentText` * Dropdown Field use `SubFormFieldsPerDocumentDropdown` * Hyperlink Field use `SubFormFieldsPerDocumentHyperlink` * Checkbox Field use `SubFormFieldsPerDocumentCheckbox` * Radio Field use `SubFormFieldsPerDocumentRadio` * Signature Field use `SubFormFieldsPerDocumentSignature` * Date Signed Field use `SubFormFieldsPerDocumentDateSigned` * Initials Field use `SubFormFieldsPerDocumentInitials` * Text Merge Field use `SubFormFieldsPerDocumentTextMerge` * Checkbox Merge Field use `SubFormFieldsPerDocumentCheckboxMerge` — item shape: {document_index: int, api_id: string, height: int, name?: string, page?: int, required: bool, signer: string, type: "text"|"dropdown"|"hyperlink"|"checkbox"|"radio"|"signature"|"date_signed"|"initials"|"text-merge"|"checkbox-merge", width: int, x: int, y: int}
  --hide-text-tags: string@bool-completer # Enables automatic Text Tag removal when set to true.  **NOTE:** Removing text tags this way can cause unwanted clipping. We recommend leaving this setting on `false` and instead hiding your text tags using white text or a similar approach. See the [Text Tags Walkthrough](https://app.hellosign.com/api/textTagsWalkthrough#TextTagIntro) for more information. (default: false)
  --is-eid: string@bool-completer # Send with a value of `true` if you wish to enable [electronic identification (eID)](https://www.hellosign.com/features/electronic-id), which requires the signer to verify their identity with an eID provider to sign a document.<br> **NOTE:** You need the eID add-on to use this feature. Please [contact sales](https://sign.dropbox.com/form/contact-sales) for more information. Cannot be used in `test_mode`. Only works on requests with one signer. (default: false)
  --message: string # The custom message in the email that will be sent to the signers.
  --metadata: record # Key-value data that should be attached to the signature request. This metadata is included in all API responses and events involving the signature request. For example, use the metadata field to store a signer's order number for look up when receiving events for the signature request.  Each request can include up to 10 metadata keys (or 50 nested metadata keys), with key names up to 40 characters long and values up to 1000 characters long.
  --signing-options: record # This allows the requester to specify the types allowed for creating a signature and specify another signing options.  **NOTE:** If `signing_options` are not defined in the request, the allowed types will default to those specified in the account settings.  **NOTE:** If `force_advanced_signature_details` is set, allowed types has to be defined too. — shape: {default_type: "draw"|"phone"|"type"|"upload", draw?: bool, phone?: bool, type?: bool, upload?: bool, force_advanced_signature_details?: bool}
  --signing-redirect-url: string # The URL you want signers redirected to after they successfully sign.
...
export def "template-add-user templateAddUser" [
  ...
  --skip-notification: string@bool-completer # If set to `true`, the user does not receive an email notification when a template has been shared with them. Defaults to `false`. (default: false)
...
export def "template-create templateCreate" [
  ...
  --test-mode: string@bool-completer # Whether this is a test, the signature request created from this draft will not be legally binding if set to `true`. Defaults to `false`. (default: false)
  --title: string # The title you want to assign to the SignatureRequest.
  --use-preexisting-fields: string@bool-completer # Enable the detection of predefined PDF fields by setting the `use_preexisting_fields` to `true` (defaults to disabled, or `false`). (default: false)
...
export def "template-create-embedded-draft templateCreateEmbeddedDraft" [
  ...
  --files: list # Use `files[]` to indicate the uploaded file(s) to send for signature.  This endpoint requires either **files** or **file_urls[]**, but not both.
  --file-urls: list # Use `file_urls[]` to have Dropbox Sign download the file(s) to send for signature.  This endpoint requires either **files** or **file_urls[]**, but not both.
  --allow-ccs: string@bool-completer # This allows the requester to specify whether the user is allowed to provide email addresses to CC when creating a template. (default: true)
  --allow-reassign: string@bool-completer # Allows signers to reassign their signature requests to other signers if set to `true`. Defaults to `false`.  **NOTE:** Only available for Premium plan and higher. (default: false)
  --attachments: list # A list describing the attachments — item shape: {instructions?: string, name: string, required?: bool, signer_index: int}
  --cc-roles: list # The CC roles that must be assigned when using the template to send a signature request
  ...
  --message: string # The default template email message.
  --metadata: record # Key-value data that should be attached to the signature request. This metadata is included in all API responses and events involving the signature request. For example, use the metadata field to store a signer's order number for look up when receiving events for the signature request.  Each request can include up to 10 metadata keys (or 50 nested metadata keys), with key names up to 40 characters long and values up to 1000 characters long.
  --show-preview: string@bool-completer # This allows the requester to enable the editor/preview experience.  - `show_preview=true`: Allows requesters to enable the editor/preview experience. - `show_preview=false`: Allows requesters to disable the editor/preview experience. (default: false)
  --show-progress-stepper: string@bool-completer # When only one step remains in the signature request process and this parameter is set to `false` then the progress stepper will be hidden. (default: true)
  ...
  --skip-me-now: string@bool-completer # Disables the "Me (Now)" option for the person preparing the document. Does not work with type `send_document`. Defaults to `false`. (default: false)
  --subject: string # The template title (alias).
  --test-mode: string@bool-completer # Whether this is a test, the signature request created from this draft will not be legally binding if set to `true`. Defaults to `false`. (default: false)
  --title: string # The title you want to assign to the SignatureRequest.
  --use-preexisting-fields: string@bool-completer # Enable the detection of predefined PDF fields by setting the `use_preexisting_fields` to `true` (defaults to disabled, or `false`). (default: false)
...
export def "unclaimed-draft-create unclaimedDraftCreate" [
  ...
  --form-field-rules: list # Conditional Logic rules for fields defined in `form_fields_per_document`. — item shape: {id: string, trigger_operator: string, triggers: list, actions: list}
  --form-fields-per-document: list # The fields that should appear on the document, expressed as an array of objects. (For more details you can read about it here: [Using Form Fields per Document](/docs/openapi/form-fields-per-document).)  **NOTE:** Fields like **text**, **dropdown**, **checkbox**, **radio**, and **hyperlink** have additional required and optional parameters. Check out the list of [additional parameters](/api/reference/constants/#form-fields-per-document) for these field types.  * Text Field use `SubFormFieldsPerDocumentText` * Dropdown Field use `SubFormFieldsPerDocumentDropdown` * Hyperlink Field use `SubFormFieldsPerDocumentHyperlink` * Checkbox Field use `SubFormFieldsPerDocumentCheckbox` * Radio Field use `SubFormFieldsPerDocumentRadio` * Signature Field use `SubFormFieldsPerDocumentSignature` * Date Signed Field use `SubFormFieldsPerDocumentDateSigned` * Initials Field use `SubFormFieldsPerDocumentInitials` * Text Merge Field use `SubFormFieldsPerDocumentTextMerge` * Checkbox Merge Field use `SubFormFieldsPerDocumentCheckboxMerge` — item shape: {document_index: int, api_id: string, height: int, name?: string, page?: int, required: bool, signer: string, type: "text"|"dropdown"|"hyperlink"|"checkbox"|"radio"|"signature"|"date_signed"|"initials"|"text-merge"|"checkbox-merge", width: int, x: int, y: int}
  --hide-text-tags: string@bool-completer # Send with a value of `true` if you wish to enable automatic Text Tag removal. Defaults to `false`. When using Text Tags it is preferred that you set this to `false` and hide your tags with white text or something similar because the automatic removal system can cause unwanted clipping. See the [Text Tags](https://app.hellosign.com/api/textTagsWalkthrough#TextTagIntro) walkthrough for more details. (default: false)
  --message: string # The custom message in the email that will be sent to the signers.
  --metadata: record # Key-value data that should be attached to the signature request. This metadata is included in all API responses and events involving the signature request. For example, use the metadata field to store a signer's order number for look up when receiving events for the signature request.  Each request can include up to 10 metadata keys (or 50 nested metadata keys), with key names up to 40 characters long and values up to 1000 characters long.
  --show-progress-stepper: string@bool-completer # When only one step remains in the signature request process and this parameter is set to `false` then the progress stepper will be hidden. (default: true)
  ...
  --use-preexisting-fields: string@bool-completer # Set `use_text_tags` to `true` to enable [Text Tags](https://app.hellosign.com/api/textTagsWalkthrough#TextTagIntro) parsing in your document (defaults to disabled, or `false`). Alternatively, if your PDF contains pre-defined fields, enable the detection of these fields by setting the `use_preexisting_fields` to `true` (defaults to disabled, or `false`). Currently we only support use of either `use_text_tags` or `use_preexisting_fields` parameter, not both. (default: false)
  --use-text-tags: string@bool-completer # Set `use_text_tags` to `true` to enable [Text Tags](https://app.hellosign.com/api/textTagsWalkthrough#TextTagIntro) parsing in your document (defaults to disabled, or `false`). Alternatively, if your PDF contains pre-defined fields, enable the detection of these fields by setting the `use_preexisting_fields` to `true` (defaults to disabled, or `false`). Currently we only support use of either `use_text_tags` or `use_preexisting_fields` parameter, not both. (default: false)
...
export def "unclaimed-draft-create-embedded unclaimedDraftCreateEmbedded" [
  ...
  --files: list # Use `files[]` to indicate the uploaded file(s) to send for signature.  This endpoint requires either **files** or **file_urls[]**, but not both.
  --file-urls: list # Use `file_urls[]` to have Dropbox Sign download the file(s) to send for signature.  This endpoint requires either **files** or **file_urls[]**, but not both.
  --allow-ccs: string@bool-completer # This allows the requester to specify whether the user is allowed to provide email addresses to CC when claiming the draft. (default: true)
  --allow-decline: string@bool-completer # Allows signers to decline to sign a document if `true`. Defaults to `false`. (default: false)
  --allow-reassign: string@bool-completer # Allows signers to reassign their signature requests to other signers if set to `true`. Defaults to `false`.  **NOTE:** Only available for Premium plan and higher. (default: false)
  --attachments: list # A list describing the attachments — item shape: {instructions?: string, name: string, required?: bool, signer_index: int}
  --cc-email-addresses: list # The email addresses that should be CCed.
  ...
  --editor-options: record # This allows the requester to specify editor options when a preparing a document — shape: {allow_edit_signers?: bool, allow_edit_documents?: bool}
  --field-options: record # This allows the requester to specify field options for a signature request. — shape: {date_format: "MM / DD / YYYY"|"MM - DD - YYYY"|"DD / MM / YYYY"|"DD - MM - YYYY"|"YYYY / MM / DD"|"YYYY - MM - DD"}
  --force-signer-page: string@bool-completer # Provide users the ability to review/edit the signers. (default: false)
  --force-subject-message: string@bool-completer # Provide users the ability to review/edit the subject and message. (default: false)
  --form-field-groups: list # Group information for fields defined in `form_fields_per_document`. String-indexed JSON array with `group_label` and `requirement` keys. `form_fields_per_document` must contain fields referencing a group defined in `form_field_groups`. — item shape: {group_id: string, group_label: string, requirement: string}
  --form-field-rules: list # Conditional Logic rules for fields defined in `form_fields_per_document`. — item shape: {id: string, trigger_operator: string, triggers: list, actions: list}
  --form-fields-per-document: list # The fields that should appear on the document, expressed as an array of objects. (For more details you can read about it here: [Using Form Fields per Document](/docs/openapi/form-fields-per-document).)  **NOTE:** Fields like **text**, **dropdown**, **checkbox**, **radio**, and **hyperlink** have additional required and optional parameters. Check out the list of [additional parameters](/api/reference/constants/#form-fields-per-document) for these field types.  * Text Field use `SubFormFieldsPerDocumentText` * Dropdown Field use `SubFormFieldsPerDocumentDropdown` * Hyperlink Field use `SubFormFieldsPerDocumentHyperlink` * Checkbox Field use `SubFormFieldsPerDocumentCheckbox` * Radio Field use `SubFormFieldsPerDocumentRadio` * Signature Field use `SubFormFieldsPerDocumentSignature` * Date Signed Field use `SubFormFieldsPerDocumentDateSigned` * Initials Field use `SubFormFieldsPerDocumentInitials` * Text Merge Field use `SubFormFieldsPerDocumentTextMerge` * Checkbox Merge Field use `SubFormFieldsPerDocumentCheckboxMerge` — item shape: {document_index: int, api_id: string, height: int, name?: string, page?: int, required: bool, signer: string, type: "text"|"dropdown"|"hyperlink"|"checkbox"|"radio"|"signature"|"date_signed"|"initials"|"text-merge"|"checkbox-merge", width: int, x: int, y: int}
  --hide-text-tags: string@bool-completer # Send with a value of `true` if you wish to enable automatic Text Tag removal. Defaults to `false`. When using Text Tags it is preferred that you set this to `false` and hide your tags with white text or something similar because the automatic removal system can cause unwanted clipping. See the [Text Tags](https://app.hellosign.com/api/textTagsWalkthrough#TextTagIntro) walkthrough for more details. (default: false)
  --hold-request: string@bool-completer # The request from this draft will not automatically send to signers post-claim if set to `true`. Requester must [release](/api/reference/operation/signatureRequestReleaseHold/) the request from hold when ready to send. Defaults to `false`. (default: false)
  --is-for-embedded-signing: string@bool-completer # The request created from this draft will also be signable in embedded mode if set to `true`. Defaults to `false`. (default: false)
  --message: string # The custom message in the email that will be sent to the signers.
  --metadata: record # Key-value data that should be attached to the signature request. This metadata is included in all API responses and events involving the signature request. For example, use the metadata field to store a signer's order number for look up when receiving events for the signature request.  Each request can include up to 10 metadata keys (or 50 nested metadata keys), with key names up to 40 characters long and values up to 1000 characters long.
  ...
  --show-preview: string@bool-completer # This allows the requester to enable the editor/preview experience.  - `show_preview=true`: Allows requesters to enable the editor/preview experience. - `show_preview=false`: Allows requesters to disable the editor/preview experience.
  --show-progress-stepper: string@bool-completer # When only one step remains in the signature request process and this parameter is set to `false` then the progress stepper will be hidden. (default: true)
  --signers: list # Add Signers to your Unclaimed Draft Signature Request. — item shape: {email_address: string, name: string, order?: int}
  --signing-options: record # This allows the requester to specify the types allowed for creating a signature and specify another signing options.  **NOTE:** If `signing_options` are not defined in the request, the allowed types will default to those specified in the account settings.  **NOTE:** If `force_advanced_signature_details` is set, allowed types has to be defined too. — shape: {default_type: "draw"|"phone"|"type"|"upload", draw?: bool, phone?: bool, type?: bool, upload?: bool, force_advanced_signature_details?: bool}
  --signing-redirect-url: string # The URL you want signers redirected to after they successfully sign.
...
export def "unclaimed-draft-create-embedded-with-template unclaimedDraftCreateEmbeddedWithTemplate" [
  ...
  --force-signer-roles: string@bool-completer # Provide users the ability to review/edit the template signer roles. (default: false)
  --force-subject-message: string@bool-completer # Provide users the ability to review/edit the template subject and message. (default: false)
  --hold-request: string@bool-completer # The request from this draft will not automatically send to signers post-claim if set to 1. Requester must [release](/api/reference/operation/signatureRequestReleaseHold/) the request from hold when ready to send. Defaults to `false`. (default: false)
  --is-for-embedded-signing: string@bool-completer # The request created from this draft will also be signable in embedded mode if set to `true`. Defaults to `false`. (default: false)
  --message: string # The custom message in the email that will be sent to the signers.
  --metadata: record # Key-value data that should be attached to the signature request. This metadata is included in all API responses and events involving the signature request. For example, use the metadata field to store a signer's order number for look up when receiving events for the signature request.  Each request can include up to 10 metadata keys (or 50 nested metadata keys), with key names up to 40 characters long and values up to 1000 characters long.
  --preview-only: string@bool-completer # This allows the requester to enable the preview experience (i.e. does not allow the requester's end user to add any additional fields via the editor).  - `preview_only=true`: Allows requesters to enable the preview only experience. - `preview_only=false`: Allows requesters to disable the preview only experience.  **NOTE:** This parameter overwrites `show_preview=1` (if set). (default: false)
  ...
  --title: string # The title you want to assign to the SignatureRequest.
  --populate-auto-fill-fields: string@bool-completer # Controls whether [auto fill fields](https://faq.hellosign.com/hc/en-us/articles/360051467511-Auto-Fill-Fields) can automatically populate a signer's information during signing.  **NOTE:** Keep your signer's information safe by ensuring that the _signer on your signature request is the intended party_ before using this feature. (default: false)
  --allow-ccs: string@bool-completer # This allows the requester to specify whether the user is allowed to provide email addresses to CC when claiming the draft. (default: false)
]: any -> record<unclaimed_draft: record<signature_request_id: string, claim_url: string, signing_redirect_url: string, requesting_redirect_url: string, expires_at: int, test_mode: bool>, warnings: table<warning_msg: string, warning_name: string>> {
  let input = $in
  let auth = (build-auth $token ($auth_scheme | default "basic"))
  let base = ($base_url | default $BASE_URL)
...
export def "unclaimed-draft-edit-and-resend unclaimedDraftEditAndResend" [
  ...
  client_id: string # Client id of the app used to create the draft. Used to apply the branding and callback url defined for the app.
  --editor-options: record # This allows the requester to specify editor options when a preparing a document — shape: {allow_edit_signers?: bool, allow_edit_documents?: bool}
  --is-for-embedded-signing: string@bool-completer # The request created from this draft will also be signable in embedded mode if set to `true`.
