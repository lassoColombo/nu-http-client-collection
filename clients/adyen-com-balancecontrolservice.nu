...
export def commands []: nothing -> table {
  ...
  let mod_name = (scope modules | where { $in.commands | any { $in.name == "balance-transfer post-balanceTransfer" } } | get name | first)
...
export def "balance-transfer post-balanceTransfer" [
