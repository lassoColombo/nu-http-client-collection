...
export def commands []: nothing -> table {
  ...
  let mod_name = (scope modules | where { $in.commands | any { $in.name == "subscriptions-providers-microsoft-network-locations-check-dns-name-availability CheckDnsNameAvailability" } } | get name | first)
