...
export def commands []: nothing -> table {
  ...
  let mod_name = (scope modules | where { $in.commands | any { $in.name == "subscriptions-resource-groups-providers-microsoft-api-management-service-properties ListByService" } } | get name | first)
...
export def "subscriptions-resource-groups-providers-microsoft-api-management-service-properties ListByService" [
  ...
  let full_url = (build-url $base $"/subscriptions/($subscriptionId)/resourceGroups/($resourceGroupName)/providers/Microsoft.ApiManagement/service/($serviceName)/properties" $qp)
...
export def "subscriptions-resource-groups-providers-microsoft-api-management-service-properties Delete" [
  ...
  let full_url = (build-url $base $"/subscriptions/($subscriptionId)/resourceGroups/($resourceGroupName)/providers/Microsoft.ApiManagement/service/($serviceName)/properties/($propId)" $qp)
...
export def "subscriptions-resource-groups-providers-microsoft-api-management-service-properties GetEntityTag" [
  resourceGroupName: string
  serviceName: string
  propId: string
  subscriptionId: string
...
# --properties shape: {displayName: string, value: string, secret?: bool, tags?: list}
export def "subscriptions-resource-groups-providers-microsoft-api-management-service-properties CreateOrUpdate" [
  resourceGroupName: string
  serviceName: string
  propId: string
  subscriptionId: string
