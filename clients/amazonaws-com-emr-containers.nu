...
def build-auth [token?: string, auth_scheme?: string]: nothing -> record {
  let token_val = if ($token | is-not-empty) { $token } else { $env | get -o AMAZON_EMR_CONTAINERS_TOKEN | default "" }
...
export def "virtualclusters-jobruns cancel-job-run" [
  ...
  let full_url = (build-url $base ({virtual_cluster_id: (encode-path-segment $virtual_cluster_id), job_run_id: (encode-path-segment $job_run_id)} | format pattern "/virtualclusters/{virtual_cluster_id}/jobruns/{job_run_id}") $auth.query)
...
export def "jobtemplates create-job-template" [
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let full_url = (build-url $base "/jobtemplates" $auth.query)
...
export def "jobtemplates list-job-templates" [
  ...
  let full_url = (build-url $base "/jobtemplates" $qp $auth.query)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let extra_headers = {"X-Amz-Content-Sha256": $x_amz_content_sha256, "X-Amz-Date": $x_amz_date, "X-Amz-Algorithm": $x_amz_algorithm, "X-Amz-Credential": $x_amz_credential, "X-Amz-Security-Token": $x_amz_security_token, "X-Amz-Signature": $x_amz_signature, "X-Amz-SignedHeaders": $x_amz_signed_headers} | compact
  let auth = ($auth | update headers ($auth.headers | merge $extra_headers))
  let req = {
    method: "get"
    url: $full_url
    query: ({"createdAfter": $created_after, "createdBefore": $created_before, "maxResults": $max_results, "nextToken": $next_token} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "virtualclusters-endpoints create-managed" [
  ...
  let base = ($base_url | default $BASE_URL)
  if ($virtual_cluster_id | is-empty) { error make --unspanned { msg: "path parameter 'virtualClusterId' must be non-empty" } }
  let full_url = (build-url $base ({virtual_cluster_id: (encode-path-segment $virtual_cluster_id)} | format pattern "/virtualclusters/{virtual_cluster_id}/endpoints") $auth.query)
...
export def "virtualclusters-endpoints list-managed" [
  ...
  let full_url = (build-url $base ({virtual_cluster_id: (encode-path-segment $virtual_cluster_id)} | format pattern "/virtualclusters/{virtual_cluster_id}/endpoints") $qp $auth.query)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let extra_headers = {"X-Amz-Content-Sha256": $x_amz_content_sha256, "X-Amz-Date": $x_amz_date, "X-Amz-Algorithm": $x_amz_algorithm, "X-Amz-Credential": $x_amz_credential, "X-Amz-Security-Token": $x_amz_security_token, "X-Amz-Signature": $x_amz_signature, "X-Amz-SignedHeaders": $x_amz_signed_headers} | compact
  let auth = ($auth | update headers ($auth.headers | merge $extra_headers))
  let req = {
    method: "get"
    url: $full_url
    query: ({"createdBefore": $created_before, "createdAfter": $created_after, "types": $types, "states": $states, "maxResults": $max_results, "nextToken": $next_token} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "virtualclusters create-virtual" [
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let full_url = (build-url $base "/virtualclusters" $auth.query)
...
export def "virtualclusters list-virtual-clusters" [
  ...
  let full_url = (build-url $base "/virtualclusters" $qp $auth.query)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let extra_headers = {"X-Amz-Content-Sha256": $x_amz_content_sha256, "X-Amz-Date": $x_amz_date, "X-Amz-Algorithm": $x_amz_algorithm, "X-Amz-Credential": $x_amz_credential, "X-Amz-Security-Token": $x_amz_security_token, "X-Amz-Signature": $x_amz_signature, "X-Amz-SignedHeaders": $x_amz_signed_headers} | compact
  let auth = ($auth | update headers ($auth.headers | merge $extra_headers))
  let req = {
    method: "get"
    url: $full_url
    query: ({"containerProviderId": $container_provider_id, "containerProviderType": $container_provider_type, "createdAfter": $created_after, "createdBefore": $created_before, "states": $states, "maxResults": $max_results, "nextToken": $next_token} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "jobtemplates delete-job-template" [
  ...
  let full_url = (build-url $base ({template_id: (encode-path-segment $template_id)} | format pattern "/jobtemplates/{template_id}") $auth.query)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let extra_headers = {"X-Amz-Content-Sha256": $x_amz_content_sha256, "X-Amz-Date": $x_amz_date, "X-Amz-Algorithm": $x_amz_algorithm, "X-Amz-Credential": $x_amz_credential, "X-Amz-Security-Token": $x_amz_security_token, "X-Amz-Signature": $x_amz_signature, "X-Amz-SignedHeaders": $x_amz_signed_headers} | compact
  let auth = ($auth | update headers ($auth.headers | merge $extra_headers))
...
export def "virtualclusters-endpoints delete-managed" [
  ...
  let full_url = (build-url $base ({virtual_cluster_id: (encode-path-segment $virtual_cluster_id), endpoint_id: (encode-path-segment $endpoint_id)} | format pattern "/virtualclusters/{virtual_cluster_id}/endpoints/{endpoint_id}") $auth.query)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let extra_headers = {"X-Amz-Content-Sha256": $x_amz_content_sha256, "X-Amz-Date": $x_amz_date, "X-Amz-Algorithm": $x_amz_algorithm, "X-Amz-Credential": $x_amz_credential, "X-Amz-Security-Token": $x_amz_security_token, "X-Amz-Signature": $x_amz_signature, "X-Amz-SignedHeaders": $x_amz_signed_headers} | compact
  let auth = ($auth | update headers ($auth.headers | merge $extra_headers))
...
export def "virtualclusters delete-virtual" [
  ...
  let base = ($base_url | default $BASE_URL)
  if ($virtual_cluster_id | is-empty) { error make --unspanned { msg: "path parameter 'virtualClusterId' must be non-empty" } }
  let full_url = (build-url $base ({virtual_cluster_id: (encode-path-segment $virtual_cluster_id)} | format pattern "/virtualclusters/{virtual_cluster_id}") $auth.query)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let extra_headers = {"X-Amz-Content-Sha256": $x_amz_content_sha256, "X-Amz-Date": $x_amz_date, "X-Amz-Algorithm": $x_amz_algorithm, "X-Amz-Credential": $x_amz_credential, "X-Amz-Security-Token": $x_amz_security_token, "X-Amz-Signature": $x_amz_signature, "X-Amz-SignedHeaders": $x_amz_signed_headers} | compact
  let auth = ($auth | update headers ($auth.headers | merge $extra_headers))
...
export def "virtualclusters-jobruns list-job-runs" [
  ...
  let full_url = (build-url $base ({virtual_cluster_id: (encode-path-segment $virtual_cluster_id)} | format pattern "/virtualclusters/{virtual_cluster_id}/jobruns") $qp $auth.query)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let extra_headers = {"X-Amz-Content-Sha256": $x_amz_content_sha256, "X-Amz-Date": $x_amz_date, "X-Amz-Algorithm": $x_amz_algorithm, "X-Amz-Credential": $x_amz_credential, "X-Amz-Security-Token": $x_amz_security_token, "X-Amz-Signature": $x_amz_signature, "X-Amz-SignedHeaders": $x_amz_signed_headers} | compact
  let auth = ($auth | update headers ($auth.headers | merge $extra_headers))
  let req = {
    method: "get"
    url: $full_url
    query: ({"createdBefore": $created_before, "createdAfter": $created_after, "name": $name, "states": $states, "maxResults": $max_results, "nextToken": $next_token} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "virtualclusters-jobruns start-job-run" [
  ...
  let base = ($base_url | default $BASE_URL)
  if ($virtual_cluster_id | is-empty) { error make --unspanned { msg: "path parameter 'virtualClusterId' must be non-empty" } }
  let full_url = (build-url $base ({virtual_cluster_id: (encode-path-segment $virtual_cluster_id)} | format pattern "/virtualclusters/{virtual_cluster_id}/jobruns") $auth.query)
