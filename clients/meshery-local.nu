# Auto-generated client for Meshery API. v0.4.27
# Source: https://api.apis.guru/v2/specs/meshery.local/0.4.27/openapi.json
# Auth: --token flag or $env.MESHERY_API_TOKEN

const BASE_URL = "http://meshery.local"
const DEFAULT_AUTH = "cookie-token"
...
def build-auth [token?: string, auth_scheme?: string]: nothing -> record {
  ...
  match $scheme {
    "cookie-token" => { {headers: {Cookie: $"(encode-path-segment "token")=(encode-path-segment $token_val)"}, query: ""} }
    "none" => { {headers: {}, query: ""} }
