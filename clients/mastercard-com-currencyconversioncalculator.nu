...
export def commands []: nothing -> table {
  ...
  let mod_name = (scope modules | where { $in.commands | any { $in.name == "conversion-rate get-detail-using-get" } } | get name | first)
...
export def "conversion-rate get-detail-using-get" [
