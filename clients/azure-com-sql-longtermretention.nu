...
export def "subscriptions-providers-microsoft-sql-locations-long-term-retention-backups list" [
  ...
  do-request "get" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors $full "application/json" null {query: ({"onlyLatestPerDatabase": $only_latest_per_database, "databaseState": $database_state, "api-version": $api_version} | compact), body: null}
}
