...
export def "subscriptions-providers-microsoft-compute-admin-locations-artifact-types-platform-image list" [
  ...
  let full_url = (build-url $base ({subscription_id: $subscription_id, location: $location} | format pattern "/subscriptions/{subscription_id}/providers/Microsoft.Compute.Admin/locations/{location}/artifactTypes/platformImage") $qp)
...
export def "subscriptions-providers-microsoft-compute-admin-locations-artifact-types-platform-image-publishers-offers-skus-versions delete" [
  ...
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "api-version" $api_version "scalar")] | flatten | str join "&"
  let full_url = (build-url $base ({subscription_id: $subscription_id, location: $location, publisher: $publisher, offer: $offer, sku: $sku, version: $version} | format pattern "/subscriptions/{subscription_id}/providers/Microsoft.Compute.Admin/locations/{location}/artifactTypes/platformImage/publishers/{publisher}/offers/{offer}/skus/{sku}/versions/{version}") $qp)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
