...
export def "checks-heartbeats-availability get" [
  ...
  --allow-errors(-e) # Return full response without error handling
  --dry-run(-n) # Return the request that would be sent without executing it
  --startTime: string # format: date, default: 2026-06-12T08:09:53.653Z
  --endTime: string # format: date, default: 2026-06-13T08:09:53.653Z
  --x-checkly-account: string # Your Checkly account ID, you can find it at https://app.checklyhq.com/settings/account/general
...
export def "checks-heartbeats-events list" [
  ...
  --allow-errors(-e) # Return full response without error handling
  --dry-run(-n) # Return the request that would be sent without executing it
  --startTime: string # format: date, default: 2026-06-12T08:09:53.656Z
  --endTime: string # format: date, default: 2026-06-13T08:09:53.656Z
...
export def "status-pages-incidents-incident-updates post" [
  ...
  --publicIncidentUpdateDate: string # format: date-time, default: 2026-06-13T08:09:54.944Z
  --created-at: string # format: date
