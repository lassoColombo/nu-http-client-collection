...
export def "checks-heartbeats-availability get" [
  ...
  --raw(-r) # Fetch as text
  --allow-errors(-e) # Return full response without error handling
  --startTime: string # format: date, default: 2026-06-09T23:11:03.716Z
  --endTime: string # format: date, default: 2026-06-10T23:11:03.716Z
  --x-checkly-account: string # Your Checkly account ID, you can find it at https://app.checklyhq.com/settings/account/general
...
export def "checks-heartbeats-events list" [
  ...
  --raw(-r) # Fetch as text
  --allow-errors(-e) # Return full response without error handling
  --startTime: string # format: date, default: 2026-06-09T23:11:03.719Z
  --endTime: string # format: date, default: 2026-06-10T23:11:03.719Z
...
export def "status-pages-incidents-incident-updates post" [
  ...
  --publicIncidentUpdateDate: string # format: date-time, default: 2026-06-10T23:11:04.961Z
  --created-at: string # format: date
