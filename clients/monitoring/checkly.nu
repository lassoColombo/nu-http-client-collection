...
export def "checks-heartbeats-availability get" [
  ...
  --raw(-r) # Fetch as text
  --allow-errors(-e) # Return full response without error handling
  --startTime: string # format: date, default: 2026-06-10T16:29:06.606Z
  --endTime: string # format: date, default: 2026-06-11T16:29:06.606Z
  --x-checkly-account: string # Your Checkly account ID, you can find it at https://app.checklyhq.com/settings/account/general
...
export def "checks-heartbeats-events list" [
  ...
  --raw(-r) # Fetch as text
  --allow-errors(-e) # Return full response without error handling
  --startTime: string # format: date, default: 2026-06-10T16:29:06.610Z
  --endTime: string # format: date, default: 2026-06-11T16:29:06.610Z
...
export def "status-pages-incidents-incident-updates post" [
  ...
  --publicIncidentUpdateDate: string # format: date-time, default: 2026-06-11T16:29:07.837Z
  --created-at: string # format: date
