...
# Source: https://api.apis.guru/v2/specs/azure.com/security-jitNetworkAccessPolicies/2015-06-01-preview/swagger.json
...
export def "subscriptions-providers-microsoft-security-jit-network-access-policies list" [
  ...
  let full_url = (build-url $base ({subscription_id: (encode-path-segment $subscription_id)} | format pattern "/subscriptions/{subscription_id}/providers/Microsoft.Security/jitNetworkAccessPolicies") $qp $auth.query)
...
export def "subscriptions-providers-microsoft-security-locations-jit-network-access-policies list-by-region" [
  ...
  let qp = [(serialize-qp "api-version" $api_version "scalar")] | flatten | str join "&"
  let full_url = (build-url $base ({subscription_id: (encode-path-segment $subscription_id), asc_location: (encode-path-segment $asc_location)} | format pattern "/subscriptions/{subscription_id}/providers/Microsoft.Security/locations/{asc_location}/jitNetworkAccessPolicies") $qp $auth.query)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "get"
...
export def "subscriptions-resource-groups-providers-microsoft-security-jit-network-access-policies list" [
  ...
  let qp = [(serialize-qp "api-version" $api_version "scalar")] | flatten | str join "&"
  let full_url = (build-url $base ({subscription_id: (encode-path-segment $subscription_id), resource_group_name: (encode-path-segment $resource_group_name)} | format pattern "/subscriptions/{subscription_id}/resourceGroups/{resource_group_name}/providers/Microsoft.Security/jitNetworkAccessPolicies") $qp $auth.query)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "get"
...
export def "subscriptions-resource-groups-providers-microsoft-security-locations-jit-network-access-policies delete" [
  ...
  if ($resource_group_name | is-empty) { error make --unspanned { msg: "path parameter 'resourceGroupName' must be non-empty" } }
  if ($asc_location | is-empty) { error make --unspanned { msg: "path parameter 'ascLocation' must be non-empty" } }
  if ($jit_network_access_policy_name | is-empty) { error make --unspanned { msg: "path parameter 'jitNetworkAccessPolicyName' must be non-empty" } }
  let qp = [(serialize-qp "api-version" $api_version "scalar")] | flatten | str join "&"
  let full_url = (build-url $base ({subscription_id: (encode-path-segment $subscription_id), resource_group_name: (encode-path-segment $resource_group_name), asc_location: (encode-path-segment $asc_location), jit_network_access_policy_name: (encode-path-segment $jit_network_access_policy_name)} | format pattern "/subscriptions/{subscription_id}/resourceGroups/{resource_group_name}/providers/Microsoft.Security/locations/{asc_location}/jitNetworkAccessPolicies/{jit_network_access_policy_name}") $qp $auth.query)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "delete"
...
export def "subscriptions-resource-groups-providers-microsoft-security-locations-jit-network-access-policies get" [
  ...
  --dry-run(-n) # Return the request that would be sent without executing it
  --api-version: string # API version for the operation
]: nothing -> record<properties: record<provisioningState: string, requests: list<record>, virtualMachines: list<record>>> {
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  if ($subscription_id | is-empty) { error make --unspanned { msg: "path parameter 'subscriptionId' must be non-empty" } }
  if ($resource_group_name | is-empty) { error make --unspanned { msg: "path parameter 'resourceGroupName' must be non-empty" } }
...
export def "subscriptions-resource-groups-providers-microsoft-security-locations-jit-network-access-policies create-or-update" [
  ...
  --dry-run(-n) # Return the request that would be sent without executing it
  --api-version: string # API version for the operation
  properties: record # shape: {requests?: list, virtualMachines: list}
  --kind: string # Kind of the resource
]: any -> record<properties: record<provisioningState: string, requests: list<record>, virtualMachines: list<record>>> {
  let input = $in
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  if ($subscription_id | is-empty) { error make --unspanned { msg: "path parameter 'subscriptionId' must be non-empty" } }
...
export def "subscriptions-resource-groups-providers-microsoft-security-locations-jit-network-access-policies create-initiate" [
  ...
  virtual_machines: list # A list of virtual machines & ports to open access for — item shape: {id: string, ports: list}
]: any -> record<justification: string, requestor: string, startTimeUtc: string, virtualMachines: table<id: string, ports: list>> {
  let input = $in
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  if ($subscription_id | is-empty) { error make --unspanned { msg: "path parameter 'subscriptionId' must be non-empty" } }
  ...
  if ($asc_location | is-empty) { error make --unspanned { msg: "path parameter 'ascLocation' must be non-empty" } }
  if ($jit_network_access_policy_name | is-empty) { error make --unspanned { msg: "path parameter 'jitNetworkAccessPolicyName' must be non-empty" } }
  if ($jit_network_access_policy_initiate_type | is-empty) { error make --unspanned { msg: "path parameter 'jitNetworkAccessPolicyInitiateType' must be non-empty" } }
  let qp = [(serialize-qp "api-version" $api_version "scalar")] | flatten | str join "&"
  let full_url = (build-url $base ({subscription_id: (encode-path-segment $subscription_id), resource_group_name: (encode-path-segment $resource_group_name), asc_location: (encode-path-segment $asc_location), jit_network_access_policy_name: (encode-path-segment $jit_network_access_policy_name), jit_network_access_policy_initiate_type: (encode-path-segment $jit_network_access_policy_initiate_type)} | format pattern "/subscriptions/{subscription_id}/resourceGroups/{resource_group_name}/providers/Microsoft.Security/locations/{asc_location}/jitNetworkAccessPolicies/{jit_network_access_policy_name}/{jit_network_access_policy_initiate_type}") $qp $auth.query)
  let req_body = {"justification": $justification, "virtualMachines": $virtual_machines} | compact
  let req_body = if ($input | describe | str starts-with "record") { $input | merge deep ($req_body | default {}) } else { $req_body }
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
