...
def build-auth [token?: string, auth_scheme?: string]: nothing -> record {
  let token_val = if ($token | is-not-empty) { $token } else { $env | get -o PRODUCT_FINDER_API_TOKEN | default "" }
...
export def "open-banking-v2-2-business-current-accounts get" [
  ...
  let full_url = (build-url $base "/open-banking/v2.2/business-current-accounts" $auth.query)
...
export def "open-banking-v2-2-commercial-credit-cards get" [
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let full_url = (build-url $base "/open-banking/v2.2/commercial-credit-cards" $auth.query)
  let accept_val = "application/prs.openbanking.opendata.v2.2+json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "get"
...
export def "open-banking-v2-2-personal-current-accounts get" [
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let full_url = (build-url $base "/open-banking/v2.2/personal-current-accounts" $auth.query)
  let accept_val = "application/prs.openbanking.opendata.v2.2+json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "get"
...
export def "open-banking-v2-2-unsecured-sme-loans get" [
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let full_url = (build-url $base "/open-banking/v2.2/unsecured-sme-loans" $auth.query)
  let accept_val = "application/prs.openbanking.opendata.v2.2+json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "get"
...
export def "x-open-banking-v2-2-business-current-accounts-segment get" [
  ...
  let full_url = (build-url $base ({segment: (encode-path-segment $segment)} | format pattern "/x-open-banking/v2.2/business-current-accounts/segment/{segment}") $auth.query)
  let accept_val = "application/prs.openbanking.opendata.v2.2+json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "get"
...
export def "x-open-banking-v2-2-commercial-credit-cards-segment get" [
  ...
  let base = ($base_url | default $BASE_URL)
  if ($segment | is-empty) { error make --unspanned { msg: "path parameter 'segment' must be non-empty" } }
  let full_url = (build-url $base ({segment: (encode-path-segment $segment)} | format pattern "/x-open-banking/v2.2/commercial-credit-cards/segment/{segment}") $auth.query)
  let accept_val = "application/prs.openbanking.opendata.v2.2+json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "get"
...
export def "x-open-banking-v2-2-personal-current-accounts-segment get" [
  ...
  let base = ($base_url | default $BASE_URL)
  if ($segment | is-empty) { error make --unspanned { msg: "path parameter 'segment' must be non-empty" } }
  let full_url = (build-url $base ({segment: (encode-path-segment $segment)} | format pattern "/x-open-banking/v2.2/personal-current-accounts/segment/{segment}") $auth.query)
  let accept_val = "application/prs.openbanking.opendata.v2.2+json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "get"
...
export def "x-open-banking-v2-2-unsecured-sme-loans-segment get" [
  ...
  let base = ($base_url | default $BASE_URL)
  if ($segment | is-empty) { error make --unspanned { msg: "path parameter 'segment' must be non-empty" } }
  let full_url = (build-url $base ({segment: (encode-path-segment $segment)} | format pattern "/x-open-banking/v2.2/unsecured-sme-loans/segment/{segment}") $auth.query)
  let accept_val = "application/prs.openbanking.opendata.v2.2+json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "get"
