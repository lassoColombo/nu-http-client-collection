...
export def "vaults-tagsoperationadd create-tags" [
  account_id: string
  vault_name: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  ...
  let full_url = (build-url $base ({account_id: (encode-path-segment $account_id), vault_name: (encode-path-segment $vault_name)} | format pattern "/{account_id}/vaults/{vault_name}/tags#operation=add") $qp)
...
export def "vaults-tagsoperationremove delete-tags" [
  account_id: string
  vault_name: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  ...
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "operation" $operation "scalar")] | flatten | str join "&"
  let full_url = (build-url $base ({account_id: (encode-path-segment $account_id), vault_name: (encode-path-segment $vault_name)} | format pattern "/{account_id}/vaults/{vault_name}/tags#operation=remove") $qp)
