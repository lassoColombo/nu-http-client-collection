...
export def "civicinfo-representatives civicinforepresentativesrepresentativeInfoByAddress" [
  ...
  --includeOffices: oneof<nothing, bool> # Whether to return information about offices and officials. If false, only the top-level district information will be returned.
...
export def "civicinfo-voterinfo civicinfoelectionsvoterInfoQuery" [
  ...
  --officialOnly: oneof<nothing, bool> # If set to true, only data from official state sources will be returned.
  --returnAllAvailableData: oneof<nothing, bool> # If set to true, the query will return the success code and include any partial information when it is unable to determine a matching address or unable to determine the election for electionId=0 queries.
