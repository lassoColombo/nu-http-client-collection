...
def build-auth [token?: string, auth_scheme?: string]: nothing -> record {
  let token_val = if ($token | is-not-empty) { $token } else { $env | get -o GOOGLE_CIVIC_INFORMATION_API_TOKEN | default "" }
...
export def "civicinfo-divisions list" [
  ...
  let full_url = (build-url $base "/civicinfo/v2/divisions" $qp $auth.query)
...
export def "civicinfo-elections list" [
  ...
  let full_url = (build-url $base "/civicinfo/v2/elections" $qp $auth.query)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "get"
...
export def "civicinfo-representatives get-by-address" [
  ...
  let full_url = (build-url $base "/civicinfo/v2/representatives" $qp $auth.query)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "get"
    url: $full_url
    query: ({"$.xgafv": $xgafv, "access_token": $access_token, "alt": $alt, "callback": $callback, "fields": $fields, "key": $key, "oauth_token": $oauth_token, "prettyPrint": $pretty_print, "quotaUser": $quota_user, "upload_protocol": $upload_protocol, "uploadType": $upload_type, "address": $address, "includeOffices": $include_offices, "levels": $levels, "roles": $roles} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "civicinfo-representatives get-by-division" [
  ...
  let full_url = (build-url $base ({ocd_id: (encode-path-segment $ocd_id)} | format pattern "/civicinfo/v2/representatives/{ocd_id}") $qp $auth.query)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "get"
    url: $full_url
    query: ({"$.xgafv": $xgafv, "access_token": $access_token, "alt": $alt, "callback": $callback, "fields": $fields, "key": $key, "oauth_token": $oauth_token, "prettyPrint": $pretty_print, "quotaUser": $quota_user, "upload_protocol": $upload_protocol, "uploadType": $upload_type, "levels": $levels, "recursive": $recursive, "roles": $roles} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
