...
# Source: https://api.apis.guru/v2/specs/azure.com/resources-policySetDefinitions/2019-06-01/swagger.json
...
export def "providers-microsoft-authorization-policy-set-definitions list-built" [
  ...
  let full_url = (build-url $base "/providers/Microsoft.Authorization/policySetDefinitions" $qp $auth.query)
...
export def "providers-microsoft-authorization-policy-set-definitions get-built" [
  ...
  --dry-run(-n) # Return the request that would be sent without executing it
  --api-version: string # The API version to use for the operation.
]: nothing -> record<id: string, name: string, properties: record<description: string, displayName: string, metadata: record, parameters: record, policyDefinitions: list<record>, policyType: string>, type: string> {
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  if ($policy_set_definition_name | is-empty) { error make --unspanned { msg: "path parameter 'policySetDefinitionName' must be non-empty" } }
  let qp = [(serialize-qp "api-version" $api_version "scalar")] | flatten | str join "&"
  let full_url = (build-url $base ({policy_set_definition_name: (encode-path-segment $policy_set_definition_name)} | format pattern "/providers/Microsoft.Authorization/policySetDefinitions/{policy_set_definition_name}") $qp $auth.query)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "get"
...
export def "providers-microsoft-management-managementgroups-providers-microsoft-authorization-policy-set-definitions list-by-group" [
  ...
  let qp = [(serialize-qp "api-version" $api_version "scalar")] | flatten | str join "&"
  let full_url = (build-url $base ({management_group_id: (encode-path-segment $management_group_id)} | format pattern "/providers/Microsoft.Management/managementgroups/{management_group_id}/providers/Microsoft.Authorization/policySetDefinitions") $qp $auth.query)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "get"
...
export def "providers-microsoft-management-managementgroups-providers-microsoft-authorization-policy-set-definitions create-or-update-at-group" [
  ...
  --dry-run(-n) # Return the request that would be sent without executing it
  --api-version: string # The API version to use for the operation.
  --properties: any # The policy set definition properties. — shape: {description?: string, displayName?: string, metadata?: record, parameters?: record, policyDefinitions: list, policyType?: "NotSpecified"|"BuiltIn"|"Custom"}
]: any -> record<id: string, name: string, properties: record<description: string, displayName: string, metadata: record, parameters: record, policyDefinitions: list<record>, policyType: string>, type: string> {
  let input = $in
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  if ($management_group_id | is-empty) { error make --unspanned { msg: "path parameter 'managementGroupId' must be non-empty" } }
...
export def "subscriptions-providers-microsoft-authorization-policy-set-definitions list" [
  ...
  let qp = [(serialize-qp "api-version" $api_version "scalar")] | flatten | str join "&"
  let full_url = (build-url $base ({subscription_id: (encode-path-segment $subscription_id)} | format pattern "/subscriptions/{subscription_id}/providers/Microsoft.Authorization/policySetDefinitions") $qp $auth.query)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "get"
...
export def "subscriptions-providers-microsoft-authorization-policy-set-definitions delete" [
  ...
  if ($policy_set_definition_name | is-empty) { error make --unspanned { msg: "path parameter 'policySetDefinitionName' must be non-empty" } }
  let qp = [(serialize-qp "api-version" $api_version "scalar")] | flatten | str join "&"
  let full_url = (build-url $base ({subscription_id: (encode-path-segment $subscription_id), policy_set_definition_name: (encode-path-segment $policy_set_definition_name)} | format pattern "/subscriptions/{subscription_id}/providers/Microsoft.Authorization/policySetDefinitions/{policy_set_definition_name}") $qp $auth.query)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "delete"
