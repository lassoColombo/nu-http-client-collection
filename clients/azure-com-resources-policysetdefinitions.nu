...
export def commands []: nothing -> table {
  ...
  let mod_name = (scope modules | where { $in.commands | any { $in.name == "providers-microsoft-authorization-policy-set-definitions ListBuiltIn" } } | get name | first)
...
export def "providers-microsoft-authorization-policy-set-definitions ListBuiltIn" [
...
export def "providers-microsoft-authorization-policy-set-definitions GetBuiltIn" [
  ...
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "api-version" $api_version "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/providers/Microsoft.Authorization/policySetDefinitions/($policySetDefinitionName)" $qp)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "get" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json"
}
...
export def "providers-microsoft-management-managementgroups-providers-microsoft-authorization-policy-set-definitions ListByManagementGroup" [
  ...
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "api-version" $api_version "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/providers/Microsoft.Management/managementgroups/($managementGroupId)/providers/Microsoft.Authorization/policySetDefinitions" $qp)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "get" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json"
}
...
export def "providers-microsoft-management-managementgroups-providers-microsoft-authorization-policy-set-definitions DeleteAtManagementGroup" [
  policySetDefinitionName: string
  managementGroupId: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  ...
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "api-version" $api_version "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/providers/Microsoft.Management/managementgroups/($managementGroupId)/providers/Microsoft.Authorization/policySetDefinitions/($policySetDefinitionName)" $qp)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
...
export def "providers-microsoft-management-managementgroups-providers-microsoft-authorization-policy-set-definitions GetAtManagementGroup" [
  policySetDefinitionName: string
  managementGroupId: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
...
export def "providers-microsoft-management-managementgroups-providers-microsoft-authorization-policy-set-definitions CreateOrUpdateAtManagementGroup" [
  policySetDefinitionName: string
  managementGroupId: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
...
export def "subscriptions-providers-microsoft-authorization-policy-set-definitions List" [
  ...
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "api-version" $api_version "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/subscriptions/($subscriptionId)/providers/Microsoft.Authorization/policySetDefinitions" $qp)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "get" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json"
}
...
export def "subscriptions-providers-microsoft-authorization-policy-set-definitions Delete" [
  ...
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "api-version" $api_version "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/subscriptions/($subscriptionId)/providers/Microsoft.Authorization/policySetDefinitions/($policySetDefinitionName)" $qp)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "delete" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json"
}
...
# --properties shape: {description?: string, displayName?: string, metadata?: record, parameters?: record, policyDefinitions: list, policyType?: "NotSpecified"|"BuiltIn"|"Custom"}
export def "subscriptions-providers-microsoft-authorization-policy-set-definitions CreateOrUpdate" [
  policySetDefinitionName: string
  subscriptionId: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
