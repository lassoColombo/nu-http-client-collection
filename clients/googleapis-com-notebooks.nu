# Auto-generated client for Notebooks API vv2
# Source: https://api.apis.guru/v2/specs/googleapis.com/notebooks/v2/openapi.json
# Auth: --token flag or $env.NOTEBOOKS_API_TOKEN
...
def build-auth [token?: string, auth_scheme?: string]: nothing -> record {
  let token_val = if ($token | is-not-empty) { $token } else { $env | get -o NOTEBOOKS_API_TOKEN | default "" }
...
def base-url-completer [] { ["https://notebooks.googleapis.com"] }
...
export def "projects delete" [
  ...
  let auth = (merge-auth [(build-auth ($token_oauth2 | default ($env | get -o NOTEBOOKS_API_OAUTH2_TOKEN | default "")) "bearer") (build-auth ($token_oauth2c | default ($env | get -o NOTEBOOKS_API_OAUTH2C_TOKEN | default "")) "bearer")])
