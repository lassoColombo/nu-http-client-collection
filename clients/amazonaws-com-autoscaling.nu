...
def build-auth [token?: string, auth_scheme?: string]: nothing -> record {
  let token_val = if ($token | is-not-empty) { $token } else { $env | get -o AUTO_SCALING_TOKEN | default "" }
...
export def "api get-attach-instances" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"InstanceIds": $instance_ids, "AutoScalingGroupName": $auto_scaling_group_name, "Action": $action, "Version": $version} | compact)
...
export def "api get-attach-load-balancer-target-groups" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"AutoScalingGroupName": $auto_scaling_group_name, "TargetGroupARNs": $target_group_ar_ns, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-attach-load-balancers" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"AutoScalingGroupName": $auto_scaling_group_name, "LoadBalancerNames": $load_balancer_names, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-attach-traffic-sources" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"AutoScalingGroupName": $auto_scaling_group_name, "TrafficSources": $traffic_sources, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-batch-delete-scheduled-action" [
  ...
  --x-amz-signature: string
  --x-amz-signed-headers: string
]: nothing -> record<FailedScheduledActions: record> {
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"AutoScalingGroupName": $auto_scaling_group_name, "ScheduledActionNames": $scheduled_action_names, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api create-batch-delete-scheduled-action" [
  ...
  --x-amz-signed-headers: string
  --body: any
]: any -> record<FailedScheduledActions: record> {
  let input = $in
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "Action" $action "scalar") (serialize-qp "Version" $version "scalar")] | flatten | str join "&"
...
export def "api get-batch-update-scheduled-group-action" [
  ...
  --x-amz-signature: string
  --x-amz-signed-headers: string
]: nothing -> record<FailedScheduledUpdateGroupActions: record> {
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"AutoScalingGroupName": $auto_scaling_group_name, "ScheduledUpdateGroupActions": $scheduled_update_group_actions, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api create-batch-update-scheduled-group-action" [
  ...
  --x-amz-signed-headers: string
  --body: any
]: any -> record<FailedScheduledUpdateGroupActions: record> {
  let input = $in
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "Action" $action "scalar") (serialize-qp "Version" $version "scalar")] | flatten | str join "&"
...
export def "api get-cancel-instance-refresh" [
  ...
  --x-amz-signature: string
  --x-amz-signed-headers: string
]: nothing -> record<InstanceRefreshId: record> {
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"AutoScalingGroupName": $auto_scaling_group_name, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api create-cancel-instance-refresh" [
  ...
  --x-amz-signed-headers: string
  --body: any
]: any -> record<InstanceRefreshId: record> {
  let input = $in
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "Action" $action "scalar") (serialize-qp "Version" $version "scalar")] | flatten | str join "&"
...
export def "api get-complete-lifecycle-action" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"LifecycleHookName": $lifecycle_hook_name, "AutoScalingGroupName": $auto_scaling_group_name, "LifecycleActionToken": $lifecycle_action_token, "LifecycleActionResult": $lifecycle_action_result, "InstanceId": $instance_id, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-create-launch-configuration" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"LaunchConfigurationName": $launch_configuration_name, "ImageId": $image_id, "KeyName": $key_name, "SecurityGroups": $security_groups, "ClassicLinkVPCId": $classic_link_vpc_id, "ClassicLinkVPCSecurityGroups": $classic_link_vpc_security_groups, "UserData": $user_data, "InstanceId": $instance_id, "InstanceType": $instance_type, "KernelId": $kernel_id, "RamdiskId": $ramdisk_id, "BlockDeviceMappings": $block_device_mappings, "InstanceMonitoring": $instance_monitoring, "SpotPrice": $spot_price, "IamInstanceProfile": $iam_instance_profile, "EbsOptimized": $ebs_optimized, "AssociatePublicIpAddress": $associate_public_ip_address, "PlacementTenancy": $placement_tenancy, "MetadataOptions": $metadata_options, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-create-or-update-tags" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"Tags": $tags, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-delete-auto-scaling-group" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"AutoScalingGroupName": $auto_scaling_group_name, "ForceDelete": $force_delete, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-delete-launch-configuration" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"LaunchConfigurationName": $launch_configuration_name, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-delete-lifecycle-hook" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"LifecycleHookName": $lifecycle_hook_name, "AutoScalingGroupName": $auto_scaling_group_name, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-delete-notification-configuration" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"AutoScalingGroupName": $auto_scaling_group_name, "TopicARN": $topic_arn, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-delete-policy" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"AutoScalingGroupName": $auto_scaling_group_name, "PolicyName": $policy_name, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-delete-scheduled-action" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"AutoScalingGroupName": $auto_scaling_group_name, "ScheduledActionName": $scheduled_action_name, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-account-limits" [
  ...
  --x-amz-signature: string
  --x-amz-signed-headers: string
]: nothing -> record<MaxNumberOfAutoScalingGroups: record, MaxNumberOfLaunchConfigurations: record, NumberOfAutoScalingGroups: record, NumberOfLaunchConfigurations: record> {
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "Action" $action "scalar") (serialize-qp "Version" $version "scalar")] | flatten | str join "&"
  let full_url = (build-url $base "/" $qp $auth.query)
...
export def "api get-adjustment-types" [
  ...
  --x-amz-signature: string
  --x-amz-signed-headers: string
]: nothing -> record<AdjustmentTypes: record> {
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "Action" $action "scalar") (serialize-qp "Version" $version "scalar")] | flatten | str join "&"
  let full_url = (build-url $base "/" $qp $auth.query)
...
export def "api get-auto-scaling-groups" [
  ...
  --x-amz-signature: string
  --x-amz-signed-headers: string
]: nothing -> record<AutoScalingGroups: record, NextToken: record> {
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"AutoScalingGroupNames": $auto_scaling_group_names, "NextToken": $next_token, "MaxRecords": $max_records, "Filters": $filters, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api create-get-auto-scaling-groups" [
  ...
  --x-amz-signed-headers: string
  --body: any
]: any -> record<AutoScalingGroups: record, NextToken: record> {
  let input = $in
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
...
export def "api get-auto-scaling-instances" [
  ...
  --x-amz-signature: string
  --x-amz-signed-headers: string
]: nothing -> record<AutoScalingInstances: record, NextToken: record> {
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"InstanceIds": $instance_ids, "MaxRecords": $max_records, "NextToken": $next_token, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api create-get-auto-scaling-instances" [
  ...
  --x-amz-signed-headers: string
  --body: any
]: any -> record<AutoScalingInstances: record, NextToken: record> {
  let input = $in
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "MaxRecords" $max_records "scalar") (serialize-qp "NextToken" $next_token "scalar") (serialize-qp "Action" $action "scalar") (serialize-qp "Version" $version "scalar")] | flatten | str join "&"
...
export def "api get-auto-scaling-notification-types" [
  ...
  --x-amz-signature: string
  --x-amz-signed-headers: string
]: nothing -> record<AutoScalingNotificationTypes: record> {
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "Action" $action "scalar") (serialize-qp "Version" $version "scalar")] | flatten | str join "&"
  let full_url = (build-url $base "/" $qp $auth.query)
...
export def "api get-instance-refreshes" [
  ...
  --x-amz-signature: string
  --x-amz-signed-headers: string
]: nothing -> record<InstanceRefreshes: record, NextToken: record> {
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"AutoScalingGroupName": $auto_scaling_group_name, "InstanceRefreshIds": $instance_refresh_ids, "NextToken": $next_token, "MaxRecords": $max_records, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api create-get-instance-refreshes" [
  ...
  --x-amz-signed-headers: string
  --body: any
]: any -> record<InstanceRefreshes: record, NextToken: record> {
  let input = $in
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "Action" $action "scalar") (serialize-qp "Version" $version "scalar")] | flatten | str join "&"
...
export def "api get-launch-configurations" [
  ...
  --x-amz-signature: string
  --x-amz-signed-headers: string
]: nothing -> record<LaunchConfigurations: record, NextToken: record> {
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"LaunchConfigurationNames": $launch_configuration_names, "NextToken": $next_token, "MaxRecords": $max_records, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api create-get-launch-configurations" [
  ...
  --x-amz-signed-headers: string
  --body: any
]: any -> record<LaunchConfigurations: record, NextToken: record> {
  let input = $in
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "MaxRecords" $max_records "scalar") (serialize-qp "NextToken" $next_token "scalar") (serialize-qp "Action" $action "scalar") (serialize-qp "Version" $version "scalar")] | flatten | str join "&"
...
export def "api get-lifecycle-hook-types" [
  ...
  --x-amz-signature: string
  --x-amz-signed-headers: string
]: nothing -> record<LifecycleHookTypes: record> {
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "Action" $action "scalar") (serialize-qp "Version" $version "scalar")] | flatten | str join "&"
  let full_url = (build-url $base "/" $qp $auth.query)
...
export def "api get-lifecycle-hooks" [
  ...
  --x-amz-signature: string
  --x-amz-signed-headers: string
]: nothing -> record<LifecycleHooks: record> {
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"AutoScalingGroupName": $auto_scaling_group_name, "LifecycleHookNames": $lifecycle_hook_names, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api create-get-lifecycle-hooks" [
  ...
  --x-amz-signed-headers: string
  --body: any
]: any -> record<LifecycleHooks: record> {
  let input = $in
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "Action" $action "scalar") (serialize-qp "Version" $version "scalar")] | flatten | str join "&"
...
export def "api get-load-balancer-target-groups" [
  ...
  --x-amz-signature: string
  --x-amz-signed-headers: string
]: nothing -> record<LoadBalancerTargetGroups: record, NextToken: record> {
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"AutoScalingGroupName": $auto_scaling_group_name, "NextToken": $next_token, "MaxRecords": $max_records, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api create-get-load-balancer-target-groups" [
  ...
  --x-amz-signed-headers: string
  --body: any
]: any -> record<LoadBalancerTargetGroups: record, NextToken: record> {
  let input = $in
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "Action" $action "scalar") (serialize-qp "Version" $version "scalar")] | flatten | str join "&"
...
export def "api get-load-balancers" [
  ...
  --x-amz-signature: string
  --x-amz-signed-headers: string
]: nothing -> record<LoadBalancers: record, NextToken: record> {
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "AutoScalingGroupName" $auto_scaling_group_name "scalar") (serialize-qp "NextToken" $next_token "scalar") (serialize-qp "MaxRecords" $max_records "scalar") (serialize-qp "Action" $action "scalar") (serialize-qp "Version" $version "scalar")] | flatten | str join "&"
  let full_url = (build-url $base "/" $qp $auth.query)
...
export def "api create-get-load-balancers" [
  ...
  --x-amz-signed-headers: string
  --body: any
]: any -> record<LoadBalancers: record, NextToken: record> {
  let input = $in
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "Action" $action "scalar") (serialize-qp "Version" $version "scalar")] | flatten | str join "&"
...
export def "api get-metric-collection-types" [
  ...
  --x-amz-signature: string
  --x-amz-signed-headers: string
]: nothing -> record<Metrics: record, Granularities: record> {
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "Action" $action "scalar") (serialize-qp "Version" $version "scalar")] | flatten | str join "&"
  let full_url = (build-url $base "/" $qp $auth.query)
...
export def "api get-notification-configurations" [
  ...
  --x-amz-signature: string
  --x-amz-signed-headers: string
]: nothing -> record<NotificationConfigurations: record, NextToken: record> {
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"AutoScalingGroupNames": $auto_scaling_group_names, "NextToken": $next_token, "MaxRecords": $max_records, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api create-get-notification-configurations" [
  ...
  --x-amz-signed-headers: string
  --body: any
]: any -> record<NotificationConfigurations: record, NextToken: record> {
  let input = $in
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "MaxRecords" $max_records "scalar") (serialize-qp "NextToken" $next_token "scalar") (serialize-qp "Action" $action "scalar") (serialize-qp "Version" $version "scalar")] | flatten | str join "&"
...
export def "api get-policies" [
  ...
  --x-amz-signature: string
  --x-amz-signed-headers: string
]: nothing -> record<ScalingPolicies: record, NextToken: record> {
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"AutoScalingGroupName": $auto_scaling_group_name, "PolicyNames": $policy_names, "PolicyTypes": $policy_types, "NextToken": $next_token, "MaxRecords": $max_records, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-scaling-activities" [
  ...
  --x-amz-signature: string
  --x-amz-signed-headers: string
]: nothing -> record<Activities: record, NextToken: record> {
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"ActivityIds": $activity_ids, "AutoScalingGroupName": $auto_scaling_group_name, "IncludeDeletedGroups": $include_deleted_groups, "MaxRecords": $max_records, "NextToken": $next_token, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-scaling-process-types" [
  ...
  --x-amz-signature: string
  --x-amz-signed-headers: string
]: nothing -> record<Processes: record> {
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "Action" $action "scalar") (serialize-qp "Version" $version "scalar")] | flatten | str join "&"
  let full_url = (build-url $base "/" $qp $auth.query)
...
export def "api get-scheduled-actions" [
  ...
  --x-amz-signature: string
  --x-amz-signed-headers: string
]: nothing -> record<ScheduledUpdateGroupActions: record, NextToken: record> {
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"AutoScalingGroupName": $auto_scaling_group_name, "ScheduledActionNames": $scheduled_action_names, "StartTime": $start_time, "EndTime": $end_time, "NextToken": $next_token, "MaxRecords": $max_records, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api create-get-scheduled-actions" [
  ...
  --x-amz-signed-headers: string
  --body: any
]: any -> record<ScheduledUpdateGroupActions: record, NextToken: record> {
  let input = $in
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "MaxRecords" $max_records "scalar") (serialize-qp "NextToken" $next_token "scalar") (serialize-qp "Action" $action "scalar") (serialize-qp "Version" $version "scalar")] | flatten | str join "&"
...
export def "api get-tags" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"Filters": $filters, "NextToken": $next_token, "MaxRecords": $max_records, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-termination-policy-types" [
  ...
  --x-amz-signature: string
  --x-amz-signed-headers: string
]: nothing -> record<TerminationPolicyTypes: record> {
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "Action" $action "scalar") (serialize-qp "Version" $version "scalar")] | flatten | str join "&"
  let full_url = (build-url $base "/" $qp $auth.query)
...
export def "api get-traffic-sources" [
  ...
  --x-amz-signature: string
  --x-amz-signed-headers: string
]: nothing -> record<TrafficSources: record, NextToken: record> {
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"AutoScalingGroupName": $auto_scaling_group_name, "TrafficSourceType": $traffic_source_type, "NextToken": $next_token, "MaxRecords": $max_records, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api create-get-traffic-sources" [
  ...
  --x-amz-signed-headers: string
  --body: any
]: any -> record<TrafficSources: record, NextToken: record> {
  let input = $in
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "MaxRecords" $max_records "scalar") (serialize-qp "NextToken" $next_token "scalar") (serialize-qp "Action" $action "scalar") (serialize-qp "Version" $version "scalar")] | flatten | str join "&"
...
export def "api get-warm-pool" [
  ...
  --x-amz-signature: string
  --x-amz-signed-headers: string
]: nothing -> record<WarmPoolConfiguration: record<MaxGroupPreparedCapacity: record, MinSize: record, PoolState: record, Status: record, InstanceReusePolicy: record<ReuseOnScaleIn: record>>, Instances: record, NextToken: record> {
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"AutoScalingGroupName": $auto_scaling_group_name, "MaxRecords": $max_records, "NextToken": $next_token, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api create-get-warm-pool" [
  ...
  --x-amz-signed-headers: string
  --body: any
]: any -> record<WarmPoolConfiguration: record<MaxGroupPreparedCapacity: record, MinSize: record, PoolState: record, Status: record, InstanceReusePolicy: record<ReuseOnScaleIn: record>>, Instances: record, NextToken: record> {
  let input = $in
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "Action" $action "scalar") (serialize-qp "Version" $version "scalar")] | flatten | str join "&"
...
export def "api get-detach-instances" [
  ...
  --x-amz-signature: string
  --x-amz-signed-headers: string
]: nothing -> record<Activities: record> {
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"InstanceIds": $instance_ids, "AutoScalingGroupName": $auto_scaling_group_name, "ShouldDecrementDesiredCapacity": $should_decrement_desired_capacity, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-disable-metrics-collection" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"AutoScalingGroupName": $auto_scaling_group_name, "Metrics": $metrics, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-enable-metrics-collection" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"AutoScalingGroupName": $auto_scaling_group_name, "Metrics": $metrics, "Granularity": $granularity, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-execute-policy" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"AutoScalingGroupName": $auto_scaling_group_name, "PolicyName": $policy_name, "HonorCooldown": $honor_cooldown, "MetricValue": $metric_value, "BreachThreshold": $breach_threshold, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-predictive-scaling-forecast" [
  ...
  --x-amz-signature: string
  --x-amz-signed-headers: string
]: nothing -> record<LoadForecast: record, CapacityForecast: record<Timestamps: record, Values: record>, UpdateTime: record> {
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"AutoScalingGroupName": $auto_scaling_group_name, "PolicyName": $policy_name, "StartTime": $start_time, "EndTime": $end_time, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api create-get-predictive-scaling-forecast" [
  ...
  --x-amz-signed-headers: string
  --body: any
]: any -> record<LoadForecast: record, CapacityForecast: record<Timestamps: record, Values: record>, UpdateTime: record> {
  let input = $in
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "Action" $action "scalar") (serialize-qp "Version" $version "scalar")] | flatten | str join "&"
...
export def "api get-update-lifecycle-hook" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"LifecycleHookName": $lifecycle_hook_name, "AutoScalingGroupName": $auto_scaling_group_name, "LifecycleTransition": $lifecycle_transition, "RoleARN": $role_arn, "NotificationTargetARN": $notification_target_arn, "NotificationMetadata": $notification_metadata, "HeartbeatTimeout": $heartbeat_timeout, "DefaultResult": $default_result, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-update-notification-configuration" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"AutoScalingGroupName": $auto_scaling_group_name, "TopicARN": $topic_arn, "NotificationTypes": $notification_types, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-update-scaling-policy" [
  ...
  --x-amz-signature: string
  --x-amz-signed-headers: string
]: nothing -> record<PolicyARN: record, Alarms: record> {
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
...
export def "api get-update-scheduled-group-action" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"AutoScalingGroupName": $auto_scaling_group_name, "ScheduledActionName": $scheduled_action_name, "Time": $time, "StartTime": $start_time, "EndTime": $end_time, "Recurrence": $recurrence, "MinSize": $min_size, "MaxSize": $max_size, "DesiredCapacity": $desired_capacity, "TimeZone": $time_zone, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-update-warm-pool" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"AutoScalingGroupName": $auto_scaling_group_name, "MaxGroupPreparedCapacity": $max_group_prepared_capacity, "MinSize": $min_size, "PoolState": $pool_state, "InstanceReusePolicy": $instance_reuse_policy, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-record-lifecycle-action-heartbeat" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"LifecycleHookName": $lifecycle_hook_name, "AutoScalingGroupName": $auto_scaling_group_name, "LifecycleActionToken": $lifecycle_action_token, "InstanceId": $instance_id, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-resume-processes" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"AutoScalingGroupName": $auto_scaling_group_name, "ScalingProcesses": $scaling_processes, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-update-desired-capacity" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"AutoScalingGroupName": $auto_scaling_group_name, "DesiredCapacity": $desired_capacity, "HonorCooldown": $honor_cooldown, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-update-instance-health" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"InstanceId": $instance_id, "HealthStatus": $health_status, "ShouldRespectGracePeriod": $should_respect_grace_period, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-update-instance-protection" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"InstanceIds": $instance_ids, "AutoScalingGroupName": $auto_scaling_group_name, "ProtectedFromScaleIn": $protected_from_scale_in, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-start-instance-refresh" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"AutoScalingGroupName": $auto_scaling_group_name, "Strategy": $strategy, "DesiredConfiguration": $desired_configuration, "Preferences": $preferences, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-terminate-instance-in-auto-scaling-group" [
  ...
  --x-amz-signature: string
  --x-amz-signed-headers: string
]: nothing -> record<Activity: record<ActivityId: record, AutoScalingGroupName: record, Description: record, Cause: record, StartTime: record, EndTime: record, StatusCode: record, StatusMessage: record, Progress: record, Details: record, AutoScalingGroupState: record, AutoScalingGroupARN: record>> {
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"InstanceId": $instance_id, "ShouldDecrementDesiredCapacity": $should_decrement_desired_capacity, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api create-terminate-instance-in-auto-scaling-group" [
  ...
  --x-amz-signed-headers: string
  --body: any
]: any -> record<Activity: record<ActivityId: record, AutoScalingGroupName: record, Description: record, Cause: record, StartTime: record, EndTime: record, StatusCode: record, StatusMessage: record, Progress: record, Details: record, AutoScalingGroupState: record, AutoScalingGroupARN: record>> {
  let input = $in
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "Action" $action "scalar") (serialize-qp "Version" $version "scalar")] | flatten | str join "&"
