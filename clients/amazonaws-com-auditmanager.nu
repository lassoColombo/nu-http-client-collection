...
export def "assessments-associate-to-assessment-report update-evidence-folder" [
  ...
  let full_url = (build-url $base ({assessment_id: (encode-path-segment $assessment_id)} | format pattern "/assessments/{assessment_id}/associateToAssessmentReport"))
...
export def "assessments-batch-associate-to-assessment-report update-evidence" [
  ...
  let base = ($base_url | default $BASE_URL)
  if ($assessment_id | is-empty) { error make --unspanned { msg: "path parameter 'assessmentId' must be non-empty" } }
  let full_url = (build-url $base ({assessment_id: (encode-path-segment $assessment_id)} | format pattern "/assessments/{assessment_id}/batchAssociateToAssessmentReport"))
...
export def "assessments-delegations create-batch" [
  ...
  let base = ($base_url | default $BASE_URL)
  if ($assessment_id | is-empty) { error make --unspanned { msg: "path parameter 'assessmentId' must be non-empty" } }
  let full_url = (build-url $base ({assessment_id: (encode-path-segment $assessment_id)} | format pattern "/assessments/{assessment_id}/delegations"))
...
export def "assessments-batch-disassociate-from-assessment-report update-evidence" [
  ...
  let base = ($base_url | default $BASE_URL)
  if ($assessment_id | is-empty) { error make --unspanned { msg: "path parameter 'assessmentId' must be non-empty" } }
  let full_url = (build-url $base ({assessment_id: (encode-path-segment $assessment_id)} | format pattern "/assessments/{assessment_id}/batchDisassociateFromAssessmentReport"))
  let req_body = {"evidenceFolderId": $evidence_folder_id, "evidenceIds": $evidence_ids} | compact
  let req_body = if ($input | describe | str starts-with "record") { $input | merge deep ($req_body | default {}) } else { $req_body }
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
...
export def "assessments-control-sets-controls-evidence import-batch" [
  ...
  let full_url = (build-url $base ({assessment_id: (encode-path-segment $assessment_id), control_set_id: (encode-path-segment $control_set_id), control_id: (encode-path-segment $control_id)} | format pattern "/assessments/{assessment_id}/controlSets/{control_set_id}/controls/{control_id}/evidence"))
...
export def "assessments-reports create" [
  ...
  let base = ($base_url | default $BASE_URL)
  if ($assessment_id | is-empty) { error make --unspanned { msg: "path parameter 'assessmentId' must be non-empty" } }
  let full_url = (build-url $base ({assessment_id: (encode-path-segment $assessment_id)} | format pattern "/assessments/{assessment_id}/reports"))
...
export def "assessments delete" [
  ...
  let base = ($base_url | default $BASE_URL)
  if ($assessment_id | is-empty) { error make --unspanned { msg: "path parameter 'assessmentId' must be non-empty" } }
  let full_url = (build-url $base ({assessment_id: (encode-path-segment $assessment_id)} | format pattern "/assessments/{assessment_id}"))
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let extra_headers = {"X-Amz-Content-Sha256": $x_amz_content_sha256, "X-Amz-Date": $x_amz_date, "X-Amz-Algorithm": $x_amz_algorithm, "X-Amz-Credential": $x_amz_credential, "X-Amz-Security-Token": $x_amz_security_token, "X-Amz-Signature": $x_amz_signature, "X-Amz-SignedHeaders": $x_amz_signed_headers} | compact
  let auth = ($auth | update headers ($auth.headers | merge $extra_headers))
...
export def "assessment-frameworks delete" [
  ...
  let full_url = (build-url $base ({framework_id: (encode-path-segment $framework_id)} | format pattern "/assessmentFrameworks/{framework_id}"))
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let extra_headers = {"X-Amz-Content-Sha256": $x_amz_content_sha256, "X-Amz-Date": $x_amz_date, "X-Amz-Algorithm": $x_amz_algorithm, "X-Amz-Credential": $x_amz_credential, "X-Amz-Security-Token": $x_amz_security_token, "X-Amz-Signature": $x_amz_signature, "X-Amz-SignedHeaders": $x_amz_signed_headers} | compact
  let auth = ($auth | update headers ($auth.headers | merge $extra_headers))
...
export def "assessment-framework-share-requests delete" [
  ...
  let full_url = (build-url $base ({request_id: (encode-path-segment $request_id)} | format pattern "/assessmentFrameworkShareRequests/{request_id}") $qp)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let extra_headers = {"X-Amz-Content-Sha256": $x_amz_content_sha256, "X-Amz-Date": $x_amz_date, "X-Amz-Algorithm": $x_amz_algorithm, "X-Amz-Credential": $x_amz_credential, "X-Amz-Security-Token": $x_amz_security_token, "X-Amz-Signature": $x_amz_signature, "X-Amz-SignedHeaders": $x_amz_signed_headers} | compact
  let auth = ($auth | update headers ($auth.headers | merge $extra_headers))
  do-request "delete" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors $full "application/json" null {query: ({"requestType": $request_type} | compact), body: null}
}
...
export def "assessments-reports delete" [
  ...
  let full_url = (build-url $base ({assessment_id: (encode-path-segment $assessment_id), assessment_report_id: (encode-path-segment $assessment_report_id)} | format pattern "/assessments/{assessment_id}/reports/{assessment_report_id}"))
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let extra_headers = {"X-Amz-Content-Sha256": $x_amz_content_sha256, "X-Amz-Date": $x_amz_date, "X-Amz-Algorithm": $x_amz_algorithm, "X-Amz-Credential": $x_amz_credential, "X-Amz-Security-Token": $x_amz_security_token, "X-Amz-Signature": $x_amz_signature, "X-Amz-SignedHeaders": $x_amz_signed_headers} | compact
  let auth = ($auth | update headers ($auth.headers | merge $extra_headers))
...
export def "controls delete" [
  ...
  let base = ($base_url | default $BASE_URL)
  if ($control_id | is-empty) { error make --unspanned { msg: "path parameter 'controlId' must be non-empty" } }
  let full_url = (build-url $base ({control_id: (encode-path-segment $control_id)} | format pattern "/controls/{control_id}"))
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let extra_headers = {"X-Amz-Content-Sha256": $x_amz_content_sha256, "X-Amz-Date": $x_amz_date, "X-Amz-Algorithm": $x_amz_algorithm, "X-Amz-Credential": $x_amz_credential, "X-Amz-Security-Token": $x_amz_security_token, "X-Amz-Signature": $x_amz_signature, "X-Amz-SignedHeaders": $x_amz_signed_headers} | compact
  let auth = ($auth | update headers ($auth.headers | merge $extra_headers))
...
export def "assessments-disassociate-from-assessment-report update-evidence-folder" [
  ...
  let base = ($base_url | default $BASE_URL)
  if ($assessment_id | is-empty) { error make --unspanned { msg: "path parameter 'assessmentId' must be non-empty" } }
  let full_url = (build-url $base ({assessment_id: (encode-path-segment $assessment_id)} | format pattern "/assessments/{assessment_id}/disassociateFromAssessmentReport"))
  let req_body = {"evidenceFolderId": $evidence_folder_id} | compact
  let req_body = if ($input | describe | str starts-with "record") { $input | merge deep ($req_body | default {}) } else { $req_body }
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
...
export def "assessments-reports-url get" [
  ...
  if ($assessment_id | is-empty) { error make --unspanned { msg: "path parameter 'assessmentId' must be non-empty" } }
  if ($assessment_report_id | is-empty) { error make --unspanned { msg: "path parameter 'assessmentReportId' must be non-empty" } }
  let full_url = (build-url $base ({assessment_id: (encode-path-segment $assessment_id), assessment_report_id: (encode-path-segment $assessment_report_id)} | format pattern "/assessments/{assessment_id}/reports/{assessment_report_id}/url"))
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let extra_headers = {"X-Amz-Content-Sha256": $x_amz_content_sha256, "X-Amz-Date": $x_amz_date, "X-Amz-Algorithm": $x_amz_algorithm, "X-Amz-Credential": $x_amz_credential, "X-Amz-Security-Token": $x_amz_security_token, "X-Amz-Signature": $x_amz_signature, "X-Amz-SignedHeaders": $x_amz_signed_headers} | compact
  let auth = ($auth | update headers ($auth.headers | merge $extra_headers))
...
export def "assessments-changelogs get-change-logs" [
  ...
  let full_url = (build-url $base ({assessment_id: (encode-path-segment $assessment_id)} | format pattern "/assessments/{assessment_id}/changelogs") $qp)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let extra_headers = {"X-Amz-Content-Sha256": $x_amz_content_sha256, "X-Amz-Date": $x_amz_date, "X-Amz-Algorithm": $x_amz_algorithm, "X-Amz-Credential": $x_amz_credential, "X-Amz-Security-Token": $x_amz_security_token, "X-Amz-Signature": $x_amz_signature, "X-Amz-SignedHeaders": $x_amz_signed_headers} | compact
  let auth = ($auth | update headers ($auth.headers | merge $extra_headers))
  do-request "get" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors $full "application/json" null {query: ({"controlSetId": $control_set_id, "controlId": $control_id, "nextToken": $next_token, "maxResults": $max_results} | compact), body: null}
}
...
export def "assessments-control-sets-evidence-folders-evidence list" [
  ...
  if ($evidence_folder_id | is-empty) { error make --unspanned { msg: "path parameter 'evidenceFolderId' must be non-empty" } }
  let qp = [(serialize-qp "nextToken" $next_token "scalar") (serialize-qp "maxResults" $max_results "scalar")] | flatten | str join "&"
  let full_url = (build-url $base ({assessment_id: (encode-path-segment $assessment_id), control_set_id: (encode-path-segment $control_set_id), evidence_folder_id: (encode-path-segment $evidence_folder_id)} | format pattern "/assessments/{assessment_id}/controlSets/{control_set_id}/evidenceFolders/{evidence_folder_id}/evidence") $qp)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let extra_headers = {"X-Amz-Content-Sha256": $x_amz_content_sha256, "X-Amz-Date": $x_amz_date, "X-Amz-Algorithm": $x_amz_algorithm, "X-Amz-Credential": $x_amz_credential, "X-Amz-Security-Token": $x_amz_security_token, "X-Amz-Signature": $x_amz_signature, "X-Amz-SignedHeaders": $x_amz_signed_headers} | compact
  let auth = ($auth | update headers ($auth.headers | merge $extra_headers))
...
export def "assessments-control-sets-evidence-folders get" [
  ...
  if ($control_set_id | is-empty) { error make --unspanned { msg: "path parameter 'controlSetId' must be non-empty" } }
  if ($evidence_folder_id | is-empty) { error make --unspanned { msg: "path parameter 'evidenceFolderId' must be non-empty" } }
  let full_url = (build-url $base ({assessment_id: (encode-path-segment $assessment_id), control_set_id: (encode-path-segment $control_set_id), evidence_folder_id: (encode-path-segment $evidence_folder_id)} | format pattern "/assessments/{assessment_id}/controlSets/{control_set_id}/evidenceFolders/{evidence_folder_id}"))
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let extra_headers = {"X-Amz-Content-Sha256": $x_amz_content_sha256, "X-Amz-Date": $x_amz_date, "X-Amz-Algorithm": $x_amz_algorithm, "X-Amz-Credential": $x_amz_credential, "X-Amz-Security-Token": $x_amz_security_token, "X-Amz-Signature": $x_amz_signature, "X-Amz-SignedHeaders": $x_amz_signed_headers} | compact
  let auth = ($auth | update headers ($auth.headers | merge $extra_headers))
...
export def "assessments-evidence-folders get" [
  ...
  if ($assessment_id | is-empty) { error make --unspanned { msg: "path parameter 'assessmentId' must be non-empty" } }
  let qp = [(serialize-qp "nextToken" $next_token "scalar") (serialize-qp "maxResults" $max_results "scalar")] | flatten | str join "&"
  let full_url = (build-url $base ({assessment_id: (encode-path-segment $assessment_id)} | format pattern "/assessments/{assessment_id}/evidenceFolders") $qp)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let extra_headers = {"X-Amz-Content-Sha256": $x_amz_content_sha256, "X-Amz-Date": $x_amz_date, "X-Amz-Algorithm": $x_amz_algorithm, "X-Amz-Credential": $x_amz_credential, "X-Amz-Security-Token": $x_amz_security_token, "X-Amz-Signature": $x_amz_signature, "X-Amz-SignedHeaders": $x_amz_signed_headers} | compact
  let auth = ($auth | update headers ($auth.headers | merge $extra_headers))
...
export def "assessments-evidence-folders-by-assessment-control get" [
  ...
  if ($control_id | is-empty) { error make --unspanned { msg: "path parameter 'controlId' must be non-empty" } }
  let qp = [(serialize-qp "nextToken" $next_token "scalar") (serialize-qp "maxResults" $max_results "scalar")] | flatten | str join "&"
  let full_url = (build-url $base ({assessment_id: (encode-path-segment $assessment_id), control_set_id: (encode-path-segment $control_set_id), control_id: (encode-path-segment $control_id)} | format pattern "/assessments/{assessment_id}/evidenceFolders-by-assessment-control/{control_set_id}/{control_id}") $qp)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let extra_headers = {"X-Amz-Content-Sha256": $x_amz_content_sha256, "X-Amz-Date": $x_amz_date, "X-Amz-Algorithm": $x_amz_algorithm, "X-Amz-Credential": $x_amz_credential, "X-Amz-Security-Token": $x_amz_security_token, "X-Amz-Signature": $x_amz_signature, "X-Amz-SignedHeaders": $x_amz_signed_headers} | compact
  let auth = ($auth | update headers ($auth.headers | merge $extra_headers))
...
export def "insights-assessments get" [
  ...
  let base = ($base_url | default $BASE_URL)
  if ($assessment_id | is-empty) { error make --unspanned { msg: "path parameter 'assessmentId' must be non-empty" } }
  let full_url = (build-url $base ({assessment_id: (encode-path-segment $assessment_id)} | format pattern "/insights/assessments/{assessment_id}"))
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let extra_headers = {"X-Amz-Content-Sha256": $x_amz_content_sha256, "X-Amz-Date": $x_amz_date, "X-Amz-Algorithm": $x_amz_algorithm, "X-Amz-Credential": $x_amz_credential, "X-Amz-Security-Token": $x_amz_security_token, "X-Amz-Signature": $x_amz_signature, "X-Amz-SignedHeaders": $x_amz_signed_headers} | compact
  let auth = ($auth | update headers ($auth.headers | merge $extra_headers))
...
export def "settings get" [
  ...
  let full_url = (build-url $base ({attribute: (encode-path-segment $attribute)} | format pattern "/settings/{attribute}"))
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let extra_headers = {"X-Amz-Content-Sha256": $x_amz_content_sha256, "X-Amz-Date": $x_amz_date, "X-Amz-Algorithm": $x_amz_algorithm, "X-Amz-Credential": $x_amz_credential, "X-Amz-Security-Token": $x_amz_security_token, "X-Amz-Signature": $x_amz_signature, "X-Amz-SignedHeaders": $x_amz_signed_headers} | compact
  let auth = ($auth | update headers ($auth.headers | merge $extra_headers))
...
export def "insights-controls-by-assessment list-domain" [
  ...
  let full_url = (build-url $base "/insights/controls-by-assessment" $qp)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let extra_headers = {"X-Amz-Content-Sha256": $x_amz_content_sha256, "X-Amz-Date": $x_amz_date, "X-Amz-Algorithm": $x_amz_algorithm, "X-Amz-Credential": $x_amz_credential, "X-Amz-Security-Token": $x_amz_security_token, "X-Amz-Signature": $x_amz_signature, "X-Amz-SignedHeaders": $x_amz_signed_headers} | compact
  let auth = ($auth | update headers ($auth.headers | merge $extra_headers))
  do-request "get" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors $full "application/json" null {query: ({"controlDomainId": $control_domain_id, "assessmentId": $assessment_id, "nextToken": $next_token, "maxResults": $max_results} | compact), body: null}
}
...
export def "assessment-framework-share-requests list" [
  ...
  let full_url = (build-url $base "/assessmentFrameworkShareRequests" $qp)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let extra_headers = {"X-Amz-Content-Sha256": $x_amz_content_sha256, "X-Amz-Date": $x_amz_date, "X-Amz-Algorithm": $x_amz_algorithm, "X-Amz-Credential": $x_amz_credential, "X-Amz-Security-Token": $x_amz_security_token, "X-Amz-Signature": $x_amz_signature, "X-Amz-SignedHeaders": $x_amz_signed_headers} | compact
  let auth = ($auth | update headers ($auth.headers | merge $extra_headers))
  do-request "get" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors $full "application/json" null {query: ({"requestType": $request_type, "nextToken": $next_token, "maxResults": $max_results} | compact), body: null}
}
...
export def "assessment-frameworks list" [
  ...
  let full_url = (build-url $base "/assessmentFrameworks" $qp)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let extra_headers = {"X-Amz-Content-Sha256": $x_amz_content_sha256, "X-Amz-Date": $x_amz_date, "X-Amz-Algorithm": $x_amz_algorithm, "X-Amz-Credential": $x_amz_credential, "X-Amz-Security-Token": $x_amz_security_token, "X-Amz-Signature": $x_amz_signature, "X-Amz-SignedHeaders": $x_amz_signed_headers} | compact
  let auth = ($auth | update headers ($auth.headers | merge $extra_headers))
  do-request "get" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors $full "application/json" null {query: ({"frameworkType": $framework_type, "nextToken": $next_token, "maxResults": $max_results} | compact), body: null}
}
...
export def "insights-control-domains-by-assessment list" [
  ...
  let full_url = (build-url $base "/insights/control-domains-by-assessment" $qp)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let extra_headers = {"X-Amz-Content-Sha256": $x_amz_content_sha256, "X-Amz-Date": $x_amz_date, "X-Amz-Algorithm": $x_amz_algorithm, "X-Amz-Credential": $x_amz_credential, "X-Amz-Security-Token": $x_amz_security_token, "X-Amz-Signature": $x_amz_signature, "X-Amz-SignedHeaders": $x_amz_signed_headers} | compact
  let auth = ($auth | update headers ($auth.headers | merge $extra_headers))
  do-request "get" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors $full "application/json" null {query: ({"assessmentId": $assessment_id, "nextToken": $next_token, "maxResults": $max_results} | compact), body: null}
}
...
export def "insights-controls list-by-domain" [
  ...
  let full_url = (build-url $base "/insights/controls" $qp)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let extra_headers = {"X-Amz-Content-Sha256": $x_amz_content_sha256, "X-Amz-Date": $x_amz_date, "X-Amz-Algorithm": $x_amz_algorithm, "X-Amz-Credential": $x_amz_credential, "X-Amz-Security-Token": $x_amz_security_token, "X-Amz-Signature": $x_amz_signature, "X-Amz-SignedHeaders": $x_amz_signed_headers} | compact
  let auth = ($auth | update headers ($auth.headers | merge $extra_headers))
  do-request "get" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors $full "application/json" null {query: ({"controlDomainId": $control_domain_id, "nextToken": $next_token, "maxResults": $max_results} | compact), body: null}
}
...
export def "controls list" [
  ...
  let full_url = (build-url $base "/controls" $qp)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let extra_headers = {"X-Amz-Content-Sha256": $x_amz_content_sha256, "X-Amz-Date": $x_amz_date, "X-Amz-Algorithm": $x_amz_algorithm, "X-Amz-Credential": $x_amz_credential, "X-Amz-Security-Token": $x_amz_security_token, "X-Amz-Signature": $x_amz_signature, "X-Amz-SignedHeaders": $x_amz_signed_headers} | compact
  let auth = ($auth | update headers ($auth.headers | merge $extra_headers))
  do-request "get" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors $full "application/json" null {query: ({"controlType": $control_type, "nextToken": $next_token, "maxResults": $max_results} | compact), body: null}
}
...
export def "data-source-keywords list" [
  ...
  let full_url = (build-url $base "/dataSourceKeywords" $qp)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let extra_headers = {"X-Amz-Content-Sha256": $x_amz_content_sha256, "X-Amz-Date": $x_amz_date, "X-Amz-Algorithm": $x_amz_algorithm, "X-Amz-Credential": $x_amz_credential, "X-Amz-Security-Token": $x_amz_security_token, "X-Amz-Signature": $x_amz_signature, "X-Amz-SignedHeaders": $x_amz_signed_headers} | compact
  let auth = ($auth | update headers ($auth.headers | merge $extra_headers))
  do-request "get" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors $full "application/json" null {query: ({"source": $qp_source, "nextToken": $next_token, "maxResults": $max_results} | compact), body: null}
}
...
export def "assessment-frameworks-share-requests start" [
  ...
  let base = ($base_url | default $BASE_URL)
  if ($framework_id | is-empty) { error make --unspanned { msg: "path parameter 'frameworkId' must be non-empty" } }
  let full_url = (build-url $base ({framework_id: (encode-path-segment $framework_id)} | format pattern "/assessmentFrameworks/{framework_id}/shareRequests"))
...
export def "assessments-control-sets-controls update" [
  ...
  if ($control_set_id | is-empty) { error make --unspanned { msg: "path parameter 'controlSetId' must be non-empty" } }
  if ($control_id | is-empty) { error make --unspanned { msg: "path parameter 'controlId' must be non-empty" } }
  let full_url = (build-url $base ({assessment_id: (encode-path-segment $assessment_id), control_set_id: (encode-path-segment $control_set_id), control_id: (encode-path-segment $control_id)} | format pattern "/assessments/{assessment_id}/controlSets/{control_set_id}/controls/{control_id}"))
...
export def "assessments-control-sets-status update" [
  ...
  if ($assessment_id | is-empty) { error make --unspanned { msg: "path parameter 'assessmentId' must be non-empty" } }
  if ($control_set_id | is-empty) { error make --unspanned { msg: "path parameter 'controlSetId' must be non-empty" } }
  let full_url = (build-url $base ({assessment_id: (encode-path-segment $assessment_id), control_set_id: (encode-path-segment $control_set_id)} | format pattern "/assessments/{assessment_id}/controlSets/{control_set_id}/status"))
...
export def "assessment-framework-share-requests update" [
  ...
  let base = ($base_url | default $BASE_URL)
  if ($request_id | is-empty) { error make --unspanned { msg: "path parameter 'requestId' must be non-empty" } }
  let full_url = (build-url $base ({request_id: (encode-path-segment $request_id)} | format pattern "/assessmentFrameworkShareRequests/{request_id}"))
...
export def "assessments-status update" [
  ...
  let base = ($base_url | default $BASE_URL)
  if ($assessment_id | is-empty) { error make --unspanned { msg: "path parameter 'assessmentId' must be non-empty" } }
  let full_url = (build-url $base ({assessment_id: (encode-path-segment $assessment_id)} | format pattern "/assessments/{assessment_id}/status"))
