# Auto-generated client for Flight Create Orders v1.9.0
# Source: https://api.apis.guru/v2/specs/amadeus.com/amadeus-flight-create-orders/1.9.0/swagger.json
# Auth: --token flag or $env.FLIGHT_CREATE_ORDERS_TOKEN
...
def build-auth [token?: string, auth_scheme?: string]: nothing -> record {
  let token_val = if ($token != null) and ($token | is-not-empty) { $token } else { $env | get -o FLIGHT_CREATE_ORDERS_TOKEN | default "" }
...
export def "booking-flight-orders create-fligt" [
  ...
  --data: record # input parameter to create a flight order — shape: {automatedProcess?: list, contacts?: list, flightOffers: list, formOfIdentifications?: list, ownerOfficeId?: string, queuingOfficeId?: string, remarks?: record, ticketingAgreement?: record, travelers?: list, type: string}
]: any -> any {
  let input = $in
