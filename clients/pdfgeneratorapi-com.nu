...
def build-auth [token?: string, auth_scheme?: string]: nothing -> record {
  let token_val = if ($token | is-not-empty) { $token } else { $env | get -o PDF_GENERATOR_API_TOKEN | default "" }
...
export def "templates-output create-merge" [
  ...
  let full_url = (build-url $base "/templates/output" $qp $auth.query)
  let req_body = $body
  ...
  let req = {
    method: "post"
    url: $full_url
    query: ({"name": $name, "format": $format, "output": $output} | compact)
    headers: $auth.headers
    body: $req_body
    content_type: "application/json"
    timeout: ($max_time | default 30min)
...
export def "templates-template-id delete" [
  ...
  let full_url = (build-url $base "/templates/templateId" $qp $auth.query)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "delete"
    url: $full_url
    query: ({"templateId": $template_id} | compact)
    headers: $auth.headers
    body: null
    content_type: "application/json"
    timeout: ($max_time | default 30min)
...
export def "templates-template-id-copy copy" [
  ...
  let full_url = (build-url $base "/templates/templateId/copy" $qp $auth.query)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "post"
    url: $full_url
    query: ({"templateId": $template_id, "name": $name} | compact)
    headers: $auth.headers
    body: null
    content_type: "application/json"
    timeout: ($max_time | default 30min)
...
export def "templates-template-id-editor get-url" [
  ...
  let full_url = (build-url $base "/templates/templateId/editor" $qp $auth.query)
  let req_body = $body
  let req_body = if ($input | describe | str starts-with "record") { $input | merge deep ($req_body | default {}) } else { $req_body }
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "post"
    url: $full_url
    query: ({"templateId": $template_id, "language": $language} | compact)
    headers: $auth.headers
    body: $req_body
    content_type: "application/json"
    timeout: ($max_time | default 30min)
...
export def "templates-template-id-output create-merge" [
  ...
  let full_url = (build-url $base "/templates/templateId/output" $qp $auth.query)
  ...
  let req = {
    method: "post"
    url: $full_url
    query: ({"templateId": $template_id, "name": $name, "format": $format, "output": $output} | compact)
    headers: $auth.headers
    body: $req_body
    content_type: "application/json"
    timeout: ($max_time | default 30min)
...
export def "workspaces-workspace-id delete" [
  ...
  let full_url = (build-url $base "/workspaces/workspaceId" $qp $auth.query)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "delete"
    url: $full_url
    query: ({"workspaceId": $workspace_id} | compact)
    headers: $auth.headers
    body: null
    content_type: "application/json"
    timeout: ($max_time | default 30min)
