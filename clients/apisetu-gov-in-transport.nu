# Auto-generated client for Ministry of Road Transport and Highways v3.0.0
# Source: https://api.apis.guru/v2/specs/apisetu.gov.in/transport/3.0.0/openapi.json
# Auth: --token flag or $env.MINISTRY_OF_ROAD_TRANSPORT_AND_HIGHWAYS_TOKEN

const BASE_URL = "https://apisetu.gov.in/transport/v3"
const DEFAULT_AUTH = "x-apisetu-apikey"

# Build auth: returns {headers: record, query: string}
def build-auth [token?: string, auth_scheme?: string]: nothing -> record {
  let token_val = if ($token != null) and ($token | is-not-empty) { $token } else { $env | get -o MINISTRY_OF_ROAD_TRANSPORT_AND_HIGHWAYS_TOKEN | default "" }
...
def base-url-completer [] { ["https://apisetu.gov.in/transport/v3"] }
...
export def commands []: nothing -> table {
  ...
  let mod_name = (scope modules | where { $in.commands | any { $in.name == "drvlc-certificate drvlc" } } | get name | first)
...
export def "drvlc-certificate drvlc" [
  ...
  --certificate-parameters: record # shape: {DOB: string, FullName: string, UID: string, dlno: string}
...
# --consentArtifact shape: {consent: record, signature: record}
export def "fitcer-certificate fitcer" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
  ...
  --dry-run(-n) # Return the request that would be sent without executing it
  --accept: string@accept-completer # Response content type
  --certificate-parameters: record # shape: {FullName: string, UID: string, chasis_no: string, reg_no: string, swd_name: string}
  --consent-artifact: any # shape: {consent: record, signature: record}
  format: string@format-completer # The format of the certificate in response.
  txn_id: string # A unique transaction id for this request in UUID format. It is used for tracking the request. (format: uuid, e.g. f7f1469c-29b0-4325-9dfc-c567200a70f7)
]: any -> any {
...
# --consentArtifact shape: {consent: record, signature: record}
export def "rvcer-certificate rvcer" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
  ...
  --dry-run(-n) # Return the request that would be sent without executing it
  --accept: string@accept-completer # Response content type
  --certificate-parameters: record # shape: {FullName: string, UID: string, chasis_no: string, reg_no: string}
  --consent-artifact: any # shape: {consent: record, signature: record}
  format: string@format-completer # The format of the certificate in response.
  txn_id: string # A unique transaction id for this request in UUID format. It is used for tracking the request. (format: uuid, e.g. f7f1469c-29b0-4325-9dfc-c567200a70f7)
]: any -> any {
...
# --certificateParameters shape: {FullName: string, UID: string, chasis_no: string, reg_no: string, swd_name: string}
# --consentArtifact shape: {consent: record, signature: record}
export def "vhinsc-certificate vhinsc" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
...
# --certificateParameters shape: {FullName: string, UID: string, chasis_no: string, reg_no: string, swd_name: string}
# --consentArtifact shape: {consent: record, signature: record}
export def "vhtax-certificate vhtax" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
