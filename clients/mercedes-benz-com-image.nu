...
def build-auth [token?: string, auth_scheme?: string]: nothing -> record {
  let token_val = if ($token | is-not-empty) { $token } else { $env | get -o VEHICLE_IMAGE_TOKEN | default "" }
...
export def "components get-image" [
  ...
  let full_url = (build-url $base ({finorvin: (encode-path-segment $finorvin)} | format pattern "/{finorvin}/components") $auth.query)
...
export def "components-engine get-image" [
  ...
  let base = ($base_url | default $BASE_URL)
  if ($finorvin | is-empty) { error make --unspanned { msg: "path parameter 'finorvin' must be non-empty" } }
  let full_url = (build-url $base ({finorvin: (encode-path-segment $finorvin)} | format pattern "/{finorvin}/components/engine") $auth.query)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "get"
...
export def "components-equipments get-image" [
  ...
  let base = ($base_url | default $BASE_URL)
  if ($finorvin | is-empty) { error make --unspanned { msg: "path parameter 'finorvin' must be non-empty" } }
  let full_url = (build-url $base ({finorvin: (encode-path-segment $finorvin)} | format pattern "/{finorvin}/components/equipments") $auth.query)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "get"
...
export def "components-paint get-image" [
  ...
  let base = ($base_url | default $BASE_URL)
  if ($finorvin | is-empty) { error make --unspanned { msg: "path parameter 'finorvin' must be non-empty" } }
  let full_url = (build-url $base ({finorvin: (encode-path-segment $finorvin)} | format pattern "/{finorvin}/components/paint") $auth.query)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "get"
...
export def "components-rim get-image" [
  ...
  let base = ($base_url | default $BASE_URL)
  if ($finorvin | is-empty) { error make --unspanned { msg: "path parameter 'finorvin' must be non-empty" } }
  let full_url = (build-url $base ({finorvin: (encode-path-segment $finorvin)} | format pattern "/{finorvin}/components/rim") $auth.query)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "get"
...
export def "components-trim get-image" [
  ...
  let base = ($base_url | default $BASE_URL)
  if ($finorvin | is-empty) { error make --unspanned { msg: "path parameter 'finorvin' must be non-empty" } }
  let full_url = (build-url $base ({finorvin: (encode-path-segment $finorvin)} | format pattern "/{finorvin}/components/trim") $auth.query)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "get"
...
export def "components-upholstery get-image" [
  ...
  let base = ($base_url | default $BASE_URL)
  if ($finorvin | is-empty) { error make --unspanned { msg: "path parameter 'finorvin' must be non-empty" } }
  let full_url = (build-url $base ({finorvin: (encode-path-segment $finorvin)} | format pattern "/{finorvin}/components/upholstery") $auth.query)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "get"
...
export def "vehicle get-image" [
  ...
  let full_url = (build-url $base ({finorvin: (encode-path-segment $finorvin)} | format pattern "/{finorvin}/vehicle") $qp $auth.query)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "get"
