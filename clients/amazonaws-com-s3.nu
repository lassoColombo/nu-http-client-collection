...
export def "api abort-multipart-upload" [
  ...
  let full_url = (build-url $base ({bucket: (encode-path-segment $bucket), key: (encode-path-segment $key)} | format pattern "/{bucket}/{key}#uploadId") $qp)
...
export def "api copy-object" [
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let full_url = (build-url $base ({bucket: (encode-path-segment $bucket), key: (encode-path-segment $key)} | format pattern "/{bucket}/{key}#x-amz-copy-source"))
  let req_body = $body
  let req_body = if ($input | describe | str starts-with "record") { $input | merge deep ($req_body | default {}) } else { $req_body }
  let accept_val = "text/xml"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
...
export def "api create" [
  ...
  let auth = ($auth | update headers ($auth.headers | merge $extra_headers))
  do-request "put" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "text/xml" $req_body
}
...
export def "api create-multipart-upload" [
  ...
  let full_url = (build-url $base ({bucket: (encode-path-segment $bucket), key: (encode-path-segment $key)} | format pattern "/{bucket}/{key}#uploads") $qp)
  let req_body = $body
  let req_body = if ($input | describe | str starts-with "record") { $input | merge deep ($req_body | default {}) } else { $req_body }
  let accept_val = "text/xml"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
...
export def "api delete-analytics-configuration" [
  ...
  let full_url = (build-url $base ({bucket: (encode-path-segment $bucket)} | format pattern "/{bucket}#analytics&id") $qp)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let extra_headers = {"x-amz-security-token": $x_amz_security_token, "x-amz-expected-bucket-owner": $x_amz_expected_bucket_owner} | compact
  let auth = ($auth | update headers ($auth.headers | merge $extra_headers))
...
export def "api delete-cors" [
  ...
  let full_url = (build-url $base ({bucket: (encode-path-segment $bucket)} | format pattern "/{bucket}#cors") $qp)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let extra_headers = {"x-amz-security-token": $x_amz_security_token, "x-amz-expected-bucket-owner": $x_amz_expected_bucket_owner} | compact
  let auth = ($auth | update headers ($auth.headers | merge $extra_headers))
...
export def "api delete-encryption" [
  ...
  let full_url = (build-url $base ({bucket: (encode-path-segment $bucket)} | format pattern "/{bucket}#encryption") $qp)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let extra_headers = {"x-amz-security-token": $x_amz_security_token, "x-amz-expected-bucket-owner": $x_amz_expected_bucket_owner} | compact
  let auth = ($auth | update headers ($auth.headers | merge $extra_headers))
...
export def "api delete-intelligent-tiering-configuration" [
  ...
  let full_url = (build-url $base ({bucket: (encode-path-segment $bucket)} | format pattern "/{bucket}#intelligent-tiering&id") $qp)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
...
export def "api delete-inventory-configuration" [
  ...
  let full_url = (build-url $base ({bucket: (encode-path-segment $bucket)} | format pattern "/{bucket}#inventory&id") $qp)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let extra_headers = {"x-amz-security-token": $x_amz_security_token, "x-amz-expected-bucket-owner": $x_amz_expected_bucket_owner} | compact
  let auth = ($auth | update headers ($auth.headers | merge $extra_headers))
...
export def "api delete-lifecycle" [
  ...
  let full_url = (build-url $base ({bucket: (encode-path-segment $bucket)} | format pattern "/{bucket}#lifecycle") $qp)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let extra_headers = {"x-amz-security-token": $x_amz_security_token, "x-amz-expected-bucket-owner": $x_amz_expected_bucket_owner} | compact
  let auth = ($auth | update headers ($auth.headers | merge $extra_headers))
...
export def "api delete-metrics-configuration" [
  ...
  let full_url = (build-url $base ({bucket: (encode-path-segment $bucket)} | format pattern "/{bucket}#metrics&id") $qp)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let extra_headers = {"x-amz-security-token": $x_amz_security_token, "x-amz-expected-bucket-owner": $x_amz_expected_bucket_owner} | compact
  let auth = ($auth | update headers ($auth.headers | merge $extra_headers))
...
export def "api delete-ownership-controls" [
  ...
  let full_url = (build-url $base ({bucket: (encode-path-segment $bucket)} | format pattern "/{bucket}#ownershipControls") $qp)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let extra_headers = {"x-amz-security-token": $x_amz_security_token, "x-amz-expected-bucket-owner": $x_amz_expected_bucket_owner} | compact
  let auth = ($auth | update headers ($auth.headers | merge $extra_headers))
...
export def "api delete-policy" [
  ...
  let full_url = (build-url $base ({bucket: (encode-path-segment $bucket)} | format pattern "/{bucket}#policy") $qp)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let extra_headers = {"x-amz-security-token": $x_amz_security_token, "x-amz-expected-bucket-owner": $x_amz_expected_bucket_owner} | compact
  let auth = ($auth | update headers ($auth.headers | merge $extra_headers))
...
export def "api delete-replication" [
  ...
  let full_url = (build-url $base ({bucket: (encode-path-segment $bucket)} | format pattern "/{bucket}#replication") $qp)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let extra_headers = {"x-amz-security-token": $x_amz_security_token, "x-amz-expected-bucket-owner": $x_amz_expected_bucket_owner} | compact
  let auth = ($auth | update headers ($auth.headers | merge $extra_headers))
...
export def "api delete-tagging" [
  ...
  let full_url = (build-url $base ({bucket: (encode-path-segment $bucket)} | format pattern "/{bucket}#tagging") $qp)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let extra_headers = {"x-amz-security-token": $x_amz_security_token, "x-amz-expected-bucket-owner": $x_amz_expected_bucket_owner} | compact
  let auth = ($auth | update headers ($auth.headers | merge $extra_headers))
...
export def "api delete-website" [
  ...
  let full_url = (build-url $base ({bucket: (encode-path-segment $bucket)} | format pattern "/{bucket}#website") $qp)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let extra_headers = {"x-amz-security-token": $x_amz_security_token, "x-amz-expected-bucket-owner": $x_amz_expected_bucket_owner} | compact
  let auth = ($auth | update headers ($auth.headers | merge $extra_headers))
...
export def "api delete-object-tagging" [
  ...
  let full_url = (build-url $base ({bucket: (encode-path-segment $bucket), key: (encode-path-segment $key)} | format pattern "/{bucket}/{key}#tagging") $qp)
  let accept_val = "text/xml"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let extra_headers = {"x-amz-security-token": $x_amz_security_token, "x-amz-expected-bucket-owner": $x_amz_expected_bucket_owner} | compact
  let auth = ($auth | update headers ($auth.headers | merge $extra_headers))
...
export def "api delete-objects" [
  ...
  let full_url = (build-url $base ({bucket: (encode-path-segment $bucket)} | format pattern "/{bucket}#delete") $qp)
  let req_body = $body
  let req_body = if ($input | describe | str starts-with "record") { $input | merge deep ($req_body | default {}) } else { $req_body }
  let accept_val = "text/xml"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
...
export def "api delete-public-access-block" [
  ...
  let full_url = (build-url $base ({bucket: (encode-path-segment $bucket)} | format pattern "/{bucket}#publicAccessBlock") $qp)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let extra_headers = {"x-amz-security-token": $x_amz_security_token, "x-amz-expected-bucket-owner": $x_amz_expected_bucket_owner} | compact
  let auth = ($auth | update headers ($auth.headers | merge $extra_headers))
...
export def "api get-accelerate-configuration" [
  ...
  let full_url = (build-url $base ({bucket: (encode-path-segment $bucket)} | format pattern "/{bucket}#accelerate") $qp)
  let accept_val = "text/xml"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let extra_headers = {"x-amz-security-token": $x_amz_security_token, "x-amz-expected-bucket-owner": $x_amz_expected_bucket_owner} | compact
  let auth = ($auth | update headers ($auth.headers | merge $extra_headers))
...
export def "api get-acl" [
  ...
  let full_url = (build-url $base ({bucket: (encode-path-segment $bucket)} | format pattern "/{bucket}#acl") $qp)
  let accept_val = "text/xml"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let extra_headers = {"x-amz-security-token": $x_amz_security_token, "x-amz-expected-bucket-owner": $x_amz_expected_bucket_owner} | compact
  let auth = ($auth | update headers ($auth.headers | merge $extra_headers))
...
export def "api get-lifecycle" [
  ...
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "lifecycle" $lifecycle "scalar")] | flatten | str join "&"
  let full_url = (build-url $base ({bucket: (encode-path-segment $bucket)} | format pattern "/{bucket}#lifecycle&deprecated!") $qp)
  let accept_val = "text/xml"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let extra_headers = {"x-amz-security-token": $x_amz_security_token, "x-amz-expected-bucket-owner": $x_amz_expected_bucket_owner} | compact
  let auth = ($auth | update headers ($auth.headers | merge $extra_headers))
...
export def "api get-location" [
  ...
  let full_url = (build-url $base ({bucket: (encode-path-segment $bucket)} | format pattern "/{bucket}#location") $qp)
  let accept_val = "text/xml"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let extra_headers = {"x-amz-security-token": $x_amz_security_token, "x-amz-expected-bucket-owner": $x_amz_expected_bucket_owner} | compact
  let auth = ($auth | update headers ($auth.headers | merge $extra_headers))
...
export def "api get-logging" [
  ...
  let full_url = (build-url $base ({bucket: (encode-path-segment $bucket)} | format pattern "/{bucket}#logging") $qp)
  let accept_val = "text/xml"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let extra_headers = {"x-amz-security-token": $x_amz_security_token, "x-amz-expected-bucket-owner": $x_amz_expected_bucket_owner} | compact
  let auth = ($auth | update headers ($auth.headers | merge $extra_headers))
...
export def "api get-notification-configuration" [
  ...
  let full_url = (build-url $base ({bucket: (encode-path-segment $bucket)} | format pattern "/{bucket}#notification") $qp)
  let accept_val = "text/xml"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let extra_headers = {"x-amz-security-token": $x_amz_security_token, "x-amz-expected-bucket-owner": $x_amz_expected_bucket_owner} | compact
  let auth = ($auth | update headers ($auth.headers | merge $extra_headers))
...
export def "api get-notification" [
  ...
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "notification" $notification "scalar")] | flatten | str join "&"
  let full_url = (build-url $base ({bucket: (encode-path-segment $bucket)} | format pattern "/{bucket}#notification&deprecated!") $qp)
  let accept_val = "text/xml"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let extra_headers = {"x-amz-security-token": $x_amz_security_token, "x-amz-expected-bucket-owner": $x_amz_expected_bucket_owner} | compact
  let auth = ($auth | update headers ($auth.headers | merge $extra_headers))
...
export def "api get-policy-status" [
  ...
  let full_url = (build-url $base ({bucket: (encode-path-segment $bucket)} | format pattern "/{bucket}#policyStatus") $qp)
  let accept_val = "text/xml"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let extra_headers = {"x-amz-security-token": $x_amz_security_token, "x-amz-expected-bucket-owner": $x_amz_expected_bucket_owner} | compact
  let auth = ($auth | update headers ($auth.headers | merge $extra_headers))
...
export def "api get-request-payment" [
  ...
  let full_url = (build-url $base ({bucket: (encode-path-segment $bucket)} | format pattern "/{bucket}#requestPayment") $qp)
  let accept_val = "text/xml"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let extra_headers = {"x-amz-security-token": $x_amz_security_token, "x-amz-expected-bucket-owner": $x_amz_expected_bucket_owner} | compact
  let auth = ($auth | update headers ($auth.headers | merge $extra_headers))
...
export def "api get-versioning" [
  ...
  let full_url = (build-url $base ({bucket: (encode-path-segment $bucket)} | format pattern "/{bucket}#versioning") $qp)
  let accept_val = "text/xml"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let extra_headers = {"x-amz-security-token": $x_amz_security_token, "x-amz-expected-bucket-owner": $x_amz_expected_bucket_owner} | compact
  let auth = ($auth | update headers ($auth.headers | merge $extra_headers))
...
export def "api get-object-acl" [
  ...
  let full_url = (build-url $base ({bucket: (encode-path-segment $bucket), key: (encode-path-segment $key)} | format pattern "/{bucket}/{key}#acl") $qp)
  let accept_val = "text/xml"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let extra_headers = {"x-amz-security-token": $x_amz_security_token, "x-amz-request-payer": $x_amz_request_payer, "x-amz-expected-bucket-owner": $x_amz_expected_bucket_owner} | compact
  let auth = ($auth | update headers ($auth.headers | merge $extra_headers))
...
export def "api get-object-attributes" [
  ...
  let full_url = (build-url $base ({bucket: (encode-path-segment $bucket), key: (encode-path-segment $key)} | format pattern "/{bucket}/{key}#attributes&x-amz-object-attributes") $qp)
  let accept_val = "text/xml"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
...
export def "api get-object-legal-hold" [
  ...
  let full_url = (build-url $base ({bucket: (encode-path-segment $bucket), key: (encode-path-segment $key)} | format pattern "/{bucket}/{key}#legal-hold") $qp)
  let accept_val = "text/xml"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let extra_headers = {"x-amz-security-token": $x_amz_security_token, "x-amz-request-payer": $x_amz_request_payer, "x-amz-expected-bucket-owner": $x_amz_expected_bucket_owner} | compact
  let auth = ($auth | update headers ($auth.headers | merge $extra_headers))
...
export def "api get-object-lock-configuration" [
  ...
  let full_url = (build-url $base ({bucket: (encode-path-segment $bucket)} | format pattern "/{bucket}#object-lock") $qp)
  let accept_val = "text/xml"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let extra_headers = {"x-amz-security-token": $x_amz_security_token, "x-amz-expected-bucket-owner": $x_amz_expected_bucket_owner} | compact
  let auth = ($auth | update headers ($auth.headers | merge $extra_headers))
...
export def "api get-object-retention" [
  ...
  let full_url = (build-url $base ({bucket: (encode-path-segment $bucket), key: (encode-path-segment $key)} | format pattern "/{bucket}/{key}#retention") $qp)
  let accept_val = "text/xml"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let extra_headers = {"x-amz-security-token": $x_amz_security_token, "x-amz-request-payer": $x_amz_request_payer, "x-amz-expected-bucket-owner": $x_amz_expected_bucket_owner} | compact
  let auth = ($auth | update headers ($auth.headers | merge $extra_headers))
...
export def "api get-object-torrent" [
  ...
  let full_url = (build-url $base ({bucket: (encode-path-segment $bucket), key: (encode-path-segment $key)} | format pattern "/{bucket}/{key}#torrent") $qp)
  let accept_val = "text/xml"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let extra_headers = {"x-amz-security-token": $x_amz_security_token, "x-amz-request-payer": $x_amz_request_payer, "x-amz-expected-bucket-owner": $x_amz_expected_bucket_owner} | compact
  let auth = ($auth | update headers ($auth.headers | merge $extra_headers))
...
export def "api list-analytics-configurations" [
  ...
  let full_url = (build-url $base ({bucket: (encode-path-segment $bucket)} | format pattern "/{bucket}#analytics") $qp)
  let accept_val = "text/xml"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let extra_headers = {"x-amz-security-token": $x_amz_security_token, "x-amz-expected-bucket-owner": $x_amz_expected_bucket_owner} | compact
  let auth = ($auth | update headers ($auth.headers | merge $extra_headers))
...
export def "api list-intelligent-tiering-configurations" [
  ...
  let full_url = (build-url $base ({bucket: (encode-path-segment $bucket)} | format pattern "/{bucket}#intelligent-tiering") $qp)
  let accept_val = "text/xml"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let extra_headers = {"x-amz-security-token": $x_amz_security_token} | compact
  let auth = ($auth | update headers ($auth.headers | merge $extra_headers))
...
export def "api list-inventory-configurations" [
  ...
  let full_url = (build-url $base ({bucket: (encode-path-segment $bucket)} | format pattern "/{bucket}#inventory") $qp)
  let accept_val = "text/xml"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let extra_headers = {"x-amz-security-token": $x_amz_security_token, "x-amz-expected-bucket-owner": $x_amz_expected_bucket_owner} | compact
  let auth = ($auth | update headers ($auth.headers | merge $extra_headers))
...
export def "api list-metrics-configurations" [
  ...
  let full_url = (build-url $base ({bucket: (encode-path-segment $bucket)} | format pattern "/{bucket}#metrics") $qp)
  let accept_val = "text/xml"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let extra_headers = {"x-amz-security-token": $x_amz_security_token, "x-amz-expected-bucket-owner": $x_amz_expected_bucket_owner} | compact
  let auth = ($auth | update headers ($auth.headers | merge $extra_headers))
...
export def "api list-multipart-uploads" [
  ...
  let full_url = (build-url $base ({bucket: (encode-path-segment $bucket)} | format pattern "/{bucket}#uploads") $qp)
  let accept_val = "text/xml"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let extra_headers = {"x-amz-security-token": $x_amz_security_token, "x-amz-expected-bucket-owner": $x_amz_expected_bucket_owner} | compact
  let auth = ($auth | update headers ($auth.headers | merge $extra_headers))
...
export def "api list-object-versions" [
  ...
  let full_url = (build-url $base ({bucket: (encode-path-segment $bucket)} | format pattern "/{bucket}#versions") $qp)
  let accept_val = "text/xml"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let extra_headers = {"x-amz-security-token": $x_amz_security_token, "x-amz-expected-bucket-owner": $x_amz_expected_bucket_owner} | compact
  let auth = ($auth | update headers ($auth.headers | merge $extra_headers))
...
export def "api list-objects-by-Bucket-1" [
  ...
  let full_url = (build-url $base ({bucket: (encode-path-segment $bucket)} | format pattern "/{bucket}#list-type=2") $qp)
  let accept_val = "text/xml"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let extra_headers = {"x-amz-security-token": $x_amz_security_token, "x-amz-request-payer": $x_amz_request_payer, "x-amz-expected-bucket-owner": $x_amz_expected_bucket_owner} | compact
  let auth = ($auth | update headers ($auth.headers | merge $extra_headers))
...
export def "api create-restore-object" [
  ...
  let full_url = (build-url $base ({bucket: (encode-path-segment $bucket), key: (encode-path-segment $key)} | format pattern "/{bucket}/{key}#restore") $qp)
  let req_body = $body
  let req_body = if ($input | describe | str starts-with "record") { $input | merge deep ($req_body | default {}) } else { $req_body }
  let accept_val = "text/xml"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
...
export def "api create-select-object-content" [
  ...
  let full_url = (build-url $base ({bucket: (encode-path-segment $bucket), key: (encode-path-segment $key)} | format pattern "/{bucket}/{key}#select&select-type=2") $qp)
  let req_body = $body
  let req_body = if ($input | describe | str starts-with "record") { $input | merge deep ($req_body | default {}) } else { $req_body }
  let accept_val = "text/xml"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
...
export def "api upload-part" [
  ...
  let full_url = (build-url $base ({bucket: (encode-path-segment $bucket), key: (encode-path-segment $key)} | format pattern "/{bucket}/{key}#partNumber&uploadId") $qp)
  let req_body = $body
  let req_body = if ($input | describe | str starts-with "record") { $input | merge deep ($req_body | default {}) } else { $req_body }
  let accept_val = "text/xml"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
...
export def "api upload-part-copy" [
  ...
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "partNumber" $part_number "scalar") (serialize-qp "uploadId" $upload_id "scalar")] | flatten | str join "&"
  let full_url = (build-url $base ({bucket: (encode-path-segment $bucket), key: (encode-path-segment $key)} | format pattern "/{bucket}/{key}#x-amz-copy-source&partNumber&uploadId") $qp)
  let accept_val = "text/xml"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
...
export def "write-get-object-responsex-amz-request-routex-amz-request-token get-response" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
