...
def build-auth [token?: string, auth_scheme?: string]: nothing -> record {
  let token_val = if ($token | is-not-empty) { $token } else { $env | get -o AMAZON_SIMPLE_STORAGE_SERVICE_TOKEN | default "" }
...
export def "api abort-multipart-upload" [
  ...
  let full_url = (build-url $base ({bucket: (encode-path-segment $bucket), key: (encode-path-segment $key)} | format pattern "/{bucket}/{key}") $qp $auth.query)
  ...
  let req = {
    method: "delete"
    url: $full_url
    query: ({"uploadId": $upload_id} | compact)
...
export def "api list-parts" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"max-parts": $max_parts, "part-number-marker": $part_number_marker, "uploadId": $upload_id, "MaxParts": $max_parts_2, "PartNumberMarker": $part_number_marker_2} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api copy-object" [
  ...
  if ($bucket | is-empty) { error make --unspanned { msg: "path parameter 'Bucket' must be non-empty" } }
  if ($key | is-empty) { error make --unspanned { msg: "path parameter 'Key' must be non-empty" } }
  let full_url = (build-url $base ({bucket: (encode-path-segment $bucket), key: (encode-path-segment $key)} | format pattern "/{bucket}/{key}") $auth.query)
  let req_body = $body
  let req_body = if ($input | describe | str starts-with "record") { $input | merge deep ($req_body | default {}) } else if (($input | is-not-empty) and ($req_body | is-empty)) { $input } else { $req_body }
  let accept_val = "text/xml"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
...
export def "api create" [
  ...
  let base = ($base_url | default $BASE_URL)
  if ($bucket | is-empty) { error make --unspanned { msg: "path parameter 'Bucket' must be non-empty" } }
  let full_url = (build-url $base ({bucket: (encode-path-segment $bucket)} | format pattern "/{bucket}") $auth.query)
  let req_body = $body
  let req_body = if ($input | describe | str starts-with "record") { $input | merge deep ($req_body | default {}) } else if (($input | is-not-empty) and ($req_body | is-empty)) { $input } else { $req_body }
  let accept_val = "text/xml"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
...
export def "api list-objects-by-bucket" [
  ...
  let full_url = (build-url $base ({bucket: (encode-path-segment $bucket)} | format pattern "/{bucket}") $qp $auth.query)
  let accept_val = "text/xml"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let extra_headers = {"x-amz-security-token": $x_amz_security_token, "x-amz-request-payer": $x_amz_request_payer, "x-amz-expected-bucket-owner": $x_amz_expected_bucket_owner} | compact
  let auth = ($auth | update headers ($auth.headers | merge $extra_headers))
  let req = {
    method: "get"
    url: $full_url
    query: ({"delimiter": $delimiter, "encoding-type": $encoding_type, "marker": $marker, "max-keys": $max_keys, "prefix": $prefix, "MaxKeys": $max_keys_2, "Marker": $marker_2} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api delete-analytics-configuration" [
  ...
  let req = {
    method: "delete"
    url: $full_url
    query: ({"id": $id, "analytics": $analytics} | compact)
    headers: $auth.headers
    body: null
    content_type: "application/json"
    timeout: ($max_time | default 30min)
...
export def "api delete-encryption" [
  ...
  let req = {
    method: "delete"
    url: $full_url
    query: ({"encryption": $encryption} | compact)
    headers: $auth.headers
    body: null
    content_type: "application/json"
    timeout: ($max_time | default 30min)
...
export def "api delete-intelligent-tiering-configuration" [
  ...
  let req = {
    method: "delete"
    url: $full_url
    query: ({"id": $id, "intelligent-tiering": $intelligent_tiering} | compact)
    headers: $auth.headers
    body: null
    content_type: "application/json"
    timeout: ($max_time | default 30min)
...
export def "api delete-inventory-configuration" [
  ...
  let req = {
    method: "delete"
    url: $full_url
    query: ({"id": $id, "inventory": $inventory} | compact)
    headers: $auth.headers
    body: null
    content_type: "application/json"
    timeout: ($max_time | default 30min)
...
export def "api delete-lifecycle" [
  ...
  let req = {
    method: "delete"
    url: $full_url
    query: ({"lifecycle": $lifecycle} | compact)
    headers: $auth.headers
    body: null
    content_type: "application/json"
    timeout: ($max_time | default 30min)
...
export def "api delete-metrics-configuration" [
  ...
  let req = {
    method: "delete"
    url: $full_url
    query: ({"id": $id, "metrics": $metrics} | compact)
    headers: $auth.headers
    body: null
    content_type: "application/json"
    timeout: ($max_time | default 30min)
...
export def "api delete-ownership-controls" [
  ...
  let req = {
    method: "delete"
    url: $full_url
    query: ({"ownershipControls": $ownership_controls} | compact)
    headers: $auth.headers
    body: null
    content_type: "application/json"
    timeout: ($max_time | default 30min)
...
export def "api delete-replication" [
  ...
  let req = {
    method: "delete"
    url: $full_url
    query: ({"replication": $replication} | compact)
    headers: $auth.headers
    body: null
    content_type: "application/json"
    timeout: ($max_time | default 30min)
...
export def "api get-object" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"response-cache-control": $response_cache_control, "response-content-disposition": $response_content_disposition, "response-content-encoding": $response_content_encoding, "response-content-language": $response_content_language, "response-content-type": $response_content_type, "response-expires": $response_expires, "versionId": $version_id, "partNumber": $part_number} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api head-object" [
  ...
  let req = {
    method: "head"
    url: $full_url
    query: ({"versionId": $version_id, "partNumber": $part_number} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api delete-object-tagging" [
  ...
  let req = {
    method: "delete"
    url: $full_url
    query: ({"versionId": $version_id, "tagging": $tagging} | compact)
    headers: $auth.headers
    body: null
    content_type: "application/json"
    timeout: ($max_time | default 30min)
...
export def "api delete-public-access-block" [
  ...
  let req = {
    method: "delete"
    url: $full_url
    query: ({"publicAccessBlock": $public_access_block} | compact)
    headers: $auth.headers
    body: null
    content_type: "application/json"
    timeout: ($max_time | default 30min)
...
export def "api get-accelerate-configuration" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"accelerate": $accelerate} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-notification-configuration" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"notification": $notification} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-policy-status" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"policyStatus": $policy_status} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-request-payment" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"requestPayment": $request_payment} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-versioning" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"versioning": $versioning} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-object-acl" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"versionId": $version_id, "acl": $acl} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-object-attributes" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"versionId": $version_id, "attributes": $attributes} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-object-legal-hold" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"versionId": $version_id, "legal-hold": $legal_hold} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-object-lock-configuration" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"object-lock": $object_lock} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-object-retention" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"versionId": $version_id, "retention": $retention} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api list-analytics-configurations" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"continuation-token": $continuation_token, "analytics": $analytics} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api list-intelligent-tiering-configurations" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"continuation-token": $continuation_token, "intelligent-tiering": $intelligent_tiering} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api list-inventory-configurations" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"continuation-token": $continuation_token, "inventory": $inventory} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api list-metrics-configurations" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"continuation-token": $continuation_token, "metrics": $metrics} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api list-multipart-uploads" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"delimiter": $delimiter, "encoding-type": $encoding_type, "key-marker": $key_marker, "max-uploads": $max_uploads, "prefix": $prefix, "upload-id-marker": $upload_id_marker, "MaxUploads": $max_uploads_2, "KeyMarker": $key_marker_2, "UploadIdMarker": $upload_id_marker_2, "uploads": $uploads} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api list-object-versions" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"delimiter": $delimiter, "encoding-type": $encoding_type, "key-marker": $key_marker, "max-keys": $max_keys, "prefix": $prefix, "version-id-marker": $version_id_marker, "MaxKeys": $max_keys_2, "KeyMarker": $key_marker_2, "VersionIdMarker": $version_id_marker_2, "versions": $versions} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api list-objects-by-bucket-1" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"delimiter": $delimiter, "encoding-type": $encoding_type, "max-keys": $max_keys, "prefix": $prefix, "continuation-token": $continuation_token, "fetch-owner": $fetch_owner, "start-after": $start_after, "MaxKeys": $max_keys_2, "ContinuationToken": $continuation_token_2, "list-type": $list_type} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api create-restore-object" [
  ...
  let req = {
    method: "post"
    url: $full_url
    query: ({"versionId": $version_id, "restore": $restore} | compact)
    headers: $auth.headers
    body: $req_body
    content_type: "text/xml"
    timeout: ($max_time | default 30min)
...
export def "api create-select-object-content" [
  ...
  let req = {
    method: "post"
    url: $full_url
    query: ({"select": $select, "select-type": $select_type} | compact)
    headers: $auth.headers
    body: $req_body
    content_type: "text/xml"
    timeout: ($max_time | default 30min)
...
export def "api upload-part" [
  ...
  let req = {
    method: "put"
    url: $full_url
    query: ({"partNumber": $part_number, "uploadId": $upload_id} | compact)
    headers: $auth.headers
    body: $req_body
    content_type: "text/xml"
    timeout: ($max_time | default 30min)
...
export def "write-get-object-response get" [
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let full_url = (build-url $base "/WriteGetObjectResponse" $auth.query)
  let req_body = $body
  let req_body = if ($input | describe | str starts-with "record") { $input | merge deep ($req_body | default {}) } else if (($input | is-not-empty) and ($req_body | is-empty)) { $input } else { $req_body }
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
