# Auto-generated client for Intercom API v2.10
# Source: https://raw.githubusercontent.com/intercom/Intercom-OpenAPI/main/descriptions/2.10/api.intercom.io.yaml
...
def Intercom-Version-completer [] { ["1.0" "1.1" "1.2" "1.3" "1.4" "2.0" "2.1" "2.10" "2.2" "2.3" "2.4" "2.5" "2.6" "2.7" "2.8" "2.9"] }
...
export def "me identifyAdmin" [
  ...
  --Intercom-Version: string@Intercom-Version-completer # e.g. 2.10
...
]: any -> record<type: string, id: string, name: string, email: string, job_title: string, away_mode_enabled: bool, away_mode_reassign: bool, has_inbox_seat: bool, team_ids: list<int>, avatar: string, team_priority_level: record<primary_team_ids: list<int>, secondary_team_ids: list<int>>> {
  let input = $in
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let full_url = (build-url $base $"/admins/($id)/away")
...
export def "admins listAdmins" [
  ...
  --Intercom-Version: string@Intercom-Version-completer # e.g. 2.10
]: nothing -> record<type: string, admins: table<type: string, id: string, name: string, email: string, job_title: string, away_mode_enabled: bool, away_mode_reassign: bool, has_inbox_seat: bool, team_ids: list, avatar: string, team_priority_level: record>> {
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
...
export def "admins retrieveAdmin" [
  ...
  --dry-run(-n) # Return the request that would be sent without executing it
  --Intercom-Version: string@Intercom-Version-completer # e.g. 2.10
]: nothing -> record<type: string, id: string, name: string, email: string, job_title: string, away_mode_enabled: bool, away_mode_reassign: bool, has_inbox_seat: bool, team_ids: list<int>, avatar: string, team_priority_level: record<primary_team_ids: list<int>, secondary_team_ids: list<int>>> {
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let full_url = (build-url $base $"/admins/($id)")
  let extra_headers = {"Intercom-Version": $Intercom_Version} | compact
  let auth = ($auth | update headers ($auth.headers | merge $extra_headers))
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
...
export def "articles createArticle" [
  ...
  --translated-content: record # The Translated Content of an Article. The keys are the locale codes and the values are the translated content of the article. (nullable) — shape: {type?: ""|"article_translated_content", ar?: record, bg?: record, bs?: record, ca?: record, cs?: record, da?: record, de?: record, el?: record, en?: record, es?: record, et?: record, fi?: record, fr?: record, he?: record, hr?: record, hu?: record, id?: record, it?: record, ja?: record, ko?: record, lt?: record, lv?: record, mn?: record, nb?: record, nl?: record, pl?: record, pt?: record, ro?: record, ru?: record, sl?: record, sr?: record, sv?: record, tr?: record, vi?: record, pt-BR?: record, zh-CN?: record, zh-TW?: record}
...
export def "articles retrieveArticle" [
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let full_url = (build-url $base $"/articles/($id)")
  let extra_headers = {"Intercom-Version": $Intercom_Version} | compact
  let auth = ($auth | update headers ($auth.headers | merge $extra_headers))
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
...
export def "help-center-collections createCollection" [
  ...
  --translated-content: record # The Translated Content of an Group. The keys are the locale codes and the values are the translated content of the Group. (nullable) — shape: {type?: ""|"group_translated_content", ar?: record, bg?: record, bs?: record, ca?: record, cs?: record, da?: record, de?: record, el?: record, en?: record, es?: record, et?: record, fi?: record, fr?: record, he?: record, hr?: record, hu?: record, id?: record, it?: record, ja?: record, ko?: record, lt?: record, lv?: record, mn?: record, nb?: record, nl?: record, pl?: record, pt?: record, ro?: record, ru?: record, sl?: record, sr?: record, sv?: record, tr?: record, vi?: record, pt-BR?: record, zh-CN?: record, zh-TW?: record}
...
export def "help-center-collections retrieveCollection" [
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let full_url = (build-url $base $"/help_center/collections/($id)")
  let extra_headers = {"Intercom-Version": $Intercom_Version} | compact
  let auth = ($auth | update headers ($auth.headers | merge $extra_headers))
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
...
export def "help-center-help-centers retrieveHelpCenter" [
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let full_url = (build-url $base $"/help_center/help_centers/($id)")
  let extra_headers = {"Intercom-Version": $Intercom_Version} | compact
  let auth = ($auth | update headers ($auth.headers | merge $extra_headers))
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
...
export def "help-center-help-centers listHelpCenters" [
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let full_url = (build-url $base "/help_center/help_centers")
  let extra_headers = {"Intercom-Version": $Intercom_Version} | compact
  let auth = ($auth | update headers ($auth.headers | merge $extra_headers))
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
...
export def "companies createOrUpdateCompany" [
  ...
  --industry: string # The industry that this company operates in. (e.g. Technology)
...
export def "companies-contacts ListAttachedContacts" [
  ...
  --dry-run(-n) # Return the request that would be sent without executing it
  --Intercom-Version: string@Intercom-Version-completer # e.g. 2.10
]: nothing -> record<type: string, data: table<type: string, id: string, external_id: string, workspace_id: string, role: string, email: string, email_domain: string, phone: string, name: string, owner_id: int, has_hard_bounced: bool, marked_email_as_spam: bool, unsubscribed_from_emails: bool, created_at: int, updated_at: int, signed_up_at: int, last_seen_at: int, last_replied_at: int, last_contacted_at: int, last_email_opened_at: int, last_email_clicked_at: int, language_override: string, browser: string, browser_version: string, browser_language: string, os: string, android_app_name: string, android_app_version: string, android_device: string, android_os_version: string, android_sdk_version: string, android_last_seen_at: int, ios_app_name: string, ios_app_version: string, ios_device: string, ios_os_version: string, ios_sdk_version: string, ios_last_seen_at: int, custom_attributes: record, avatar: record, tags: record, notes: record, companies: record, location: record, social_profiles: record>, total_count: int, pages: record<type: string, page: int, next: record<per_page: int, starting_after: string>, per_page: int, total_pages: int>> {
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let full_url = (build-url $base $"/companies/($id)/contacts")
  let extra_headers = {"Intercom-Version": $Intercom_Version} | compact
  let auth = ($auth | update headers ($auth.headers | merge $extra_headers))
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
...
export def "companies-segments ListAttachedSegmentsForCompanies" [
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let full_url = (build-url $base $"/companies/($id)/segments")
  let extra_headers = {"Intercom-Version": $Intercom_Version} | compact
  let auth = ($auth | update headers ($auth.headers | merge $extra_headers))
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
...
export def "contacts-companies attachContactToACompany" [
  ...
  --dry-run(-n) # Return the request that would be sent without executing it
  --Intercom-Version: string@Intercom-Version-completer # e.g. 2.10
  --body-id: string # The unique identifier for the company which is given by Intercom (e.g. 58a430d35458202d41b1e65b)
]: any -> record<type: string, id: string, name: string, app_id: string, plan: record<type: string, id: string, name: string>, company_id: string, remote_created_at: int, created_at: int, updated_at: int, last_request_at: int, size: int, website: string, industry: string, monthly_spend: int, session_count: int, user_count: int, custom_attributes: record, tags: record<type: string, tags: list<record>>, segments: record<type: string, segments: list<record>>> {
  let input = $in
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let full_url = (build-url $base $"/contacts/($id)/companies")
...
export def "contacts-companies detachContactFromACompany" [
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let full_url = (build-url $base $"/contacts/($contact_id)/companies/($id)")
  let extra_headers = {"Intercom-Version": $Intercom_Version} | compact
  let auth = ($auth | update headers ($auth.headers | merge $extra_headers))
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
...
export def "contacts-notes listNotes" [
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let full_url = (build-url $base $"/contacts/($id)/notes")
  let extra_headers = {"Intercom-Version": $Intercom_Version} | compact
  let auth = ($auth | update headers ($auth.headers | merge $extra_headers))
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
...
export def "contacts-subscriptions detachSubscriptionTypeToContact" [
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let full_url = (build-url $base $"/contacts/($contact_id)/subscriptions/($id)")
  let extra_headers = {"Intercom-Version": $Intercom_Version} | compact
  let auth = ($auth | update headers ($auth.headers | merge $extra_headers))
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
...
export def "contacts-tags detachTagFromContact" [
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let full_url = (build-url $base $"/contacts/($contact_id)/tags/($id)")
  let extra_headers = {"Intercom-Version": $Intercom_Version} | compact
  let auth = ($auth | update headers ($auth.headers | merge $extra_headers))
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
...
]: any -> record<type: string, id: string, external_id: string, workspace_id: string, role: string, email: string, email_domain: string, phone: string, name: string, owner_id: int, has_hard_bounced: bool, marked_email_as_spam: bool, unsubscribed_from_emails: bool, created_at: int, updated_at: int, signed_up_at: int, last_seen_at: int, last_replied_at: int, last_contacted_at: int, last_email_opened_at: int, last_email_clicked_at: int, language_override: string, browser: string, browser_version: string, browser_language: string, os: string, android_app_name: string, android_app_version: string, android_device: string, android_os_version: string, android_sdk_version: string, android_last_seen_at: int, ios_app_name: string, ios_app_version: string, ios_device: string, ios_os_version: string, ios_sdk_version: string, ios_last_seen_at: int, custom_attributes: record, avatar: record<type: string, image_url: string>, tags: record<data: list<record>, url: string, total_count: int, has_more: bool>, notes: record<data: list<record>, url: string, total_count: int, has_more: bool>, companies: record<data: list<record>, url: string, total_count: int, has_more: bool>, location: record<type: string, country: string, region: string, city: string>, social_profiles: record<data: list<record>>> {
  let input = $in
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
...
export def "contacts-search SearchContacts" [
  ...
  --Intercom-Version: string@Intercom-Version-completer # e.g. 2.10
  --body-query: any
  --pagination: record # nullable — shape: {per_page?: int, starting_after?: string}
...
export def "contacts-archive ArchiveContact" [
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let full_url = (build-url $base $"/contacts/($id)/archive")
  let extra_headers = {"Intercom-Version": $Intercom_Version} | compact
  let auth = ($auth | update headers ($auth.headers | merge $extra_headers))
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
...
export def "contacts-unarchive UnarchiveContact" [
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let full_url = (build-url $base $"/contacts/($id)/unarchive")
  let extra_headers = {"Intercom-Version": $Intercom_Version} | compact
  let auth = ($auth | update headers ($auth.headers | merge $extra_headers))
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
...
export def "conversations-tags detachTagFromConversation" [
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let full_url = (build-url $base $"/conversations/($conversation_id)/tags/($id)")
...
export def "conversations listConversations" [
  ...
  --Intercom-Version: string@Intercom-Version-completer # e.g. 2.10
]: nothing -> record<type: string, pages: record<type: string, page: int, next: record<per_page: int, starting_after: string>, per_page: int, total_pages: int>, total_count: int, data: list<any>> {
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
...
export def "conversations createConversation" [
  ...
  let body = {from: $body_from, body: $body_body, subject: $subject, attachment_urls: $attachment_urls} | compact
  let body = if ($input | describe | str starts-with "record") { $input | merge deep ($body | default {}) } else { $body }
  let extra_headers = {"Intercom-Version": $Intercom_Version} | compact
  let auth = ($auth | update headers ($auth.headers | merge $extra_headers))
  let accept_val = "application/json"
...
export def "conversations-reply replyConversation" [
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let full_url = (build-url $base $"/conversations/($id)/reply")
...
export def "conversations-parts manageConversation" [
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let full_url = (build-url $base $"/conversations/($id)/parts")
...
export def "conversations-run-assignment-rules autoAssignConversation" [
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let full_url = (build-url $base $"/conversations/($id)/run_assignment_rules")
  let extra_headers = {"Intercom-Version": $Intercom_Version} | compact
  let auth = ($auth | update headers ($auth.headers | merge $extra_headers))
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
...
export def "conversations-customers attachContactToConversation" [
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let full_url = (build-url $base $"/conversations/($id)/customers")
...
export def "data-attributes lisDataAttributes" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
...
export def "data-attributes updateDataAttribute" [
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let full_url = (build-url $base $"/data_attributes/($id)")
...
export def "events lisDataEvents" [
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "filter" $filter "multi") (serialize-qp "type" $type "scalar") (serialize-qp "summary" $summary "scalar")] | flatten | str join "&"
...
]: any -> record<job_identfier: string, status: string, download_expires_at: string, download_url: string> {
  let input = $in
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
...
export def "export-content-data get" [
  ...
  --dry-run(-n) # Return the request that would be sent without executing it
  --Intercom-Version: string@Intercom-Version-completer # e.g. 2.10
]: nothing -> record<job_identfier: string, status: string, download_expires_at: string, download_url: string> {
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
...
export def "messages createMessage" [
  ...
  --body-from: record # The sender of the message. If not provided, the default sender will be used. — shape: {type: "admin", id: int}
  --body-to: record # The sender of the message. If not provided, the default sender will be used. — shape: {type: "user"|"lead", id: string}
  ...
  let body = {message_type: $message_type, subject: $subject, body: $body_body, template: $template, from: $body_from, to: $body_to, create_conversation_without_contact_reply: $create_conversation_without_contact_reply} | compact
  let body = if ($input | describe | str starts-with "record") { $input | merge deep ($body | default {}) } else { $body }
  let extra_headers = {"Intercom-Version": $Intercom_Version} | compact
  let auth = ($auth | update headers ($auth.headers | merge $extra_headers))
  let accept_val = "application/json"
...
export def "news-news-items retrieveNewsItem" [
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let full_url = (build-url $base $"/news/news_items/($id)")
  let extra_headers = {"Intercom-Version": $Intercom_Version} | compact
  let auth = ($auth | update headers ($auth.headers | merge $extra_headers))
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
...
export def "news-newsfeeds-items listLiveNewsfeedItems" [
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let full_url = (build-url $base $"/news/newsfeeds/($id)/items")
  let extra_headers = {"Intercom-Version": $Intercom_Version} | compact
  let auth = ($auth | update headers ($auth.headers | merge $extra_headers))
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
...
export def "news-newsfeeds retrieveNewsfeed" [
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let full_url = (build-url $base $"/news/newsfeeds/($id)")
  let extra_headers = {"Intercom-Version": $Intercom_Version} | compact
  let auth = ($auth | update headers ($auth.headers | merge $extra_headers))
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
...
export def "ticket-types-attributes updateTicketTypeAttribute" [
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let full_url = (build-url $base $"/ticket_types/($ticket_type_id)/attributes/($id)")
...
export def "ticket-types get" [
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let full_url = (build-url $base $"/ticket_types/($id)")
  let extra_headers = {"Intercom-Version": $Intercom_Version} | compact
  let auth = ($auth | update headers ($auth.headers | merge $extra_headers))
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
...
export def "tickets-reply replyTicket" [
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let full_url = (build-url $base $"/tickets/($id)/reply")
  let body = {message_type: $message_type, type: $type, body: $body_body, admin_id: $admin_id, reply_options: $reply_options, attachment_urls: $attachment_urls, cross_post: $cross_post} | compact
  let body = if ($input | describe | str starts-with "record") { $input | merge deep ($body | default {}) } else { $body }
  let extra_headers = {"Intercom-Version": $Intercom_Version} | compact
  let auth = ($auth | update headers ($auth.headers | merge $extra_headers))
  let accept_val = "application/json"
...
export def "tickets-tags detachTagFromTicket" [
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let full_url = (build-url $base $"/tickets/($ticket_id)/tags/($id)")
  let body = {admin_id: $admin_id} | compact
  let body = if ($input | describe | str starts-with "record") { $input | merge deep ($body | default {}) } else { $body }
  let extra_headers = {"Intercom-Version": $Intercom_Version} | compact
  let auth = ($auth | update headers ($auth.headers | merge $extra_headers))
...
export def "tickets createTicket" [
  ...
  let body = {ticket_type_id: $ticket_type_id, contacts: $contacts, company_id: $company_id, ticket_attributes: $ticket_attributes} | compact
  let body = if ($input | describe | str starts-with "record") { $input | merge deep ($body | default {}) } else { $body }
  let extra_headers = {"Intercom-Version": $Intercom_Version} | compact
  let auth = ($auth | update headers ($auth.headers | merge $extra_headers))
  let accept_val = "application/json"
...
export def "tickets updateTicket" [
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let full_url = (build-url $base $"/tickets/($id)")
...
export def "tickets-search searchTickets" [
  ...
  --body-query: any
  --pagination: record # nullable — shape: {per_page?: int, starting_after?: string}
]: any -> record<type: string, tickets: table<type: string, id: string, ticket_id: string, category: string, ticket_attributes: record, ticket_state: string, ticket_state_internal_label: string, ticket_state_external_label: string, ticket_type: record, contacts: record, admin_assignee_id: string, team_assignee_id: string, created_at: int, updated_at: int, open: bool, snoozed_until: int, linked_objects: record, ticket_parts: record, is_shared: bool>, total_count: int, pages: record<type: string, page: int, next: record<per_page: int, starting_after: string>, per_page: int, total_pages: int>> {
  let input = $in
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
