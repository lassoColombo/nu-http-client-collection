...
export def "jwt-fetch-api-key jwt-fetch-api-key" [
  ...
  --include-profile: string@bool-completer # Whether to include a `user` object containing the target user's profile details in the response.  (default: false, e.g. false)
...
export def "events get-events" [
  ...
  --dont-block: string@bool-completer # Set to `true` if the client is requesting a nonblocking reply. If not specified, the request will block until either a new event is available or a few minutes have passed, in which case the server will send the client a heartbeat event.  (default: false, e.g. true)
...
export def "navigation-views add-navigation-view" [
  ...
  --is-pinned: string@bool-completer # Determines whether the view appears directly in the sidebar or is hidden in the "More Views" menu.  - `true` - Pinned and visible in the sidebar. - `false` - Hidden and accessible via the "More Views" menu.  (e.g. true)
...
export def "navigation-views edit-navigation-view" [
  ...
  --raw(-r) # Fetch as text
  --allow-errors(-e) # Return full response without error handling
  --is-pinned: string@bool-completer # Determines whether the view is pinned (true) or hidden in the menu (false).  (e.g. true)
...
export def "scheduled-messages create-scheduled-message" [
  ...
  --read-by-sender: string@bool-completer # Whether the message should be initially marked read by its sender. If unspecified, the server uses a heuristic based on the client name and the recipient.  **Changes**: New in Zulip 8.0 (feature level 236).  (e.g. true)
...
export def "messages get-messages" [
  ...
  --include-anchor: string@bool-completer # Whether a message with the specified ID matching the narrow should be included.  **Changes**: New in Zulip 6.0 (feature level 155).  (default: true, e.g. false)
  ...
  --client-gravatar: string@bool-completer # Whether the client supports computing gravatars URLs. If enabled, `avatar_url` will be included in the response only if there is a Zulip avatar, and will be `null` for users who are using gravatar as their avatar. This option significantly reduces the compressed size of user data, since gravatar URLs are long, random strings and thus do not compress well. The `client_gravatar` field is set to `true` if clients can compute their own gravatars.  **Changes**: The default value of this parameter was `false` prior to Zulip 5.0 (feature level 92).  (default: true, e.g. false)
  --apply-markdown: string@bool-completer # If `true`, message content is returned in the rendered HTML format. If `false`, message content is returned in the raw Markdown-format text that user entered.  See [Markdown message formatting](/api/message-formatting) for details on Zulip's HTML format.  (default: true, e.g. false)
  --use-first-unread-anchor: string@bool-completer # Legacy way to specify `"anchor": "first_unread"` in Zulip 2.1.x and older.  Whether to use the (computed by the server) first unread message matching the narrow as the `anchor`. Mutually exclusive with `anchor`.  **Changes**: Deprecated in Zulip 3.0 (feature level 1) and replaced by `"anchor": "first_unread"`.  (DEPRECATED, default: false, e.g. true)
...
export def "messages send-message" [
  ...
  --read-by-sender: string@bool-completer # Whether the message should be initially marked read by its sender. If unspecified, the server uses a heuristic based on the client name.  **Changes**: New in Zulip 8.0 (feature level 236).  (e.g. true)
...
export def "messages-flags-narrow update-message-flags-for-narrow" [
  ...
  --allow-errors(-e) # Return full response without error handling
  anchor: any
  --include-anchor: string@bool-completer # Whether a message with the specified ID matching the narrow should be included in the update range.  (default: true, e.g. false)
...
export def "messages update-message" [
  ...
  --send-notification-to-old-thread: string@bool-completer # Whether to send an automated message to the old topic to notify users where the messages were moved to.  **Changes**: Before Zulip 6.0 (feature level 152), this parameter had a default of `true` and was ignored unless the channel was changed.  New in Zulip 3.0 (feature level 9).  (default: false, e.g. true)
  --send-notification-to-new-thread: string@bool-completer # Whether to send an automated message to the new topic to notify users where the messages came from.  If the move is just [resolving/unresolving a topic](/help/resolve-a-topic), this parameter will not trigger an additional notification.  **Changes**: Before Zulip 6.0 (feature level 152), this parameter was ignored unless the channel was changed.  New in Zulip 3.0 (feature level 9).  (default: true, e.g. true)
...
export def "users get-users" [
  ...
  --allow-errors(-e) # Return full response without error handling
  --client-gravatar: string@bool-completer # Whether the client supports computing gravatars URLs. If enabled, `avatar_url` will be included in the response only if there is a Zulip avatar, and will be `null` for users who are using gravatar as their avatar. This option significantly reduces the compressed size of user data, since gravatar URLs are long, random strings and thus do not compress well. The `client_gravatar` field is set to `true` if clients can compute their own gravatars.  **Changes**: The default value of this parameter was `false` prior to Zulip 5.0 (feature level 92).  (default: true, e.g. false)
  --include-custom-profile-fields: string@bool-completer # Whether the client wants [custom profile field](/help/custom-profile-fields) data to be included in the response.  **Changes**: New in Zulip 2.1.0. Previous versions do not offer these data via the API.  (default: false, e.g. true)
...
export def "users-me-status update-status" [
  ...
  --allow-errors(-e) # Return full response without error handling
  --status-text: string # The text content of the status message. Sending the empty string will clear the user's status.  **Note**: The limit on the size of the message is 60 Unicode code points.  (e.g. on vacation)
  --away: string@bool-completer # Whether the user should be marked as "away".  **Changes**: Deprecated in Zulip 6.0 (feature level 148); starting with that feature level, `away` is a legacy way to access the user's `presence_enabled` setting, with `away = !presence_enabled`. To be removed in a future release.  (DEPRECATED, e.g. true)
  --emoji-name: string # The name for the emoji to associate with this status.  **Changes**: New in Zulip 5.0 (feature level 86).  (e.g. car)
  --emoji-code: string # A unique identifier, defining the specific emoji codepoint requested, within the namespace of the `reaction_type`.  **Changes**: New in Zulip 5.0 (feature level 86).  (e.g. 1f697)
  --reaction-type: string # A string indicating the type of emoji. Each emoji `reaction_type` has an independent namespace for values of `emoji_code`.  Must be one of the following values:  - `unicode_emoji` : In this namespace, `emoji_code` will be a   dash-separated hex encoding of the sequence of Unicode codepoints   that define this emoji in the Unicode specification.  - `realm_emoji` : In this namespace, `emoji_code` will be the ID of   the uploaded [custom emoji](/help/custom-emoji).  - `zulip_extra_emoji` : These are special emoji included with Zulip.   In this namespace, `emoji_code` will be the name of the emoji (e.g.   "zulip").  **Changes**: New in Zulip 5.0 (feature level 86).  (e.g. unicode_emoji)
]: any -> any {
...
export def "users-me-topics get-stream-topics" [
  ...
  --raw(-r) # Fetch as text
  --allow-errors(-e) # Return full response without error handling
  --allow-empty-topic-name: string@bool-completer # Whether the client supports processing the empty string as a topic name in the returned data.  If `false`, the value of `realm_empty_topic_display_name` found in the [`POST /register`](/api/register-queue) response is returned replacing the empty string as the topic name.  **Changes**: New in Zulip 10.0 (feature level 334). Previously, the empty string was not a valid topic.  (default: false, e.g. true)
...
export def "realm-domains add-realm-domain" [
  ...
  --allow-subdomains: string@bool-completer # Whether subdomains are allowed for this domain.  (e.g. false)
...
export def "realm-domains patch-realm-domain" [
  ...
  --raw(-r) # Fetch as text
  --allow-errors(-e) # Return full response without error handling
  --allow-subdomains: string@bool-completer # Whether subdomains are allowed for this domain.  (e.g. true)
]: any -> any {
  let input = $in
  let auth = (build-auth $token ($auth_scheme | default "basic"))
  let base = ($base_url | default $BASE_URL)
...
export def "realm-profile-fields create-custom-profile-field" [
  ...
  --display-in-profile-summary: string@bool-completer # Whether clients should display this profile field in a summary section of a user's profile (or in a more easily accessible "small profile").  At most 2 profile fields may have this property be true in a given organization.  The "Users" profile field is not supported, but that is likely to be temporary.  [profile-field-types]: /help/custom-profile-fields#profile-field-types  **Changes**: Before Zulip 12.0 (feature level 476), the "Paragraph" field type was not supported.  New in Zulip 6.0 (feature level 146).  (e.g. true)
  --required: string@bool-completer # Whether an organization administrator has configured this profile field as required.  Because the required property is mutable, clients cannot assume that a required custom profile field has a value. The Zulip web application displays a prominent banner to any user who has not set a value for a required field.  **Changes**: New in Zulip 9.0 (feature level 244).  (e.g. true)
  --editable-by-user: string@bool-completer # Whether regular users can edit this profile field on their own account.  Note that organization administrators can edit custom profile fields for any user regardless of this setting.  **Changes**: New in Zulip 10.0 (feature level 296).  (e.g. true)
  --use-for-user-matching: string@bool-completer # Whether this custom profile field should be used to match users in typeahead suggestions. Only allowed for Short Text and External Account [profile field types](/help/custom-profile-fields#profile-field-types).  This field is only included when its value is `true`.  **Changes**: New in Zulip 12.0 (feature level 455).  (e.g. false)
...
export def "realm-user-settings-defaults update-realm-user-settings-defaults" [
  ...
  --raw(-r) # Fetch as text
  --allow-errors(-e) # Return full response without error handling
  --starred-message-counts: string@bool-completer # Whether clients should display the [number of starred messages](/help/star-a-message#display-the-number-of-starred-messages).  (e.g. true)
  --receives-typing-notifications: string@bool-completer # Whether the user is configured to receive typing notifications from other users. The server will only deliver typing notifications events to users who for whom this is enabled.  **Changes**: New in Zulip 9.0 (feature level 253). Previously, there were only options to disable sending typing notifications.  (e.g. true)
  --web-suggest-update-timezone: string@bool-completer # Whether the user should be shown an alert, offering to update their [profile time zone](/help/change-your-timezone), when the time displayed for the profile time zone differs from the current time displayed by the time zone configured on their device.  **Changes**: New in Zulip 10.0 (feature level 329).  (e.g. true)
  --fluid-layout-width: string@bool-completer # Whether to use the [maximum available screen width](/help/enable-full-width-display) for the web app's center panel (message feed, recent conversations) on wide screens.  (e.g. true)
  --high-contrast-mode: string@bool-completer # This setting is reserved for use to control variations in Zulip's design to help visually impaired users.  (e.g. true)
  ...
  --enable-drafts-synchronization: string@bool-completer # A boolean parameter to control whether synchronizing drafts is enabled for the user. When synchronization is disabled, all drafts stored in the server will be automatically deleted from the server.  This does not do anything (like sending events) to delete local copies of drafts stored in clients.  (e.g. true)
  --translate-emoticons: string@bool-completer # Whether to [translate emoticons to emoji](/help/configure-emoticon-translations) in messages the user sends.  (e.g. true)
  --display-emoji-reaction-users: string@bool-completer # Whether to display the names of reacting users on a message.  When enabled, clients should display the names of reacting users, rather than a count, for messages with few total reactions. The ideal cutoff may depend on the space available for displaying reactions; the official web application displays names when 3 or fewer total reactions are present with this setting enabled.  **Changes**: New in Zulip 6.0 (feature level 125).  (e.g. false)
  ...
  --web-escape-navigates-to-home-view: string@bool-completer # Whether the escape key navigates to the [configured home view](/help/configure-home-view).  **Changes**: New in Zulip 8.0 (feature level 219). Previously, this was called `escape_navigates_to_default_view`, which was new in Zulip 5.0 (feature level 107).  (e.g. true)
  --left-side-userlist: string@bool-completer # Whether the users list on left sidebar in narrow windows.  This feature is not heavily used and is likely to be reworked.  (e.g. true)
  ...
  --hide-ai-features: string@bool-completer # Controls whether user wants AI features like topic summarization to be hidden in all Zulip clients.  **Changes**: New in Zulip 10.0 (feature level 350).
  --web-inbox-show-channel-folders: string@bool-completer # Determines whether [channel folders](/help/channel-folders) are used to organize how conversations with unread messages are displayed in the web/desktop application's Inbox view.  **Changes**: New in Zulip 12.0 (feature level 431).  (e.g. true)
  --web-left-sidebar-show-channel-folders: string@bool-completer # Determines whether [channel folders](/help/channel-folders) are used to organize how channels are displayed in the web/desktop application's left sidebar.  **Changes**: New in Zulip 11.0 (feature level 411).  (e.g. true)
  --web-left-sidebar-unreads-count-summary: string@bool-completer # Determines whether the web/desktop application's left sidebar displays the unread message count summary.  **Changes**: New in Zulip 11.0 (feature level 398).  (e.g. true)
  --enable-stream-desktop-notifications: string@bool-completer # Enable visual desktop notifications for channel messages.  (e.g. true)
  --enable-stream-email-notifications: string@bool-completer # Enable email notifications for channel messages.  (e.g. true)
  --enable-stream-push-notifications: string@bool-completer # Enable mobile notifications for channel messages.  (e.g. true)
  --enable-stream-audible-notifications: string@bool-completer # Enable audible desktop notifications for channel messages.  (e.g. true)
  --notification-sound: string # Notification sound name.  (e.g. ding)
  --enable-desktop-notifications: string@bool-completer # Enable visual desktop notifications for direct messages and @-mentions.  (e.g. true)
  --enable-sounds: string@bool-completer # Enable audible desktop notifications for direct messages and @-mentions.  (e.g. true)
  --enable-followed-topic-desktop-notifications: string@bool-completer # Enable visual desktop notifications for messages sent to followed topics.  **Changes**: New in Zulip 8.0 (feature level 189).  (e.g. true)
  --enable-followed-topic-email-notifications: string@bool-completer # Enable email notifications for messages sent to followed topics.  **Changes**: New in Zulip 8.0 (feature level 189).  (e.g. true)
  --enable-followed-topic-push-notifications: string@bool-completer # Enable push notifications for messages sent to followed topics.  **Changes**: New in Zulip 8.0 (feature level 189).  (e.g. false)
  --enable-followed-topic-audible-notifications: string@bool-completer # Enable audible desktop notifications for messages sent to followed topics.  **Changes**: New in Zulip 8.0 (feature level 189).  (e.g. false)
  ...
  --enable-offline-email-notifications: string@bool-completer # Enable email notifications for direct messages and @-mentions received when the user is offline.  (e.g. true)
  --enable-offline-push-notifications: string@bool-completer # Enable mobile notification for direct messages and @-mentions received when the user is offline.  (e.g. true)
  --enable-online-push-notifications: string@bool-completer # Enable mobile notification for direct messages and @-mentions received when the user is online.  (e.g. true)
  --enable-digest-emails: string@bool-completer # Enable digest emails when the user is away.  (e.g. true)
  --message-content-in-email-notifications: string@bool-completer # Include the message's content in email notifications for new messages.  (e.g. true)
  --pm-content-in-desktop-notifications: string@bool-completer # Include content of direct messages in desktop notifications.  (e.g. true)
  --wildcard-mentions-notify: string@bool-completer # Whether wildcard mentions (E.g. @**all**) should send notifications like a personal mention.  (e.g. true)
  --enable-followed-topic-wildcard-mentions-notify: string@bool-completer # Whether wildcard mentions (e.g., @**all**) in messages sent to followed topics should send notifications like a personal mention.  **Changes**: New in Zulip 8.0 (feature level 189).  (e.g. true)
  ...
  --automatically-follow-topics-where-mentioned: string@bool-completer # Whether the server will automatically mark the user as following topics where the user is mentioned.  **Changes**: New in Zulip 8.0 (feature level 235).  (e.g. true)
  ...
  --presence-enabled: string@bool-completer # Display the presence status to other users when online.  (e.g. true)
  --enter-sends: string@bool-completer # Whether pressing Enter in the compose box sends a message (or saves a message edit).  (e.g. true)
  --twenty-four-hour-time: string@bool-completer # Whether time should be [displayed in 24-hour notation](/help/change-the-time-format).  **Changes**: New in Zulip 5.0 (feature level 99). Previously, this default was edited using the `default_twenty_four_hour_time` parameter to the `PATCH /realm` endpoint.  (e.g. true)
  --send-private-typing-notifications: string@bool-completer # Whether [typing notifications](/help/typing-notifications) be sent when composing direct messages.  **Changes**: New in Zulip 5.0 (feature level 105).  (e.g. true)
  --send-stream-typing-notifications: string@bool-completer # Whether [typing notifications](/help/typing-notifications) be sent when composing channel messages.  **Changes**: New in Zulip 5.0 (feature level 105).  (e.g. true)
  --send-read-receipts: string@bool-completer # Whether other users are allowed to see whether you've read messages.  **Changes**: New in Zulip 5.0 (feature level 105).  (e.g. true)
  ...
  --web-navigate-to-sent-message: string@bool-completer # Web/desktop app setting for whether the user's view should automatically go to the conversation where they sent a message.  **Changes**: New in Zulip 9.0 (feature level 268). Previously, this behavior was not configurable.  (e.g. true)
]: any -> any {
  let input = $in
  let auth = (build-auth $token ($auth_scheme | default "basic"))
  let base = ($base_url | default $BASE_URL)
...
export def "invites send-invites" [
  ...
  --include-realm-default-subscriptions: string@bool-completer # Boolean indicating whether the newly created user should be subscribed to the [default channels][default-channels] for the organization.  Note that this parameter can be `true` even if the user creating the invitation does not generally have permission to [subscribe other users to channels][can-subscribe-others].  **Changes**: New in Zulip 9.0 (feature level 261). Previous versions of Zulip behaved as though this parameter was always `false`; clients needed to include the organization's default channels in the `stream_ids` parameter for a newly created user to be automatically subscribed to them.  [default-channels]: /help/set-default-channels-for-new-users [can-subscribe-others]: /help/configure-who-can-invite-to-channels  (default: false, e.g. false)
  --notify-referrer-on-join: string@bool-completer # A boolean indicating whether the referrer would like to receive a direct message from [notification bot](/help/configure-automated-notices) when a user account is created using this invitation.  **Changes**: New in Zulip 9.0 (feature level 267). Previously, referrers always received such direct messages.  (default: true, e.g. false)
...
export def "invites-multiuse create-invite-link" [
  ...
  --include-realm-default-subscriptions: string@bool-completer # Boolean indicating whether the newly created user should be subscribed to the [default channels][default-channels] for the organization.  Note that this parameter can be `true` even if the current user does not generally have permission to [subscribe other users to channels][can-subscribe-others].  **Changes**: New in Zulip 9.0 (feature level 261). Previous versions of Zulip behaved as though this parameter was always `false`; clients needed to include the organization's default channels in the `stream_ids` parameter for a newly created user to be automatically subscribed to them.  [default-channels]: /help/set-default-channels-for-new-users [can-subscribe-others]: /help/configure-who-can-invite-to-channels  (default: false, e.g. false)
  --welcome-message-custom-text: string # Custom message text, in Zulip Markdown format, to be sent by the Welcome Bot to new users that join the organization via this invitation.  Maximum length is 8000 Unicode code points.  Only organization administrators can use this feature; for other users, the value is always `null`.  - `null`: the organization's default `welcome_message_custom_text` is used. - Empty string: no Welcome Bot custom message is sent. - Otherwise, the provided string is the custom message.  **Changes**: New in Zulip 11.0 (feature level 416).  (nullable, e.g. Welcome to Zulip! We're excited to have you on board.)
...
export def "register register-queue" [
  ...
  --raw(-r) # Fetch as text
  --allow-errors(-e) # Return full response without error handling
  --apply-markdown: string@bool-completer # Set to `true` if you would like the content to be rendered in HTML format (otherwise the API will return the raw text that the user entered)  (default: false, e.g. true)
  --client-gravatar: string@bool-completer # Whether the client supports computing gravatars URLs. If enabled, `avatar_url` will be included in the response only if there is a Zulip avatar, and will be `null` for users who are using gravatar as their avatar. This option significantly reduces the compressed size of user data, since gravatar URLs are long, random strings and thus do not compress well. The `client_gravatar` field is set to `true` if clients can compute their own gravatars.  The default value is `true` for authenticated requests and `false` for [unauthenticated requests](/help/public-access-option). Passing `true` in an unauthenticated request is an error.  **Changes**: Before Zulip 6.0 (feature level 149), this parameter was silently ignored and processed as though it were `false` in unauthenticated requests.  (e.g. false)
  ...
  --slim-presence: string@bool-completer # If `true`, the `presences` object returned in the response will be keyed by user ID and the entry for each user's presence data will be in the modern format.  **Changes**: New in Zulip 3.0 (no feature level; API unstable).  (default: false, e.g. true)
  ...
  --all-public-streams: string@bool-completer # Whether you would like to request message events from all public channels. Useful for workflow bots that you'd like to see all new messages sent to public channels. (You can also subscribe the user to private channels).  (default: false, e.g. true)
...
export def "settings update-settings" [
  ...
  --twenty-four-hour-time: string@bool-completer # Whether time should be [displayed in 24-hour notation](/help/change-the-time-format).  **Changes**: Before Zulip 5.0 (feature level 80), this setting was managed by the `PATCH /settings/display` endpoint.  (e.g. true)
  --web-mark-read-on-scroll-policy: int@web-mark-read-on-scroll-policy-completer # Whether or not to mark messages as read when the user scrolls through their feed.  - 1 - Always - 2 - Only in conversation views - 3 - Never  **Changes**: New in Zulip 7.0 (feature level 175). Previously, there was no way for the user to configure this behavior on the web, and the Zulip web and desktop apps behaved like the "Always" setting when marking messages as read.  (e.g. 1)
  ...
  --starred-message-counts: string@bool-completer # Whether clients should display the [number of starred messages](/help/star-a-message#display-the-number-of-starred-messages).  **Changes**: Before Zulip 5.0 (feature level 80), this setting was managed by the `PATCH /settings/display` endpoint.  (e.g. true)
  --receives-typing-notifications: string@bool-completer # Whether the user is configured to receive typing notifications from other users. The server will only deliver typing notifications events to users who for whom this is enabled.  By default, this is set to true, enabling user to receive typing notifications from other users.  **Changes**: New in Zulip 9.0 (feature level 253). Previously, there were only options to disable sending typing notifications.  (e.g. true)
  --web-suggest-update-timezone: string@bool-completer # Whether the user should be shown an alert, offering to update their [profile time zone](/help/change-your-timezone), when the time displayed for the profile time zone differs from the current time displayed by the time zone configured on their device.  **Changes**: New in Zulip 10.0 (feature level 329).  (e.g. true)
  --fluid-layout-width: string@bool-completer # Whether to use the [maximum available screen width](/help/enable-full-width-display) for the web app's center panel (message feed, recent conversations) on wide screens.  **Changes**: Before Zulip 5.0 (feature level 80), this setting was managed by the `PATCH /settings/display` endpoint.  (e.g. true)
  --high-contrast-mode: string@bool-completer # This setting is reserved for use to control variations in Zulip's design to help visually impaired users.  **Changes**: Before Zulip 5.0 (feature level 80), this setting was managed by the `PATCH /settings/display` endpoint.  (e.g. true)
  --web-font-size-px: int # User-configured primary `font-size` for the web application, in pixels.  **Changes**: New in Zulip 9.0 (feature level 245). Previously, font size was only adjustable via browser zoom. Note that this setting was not fully implemented at this feature level.  (e.g. 14)
  --web-line-height-percent: int # User-configured primary `line-height` for the web application, in percent, so a value of 120 represents a `line-height` of 1.2.  **Changes**: New in Zulip 9.0 (feature level 245). Previously, line height was not user-configurable. Note that this setting was not fully implemented at this feature level.  (e.g. 122)
  ...
  --enable-drafts-synchronization: string@bool-completer # A boolean parameter to control whether synchronizing drafts is enabled for the user. When synchronization is disabled, all drafts stored in the server will be automatically deleted from the server.  This does not do anything (like sending events) to delete local copies of drafts stored in clients.  **Changes**: New in Zulip 5.0 (feature level 87).  (e.g. true)
  --translate-emoticons: string@bool-completer # Whether to [translate emoticons to emoji](/help/configure-emoticon-translations) in messages the user sends.  **Changes**: Before Zulip 5.0 (feature level 80), this setting was managed by the `PATCH /settings/display` endpoint.  (e.g. true)
  --display-emoji-reaction-users: string@bool-completer # Whether to display the names of reacting users on a message.  When enabled, clients should display the names of reacting users, rather than a count, for messages with few total reactions. The ideal cutoff may depend on the space available for displaying reactions; the official web application displays names when 3 or fewer total reactions are present with this setting enabled.  **Changes**: New in Zulip 6.0 (feature level 125).  (e.g. false)
  ...
  --web-escape-navigates-to-home-view: string@bool-completer # Whether the escape key navigates to the [configured home view](/help/configure-home-view).  **Changes**: New in Zulip 8.0 (feature level 219). Previously, this was called `escape_navigates_to_default_view`, which was new in Zulip 5.0 (feature level 107).  (e.g. true)
  --left-side-userlist: string@bool-completer # Whether the users list on left sidebar in narrow windows.  This feature is not heavily used and is likely to be reworked.  **Changes**: Before Zulip 5.0 (feature level 80), this setting was managed by the `PATCH /settings/display` endpoint.  (e.g. true)
  ...
  --web-stream-unreads-count-display-policy: int@web-stream-unreads-count-display-policy-completer # Configuration for which channels should be displayed with a numeric unread count in the left sidebar. Channels that do not have an unread count will have a simple dot indicator for whether there are any unread messages.  - 1 - All channels - 2 - Unmuted channels and topics - 3 - No channels  **Changes**: New in Zulip 8.0 (feature level 210).  (e.g. 2)
  --hide-ai-features: string@bool-completer # Controls whether user wants AI features like topic summarization to be hidden in all Zulip clients.  **Changes**: New in Zulip 10.0 (feature level 350).
  --web-inbox-show-channel-folders: string@bool-completer # Determines whether [channel folders](/help/channel-folders) are used to organize how conversations with unread messages are displayed in the web/desktop application's Inbox view.  **Changes**: New in Zulip 12.0 (feature level 431).
  --web-left-sidebar-show-channel-folders: string@bool-completer # Determines whether [channel folders](/help/channel-folders) are used to organize how channels are displayed in the web/desktop application's left sidebar.  **Changes**: New in Zulip 11.0 (feature level 411).  (e.g. true)
  --web-left-sidebar-unreads-count-summary: string@bool-completer # Determines whether the web/desktop application's left sidebar displays the unread message count summary.  **Changes**: New in Zulip 11.0 (feature level 398).  (e.g. true)
  ...
  --enable-stream-desktop-notifications: string@bool-completer # Enable visual desktop notifications for channel messages.  **Changes**: Before Zulip 5.0 (feature level 80), this setting was managed by the `PATCH /settings/notifications` endpoint.  (e.g. true)
  --enable-stream-email-notifications: string@bool-completer # Enable email notifications for channel messages.  **Changes**: Before Zulip 5.0 (feature level 80), this setting was managed by the `PATCH /settings/notifications` endpoint.  (e.g. true)
  --enable-stream-push-notifications: string@bool-completer # Enable mobile notifications for channel messages.  **Changes**: Before Zulip 5.0 (feature level 80), this setting was managed by the `PATCH /settings/notifications` endpoint.  (e.g. true)
  --enable-stream-audible-notifications: string@bool-completer # Enable audible desktop notifications for channel messages.  **Changes**: Before Zulip 5.0 (feature level 80), this setting was managed by the `PATCH /settings/notifications` endpoint.  (e.g. true)
  ...
  --enable-desktop-notifications: string@bool-completer # Enable visual desktop notifications for direct messages and @-mentions.  **Changes**: Before Zulip 5.0 (feature level 80), this setting was managed by the `PATCH /settings/notifications` endpoint.  (e.g. true)
  --enable-sounds: string@bool-completer # Enable audible desktop notifications for direct messages and @-mentions.  **Changes**: Before Zulip 5.0 (feature level 80), this setting was managed by the `PATCH /settings/notifications` endpoint.  (e.g. true)
  ...
  --enable-offline-email-notifications: string@bool-completer # Enable email notifications for direct messages and @-mentions received when the user is offline.  **Changes**: Before Zulip 5.0 (feature level 80), this setting was managed by the `PATCH /settings/notifications` endpoint.  (e.g. true)
  --enable-offline-push-notifications: string@bool-completer # Enable mobile notification for direct messages and @-mentions received when the user is offline.  **Changes**: Before Zulip 5.0 (feature level 80), this setting was managed by the `PATCH /settings/notifications` endpoint.  (e.g. true)
  --enable-online-push-notifications: string@bool-completer # Enable mobile notification for direct messages and @-mentions received when the user is online.  **Changes**: Before Zulip 5.0 (feature level 80), this setting was managed by the `PATCH /settings/notifications` endpoint.  (e.g. true)
  --enable-followed-topic-desktop-notifications: string@bool-completer # Enable visual desktop notifications for messages sent to followed topics.  **Changes**: New in Zulip 8.0 (feature level 189).  (e.g. true)
  --enable-followed-topic-email-notifications: string@bool-completer # Enable email notifications for messages sent to followed topics.  **Changes**: New in Zulip 8.0 (feature level 189).  (e.g. true)
  --enable-followed-topic-push-notifications: string@bool-completer # Enable push notifications for messages sent to followed topics.  **Changes**: New in Zulip 8.0 (feature level 189).  (e.g. false)
  --enable-followed-topic-audible-notifications: string@bool-completer # Enable audible desktop notifications for messages sent to followed topics.  **Changes**: New in Zulip 8.0 (feature level 189).  (e.g. false)
  --enable-digest-emails: string@bool-completer # Enable digest emails when the user is away.  **Changes**: Before Zulip 5.0 (feature level 80), this setting was managed by the `PATCH /settings/notifications` endpoint.  (e.g. true)
  --enable-marketing-emails: string@bool-completer # Enable marketing emails. Has no function outside Zulip Cloud.  **Changes**: Before Zulip 5.0 (feature level 80), this setting was managed by the `PATCH /settings/notifications` endpoint.  (e.g. true)
  --enable-login-emails: string@bool-completer # Enable email notifications for new logins to account.  **Changes**: Before Zulip 5.0 (feature level 80), this setting was managed by the `PATCH /settings/notifications` endpoint.  (e.g. true)
  --message-content-in-email-notifications: string@bool-completer # Include the message's content in email notifications for new messages.  **Changes**: Before Zulip 5.0 (feature level 80), this setting was managed by the `PATCH /settings/notifications` endpoint.  (e.g. true)
  --pm-content-in-desktop-notifications: string@bool-completer # Include content of direct messages in desktop notifications.  **Changes**: Before Zulip 5.0 (feature level 80), this setting was managed by the `PATCH /settings/notifications` endpoint.  (e.g. true)
  --wildcard-mentions-notify: string@bool-completer # Whether wildcard mentions (E.g. @**all**) should send notifications like a personal mention.  **Changes**: Before Zulip 5.0 (feature level 80), this setting was managed by the `PATCH /settings/notifications` endpoint.  (e.g. true)
  --enable-followed-topic-wildcard-mentions-notify: string@bool-completer # Whether wildcard mentions (e.g., @**all**) in messages sent to followed topics should send notifications like a personal mention.  **Changes**: New in Zulip 8.0 (feature level 189).  (e.g. true)
  ...
  --automatically-follow-topics-where-mentioned: string@bool-completer # Whether the server will automatically mark the user as following topics where the user is mentioned.  **Changes**: New in Zulip 8.0 (feature level 235).  (e.g. true)
  --resolved-topic-notice-auto-read-policy: string@resolved-topic-notice-auto-read-policy-completer # Controls whether the resolved-topic notices are marked as read.  - "always" - Always mark resolved-topic notices as read. - "except_followed" - Mark resolved-topic notices as read in topics not followed by the user. - "never" - Never mark resolved-topic notices as read.  **Changes**: New in Zulip 11.0 (feature level 385).  (e.g. except_followed)
  --presence-enabled: string@bool-completer # Display the presence status to other users when online.  **Changes**: Before Zulip 5.0 (feature level 80), this setting was managed by the `PATCH /settings/notifications` endpoint.  (e.g. true)
  --enter-sends: string@bool-completer # Whether pressing Enter in the compose box sends a message (or saves a message edit).  **Changes**: Before Zulip 5.0 (feature level 81), this setting was managed by the `POST /users/me/enter-sends` endpoint, with the same parameter format.  (e.g. true)
  --send-private-typing-notifications: string@bool-completer # Whether [typing notifications](/help/typing-notifications) be sent when composing direct messages.  **Changes**: New in Zulip 5.0 (feature level 105).  (e.g. true)
  --send-stream-typing-notifications: string@bool-completer # Whether [typing notifications](/help/typing-notifications) be sent when composing channel messages.  **Changes**: New in Zulip 5.0 (feature level 105).  (e.g. true)
  --send-read-receipts: string@bool-completer # Whether other users are allowed to see whether you've read messages.  **Changes**: New in Zulip 5.0 (feature level 105).  (e.g. true)
  --allow-private-data-export: string@bool-completer # Whether organization administrators are allowed to export your private data.  **Changes**: New in Zulip 10.0 (feature level 293).  (e.g. true)
...
export def "streams get-streams" [
  ...
  --raw(-r) # Fetch as text
  --allow-errors(-e) # Return full response without error handling
  --include-public: string@bool-completer # Include all public channels.  (default: true, e.g. false)
  --include-web-public: string@bool-completer # Include all web-public channels.  (default: false, e.g. true)
  --include-subscribed: string@bool-completer # Include all channels that the user is subscribed to.  (default: true, e.g. false)
  --exclude-archived: string@bool-completer # Whether to exclude archived streams from the results.  **Changes**: New in Zulip 10.0 (feature level 315).  (default: true, e.g. true)
  --include-all-active: string@bool-completer # Deprecated parameter to include all channels. The user must have administrative privileges to use this parameter.  **Changes**: Deprecated in Zulip 10.0 (feature level 356). Clients interacting with newer servers should use the equivalent `include_all` parameter, which does not incorrectly hint that this parameter, and not `exclude_archived`, controls whether archived channels appear in the response.  (DEPRECATED, default: false, e.g. true)
  --include-all: string@bool-completer # Include all channels that the user has metadata access to.  For organization administrators, this will be all channels in the organization, since organization administrators implicitly have metadata access to all channels.  **Changes**: New in Zulip 10.0 (feature level 356). On older versions, use `include_all_active`, which this replaces.  (default: false, e.g. true)
  --include-default: string@bool-completer # Include all default channels for the user's realm.  (default: false, e.g. true)
  --include-owner-subscribed: string@bool-completer # If the user is a bot, include all channels that the bot's owner is subscribed to.  (default: false, e.g. true)
  --include-can-access-content: string@bool-completer # Include all the channels that the user has content access to.  **Changes**: New in Zulip 10.0 (feature level 356).  (default: false, e.g. true)
...
export def "streams update-stream" [
  ...
  --is-private: string@bool-completer # Change whether the channel is a private channel.  (e.g. true)
  --is-web-public: string@bool-completer # Change whether the channel is a web-public channel.  Note that creating web-public channels requires the `WEB_PUBLIC_STREAMS_ENABLED` [server setting][server-settings] to be enabled on the Zulip server in question, the organization to have enabled the `enable_spectator_access` realm setting, and the current use to have permission under the organization's `can_create_web_public_channel_group` realm setting.  [server-settings]: https://zulip.readthedocs.io/en/stable/production/settings.html  **Changes**: New in Zulip 5.0 (feature level 98).  (e.g. true)
  --history-public-to-subscribers: string@bool-completer # Whether the channel's message history should be available to newly subscribed members, or users can only access messages they actually received while subscribed to the channel.  Corresponds to the shared history option for [private channels](/help/channel-permissions#private-channels).  It's an error for this parameter to be false for a public or web-public channel and when is_private is false.  This can only be `false` if `can_create_topic_group` for the channel is the `role:everyone` [system group][system-groups].  **Changes**: Before Zulip 6.0 (feature level 136), `history_public_to_subscribers` was silently ignored unless the request also contained either `is_private` or `is_web_public`.  [system-groups]: /api/group-setting-values#system-groups  (e.g. false)
  --is-default-stream: string@bool-completer # Add or remove the channel as a [default channel][default-channel] for new users joining the organization.  [default-channel]: /help/set-default-channels-for-new-users  **Changes**: New in Zulip 8.0 (feature level 200). Previously, default channel status could only be changed using the [dedicated API endpoint](/api/add-default-stream).  (e.g. false)
  --message-retention-days: any # Number of days that messages sent to this channel will be stored before being automatically deleted by the [message retention policy](/help/message-retention-policy). Two special string format values are supported:  - `"realm_default"`: Return to the organization-level setting. - `"unlimited"`: Retain messages forever.  **Changes**: Prior to Zulip 5.0 (feature level 91), retaining messages forever was encoded using `"forever"` instead of `"unlimited"`.  New in Zulip 3.0 (feature level 17).  (e.g. 20)
  --is-archived: string@bool-completer # A boolean indicating whether the channel is [archived](/help/archive-a-channel) or unarchived. Currently only allows unarchiving previously archived channels.  **Changes**: New in Zulip 11.0 (feature level 388).  (e.g. true)
...
export def "channels-create create-channel" [
  ...
  --announce: string@bool-completer # This determines whether [notification bot](/help/configure-automated-notices) will send an announcement about the new channel's creation.  (default: false, e.g. true)
  --invite-only: string@bool-completer # This parameter and the ones that follow are used to request an initial configuration of the new channel.  This parameter determines whether the newly created channel will be a [private channel](/help/channel-permissions#private-channels).  (default: false, e.g. true)
  --is-web-public: string@bool-completer # This parameter determines whether the newly created channel will be a web-public channel.  Note that creating web-public channels requires the `WEB_PUBLIC_STREAMS_ENABLED` [server setting][server-settings] to be enabled on the Zulip server in question, the organization to have enabled the `enable_spectator_access` realm setting, and the current user to have permission under the organization's `can_create_web_public_channel_group` realm setting.  [server-settings]: https://zulip.readthedocs.io/en/stable/production/settings.html  (default: false, e.g. true)
  --is-default-stream: string@bool-completer # This parameter determines whether the newly created channel will be added as a [default channel][default-channels] for new users joining the organization.  [default-channels]: /help/set-default-channels-for-new-users  (default: false, e.g. true)
  --folder-id: int # This parameter adds the newly created channel to the specified [channel folder](/help/channel-folders).  **Changes**: New in Zulip 11.0 (feature level 389).  (e.g. 1)
  --topics-policy: string@topics-policy-completer # Whether [named topics](/help/introduction-to-topics) and the empty topic (i.e., ["general chat" topic](/help/general-chat-topic)) are enabled in this channel.  - `"inherit"`: Messages can be sent to named topics in this channel,   and the [organization-level `realm_topics_policy`][realm-topics-policy]   is used for whether messages can be sent to the empty topic in this   channel. - `"allow_empty_topic"`: Messages can be sent to both named topics and   the empty topic in this channel. - `"disable_empty_topic"`: Messages can be sent to named topics in this   channel, but the empty topic is disabled. - `"empty_topic_only"`: Messages can be sent to the empty topic in this   channel, but named topics are disabled. See ["general chat"   channels](/help/general-chat-channels).  The `"empty_topic_only"` policy can only be set if all existing messages in the channel are already in the empty topic.  When creating a new channel, if the `topics_policy` is not specified, the `"inherit"` option will be set.  **Changes**: In Zulip 11.0 (feature level 404), the `"empty_topic_only"` option was added.  New in Zulip 11.0 (feature level 392).  [realm-topics-policy]: /help/require-topics#set-the-default-general-chat-topic-configuration  (e.g. inherit)
  --history-public-to-subscribers: string@bool-completer # Whether the channel's message history should be available to newly subscribed members, or users can only access messages they actually received while subscribed to the channel.  Corresponds to the shared history option for [private channels](/help/channel-permissions#private-channels).  (e.g. false)
  --message-retention-days: any # Number of days that messages sent to this channel will be stored before being automatically deleted by the [message retention policy](/help/message-retention-policy). Two special string format values are supported:  - `"realm_default"`: Return to the organization-level setting. - `"unlimited"`: Retain messages forever.  **Changes**: Prior to Zulip 5.0 (feature level 91), retaining messages forever was encoded using `"forever"` instead of `"unlimited"`.  New in Zulip 3.0 (feature level 17).  (e.g. 20)
...
export def "user-groups-members get-user-group-members" [
  ...
  --raw(-r) # Fetch as text
  --allow-errors(-e) # Return full response without error handling
  --direct-member-only: string@bool-completer # Whether to consider only the direct members of user group and not members of its subgroups. Default is `false`.  (e.g. false)
...
export def "user-groups update-user-group" [
  ...
  --deactivated: string@bool-completer # A deactivated user group can be reactivated by passing this parameter as `false`.  Passing `true` does nothing as user group is deactivated using [`POST /user_groups/{user_group_id}/deactivate`](deactivate-user-group) endpoint.  **Changes**: New in Zulip 11.0 (feature level 386).  (e.g. false)
]: any -> any {
  let input = $in
  let auth = (build-auth $token ($auth_scheme | default "basic"))
  let base = ($base_url | default $BASE_URL)
...
export def "user-groups get-user-groups" [
  ...
  --raw(-r) # Fetch as text
  --allow-errors(-e) # Return full response without error handling
  --include-deactivated-groups: string@bool-completer # Whether to include deactivated user groups in the response.  **Changes**: In Zulip 10.0 (feature level 294), renamed `allow_deactivated` to `include_deactivated_groups`.  New in Zulip 10.0 (feature level 290). Previously, deactivated user groups did not exist and thus would never be included in the response.  (default: false, e.g. true)
...
export def "user-groups-subgroups get-user-group-subgroups" [
  ...
  --raw(-r) # Fetch as text
  --allow-errors(-e) # Return full response without error handling
  --direct-subgroup-only: string@bool-completer # Whether to consider only direct subgroups of the user group or subgroups of subgroups also.  (default: false, e.g. true)
...
export def "channel-folders get-channel-folders" [
  ...
  --raw(-r) # Fetch as text
  --allow-errors(-e) # Return full response without error handling
  --include-archived: string@bool-completer # Whether to include archived channel folders in the response.  (default: false, e.g. true)
...
export def "channel-folders update-channel-folder" [
  ...
  --is-archived: string@bool-completer # Whether to archive or unarchive the channel folder.  (e.g. true)
]: any -> any {
  let input = $in
  let auth = (build-auth $token ($auth_scheme | default "basic"))
  let base = ($base_url | default $BASE_URL)
...
export def "calls-bigbluebutton-create create-big-blue-button-video-call" [
  ...
  --voice-only: string@bool-completer # Configures whether the call is voice-only; if true, disables cameras for all users. Only the call creator/moderator can edit this configuration.  **Changes**: New in Zulip 10.0 (feature level 337).  (e.g. true)
]: nothing -> record<result: any, msg: any, ignored_parameters_unsupported: any, url: string> {
  let auth = (build-auth $token ($auth_scheme | default "basic"))
  let base = ($base_url | default $BASE_URL)
