...
export def "bot-message-reply replyMessage" [
  ...
  --notificationDisabled: string@bool-completer # `true`: The user doesn’t receive a push notification when a message is sent. `false`: The user receives a push notification when the message is sent (unless they have disabled push notifications in LINE and/or their device). The default value is false.  (default: false)
...
export def "bot-richmenu createRichMenu" [
  ...
  --selected: string@bool-completer # `true` to display the rich menu by default. Otherwise, `false`.
