...
export def commands []: nothing -> table {
  ...
  let mod_name = (scope modules | where { $in.commands | any { $in.name == "messages-send fcmprojectsmessagessend" } } | get name | first)
...
export def "messages-send fcmprojectsmessagessend" [
  parent: string
