...
export def "wiki-rest-audit createAuditRecord" [
  ...
  --sysAdmin: string@bool-completer # Indicates whether the event was actioned by a system administrator. (default: false)
...
export def "wiki-rest-content-pagehierarchy-copy copyPageHierarchy" [
  ...
  --raw(-r) # Fetch as text
  --allow-errors(-e) # Return full response without error handling
  --copyAttachments: string@bool-completer # If set to `true`, attachments are copied to the destination page. (default: false)
  --copyPermissions: string@bool-completer # If set to `true`, page permissions are copied to the destination page. (default: false)
  --copyProperties: string@bool-completer # If set to `true`, content properties are copied to the destination page. (default: false)
  --copyLabels: string@bool-completer # If set to `true`, labels are copied to the destination page. (default: false)
  --copyCustomContents: string@bool-completer # If set to `true`, custom contents are copied to the destination page. (default: false)
  --copyDescendants: string@bool-completer # If set to `true`, descendants are copied to the destination page. (default: true)
...
export def "wiki-rest-group-picker searchGroups" [
  ...
  --shouldReturnTotalSize: string@bool-completer # Whether to include total size parameter in the results. Note, fetching total size property is an expensive operation; use it if your use case needs this value. (default: false)
]: nothing -> record<results: table<type: string, name: string, id: string, usageType: string, managedBy: string, _links: record>, start: int, limit: int, size: int, totalSize: int, _links: record> {
  let auth = (build-auth $token ($auth_scheme | default "basic"))
  let base = ($base_url | default $BASE_URL)
...
export def "wiki-rest-search searchByCQL" [
  ...
  --cursor: string # Pointer to a set of search results, returned as part of the `next` or `prev` URL from the previous search call.
  --next: string@bool-completer # default: false
  --prev: string@bool-completer # default: false
  --limit: int # The maximum number of content objects to return per page. Note, this may be restricted by fixed system limits. (format: int32, default: 25)
  --start: int # The start point of the collection to return (format: int32, default: 0)
  --includeArchivedSpaces: string@bool-completer # Whether to include content from archived spaces in the results. (default: false)
  --excludeCurrentSpaces: string@bool-completer # Whether to exclude current spaces and only show archived spaces. (default: false)
