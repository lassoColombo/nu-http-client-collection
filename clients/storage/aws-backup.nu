...
export def "backup-plans ListBackupPlans" [
  ...
  --includeDeleted: string@bool-completer # A Boolean value with a default value of <code>FALSE</code> that returns deleted backup plans when set to <code>TRUE</code>.
