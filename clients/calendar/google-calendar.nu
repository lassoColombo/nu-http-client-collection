...
export def "calendars-acl calendaracllist" [
  ...
  --showDeleted: string@bool-completer # Whether to include deleted ACLs in the result. Deleted ACLs are represented by role equal to "none". Deleted ACLs will always be included if syncToken is provided. Optional. The default is False.
...
export def "calendars-acl calendaraclinsert" [
  ...
  --quotaUser: string # An opaque string that represents a user for quota purposes. Must not exceed 40 characters.
  --userIp: string # Deprecated. Please use quotaUser instead.
  --sendNotifications: string@bool-completer # Whether to send notifications about the calendar sharing change. Optional. The default is True.
  --etag: string # ETag of the resource.
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "alt" $alt "scalar") (serialize-qp "fields" $qp_fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "userIp" $userIp "scalar") (serialize-qp "sendNotifications" $sendNotifications "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/calendars/($calendarId)/acl" $qp)
...
export def "calendars-acl calendaraclpatch" [
  ...
  --quotaUser: string # An opaque string that represents a user for quota purposes. Must not exceed 40 characters.
  --userIp: string # Deprecated. Please use quotaUser instead.
  --sendNotifications: string@bool-completer # Whether to send notifications about the calendar sharing change. Note that there are no notifications on access removal. Optional. The default is True.
  --etag: string # ETag of the resource.
  --id: string # Identifier of the Access Control List (ACL) rule. See Sharing calendars.
  --kind: string # Type of the resource ("calendar#aclRule"). (default: calendar#aclRule)
  --role: string # The role assigned to the scope. Possible values are:   - "none" - Provides no access.  - "freeBusyReader" - Provides read access to free/busy information.  - "reader" - Provides read access to the calendar. Private events will appear to users with reader access, but event details will be hidden.  - "writer" - Provides read and write access to the calendar. Private events will appear to users with writer access, and event details will be visible.  - "owner" - Provides ownership of the calendar. This role has all of the permissions of the writer role with the additional ability to see and manipulate ACLs.
...
export def "calendars-events calendareventslist" [
  ...
  --quotaUser: string # An opaque string that represents a user for quota purposes. Must not exceed 40 characters.
  --userIp: string # Deprecated. Please use quotaUser instead.
  --alwaysIncludeEmail: string@bool-completer # Deprecated and ignored. A value will always be returned in the email field for the organizer, creator and attendees, even if no real email address is available (i.e. a generated, non-working value will be provided).
  ...
  --showDeleted: string@bool-completer # Whether to include deleted events (with status equals "cancelled") in the result. Cancelled instances of recurring events (but not the underlying recurring event) will still be included if showDeleted and singleEvents are both False. If showDeleted and singleEvents are both True, only single instances of deleted events (but not the underlying recurring events) are returned. Optional. The default is False.
  --showHiddenInvitations: string@bool-completer # Whether to include hidden invitations in the result. Optional. The default is False.
  --singleEvents: string@bool-completer # Whether to expand recurring events into instances and only return single one-off events and instances of recurring events, but not the underlying recurring events themselves. Optional. The default is False.
...
export def "calendars-events calendareventsinsert" [
  ...
  --maxAttendees: int # The maximum number of attendees to include in the response. If there are more than the specified number of attendees, only the participant is returned. Optional.
  --sendNotifications: string@bool-completer # Deprecated. Please use sendUpdates instead.  Whether to send notifications about the creation of the new event. Note that some emails might still be sent even if you set the value to false. The default is false.
  ...
  --supportsAttachments: string@bool-completer # Whether API client performing operation supports event attachments. Optional. The default is False.
  --anyoneCanAddSelf: string@bool-completer # Whether anyone can invite themselves to the event (deprecated). Optional. The default is False. (default: false)
  ...
  --endTimeUnspecified: string@bool-completer # Whether the end time is actually unspecified. An end time is still provided for compatibility reasons, even if this attribute is set to True. The default is False. (default: false)
  --etag: string # ETag of the resource.
  ...
  --guestsCanInviteOthers: string@bool-completer # Whether attendees other than the organizer can invite others to the event. Optional. The default is True. (default: true)
  --guestsCanModify: string@bool-completer # Whether attendees other than the organizer can modify the event. Optional. The default is False. (default: false)
  --guestsCanSeeOtherGuests: string@bool-completer # Whether attendees other than the organizer can see who the event's attendees are. Optional. The default is True. (default: true)
  ...
  --locked: string@bool-completer # Whether this is a locked event copy where no changes can be made to the main event fields "summary", "description", "location", "start", "end" or "recurrence". The default is False. Read-Only. (default: false)
  ...
  --privateCopy: string@bool-completer # If set to True, Event propagation is disabled. Note that it is not the same thing as Private event properties. Optional. Immutable. The default is False. (default: false)
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "alt" $alt "scalar") (serialize-qp "fields" $qp_fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "userIp" $userIp "scalar") (serialize-qp "conferenceDataVersion" $conferenceDataVersion "scalar") (serialize-qp "maxAttendees" $maxAttendees "scalar") (serialize-qp "sendNotifications" $sendNotifications "scalar") (serialize-qp "sendUpdates" $sendUpdates "scalar") (serialize-qp "supportsAttachments" $supportsAttachments "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/calendars/($calendarId)/events" $qp)
...
export def "calendars-events-import calendareventsimport" [
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "alt" $alt "scalar") (serialize-qp "fields" $qp_fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "userIp" $userIp "scalar") (serialize-qp "conferenceDataVersion" $conferenceDataVersion "scalar") (serialize-qp "supportsAttachments" $supportsAttachments "scalar")] | flatten | str join "&"
...
export def "calendars-events-quick-add calendareventsquickAdd" [
  ...
  --sendNotifications: string@bool-completer # Deprecated. Please use sendUpdates instead.  Whether to send notifications about the creation of the event. Note that some emails might still be sent even if you set the value to false. The default is false.
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "alt" $alt "scalar") (serialize-qp "fields" $qp_fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "userIp" $userIp "scalar") (serialize-qp "text" $text "scalar") (serialize-qp "sendNotifications" $sendNotifications "scalar") (serialize-qp "sendUpdates" $sendUpdates "scalar")] | flatten | str join "&"
...
export def "calendars-events calendareventsdelete" [
  ...
  --quotaUser: string # An opaque string that represents a user for quota purposes. Must not exceed 40 characters.
  --userIp: string # Deprecated. Please use quotaUser instead.
  --sendNotifications: string@bool-completer # Deprecated. Please use sendUpdates instead.  Whether to send notifications about the deletion of the event. Note that some emails might still be sent even if you set the value to false. The default is false.
  --sendUpdates: string@sendUpdates-completer # Guests who should receive notifications about the deletion of the event.
]: nothing -> any {
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "alt" $alt "scalar") (serialize-qp "fields" $qp_fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "userIp" $userIp "scalar") (serialize-qp "sendNotifications" $sendNotifications "scalar") (serialize-qp "sendUpdates" $sendUpdates "scalar")] | flatten | str join "&"
...
export def "calendars-events calendareventsget" [
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "alt" $alt "scalar") (serialize-qp "fields" $qp_fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "userIp" $userIp "scalar") (serialize-qp "alwaysIncludeEmail" $alwaysIncludeEmail "scalar") (serialize-qp "maxAttendees" $maxAttendees "scalar") (serialize-qp "timeZone" $timeZone "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/calendars/($calendarId)/events/($eventId)" $qp)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "get" $full_url $auth $insecure $raw $max_time $allow_errors "application/json"
...
export def "calendars-events calendareventspatch" [
  ...
  --conferenceDataVersion: int # Version number of conference data supported by the API client. Version 0 assumes no conference data support and ignores conference data in the event's body. Version 1 enables support for copying of ConferenceData as well as for creating new conferences using the createRequest field of conferenceData. The default is 0.
  --maxAttendees: int # The maximum number of attendees to include in the response. If there are more than the specified number of attendees, only the participant is returned. Optional.
  --sendNotifications: string@bool-completer # Deprecated. Please use sendUpdates instead.  Whether to send notifications about the event update (for example, description changes, etc.). Note that some emails might still be sent even if you set the value to false. The default is false.
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "alt" $alt "scalar") (serialize-qp "fields" $qp_fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "userIp" $userIp "scalar") (serialize-qp "alwaysIncludeEmail" $alwaysIncludeEmail "scalar") (serialize-qp "conferenceDataVersion" $conferenceDataVersion "scalar") (serialize-qp "maxAttendees" $maxAttendees "scalar") (serialize-qp "sendNotifications" $sendNotifications "scalar") (serialize-qp "sendUpdates" $sendUpdates "scalar") (serialize-qp "supportsAttachments" $supportsAttachments "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/calendars/($calendarId)/events/($eventId)" $qp)
  let body = {anyoneCanAddSelf: $anyoneCanAddSelf, attachments: $attachments, attendees: $attendees, attendeesOmitted: $attendeesOmitted, colorId: $colorId, conferenceData: $conferenceData, created: $created, creator: $creator, description: $description, end: $end, endTimeUnspecified: $endTimeUnspecified, etag: $etag, eventType: $eventType, extendedProperties: $extendedProperties, gadget: $gadget, guestsCanInviteOthers: $guestsCanInviteOthers, guestsCanModify: $guestsCanModify, guestsCanSeeOtherGuests: $guestsCanSeeOtherGuests, hangoutLink: $hangoutLink, htmlLink: $htmlLink, iCalUID: $iCalUID, id: $id, kind: $kind, location: $location, locked: $locked, organizer: $organizer, originalStartTime: $originalStartTime, privateCopy: $privateCopy, recurrence: $recurrence, recurringEventId: $recurringEventId, reminders: $reminders, sequence: $sequence, source: $body_source, start: $start, status: $status, summary: $summary, transparency: $transparency, updated: $updated, visibility: $visibility, workingLocationProperties: $workingLocationProperties} | compact
  let body = if ($input | describe | str starts-with "record") { $input | merge deep ($body | default {}) } else { $body }
  let accept_val = "application/json"
...
export def "calendars-events-instances calendareventsinstances" [
  ...
  --pageToken: string # Token specifying which result page to return. Optional.
  --showDeleted: string@bool-completer # Whether to include deleted events (with status equals "cancelled") in the result. Cancelled instances of recurring events will still be included if singleEvents is False. Optional. The default is False.
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "alt" $alt "scalar") (serialize-qp "fields" $qp_fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "userIp" $userIp "scalar") (serialize-qp "alwaysIncludeEmail" $alwaysIncludeEmail "scalar") (serialize-qp "maxAttendees" $maxAttendees "scalar") (serialize-qp "maxResults" $maxResults "scalar") (serialize-qp "originalStart" $originalStart "scalar") (serialize-qp "pageToken" $pageToken "scalar") (serialize-qp "showDeleted" $showDeleted "scalar") (serialize-qp "timeMax" $timeMax "scalar") (serialize-qp "timeMin" $timeMin "scalar") (serialize-qp "timeZone" $timeZone "scalar")] | flatten | str join "&"
...
export def "calendars-events-move calendareventsmove" [
  ...
  --sendNotifications: string@bool-completer # Deprecated. Please use sendUpdates instead.  Whether to send notifications about the change of the event's organizer. Note that some emails might still be sent even if you set the value to false. The default is false.
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "alt" $alt "scalar") (serialize-qp "fields" $qp_fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "userIp" $userIp "scalar") (serialize-qp "destination" $destination "scalar") (serialize-qp "sendNotifications" $sendNotifications "scalar") (serialize-qp "sendUpdates" $sendUpdates "scalar")] | flatten | str join "&"
...
export def "users-me-calendar-list calendarcalendarListlist" [
  ...
  --pageToken: string # Token specifying which result page to return. Optional.
  --showDeleted: string@bool-completer # Whether to include deleted calendar list entries in the result. Optional. The default is False.
  --showHidden: string@bool-completer # Whether to show hidden entries. Optional. The default is False.
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "alt" $alt "scalar") (serialize-qp "fields" $qp_fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "userIp" $userIp "scalar") (serialize-qp "maxResults" $maxResults "scalar") (serialize-qp "minAccessRole" $minAccessRole "scalar") (serialize-qp "pageToken" $pageToken "scalar") (serialize-qp "showDeleted" $showDeleted "scalar") (serialize-qp "showHidden" $showHidden "scalar") (serialize-qp "syncToken" $syncToken "scalar")] | flatten | str join "&"
...
export def "users-me-calendar-list calendarcalendarListinsert" [
  ...
  --quotaUser: string # An opaque string that represents a user for quota purposes. Must not exceed 40 characters.
  --userIp: string # Deprecated. Please use quotaUser instead.
  --colorRgbFormat: string@bool-completer # Whether to use the foregroundColor and backgroundColor fields to write the calendar colors (RGB). If this feature is used, the index-based colorId field will be set to the best matching option automatically. Optional. The default is False.
  ...
  --deleted: string@bool-completer # Whether this calendar list entry has been deleted from the calendar list. Read-only. Optional. The default is False. (default: false)
  ...
  --hidden: string@bool-completer # Whether the calendar has been hidden from the list. Optional. The attribute is only returned when the calendar is hidden, in which case the value is true. (default: false)
  ...
  --primary: string@bool-completer # Whether the calendar is the primary calendar of the authenticated user. Read-only. Optional. The default is False. (default: false)
  --selected: string@bool-completer # Whether the calendar content shows up in the calendar UI. Optional. The default is False. (default: false)
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "alt" $alt "scalar") (serialize-qp "fields" $qp_fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "userIp" $userIp "scalar") (serialize-qp "colorRgbFormat" $colorRgbFormat "scalar")] | flatten | str join "&"
  let full_url = (build-url $base "/users/me/calendarList" $qp)
