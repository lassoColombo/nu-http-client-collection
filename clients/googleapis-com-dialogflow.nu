# Auto-generated client for Dialogflow API vv3beta1
# Source: https://api.apis.guru/v2/specs/googleapis.com/dialogflow/v3beta1/openapi.json
# Auth: --token flag or $env.DIALOGFLOW_API_TOKEN
...
def build-auth [token?: string, auth_scheme?: string]: nothing -> record {
  let token_val = if ($token != null) and ($token | is-not-empty) { $token } else { $env | get -o DIALOGFLOW_API_TOKEN | default "" }
...
def base-url-completer [] { ["https://dialogflow.googleapis.com"] }
def auth-scheme-completer [] { ["bearer"] }

# Completers for enum parameters
def xgafv-completer [] { ["1" "2"] }
def alt-completer [] { ["json" "media" "proto"] }
def type-completer [] { ["COVERAGE_TYPE_UNSPECIFIED" "INTENT" "PAGE_TRANSITION" "TRANSITION_ROUTE_GROUP"] }
def redactionScope-completer [] { ["REDACTION_SCOPE_UNSPECIFIED" "REDACT_DISK_STORAGE"] }
def redactionStrategy-completer [] { ["REDACTION_STRATEGY_UNSPECIFIED" "REDACT_WITH_SERVICE"] }
def restoreOption-completer [] { ["FALLBACK" "KEEP" "RESTORE_OPTION_UNSPECIFIED"] }
def entityOverrideMode-completer [] { ["ENTITY_OVERRIDE_MODE_OVERRIDE" "ENTITY_OVERRIDE_MODE_SUPPLEMENT" "ENTITY_OVERRIDE_MODE_UNSPECIFIED"] }
def state-completer [] { ["DONE" "DRAFT" "ROLLOUT_FAILED" "RUNNING" "STATE_UNSPECIFIED"] }
def importOption-completer [] { ["FALLBACK" "IMPORT_OPTION_UNSPECIFIED" "KEEP"] }
def intentView-completer [] { ["INTENT_VIEW_FULL" "INTENT_VIEW_PARTIAL" "INTENT_VIEW_UNSPECIFIED"] }
def view-completer [] { ["BASIC" "FULL" "TEST_CASE_VIEW_UNSPECIFIED"] }
def dataFormat-completer [] { ["BLOB" "DATA_FORMAT_UNSPECIFIED" "JSON"] }
...
export def "v3beta1-test-cases-calculate-coverage dialogflowprojectslocationsagentstestCasescalculateCoverage" [
  ...
  --type: string@type-completer # Required. The type of coverage requested.
]: nothing -> record<agent: string, intentCoverage: record<coverageScore: float, intents: list<record>>, routeGroupCoverage: record<coverageScore: float, coverages: list<record>>, transitionCoverage: record<coverageScore: float, transitions: list<record>>> {
  ...
  let full_url = (build-url $base $"/v3beta1/($agent)/testCases:calculateCoverage" $qp)
...
export def "v3beta1 dialogflowprojectslocationsagentsflowsversionscompareVersions" [
  ...
  --upload-protocol: string # Upload protocol for media (e.g. "raw", "multipart").
  --uploadType: string # Legacy upload protocol for media (e.g. "media", "multipart").
  --languageCode: string # The language to compare the flow versions for. If not specified, the agent's default language is used. [Many languages](https://cloud.google.com/dialogflow/docs/reference/language) are supported. Note: languages must be enabled in the agent before they can be used.
  --targetVersion: string # Required. Name of the target flow version to compare with the base version. Use version ID `0` to indicate the draft version of the specified flow. Format: `projects//locations//agents//flows//versions/`.
]: any -> record<baseVersionContentJson: string, compareTime: string, targetVersionContentJson: string> {
  let input = $in
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  ...
  let full_url = (build-url $base $"/v3beta1/($baseVersion):compareVersions" $qp)
  let body = {languageCode: $languageCode, targetVersion: $targetVersion} | compact
...
export def "v3beta1 dialogflowprojectslocationsagentsenvironmentsdeployFlow" [
  ...
  --upload-protocol: string # Upload protocol for media (e.g. "raw", "multipart").
  --uploadType: string # Legacy upload protocol for media (e.g. "media", "multipart").
  --flowVersion: string # Required. The flow version to deploy. Format: `projects//locations//agents// flows//versions/`.
  ...
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v3beta1/($environment):deployFlow" $qp)
  let body = {flowVersion: $flowVersion} | compact
  let body = if ($input | describe | str starts-with "record") { $input | merge deep ($body | default {}) } else { $body }
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "post" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json" $body
...
export def "v3beta1 dialogflowprojectslocationsagentsenvironmentsrunContinuousTest" [
  ...
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v3beta1/($environment):runContinuousTest" $qp)
  let body = if ($input | describe | str starts-with "record") { $input | merge deep ($body | default {}) } else { $body }
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "post" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json" $body
...
export def "v3beta1 dialogflowprojectslocationssecuritySettingsdelete" [
  ...
  let full_url = (build-url $base $"/v3beta1/($name)" $qp)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
...
export def "v3beta1 dialogflowprojectslocationssecuritySettingspatch" [
  ...
  --audioExportSettings: record # Settings for exporting audio. — shape: {audioExportPattern?: string, audioFormat?: "AUDIO_FORMAT_UNSPECIFIED"|"MULAW"|"MP3"|"OGG", enableAudioRedaction?: bool, gcsBucket?: string}
  ...
  --insightsExportSettings: record # Settings for exporting conversations to [Insights](https://cloud.google.com/contact-center/insights/docs). — shape: {enableInsightsExport?: bool}
  ...
  --purgeDataTypes: list # List of types of data to remove when retention settings triggers purge.
  --redactionScope: string@redactionScope-completer # Defines the data for which Dialogflow applies redaction. Dialogflow does not redact data that it does not have access to – for example, Cloud logging.
  --redactionStrategy: string@redactionStrategy-completer # Strategy that defines how we do redaction.
  --retentionWindowDays: int # Retains data in interaction logging for the specified number of days. This does not apply to Cloud logging, which is owned by the user - not Dialogflow. User must set a value lower than Dialogflow's default 365d TTL (30 days for Agent Assist traffic), higher value will be ignored and use default. Setting a value higher than that has no effect. A missing value or setting to 0 also means we use default TTL. (format: int32)
]: any -> record<audioExportSettings: record<audioExportPattern: string, audioFormat: string, enableAudioRedaction: bool, gcsBucket: string>, deidentifyTemplate: string, displayName: string, insightsExportSettings: record<enableInsightsExport: bool>, inspectTemplate: string, name: string, purgeDataTypes: list<string>, redactionScope: string, redactionStrategy: string, retentionWindowDays: int> {
  let input = $in
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  ...
  let full_url = (build-url $base $"/v3beta1/($name)" $qp)
  let body = {audioExportSettings: $audioExportSettings, deidentifyTemplate: $deidentifyTemplate, displayName: $displayName, insightsExportSettings: $insightsExportSettings, inspectTemplate: $inspectTemplate, name: $body_name, purgeDataTypes: $purgeDataTypes, redactionScope: $redactionScope, redactionStrategy: $redactionStrategy, retentionWindowDays: $retentionWindowDays} | compact
  let body = if ($input | describe | str starts-with "record") { $input | merge deep ($body | default {}) } else { $body }
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
...
export def "v3beta1-locations dialogflowprojectslocationslist" [
  ...
  let full_url = (build-url $base $"/v3beta1/($name)/locations" $qp)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "get" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json"
}
...
export def "v3beta1-operations dialogflowprojectsoperationslist" [
  ...
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar") (serialize-qp "filter" $filter "scalar") (serialize-qp "pageSize" $pageSize "scalar") (serialize-qp "pageToken" $pageToken "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v3beta1/($name)/operations" $qp)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "get" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json"
}
...
export def "v3beta1 dialogflowprojectsoperationscancel" [
  ...
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v3beta1/($name):cancel" $qp)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
...
export def "v3beta1 dialogflowprojectslocationsagentsflowsexport" [
  ...
  --includeReferencedFlows: oneof<nothing, bool> # Optional. Whether to export flows referenced by the specified flow.
]: any -> record<done: bool, error: record<code: int, details: list<record>, message: string>, metadata: record, name: string, response: record> {
  let input = $in
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v3beta1/($name):export" $qp)
  let body = {flowUri: $flowUri, includeReferencedFlows: $includeReferencedFlows} | compact
  let body = if ($input | describe | str starts-with "record") { $input | merge deep ($body | default {}) } else { $body }
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "post" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json" $body
...
export def "v3beta1 dialogflowprojectslocationsagentsenvironmentslookupEnvironmentHistory" [
  ...
  --upload-protocol: string # Upload protocol for media (e.g. "raw", "multipart").
  --uploadType: string # Legacy upload protocol for media (e.g. "media", "multipart").
  --pageSize: int # The maximum number of items to return in a single page. By default 100 and at most 1000.
  --pageToken: string # The next_page_token value returned from a previous list request.
]: nothing -> record<environments: table<description: string, displayName: string, name: string, testCasesConfig: record, updateTime: string, versionConfigs: list, webhookConfig: record>, nextPageToken: string> {
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  ...
  let full_url = (build-url $base $"/v3beta1/($name):lookupEnvironmentHistory" $qp)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "get" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json"
}
...
export def "v3beta1 dialogflowprojectslocationsagentsrestore" [
  ...
  --upload-protocol: string # Upload protocol for media (e.g. "raw", "multipart").
  --uploadType: string # Legacy upload protocol for media (e.g. "media", "multipart").
  --agentContent: string # Uncompressed raw byte content for agent. (format: byte)
  ...
  --restoreOption: string@restoreOption-completer # Agent restore mode. If not specified, `KEEP` is assumed.
]: any -> record<done: bool, error: record<code: int, details: list<record>, message: string>, metadata: record, name: string, response: record> {
  let input = $in
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v3beta1/($name):restore" $qp)
  let body = {agentContent: $agentContent, agentUri: $agentUri, restoreOption: $restoreOption} | compact
  let body = if ($input | describe | str starts-with "record") { $input | merge deep ($body | default {}) } else { $body }
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "post" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json" $body
...
export def "v3beta1 dialogflowprojectslocationsagentstestCasesrun" [
  ...
  --upload-protocol: string # Upload protocol for media (e.g. "raw", "multipart").
  --uploadType: string # Legacy upload protocol for media (e.g. "media", "multipart").
  --environment: string # Optional. Environment name. If not set, draft environment is assumed. Format: `projects//locations//agents//environments/`.
]: any -> record<done: bool, error: record<code: int, details: list<record>, message: string>, metadata: record, name: string, response: record> {
  let input = $in
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v3beta1/($name):run" $qp)
...
export def "v3beta1 dialogflowprojectslocationsagentsenvironmentsexperimentsstart" [
  ...
  --uploadType: string # Legacy upload protocol for media (e.g. "media", "multipart").
  --body: record
]: any -> record<createTime: string, definition: record<condition: string, versionVariants: record<variants: list>>, description: string, displayName: string, endTime: string, experimentLength: string, lastUpdateTime: string, name: string, result: record<lastUpdateTime: string, versionMetrics: list<record>>, rolloutConfig: record<failureCondition: string, rolloutCondition: string, rolloutSteps: list<record>>, rolloutFailureReason: string, rolloutState: record<startTime: string, step: string, stepIndex: int>, startTime: string, state: string, variantsHistory: table<updateTime: string, versionVariants: record>> {
  let input = $in
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v3beta1/($name):start" $qp)
  let body = if ($input | describe | str starts-with "record") { $input | merge deep ($body | default {}) } else { $body }
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "post" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json" $body
...
export def "v3beta1 dialogflowprojectslocationsagentsenvironmentsexperimentsstop" [
  ...
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v3beta1/($name):stop" $qp)
  let body = if ($input | describe | str starts-with "record") { $input | merge deep ($body | default {}) } else { $body }
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "post" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json" $body
...
export def "v3beta1 dialogflowprojectslocationsagentsflowstrain" [
  ...
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v3beta1/($name):train" $qp)
  let body = if ($input | describe | str starts-with "record") { $input | merge deep ($body | default {}) } else { $body }
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "post" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json" $body
...
]: any -> record<name: string, updateTime: string, validationMessages: table<detail: string, resourceNames: list, resourceType: string, resources: list, severity: string>> {
  let input = $in
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v3beta1/($name):validate" $qp)
  let body = {languageCode: $languageCode} | compact
  let body = if ($input | describe | str starts-with "record") { $input | merge deep ($body | default {}) } else { $body }
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "post" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json" $body
...
export def "v3beta1-agents dialogflowprojectslocationsagentslist" [
  ...
  --pageSize: int # The maximum number of items to return in a single page. By default 100 and at most 1000.
  --pageToken: string # The next_page_token value returned from a previous list request.
]: nothing -> record<agents: table<advancedSettings: record, avatarUri: string, defaultLanguageCode: string, description: string, displayName: string, enableSpellCorrection: bool, enableStackdriverLogging: bool, locked: bool, name: string, securitySettings: string, speechToTextSettings: record, startFlow: string, supportedLanguageCodes: list, textToSpeechSettings: record, timeZone: string>, nextPageToken: string> {
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar") (serialize-qp "pageSize" $pageSize "scalar") (serialize-qp "pageToken" $pageToken "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v3beta1/($parent)/agents" $qp)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "get" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json"
}
...
export def "v3beta1-agents dialogflowprojectslocationsagentscreate" [
  ...
  --upload-protocol: string # Upload protocol for media (e.g. "raw", "multipart").
  --uploadType: string # Legacy upload protocol for media (e.g. "media", "multipart").
  --advancedSettings: record # Hierarchical advanced settings for agent/flow/page/fulfillment/parameter. Settings exposed at lower level overrides the settings exposed at higher level. Overriding occurs at the sub-setting level. For example, the playback_interruption_settings at fulfillment level only overrides the playback_interruption_settings at the agent level, leaving other settings at the agent level unchanged. DTMF settings does not override each other. DTMF settings set at different levels define DTMF detections running in parallel. Hierarchy: Agent->Flow->Page->Fulfillment/Parameter. — shape: {audioExportGcsDestination?: record, loggingSettings?: record}
  ...
  --enableSpellCorrection: oneof<nothing, bool> # Indicates if automatic spell correction is enabled in detect intent requests.
  --enableStackdriverLogging: oneof<nothing, bool> # Indicates if stackdriver logging is enabled for the agent. Please use agent.advanced_settings instead.
  --locked: oneof<nothing, bool> # Indicates whether the agent is locked for changes. If the agent is locked, modifications to the agent will be rejected except for RestoreAgent.
  ...
  --speechToTextSettings: record # Settings related to speech recognition. — shape: {enableSpeechAdaptation?: bool}
  ...
  --supportedLanguageCodes: list # The list of all languages supported by the agent (except for the `default_language_code`).
  --textToSpeechSettings: record # Settings related to speech generating. — shape: {synthesizeSpeechConfigs?: record}
  ...
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v3beta1/($parent)/agents" $qp)
  let body = {advancedSettings: $advancedSettings, avatarUri: $avatarUri, defaultLanguageCode: $defaultLanguageCode, description: $description, displayName: $displayName, enableSpellCorrection: $enableSpellCorrection, enableStackdriverLogging: $enableStackdriverLogging, locked: $locked, name: $name, securitySettings: $securitySettings, speechToTextSettings: $speechToTextSettings, startFlow: $startFlow, supportedLanguageCodes: $supportedLanguageCodes, textToSpeechSettings: $textToSpeechSettings, timeZone: $timeZone} | compact
  let body = if ($input | describe | str starts-with "record") { $input | merge deep ($body | default {}) } else { $body }
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "post" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json" $body
...
export def "v3beta1-changelogs dialogflowprojectslocationsagentschangelogslist" [
  ...
  --pageSize: int # The maximum number of items to return in a single page. By default 100 and at most 1000.
  --pageToken: string # The next_page_token value returned from a previous list request.
]: nothing -> record<changelogs: table<action: string, createTime: string, displayName: string, name: string, resource: string, type: string, userEmail: string>, nextPageToken: string> {
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar") (serialize-qp "filter" $filter "scalar") (serialize-qp "pageSize" $pageSize "scalar") (serialize-qp "pageToken" $pageToken "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v3beta1/($parent)/changelogs" $qp)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "get" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json"
}
...
export def "v3beta1-continuous-test-results dialogflowprojectslocationsagentsenvironmentscontinuousTestResultslist" [
  ...
  --pageSize: int # The maximum number of items to return in a single page. By default 100 and at most 1000.
  --pageToken: string # The next_page_token value returned from a previous list request.
]: nothing -> record<continuousTestResults: table<name: string, result: string, runTime: string, testCaseResults: list>, nextPageToken: string> {
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar") (serialize-qp "pageSize" $pageSize "scalar") (serialize-qp "pageToken" $pageToken "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v3beta1/($parent)/continuousTestResults" $qp)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "get" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json"
}
...
export def "v3beta1-deployments dialogflowprojectslocationsagentsenvironmentsdeploymentslist" [
  ...
  --upload-protocol: string # Upload protocol for media (e.g. "raw", "multipart").
  --uploadType: string # Legacy upload protocol for media (e.g. "media", "multipart").
  --pageSize: int # The maximum number of items to return in a single page. By default 20 and at most 100.
  --pageToken: string # The next_page_token value returned from a previous list request.
]: nothing -> record<deployments: table<endTime: string, flowVersion: string, name: string, result: record, startTime: string, state: string>, nextPageToken: string> {
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar") (serialize-qp "pageSize" $pageSize "scalar") (serialize-qp "pageToken" $pageToken "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v3beta1/($parent)/deployments" $qp)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "get" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json"
}
...
export def "v3beta1-entity-types dialogflowprojectslocationsagentssessionsentityTypeslist" [
  ...
  --pageSize: int # The maximum number of items to return in a single page. By default 100 and at most 1000.
  --pageToken: string # The next_page_token value returned from a previous list request.
]: nothing -> record<nextPageToken: string, sessionEntityTypes: table<entities: list, entityOverrideMode: string, name: string>> {
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar") (serialize-qp "pageSize" $pageSize "scalar") (serialize-qp "pageToken" $pageToken "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v3beta1/($parent)/entityTypes" $qp)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "get" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json"
}
...
export def "v3beta1-entity-types dialogflowprojectslocationsagentssessionsentityTypescreate" [
  ...
  --entityOverrideMode: string@entityOverrideMode-completer # Required. Indicates whether the additional data should override or supplement the custom entity type definition.
  ...
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar") (serialize-qp "languageCode" $languageCode "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v3beta1/($parent)/entityTypes" $qp)
  let body = {entities: $entities, entityOverrideMode: $entityOverrideMode, name: $name} | compact
  let body = if ($input | describe | str starts-with "record") { $input | merge deep ($body | default {}) } else { $body }
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "post" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json" $body
...
export def "v3beta1-environments dialogflowprojectslocationsagentsenvironmentslist" [
  ...
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar") (serialize-qp "pageSize" $pageSize "scalar") (serialize-qp "pageToken" $pageToken "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v3beta1/($parent)/environments" $qp)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "get" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json"
}
...
export def "v3beta1-environments dialogflowprojectslocationsagentsenvironmentscreate" [
  ...
  --testCasesConfig: record # The configuration for continuous tests. — shape: {enableContinuousRun?: bool, enablePredeploymentRun?: bool, testCases?: list}
  --versionConfigs: list # A list of configurations for flow versions. You should include version configs for all flows that are reachable from `Start Flow` in the agent. Otherwise, an error will be returned. — item shape: {version?: string}
  --webhookConfig: record # Configuration for webhooks. — shape: {webhookOverrides?: list}
]: any -> record<done: bool, error: record<code: int, details: list<record>, message: string>, metadata: record, name: string, response: record> {
  let input = $in
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v3beta1/($parent)/environments" $qp)
  let body = {description: $description, displayName: $displayName, name: $name, testCasesConfig: $testCasesConfig, versionConfigs: $versionConfigs, webhookConfig: $webhookConfig} | compact
  let body = if ($input | describe | str starts-with "record") { $input | merge deep ($body | default {}) } else { $body }
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "post" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json" $body
...
export def "v3beta1-experiments dialogflowprojectslocationsagentsenvironmentsexperimentslist" [
  ...
  --pageSize: int # The maximum number of items to return in a single page. By default 20 and at most 100.
  --pageToken: string # The next_page_token value returned from a previous list request.
]: nothing -> record<experiments: table<createTime: string, definition: record, description: string, displayName: string, endTime: string, experimentLength: string, lastUpdateTime: string, name: string, result: record, rolloutConfig: record, rolloutFailureReason: string, rolloutState: record, startTime: string, state: string, variantsHistory: list>, nextPageToken: string> {
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar") (serialize-qp "pageSize" $pageSize "scalar") (serialize-qp "pageToken" $pageToken "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v3beta1/($parent)/experiments" $qp)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "get" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json"
}
...
# --definition shape: {condition?: string, versionVariants?: record}
# --result shape: {lastUpdateTime?: string, versionMetrics?: list}
...
export def "v3beta1-experiments dialogflowprojectslocationsagentsenvironmentsexperimentscreate" [
  ...
  --upload-protocol: string # Upload protocol for media (e.g. "raw", "multipart").
  --uploadType: string # Legacy upload protocol for media (e.g. "media", "multipart").
  --createTime: string # Creation time of this experiment. (format: google-datetime)
  --definition: record # Definition of the experiment. — shape: {condition?: string, versionVariants?: record}
  ...
  --endTime: string # End time of this experiment. (format: google-datetime)
  --experimentLength: string # Maximum number of days to run the experiment. If auto-rollout is not enabled, default value and maximum will be 30 days. If auto-rollout is enabled, default value and maximum will be 6 days. (format: google-duration)
  --lastUpdateTime: string # Last update time of this experiment. (format: google-datetime)
  --name: string # The name of the experiment. Format: projects//locations//agents//environments//experiments/..
  --result: record # The inference result which includes an objective metric to optimize and the confidence interval. — shape: {lastUpdateTime?: string, versionMetrics?: list}
  --rolloutConfig: record # The configuration for auto rollout. — shape: {failureCondition?: string, rolloutCondition?: string, rolloutSteps?: list}
  --rolloutFailureReason: string # The reason why rollout has failed. Should only be set when state is ROLLOUT_FAILED.
  --rolloutState: record # State of the auto-rollout process. — shape: {startTime?: string, step?: string, stepIndex?: int}
  --startTime: string # Start time of this experiment. (format: google-datetime)
  --state: string@state-completer # The current state of the experiment. Transition triggered by Experiments.StartExperiment: DRAFT->RUNNING. Transition triggered by Experiments.CancelExperiment: DRAFT->DONE or RUNNING->DONE.
  --variantsHistory: list # The history of updates to the experiment variants. — item shape: {updateTime?: string, versionVariants?: record}
]: any -> record<createTime: string, definition: record<condition: string, versionVariants: record<variants: list>>, description: string, displayName: string, endTime: string, experimentLength: string, lastUpdateTime: string, name: string, result: record<lastUpdateTime: string, versionMetrics: list<record>>, rolloutConfig: record<failureCondition: string, rolloutCondition: string, rolloutSteps: list<record>>, rolloutFailureReason: string, rolloutState: record<startTime: string, step: string, stepIndex: int>, startTime: string, state: string, variantsHistory: table<updateTime: string, versionVariants: record>> {
  let input = $in
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v3beta1/($parent)/experiments" $qp)
  let body = {createTime: $createTime, definition: $definition, description: $description, displayName: $displayName, endTime: $endTime, experimentLength: $experimentLength, lastUpdateTime: $lastUpdateTime, name: $name, result: $result, rolloutConfig: $rolloutConfig, rolloutFailureReason: $rolloutFailureReason, rolloutState: $rolloutState, startTime: $startTime, state: $state, variantsHistory: $variantsHistory} | compact
  let body = if ($input | describe | str starts-with "record") { $input | merge deep ($body | default {}) } else { $body }
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "post" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json" $body
...
export def "v3beta1-flows dialogflowprojectslocationsagentsflowslist" [
  ...
  --pageSize: int # The maximum number of items to return in a single page. By default 100 and at most 1000.
  --pageToken: string # The next_page_token value returned from a previous list request.
]: nothing -> record<flows: table<description: string, displayName: string, eventHandlers: list, name: string, nluSettings: record, transitionRouteGroups: list, transitionRoutes: list>, nextPageToken: string> {
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar") (serialize-qp "languageCode" $languageCode "scalar") (serialize-qp "pageSize" $pageSize "scalar") (serialize-qp "pageToken" $pageToken "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v3beta1/($parent)/flows" $qp)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "get" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json"
}
...
export def "v3beta1-flows dialogflowprojectslocationsagentsflowscreate" [
  ...
  --eventHandlers: list # A flow's event handlers serve two purposes: * They are responsible for handling events (e.g. no match, webhook errors) in the flow. * They are inherited by every page's event handlers, which can be used to handle common events regardless of the current page. Event handlers defined in the page have higher priority than those defined in the flow. Unlike transition_routes, these handlers are evaluated on a first-match basis. The first one that matches the event get executed, with the rest being ignored. — item shape: {event?: string, targetFlow?: string, targetPage?: string, triggerFulfillment?: record}
  --name: string # The unique identifier of the flow. Format: `projects//locations//agents//flows/`.
  --nluSettings: record # Settings related to NLU. — shape: {classificationThreshold?: float, modelTrainingMode?: "MODEL_TRAINING_MODE_UNSPECIFIED"|"MODEL_TRAINING_MODE_AUTOMATIC"|"MODEL_TRAINING_MODE_MANUAL", modelType?: "MODEL_TYPE_UNSPECIFIED"|"MODEL_TYPE_STANDARD"|"MODEL_TYPE_ADVANCED"}
  --transitionRouteGroups: list # A flow's transition route group serve two purposes: * They are responsible for matching the user's first utterances in the flow. * They are inherited by every page's transition route groups. Transition route groups defined in the page have higher priority than those defined in the flow. Format:`projects//locations//agents//flows//transitionRouteGroups/`.
  --transitionRoutes: list # A flow's transition routes serve two purposes: * They are responsible for matching the user's first utterances in the flow. * They are inherited by every page's transition routes and can support use cases such as the user saying "help" or "can I talk to a human?", which can be handled in a common way regardless of the current page. Transition routes defined in the page have higher priority than those defined in the flow. TransitionRoutes are evalauted in the following order: * TransitionRoutes with intent specified. * TransitionRoutes with only condition specified. TransitionRoutes with intent specified are inherited by pages in the flow. — item shape: {condition?: string, intent?: string, targetFlow?: string, targetPage?: string, triggerFulfillment?: record}
  ...
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar") (serialize-qp "languageCode" $languageCode "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v3beta1/($parent)/flows" $qp)
  let body = {description: $description, displayName: $displayName, eventHandlers: $eventHandlers, name: $name, nluSettings: $nluSettings, transitionRouteGroups: $transitionRouteGroups, transitionRoutes: $transitionRoutes} | compact
  let body = if ($input | describe | str starts-with "record") { $input | merge deep ($body | default {}) } else { $body }
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "post" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json" $body
...
export def "v3beta1-flows-import dialogflowprojectslocationsagentsflowsimport" [
  ...
  --upload-protocol: string # Upload protocol for media (e.g. "raw", "multipart").
  --uploadType: string # Legacy upload protocol for media (e.g. "media", "multipart").
  --flowContent: string # Uncompressed raw byte content for flow. (format: byte)
  --flowUri: string # The [Google Cloud Storage](https://cloud.google.com/storage/docs/) URI to import flow from. The format of this URI must be `gs:///`. Dialogflow performs a read operation for the Cloud Storage object on the caller's behalf, so your request authentication must have read permissions for the object. For more information, see [Dialogflow access control](https://cloud.google.com/dialogflow/cx/docs/concept/access-control#storage).
  --importOption: string@importOption-completer # Flow import mode. If not specified, `KEEP` is assumed.
]: any -> record<done: bool, error: record<code: int, details: list<record>, message: string>, metadata: record, name: string, response: record> {
  let input = $in
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v3beta1/($parent)/flows:import" $qp)
  let body = {flowContent: $flowContent, flowUri: $flowUri, importOption: $importOption} | compact
  let body = if ($input | describe | str starts-with "record") { $input | merge deep ($body | default {}) } else { $body }
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "post" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json" $body
...
export def "v3beta1-intents dialogflowprojectslocationsagentsintentslist" [
  ...
  --upload-protocol: string # Upload protocol for media (e.g. "raw", "multipart").
  --uploadType: string # Legacy upload protocol for media (e.g. "media", "multipart").
  --intentView: string@intentView-completer # The resource view to apply to the returned intent.
  --languageCode: string # The language to list intents for. The following fields are language dependent: * `Intent.training_phrases.parts.text` If not specified, the agent's default language is used. [Many languages](https://cloud.google.com/dialogflow/cx/docs/reference/language) are supported. Note: languages must be enabled in the agent before they can be used.
  --pageSize: int # The maximum number of items to return in a single page. By default 100 and at most 1000.
  --pageToken: string # The next_page_token value returned from a previous list request.
]: nothing -> record<intents: table<description: string, displayName: string, isFallback: bool, labels: record, name: string, parameters: list, priority: int, trainingPhrases: list>, nextPageToken: string> {
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar") (serialize-qp "intentView" $intentView "scalar") (serialize-qp "languageCode" $languageCode "scalar") (serialize-qp "pageSize" $pageSize "scalar") (serialize-qp "pageToken" $pageToken "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v3beta1/($parent)/intents" $qp)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "get" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json"
}
...
export def "v3beta1-intents dialogflowprojectslocationsagentsintentscreate" [
  ...
  --isFallback: oneof<nothing, bool> # Indicates whether this is a fallback intent. Currently only default fallback intent is allowed in the agent, which is added upon agent creation. Adding training phrases to fallback intent is useful in the case of requests that are mistakenly matched, since training phrases assigned to fallback intents act as negative examples that triggers no-match event.
  --labels: record # The key/value metadata to label an intent. Labels can contain lowercase letters, digits and the symbols '-' and '_'. International characters are allowed, including letters from unicase alphabets. Keys must start with a letter. Keys and values can be no longer than 63 characters and no more than 128 bytes. Prefix "sys-" is reserved for Dialogflow defined labels. Currently allowed Dialogflow defined labels include: * sys-head * sys-contextual The above labels do not require value. "sys-head" means the intent is a head intent. "sys-contextual" means the intent is a contextual intent.
  ...
  --parameters: list # The collection of parameters associated with the intent. — item shape: {entityType?: string, id?: string, isList?: bool, redact?: bool}
  ...
  --trainingPhrases: list # The collection of training phrases the agent is trained on to identify the intent. — item shape: {id?: string, parts?: list, repeatCount?: int}
]: any -> record<description: string, displayName: string, isFallback: bool, labels: record, name: string, parameters: table<entityType: string, id: string, isList: bool, redact: bool>, priority: int, trainingPhrases: table<id: string, parts: list, repeatCount: int>> {
  let input = $in
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar") (serialize-qp "languageCode" $languageCode "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v3beta1/($parent)/intents" $qp)
  let body = {description: $description, displayName: $displayName, isFallback: $isFallback, labels: $labels, name: $name, parameters: $parameters, priority: $priority, trainingPhrases: $trainingPhrases} | compact
  let body = if ($input | describe | str starts-with "record") { $input | merge deep ($body | default {}) } else { $body }
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "post" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json" $body
...
export def "v3beta1-pages dialogflowprojectslocationsagentsflowspageslist" [
  ...
  --pageSize: int # The maximum number of items to return in a single page. By default 100 and at most 1000.
  --pageToken: string # The next_page_token value returned from a previous list request.
]: nothing -> record<nextPageToken: string, pages: table<displayName: string, entryFulfillment: record, eventHandlers: list, form: record, name: string, transitionRouteGroups: list, transitionRoutes: list>> {
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar") (serialize-qp "languageCode" $languageCode "scalar") (serialize-qp "pageSize" $pageSize "scalar") (serialize-qp "pageToken" $pageToken "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v3beta1/($parent)/pages" $qp)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "get" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json"
}
...
# --entryFulfillment shape: {conditionalCases?: list, messages?: list, returnPartialResponses?: bool, setParameterActions?: list, tag?: string, webhook?: string}
# --eventHandlers item shape: {event?: string, targetFlow?: string, targetPage?: string, triggerFulfillment?: record}
...
export def "v3beta1-pages dialogflowprojectslocationsagentsflowspagescreate" [
  ...
  --entryFulfillment: record # A fulfillment can do one or more of the following actions at the same time: * Generate rich message responses. * Set parameter values. * Call the webhook. Fulfillments can be called at various stages in the Page or Form lifecycle. For example, when a DetectIntentRequest drives a session to enter a new page, the page's entry fulfillment can add a static response to the QueryResult in the returning DetectIntentResponse, call the webhook (for example, to load user data from a database), or both. — shape: {conditionalCases?: list, messages?: list, returnPartialResponses?: bool, setParameterActions?: list, tag?: string, webhook?: string}
  --eventHandlers: list # Handlers associated with the page to handle events such as webhook errors, no match or no input. — item shape: {event?: string, targetFlow?: string, targetPage?: string, triggerFulfillment?: record}
  ...
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar") (serialize-qp "languageCode" $languageCode "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v3beta1/($parent)/pages" $qp)
  let body = {displayName: $displayName, entryFulfillment: $entryFulfillment, eventHandlers: $eventHandlers, form: $form, name: $name, transitionRouteGroups: $transitionRouteGroups, transitionRoutes: $transitionRoutes} | compact
  let body = if ($input | describe | str starts-with "record") { $input | merge deep ($body | default {}) } else { $body }
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "post" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json" $body
...
export def "v3beta1-results dialogflowprojectslocationsagentstestCasesresultslist" [
  ...
  --pageSize: int # The maximum number of items to return in a single page. By default 100 and at most 1000.
  --pageToken: string # The next_page_token value returned from a previous list request.
]: nothing -> record<nextPageToken: string, testCaseResults: table<conversationTurns: list, environment: string, name: string, testResult: string, testTime: string>> {
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar") (serialize-qp "filter" $filter "scalar") (serialize-qp "pageSize" $pageSize "scalar") (serialize-qp "pageToken" $pageToken "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v3beta1/($parent)/results" $qp)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "get" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json"
}
...
export def "v3beta1-security-settings dialogflowprojectslocationssecuritySettingslist" [
  ...
  --pageSize: int # The maximum number of items to return in a single page. By default 20 and at most 100.
  --pageToken: string # The next_page_token value returned from a previous list request.
]: nothing -> record<nextPageToken: string, securitySettings: table<audioExportSettings: record, deidentifyTemplate: string, displayName: string, insightsExportSettings: record, inspectTemplate: string, name: string, purgeDataTypes: list, redactionScope: string, redactionStrategy: string, retentionWindowDays: int>> {
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar") (serialize-qp "pageSize" $pageSize "scalar") (serialize-qp "pageToken" $pageToken "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v3beta1/($parent)/securitySettings" $qp)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "get" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json"
}
...
export def "v3beta1-security-settings dialogflowprojectslocationssecuritySettingscreate" [
  ...
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v3beta1/($parent)/securitySettings" $qp)
  let body = {audioExportSettings: $audioExportSettings, deidentifyTemplate: $deidentifyTemplate, displayName: $displayName, insightsExportSettings: $insightsExportSettings, inspectTemplate: $inspectTemplate, name: $name, purgeDataTypes: $purgeDataTypes, redactionScope: $redactionScope, redactionStrategy: $redactionStrategy, retentionWindowDays: $retentionWindowDays} | compact
  let body = if ($input | describe | str starts-with "record") { $input | merge deep ($body | default {}) } else { $body }
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "post" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json" $body
...
export def "v3beta1-test-cases dialogflowprojectslocationsagentstestCaseslist" [
  ...
  --upload-protocol: string # Upload protocol for media (e.g. "raw", "multipart").
  --uploadType: string # Legacy upload protocol for media (e.g. "media", "multipart").
  --pageSize: int # The maximum number of items to return in a single page. By default 20. Note that when TestCaseView = FULL, the maximum page size allowed is 20. When TestCaseView = BASIC, the maximum page size allowed is 500.
  --pageToken: string # The next_page_token value returned from a previous list request.
  --view: string@view-completer # Specifies whether response should include all fields or just the metadata.
]: nothing -> record<nextPageToken: string, testCases: table<creationTime: string, displayName: string, lastTestResult: record, name: string, notes: string, tags: list, testCaseConversationTurns: list, testConfig: record>> {
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar") (serialize-qp "pageSize" $pageSize "scalar") (serialize-qp "pageToken" $pageToken "scalar") (serialize-qp "view" $view "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v3beta1/($parent)/testCases" $qp)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "get" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json"
}
...
export def "v3beta1-test-cases dialogflowprojectslocationsagentstestCasescreate" [
  ...
  --lastTestResult: record # Represents a result from running a test case in an agent environment. — shape: {conversationTurns?: list, environment?: string, name?: string, testResult?: "TEST_RESULT_UNSPECIFIED"|"PASSED"|"FAILED", testTime?: string}
  ...
  --testCaseConversationTurns: list # The conversation turns uttered when the test case was created, in chronological order. These include the canonical set of agent utterances that should occur when the agent is working properly. — item shape: {userInput?: record, virtualAgentOutput?: record}
  --testConfig: record # Represents configurations for a test case. — shape: {flow?: string, page?: string, trackingParameters?: list}
  ...
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v3beta1/($parent)/testCases" $qp)
  let body = {displayName: $displayName, lastTestResult: $lastTestResult, name: $name, notes: $notes, tags: $tags, testCaseConversationTurns: $testCaseConversationTurns, testConfig: $testConfig} | compact
  let body = if ($input | describe | str starts-with "record") { $input | merge deep ($body | default {}) } else { $body }
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "post" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json" $body
...
export def "v3beta1-test-cases-batch-delete dialogflowprojectslocationsagentstestCasesbatchDelete" [
  ...
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v3beta1/($parent)/testCases:batchDelete" $qp)
...
export def "v3beta1-test-cases-batch-run dialogflowprojectslocationsagentstestCasesbatchRun" [
  ...
  --testCases: list # Required. Format: `projects//locations//agents//testCases/`.
]: any -> record<done: bool, error: record<code: int, details: list<record>, message: string>, metadata: record, name: string, response: record> {
  let input = $in
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v3beta1/($parent)/testCases:batchRun" $qp)
  let body = {environment: $environment, testCases: $testCases} | compact
  let body = if ($input | describe | str starts-with "record") { $input | merge deep ($body | default {}) } else { $body }
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "post" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json" $body
...
export def "v3beta1-test-cases-export dialogflowprojectslocationsagentstestCasesexport" [
  ...
  --upload-protocol: string # Upload protocol for media (e.g. "raw", "multipart").
  --uploadType: string # Legacy upload protocol for media (e.g. "media", "multipart").
  --dataFormat: string@dataFormat-completer # The data format of the exported test cases. If not specified, `BLOB` is assumed.
  --filter: string # The filter expression used to filter exported test cases, see [API Filtering](https://aip.dev/160). The expression is case insensitive and supports the following syntax: name = [OR name = ] ... For example: * "name = t1 OR name = t2" matches the test case with the exact resource name "t1" or "t2".
  ...
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v3beta1/($parent)/testCases:export" $qp)
  let body = {dataFormat: $dataFormat, filter: $filter, gcsUri: $gcsUri} | compact
  let body = if ($input | describe | str starts-with "record") { $input | merge deep ($body | default {}) } else { $body }
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "post" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json" $body
...
export def "v3beta1-test-cases-import dialogflowprojectslocationsagentstestCasesimport" [
  ...
  --upload-protocol: string # Upload protocol for media (e.g. "raw", "multipart").
  --uploadType: string # Legacy upload protocol for media (e.g. "media", "multipart").
  --content: string # Uncompressed raw byte content for test cases. (format: byte)
  ...
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v3beta1/($parent)/testCases:import" $qp)
  let body = {content: $content, gcsUri: $gcsUri} | compact
  let body = if ($input | describe | str starts-with "record") { $input | merge deep ($body | default {}) } else { $body }
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "post" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json" $body
...
export def "v3beta1-transition-route-groups dialogflowprojectslocationsagentsflowstransitionRouteGroupslist" [
  ...
  --pageSize: int # The maximum number of items to return in a single page. By default 100 and at most 1000.
  --pageToken: string # The next_page_token value returned from a previous list request.
]: nothing -> record<nextPageToken: string, transitionRouteGroups: table<displayName: string, name: string, transitionRoutes: list>> {
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar") (serialize-qp "languageCode" $languageCode "scalar") (serialize-qp "pageSize" $pageSize "scalar") (serialize-qp "pageToken" $pageToken "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v3beta1/($parent)/transitionRouteGroups" $qp)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "get" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json"
}
...
export def "v3beta1-transition-route-groups dialogflowprojectslocationsagentsflowstransitionRouteGroupscreate" [
  ...
  --transitionRoutes: list # Transition routes associated with the TransitionRouteGroup. — item shape: {condition?: string, intent?: string, targetFlow?: string, targetPage?: string, triggerFulfillment?: record}
]: any -> record<displayName: string, name: string, transitionRoutes: table<condition: string, intent: string, name: string, targetFlow: string, targetPage: string, triggerFulfillment: record>> {
  let input = $in
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar") (serialize-qp "languageCode" $languageCode "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v3beta1/($parent)/transitionRouteGroups" $qp)
  let body = {displayName: $displayName, name: $name, transitionRoutes: $transitionRoutes} | compact
  let body = if ($input | describe | str starts-with "record") { $input | merge deep ($body | default {}) } else { $body }
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "post" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json" $body
...
export def "v3beta1-versions dialogflowprojectslocationsagentsflowsversionslist" [
  ...
  --pageSize: int # The maximum number of items to return in a single page. By default 20 and at most 100.
  --pageToken: string # The next_page_token value returned from a previous list request.
]: nothing -> record<nextPageToken: string, versions: table<createTime: string, description: string, displayName: string, name: string, nluSettings: record, state: string>> {
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar") (serialize-qp "pageSize" $pageSize "scalar") (serialize-qp "pageToken" $pageToken "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v3beta1/($parent)/versions" $qp)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "get" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json"
}
...
export def "v3beta1-versions dialogflowprojectslocationsagentsflowsversionscreate" [
  ...
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v3beta1/($parent)/versions" $qp)
  let body = {description: $description, displayName: $displayName, name: $name, nluSettings: $nluSettings} | compact
  let body = if ($input | describe | str starts-with "record") { $input | merge deep ($body | default {}) } else { $body }
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "post" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json" $body
...
export def "v3beta1-webhooks dialogflowprojectslocationsagentswebhookslist" [
  ...
  --pageSize: int # The maximum number of items to return in a single page. By default 100 and at most 1000.
  --pageToken: string # The next_page_token value returned from a previous list request.
]: nothing -> record<nextPageToken: string, webhooks: table<disabled: bool, displayName: string, genericWebService: record, name: string, serviceDirectory: record, timeout: string>> {
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar") (serialize-qp "pageSize" $pageSize "scalar") (serialize-qp "pageToken" $pageToken "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v3beta1/($parent)/webhooks" $qp)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "get" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json"
}
...
export def "v3beta1-webhooks dialogflowprojectslocationsagentswebhookscreate" [
  ...
  --genericWebService: record # Represents configuration for a generic web service. — shape: {allowedCaCerts?: list, password?: string, requestHeaders?: record, uri?: string, username?: string}
  ...
  --serviceDirectory: record # Represents configuration for a [Service Directory](https://cloud.google.com/service-directory) service. — shape: {genericWebService?: record, service?: string}
...
]: any -> record<disabled: bool, displayName: string, genericWebService: record<allowedCaCerts: list<string>, password: string, requestHeaders: record, uri: string, username: string>, name: string, serviceDirectory: record<genericWebService: record<allowedCaCerts: list, password: string, requestHeaders: record, uri: string, username: string>, service: string>, timeout: string> {
  let input = $in
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v3beta1/($parent)/webhooks" $qp)
  let body = {disabled: $disabled, displayName: $displayName, genericWebService: $genericWebService, name: $name, serviceDirectory: $serviceDirectory, timeout: $timeout} | compact
  let body = if ($input | describe | str starts-with "record") { $input | merge deep ($body | default {}) } else { $body }
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "post" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json" $body
...
export def "v3beta1 dialogflowprojectslocationsagentssessionsdetectIntent" [
  ...
  --upload-protocol: string # Upload protocol for media (e.g. "raw", "multipart").
  --uploadType: string # Legacy upload protocol for media (e.g. "media", "multipart").
  --outputAudioConfig: record # Instructs the speech synthesizer how to generate the output audio content. — shape: {audioEncoding?: "OUTPUT_AUDIO_ENCODING_UNSPECIFIED"|"OUTPUT_AUDIO_ENCODING_LINEAR_16"|"OUTPUT_AUDIO_ENCODING_MP3"|"OUTPUT_AUDIO_ENCODING_MP3_64_KBPS"|"OUTPUT_AUDIO_ENCODING_OGG_OPUS"|"OUTPUT_AUDIO_ENCODING_MULAW", sampleRateHertz?: int, synthesizeSpeechConfig?: record}
  --queryInput: record # Represents the query input. It can contain one of: 1. A conversational query in the form of text. 2. An intent query that specifies which intent to trigger. 3. Natural language speech audio to be processed. 4. An event to be triggered.  — shape: {audio?: record, dtmf?: record, event?: record, intent?: record, languageCode?: string, text?: record}
  --queryParams: record # Represents the parameters of a conversational query. — shape: {analyzeQueryTextSentiment?: bool, channel?: string, currentPage?: string, disableWebhook?: bool, flowVersions?: list, geoLocation?: record, parameters?: record, payload?: record, sessionEntityTypes?: list, timeZone?: string, webhookHeaders?: record}
  ...
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v3beta1/($session):detectIntent" $qp)
  let body = {outputAudioConfig: $outputAudioConfig, queryInput: $queryInput, queryParams: $queryParams} | compact
  let body = if ($input | describe | str starts-with "record") { $input | merge deep ($body | default {}) } else { $body }
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "post" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json" $body
...
export def "v3beta1 dialogflowprojectslocationsagentssessionsfulfillIntent" [
  ...
  --upload-protocol: string # Upload protocol for media (e.g. "raw", "multipart").
  --uploadType: string # Legacy upload protocol for media (e.g. "media", "multipart").
  --body-match: record # Represents one match result of MatchIntent. — shape: {confidence?: float, event?: string, intent?: record, matchType?: "MATCH_TYPE_UNSPECIFIED"|"INTENT"|"DIRECT_INTENT"|"PARAMETER_FILLING"|"NO_MATCH"|"NO_INPUT"|"EVENT", parameters?: record, resolvedInput?: string}
  --matchIntentRequest: record # Request of MatchIntent. — shape: {persistParameterChanges?: bool, queryInput?: record, queryParams?: record}
  --outputAudioConfig: record # Instructs the speech synthesizer how to generate the output audio content. — shape: {audioEncoding?: "OUTPUT_AUDIO_ENCODING_UNSPECIFIED"|"OUTPUT_AUDIO_ENCODING_LINEAR_16"|"OUTPUT_AUDIO_ENCODING_MP3"|"OUTPUT_AUDIO_ENCODING_MP3_64_KBPS"|"OUTPUT_AUDIO_ENCODING_OGG_OPUS"|"OUTPUT_AUDIO_ENCODING_MULAW", sampleRateHertz?: int, synthesizeSpeechConfig?: record}
]: any -> record<outputAudio: string, outputAudioConfig: record<audioEncoding: string, sampleRateHertz: int, synthesizeSpeechConfig: record<effectsProfileId: list, pitch: float, speakingRate: float, voice: record, volumeGainDb: float>>, queryResult: record<currentPage: record<displayName: string, entryFulfillment: record, eventHandlers: list, form: record, name: string, transitionRouteGroups: list, transitionRoutes: list>, diagnosticInfo: record, dtmf: record<digits: string, finishDigit: string>, intent: record<description: string, displayName: string, isFallback: bool, labels: record, name: string, parameters: list, priority: int, trainingPhrases: list>, intentDetectionConfidence: float, languageCode: string, match: record<confidence: float, event: string, intent: record, matchType: string, parameters: record, resolvedInput: string>, parameters: record, responseMessages: list<record>, sentimentAnalysisResult: record<magnitude: float, score: float>, text: string, transcript: string, triggerEvent: string, triggerIntent: string, webhookPayloads: list<record>, webhookStatuses: list<record>>, responseId: string> {
  let input = $in
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v3beta1/($session):fulfillIntent" $qp)
  let body = {match: $body_match, matchIntentRequest: $matchIntentRequest, outputAudioConfig: $outputAudioConfig} | compact
  let body = if ($input | describe | str starts-with "record") { $input | merge deep ($body | default {}) } else { $body }
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "post" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json" $body
...
export def "v3beta1 dialogflowprojectslocationsagentssessionsmatchIntent" [
  ...
  --upload-protocol: string # Upload protocol for media (e.g. "raw", "multipart").
  --uploadType: string # Legacy upload protocol for media (e.g. "media", "multipart").
  --persistParameterChanges: oneof<nothing, bool> # Persist session parameter changes from `query_params`.
  --queryInput: record # Represents the query input. It can contain one of: 1. A conversational query in the form of text. 2. An intent query that specifies which intent to trigger. 3. Natural language speech audio to be processed. 4. An event to be triggered.  — shape: {audio?: record, dtmf?: record, event?: record, intent?: record, languageCode?: string, text?: record}
  --queryParams: record # Represents the parameters of a conversational query. — shape: {analyzeQueryTextSentiment?: bool, channel?: string, currentPage?: string, disableWebhook?: bool, flowVersions?: list, geoLocation?: record, parameters?: record, payload?: record, sessionEntityTypes?: list, timeZone?: string, webhookHeaders?: record}
  ...
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v3beta1/($session):matchIntent" $qp)
  let body = {persistParameterChanges: $persistParameterChanges, queryInput: $queryInput, queryParams: $queryParams} | compact
  let body = if ($input | describe | str starts-with "record") { $input | merge deep ($body | default {}) } else { $body }
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "post" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json" $body
