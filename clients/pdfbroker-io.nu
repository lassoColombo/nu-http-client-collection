...
def build-auth [token?: string, auth_scheme?: string]: nothing -> record {
  let token_val = if ($token | is-not-empty) { $token } else { $env | get -o PDFBROKER_IO_API_TOKEN | default "" }
...
export def "pdf get" [
  ...
  let full_url = (build-url $base "/api/pdf" $auth.query)
...
export def "pdf-pdfconcat create" [
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let full_url = (build-url $base "/api/pdf/pdfconcat" $auth.query)
...
export def "pdf-pdftoimage create" [
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let full_url = (build-url $base "/api/pdf/pdftoimage" $auth.query)
...
export def "pdf-pdfwritestring create" [
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let full_url = (build-url $base "/api/pdf/pdfwritestring" $auth.query)
...
export def "pdf-wkhtmltopdf create" [
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let full_url = (build-url $base "/api/pdf/wkhtmltopdf" $auth.query)
...
export def "pdf-xslfo create" [
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let full_url = (build-url $base "/api/pdf/xslfo" $auth.query)
...
export def "pdf-xslfowithtransform create" [
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let full_url = (build-url $base "/api/pdf/xslfowithtransform" $auth.query)
