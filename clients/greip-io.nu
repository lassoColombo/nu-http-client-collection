...
export def "bulk-lookup get" [
  ...
  do-request "get" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors $full "application/json" null {query: ({"key": $key, "ips": $ips, "params": $params, "lang": $lang, "format": $format} | compact), body: null}
}
...
export def "country get" [
  ...
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "get" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors $full "application/json" null {query: ({"key": $key, "CountryCode": $country_code, "params": $params, "lang": $lang, "format": $format} | compact), body: null}
}
...
export def "geo-ip get" [
  ...
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "get" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors $full "application/json" null {query: ({"key": $key, "params": $params, "lang": $lang, "format": $format} | compact), body: null}
}
...
export def "ip-lookup get" [
  ...
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "get" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors $full "application/json" null {query: ({"key": $key, "ip": $ip, "params": $params, "lang": $lang, "format": $format} | compact), body: null}
}
...
export def "bad-words get" [
  ...
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "get" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors $full "application/json" null {query: ({"key": $key, "text": $text, "listBadWords": $list_bad_words, "scoreOnly": $score_only, "format": $format} | compact), body: null}
}
