...
def AquaConfigurationStatus-completer [] { ["auto" "disabled" "enabled"] }
...
def FeatureType-completer [] { ["concurrency-scaling" "cross-region-datasharing" "spectrum"] }
def LimitType-completer [] { ["data-scanned" "time"] }
def Period-completer [] { ["daily" "monthly" "weekly"] }
def BreachAction-completer [] { ["disable" "emit-metric" "log"] }
...
def SourceType-completer [] { ["cluster" "cluster-parameter-group" "cluster-security-group" "cluster-snapshot" "scheduled-action"] }
...
def ActionType-completer [] { ["recommend-node-config" "resize-cluster" "restore-cluster"] }
...
def TargetActionType-completer [] { ["PauseCluster" "ResizeCluster" "ResumeCluster"] }
...
def LogDestinationType-completer [] { ["cloudwatch" "s3"] }
...
def ActionType-completer-1 [] { ["resize-cluster" "restore-cluster"] }
...
export def commands []: nothing -> table {
  ...
  let mod_name = (scope modules | where { $in.commands | any { $in.name == "action-accept-reserved-node-exchange AcceptReservedNodeExchange" } } | get name | first)
...
export def "action-accept-reserved-node-exchange AcceptReservedNodeExchange" [
  ...
  --TargetReservedNodeOfferingId: string # The unique identifier of the DC2 Reserved Node offering to be used for the exchange. You can obtain the value for the parameter by calling <a>GetReservedNodeExchangeOfferings</a> 
  ...
  let qp = [(serialize-qp "ReservedNodeId" $ReservedNodeId "scalar") (serialize-qp "TargetReservedNodeOfferingId" $TargetReservedNodeOfferingId "scalar") (serialize-qp "Action" $Action "scalar") (serialize-qp "Version" $Version "scalar")] | flatten | str join "&"
...
export def "action-accept-reserved-node-exchange AcceptReservedNodeExchange-1" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
...
export def "action-add-partner AddPartner" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
  ...
  --ClusterIdentifier: string # The cluster identifier of the cluster that receives data from the partner.
  --DatabaseName: string # The name of the database that receives data from the partner.
  --PartnerName: string # The name of the partner that is authorized to send data.
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "AccountId" $AccountId "scalar") (serialize-qp "ClusterIdentifier" $ClusterIdentifier "scalar") (serialize-qp "DatabaseName" $DatabaseName "scalar") (serialize-qp "PartnerName" $PartnerName "scalar") (serialize-qp "Action" $Action "scalar") (serialize-qp "Version" $Version "scalar")] | flatten | str join "&"
...
export def "action-add-partner AddPartner-1" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
...
export def "action-associate-data-share-consumer AssociateDataShareConsumer" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
  ...
  --allow-errors(-e) # Return full response without error handling
  --dry-run(-n) # Return the request that would be sent without executing it
  --DataShareArn: string # The Amazon Resource Name (ARN) of the datashare that the consumer is to use with the account or the namespace.
  --AssociateEntireAccount: oneof<nothing, bool> # A value that specifies whether the datashare is associated with the entire account.
  --ConsumerArn: string # The Amazon Resource Name (ARN) of the consumer that is associated with the datashare.
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "DataShareArn" $DataShareArn "scalar") (serialize-qp "AssociateEntireAccount" $AssociateEntireAccount "scalar") (serialize-qp "ConsumerArn" $ConsumerArn "scalar") (serialize-qp "ConsumerRegion" $ConsumerRegion "scalar") (serialize-qp "Action" $Action "scalar") (serialize-qp "Version" $Version "scalar")] | flatten | str join "&"
...
export def "action-associate-data-share-consumer AssociateDataShareConsumer-1" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
...
export def "action-authorize-cluster-security-group-ingress AuthorizeClusterSecurityGroupIngress" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
  ...
  --EC2SecurityGroupOwnerId: string # <p>The Amazon Web Services account number of the owner of the security group specified by the <i>EC2SecurityGroupName</i> parameter. The Amazon Web Services Access Key ID is not an acceptable value. </p> <p>Example: <code>111122223333</code> </p>
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "ClusterSecurityGroupName" $ClusterSecurityGroupName "scalar") (serialize-qp "CIDRIP" $CIDRIP "scalar") (serialize-qp "EC2SecurityGroupName" $EC2SecurityGroupName "scalar") (serialize-qp "EC2SecurityGroupOwnerId" $EC2SecurityGroupOwnerId "scalar") (serialize-qp "Action" $Action "scalar") (serialize-qp "Version" $Version "scalar")] | flatten | str join "&"
...
export def "action-authorize-cluster-security-group-ingress AuthorizeClusterSecurityGroupIngress-1" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
...
export def "action-authorize-data-share AuthorizeDataShare" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
  ...
  --allow-errors(-e) # Return full response without error handling
  --dry-run(-n) # Return the request that would be sent without executing it
  --DataShareArn: string # The Amazon Resource Name (ARN) of the datashare that producers are to authorize sharing for.
  --ConsumerIdentifier: string # The identifier of the data consumer that is authorized to access the datashare. This identifier is an Amazon Web Services account ID or a keyword, such as ADX.
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "DataShareArn" $DataShareArn "scalar") (serialize-qp "ConsumerIdentifier" $ConsumerIdentifier "scalar") (serialize-qp "Action" $Action "scalar") (serialize-qp "Version" $Version "scalar")] | flatten | str join "&"
...
export def "action-authorize-data-share AuthorizeDataShare-1" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
...
export def "action-authorize-endpoint-access AuthorizeEndpointAccess" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
  ...
  --VpcIds: list # The virtual private cloud (VPC) identifiers to grant access to.
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "ClusterIdentifier" $ClusterIdentifier "scalar") (serialize-qp "Account" $Account "scalar") (serialize-qp "VpcIds" $VpcIds "multi") (serialize-qp "Action" $Action "scalar") (serialize-qp "Version" $Version "scalar")] | flatten | str join "&"
...
export def "action-authorize-endpoint-access AuthorizeEndpointAccess-1" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
...
export def "action-authorize-snapshot-access AuthorizeSnapshotAccess" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
  ...
  --SnapshotClusterIdentifier: string # The identifier of the cluster the snapshot was created from. This parameter is required if your IAM user or role has a policy containing a snapshot resource element that specifies anything other than * for the cluster name.
  --AccountWithRestoreAccess: string # <p>The identifier of the Amazon Web Services account authorized to restore the specified snapshot.</p> <p>To share a snapshot with Amazon Web Services Support, specify amazon-redshift-support.</p>
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "SnapshotIdentifier" $SnapshotIdentifier "scalar") (serialize-qp "SnapshotArn" $SnapshotArn "scalar") (serialize-qp "SnapshotClusterIdentifier" $SnapshotClusterIdentifier "scalar") (serialize-qp "AccountWithRestoreAccess" $AccountWithRestoreAccess "scalar") (serialize-qp "Action" $Action "scalar") (serialize-qp "Version" $Version "scalar")] | flatten | str join "&"
...
export def "action-authorize-snapshot-access AuthorizeSnapshotAccess-1" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
...
export def "action-batch-delete-cluster-snapshots BatchDeleteClusterSnapshots" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
...
export def "action-batch-delete-cluster-snapshots BatchDeleteClusterSnapshots-1" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
...
export def "action-batch-modify-cluster-snapshots BatchModifyClusterSnapshots" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "SnapshotIdentifierList" $SnapshotIdentifierList "multi") (serialize-qp "ManualSnapshotRetentionPeriod" $ManualSnapshotRetentionPeriod "scalar") (serialize-qp "Force" $Force "scalar") (serialize-qp "Action" $Action "scalar") (serialize-qp "Version" $Version "scalar")] | flatten | str join "&"
...
export def "action-batch-modify-cluster-snapshots BatchModifyClusterSnapshots-1" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
...
export def "action-cancel-resize CancelResize" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
  ...
  --allow-errors(-e) # Return full response without error handling
  --dry-run(-n) # Return the request that would be sent without executing it
  --ClusterIdentifier: string # The unique identifier for the cluster that you want to cancel a resize operation for.
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "ClusterIdentifier" $ClusterIdentifier "scalar") (serialize-qp "Action" $Action "scalar") (serialize-qp "Version" $Version "scalar")] | flatten | str join "&"
...
export def "action-cancel-resize CancelResize-1" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
...
export def "action-copy-cluster-snapshot CopyClusterSnapshot" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
  ...
  --SourceSnapshotClusterIdentifier: string # <p>The identifier of the cluster the source snapshot was created from. This parameter is required if your IAM user or role has a policy containing a snapshot resource element that specifies anything other than * for the cluster name.</p> <p>Constraints:</p> <ul> <li> <p>Must be the identifier for a valid cluster.</p> </li> </ul>
  ...
  --ManualSnapshotRetentionPeriod: int # <p>The number of days that a manual snapshot is retained. If the value is -1, the manual snapshot is retained indefinitely. </p> <p>The value must be either -1 or an integer between 1 and 3,653.</p> <p>The default value is -1.</p>
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "SourceSnapshotIdentifier" $SourceSnapshotIdentifier "scalar") (serialize-qp "SourceSnapshotClusterIdentifier" $SourceSnapshotClusterIdentifier "scalar") (serialize-qp "TargetSnapshotIdentifier" $TargetSnapshotIdentifier "scalar") (serialize-qp "ManualSnapshotRetentionPeriod" $ManualSnapshotRetentionPeriod "scalar") (serialize-qp "Action" $Action "scalar") (serialize-qp "Version" $Version "scalar")] | flatten | str join "&"
...
export def "action-copy-cluster-snapshot CopyClusterSnapshot-1" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
...
export def "action-create-authentication-profile CreateAuthenticationProfile" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
  ...
  --allow-errors(-e) # Return full response without error handling
  --dry-run(-n) # Return the request that would be sent without executing it
  --AuthenticationProfileName: string # The name of the authentication profile to be created.
  --AuthenticationProfileContent: string # The content of the authentication profile in JSON format. The maximum length of the JSON string is determined by a quota for your account.
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "AuthenticationProfileName" $AuthenticationProfileName "scalar") (serialize-qp "AuthenticationProfileContent" $AuthenticationProfileContent "scalar") (serialize-qp "Action" $Action "scalar") (serialize-qp "Version" $Version "scalar")] | flatten | str join "&"
...
export def "action-create-authentication-profile CreateAuthenticationProfile-1" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
...
export def "action-create-cluster CreateCluster" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
  ...
  --MasterUsername: string # <p>The user name associated with the admin user for the cluster that is being created.</p> <p>Constraints:</p> <ul> <li> <p>Must be 1 - 128 alphanumeric characters or hyphens. The user name can't be <code>PUBLIC</code>.</p> </li> <li> <p>Must contain only lowercase letters, numbers, underscore, plus sign, period (dot), at symbol (@), or hyphen.</p> </li> <li> <p>The first character must be a letter.</p> </li> <li> <p>Must not contain a colon (:) or a slash (/).</p> </li> <li> <p>Cannot be a reserved word. A list of reserved words can be found in <a href="https://docs.aws.amazon.com/redshift/latest/dg/r_pg_keywords.html">Reserved Words</a> in the Amazon Redshift Database Developer Guide. </p> </li> </ul>
  --MasterUserPassword: string # <p>The password associated with the admin user for the cluster that is being created.</p> <p>Constraints:</p> <ul> <li> <p>Must be between 8 and 64 characters in length.</p> </li> <li> <p>Must contain at least one uppercase letter.</p> </li> <li> <p>Must contain at least one lowercase letter.</p> </li> <li> <p>Must contain one number.</p> </li> <li> <p>Can be any printable ASCII character (ASCII code 33-126) except <code>'</code> (single quote), <code>"</code> (double quote), <code>\</code>, <code>/</code>, or <code>@</code>.</p> </li> </ul>
  --ClusterSecurityGroups: list # <p>A list of security groups to be associated with this cluster.</p> <p>Default: The default cluster security group for Amazon Redshift.</p>
  --VpcSecurityGroupIds: list # <p>A list of Virtual Private Cloud (VPC) security groups to be associated with the cluster.</p> <p>Default: The default VPC security group is associated with the cluster.</p>
  ...
  --ClusterParameterGroupName: string # <p>The name of the parameter group to be associated with this cluster.</p> <p>Default: The default Amazon Redshift cluster parameter group. For information about the default parameter group, go to <a href="https://docs.aws.amazon.com/redshift/latest/mgmt/working-with-parameter-groups.html">Working with Amazon Redshift Parameter Groups</a> </p> <p>Constraints:</p> <ul> <li> <p>Must be 1 to 255 alphanumeric characters or hyphens.</p> </li> <li> <p>First character must be a letter.</p> </li> <li> <p>Cannot end with a hyphen or contain two consecutive hyphens.</p> </li> </ul>
  --AutomatedSnapshotRetentionPeriod: int # <p>The number of days that automated snapshots are retained. If the value is 0, automated snapshots are disabled. Even if automated snapshots are disabled, you can still create manual snapshots when you want with <a>CreateClusterSnapshot</a>. </p> <p>You can't disable automated snapshots for RA3 node types. Set the automated retention period from 1-35 days.</p> <p>Default: <code>1</code> </p> <p>Constraints: Must be a value from 0 to 35.</p>
  --ManualSnapshotRetentionPeriod: int # <p>The default number of days to retain a manual snapshot. If the value is -1, the snapshot is retained indefinitely. This setting doesn't change the retention period of existing snapshots.</p> <p>The value must be either -1 or an integer between 1 and 3,653.</p>
  ...
  --AllowVersionUpgrade: oneof<nothing, bool> # <p>If <code>true</code>, major version upgrades can be applied during the maintenance window to the Amazon Redshift engine that is running on the cluster.</p> <p>When a new major version of the Amazon Redshift engine is released, you can request that the service automatically apply upgrades during the maintenance window to the Amazon Redshift engine that is running on your cluster.</p> <p>Default: <code>true</code> </p>
  ...
  --PubliclyAccessible: oneof<nothing, bool> # If <code>true</code>, the cluster can be accessed from a public network. 
  ...
  --EnhancedVpcRouting: oneof<nothing, bool> # <p>An option that specifies whether to create the cluster with enhanced VPC routing enabled. To create a cluster that uses enhanced VPC routing, the cluster must be in a VPC. For more information, see <a href="https://docs.aws.amazon.com/redshift/latest/mgmt/enhanced-vpc-routing.html">Enhanced VPC Routing</a> in the Amazon Redshift Cluster Management Guide.</p> <p>If this option is <code>true</code>, enhanced VPC routing is enabled. </p> <p>Default: false</p>
  --AdditionalInfo: string # Reserved.
  --IamRoles: list # <p>A list of Identity and Access Management (IAM) roles that can be used by the cluster to access other Amazon Web Services services. You must supply the IAM roles in their Amazon Resource Name (ARN) format. </p> <p>The maximum number of IAM roles that you can associate is subject to a quota. For more information, go to <a href="https://docs.aws.amazon.com/redshift/latest/mgmt/amazon-redshift-limits.html">Quotas and limits</a> in the <i>Amazon Redshift Cluster Management Guide</i>.</p>
  --MaintenanceTrackName: string # An optional parameter for the name of the maintenance track for the cluster. If you don't provide a maintenance track name, the cluster is assigned to the <code>current</code> track.
  --SnapshotScheduleIdentifier: string # A unique identifier for the snapshot schedule.
  --AvailabilityZoneRelocation: oneof<nothing, bool> # The option to enable relocation for an Amazon Redshift cluster between Availability Zones after the cluster is created.
  --AquaConfigurationStatus: string@AquaConfigurationStatus-completer # This parameter is retired. It does not set the AQUA configuration status. Amazon Redshift automatically determines whether to use AQUA (Advanced Query Accelerator).
  --DefaultIamRoleArn: string # The Amazon Resource Name (ARN) for the IAM role that was set as default for the cluster when the cluster was created. 
  --LoadSampleData: string # A flag that specifies whether to load sample data once the cluster is created.
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "DBName" $DBName "scalar") (serialize-qp "ClusterIdentifier" $ClusterIdentifier "scalar") (serialize-qp "ClusterType" $ClusterType "scalar") (serialize-qp "NodeType" $NodeType "scalar") (serialize-qp "MasterUsername" $MasterUsername "scalar") (serialize-qp "MasterUserPassword" $MasterUserPassword "scalar") (serialize-qp "ClusterSecurityGroups" $ClusterSecurityGroups "multi") (serialize-qp "VpcSecurityGroupIds" $VpcSecurityGroupIds "multi") (serialize-qp "ClusterSubnetGroupName" $ClusterSubnetGroupName "scalar") (serialize-qp "AvailabilityZone" $AvailabilityZone "scalar") (serialize-qp "PreferredMaintenanceWindow" $PreferredMaintenanceWindow "scalar") (serialize-qp "ClusterParameterGroupName" $ClusterParameterGroupName "scalar") (serialize-qp "AutomatedSnapshotRetentionPeriod" $AutomatedSnapshotRetentionPeriod "scalar") (serialize-qp "ManualSnapshotRetentionPeriod" $ManualSnapshotRetentionPeriod "scalar") (serialize-qp "Port" $Port "scalar") (serialize-qp "ClusterVersion" $ClusterVersion "scalar") (serialize-qp "AllowVersionUpgrade" $AllowVersionUpgrade "scalar") (serialize-qp "NumberOfNodes" $NumberOfNodes "scalar") (serialize-qp "PubliclyAccessible" $PubliclyAccessible "scalar") (serialize-qp "Encrypted" $Encrypted "scalar") (serialize-qp "HsmClientCertificateIdentifier" $HsmClientCertificateIdentifier "scalar") (serialize-qp "HsmConfigurationIdentifier" $HsmConfigurationIdentifier "scalar") (serialize-qp "ElasticIp" $ElasticIp "scalar") (serialize-qp "Tags" $Tags "multi") (serialize-qp "KmsKeyId" $KmsKeyId "scalar") (serialize-qp "EnhancedVpcRouting" $EnhancedVpcRouting "scalar") (serialize-qp "AdditionalInfo" $AdditionalInfo "scalar") (serialize-qp "IamRoles" $IamRoles "multi") (serialize-qp "MaintenanceTrackName" $MaintenanceTrackName "scalar") (serialize-qp "SnapshotScheduleIdentifier" $SnapshotScheduleIdentifier "scalar") (serialize-qp "AvailabilityZoneRelocation" $AvailabilityZoneRelocation "scalar") (serialize-qp "AquaConfigurationStatus" $AquaConfigurationStatus "scalar") (serialize-qp "DefaultIamRoleArn" $DefaultIamRoleArn "scalar") (serialize-qp "LoadSampleData" $LoadSampleData "scalar") (serialize-qp "Action" $Action "scalar") (serialize-qp "Version" $Version "scalar")] | flatten | str join "&"
...
export def "action-create-cluster CreateCluster-1" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
...
export def "action-create-cluster-parameter-group CreateClusterParameterGroup" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
  ...
  --ParameterGroupFamily: string # <p>The Amazon Redshift engine version to which the cluster parameter group applies. The cluster engine version determines the set of parameters.</p> <p>To get a list of valid parameter group family names, you can call <a>DescribeClusterParameterGroups</a>. By default, Amazon Redshift returns a list of all the parameter groups that are owned by your Amazon Web Services account, including the default parameter groups for each Amazon Redshift engine version. The parameter group family names associated with the default parameter groups provide you the valid values. For example, a valid family name is "redshift-1.0". </p>
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "ParameterGroupName" $ParameterGroupName "scalar") (serialize-qp "ParameterGroupFamily" $ParameterGroupFamily "scalar") (serialize-qp "Description" $Description "scalar") (serialize-qp "Tags" $Tags "multi") (serialize-qp "Action" $Action "scalar") (serialize-qp "Version" $Version "scalar")] | flatten | str join "&"
...
export def "action-create-cluster-parameter-group CreateClusterParameterGroup-1" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
...
export def "action-create-cluster-security-group CreateClusterSecurityGroup" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "ClusterSecurityGroupName" $ClusterSecurityGroupName "scalar") (serialize-qp "Description" $Description "scalar") (serialize-qp "Tags" $Tags "multi") (serialize-qp "Action" $Action "scalar") (serialize-qp "Version" $Version "scalar")] | flatten | str join "&"
...
export def "action-create-cluster-security-group CreateClusterSecurityGroup-1" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
...
export def "action-create-cluster-snapshot CreateClusterSnapshot" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "SnapshotIdentifier" $SnapshotIdentifier "scalar") (serialize-qp "ClusterIdentifier" $ClusterIdentifier "scalar") (serialize-qp "ManualSnapshotRetentionPeriod" $ManualSnapshotRetentionPeriod "scalar") (serialize-qp "Tags" $Tags "multi") (serialize-qp "Action" $Action "scalar") (serialize-qp "Version" $Version "scalar")] | flatten | str join "&"
...
export def "action-create-cluster-snapshot CreateClusterSnapshot-1" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
...
export def "action-create-cluster-subnet-group CreateClusterSubnetGroup" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "ClusterSubnetGroupName" $ClusterSubnetGroupName "scalar") (serialize-qp "Description" $Description "scalar") (serialize-qp "SubnetIds" $SubnetIds "multi") (serialize-qp "Tags" $Tags "multi") (serialize-qp "Action" $Action "scalar") (serialize-qp "Version" $Version "scalar")] | flatten | str join "&"
...
export def "action-create-cluster-subnet-group CreateClusterSubnetGroup-1" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
...
export def "action-create-endpoint-access CreateEndpointAccess" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
  ...
  --EndpointName: string # <p>The Redshift-managed VPC endpoint name.</p> <p>An endpoint name must contain 1-30 characters. Valid characters are A-Z, a-z, 0-9, and hyphen(-). The first character must be a letter. The name can't contain two consecutive hyphens or end with a hyphen.</p>
  --SubnetGroupName: string # The subnet group from which Amazon Redshift chooses the subnet to deploy the endpoint.
  --VpcSecurityGroupIds: list # The security group that defines the ports, protocols, and sources for inbound traffic that you are authorizing into your endpoint.
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "ClusterIdentifier" $ClusterIdentifier "scalar") (serialize-qp "ResourceOwner" $ResourceOwner "scalar") (serialize-qp "EndpointName" $EndpointName "scalar") (serialize-qp "SubnetGroupName" $SubnetGroupName "scalar") (serialize-qp "VpcSecurityGroupIds" $VpcSecurityGroupIds "multi") (serialize-qp "Action" $Action "scalar") (serialize-qp "Version" $Version "scalar")] | flatten | str join "&"
...
export def "action-create-endpoint-access CreateEndpointAccess-1" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
...
export def "action-create-event-subscription CreateEventSubscription" [
  ...
  --SourceIds: list # <p>A list of one or more identifiers of Amazon Redshift source objects. All of the objects must be of the same type as was specified in the source type parameter. The event subscription will return only events generated by the specified objects. If not specified, then events are returned for all objects within the source type specified.</p> <p>Example: my-cluster-1, my-cluster-2</p> <p>Example: my-snapshot-20131010</p>
  --EventCategories: list # <p>Specifies the Amazon Redshift event categories to be published by the event notification subscription.</p> <p>Values: configuration, management, monitoring, security, pending</p>
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "SubscriptionName" $SubscriptionName "scalar") (serialize-qp "SnsTopicArn" $SnsTopicArn "scalar") (serialize-qp "SourceType" $SourceType "scalar") (serialize-qp "SourceIds" $SourceIds "multi") (serialize-qp "EventCategories" $EventCategories "multi") (serialize-qp "Severity" $Severity "scalar") (serialize-qp "Enabled" $Enabled "scalar") (serialize-qp "Tags" $Tags "multi") (serialize-qp "Action" $Action "scalar") (serialize-qp "Version" $Version "scalar")] | flatten | str join "&"
...
export def "action-create-hsm-client-certificate CreateHsmClientCertificate" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "HsmClientCertificateIdentifier" $HsmClientCertificateIdentifier "scalar") (serialize-qp "Tags" $Tags "multi") (serialize-qp "Action" $Action "scalar") (serialize-qp "Version" $Version "scalar")] | flatten | str join "&"
...
export def "action-create-hsm-client-certificate CreateHsmClientCertificate-1" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
...
export def "action-create-hsm-configuration CreateHsmConfiguration" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "HsmConfigurationIdentifier" $HsmConfigurationIdentifier "scalar") (serialize-qp "Description" $Description "scalar") (serialize-qp "HsmIpAddress" $HsmIpAddress "scalar") (serialize-qp "HsmPartitionName" $HsmPartitionName "scalar") (serialize-qp "HsmPartitionPassword" $HsmPartitionPassword "scalar") (serialize-qp "HsmServerPublicCertificate" $HsmServerPublicCertificate "scalar") (serialize-qp "Tags" $Tags "multi") (serialize-qp "Action" $Action "scalar") (serialize-qp "Version" $Version "scalar")] | flatten | str join "&"
...
export def "action-create-hsm-configuration CreateHsmConfiguration-1" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
...
export def "action-create-scheduled-action CreateScheduledAction" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
  ...
  --allow-errors(-e) # Return full response without error handling
  --dry-run(-n) # Return the request that would be sent without executing it
  --ScheduledActionName: string # The name of the scheduled action. The name must be unique within an account. For more information about this parameter, see <a>ScheduledAction</a>. 
  --TargetAction: record # A JSON format string of the Amazon Redshift API operation with input parameters. For more information about this parameter, see <a>ScheduledAction</a>. 
  ...
  --IamRole: string # The IAM role to assume to run the target action. For more information about this parameter, see <a>ScheduledAction</a>. 
  --ScheduledActionDescription: string # The description of the scheduled action. 
  --StartTime: string # The start time in UTC of the scheduled action. Before this time, the scheduled action does not trigger. For more information about this parameter, see <a>ScheduledAction</a>. (format: date-time)
  --EndTime: string # The end time in UTC of the scheduled action. After this time, the scheduled action does not trigger. For more information about this parameter, see <a>ScheduledAction</a>.  (format: date-time)
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "ScheduledActionName" $ScheduledActionName "scalar") (serialize-qp "TargetAction" $TargetAction "multi") (serialize-qp "Schedule" $Schedule "scalar") (serialize-qp "IamRole" $IamRole "scalar") (serialize-qp "ScheduledActionDescription" $ScheduledActionDescription "scalar") (serialize-qp "StartTime" $StartTime "scalar") (serialize-qp "EndTime" $EndTime "scalar") (serialize-qp "Enable" $Enable "scalar") (serialize-qp "Action" $Action "scalar") (serialize-qp "Version" $Version "scalar")] | flatten | str join "&"
...
export def "action-create-scheduled-action CreateScheduledAction-1" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
...
export def "action-create-snapshot-copy-grant CreateSnapshotCopyGrant" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
  ...
  --allow-errors(-e) # Return full response without error handling
  --dry-run(-n) # Return the request that would be sent without executing it
  --SnapshotCopyGrantName: string # <p>The name of the snapshot copy grant. This name must be unique in the region for the Amazon Web Services account.</p> <p>Constraints:</p> <ul> <li> <p>Must contain from 1 to 63 alphanumeric characters or hyphens.</p> </li> <li> <p>Alphabetic characters must be lowercase.</p> </li> <li> <p>First character must be a letter.</p> </li> <li> <p>Cannot end with a hyphen or contain two consecutive hyphens.</p> </li> <li> <p>Must be unique for all clusters within an Amazon Web Services account.</p> </li> </ul>
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "SnapshotCopyGrantName" $SnapshotCopyGrantName "scalar") (serialize-qp "KmsKeyId" $KmsKeyId "scalar") (serialize-qp "Tags" $Tags "multi") (serialize-qp "Action" $Action "scalar") (serialize-qp "Version" $Version "scalar")] | flatten | str join "&"
...
export def "action-create-snapshot-copy-grant CreateSnapshotCopyGrant-1" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
...
export def "action-create-snapshot-schedule CreateSnapshotSchedule" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
  ...
  --allow-errors(-e) # Return full response without error handling
  --dry-run(-n) # Return the request that would be sent without executing it
  --ScheduleDefinitions: list # The definition of the snapshot schedule. The definition is made up of schedule expressions, for example "cron(30 12 *)" or "rate(12 hours)". 
  ...
  --DryRun: oneof<nothing, bool> # <p/>
  --NextInvocations: int # <p/>
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "ScheduleDefinitions" $ScheduleDefinitions "multi") (serialize-qp "ScheduleIdentifier" $ScheduleIdentifier "scalar") (serialize-qp "ScheduleDescription" $ScheduleDescription "scalar") (serialize-qp "Tags" $Tags "multi") (serialize-qp "DryRun" $DryRun "scalar") (serialize-qp "NextInvocations" $NextInvocations "scalar") (serialize-qp "Action" $Action "scalar") (serialize-qp "Version" $Version "scalar")] | flatten | str join "&"
...
export def "action-create-snapshot-schedule CreateSnapshotSchedule-1" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
...
export def "action-create-tags CreateTags" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
  ...
  --allow-errors(-e) # Return full response without error handling
  --dry-run(-n) # Return the request that would be sent without executing it
  --ResourceName: string # The Amazon Resource Name (ARN) to which you want to add the tag or tags. For example, <code>arn:aws:redshift:us-east-2:123456789:cluster:t1</code>. 
...
export def "action-create-tags CreateTags-1" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
...
export def "action-create-usage-limit CreateUsageLimit" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
  ...
  --BreachAction: string@BreachAction-completer # The action that Amazon Redshift takes when the limit is reached. The default is log. For more information about this parameter, see <a>UsageLimit</a>.
  --Tags: list # A list of tag instances.
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "ClusterIdentifier" $ClusterIdentifier "scalar") (serialize-qp "FeatureType" $FeatureType "scalar") (serialize-qp "LimitType" $LimitType "scalar") (serialize-qp "Amount" $Amount "scalar") (serialize-qp "Period" $Period "scalar") (serialize-qp "BreachAction" $BreachAction "scalar") (serialize-qp "Tags" $Tags "multi") (serialize-qp "Action" $Action "scalar") (serialize-qp "Version" $Version "scalar")] | flatten | str join "&"
...
export def "action-create-usage-limit CreateUsageLimit-1" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
...
export def "action-deauthorize-data-share DeauthorizeDataShare" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
  ...
  --allow-errors(-e) # Return full response without error handling
  --dry-run(-n) # Return the request that would be sent without executing it
  --DataShareArn: string # The Amazon Resource Name (ARN) of the datashare to remove authorization from.
...
export def "action-deauthorize-data-share DeauthorizeDataShare-1" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
...
export def "action-delete-authentication-profile DeleteAuthenticationProfile" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "AuthenticationProfileName" $AuthenticationProfileName "scalar") (serialize-qp "Action" $Action "scalar") (serialize-qp "Version" $Version "scalar")] | flatten | str join "&"
...
export def "action-delete-authentication-profile DeleteAuthenticationProfile-1" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
...
export def "action-delete-cluster DeleteCluster" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
  ...
  --SkipFinalClusterSnapshot: oneof<nothing, bool> # <p>Determines whether a final snapshot of the cluster is created before Amazon Redshift deletes the cluster. If <code>true</code>, a final cluster snapshot is not created. If <code>false</code>, a final cluster snapshot is created before the cluster is deleted. </p> <note> <p>The <i>FinalClusterSnapshotIdentifier</i> parameter must be specified if <i>SkipFinalClusterSnapshot</i> is <code>false</code>.</p> </note> <p>Default: <code>false</code> </p>
  ...
  --FinalClusterSnapshotRetentionPeriod: int # <p>The number of days that a manual snapshot is retained. If the value is -1, the manual snapshot is retained indefinitely.</p> <p>The value must be either -1 or an integer between 1 and 3,653.</p> <p>The default value is -1.</p>
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "ClusterIdentifier" $ClusterIdentifier "scalar") (serialize-qp "SkipFinalClusterSnapshot" $SkipFinalClusterSnapshot "scalar") (serialize-qp "FinalClusterSnapshotIdentifier" $FinalClusterSnapshotIdentifier "scalar") (serialize-qp "FinalClusterSnapshotRetentionPeriod" $FinalClusterSnapshotRetentionPeriod "scalar") (serialize-qp "Action" $Action "scalar") (serialize-qp "Version" $Version "scalar")] | flatten | str join "&"
...
export def "action-delete-cluster DeleteCluster-1" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
...
export def "action-delete-cluster-parameter-group DeleteClusterParameterGroup" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "ParameterGroupName" $ParameterGroupName "scalar") (serialize-qp "Action" $Action "scalar") (serialize-qp "Version" $Version "scalar")] | flatten | str join "&"
...
export def "action-delete-cluster-parameter-group DeleteClusterParameterGroup-1" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
...
export def "action-delete-cluster-security-group DeleteClusterSecurityGroup" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "ClusterSecurityGroupName" $ClusterSecurityGroupName "scalar") (serialize-qp "Action" $Action "scalar") (serialize-qp "Version" $Version "scalar")] | flatten | str join "&"
...
export def "action-delete-cluster-security-group DeleteClusterSecurityGroup-1" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
...
export def "action-delete-cluster-snapshot DeleteClusterSnapshot" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
  ...
  --allow-errors(-e) # Return full response without error handling
  --dry-run(-n) # Return the request that would be sent without executing it
  --SnapshotIdentifier: string # <p>The unique identifier of the manual snapshot to be deleted.</p> <p>Constraints: Must be the name of an existing snapshot that is in the <code>available</code>, <code>failed</code>, or <code>cancelled</code> state.</p>
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "SnapshotIdentifier" $SnapshotIdentifier "scalar") (serialize-qp "SnapshotClusterIdentifier" $SnapshotClusterIdentifier "scalar") (serialize-qp "Action" $Action "scalar") (serialize-qp "Version" $Version "scalar")] | flatten | str join "&"
...
export def "action-delete-cluster-snapshot DeleteClusterSnapshot-1" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
...
export def "action-delete-cluster-subnet-group DeleteClusterSubnetGroup" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "ClusterSubnetGroupName" $ClusterSubnetGroupName "scalar") (serialize-qp "Action" $Action "scalar") (serialize-qp "Version" $Version "scalar")] | flatten | str join "&"
...
export def "action-delete-cluster-subnet-group DeleteClusterSubnetGroup-1" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
...
export def "action-delete-endpoint-access DeleteEndpointAccess" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "EndpointName" $EndpointName "scalar") (serialize-qp "Action" $Action "scalar") (serialize-qp "Version" $Version "scalar")] | flatten | str join "&"
...
export def "action-delete-endpoint-access DeleteEndpointAccess-1" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
...
export def "action-delete-hsm-client-certificate DeleteHsmClientCertificate" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "HsmClientCertificateIdentifier" $HsmClientCertificateIdentifier "scalar") (serialize-qp "Action" $Action "scalar") (serialize-qp "Version" $Version "scalar")] | flatten | str join "&"
...
export def "action-delete-hsm-client-certificate DeleteHsmClientCertificate-1" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
...
export def "action-delete-hsm-configuration DeleteHsmConfiguration" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "HsmConfigurationIdentifier" $HsmConfigurationIdentifier "scalar") (serialize-qp "Action" $Action "scalar") (serialize-qp "Version" $Version "scalar")] | flatten | str join "&"
...
export def "action-delete-hsm-configuration DeleteHsmConfiguration-1" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
...
export def "action-delete-partner DeletePartner" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
...
export def "action-delete-partner DeletePartner-1" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
...
export def "action-delete-scheduled-action DeleteScheduledAction" [
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "ScheduledActionName" $ScheduledActionName "scalar") (serialize-qp "Action" $Action "scalar") (serialize-qp "Version" $Version "scalar")] | flatten | str join "&"
...
export def "action-delete-snapshot-copy-grant DeleteSnapshotCopyGrant" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "SnapshotCopyGrantName" $SnapshotCopyGrantName "scalar") (serialize-qp "Action" $Action "scalar") (serialize-qp "Version" $Version "scalar")] | flatten | str join "&"
...
export def "action-delete-snapshot-copy-grant DeleteSnapshotCopyGrant-1" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
...
export def "action-delete-snapshot-schedule DeleteSnapshotSchedule" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "ScheduleIdentifier" $ScheduleIdentifier "scalar") (serialize-qp "Action" $Action "scalar") (serialize-qp "Version" $Version "scalar")] | flatten | str join "&"
...
export def "action-delete-snapshot-schedule DeleteSnapshotSchedule-1" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
...
export def "action-delete-tags DeleteTags" [
  ...
  --allow-errors(-e) # Return full response without error handling
  --dry-run(-n) # Return the request that would be sent without executing it
  --ResourceName: string # The Amazon Resource Name (ARN) from which you want to remove the tag or tags. For example, <code>arn:aws:redshift:us-east-2:123456789:cluster:t1</code>. 
...
export def "action-delete-usage-limit DeleteUsageLimit" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "UsageLimitId" $UsageLimitId "scalar") (serialize-qp "Action" $Action "scalar") (serialize-qp "Version" $Version "scalar")] | flatten | str join "&"
...
export def "action-delete-usage-limit DeleteUsageLimit-1" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
...
export def "action-describe-account-attributes DescribeAccountAttributes" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
  ...
  --allow-errors(-e) # Return full response without error handling
  --dry-run(-n) # Return the request that would be sent without executing it
  --AttributeNames: list # A list of attribute names.
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "AttributeNames" $AttributeNames "multi") (serialize-qp "Action" $Action "scalar") (serialize-qp "Version" $Version "scalar")] | flatten | str join "&"
...
export def "action-describe-account-attributes DescribeAccountAttributes-1" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
...
export def "action-describe-authentication-profiles DescribeAuthenticationProfiles" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
...
export def "action-describe-authentication-profiles DescribeAuthenticationProfiles-1" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
...
export def "action-describe-cluster-db-revisions DescribeClusterDbRevisions" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
  ...
  --allow-errors(-e) # Return full response without error handling
  --dry-run(-n) # Return the request that would be sent without executing it
  --ClusterIdentifier: string # A unique identifier for a cluster whose <code>ClusterDbRevisions</code> you are requesting. This parameter is case sensitive. All clusters defined for an account are returned by default.
  --MaxRecords: int # <p>The maximum number of response records to return in each call. If the number of remaining response records exceeds the specified MaxRecords value, a value is returned in the <code>marker</code> field of the response. You can retrieve the next set of response records by providing the returned <code>marker</code> value in the <code>marker</code> parameter and retrying the request. </p> <p>Default: 100</p> <p>Constraints: minimum 20, maximum 100.</p>
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "ClusterIdentifier" $ClusterIdentifier "scalar") (serialize-qp "MaxRecords" $MaxRecords "scalar") (serialize-qp "Marker" $Marker "scalar") (serialize-qp "Action" $Action "scalar") (serialize-qp "Version" $Version "scalar")] | flatten | str join "&"
...
export def "action-describe-cluster-db-revisions DescribeClusterDbRevisions-1" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
...
export def "action-describe-cluster-parameter-groups DescribeClusterParameterGroups" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
  ...
  --MaxRecords: int # <p>The maximum number of response records to return in each call. If the number of remaining response records exceeds the specified <code>MaxRecords</code> value, a value is returned in a <code>marker</code> field of the response. You can retrieve the next set of records by retrying the command with the returned marker value. </p> <p>Default: <code>100</code> </p> <p>Constraints: minimum 20, maximum 100.</p>
  ...
  --TagValues: list # A tag value or values for which you want to return all matching cluster parameter groups that are associated with the specified tag value or values. For example, suppose that you have parameter groups that are tagged with values called <code>admin</code> and <code>test</code>. If you specify both of these tag values in the request, Amazon Redshift returns a response with the parameter groups that have either or both of these tag values associated with them.
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "ParameterGroupName" $ParameterGroupName "scalar") (serialize-qp "MaxRecords" $MaxRecords "scalar") (serialize-qp "Marker" $Marker "scalar") (serialize-qp "TagKeys" $TagKeys "multi") (serialize-qp "TagValues" $TagValues "multi") (serialize-qp "Action" $Action "scalar") (serialize-qp "Version" $Version "scalar")] | flatten | str join "&"
...
export def "action-describe-cluster-parameter-groups DescribeClusterParameterGroups-1" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
...
export def "action-describe-cluster-parameters DescribeClusterParameters" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "ParameterGroupName" $ParameterGroupName "scalar") (serialize-qp "Source" $Source "scalar") (serialize-qp "MaxRecords" $MaxRecords "scalar") (serialize-qp "Marker" $Marker "scalar") (serialize-qp "Action" $Action "scalar") (serialize-qp "Version" $Version "scalar")] | flatten | str join "&"
...
export def "action-describe-cluster-parameters DescribeClusterParameters-1" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
...
export def "action-describe-cluster-security-groups DescribeClusterSecurityGroups" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
  ...
  --allow-errors(-e) # Return full response without error handling
  --dry-run(-n) # Return the request that would be sent without executing it
  --ClusterSecurityGroupName: string # <p>The name of a cluster security group for which you are requesting details. You must specify either the <b>Marker</b> parameter or a <b>ClusterSecurityGroupName</b> parameter, but not both. </p> <p> Example: <code>securitygroup1</code> </p>
  --MaxRecords: int # <p>The maximum number of response records to return in each call. If the number of remaining response records exceeds the specified <code>MaxRecords</code> value, a value is returned in a <code>marker</code> field of the response. You can retrieve the next set of records by retrying the command with the returned marker value. </p> <p>Default: <code>100</code> </p> <p>Constraints: minimum 20, maximum 100.</p>
  ...
  --TagValues: list # A tag value or values for which you want to return all matching cluster security groups that are associated with the specified tag value or values. For example, suppose that you have security groups that are tagged with values called <code>admin</code> and <code>test</code>. If you specify both of these tag values in the request, Amazon Redshift returns a response with the security groups that have either or both of these tag values associated with them.
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "ClusterSecurityGroupName" $ClusterSecurityGroupName "scalar") (serialize-qp "MaxRecords" $MaxRecords "scalar") (serialize-qp "Marker" $Marker "scalar") (serialize-qp "TagKeys" $TagKeys "multi") (serialize-qp "TagValues" $TagValues "multi") (serialize-qp "Action" $Action "scalar") (serialize-qp "Version" $Version "scalar")] | flatten | str join "&"
...
export def "action-describe-cluster-security-groups DescribeClusterSecurityGroups-1" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
...
export def "action-describe-cluster-snapshots DescribeClusterSnapshots" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
  ...
  --allow-errors(-e) # Return full response without error handling
  --dry-run(-n) # Return the request that would be sent without executing it
  --ClusterIdentifier: string # The identifier of the cluster which generated the requested snapshots.
  --SnapshotIdentifier: string # The snapshot identifier of the snapshot about which to return information.
  --SnapshotArn: string # The Amazon Resource Name (ARN) of the snapshot associated with the message to describe cluster snapshots.
  ...
  --StartTime: string # <p>A value that requests only snapshots created at or after the specified time. The time value is specified in ISO 8601 format. For more information about ISO 8601, go to the <a href="http://en.wikipedia.org/wiki/ISO_8601">ISO8601 Wikipedia page.</a> </p> <p>Example: <code>2012-07-16T18:00:00Z</code> </p> (format: date-time)
  --EndTime: string # <p>A time value that requests only snapshots created at or before the specified time. The time value is specified in ISO 8601 format. For more information about ISO 8601, go to the <a href="http://en.wikipedia.org/wiki/ISO_8601">ISO8601 Wikipedia page.</a> </p> <p>Example: <code>2012-07-16T18:00:00Z</code> </p> (format: date-time)
  --MaxRecords: int # <p>The maximum number of response records to return in each call. If the number of remaining response records exceeds the specified <code>MaxRecords</code> value, a value is returned in a <code>marker</code> field of the response. You can retrieve the next set of records by retrying the command with the returned marker value. </p> <p>Default: <code>100</code> </p> <p>Constraints: minimum 20, maximum 500.</p>
  ...
  --OwnerAccount: string # The Amazon Web Services account used to create or copy the snapshot. Use this field to filter the results to snapshots owned by a particular account. To describe snapshots you own, either specify your Amazon Web Services account, or do not specify the parameter.
  --TagKeys: list # A tag key or keys for which you want to return all matching cluster snapshots that are associated with the specified key or keys. For example, suppose that you have snapshots that are tagged with keys called <code>owner</code> and <code>environment</code>. If you specify both of these tag keys in the request, Amazon Redshift returns a response with the snapshots that have either or both of these tag keys associated with them.
  --TagValues: list # A tag value or values for which you want to return all matching cluster snapshots that are associated with the specified tag value or values. For example, suppose that you have snapshots that are tagged with values called <code>admin</code> and <code>test</code>. If you specify both of these tag values in the request, Amazon Redshift returns a response with the snapshots that have either or both of these tag values associated with them.
  --ClusterExists: oneof<nothing, bool> # <p>A value that indicates whether to return snapshots only for an existing cluster. You can perform table-level restore only by using a snapshot of an existing cluster, that is, a cluster that has not been deleted. Values for this parameter work as follows: </p> <ul> <li> <p>If <code>ClusterExists</code> is set to <code>true</code>, <code>ClusterIdentifier</code> is required.</p> </li> <li> <p>If <code>ClusterExists</code> is set to <code>false</code> and <code>ClusterIdentifier</code> isn't specified, all snapshots associated with deleted clusters (orphaned snapshots) are returned. </p> </li> <li> <p>If <code>ClusterExists</code> is set to <code>false</code> and <code>ClusterIdentifier</code> is specified for a deleted cluster, snapshots associated with that cluster are returned.</p> </li> <li> <p>If <code>ClusterExists</code> is set to <code>false</code> and <code>ClusterIdentifier</code> is specified for an existing cluster, no snapshots are returned. </p> </li> </ul>
  --SortingEntities: list # <p/>
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "ClusterIdentifier" $ClusterIdentifier "scalar") (serialize-qp "SnapshotIdentifier" $SnapshotIdentifier "scalar") (serialize-qp "SnapshotArn" $SnapshotArn "scalar") (serialize-qp "SnapshotType" $SnapshotType "scalar") (serialize-qp "StartTime" $StartTime "scalar") (serialize-qp "EndTime" $EndTime "scalar") (serialize-qp "MaxRecords" $MaxRecords "scalar") (serialize-qp "Marker" $Marker "scalar") (serialize-qp "OwnerAccount" $OwnerAccount "scalar") (serialize-qp "TagKeys" $TagKeys "multi") (serialize-qp "TagValues" $TagValues "multi") (serialize-qp "ClusterExists" $ClusterExists "scalar") (serialize-qp "SortingEntities" $SortingEntities "multi") (serialize-qp "Action" $Action "scalar") (serialize-qp "Version" $Version "scalar")] | flatten | str join "&"
...
export def "action-describe-cluster-snapshots DescribeClusterSnapshots-1" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
...
export def "action-describe-cluster-subnet-groups DescribeClusterSubnetGroups" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
  ...
  --TagValues: list # A tag value or values for which you want to return all matching cluster subnet groups that are associated with the specified tag value or values. For example, suppose that you have subnet groups that are tagged with values called <code>admin</code> and <code>test</code>. If you specify both of these tag values in the request, Amazon Redshift returns a response with the subnet groups that have either or both of these tag values associated with them.
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "ClusterSubnetGroupName" $ClusterSubnetGroupName "scalar") (serialize-qp "MaxRecords" $MaxRecords "scalar") (serialize-qp "Marker" $Marker "scalar") (serialize-qp "TagKeys" $TagKeys "multi") (serialize-qp "TagValues" $TagValues "multi") (serialize-qp "Action" $Action "scalar") (serialize-qp "Version" $Version "scalar")] | flatten | str join "&"
...
export def "action-describe-cluster-subnet-groups DescribeClusterSubnetGroups-1" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
...
export def "action-describe-cluster-tracks DescribeClusterTracks" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
  ...
  --MaxRecords: int # An integer value for the maximum number of maintenance tracks to return.
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "MaintenanceTrackName" $MaintenanceTrackName "scalar") (serialize-qp "MaxRecords" $MaxRecords "scalar") (serialize-qp "Marker" $Marker "scalar") (serialize-qp "Action" $Action "scalar") (serialize-qp "Version" $Version "scalar")] | flatten | str join "&"
...
export def "action-describe-cluster-tracks DescribeClusterTracks-1" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
...
export def "action-describe-cluster-versions DescribeClusterVersions" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "ClusterVersion" $ClusterVersion "scalar") (serialize-qp "ClusterParameterGroupFamily" $ClusterParameterGroupFamily "scalar") (serialize-qp "MaxRecords" $MaxRecords "scalar") (serialize-qp "Marker" $Marker "scalar") (serialize-qp "Action" $Action "scalar") (serialize-qp "Version" $Version "scalar")] | flatten | str join "&"
...
export def "action-describe-cluster-versions DescribeClusterVersions-1" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
...
export def "action-describe-clusters DescribeClusters" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
  ...
  --TagValues: list # A tag value or values for which you want to return all matching clusters that are associated with the specified tag value or values. For example, suppose that you have clusters that are tagged with values called <code>admin</code> and <code>test</code>. If you specify both of these tag values in the request, Amazon Redshift returns a response with the clusters that have either or both of these tag values associated with them.
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "ClusterIdentifier" $ClusterIdentifier "scalar") (serialize-qp "MaxRecords" $MaxRecords "scalar") (serialize-qp "Marker" $Marker "scalar") (serialize-qp "TagKeys" $TagKeys "multi") (serialize-qp "TagValues" $TagValues "multi") (serialize-qp "Action" $Action "scalar") (serialize-qp "Version" $Version "scalar")] | flatten | str join "&"
...
export def "action-describe-clusters DescribeClusters-1" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
...
export def "action-describe-data-shares DescribeDataShares" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
  ...
  --allow-errors(-e) # Return full response without error handling
  --dry-run(-n) # Return the request that would be sent without executing it
  --DataShareArn: string # The identifier of the datashare to describe details of.
  --MaxRecords: int # The maximum number of response records to return in each call. If the number of remaining response records exceeds the specified <code>MaxRecords</code> value, a value is returned in a <code>marker</code> field of the response. You can retrieve the next set of records by retrying the command with the returned marker value. 
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "DataShareArn" $DataShareArn "scalar") (serialize-qp "MaxRecords" $MaxRecords "scalar") (serialize-qp "Marker" $Marker "scalar") (serialize-qp "Action" $Action "scalar") (serialize-qp "Version" $Version "scalar")] | flatten | str join "&"
...
export def "action-describe-data-shares DescribeDataShares-1" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
...
export def "action-describe-data-shares-for-consumer DescribeDataSharesForConsumer" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
  ...
  --allow-errors(-e) # Return full response without error handling
  --dry-run(-n) # Return the request that would be sent without executing it
  --ConsumerArn: string # The Amazon Resource Name (ARN) of the consumer that returns in the list of datashares.
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "ConsumerArn" $ConsumerArn "scalar") (serialize-qp "Status" $Status "scalar") (serialize-qp "MaxRecords" $MaxRecords "scalar") (serialize-qp "Marker" $Marker "scalar") (serialize-qp "Action" $Action "scalar") (serialize-qp "Version" $Version "scalar")] | flatten | str join "&"
...
export def "action-describe-data-shares-for-consumer DescribeDataSharesForConsumer-1" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
...
export def "action-describe-data-shares-for-producer DescribeDataSharesForProducer" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
  ...
  --allow-errors(-e) # Return full response without error handling
  --dry-run(-n) # Return the request that would be sent without executing it
  --ProducerArn: string # The Amazon Resource Name (ARN) of the producer that returns in the list of datashares.
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "ProducerArn" $ProducerArn "scalar") (serialize-qp "Status" $Status "scalar") (serialize-qp "MaxRecords" $MaxRecords "scalar") (serialize-qp "Marker" $Marker "scalar") (serialize-qp "Action" $Action "scalar") (serialize-qp "Version" $Version "scalar")] | flatten | str join "&"
...
export def "action-describe-data-shares-for-producer DescribeDataSharesForProducer-1" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
...
export def "action-describe-default-cluster-parameters DescribeDefaultClusterParameters" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "ParameterGroupFamily" $ParameterGroupFamily "scalar") (serialize-qp "MaxRecords" $MaxRecords "scalar") (serialize-qp "Marker" $Marker "scalar") (serialize-qp "Action" $Action "scalar") (serialize-qp "Version" $Version "scalar")] | flatten | str join "&"
...
export def "action-describe-default-cluster-parameters DescribeDefaultClusterParameters-1" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
...
export def "action-describe-endpoint-access DescribeEndpointAccess" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
  ...
  --MaxRecords: int # The maximum number of records to include in the response. If more records exist than the specified <code>MaxRecords</code> value, a pagination token called a <code>Marker</code> is included in the response so that the remaining results can be retrieved.
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "ClusterIdentifier" $ClusterIdentifier "scalar") (serialize-qp "ResourceOwner" $ResourceOwner "scalar") (serialize-qp "EndpointName" $EndpointName "scalar") (serialize-qp "VpcId" $VpcId "scalar") (serialize-qp "MaxRecords" $MaxRecords "scalar") (serialize-qp "Marker" $Marker "scalar") (serialize-qp "Action" $Action "scalar") (serialize-qp "Version" $Version "scalar")] | flatten | str join "&"
...
export def "action-describe-endpoint-access DescribeEndpointAccess-1" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
...
export def "action-describe-endpoint-authorization DescribeEndpointAuthorization" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "ClusterIdentifier" $ClusterIdentifier "scalar") (serialize-qp "Account" $Account "scalar") (serialize-qp "Grantee" $Grantee "scalar") (serialize-qp "MaxRecords" $MaxRecords "scalar") (serialize-qp "Marker" $Marker "scalar") (serialize-qp "Action" $Action "scalar") (serialize-qp "Version" $Version "scalar")] | flatten | str join "&"
...
export def "action-describe-endpoint-authorization DescribeEndpointAuthorization-1" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
...
export def "action-describe-event-categories DescribeEventCategories" [
  ...
  --allow-errors(-e) # Return full response without error handling
  --dry-run(-n) # Return the request that would be sent without executing it
  --SourceType: string # <p>The source type, such as cluster or parameter group, to which the described event categories apply.</p> <p>Valid values: cluster, cluster-snapshot, cluster-parameter-group, cluster-security-group, and scheduled-action.</p>
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "SourceType" $SourceType "scalar") (serialize-qp "Action" $Action "scalar") (serialize-qp "Version" $Version "scalar")] | flatten | str join "&"
...
export def "action-describe-event-subscriptions DescribeEventSubscriptions" [
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "SubscriptionName" $SubscriptionName "scalar") (serialize-qp "MaxRecords" $MaxRecords "scalar") (serialize-qp "Marker" $Marker "scalar") (serialize-qp "TagKeys" $TagKeys "multi") (serialize-qp "TagValues" $TagValues "multi") (serialize-qp "Action" $Action "scalar") (serialize-qp "Version" $Version "scalar")] | flatten | str join "&"
...
export def "action-describe-events DescribeEvents" [
  ...
  --SourceType: string@SourceType-completer # <p>The event source to retrieve events for. If no value is specified, all events are returned.</p> <p>Constraints:</p> <p>If <i>SourceType</i> is supplied, <i>SourceIdentifier</i> must also be provided.</p> <ul> <li> <p>Specify <code>cluster</code> when <i>SourceIdentifier</i> is a cluster identifier.</p> </li> <li> <p>Specify <code>cluster-security-group</code> when <i>SourceIdentifier</i> is a cluster security group name.</p> </li> <li> <p>Specify <code>cluster-parameter-group</code> when <i>SourceIdentifier</i> is a cluster parameter group name.</p> </li> <li> <p>Specify <code>cluster-snapshot</code> when <i>SourceIdentifier</i> is a cluster snapshot identifier.</p> </li> </ul>
  --StartTime: string # <p>The beginning of the time interval to retrieve events for, specified in ISO 8601 format. For more information about ISO 8601, go to the <a href="http://en.wikipedia.org/wiki/ISO_8601">ISO8601 Wikipedia page.</a> </p> <p>Example: <code>2009-07-08T18:00Z</code> </p> (format: date-time)
  --EndTime: string # <p>The end of the time interval for which to retrieve events, specified in ISO 8601 format. For more information about ISO 8601, go to the <a href="http://en.wikipedia.org/wiki/ISO_8601">ISO8601 Wikipedia page.</a> </p> <p>Example: <code>2009-07-08T18:00Z</code> </p> (format: date-time)
...
export def "action-describe-hsm-client-certificates DescribeHsmClientCertificates" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
  ...
  --TagValues: list # A tag value or values for which you want to return all matching HSM client certificates that are associated with the specified tag value or values. For example, suppose that you have HSM client certificates that are tagged with values called <code>admin</code> and <code>test</code>. If you specify both of these tag values in the request, Amazon Redshift returns a response with the HSM client certificates that have either or both of these tag values associated with them.
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "HsmClientCertificateIdentifier" $HsmClientCertificateIdentifier "scalar") (serialize-qp "MaxRecords" $MaxRecords "scalar") (serialize-qp "Marker" $Marker "scalar") (serialize-qp "TagKeys" $TagKeys "multi") (serialize-qp "TagValues" $TagValues "multi") (serialize-qp "Action" $Action "scalar") (serialize-qp "Version" $Version "scalar")] | flatten | str join "&"
...
export def "action-describe-hsm-client-certificates DescribeHsmClientCertificates-1" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
...
export def "action-describe-hsm-configurations DescribeHsmConfigurations" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
  ...
  --TagValues: list # A tag value or values for which you want to return all matching HSM configurations that are associated with the specified tag value or values. For example, suppose that you have HSM configurations that are tagged with values called <code>admin</code> and <code>test</code>. If you specify both of these tag values in the request, Amazon Redshift returns a response with the HSM configurations that have either or both of these tag values associated with them.
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "HsmConfigurationIdentifier" $HsmConfigurationIdentifier "scalar") (serialize-qp "MaxRecords" $MaxRecords "scalar") (serialize-qp "Marker" $Marker "scalar") (serialize-qp "TagKeys" $TagKeys "multi") (serialize-qp "TagValues" $TagValues "multi") (serialize-qp "Action" $Action "scalar") (serialize-qp "Version" $Version "scalar")] | flatten | str join "&"
...
export def "action-describe-hsm-configurations DescribeHsmConfigurations-1" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
...
export def "action-describe-logging-status DescribeLoggingStatus" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
...
export def "action-describe-logging-status DescribeLoggingStatus-1" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
...
export def "action-describe-node-configuration-options DescribeNodeConfigurationOptions" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
  ...
  --allow-errors(-e) # Return full response without error handling
  --dry-run(-n) # Return the request that would be sent without executing it
  --ActionType: string@ActionType-completer # The action type to evaluate for possible node configurations. Specify "restore-cluster" to get configuration combinations based on an existing snapshot. Specify "recommend-node-config" to get configuration recommendations based on an existing cluster or snapshot. Specify "resize-cluster" to get configuration combinations for elastic resize based on an existing cluster. 
  ...
  --MaxRecords: int # <p>The maximum number of response records to return in each call. If the number of remaining response records exceeds the specified <code>MaxRecords</code> value, a value is returned in a <code>marker</code> field of the response. You can retrieve the next set of records by retrying the command with the returned marker value. </p> <p>Default: <code>500</code> </p> <p>Constraints: minimum 100, maximum 500.</p>
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "ActionType" $ActionType "scalar") (serialize-qp "ClusterIdentifier" $ClusterIdentifier "scalar") (serialize-qp "SnapshotIdentifier" $SnapshotIdentifier "scalar") (serialize-qp "SnapshotArn" $SnapshotArn "scalar") (serialize-qp "OwnerAccount" $OwnerAccount "scalar") (serialize-qp "Filter" $Filter "multi") (serialize-qp "Marker" $Marker "scalar") (serialize-qp "MaxRecords" $MaxRecords "scalar") (serialize-qp "Action" $Action "scalar") (serialize-qp "Version" $Version "scalar")] | flatten | str join "&"
...
export def "action-describe-node-configuration-options DescribeNodeConfigurationOptions-1" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
...
export def "action-describe-orderable-cluster-options DescribeOrderableClusterOptions" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "ClusterVersion" $ClusterVersion "scalar") (serialize-qp "NodeType" $NodeType "scalar") (serialize-qp "MaxRecords" $MaxRecords "scalar") (serialize-qp "Marker" $Marker "scalar") (serialize-qp "Action" $Action "scalar") (serialize-qp "Version" $Version "scalar")] | flatten | str join "&"
...
export def "action-describe-orderable-cluster-options DescribeOrderableClusterOptions-1" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
...
export def "action-describe-partners DescribePartners" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
  ...
  --dry-run(-n) # Return the request that would be sent without executing it
  --AccountId: string # The Amazon Web Services account ID that owns the cluster.
  --ClusterIdentifier: string # The cluster identifier of the cluster whose partner integration is being described.
...
export def "action-describe-partners DescribePartners-1" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
...
export def "action-describe-reserved-node-exchange-status DescribeReservedNodeExchangeStatus" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "ReservedNodeId" $ReservedNodeId "scalar") (serialize-qp "ReservedNodeExchangeRequestId" $ReservedNodeExchangeRequestId "scalar") (serialize-qp "MaxRecords" $MaxRecords "scalar") (serialize-qp "Marker" $Marker "scalar") (serialize-qp "Action" $Action "scalar") (serialize-qp "Version" $Version "scalar")] | flatten | str join "&"
...
export def "action-describe-reserved-node-exchange-status DescribeReservedNodeExchangeStatus-1" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
...
export def "action-describe-reserved-node-offerings DescribeReservedNodeOfferings" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "ReservedNodeOfferingId" $ReservedNodeOfferingId "scalar") (serialize-qp "MaxRecords" $MaxRecords "scalar") (serialize-qp "Marker" $Marker "scalar") (serialize-qp "Action" $Action "scalar") (serialize-qp "Version" $Version "scalar")] | flatten | str join "&"
...
export def "action-describe-reserved-node-offerings DescribeReservedNodeOfferings-1" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
...
export def "action-describe-reserved-nodes DescribeReservedNodes" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "ReservedNodeId" $ReservedNodeId "scalar") (serialize-qp "MaxRecords" $MaxRecords "scalar") (serialize-qp "Marker" $Marker "scalar") (serialize-qp "Action" $Action "scalar") (serialize-qp "Version" $Version "scalar")] | flatten | str join "&"
...
export def "action-describe-reserved-nodes DescribeReservedNodes-1" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
...
export def "action-describe-resize DescribeResize" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
  ...
  --allow-errors(-e) # Return full response without error handling
  --dry-run(-n) # Return the request that would be sent without executing it
  --ClusterIdentifier: string # <p>The unique identifier of a cluster whose resize progress you are requesting. This parameter is case-sensitive.</p> <p>By default, resize operations for all clusters defined for an Amazon Web Services account are returned.</p>
...
export def "action-describe-resize DescribeResize-1" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
...
export def "action-describe-scheduled-actions DescribeScheduledActions" [
  ...
  --TargetActionType: string@TargetActionType-completer # The type of the scheduled actions to retrieve. 
  --StartTime: string # The start time in UTC of the scheduled actions to retrieve. Only active scheduled actions that have invocations after this time are retrieved. (format: date-time)
  --EndTime: string # The end time in UTC of the scheduled action to retrieve. Only active scheduled actions that have invocations before this time are retrieved. (format: date-time)
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "ScheduledActionName" $ScheduledActionName "scalar") (serialize-qp "TargetActionType" $TargetActionType "scalar") (serialize-qp "StartTime" $StartTime "scalar") (serialize-qp "EndTime" $EndTime "scalar") (serialize-qp "Active" $Active "scalar") (serialize-qp "Filters" $Filters "multi") (serialize-qp "Marker" $Marker "scalar") (serialize-qp "MaxRecords" $MaxRecords "scalar") (serialize-qp "Action" $Action "scalar") (serialize-qp "Version" $Version "scalar")] | flatten | str join "&"
...
export def "action-describe-snapshot-copy-grants DescribeSnapshotCopyGrants" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
  ...
  --TagValues: list # A tag value or values for which you want to return all matching resources that are associated with the specified value or values. For example, suppose that you have resources tagged with values called <code>admin</code> and <code>test</code>. If you specify both of these tag values in the request, Amazon Redshift returns a response with all resources that have either or both of these tag values associated with them.
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "SnapshotCopyGrantName" $SnapshotCopyGrantName "scalar") (serialize-qp "MaxRecords" $MaxRecords "scalar") (serialize-qp "Marker" $Marker "scalar") (serialize-qp "TagKeys" $TagKeys "multi") (serialize-qp "TagValues" $TagValues "multi") (serialize-qp "Action" $Action "scalar") (serialize-qp "Version" $Version "scalar")] | flatten | str join "&"
...
export def "action-describe-snapshot-copy-grants DescribeSnapshotCopyGrants-1" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
...
export def "action-describe-snapshot-schedules DescribeSnapshotSchedules" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
  ...
  --ScheduleIdentifier: string # A unique identifier for a snapshot schedule.
  --TagKeys: list # The key value for a snapshot schedule tag.
  --TagValues: list # The value corresponding to the key of the snapshot schedule tag.
  ...
  --MaxRecords: int # The maximum number or response records to return in each call. If the number of remaining response records exceeds the specified <code>MaxRecords</code> value, a value is returned in a <code>marker</code> field of the response. You can retrieve the next set of records by retrying the command with the returned <code>marker</code> value.
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "ClusterIdentifier" $ClusterIdentifier "scalar") (serialize-qp "ScheduleIdentifier" $ScheduleIdentifier "scalar") (serialize-qp "TagKeys" $TagKeys "multi") (serialize-qp "TagValues" $TagValues "multi") (serialize-qp "Marker" $Marker "scalar") (serialize-qp "MaxRecords" $MaxRecords "scalar") (serialize-qp "Action" $Action "scalar") (serialize-qp "Version" $Version "scalar")] | flatten | str join "&"
...
export def "action-describe-snapshot-schedules DescribeSnapshotSchedules-1" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
...
export def "action-describe-storage DescribeStorage" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
...
export def "action-describe-storage DescribeStorage-1" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
...
export def "action-describe-table-restore-status DescribeTableRestoreStatus" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
  ...
  --TableRestoreRequestId: string # The identifier of the table restore request to return status for. If you don't specify a <code>TableRestoreRequestId</code> value, then <code>DescribeTableRestoreStatus</code> returns the status of all in-progress table restore requests.
  --MaxRecords: int # The maximum number of records to include in the response. If more records exist than the specified <code>MaxRecords</code> value, a pagination token called a marker is included in the response so that the remaining results can be retrieved.
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "ClusterIdentifier" $ClusterIdentifier "scalar") (serialize-qp "TableRestoreRequestId" $TableRestoreRequestId "scalar") (serialize-qp "MaxRecords" $MaxRecords "scalar") (serialize-qp "Marker" $Marker "scalar") (serialize-qp "Action" $Action "scalar") (serialize-qp "Version" $Version "scalar")] | flatten | str join "&"
...
export def "action-describe-table-restore-status DescribeTableRestoreStatus-1" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
...
export def "action-describe-tags DescribeTags" [
  ...
  --allow-errors(-e) # Return full response without error handling
  --dry-run(-n) # Return the request that would be sent without executing it
  --ResourceName: string # The Amazon Resource Name (ARN) for which you want to describe the tag or tags. For example, <code>arn:aws:redshift:us-east-2:123456789:cluster:t1</code>. 
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "ResourceName" $ResourceName "scalar") (serialize-qp "ResourceType" $ResourceType "scalar") (serialize-qp "MaxRecords" $MaxRecords "scalar") (serialize-qp "Marker" $Marker "scalar") (serialize-qp "TagKeys" $TagKeys "multi") (serialize-qp "TagValues" $TagValues "multi") (serialize-qp "Action" $Action "scalar") (serialize-qp "Version" $Version "scalar")] | flatten | str join "&"
...
export def "action-describe-usage-limits DescribeUsageLimits" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
  ...
  --FeatureType: string@FeatureType-completer # The feature type for which you want to describe usage limits.
  --MaxRecords: int # <p>The maximum number of response records to return in each call. If the number of remaining response records exceeds the specified <code>MaxRecords</code> value, a value is returned in a <code>marker</code> field of the response. You can retrieve the next set of records by retrying the command with the returned marker value. </p> <p>Default: <code>100</code> </p> <p>Constraints: minimum 20, maximum 100.</p>
  ...
  --TagValues: list # A tag value or values for which you want to return all matching usage limit objects that are associated with the specified tag value or values. For example, suppose that you have parameter groups that are tagged with values called <code>admin</code> and <code>test</code>. If you specify both of these tag values in the request, Amazon Redshift returns a response with the usage limit objects that have either or both of these tag values associated with them.
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "UsageLimitId" $UsageLimitId "scalar") (serialize-qp "ClusterIdentifier" $ClusterIdentifier "scalar") (serialize-qp "FeatureType" $FeatureType "scalar") (serialize-qp "MaxRecords" $MaxRecords "scalar") (serialize-qp "Marker" $Marker "scalar") (serialize-qp "TagKeys" $TagKeys "multi") (serialize-qp "TagValues" $TagValues "multi") (serialize-qp "Action" $Action "scalar") (serialize-qp "Version" $Version "scalar")] | flatten | str join "&"
...
export def "action-describe-usage-limits DescribeUsageLimits-1" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
...
export def "action-disable-logging DisableLogging" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
...
export def "action-disable-logging DisableLogging-1" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
...
export def "action-disable-snapshot-copy DisableSnapshotCopy" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
...
export def "action-disable-snapshot-copy DisableSnapshotCopy-1" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
...
export def "action-disassociate-data-share-consumer DisassociateDataShareConsumer" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
  ...
  --allow-errors(-e) # Return full response without error handling
  --dry-run(-n) # Return the request that would be sent without executing it
  --DataShareArn: string # The Amazon Resource Name (ARN) of the datashare to remove association for. 
  --DisassociateEntireAccount: oneof<nothing, bool> # A value that specifies whether association for the datashare is removed from the entire account.
  --ConsumerArn: string # The Amazon Resource Name (ARN) of the consumer that association for the datashare is removed from.
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "DataShareArn" $DataShareArn "scalar") (serialize-qp "DisassociateEntireAccount" $DisassociateEntireAccount "scalar") (serialize-qp "ConsumerArn" $ConsumerArn "scalar") (serialize-qp "ConsumerRegion" $ConsumerRegion "scalar") (serialize-qp "Action" $Action "scalar") (serialize-qp "Version" $Version "scalar")] | flatten | str join "&"
...
export def "action-disassociate-data-share-consumer DisassociateDataShareConsumer-1" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
...
export def "action-enable-logging EnableLogging" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
  ...
  --LogDestinationType: string@LogDestinationType-completer # The log destination type. An enum with possible values of <code>s3</code> and <code>cloudwatch</code>.
  --LogExports: list # The collection of exported log types. Possible values are <code>connectionlog</code>, <code>useractivitylog</code>, and <code>userlog</code>.
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "ClusterIdentifier" $ClusterIdentifier "scalar") (serialize-qp "BucketName" $BucketName "scalar") (serialize-qp "S3KeyPrefix" $S3KeyPrefix "scalar") (serialize-qp "LogDestinationType" $LogDestinationType "scalar") (serialize-qp "LogExports" $LogExports "multi") (serialize-qp "Action" $Action "scalar") (serialize-qp "Version" $Version "scalar")] | flatten | str join "&"
...
export def "action-enable-logging EnableLogging-1" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
...
export def "action-enable-snapshot-copy EnableSnapshotCopy" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
  ...
  --DestinationRegion: string # <p>The destination Amazon Web Services Region that you want to copy snapshots to.</p> <p>Constraints: Must be the name of a valid Amazon Web Services Region. For more information, see <a href="https://docs.aws.amazon.com/general/latest/gr/rande.html#redshift_region">Regions and Endpoints</a> in the Amazon Web Services General Reference. </p>
  --RetentionPeriod: int # <p>The number of days to retain automated snapshots in the destination region after they are copied from the source region.</p> <p>Default: 7.</p> <p>Constraints: Must be at least 1 and no more than 35.</p>
  --SnapshotCopyGrantName: string # The name of the snapshot copy grant to use when snapshots of an Amazon Web Services KMS-encrypted cluster are copied to the destination region.
  --ManualSnapshotRetentionPeriod: int # <p>The number of days to retain newly copied snapshots in the destination Amazon Web Services Region after they are copied from the source Amazon Web Services Region. If the value is -1, the manual snapshot is retained indefinitely. </p> <p>The value must be either -1 or an integer between 1 and 3,653.</p>
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "ClusterIdentifier" $ClusterIdentifier "scalar") (serialize-qp "DestinationRegion" $DestinationRegion "scalar") (serialize-qp "RetentionPeriod" $RetentionPeriod "scalar") (serialize-qp "SnapshotCopyGrantName" $SnapshotCopyGrantName "scalar") (serialize-qp "ManualSnapshotRetentionPeriod" $ManualSnapshotRetentionPeriod "scalar") (serialize-qp "Action" $Action "scalar") (serialize-qp "Version" $Version "scalar")] | flatten | str join "&"
...
export def "action-enable-snapshot-copy EnableSnapshotCopy-1" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
...
export def "action-get-cluster-credentials GetClusterCredentials" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
  ...
  --DurationSeconds: int # <p>The number of seconds until the returned temporary password expires.</p> <p>Constraint: minimum 900, maximum 3600.</p> <p>Default: 900</p>
  --AutoCreate: oneof<nothing, bool> # Create a database user with the name specified for the user named in <code>DbUser</code> if one does not exist.
  --DbGroups: list # <p>A list of the names of existing database groups that the user named in <code>DbUser</code> will join for the current session, in addition to any group memberships for an existing user. If not specified, a new user is added only to PUBLIC.</p> <p>Database group name constraints</p> <ul> <li> <p>Must be 1 to 64 alphanumeric characters or hyphens</p> </li> <li> <p>Must contain only lowercase letters, numbers, underscore, plus sign, period (dot), at symbol (@), or hyphen.</p> </li> <li> <p>First character must be a letter.</p> </li> <li> <p>Must not contain a colon ( : ) or slash ( / ). </p> </li> <li> <p>Cannot be a reserved word. A list of reserved words can be found in <a href="http://docs.aws.amazon.com/redshift/latest/dg/r_pg_keywords.html">Reserved Words</a> in the Amazon Redshift Database Developer Guide.</p> </li> </ul>
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "DbUser" $DbUser "scalar") (serialize-qp "DbName" $DbName "scalar") (serialize-qp "ClusterIdentifier" $ClusterIdentifier "scalar") (serialize-qp "DurationSeconds" $DurationSeconds "scalar") (serialize-qp "AutoCreate" $AutoCreate "scalar") (serialize-qp "DbGroups" $DbGroups "multi") (serialize-qp "Action" $Action "scalar") (serialize-qp "Version" $Version "scalar")] | flatten | str join "&"
...
export def "action-get-cluster-credentials GetClusterCredentials-1" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
...
export def "action-get-cluster-credentials-with-iam GetClusterCredentialsWithIAM" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
  ...
  --allow-errors(-e) # Return full response without error handling
  --dry-run(-n) # Return the request that would be sent without executing it
  --DbName: string # The name of the database for which you are requesting credentials. If the database name is specified, the IAM policy must allow access to the resource <code>dbname</code> for the specified database name. If the database name is not specified, access to all databases is allowed.
  --ClusterIdentifier: string # The unique identifier of the cluster that contains the database for which you are requesting credentials. 
  --DurationSeconds: int # <p>The number of seconds until the returned temporary password expires.</p> <p>Range: 900-3600. Default: 900.</p>
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "DbName" $DbName "scalar") (serialize-qp "ClusterIdentifier" $ClusterIdentifier "scalar") (serialize-qp "DurationSeconds" $DurationSeconds "scalar") (serialize-qp "Action" $Action "scalar") (serialize-qp "Version" $Version "scalar")] | flatten | str join "&"
...
export def "action-get-cluster-credentials-with-iam GetClusterCredentialsWithIAM-1" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
...
export def "action-get-reserved-node-exchange-configuration-options GetReservedNodeExchangeConfigurationOptions" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
  ...
  --allow-errors(-e) # Return full response without error handling
  --dry-run(-n) # Return the request that would be sent without executing it
  --ActionType: string@ActionType-completer-1 # The action type of the reserved-node configuration. The action type can be an exchange initiated from either a snapshot or a resize.
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "ActionType" $ActionType "scalar") (serialize-qp "ClusterIdentifier" $ClusterIdentifier "scalar") (serialize-qp "SnapshotIdentifier" $SnapshotIdentifier "scalar") (serialize-qp "MaxRecords" $MaxRecords "scalar") (serialize-qp "Marker" $Marker "scalar") (serialize-qp "Action" $Action "scalar") (serialize-qp "Version" $Version "scalar")] | flatten | str join "&"
...
export def "action-get-reserved-node-exchange-configuration-options GetReservedNodeExchangeConfigurationOptions-1" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
...
export def "action-get-reserved-node-exchange-offerings GetReservedNodeExchangeOfferings" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
  ...
  --MaxRecords: int # An integer setting the maximum number of ReservedNodeOfferings to retrieve.
...
export def "action-get-reserved-node-exchange-offerings GetReservedNodeExchangeOfferings-1" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
...
export def "action-modify-aqua-configuration ModifyAquaConfiguration" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
  ...
  --allow-errors(-e) # Return full response without error handling
  --dry-run(-n) # Return the request that would be sent without executing it
  --ClusterIdentifier: string # The identifier of the cluster to be modified.
  --AquaConfigurationStatus: string@AquaConfigurationStatus-completer # This parameter is retired. Amazon Redshift automatically determines whether to use AQUA (Advanced Query Accelerator).
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "ClusterIdentifier" $ClusterIdentifier "scalar") (serialize-qp "AquaConfigurationStatus" $AquaConfigurationStatus "scalar") (serialize-qp "Action" $Action "scalar") (serialize-qp "Version" $Version "scalar")] | flatten | str join "&"
...
export def "action-modify-aqua-configuration ModifyAquaConfiguration-1" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
...
export def "action-modify-authentication-profile ModifyAuthenticationProfile" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
  ...
  --allow-errors(-e) # Return full response without error handling
  --dry-run(-n) # Return the request that would be sent without executing it
  --AuthenticationProfileName: string # The name of the authentication profile to replace.
...
export def "action-modify-authentication-profile ModifyAuthenticationProfile-1" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
...
export def "action-modify-cluster ModifyCluster" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
  ...
  --ClusterSecurityGroups: list # <p>A list of cluster security groups to be authorized on this cluster. This change is asynchronously applied as soon as possible.</p> <p>Security groups currently associated with the cluster, and not in the list of groups to apply, will be revoked from the cluster.</p> <p>Constraints:</p> <ul> <li> <p>Must be 1 to 255 alphanumeric characters or hyphens</p> </li> <li> <p>First character must be a letter</p> </li> <li> <p>Cannot end with a hyphen or contain two consecutive hyphens</p> </li> </ul>
  --VpcSecurityGroupIds: list # A list of virtual private cloud (VPC) security groups to be associated with the cluster. This change is asynchronously applied as soon as possible.
  --MasterUserPassword: string # <p>The new password for the cluster admin user. This change is asynchronously applied as soon as possible. Between the time of the request and the completion of the request, the <code>MasterUserPassword</code> element exists in the <code>PendingModifiedValues</code> element of the operation response. </p> <note> <p>Operations never return the password, so this operation provides a way to regain access to the admin user for a cluster if the password is lost.</p> </note> <p>Default: Uses existing setting.</p> <p>Constraints:</p> <ul> <li> <p>Must be between 8 and 64 characters in length.</p> </li> <li> <p>Must contain at least one uppercase letter.</p> </li> <li> <p>Must contain at least one lowercase letter.</p> </li> <li> <p>Must contain one number.</p> </li> <li> <p>Can be any printable ASCII character (ASCII code 33-126) except <code>'</code> (single quote), <code>"</code> (double quote), <code>\</code>, <code>/</code>, or <code>@</code>.</p> </li> </ul>
  ...
  --ManualSnapshotRetentionPeriod: int # <p>The default for number of days that a newly created manual snapshot is retained. If the value is -1, the manual snapshot is retained indefinitely. This value doesn't retroactively change the retention periods of existing manual snapshots.</p> <p>The value must be either -1 or an integer between 1 and 3,653.</p> <p>The default value is -1.</p>
  ...
  --AllowVersionUpgrade: oneof<nothing, bool> # <p>If <code>true</code>, major version upgrades will be applied automatically to the cluster during the maintenance window. </p> <p>Default: <code>false</code> </p>
  --HsmClientCertificateIdentifier: string # Specifies the name of the HSM client certificate the Amazon Redshift cluster uses to retrieve the data encryption keys stored in an HSM.
  --HsmConfigurationIdentifier: string # Specifies the name of the HSM configuration that contains the information the Amazon Redshift cluster can use to retrieve and store keys in an HSM.
  ...
  --PubliclyAccessible: oneof<nothing, bool> # If <code>true</code>, the cluster can be accessed from a public network. Only clusters in VPCs can be set to be publicly available.
  ...
  --EnhancedVpcRouting: oneof<nothing, bool> # <p>An option that specifies whether to create the cluster with enhanced VPC routing enabled. To create a cluster that uses enhanced VPC routing, the cluster must be in a VPC. For more information, see <a href="https://docs.aws.amazon.com/redshift/latest/mgmt/enhanced-vpc-routing.html">Enhanced VPC Routing</a> in the Amazon Redshift Cluster Management Guide.</p> <p>If this option is <code>true</code>, enhanced VPC routing is enabled. </p> <p>Default: false</p>
  --MaintenanceTrackName: string # The name for the maintenance track that you want to assign for the cluster. This name change is asynchronous. The new track name stays in the <code>PendingModifiedValues</code> for the cluster until the next maintenance window. When the maintenance track changes, the cluster is switched to the latest cluster release available for the maintenance track. At this point, the maintenance track name is applied.
  ...
  --KmsKeyId: string # The Key Management Service (KMS) key ID of the encryption key that you want to use to encrypt data in the cluster.
  --AvailabilityZoneRelocation: oneof<nothing, bool> # The option to enable relocation for an Amazon Redshift cluster between Availability Zones after the cluster modification is complete.
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "ClusterIdentifier" $ClusterIdentifier "scalar") (serialize-qp "ClusterType" $ClusterType "scalar") (serialize-qp "NodeType" $NodeType "scalar") (serialize-qp "NumberOfNodes" $NumberOfNodes "scalar") (serialize-qp "ClusterSecurityGroups" $ClusterSecurityGroups "multi") (serialize-qp "VpcSecurityGroupIds" $VpcSecurityGroupIds "multi") (serialize-qp "MasterUserPassword" $MasterUserPassword "scalar") (serialize-qp "ClusterParameterGroupName" $ClusterParameterGroupName "scalar") (serialize-qp "AutomatedSnapshotRetentionPeriod" $AutomatedSnapshotRetentionPeriod "scalar") (serialize-qp "ManualSnapshotRetentionPeriod" $ManualSnapshotRetentionPeriod "scalar") (serialize-qp "PreferredMaintenanceWindow" $PreferredMaintenanceWindow "scalar") (serialize-qp "ClusterVersion" $ClusterVersion "scalar") (serialize-qp "AllowVersionUpgrade" $AllowVersionUpgrade "scalar") (serialize-qp "HsmClientCertificateIdentifier" $HsmClientCertificateIdentifier "scalar") (serialize-qp "HsmConfigurationIdentifier" $HsmConfigurationIdentifier "scalar") (serialize-qp "NewClusterIdentifier" $NewClusterIdentifier "scalar") (serialize-qp "PubliclyAccessible" $PubliclyAccessible "scalar") (serialize-qp "ElasticIp" $ElasticIp "scalar") (serialize-qp "EnhancedVpcRouting" $EnhancedVpcRouting "scalar") (serialize-qp "MaintenanceTrackName" $MaintenanceTrackName "scalar") (serialize-qp "Encrypted" $Encrypted "scalar") (serialize-qp "KmsKeyId" $KmsKeyId "scalar") (serialize-qp "AvailabilityZoneRelocation" $AvailabilityZoneRelocation "scalar") (serialize-qp "AvailabilityZone" $AvailabilityZone "scalar") (serialize-qp "Port" $Port "scalar") (serialize-qp "Action" $Action "scalar") (serialize-qp "Version" $Version "scalar")] | flatten | str join "&"
...
export def "action-modify-cluster ModifyCluster-1" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
...
export def "action-modify-cluster-db-revision ModifyClusterDbRevision" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
  ...
  --RevisionTarget: string # The identifier of the database revision. You can retrieve this value from the response to the <a>DescribeClusterDbRevisions</a> request.
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "ClusterIdentifier" $ClusterIdentifier "scalar") (serialize-qp "RevisionTarget" $RevisionTarget "scalar") (serialize-qp "Action" $Action "scalar") (serialize-qp "Version" $Version "scalar")] | flatten | str join "&"
...
export def "action-modify-cluster-db-revision ModifyClusterDbRevision-1" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
...
export def "action-modify-cluster-iam-roles ModifyClusterIamRoles" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
  ...
  --AddIamRoles: list # Zero or more IAM roles to associate with the cluster. The roles must be in their Amazon Resource Name (ARN) format. 
  --RemoveIamRoles: list # Zero or more IAM roles in ARN format to disassociate from the cluster. 
  --DefaultIamRoleArn: string # The Amazon Resource Name (ARN) for the IAM role that was set as default for the cluster when the cluster was last modified.
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "ClusterIdentifier" $ClusterIdentifier "scalar") (serialize-qp "AddIamRoles" $AddIamRoles "multi") (serialize-qp "RemoveIamRoles" $RemoveIamRoles "multi") (serialize-qp "DefaultIamRoleArn" $DefaultIamRoleArn "scalar") (serialize-qp "Action" $Action "scalar") (serialize-qp "Version" $Version "scalar")] | flatten | str join "&"
...
export def "action-modify-cluster-iam-roles ModifyClusterIamRoles-1" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
...
export def "action-modify-cluster-maintenance ModifyClusterMaintenance" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
  ...
  --allow-errors(-e) # Return full response without error handling
  --dry-run(-n) # Return the request that would be sent without executing it
  --ClusterIdentifier: string # A unique identifier for the cluster.
  --DeferMaintenance: oneof<nothing, bool> # A boolean indicating whether to enable the deferred maintenance window. 
  --DeferMaintenanceIdentifier: string # A unique identifier for the deferred maintenance window.
  --DeferMaintenanceStartTime: string # A timestamp indicating the start time for the deferred maintenance window. (format: date-time)
  --DeferMaintenanceEndTime: string # A timestamp indicating end time for the deferred maintenance window. If you specify an end time, you can't specify a duration. (format: date-time)
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "ClusterIdentifier" $ClusterIdentifier "scalar") (serialize-qp "DeferMaintenance" $DeferMaintenance "scalar") (serialize-qp "DeferMaintenanceIdentifier" $DeferMaintenanceIdentifier "scalar") (serialize-qp "DeferMaintenanceStartTime" $DeferMaintenanceStartTime "scalar") (serialize-qp "DeferMaintenanceEndTime" $DeferMaintenanceEndTime "scalar") (serialize-qp "DeferMaintenanceDuration" $DeferMaintenanceDuration "scalar") (serialize-qp "Action" $Action "scalar") (serialize-qp "Version" $Version "scalar")] | flatten | str join "&"
...
export def "action-modify-cluster-maintenance ModifyClusterMaintenance-1" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
...
export def "action-modify-cluster-parameter-group ModifyClusterParameterGroup" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "ParameterGroupName" $ParameterGroupName "scalar") (serialize-qp "Parameters" $Parameters "multi") (serialize-qp "Action" $Action "scalar") (serialize-qp "Version" $Version "scalar")] | flatten | str join "&"
...
export def "action-modify-cluster-parameter-group ModifyClusterParameterGroup-1" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
...
export def "action-modify-cluster-snapshot ModifyClusterSnapshot" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
  ...
  --allow-errors(-e) # Return full response without error handling
  --dry-run(-n) # Return the request that would be sent without executing it
  --SnapshotIdentifier: string # The identifier of the snapshot whose setting you want to modify.
  --ManualSnapshotRetentionPeriod: int # <p>The number of days that a manual snapshot is retained. If the value is -1, the manual snapshot is retained indefinitely.</p> <p>If the manual snapshot falls outside of the new retention period, you can specify the force option to immediately delete the snapshot.</p> <p>The value must be either -1 or an integer between 1 and 3,653.</p>
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "SnapshotIdentifier" $SnapshotIdentifier "scalar") (serialize-qp "ManualSnapshotRetentionPeriod" $ManualSnapshotRetentionPeriod "scalar") (serialize-qp "Force" $Force "scalar") (serialize-qp "Action" $Action "scalar") (serialize-qp "Version" $Version "scalar")] | flatten | str join "&"
...
export def "action-modify-cluster-snapshot ModifyClusterSnapshot-1" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
...
export def "action-modify-cluster-snapshot-schedule ModifyClusterSnapshotSchedule" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
  ...
  --DisassociateSchedule: oneof<nothing, bool> # A boolean to indicate whether to remove the assoiciation between the cluster and the schedule.
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "ClusterIdentifier" $ClusterIdentifier "scalar") (serialize-qp "ScheduleIdentifier" $ScheduleIdentifier "scalar") (serialize-qp "DisassociateSchedule" $DisassociateSchedule "scalar") (serialize-qp "Action" $Action "scalar") (serialize-qp "Version" $Version "scalar")] | flatten | str join "&"
...
export def "action-modify-cluster-snapshot-schedule ModifyClusterSnapshotSchedule-1" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
...
export def "action-modify-cluster-subnet-group ModifyClusterSubnetGroup" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "ClusterSubnetGroupName" $ClusterSubnetGroupName "scalar") (serialize-qp "Description" $Description "scalar") (serialize-qp "SubnetIds" $SubnetIds "multi") (serialize-qp "Action" $Action "scalar") (serialize-qp "Version" $Version "scalar")] | flatten | str join "&"
...
export def "action-modify-cluster-subnet-group ModifyClusterSubnetGroup-1" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
...
export def "action-modify-endpoint-access ModifyEndpointAccess" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
  ...
  --allow-errors(-e) # Return full response without error handling
  --dry-run(-n) # Return the request that would be sent without executing it
  --EndpointName: string # The endpoint to be modified.
  --VpcSecurityGroupIds: list # The complete list of VPC security groups associated with the endpoint after the endpoint is modified.
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "EndpointName" $EndpointName "scalar") (serialize-qp "VpcSecurityGroupIds" $VpcSecurityGroupIds "multi") (serialize-qp "Action" $Action "scalar") (serialize-qp "Version" $Version "scalar")] | flatten | str join "&"
...
export def "action-modify-endpoint-access ModifyEndpointAccess-1" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
...
export def "action-modify-event-subscription ModifyEventSubscription" [
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "SubscriptionName" $SubscriptionName "scalar") (serialize-qp "SnsTopicArn" $SnsTopicArn "scalar") (serialize-qp "SourceType" $SourceType "scalar") (serialize-qp "SourceIds" $SourceIds "multi") (serialize-qp "EventCategories" $EventCategories "multi") (serialize-qp "Severity" $Severity "scalar") (serialize-qp "Enabled" $Enabled "scalar") (serialize-qp "Action" $Action "scalar") (serialize-qp "Version" $Version "scalar")] | flatten | str join "&"
...
export def "action-modify-scheduled-action ModifyScheduledAction" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
  ...
  --allow-errors(-e) # Return full response without error handling
  --dry-run(-n) # Return the request that would be sent without executing it
  --ScheduledActionName: string # The name of the scheduled action to modify. 
  --TargetAction: record # A modified JSON format of the scheduled action. For more information about this parameter, see <a>ScheduledAction</a>. 
  ...
  --IamRole: string # A different IAM role to assume to run the target action. For more information about this parameter, see <a>ScheduledAction</a>.
  --ScheduledActionDescription: string # A modified description of the scheduled action. 
  --StartTime: string # A modified start time of the scheduled action. For more information about this parameter, see <a>ScheduledAction</a>.  (format: date-time)
  --EndTime: string # A modified end time of the scheduled action. For more information about this parameter, see <a>ScheduledAction</a>.  (format: date-time)
...
export def "action-modify-scheduled-action ModifyScheduledAction-1" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
...
export def "action-modify-snapshot-copy-retention-period ModifySnapshotCopyRetentionPeriod" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "ClusterIdentifier" $ClusterIdentifier "scalar") (serialize-qp "RetentionPeriod" $RetentionPeriod "scalar") (serialize-qp "Manual" $Manual "scalar") (serialize-qp "Action" $Action "scalar") (serialize-qp "Version" $Version "scalar")] | flatten | str join "&"
...
export def "action-modify-snapshot-copy-retention-period ModifySnapshotCopyRetentionPeriod-1" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
...
export def "action-modify-snapshot-schedule ModifySnapshotSchedule" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
  ...
  --allow-errors(-e) # Return full response without error handling
  --dry-run(-n) # Return the request that would be sent without executing it
  --ScheduleIdentifier: string # A unique alphanumeric identifier of the schedule to modify.
  --ScheduleDefinitions: list # An updated list of schedule definitions. A schedule definition is made up of schedule expressions, for example, "cron(30 12 *)" or "rate(12 hours)".
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "ScheduleIdentifier" $ScheduleIdentifier "scalar") (serialize-qp "ScheduleDefinitions" $ScheduleDefinitions "multi") (serialize-qp "Action" $Action "scalar") (serialize-qp "Version" $Version "scalar")] | flatten | str join "&"
...
export def "action-modify-snapshot-schedule ModifySnapshotSchedule-1" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
...
export def "action-modify-usage-limit ModifyUsageLimit" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
  ...
  --allow-errors(-e) # Return full response without error handling
  --dry-run(-n) # Return the request that would be sent without executing it
  --UsageLimitId: string # The identifier of the usage limit to modify.
  --Amount: int # The new limit amount. For more information about this parameter, see <a>UsageLimit</a>. 
  --BreachAction: string@BreachAction-completer # The new action that Amazon Redshift takes when the limit is reached. For more information about this parameter, see <a>UsageLimit</a>. 
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "UsageLimitId" $UsageLimitId "scalar") (serialize-qp "Amount" $Amount "scalar") (serialize-qp "BreachAction" $BreachAction "scalar") (serialize-qp "Action" $Action "scalar") (serialize-qp "Version" $Version "scalar")] | flatten | str join "&"
...
export def "action-modify-usage-limit ModifyUsageLimit-1" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
...
export def "action-pause-cluster PauseCluster" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
  ...
  --allow-errors(-e) # Return full response without error handling
  --dry-run(-n) # Return the request that would be sent without executing it
  --ClusterIdentifier: string # The identifier of the cluster to be paused.
...
export def "action-pause-cluster PauseCluster-1" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
...
export def "action-purchase-reserved-node-offering PurchaseReservedNodeOffering" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
  ...
  --NodeCount: int # <p>The number of reserved nodes that you want to purchase.</p> <p>Default: <code>1</code> </p>
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "ReservedNodeOfferingId" $ReservedNodeOfferingId "scalar") (serialize-qp "NodeCount" $NodeCount "scalar") (serialize-qp "Action" $Action "scalar") (serialize-qp "Version" $Version "scalar")] | flatten | str join "&"
...
export def "action-purchase-reserved-node-offering PurchaseReservedNodeOffering-1" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
...
export def "action-reboot-cluster RebootCluster" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
...
export def "action-reboot-cluster RebootCluster-1" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
...
export def "action-reject-data-share RejectDataShare" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "DataShareArn" $DataShareArn "scalar") (serialize-qp "Action" $Action "scalar") (serialize-qp "Version" $Version "scalar")] | flatten | str join "&"
...
export def "action-reject-data-share RejectDataShare-1" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
...
export def "action-reset-cluster-parameter-group ResetClusterParameterGroup" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
  ...
  --ResetAllParameters: oneof<nothing, bool> # <p>If <code>true</code>, all parameters in the specified parameter group will be reset to their default values. </p> <p>Default: <code>true</code> </p>
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "ParameterGroupName" $ParameterGroupName "scalar") (serialize-qp "ResetAllParameters" $ResetAllParameters "scalar") (serialize-qp "Parameters" $Parameters "multi") (serialize-qp "Action" $Action "scalar") (serialize-qp "Version" $Version "scalar")] | flatten | str join "&"
...
export def "action-reset-cluster-parameter-group ResetClusterParameterGroup-1" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
...
export def "action-resize-cluster ResizeCluster" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
  ...
  --allow-errors(-e) # Return full response without error handling
  --dry-run(-n) # Return the request that would be sent without executing it
  --ClusterIdentifier: string # The unique identifier for the cluster to resize.
  ...
  --NumberOfNodes: int # The new number of nodes for the cluster. If not specified, the cluster's current number of nodes is used.
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "ClusterIdentifier" $ClusterIdentifier "scalar") (serialize-qp "ClusterType" $ClusterType "scalar") (serialize-qp "NodeType" $NodeType "scalar") (serialize-qp "NumberOfNodes" $NumberOfNodes "scalar") (serialize-qp "Classic" $Classic "scalar") (serialize-qp "ReservedNodeId" $ReservedNodeId "scalar") (serialize-qp "TargetReservedNodeOfferingId" $TargetReservedNodeOfferingId "scalar") (serialize-qp "Action" $Action "scalar") (serialize-qp "Version" $Version "scalar")] | flatten | str join "&"
...
export def "action-resize-cluster ResizeCluster-1" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
...
export def "action-restore-from-cluster-snapshot RestoreFromClusterSnapshot" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
  ...
  --SnapshotIdentifier: string # <p>The name of the snapshot from which to create the new cluster. This parameter isn't case sensitive. You must specify this parameter or <code>snapshotArn</code>, but not both.</p> <p>Example: <code>my-snapshot-id</code> </p>
  --SnapshotArn: string # The Amazon Resource Name (ARN) of the snapshot associated with the message to restore from a cluster. You must specify this parameter or <code>snapshotIdentifier</code>, but not both.
  --SnapshotClusterIdentifier: string # The name of the cluster the source snapshot was created from. This parameter is required if your IAM user or role has a policy containing a snapshot resource element that specifies anything other than * for the cluster name.
  ...
  --AvailabilityZone: string # <p>The Amazon EC2 Availability Zone in which to restore the cluster.</p> <p>Default: A random, system-chosen Availability Zone.</p> <p>Example: <code>us-east-2a</code> </p>
  --AllowVersionUpgrade: oneof<nothing, bool> # <p>If <code>true</code>, major version upgrades can be applied during the maintenance window to the Amazon Redshift engine that is running on the cluster. </p> <p>Default: <code>true</code> </p>
  ...
  --HsmClientCertificateIdentifier: string # Specifies the name of the HSM client certificate the Amazon Redshift cluster uses to retrieve the data encryption keys stored in an HSM.
  --HsmConfigurationIdentifier: string # Specifies the name of the HSM configuration that contains the information the Amazon Redshift cluster can use to retrieve and store keys in an HSM.
  --ElasticIp: string # The Elastic IP (EIP) address for the cluster. Don't specify the Elastic IP address for a publicly accessible cluster with availability zone relocation turned on.
  --ClusterParameterGroupName: string # <p>The name of the parameter group to be associated with this cluster.</p> <p>Default: The default Amazon Redshift cluster parameter group. For information about the default parameter group, go to <a href="https://docs.aws.amazon.com/redshift/latest/mgmt/working-with-parameter-groups.html">Working with Amazon Redshift Parameter Groups</a>.</p> <p>Constraints:</p> <ul> <li> <p>Must be 1 to 255 alphanumeric characters or hyphens.</p> </li> <li> <p>First character must be a letter.</p> </li> <li> <p>Cannot end with a hyphen or contain two consecutive hyphens.</p> </li> </ul>
  --ClusterSecurityGroups: list # <p>A list of security groups to be associated with this cluster.</p> <p>Default: The default cluster security group for Amazon Redshift.</p> <p>Cluster security groups only apply to clusters outside of VPCs.</p>
  --VpcSecurityGroupIds: list # <p>A list of Virtual Private Cloud (VPC) security groups to be associated with the cluster.</p> <p>Default: The default VPC security group is associated with the cluster.</p> <p>VPC security groups only apply to clusters in VPCs.</p>
  ...
  --ManualSnapshotRetentionPeriod: int # <p>The default number of days to retain a manual snapshot. If the value is -1, the snapshot is retained indefinitely. This setting doesn't change the retention period of existing snapshots.</p> <p>The value must be either -1 or an integer between 1 and 3,653.</p>
  --KmsKeyId: string # The Key Management Service (KMS) key ID of the encryption key that encrypts data in the cluster restored from a shared snapshot. You can also provide the key ID when you restore from an unencrypted snapshot to an encrypted cluster in the same account. Additionally, you can specify a new KMS key ID when you restore from an encrypted snapshot in the same account in order to change it. In that case, the restored cluster is encrypted with the new KMS key ID.
  ...
  --AdditionalInfo: string # Reserved.
  --IamRoles: list # <p>A list of Identity and Access Management (IAM) roles that can be used by the cluster to access other Amazon Web Services services. You must supply the IAM roles in their Amazon Resource Name (ARN) format. </p> <p>The maximum number of IAM roles that you can associate is subject to a quota. For more information, go to <a href="https://docs.aws.amazon.com/redshift/latest/mgmt/amazon-redshift-limits.html">Quotas and limits</a> in the <i>Amazon Redshift Cluster Management Guide</i>.</p>
  --MaintenanceTrackName: string # The name of the maintenance track for the restored cluster. When you take a snapshot, the snapshot inherits the <code>MaintenanceTrack</code> value from the cluster. The snapshot might be on a different track than the cluster that was the source for the snapshot. For example, suppose that you take a snapshot of a cluster that is on the current track and then change the cluster to be on the trailing track. In this case, the snapshot and the source cluster are on different tracks.
  --SnapshotScheduleIdentifier: string # A unique identifier for the snapshot schedule.
  --NumberOfNodes: int # The number of nodes specified when provisioning the restored cluster.
  --AvailabilityZoneRelocation: oneof<nothing, bool> # The option to enable relocation for an Amazon Redshift cluster between Availability Zones after the cluster is restored.
  --AquaConfigurationStatus: string@AquaConfigurationStatus-completer # This parameter is retired. It does not set the AQUA configuration status. Amazon Redshift automatically determines whether to use AQUA (Advanced Query Accelerator).
  --DefaultIamRoleArn: string # The Amazon Resource Name (ARN) for the IAM role that was set as default for the cluster when the cluster was last modified while it was restored from a snapshot.
  --ReservedNodeId: string # The identifier of the target reserved node offering.
  --TargetReservedNodeOfferingId: string # The identifier of the target reserved node offering.
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "ClusterIdentifier" $ClusterIdentifier "scalar") (serialize-qp "SnapshotIdentifier" $SnapshotIdentifier "scalar") (serialize-qp "SnapshotArn" $SnapshotArn "scalar") (serialize-qp "SnapshotClusterIdentifier" $SnapshotClusterIdentifier "scalar") (serialize-qp "Port" $Port "scalar") (serialize-qp "AvailabilityZone" $AvailabilityZone "scalar") (serialize-qp "AllowVersionUpgrade" $AllowVersionUpgrade "scalar") (serialize-qp "ClusterSubnetGroupName" $ClusterSubnetGroupName "scalar") (serialize-qp "PubliclyAccessible" $PubliclyAccessible "scalar") (serialize-qp "OwnerAccount" $OwnerAccount "scalar") (serialize-qp "HsmClientCertificateIdentifier" $HsmClientCertificateIdentifier "scalar") (serialize-qp "HsmConfigurationIdentifier" $HsmConfigurationIdentifier "scalar") (serialize-qp "ElasticIp" $ElasticIp "scalar") (serialize-qp "ClusterParameterGroupName" $ClusterParameterGroupName "scalar") (serialize-qp "ClusterSecurityGroups" $ClusterSecurityGroups "multi") (serialize-qp "VpcSecurityGroupIds" $VpcSecurityGroupIds "multi") (serialize-qp "PreferredMaintenanceWindow" $PreferredMaintenanceWindow "scalar") (serialize-qp "AutomatedSnapshotRetentionPeriod" $AutomatedSnapshotRetentionPeriod "scalar") (serialize-qp "ManualSnapshotRetentionPeriod" $ManualSnapshotRetentionPeriod "scalar") (serialize-qp "KmsKeyId" $KmsKeyId "scalar") (serialize-qp "NodeType" $NodeType "scalar") (serialize-qp "EnhancedVpcRouting" $EnhancedVpcRouting "scalar") (serialize-qp "AdditionalInfo" $AdditionalInfo "scalar") (serialize-qp "IamRoles" $IamRoles "multi") (serialize-qp "MaintenanceTrackName" $MaintenanceTrackName "scalar") (serialize-qp "SnapshotScheduleIdentifier" $SnapshotScheduleIdentifier "scalar") (serialize-qp "NumberOfNodes" $NumberOfNodes "scalar") (serialize-qp "AvailabilityZoneRelocation" $AvailabilityZoneRelocation "scalar") (serialize-qp "AquaConfigurationStatus" $AquaConfigurationStatus "scalar") (serialize-qp "DefaultIamRoleArn" $DefaultIamRoleArn "scalar") (serialize-qp "ReservedNodeId" $ReservedNodeId "scalar") (serialize-qp "TargetReservedNodeOfferingId" $TargetReservedNodeOfferingId "scalar") (serialize-qp "Encrypted" $Encrypted "scalar") (serialize-qp "Action" $Action "scalar") (serialize-qp "Version" $Version "scalar")] | flatten | str join "&"
...
export def "action-restore-from-cluster-snapshot RestoreFromClusterSnapshot-1" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
...
export def "action-restore-table-from-cluster-snapshot RestoreTableFromClusterSnapshot" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
  ...
  --SnapshotIdentifier: string # The identifier of the snapshot to restore the table from. This snapshot must have been created from the Amazon Redshift cluster specified by the <code>ClusterIdentifier</code> parameter.
  --SourceDatabaseName: string # The name of the source database that contains the table to restore from.
  --SourceSchemaName: string # The name of the source schema that contains the table to restore from. If you do not specify a <code>SourceSchemaName</code> value, the default is <code>public</code>.
  ...
  --EnableCaseSensitiveIdentifier: oneof<nothing, bool> # Indicates whether name identifiers for database, schema, and table are case sensitive. If <code>true</code>, the names are case sensitive. If <code>false</code> (default), the names are not case sensitive.
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "ClusterIdentifier" $ClusterIdentifier "scalar") (serialize-qp "SnapshotIdentifier" $SnapshotIdentifier "scalar") (serialize-qp "SourceDatabaseName" $SourceDatabaseName "scalar") (serialize-qp "SourceSchemaName" $SourceSchemaName "scalar") (serialize-qp "SourceTableName" $SourceTableName "scalar") (serialize-qp "TargetDatabaseName" $TargetDatabaseName "scalar") (serialize-qp "TargetSchemaName" $TargetSchemaName "scalar") (serialize-qp "NewTableName" $NewTableName "scalar") (serialize-qp "EnableCaseSensitiveIdentifier" $EnableCaseSensitiveIdentifier "scalar") (serialize-qp "Action" $Action "scalar") (serialize-qp "Version" $Version "scalar")] | flatten | str join "&"
...
export def "action-restore-table-from-cluster-snapshot RestoreTableFromClusterSnapshot-1" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
...
export def "action-resume-cluster ResumeCluster" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
  ...
  --allow-errors(-e) # Return full response without error handling
  --dry-run(-n) # Return the request that would be sent without executing it
  --ClusterIdentifier: string # The identifier of the cluster to be resumed.
...
export def "action-resume-cluster ResumeCluster-1" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
...
export def "action-revoke-cluster-security-group-ingress RevokeClusterSecurityGroupIngress" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
  ...
  --allow-errors(-e) # Return full response without error handling
  --dry-run(-n) # Return the request that would be sent without executing it
  --ClusterSecurityGroupName: string # The name of the security Group from which to revoke the ingress rule.
  ...
  --EC2SecurityGroupName: string # The name of the EC2 Security Group whose access is to be revoked. If <code>EC2SecurityGroupName</code> is specified, <code>EC2SecurityGroupOwnerId</code> must also be provided and <code>CIDRIP</code> cannot be provided. 
  --EC2SecurityGroupOwnerId: string # <p>The Amazon Web Services account number of the owner of the security group specified in the <code>EC2SecurityGroupName</code> parameter. The Amazon Web Services access key ID is not an acceptable value. If <code>EC2SecurityGroupOwnerId</code> is specified, <code>EC2SecurityGroupName</code> must also be provided. and <code>CIDRIP</code> cannot be provided. </p> <p>Example: <code>111122223333</code> </p>
...
export def "action-revoke-cluster-security-group-ingress RevokeClusterSecurityGroupIngress-1" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
...
export def "action-revoke-endpoint-access RevokeEndpointAccess" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
  ...
  --VpcIds: list # The virtual private cloud (VPC) identifiers for which access is to be revoked.
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "ClusterIdentifier" $ClusterIdentifier "scalar") (serialize-qp "Account" $Account "scalar") (serialize-qp "VpcIds" $VpcIds "multi") (serialize-qp "Force" $Force "scalar") (serialize-qp "Action" $Action "scalar") (serialize-qp "Version" $Version "scalar")] | flatten | str join "&"
...
export def "action-revoke-endpoint-access RevokeEndpointAccess-1" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
...
export def "action-revoke-snapshot-access RevokeSnapshotAccess" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
...
export def "action-revoke-snapshot-access RevokeSnapshotAccess-1" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
...
export def "action-rotate-encryption-key RotateEncryptionKey" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
...
export def "action-rotate-encryption-key RotateEncryptionKey-1" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
...
export def "action-update-partner-status UpdatePartnerStatus" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "AccountId" $AccountId "scalar") (serialize-qp "ClusterIdentifier" $ClusterIdentifier "scalar") (serialize-qp "DatabaseName" $DatabaseName "scalar") (serialize-qp "PartnerName" $PartnerName "scalar") (serialize-qp "Status" $Status "scalar") (serialize-qp "StatusMessage" $StatusMessage "scalar") (serialize-qp "Action" $Action "scalar") (serialize-qp "Version" $Version "scalar")] | flatten | str join "&"
...
export def "action-update-partner-status UpdatePartnerStatus-1" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
