...
export def "reporting-mortgagesbycreateddate get-controller-mortgages-by-created-date" [
  ...
  do-request "get" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors $full "application/json" null {query: ({"branchID": $branch_id, "startDate": $start_date, "offset": $offset, "count": $count} | compact), body: null}
}
