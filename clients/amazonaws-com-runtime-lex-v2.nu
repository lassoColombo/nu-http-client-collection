...
export def "bots-bot-aliases-bot-locales-sessions-utterance-content-type create-recognize-utterance" [
  bot_id: string
  bot_alias_id: string
  locale_id: string
  session_id: string
