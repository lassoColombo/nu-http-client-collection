...
export def "subscriptions-providers-microsoft-security-regulatory-compliance-standards list" [
  ...
  let full_url = (build-url $base ({subscription_id: (encode-path-segment $subscription_id)} | format pattern "/subscriptions/{subscription_id}/providers/Microsoft.Security/regulatoryComplianceStandards") $qp)
...
export def "subscriptions-providers-microsoft-security-regulatory-compliance-standards get" [
  ...
  let full_url = (build-url $base ({subscription_id: (encode-path-segment $subscription_id), regulatory_compliance_standard_name: (encode-path-segment $regulatory_compliance_standard_name)} | format pattern "/subscriptions/{subscription_id}/providers/Microsoft.Security/regulatoryComplianceStandards/{regulatory_compliance_standard_name}") $qp)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
...
export def "subscriptions-providers-microsoft-security-regulatory-compliance-standards-regulatory-compliance-controls list" [
  ...
  if ($regulatory_compliance_standard_name | is-empty) { error make --unspanned { msg: "path parameter 'regulatoryComplianceStandardName' must be non-empty" } }
  let qp = [(serialize-qp "api-version" $api_version "scalar") (serialize-qp "$filter" $filter "scalar")] | flatten | str join "&"
  let full_url = (build-url $base ({subscription_id: (encode-path-segment $subscription_id), regulatory_compliance_standard_name: (encode-path-segment $regulatory_compliance_standard_name)} | format pattern "/subscriptions/{subscription_id}/providers/Microsoft.Security/regulatoryComplianceStandards/{regulatory_compliance_standard_name}/regulatoryComplianceControls") $qp)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "get" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors $full "application/json" null {query: ({"api-version": $api_version, "$filter": $filter} | compact), body: null}
}
