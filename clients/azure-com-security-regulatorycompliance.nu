...
export def "subscriptions-providers-microsoft-security-regulatory-compliance-standards List" [
  ...
  let full_url = (build-url $base $"/subscriptions/($subscriptionId)/providers/Microsoft.Security/regulatoryComplianceStandards" $qp)
...
export def "subscriptions-providers-microsoft-security-regulatory-compliance-standards Get" [
  ...
  let full_url = (build-url $base $"/subscriptions/($subscriptionId)/providers/Microsoft.Security/regulatoryComplianceStandards/($regulatoryComplianceStandardName)" $qp)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "get" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json"
}
...
export def "subscriptions-providers-microsoft-security-regulatory-compliance-standards-regulatory-compliance-controls List" [
  ...
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "api-version" $api_version "scalar") (serialize-qp "$filter" $filter "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/subscriptions/($subscriptionId)/providers/Microsoft.Security/regulatoryComplianceStandards/($regulatoryComplianceStandardName)/regulatoryComplianceControls" $qp)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "get" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json"
}
...
export def "subscriptions-providers-microsoft-security-regulatory-compliance-standards-regulatory-compliance-controls Get" [
  ...
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "api-version" $api_version "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/subscriptions/($subscriptionId)/providers/Microsoft.Security/regulatoryComplianceStandards/($regulatoryComplianceStandardName)/regulatoryComplianceControls/($regulatoryComplianceControlName)" $qp)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "get" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json"
}
...
export def "subscriptions-providers-microsoft-security-regulatory-compliance-standards-regulatory-compliance-controls-regulatory-compliance-assessments List" [
  ...
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "api-version" $api_version "scalar") (serialize-qp "$filter" $filter "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/subscriptions/($subscriptionId)/providers/Microsoft.Security/regulatoryComplianceStandards/($regulatoryComplianceStandardName)/regulatoryComplianceControls/($regulatoryComplianceControlName)/regulatoryComplianceAssessments" $qp)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "get" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json"
}
...
export def "subscriptions-providers-microsoft-security-regulatory-compliance-standards-regulatory-compliance-controls-regulatory-compliance-assessments Get" [
  ...
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "api-version" $api_version "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/subscriptions/($subscriptionId)/providers/Microsoft.Security/regulatoryComplianceStandards/($regulatoryComplianceStandardName)/regulatoryComplianceControls/($regulatoryComplianceControlName)/regulatoryComplianceAssessments/($regulatoryComplianceAssessmentName)" $qp)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "get" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json"
}
