...
export def "subscriptions-resource-groups-providers-microsoft-insights-components-favorites list" [
  ...
  do-request "get" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors $full "application/json" null {query: ({"api-version": $api_version, "favoriteType": $favorite_type, "sourceType": $source_type, "canFetchContent": $can_fetch_content, "tags": $tags} | compact), body: null}
}
