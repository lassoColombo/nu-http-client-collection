...
export def commands []: nothing -> table {
  ...
  let mod_name = (scope modules | where { $in.commands | any { $in.name == "shopping-flight-offers-pricing quoteAirOffers" } } | get name | first)
...
export def "shopping-flight-offers-pricing quoteAirOffers" [
