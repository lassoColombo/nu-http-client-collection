...
export def commands []: nothing -> table {
  ...
  let mod_name = (scope modules | where { $in.commands | any { $in.name == "conversations-visitor-identification-tokens-create generateToken" } } | get name | first)
...
export def "conversations-visitor-identification-tokens-create generateToken" [
