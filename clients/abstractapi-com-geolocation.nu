...
# Source: https://api.apis.guru/v2/specs/abstractapi.com/geolocation/1.0.0/openapi.json
...
def base-url-completer [] { ["https://ipgeolocation.abstractapi.com"] }
...
export def "api get" [
  ...
  do-request "get" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors $full "application/json" null {query: ({"api_key": $api_key, "ip_address": $ip_address, "fields": $fields} | compact), body: null}
}
