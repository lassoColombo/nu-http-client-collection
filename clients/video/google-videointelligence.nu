# Auto-generated client for Cloud Video Intelligence API vv1
# Source: https://api.apis.guru/v2/specs/googleapis.com/videointelligence/v1/openapi.json
# Auth: --token flag or $env.CLOUD_VIDEO_INTELLIGENCE_API_TOKEN

const BASE_URL = "https://videointelligence.googleapis.com"
const DEFAULT_AUTH = "bearer"

# Build auth: returns {headers: record, query: string}
def build-auth [token?: string, auth_scheme?: string]: nothing -> record {
  let token_val = if ($token != null) and ($token | is-not-empty) { $token } else { $env | get -o CLOUD_VIDEO_INTELLIGENCE_API_TOKEN | default "" }
...
def base-url-completer [] { ["https://videointelligence.googleapis.com"] }
...
export def commands []: nothing -> table {
  ...
  let mod_name = (scope modules | where { $in.commands | any { $in.name == "operations videointelligenceoperationsprojectslocationsoperationsdelete" } } | get name | first)
...
# operationId: videointelligence.operations.projects.locations.operations.delete
export def "operations videointelligenceoperationsprojectslocationsoperationsdelete" [
  name: string
  ...
  let full_url = (build-url $base $"/v1/operations/($name)" $qp)
...
# operationId: videointelligence.operations.projects.locations.operations.get
export def "operations videointelligenceoperationsprojectslocationsoperationsget" [
  name: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
...
# operationId: videointelligence.operations.projects.locations.operations.cancel
export def "operations videointelligenceoperationsprojectslocationsoperationscancel" [
  name: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  ...
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $qp_fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v1/operations/($name):cancel" $qp)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
...
export def "videos-annotate videointelligencevideosannotate" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
  ...
  --upload-protocol: string # Upload protocol for media (e.g. "raw", "multipart").
  --uploadType: string # Legacy upload protocol for media (e.g. "media", "multipart").
  --features: list # Required. Requested video annotation features.
  --inputContent: string # The video data bytes. If unset, the input video(s) should be specified via the `input_uri`. If set, `input_uri` must be unset. (format: byte)
  ...
  --videoContext: record # Video context and/or feature-specific parameters. — shape: {explicitContentDetectionConfig?: record, faceDetectionConfig?: record, labelDetectionConfig?: record, objectTrackingConfig?: record, personDetectionConfig?: record, segments?: list, shotChangeDetectionConfig?: record, speechTranscriptionConfig?: record, textDetectionConfig?: record}
  ...
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $qp_fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar")] | flatten | str join "&"
  let full_url = (build-url $base "/v1/videos:annotate" $qp)
  let body = {features: $features, inputContent: $inputContent, inputUri: $inputUri, locationId: $locationId, outputUri: $outputUri, videoContext: $videoContext} | compact
...
#
# DELETE /v1/{name}
# operationId: videointelligence.projects.locations.operations.delete
export def "projects videointelligenceprojectslocationsoperationsdelete" [
  name: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
...
#
# GET /v1/{name}
# operationId: videointelligence.projects.locations.operations.get
export def "projects videointelligenceprojectslocationsoperationsget" [
  name: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
...
# operationId: videointelligence.projects.locations.operations.list
export def "operations videointelligenceprojectslocationsoperationslist" [
  name: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
...
#
# POST /v1/{name}:cancel
# operationId: videointelligence.projects.locations.operations.cancel
export def "projects videointelligenceprojectslocationsoperationscancel" [
  name: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
