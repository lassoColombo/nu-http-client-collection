...
export def "reports get" [
  ...
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "get" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors $full "application/json" null {query: ({"report_hash": $report_hash, "baseline": $baseline, "report_date": $report_date, "sample": $sample} | compact), body: null}
}
...
export def "reports create" [
  ...
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "post" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors $full "application/json" null {query: ({"report_hash": $report_hash, "baseline": $baseline, "report_date": $report_date, "sample": $sample} | compact), body: null}
}
...
export def "reports-custom-create get" [
  ...
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "get" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors $full "application/json" null {query: ({"upload_hash": $upload_hash, "filter": $filter} | compact), body: null}
}
...
export def "reports-custom-create create" [
  ...
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "post" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors $full "application/json" null {query: ({"upload_hash": $upload_hash, "filter": $filter} | compact), body: null}
}
...
export def "reports-custom-generate get" [
  ...
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "get" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors $full "application/json" null {query: ({"report_name": $report_name} | compact), body: null}
}
...
export def "reports-custom-generate create" [
  ...
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "post" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors $full "application/json" null {query: ({"report_name": $report_name} | compact), body: null}
}
...
export def "reports-custom-insert get" [
  ...
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "get" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors $full "application/json" null {query: ({"upload_hash": $upload_hash, "ids": $ids} | compact), body: null}
}
...
export def "reports-custom-insert create" [
  ...
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "post" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors $full "application/json" null {query: ({"upload_hash": $upload_hash, "ids": $ids} | compact), body: null}
}
...
export def "reports-dates get" [
  ...
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "get" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors $full "application/json" null {query: ({"report_hash": $report_hash} | compact), body: null}
}
...
export def "reports-dates create" [
  ...
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "post" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors $full "application/json" null {query: ({"report_hash": $report_hash} | compact), body: null}
}
...
export def "reports-tweet-create get" [
  ...
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "get" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors $full "application/json" null {query: ({"report_name": $report_name, "start_date": $start_date, "end_date": $end_date, "terms": $terms, "filter": $filter} | compact), body: null}
}
...
export def "reports-tweet-create create" [
  ...
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "post" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors $full "application/json" null {query: ({"report_name": $report_name, "start_date": $start_date, "end_date": $end_date, "terms": $terms, "filter": $filter} | compact), body: null}
}
...
export def "reports-twitter-create get" [
  ...
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "get" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors $full "application/json" null {query: ({"twitter_id": $twitter_id, "twitter_handle": $twitter_handle, "filter": $filter} | compact), body: null}
}
...
export def "reports-twitter-create create" [
  ...
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "post" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors $full "application/json" null {query: ({"twitter_id": $twitter_id, "twitter_handle": $twitter_handle, "filter": $filter} | compact), body: null}
}
