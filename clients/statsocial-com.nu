...
def build-auth [token?: string, auth_scheme?: string]: nothing -> record {
  let token_val = if ($token | is-not-empty) { $token } else { $env | get -o STATSOCIAL_PLATFORM_API_TOKEN | default "" }
...
export def "applications-status get" [
  ...
  let full_url = (build-url $base "/applications/status/" $qp $auth.query)
...
export def "reports get" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"report_hash": $report_hash, "baseline": $baseline, "report_date": $report_date, "sample": $sample} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "reports-custom-create get" [
  ...
  let full_url = (build-url $base "/reports/custom/create/" $qp $auth.query)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "get"
    url: $full_url
    query: ({"upload_hash": $upload_hash, "filter": $filter} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "reports-custom-generate get" [
  ...
  let full_url = (build-url $base "/reports/custom/generate/" $qp $auth.query)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "get"
    url: $full_url
    query: ({"report_name": $report_name} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "reports-custom-insert get" [
  ...
  let full_url = (build-url $base "/reports/custom/insert/" $qp $auth.query)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "get"
    url: $full_url
    query: ({"upload_hash": $upload_hash, "ids": $ids} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "reports-dates get" [
  ...
  let full_url = (build-url $base "/reports/dates/" $qp $auth.query)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "get"
    url: $full_url
    query: ({"report_hash": $report_hash} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "reports-status get" [
  ...
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "report_hash" $report_hash "scalar")] | flatten | str join "&"
  let full_url = (build-url $base "/reports/status/" $qp $auth.query)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "get"
...
export def "reports-tweet-create get" [
  ...
  let full_url = (build-url $base "/reports/tweet/create/" $qp $auth.query)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "get"
    url: $full_url
    query: ({"report_name": $report_name, "start_date": $start_date, "end_date": $end_date, "terms": $terms, "filter": $filter} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "reports-twitter-create get" [
  ...
  let full_url = (build-url $base "/reports/twitter/create/" $qp $auth.query)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "get"
    url: $full_url
    query: ({"twitter_id": $twitter_id, "twitter_handle": $twitter_handle, "filter": $filter} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
