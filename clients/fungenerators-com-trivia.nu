...
export def "trivia delete" [
  ...
  let full_url = (build-url $base "/trivia" $qp $auth.query)
...
export def "trivia-categories get" [
  ...
  let full_url = (build-url $base "/trivia/categories" $qp $auth.query)
  let accept_val = ($accept | default "application/json")
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "get"
...
export def "trivia-random get" [
  ...
  let full_url = (build-url $base "/trivia/random" $qp $auth.query)
  let accept_val = ($accept | default "application/json")
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "get"
...
export def "trivia-search get" [
  ...
  let full_url = (build-url $base "/trivia/search" $qp $auth.query)
  let accept_val = ($accept | default "application/json")
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "get"
