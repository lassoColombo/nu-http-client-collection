...
def build-auth [token?: string, auth_scheme?: string]: nothing -> record {
  let token_val = if ($token | is-not-empty) { $token } else { $env | get -o OPEN_POLICY_AGENT_OPA_REST_API_TOKEN | default "" }
...
export def "health get" [
  ...
  let full_url = (build-url $base "/health" $qp $auth.query)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "get"
    url: $full_url
    query: ({"bundles": $bundles, "plugins": $plugins} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "data get-document-with-web-hook" [
  ...
  let qp = [(serialize-qp "pretty" $pretty "scalar")] | flatten | str join "&"
  let full_url = (build-url $base ({path: (encode-path-segment $path)} | format pattern "/v0/data/{path}") $qp $auth.query)
  let req_body = $body
...
export def "compile create" [
  ...
  let full_url = (build-url $base "/v1/compile" $qp $auth.query)
  let req_body = $body
  let req_body = if ($input | describe | str starts-with "record") { $input | merge deep ($req_body | default {}) } else { $req_body }
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "post"
    url: $full_url
    query: ({"pretty": $pretty, "explain": $explain, "metrics": $metrics, "instrument": $instrument} | compact)
    headers: $auth.headers
    body: $req_body
    content_type: "application/json"
    timeout: ($max_time | default 30min)
...
export def "data delete-document" [
  ...
  let base = ($base_url | default $BASE_URL)
  if ($path | is-empty) { error make --unspanned { msg: "path parameter 'path' must be non-empty" } }
  let full_url = (build-url $base ({path: (encode-path-segment $path)} | format pattern "/v1/data/{path}") $auth.query)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "delete"
...
export def "data get-document-by-path" [
  ...
  let full_url = (build-url $base ({path: (encode-path-segment $path)} | format pattern "/v1/data/{path}") $qp $auth.query)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "get"
    url: $full_url
    query: ({"input": $input, "pretty": $pretty, "provenance": $provenance, "explain": $explain, "metrics": $metrics, "instrument": $instrument} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "data get-document-by-path-1" [
  ...
  let req = {
    method: "post"
    url: $full_url
    query: ({"pretty": $pretty, "provenance": $provenance, "explain": $explain, "metrics": $metrics, "instrument": $instrument} | compact)
    headers: $auth.headers
    body: $req_body
    content_type: "application/x-yaml"
    timeout: ($max_time | default 30min)
...
export def "data update-document-by-path-1" [
  ...
  if $dry_run { return ({dry_run: true} | merge $req) }
  send-put $req $req_body $insecure $raw $allow_errors $full [204 304]
}
...
export def "policies delete-policy-module" [
  ...
  let qp = [(serialize-qp "pretty" $pretty "scalar")] | flatten | str join "&"
  let full_url = (build-url $base ({id: (encode-path-segment $id)} | format pattern "/v1/policies/{id}") $qp $auth.query)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "delete"
...
export def "policies update-policy-module" [
  ...
  let req = {
    method: "put"
    url: $full_url
    query: ({"pretty": $pretty, "metrics": $metrics} | compact)
    headers: $auth.headers
    body: $req_body
...
export def "query get" [
  ...
  let full_url = (build-url $base "/v1/query" $qp $auth.query)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "get"
    url: $full_url
    query: ({"q": $q, "pretty": $pretty, "explain": $explain, "metrics": $metrics} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "query create" [
  ...
  let req = {
    method: "post"
    url: $full_url
    query: ({"pretty": $pretty, "explain": $explain, "metrics": $metrics} | compact)
    headers: $auth.headers
    body: $req_body
    content_type: "application/x-yaml"
    timeout: ($max_time | default 30min)
