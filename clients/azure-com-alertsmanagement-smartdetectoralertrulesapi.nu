...
export def "subscriptions-providers-microsoft-alerts-management-smart-detector-alert-rules list" [
  ...
  do-request "get" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors $full "application/json" null {query: ({"api-version": $api_version, "expandDetector": $expand_detector} | compact), body: null}
}
