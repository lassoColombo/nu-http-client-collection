...
export def "subscriptions-resource-groups-providers-microsoft-network-ddos-custom-policies Delete" [
  ...
  let full_url = (build-url $base $"/subscriptions/($subscriptionId)/resourceGroups/($resourceGroupName)/providers/Microsoft.Network/ddosCustomPolicies/($ddosCustomPolicyName)" $qp)
...
export def "subscriptions-resource-groups-providers-microsoft-network-ddos-custom-policies UpdateTags" [
  resourceGroupName: string
  ddosCustomPolicyName: string
  subscriptionId: string
  --base-url(-b): string@base-url-completer # API base URL
...
export def "subscriptions-resource-groups-providers-microsoft-network-ddos-custom-policies CreateOrUpdate" [
  resourceGroupName: string
  ddosCustomPolicyName: string
  subscriptionId: string
  --base-url(-b): string@base-url-completer # API base URL
