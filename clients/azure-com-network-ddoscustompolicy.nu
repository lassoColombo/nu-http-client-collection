...
export def "subscriptions-resource-groups-providers-microsoft-network-ddos-custom-policies delete" [
  ...
  let full_url = (build-url $base ({subscription_id: (encode-path-segment $subscription_id), resource_group_name: (encode-path-segment $resource_group_name), ddos_custom_policy_name: (encode-path-segment $ddos_custom_policy_name)} | format pattern "/subscriptions/{subscription_id}/resourceGroups/{resource_group_name}/providers/Microsoft.Network/ddosCustomPolicies/{ddos_custom_policy_name}") $qp)
