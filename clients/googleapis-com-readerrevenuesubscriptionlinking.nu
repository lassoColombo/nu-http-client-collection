...
export def commands []: nothing -> table {
  ...
  let mod_name = (scope modules | where { $in.commands | any { $in.name == "publications readerrevenuesubscriptionlinkingpublicationsreadersdelete" } } | get name | first)
...
export def "publications readerrevenuesubscriptionlinkingpublicationsreadersdelete" [
  name: string
...
export def "publications readerrevenuesubscriptionlinkingpublicationsreadersgetEntitlements" [
  name: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
...
export def "publications readerrevenuesubscriptionlinkingpublicationsreadersupdateEntitlements" [
  name: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
