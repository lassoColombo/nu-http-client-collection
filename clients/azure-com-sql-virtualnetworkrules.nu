...
# Source: https://api.apis.guru/v2/specs/azure.com/sql-virtualNetworkRules/2015-05-01-preview/swagger.json
...
export def commands []: nothing -> table {
  ...
  let mod_name = (scope modules | where { $in.commands | any { $in.name == "subscriptions-resource-groups-providers-microsoft-sql-servers-virtual-network-rules list" } } | get name | first)
...
export def "subscriptions-resource-groups-providers-microsoft-sql-servers-virtual-network-rules list" [
  ...
  let full_url = (build-url $base ({subscription_id: (encode-path-segment $subscription_id), resource_group_name: (encode-path-segment $resource_group_name), server_name: (encode-path-segment $server_name)} | format pattern "/subscriptions/{subscription_id}/resourceGroups/{resource_group_name}/providers/Microsoft.Sql/servers/{server_name}/virtualNetworkRules") $qp $auth.query)
...
export def "subscriptions-resource-groups-providers-microsoft-sql-servers-virtual-network-rules delete" [
  subscription_id: string
  resource_group_name: string
  server_name: string
...
export def "subscriptions-resource-groups-providers-microsoft-sql-servers-virtual-network-rules get" [
  subscription_id: string
  resource_group_name: string
  server_name: string
  virtual_network_rule_name: string
...
export def "subscriptions-resource-groups-providers-microsoft-sql-servers-virtual-network-rules create-or-update" [
  subscription_id: string
  resource_group_name: string
  server_name: string
  virtual_network_rule_name: string
