...
export def commands []: nothing -> table {
  ...
  let mod_name = (scope modules | where { $in.commands | any { $in.name == "checkout-pvt-configuration-window-to-change-seller GetWindowToChangeSeller" } } | get name | first)
...
export def "oms-pvt-admin-reports-completed StatusCompleted" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
...
export def "oms-pvt-admin-reports-inprogress StatusInProgress" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
...
export def "oms-pvt-feed-orders-status Getfeedorderstatus" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
...
export def "oms-pvt-orders ListOrders" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
  ...
  --f-creationDate: string # Concatened value sufix `{{creationDate}}` and range date in Timestamp format. To use the `utc` query parameter, to filter orders by time zone, you must also fill the `f_creationDate` date parameter. (default: creationDate:[2016-01-01T02:00:00.000Z TO 2021-01-01T01:59:59.999Z])
  ...
  --f-shippingEstimate: string # You can filter orders by shipping estimate time in days by concatenating the desired number of days with the sufix `.days`. For example:  - Next 7 days: `7.days`  - Tomorrow: `1.days`  - Today: `0.days`  - Late: `-1.days` (default: 0.days)
  --f-invoicedDate: string # You can filter orders by invoiced date by concatenating the sufix `invoicedDate:` with the range date in Timestamp format. For example:  - 1 Day: `invoicedDate:[2022-01-01T02:00:00.000Z TO 2022-01-02T01:59:59.999Z]` - 1 Month: `invoicedDate:[2022-01-01T02:00:00.000Z TO 2022-02-01T01:59:59.999Z]`  - 1 Year: `invoicedDate:[2022-01-01T02:00:00.000Z TO 2022-01-01T01:59:59.999Z]` (default: invoicedDate:[2022-01-01T02:00:00.000Z TO 2022-01-02T01:59:59.999Z])
  --f-authorizedDate: string # You can filter orders by creation date by concatenating the sufix `authorizedDate:` with the range date in Timestamp format. For example:  - 1 Day: `authorizedDate:[2022-01-01T02:00:00.000Z TO 2022-01-02T01:59:59.999Z]` - 1 Month: `authorizedDate:[2022-01-01T02:00:00.000Z TO 2022-02-01T01:59:59.999Z]`  - 1 Year: `authorizedDate:[2022-01-01T02:00:00.000Z TO 2022-01-01T01:59:59.999Z]` (default: creationDate:[2022-01-01T02:00:00.000Z TO 2022-01-02T01:59:59.999Z])
  --f-UtmSource: string # You can filter orders by using a Universal Transverse Mercator (UTM) source. (default: christmas_campaign)
  --f-sellerNames: string # You can filter orders by using a seller's name. (default: SellerName)
  --f-callCenterOperatorName: string # You can filter orders by using a Call Center Operator's identification. (default: Operator%20Name)
  --f-salesChannel: string # You can filter orders by sales channel's ([or trade policy](https://help.vtex.com/en/tutorial/how-trade-policies-work--6Xef8PZiFm40kg2STrMkMV)) name. (default: Main)
  --salesChannelId: string # You can filter orders by sales channel's ([or trade policy](https://help.vtex.com/en/tutorial/how-trade-policies-work--6Xef8PZiFm40kg2STrMkMV)) ID. (default: 1)
  --f-affiliateId: string # You can filter orders by affiliate ID. (default: WLM)
  ...
  --incompleteOrders: oneof<nothing, bool> # When set as `true`, you retrieve [incomplete orders](https://help.vtex.com/en/tutorial/understanding-incomplete-orders), when set as `false`, you retrieve orders that are not incomplete. (default: true)
  --f-paymentNames: string # You can filter orders by payment type. (default: Visa)
  --f-RnB: string # You can filter orders by rates and benefits (promotions). (default: Free+Shipping)
  --searchField: string # You can search orders by using one of the following criterias:  - SKU ID - `sku_Ids&sku_Ids`  - Gift List ID - `listId&listId`  - Transaction ID (TID) - `tid&tid`  - PCI Connector's Transaction ID (TID) - `pci_tid&pci_tid`  - Payment ID (PID) - `paymentId&paymentId`  - Connector's NSU - `nsu&nsu` (default:  - SKU ID: `25`  - Gift List ID: `11223`  - Transaction ID (TID): `54546300238810034995829230012`  - PCI Connector's Transaction ID (TID): `7032909234899834298423209`  - Payment ID (PID): `2`  - Connector's NSU: `2437281`)
  --f-isInstore: oneof<nothing, bool> # When set as `true`, this parameter filters orders made via [inStore](https://help.vtex.com/en/tracks/what-is-instore--zav76TFEZlAjnyBVL5tRc), and when set as `false`, it filters orders that were not made via inStore. (default: true)
  --Accept: string # HTTP Client Negotiation Accept Header. Indicates the types of responses the client can understand.
  --Content-Type: string # Type of the content being sent.
]: nothing -> any {
  let auth = (build-auth $token ($auth_scheme | default "x-vtex-api-appkey"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "orderBy" $orderBy "scalar") (serialize-qp "page" $page "scalar") (serialize-qp "per_page" $per_page "scalar") (serialize-qp "f_creationDate" $f_creationDate "scalar") (serialize-qp "f_hasInputInvoice" $f_hasInputInvoice "scalar") (serialize-qp "q" $q "scalar") (serialize-qp "utc" $utc "scalar") (serialize-qp "f_shippingEstimate" $f_shippingEstimate "scalar") (serialize-qp "f_invoicedDate" $f_invoicedDate "scalar") (serialize-qp "f_authorizedDate" $f_authorizedDate "scalar") (serialize-qp "f_UtmSource" $f_UtmSource "scalar") (serialize-qp "f_sellerNames" $f_sellerNames "scalar") (serialize-qp "f_callCenterOperatorName" $f_callCenterOperatorName "scalar") (serialize-qp "f_salesChannel" $f_salesChannel "scalar") (serialize-qp "salesChannelId" $salesChannelId "scalar") (serialize-qp "f_affiliateId" $f_affiliateId "scalar") (serialize-qp "f_status" $f_status "scalar") (serialize-qp "incompleteOrders" $incompleteOrders "scalar") (serialize-qp "f_paymentNames" $f_paymentNames "scalar") (serialize-qp "f_RnB" $f_RnB "scalar") (serialize-qp "searchField" $searchField "scalar") (serialize-qp "f_isInstore" $f_isInstore "scalar")] | flatten | str join "&"
...
export def "oms-pvt-orders GetOrder" [
  orderId: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  ...
  let auth = (build-auth $token ($auth_scheme | default "x-vtex-api-appkey"))
  let base = ($base_url | default $BASE_URL)
  let full_url = (build-url $base $"/api/oms/pvt/orders/($orderId)")
  let extra_headers = {"Accept": $Accept, "Content-Type": $Content_Type} | compact
  let auth = ($auth | update headers ($auth.headers | merge $extra_headers))
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
...
export def "oms-pvt-orders-cancel CancelOrder" [
  orderId: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  ...
  let auth = (build-auth $token ($auth_scheme | default "x-vtex-api-appkey"))
  let base = ($base_url | default $BASE_URL)
  let full_url = (build-url $base $"/api/oms/pvt/orders/($orderId)/cancel")
...
export def "oms-pvt-orders-changes RegisterChange" [
  orderId: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  ...
  --Content-Type: string # Type of the content being sent.
  --Accept: string # HTTP Client Negotiation Accept Header. Indicates the types of responses the client can understand.
  discountValue: int # This field can be used to apply a discount to the total value of the order. Value in cents. (format: int32, default: 100)
  incrementValue: int # This field can be used to increment the total value of the order. Value in cents. (format: int32, default: 100)
  --itemsAdded: list # List of items that should be added to the order. — item shape: {id: string, price: int, quantity: int}
  --itemsRemoved: list # List of items that should be removed from the order. — item shape: {id: string, price: int, quantity: int}
  ...
  requestId: string # Request identification of the change. Only the first change made with each `requestId` will be effective on a given order. Use different IDs for different changes to the same order. (default: change-request-0123)
]: any -> record<date: string, orderId: string, receipt: string> {
  let input = $in
  let auth = (build-auth $token ($auth_scheme | default "x-vtex-api-appkey"))
  let base = ($base_url | default $BASE_URL)
  let full_url = (build-url $base $"/api/oms/pvt/orders/($orderId)/changes")
  let body = {discountValue: $discountValue, incrementValue: $incrementValue, itemsAdded: $itemsAdded, itemsRemoved: $itemsRemoved, reason: $reason, requestId: $requestId} | compact
  let body = if ($input | describe | str starts-with "record") { $input | merge deep ($body | default {}) } else { $body }
  let extra_headers = {"Content-Type": $Content_Type, "Accept": $Accept} | compact
  let auth = ($auth | update headers ($auth.headers | merge $extra_headers))
  let accept_val = "application/json"
...
export def "oms-pvt-orders-conversation-message GetConversation" [
  orderId: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  ...
  let full_url = (build-url $base $"/api/oms/pvt/orders/($orderId)/conversation-message" $qp)
  let extra_headers = {"Accept": $Accept, "Content-Type": $Content_Type} | compact
  let auth = ($auth | update headers ($auth.headers | merge $extra_headers))
  let accept_val = "application/json; charset=utf-8"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
...
# operationId: AddLog
export def "oms-pvt-orders-interactions AddLog" [
  orderId: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  ...
  let auth = (build-auth $token ($auth_scheme | default "x-vtex-api-appkey"))
  let base = ($base_url | default $BASE_URL)
  let full_url = (build-url $base $"/api/oms/pvt/orders/($orderId)/interactions")
...
export def "oms-pvt-orders-invoice InvoiceNotification" [
  orderId: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  ...
  --trackingNumber: string # The number code that identifies the order tracking. *This field should only be used when sending the **tracking** information. When the request is used for sending the invoice, this field should be left empty (`""`).* (nullable)
  --trackingUrl: string # The URL used to track the order. *This field should only be used when sending the **tracking** information. When the request is used for sending the invoice, this field should be left empty (`""`).* (nullable)
  ...
  let auth = (build-auth $token ($auth_scheme | default "x-vtex-api-appkey"))
  let base = ($base_url | default $BASE_URL)
  let full_url = (build-url $base $"/api/oms/pvt/orders/($orderId)/invoice")
  let body = {courier: $courier, dispatchedDate: $dispatchedDate, embeddedInvoice: $embeddedInvoice, invoiceKey: $invoiceKey, invoiceNumber: $invoiceNumber, invoiceUrl: $invoiceUrl, invoiceValue: $invoiceValue, issuanceDate: $issuanceDate, items: $items, trackingNumber: $trackingNumber, trackingUrl: $trackingUrl, type: $type} | compact
  let body = if ($input | describe | str starts-with "record") { $input | merge deep ($body | default {}) } else { $body }
  let extra_headers = {"Accept": $Accept, "Content-Type": $Content_Type} | compact
  let auth = ($auth | update headers ($auth.headers | merge $extra_headers))
  let accept_val = "application/json"
...
export def "oms-pvt-orders-invoice UpdatepartialinvoiceSendTrackingNumber" [
  orderId: string
  ...
  --dispatchedDate: string # Date when the package was dispatched. For example, 2023-01-08T13:16:13.4617653+00:00. (nullable)
  trackingNumber: string # The number code that identifies the order tracking.
  --trackingUrl: string # Package tracking URL. (nullable)
]: any -> record<date: string, orderId: string, receipt: string> {
  let input = $in
  let auth = (build-auth $token ($auth_scheme | default "x-vtex-api-appkey"))
  let base = ($base_url | default $BASE_URL)
  let full_url = (build-url $base $"/api/oms/pvt/orders/($orderId)/invoice/($invoiceNumber)")
...
export def "oms-pvt-orders-invoice-tracking UpdateTrackingStatus" [
  orderId: string
  invoiceNumber: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  ...
  --Content-Type: string # Type of the content being sent.
  --Accept: string # HTTP Client Negotiation Accept Header. Indicates the types of responses the client can understand.
  --deliveredDate: string # Date and time of when the package was delivered. Note that it is different from the tracking date parameter. The `deliveredDate` format is `yyyy-mm-dd hh:mm`. (nullable, default: 2022-10-01 21:15)
  ...
  let auth = (build-auth $token ($auth_scheme | default "x-vtex-api-appkey"))
  let base = ($base_url | default $BASE_URL)
  let full_url = (build-url $base $"/api/oms/pvt/orders/($orderId)/invoice/($invoiceNumber)/tracking")
  let body = {deliveredDate: $deliveredDate, events: $events, isDelivered: $isDelivered} | compact
  let body = if ($input | describe | str starts-with "record") { $input | merge deep ($body | default {}) } else { $body }
  let extra_headers = {"Content-Type": $Content_Type, "Accept": $Accept} | compact
  let auth = ($auth | update headers ($auth.headers | merge $extra_headers))
  let accept_val = "application/json; charset=utf-8"
...
export def "oms-pvt-orders-payment-transaction GetPaymenttransaction" [
  orderId: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  ...
  let auth = (build-auth $token ($auth_scheme | default "x-vtex-api-appkey"))
  let base = ($base_url | default $BASE_URL)
  let full_url = (build-url $base $"/api/oms/pvt/orders/($orderId)/payment-transaction")
  let extra_headers = {"Accept": $Accept, "Content-Type": $Content_Type} | compact
  let auth = ($auth | update headers ($auth.headers | merge $extra_headers))
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
...
export def "oms-pvt-orders-payments-payment-notification SendPaymentNotification" [
  orderId: string
  paymentId: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  ...
  let auth = (build-auth $token ($auth_scheme | default "x-vtex-api-appkey"))
  let base = ($base_url | default $BASE_URL)
  let full_url = (build-url $base $"/api/oms/pvt/orders/($orderId)/payments/($paymentId)/payment-notification")
  let extra_headers = {"Accept": $Accept, "Content-Type": $Content_Type} | compact
  let auth = ($auth | update headers ($auth.headers | merge $extra_headers))
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
...
export def "oms-pvt-orders-start-handling StartHandling" [
  orderId: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  ...
  let auth = (build-auth $token ($auth_scheme | default "x-vtex-api-appkey"))
  let base = ($base_url | default $BASE_URL)
  let full_url = (build-url $base $"/api/oms/pvt/orders/($orderId)/start-handling")
  let extra_headers = {"Accept": $Accept, "Content-Type": $Content_Type} | compact
  let auth = ($auth | update headers ($auth.headers | merge $extra_headers))
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
...
export def "oms-user-orders Userorderslist" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
  ...
  --allow-errors(-e) # Return full response without error handling
  --dry-run(-n) # Return the request that would be sent without executing it
  --clientEmail: string # Customer email. (e.g. customer@mail.com)
  ...
  let auth = (build-auth $token ($auth_scheme | default "x-vtex-api-appkey"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "clientEmail" $clientEmail "scalar") (serialize-qp "page" $page "scalar") (serialize-qp "per_page" $per_page "scalar")] | flatten | str join "&"
...
export def "oms-user-orders Userorderdetails" [
  orderId: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  ...
  let auth = (build-auth $token ($auth_scheme | default "x-vtex-api-appkey"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "clientEmail" $clientEmail "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/api/oms/user/orders/($orderId)" $qp)
  let extra_headers = {"Content-Type": $Content_Type, "Accept": $Accept} | compact
  let auth = ($auth | update headers ($auth.headers | merge $extra_headers))
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
...
export def "orders-expressions-jsonata TestJSONataExpression" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
...
export def "orders-feed Getfeedorderstatus1" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
...
export def "orders-feed Commititemfeedorderstatus" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
...
export def "orders-feed-config FeedConfigurationDelete" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
...
export def "orders-feed-config GetFeedConfiguration" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
...
export def "orders-feed-config FeedConfiguration" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
...
export def "orders-hook-config DeleteHookConfiguration" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
...
export def "orders-hook-config GetHookConfiguration" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
...
export def "orders-hook-config HookConfiguration" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
