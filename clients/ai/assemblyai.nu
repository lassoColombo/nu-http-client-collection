...
export def "transcript createTranscript" [
  ...
  --auto-chapters: string@bool-completer # Enable [Auto Chapters](https://www.assemblyai.com/docs/speech-understanding/auto-chapters), can be true or false. Deprecated - use [LLM Gateway](https://www.assemblyai.com/docs/llm-gateway/overview) instead for more flexible chapter summaries. See the [updated Auto Chapters page](https://www.assemblyai.com/docs/speech-understanding/auto-chapters) for details.  Note: This parameter is only supported for the Universal-2 model.  (DEPRECATED, default: false)
  --auto-highlights: string@bool-completer # Enable [Key Phrases](https://www.assemblyai.com/docs/speech-understanding/key-phrases), either true or false (default: false)
  --content-safety: string@bool-completer # Enable [Content Moderation](https://www.assemblyai.com/docs/content-moderation), can be true or false (default: false)
  ...
  --disfluencies: string@bool-completer # Transcribe [Filler Words](https://www.assemblyai.com/docs/pre-recorded-audio/include-filler-words), like "umm", in your media file; can be true or false. Supported on Universal-3 Pro and Universal-2. (default: false)
  ...
  --entity-detection: string@bool-completer # Enable [Entity Detection](https://www.assemblyai.com/docs/speech-understanding/entity-detection), can be true or false (default: false)
  --filter-profanity: string@bool-completer # Filter profanity from the transcribed text, can be true or false. See [Profanity Filtering](https://www.assemblyai.com/docs/profanity-filtering) for more details. (default: false)
  --format-text: string@bool-completer # Enable [Text Formatting](https://www.assemblyai.com/docs/pre-recorded-audio), can be true or false (default: true)
  --iab-categories: string@bool-completer # Enable [Topic Detection](https://www.assemblyai.com/docs/speech-understanding/topic-detection), can be true or false (default: false)
  ...
  --language-detection: string@bool-completer # Enable [Automatic language detection](https://www.assemblyai.com/docs/pre-recorded-audio/language-detection), either true or false. (default: false)
  ...
  --multichannel: string@bool-completer # Enable [Multichannel](https://www.assemblyai.com/docs/pre-recorded-audio/transcribe-multiple-audio-channels) transcription, can be true or false. (default: false)
  ...
  --punctuate: string@bool-completer # Enable [Automatic Punctuation](https://www.assemblyai.com/docs/pre-recorded-audio), can be true or false (default: true)
  --redact-pii: string@bool-completer # Redact PII from the transcribed text using the Redact PII model, can be true or false. See [PII Redaction](https://www.assemblyai.com/docs/pii-redaction) for more details. (default: false)
  --redact-pii-audio: string@bool-completer # Generate a copy of the original media file with spoken PII "beeped" out, can be true or false. See [PII redaction](https://www.assemblyai.com/docs/pii-redaction#request-for-redacted-audio) for more details. (default: false)
  ...
  --custom-topics: string@bool-completer # This parameter does not currently have any functionality attached to it. (DEPRECATED, default: false)
...
export def "transcript listTranscripts" [
  ...
  --throttled-only: string@bool-completer # Only get throttled transcripts, overrides the status filter (DEPRECATED, default: false)
