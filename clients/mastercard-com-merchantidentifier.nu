...
export def commands []: nothing -> table {
  ...
  let mod_name = (scope modules | where { $in.commands | any { $in.name == "merchant-ids GetMerchantIdentifiers" } } | get name | first)
...
export def "merchant-ids GetMerchantIdentifiers" [
