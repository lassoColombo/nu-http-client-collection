...
export def "services-channels update" [
  ...
  let full_url = (build-url $base ({service_sid: (encode-path-segment $service_sid), sid: (encode-path-segment $sid)} | format pattern "/v3/Services/{service_sid}/Channels/{sid}"))
