...
# Source: https://api.apis.guru/v2/specs/twilio.com/twilio_chat_v3/1.42.0/openapi.json
...
export def "services-channels update" [
  ...
  let full_url = (build-url $base ({service_sid: (encode-path-segment $service_sid), sid: (encode-path-segment $sid)} | format pattern "/v3/Services/{service_sid}/Channels/{sid}") $auth.query)
  let req_body = {"MessagingServiceSid": $messaging_service_sid, "Type": $type} | compact
