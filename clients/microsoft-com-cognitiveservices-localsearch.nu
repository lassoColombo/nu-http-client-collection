...
export def commands []: nothing -> table {
  ...
  let mod_name = (scope modules | where { $in.commands | any { $in.name == "v70-localbusinesses-search list" } } | get name | first)
...
export def "v70-localbusinesses-search list" [
  ...
  --response-format: list # The media type to use for the response. The following are the possible case-insensitive values: JSON, JSONLD. The default is JSON. If you specify JSONLD, the response body includes JSON-LD objects that contain the search results.
