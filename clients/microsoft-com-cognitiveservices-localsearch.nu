...
export def "v7-0-localbusinesses-search list-local" [
  ...
  do-request "get" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors $full "application/json" null {query: ({"cc": $cc, "mkt": $mkt, "q": $q, "localcategories": $localcategories, "localcircularview": $localcircularview, "localmapview": $localmapview, "count": $count, "first": $first, "ResponseFormat": $response_format, "SafeSearch": $safe_search, "SetLang": $set_lang} | compact), body: null}
}
