...
export def commands []: nothing -> table {
  ...
  let mod_name = (scope modules | where { $in.commands | any { $in.name == "subscriptions-resource-groups-providers-microsoft-api-management-service-api-version-sets ListByService" } } | get name | first)
...
export def "subscriptions-resource-groups-providers-microsoft-api-management-service-api-version-sets ListByService" [
  ...
  let full_url = (build-url $base $"/subscriptions/($subscriptionId)/resourceGroups/($resourceGroupName)/providers/Microsoft.ApiManagement/service/($serviceName)/api-version-sets" $qp)
...
export def "subscriptions-resource-groups-providers-microsoft-api-management-service-api-version-sets Delete" [
  ...
  let full_url = (build-url $base $"/subscriptions/($subscriptionId)/resourceGroups/($resourceGroupName)/providers/Microsoft.ApiManagement/service/($serviceName)/api-version-sets/($versionSetId)" $qp)
...
export def "subscriptions-resource-groups-providers-microsoft-api-management-service-api-version-sets GetEntityTag" [
  resourceGroupName: string
  serviceName: string
  subscriptionId: string
  versionSetId: string
...
# --properties shape: {displayName: string, versioningScheme: "Segment"|"Query"|"Header", description?: string, versionHeaderName?: string, versionQueryName?: string}
export def "subscriptions-resource-groups-providers-microsoft-api-management-service-api-version-sets CreateOrUpdate" [
  resourceGroupName: string
  serviceName: string
  subscriptionId: string
  versionSetId: string
