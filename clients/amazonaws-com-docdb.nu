...
def build-auth [token?: string, auth_scheme?: string]: nothing -> record {
  let token_val = if ($token | is-not-empty) { $token } else { $env | get -o AMAZON_DOCUMENTDB_WITH_MONGODB_COMPATIBILITY_TOKEN | default "" }
...
export def "api get-create-source-identifier-to-subscription" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"SubscriptionName": $subscription_name, "SourceIdentifier": $source_identifier, "Action": $action, "Version": $version} | compact)
...
export def "api get-apply-pending-maintenance-action" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"ResourceIdentifier": $resource_identifier, "ApplyAction": $apply_action, "OptInType": $opt_in_type, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-copy-db-parameter-group" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"SourceDBClusterParameterGroupIdentifier": $source_db_cluster_parameter_group_identifier, "TargetDBClusterParameterGroupIdentifier": $target_db_cluster_parameter_group_identifier, "TargetDBClusterParameterGroupDescription": $target_db_cluster_parameter_group_description, "Tags": $tags, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-copy-db-snapshot" [
  ...
  --x-amz-signature: string
  --x-amz-signed-headers: string
]: nothing -> record<DBClusterSnapshot: record<AvailabilityZones: record, DBClusterSnapshotIdentifier: record, DBClusterIdentifier: record, SnapshotCreateTime: record, Engine: record, Status: record, Port: record, VpcId: record, ClusterCreateTime: record, MasterUsername: record, EngineVersion: record, SnapshotType: record, PercentProgress: record, StorageEncrypted: record, KmsKeyId: record, DBClusterSnapshotArn: record, SourceDBClusterSnapshotArn: record>> {
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"SourceDBClusterSnapshotIdentifier": $source_db_cluster_snapshot_identifier, "TargetDBClusterSnapshotIdentifier": $target_db_cluster_snapshot_identifier, "KmsKeyId": $kms_key_id, "PreSignedUrl": $pre_signed_url, "CopyTags": $copy_tags, "Tags": $tags, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api create-copy-db-snapshot" [
  ...
  --x-amz-signed-headers: string
  --body: any
]: any -> record<DBClusterSnapshot: record<AvailabilityZones: record, DBClusterSnapshotIdentifier: record, DBClusterIdentifier: record, SnapshotCreateTime: record, Engine: record, Status: record, Port: record, VpcId: record, ClusterCreateTime: record, MasterUsername: record, EngineVersion: record, SnapshotType: record, PercentProgress: record, StorageEncrypted: record, KmsKeyId: record, DBClusterSnapshotArn: record, SourceDBClusterSnapshotArn: record>> {
  let input = $in
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "Action" $action "scalar") (serialize-qp "Version" $version "scalar")] | flatten | str join "&"
...
export def "api get-create-db" [
  ...
  --x-amz-signature: string
  --x-amz-signed-headers: string
]: nothing -> record<DBCluster: record<AvailabilityZones: record, BackupRetentionPeriod: record, DBClusterIdentifier: record, DBClusterParameterGroup: record, DBSubnetGroup: record, Status: record, PercentProgress: record, EarliestRestorableTime: record, Endpoint: record, ReaderEndpoint: record, MultiAZ: record, Engine: record, EngineVersion: record, LatestRestorableTime: record, Port: record, MasterUsername: record, PreferredBackupWindow: record, PreferredMaintenanceWindow: record, ReplicationSourceIdentifier: record, ReadReplicaIdentifiers: record, DBClusterMembers: record, VpcSecurityGroups: record, HostedZoneId: record, StorageEncrypted: record, KmsKeyId: record, DbClusterResourceId: record, DBClusterArn: record, AssociatedRoles: record, CloneGroupId: record, ClusterCreateTime: record, EnabledCloudwatchLogsExports: record, DeletionProtection: record>> {
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
...
export def "api create-db" [
  ...
  --x-amz-signed-headers: string
  --body: any
]: any -> record<DBCluster: record<AvailabilityZones: record, BackupRetentionPeriod: record, DBClusterIdentifier: record, DBClusterParameterGroup: record, DBSubnetGroup: record, Status: record, PercentProgress: record, EarliestRestorableTime: record, Endpoint: record, ReaderEndpoint: record, MultiAZ: record, Engine: record, EngineVersion: record, LatestRestorableTime: record, Port: record, MasterUsername: record, PreferredBackupWindow: record, PreferredMaintenanceWindow: record, ReplicationSourceIdentifier: record, ReadReplicaIdentifiers: record, DBClusterMembers: record, VpcSecurityGroups: record, HostedZoneId: record, StorageEncrypted: record, KmsKeyId: record, DbClusterResourceId: record, DBClusterArn: record, AssociatedRoles: record, CloneGroupId: record, ClusterCreateTime: record, EnabledCloudwatchLogsExports: record, DeletionProtection: record>> {
  let input = $in
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "Action" $action "scalar") (serialize-qp "Version" $version "scalar")] | flatten | str join "&"
...
export def "api get-create-db-parameter-group" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"DBClusterParameterGroupName": $db_cluster_parameter_group_name, "DBParameterGroupFamily": $db_parameter_group_family, "Description": $description, "Tags": $tags, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-create-db-snapshot" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"DBClusterSnapshotIdentifier": $db_cluster_snapshot_identifier, "DBClusterIdentifier": $db_cluster_identifier, "Tags": $tags, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-create-db-instance" [
  ...
  --x-amz-signature: string
  --x-amz-signed-headers: string
]: nothing -> record<DBInstance: record<DBInstanceIdentifier: record, DBInstanceClass: record, Engine: record, DBInstanceStatus: record, Endpoint: record<Address: record, Port: record, HostedZoneId: record>, InstanceCreateTime: record, PreferredBackupWindow: record, BackupRetentionPeriod: record, VpcSecurityGroups: record, AvailabilityZone: record, DBSubnetGroup: record<DBSubnetGroupName: record, DBSubnetGroupDescription: record, VpcId: record, SubnetGroupStatus: record, Subnets: record, DBSubnetGroupArn: record>, PreferredMaintenanceWindow: record, PendingModifiedValues: record<DBInstanceClass: record, AllocatedStorage: record, MasterUserPassword: record, Port: record, BackupRetentionPeriod: record, MultiAZ: record, EngineVersion: record, LicenseModel: record, Iops: record, DBInstanceIdentifier: record, StorageType: record, CACertificateIdentifier: record, DBSubnetGroupName: record, PendingCloudwatchLogsExports: record>, LatestRestorableTime: record, EngineVersion: record, AutoMinorVersionUpgrade: record, PubliclyAccessible: record, StatusInfos: record, DBClusterIdentifier: record, StorageEncrypted: record, KmsKeyId: record, DbiResourceId: record, CACertificateIdentifier: record, CopyTagsToSnapshot: record, PromotionTier: record, DBInstanceArn: record, EnabledCloudwatchLogsExports: record>> {
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
...
export def "api get-create-db-subnet-group" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"DBSubnetGroupName": $db_subnet_group_name, "DBSubnetGroupDescription": $db_subnet_group_description, "SubnetIds": $subnet_ids, "Tags": $tags, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-create-event-subscription" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"SubscriptionName": $subscription_name, "SnsTopicArn": $sns_topic_arn, "SourceType": $source_type, "EventCategories": $event_categories, "SourceIds": $source_ids, "Enabled": $enabled, "Tags": $tags, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-create-global" [
  ...
  --x-amz-signature: string
  --x-amz-signed-headers: string
]: nothing -> record<GlobalCluster: record<GlobalClusterIdentifier: record, GlobalClusterResourceId: record, GlobalClusterArn: record, Status: record, Engine: record, EngineVersion: record, DatabaseName: record, StorageEncrypted: record, DeletionProtection: record, GlobalClusterMembers: record>> {
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"GlobalClusterIdentifier": $global_cluster_identifier, "SourceDBClusterIdentifier": $source_db_cluster_identifier, "Engine": $engine, "EngineVersion": $engine_version, "DeletionProtection": $deletion_protection, "DatabaseName": $database_name, "StorageEncrypted": $storage_encrypted, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api create-global" [
  ...
  --x-amz-signed-headers: string
  --body: any
]: any -> record<GlobalCluster: record<GlobalClusterIdentifier: record, GlobalClusterResourceId: record, GlobalClusterArn: record, Status: record, Engine: record, EngineVersion: record, DatabaseName: record, StorageEncrypted: record, DeletionProtection: record, GlobalClusterMembers: record>> {
  let input = $in
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "Action" $action "scalar") (serialize-qp "Version" $version "scalar")] | flatten | str join "&"
...
export def "api get-delete-db" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"DBClusterIdentifier": $db_cluster_identifier, "SkipFinalSnapshot": $skip_final_snapshot, "FinalDBSnapshotIdentifier": $final_db_snapshot_identifier, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-delete-db-parameter-group" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"DBClusterParameterGroupName": $db_cluster_parameter_group_name, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-delete-db-snapshot" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"DBClusterSnapshotIdentifier": $db_cluster_snapshot_identifier, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-delete-db-instance" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"DBInstanceIdentifier": $db_instance_identifier, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-delete-db-subnet-group" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"DBSubnetGroupName": $db_subnet_group_name, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-delete-global" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"GlobalClusterIdentifier": $global_cluster_identifier, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-certificates" [
  ...
  --x-amz-signature: string
  --x-amz-signed-headers: string
]: nothing -> record<Certificates: record, Marker: record> {
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"CertificateIdentifier": $certificate_identifier, "Filters": $filters, "MaxRecords": $max_records, "Marker": $marker, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api create-get-certificates" [
  ...
  --x-amz-signed-headers: string
  --body: any
]: any -> record<Certificates: record, Marker: record> {
  let input = $in
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
...
export def "api get-db-parameter-groups" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"DBClusterParameterGroupName": $db_cluster_parameter_group_name, "Filters": $filters, "MaxRecords": $max_records, "Marker": $marker, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-db-parameters" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"DBClusterParameterGroupName": $db_cluster_parameter_group_name, "Source": $qp_source, "Filters": $filters, "MaxRecords": $max_records, "Marker": $marker, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-db-snapshots" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"DBClusterIdentifier": $db_cluster_identifier, "DBClusterSnapshotIdentifier": $db_cluster_snapshot_identifier, "SnapshotType": $snapshot_type, "Filters": $filters, "MaxRecords": $max_records, "Marker": $marker, "IncludeShared": $include_shared, "IncludePublic": $include_public, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-db-clusters" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"DBClusterIdentifier": $db_cluster_identifier, "Filters": $filters, "MaxRecords": $max_records, "Marker": $marker, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-db-instances" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"DBInstanceIdentifier": $db_instance_identifier, "Filters": $filters, "MaxRecords": $max_records, "Marker": $marker, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-db-subnet-groups" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"DBSubnetGroupName": $db_subnet_group_name, "Filters": $filters, "MaxRecords": $max_records, "Marker": $marker, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-engine-default-parameters" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"DBParameterGroupFamily": $db_parameter_group_family, "Filters": $filters, "MaxRecords": $max_records, "Marker": $marker, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-event-categories" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"SourceType": $source_type, "Filters": $filters, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-event-subscriptions" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"SubscriptionName": $subscription_name, "Filters": $filters, "MaxRecords": $max_records, "Marker": $marker, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-events" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"SourceIdentifier": $source_identifier, "SourceType": $source_type, "StartTime": $start_time, "EndTime": $end_time, "Duration": $duration, "EventCategories": $event_categories, "Filters": $filters, "MaxRecords": $max_records, "Marker": $marker, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-global-clusters" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"GlobalClusterIdentifier": $global_cluster_identifier, "Filters": $filters, "MaxRecords": $max_records, "Marker": $marker, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-orderable-db-instance-options" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"Engine": $engine, "EngineVersion": $engine_version, "DBInstanceClass": $db_instance_class, "LicenseModel": $license_model, "Vpc": $vpc, "Filters": $filters, "MaxRecords": $max_records, "Marker": $marker, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-pending-maintenance-actions" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"ResourceIdentifier": $resource_identifier, "Filters": $filters, "Marker": $marker, "MaxRecords": $max_records, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-failover-db" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"DBClusterIdentifier": $db_cluster_identifier, "TargetDBInstanceIdentifier": $target_db_instance_identifier, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-list-tags-for-resource" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"ResourceName": $resource_name, "Filters": $filters, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-modify-db" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"DBClusterIdentifier": $db_cluster_identifier, "NewDBClusterIdentifier": $new_db_cluster_identifier, "ApplyImmediately": $apply_immediately, "BackupRetentionPeriod": $backup_retention_period, "DBClusterParameterGroupName": $db_cluster_parameter_group_name, "VpcSecurityGroupIds": $vpc_security_group_ids, "Port": $port, "MasterUserPassword": $master_user_password, "PreferredBackupWindow": $preferred_backup_window, "PreferredMaintenanceWindow": $preferred_maintenance_window, "CloudwatchLogsExportConfiguration": $cloudwatch_logs_export_configuration, "EngineVersion": $engine_version, "DeletionProtection": $deletion_protection, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-modify-db-parameter-group" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"DBClusterParameterGroupName": $db_cluster_parameter_group_name, "Parameters": $parameters, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-modify-db-snapshot-attribute" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"DBClusterSnapshotIdentifier": $db_cluster_snapshot_identifier, "AttributeName": $attribute_name, "ValuesToAdd": $values_to_add, "ValuesToRemove": $values_to_remove, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-modify-db-subnet-group" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"DBSubnetGroupName": $db_subnet_group_name, "DBSubnetGroupDescription": $db_subnet_group_description, "SubnetIds": $subnet_ids, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-modify-event-subscription" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"SubscriptionName": $subscription_name, "SnsTopicArn": $sns_topic_arn, "SourceType": $source_type, "EventCategories": $event_categories, "Enabled": $enabled, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-modify-global" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"GlobalClusterIdentifier": $global_cluster_identifier, "NewGlobalClusterIdentifier": $new_global_cluster_identifier, "DeletionProtection": $deletion_protection, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-reboot-db-instance" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"DBInstanceIdentifier": $db_instance_identifier, "ForceFailover": $force_failover, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-delete-from-global" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"GlobalClusterIdentifier": $global_cluster_identifier, "DbClusterIdentifier": $db_cluster_identifier, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-reset-db-parameter-group" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"DBClusterParameterGroupName": $db_cluster_parameter_group_name, "ResetAllParameters": $reset_all_parameters, "Parameters": $parameters, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-restore-db-to-point-in-time" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"DBClusterIdentifier": $db_cluster_identifier, "RestoreType": $restore_type, "SourceDBClusterIdentifier": $source_db_cluster_identifier, "RestoreToTime": $restore_to_time, "UseLatestRestorableTime": $use_latest_restorable_time, "Port": $port, "DBSubnetGroupName": $db_subnet_group_name, "VpcSecurityGroupIds": $vpc_security_group_ids, "Tags": $tags, "KmsKeyId": $kms_key_id, "EnableCloudwatchLogsExports": $enable_cloudwatch_logs_exports, "DeletionProtection": $deletion_protection, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-start-db" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"DBClusterIdentifier": $db_cluster_identifier, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
