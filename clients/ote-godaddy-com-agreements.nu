...
# Source: https://api.apis.guru/v2/specs/ote-godaddy.com/agreements/1.0.0/openapi.json
...
export def commands []: nothing -> table {
  ...
  let mod_name = (scope modules | where { $in.commands | any { $in.name == "agreements get" } } | get name | first)
