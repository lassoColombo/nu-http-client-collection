...
def base-url-completer [] { ["https://countries.trevorblades.com/graphql"] }
...
# --filter-code shape: {eq?: string, in?: string, ne?: string, nin?: string, regex?: string}
# --filter-continent shape: {eq?: string, in?: string, ne?: string, nin?: string, regex?: string}
# --filter-currency shape: {eq?: string, in?: string, ne?: string, nin?: string, regex?: string}
# --filter-name shape: {eq?: string, in?: string, ne?: string, nin?: string, regex?: string}
export def "query countries" [
  ...
  --query: string # Raw GraphQL query (overrides auto-generated)
  --filter-code: record # shape: {eq?: string, in?: string, ne?: string, nin?: string, regex?: string}
  --filter-continent: record # shape: {eq?: string, in?: string, ne?: string, nin?: string, regex?: string}
  --filter-currency: record # shape: {eq?: string, in?: string, ne?: string, nin?: string, regex?: string}
  --filter-name: record # shape: {eq?: string, in?: string, ne?: string, nin?: string, regex?: string}
]: any -> list {
  let input = $in
  let auth = (build-auth $token ($auth_scheme | default $DEFAULT_AUTH))
  let base = ($base_url | default $BASE_URL)
