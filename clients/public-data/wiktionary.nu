...
# Source: https://en.wiktionary.org/api/rest_v1/?spec
...
def accept-completer-2 [] { ["application/json; charset=utf-8; profile="https://www.mediawiki.org/wiki/Specs/Media/1.3.1"" "application/problem+json"] }
def accept-completer-3 [] { ["application/problem+json" "text/html; charset=utf-8; profile="https://www.mediawiki.org/wiki/Specs/Mobile-HTML/1.2.2""] }
def accept-completer-4 [] { ["application/json; charset=utf-8; profile="https://www.mediawiki.org/wiki/Specs/Mobile-HTML-Offline-Resources/1.2.1"" "application/problem+json"] }
def accept-completer-5 [] { ["application/json; charset=utf-8; profile="https://www.mediawiki.org/wiki/Specs/definition/0.8.0"" "application/problem+json"] }
def accept-completer-6 [] { ["application/problem+json" "text/plain; charset=utf-8; profile="https://www.mediawiki.org/wiki/Specs/wikitext/1.0.0""] }
def accept-completer-7 [] { ["application/problem+json" "text/html; charset=utf-8; profile="https://www.mediawiki.org/wiki/Specs/HTML/2.1.0""] }
def output-mode-completer [] { ["content" "contentAndReferences" "editPreview" "references"] }
def accept-completer-8 [] { ["application/problem+json" "text/html; charset=utf-8; profile="https://www.mediawiki.org/wiki/Specs/Mobile-HTML/1.0.0""] }
def accept-completer-9 [] { ["application/mathml+xml" "application/problem+json" "image/svg+xml"] }
def accept-completer-10 [] { ["application/json; charset=utf-8;" "application/x-bibtex; charset=utf-8"] }
def accept-completer-11 [] { ["application/json; charset=utf-8" "application/problem+json"] }
def sort-completer [] { ["name" "updated"] }
def accept-completer-12 [] { ["application/json; charset=utf-8; profile="https://www.mediawiki.org/wiki/Specs/Lists/0.1"" "application/problem+json"] }
def accept-completer-13 [] { ["application/json; charset=utf-8; profile="https://www.mediawiki.org/wiki/Specs/CSS/1.0.0"" "application/problem+json"] }
def accept-completer-14 [] { ["application/json; charset=utf-8; profile="https://www.mediawiki.org/wiki/Specs/JavaScript/1.0.0"" "application/problem+json"] }
def accept-completer-15 [] { ["application/json; charset=utf-8; profile="https://www.mediawiki.org/wiki/Specs/i18n/0.0.1"" "application/problem+json"] }
...
# Get term definitions based on Wiktionary content.
#
# GET /page/definition/{term}
export def "page-definition get" [
  term: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  ...
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "redirect" $redirect "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/page/definition/($term)" $qp)
  let accept_val = ($accept | default "application/json; charset=utf-8; profile="https://www.mediawiki.org/wiki/Specs/definition/0.8.0"")
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "get" $full_url $auth $insecure $raw $max_time $allow_errors "application/json"
}
