...
export def "audit-case get" [
  ...
  --qq: list # Name of candidate running for office
...
export def "calendar-dates get" [
  ...
  --summary: list # Longer description of event
...
export def "candidate-filings get" [
  ...
  --form-type: list # The form where the underlying data comes from, for example, Form 1 would appear as F1:     - F1   Statement of Organization     - F1M  Notification of Multicandidate Status     - F2   Statement of Candidacy     - F3   Report of Receipts and Disbursements for an Authorized Committee     - F3P  Report of Receipts and Disbursements by an Authorized Committee of a Candidate for     The Office of President or Vice President     - F3L  Report of Contributions Bundled by Lobbyists/Registrants and Lobbyist/Registrant PACs     - F3X  Report of Receipts and Disbursements for other than an Authorized Committee     - F4   Report of Receipts and Disbursements for a Committee or Organization Supporting a Nomination Convention     - F5   Report of Independent Expenditures Made and Contributions Received     - F6   48 Hour Notice of Contributions/Loans Received     - F7   Report of Communication Costs by Corporations and Membership Organizations     - F8   Debt Settlement Plan     - F9   24 Hour Notice of Disbursements for Electioneering Communications     - F13  Report of Donations Accepted for Inaugural Committee     - F99  Miscellaneous Text     - FRQ  Request for Additional Information
  --committee-type: string # The one-letter type code of the organization:         - C communication cost         - D delegate         - E electioneering communication         - H House         - I independent expenditure filer (not a committee)         - N PAC - nonqualified         - O independent expenditure-only (super PACs)         - P presidential         - Q PAC - qualified         - S Senate         - U single candidate independent expenditure         - V PAC with non-contribution account, nonqualified         - W PAC with non-contribution account, qualified         - X party, nonqualified         - Y party, qualified         - Z national party non-federal account
  --beginning-image-number: list #  Unique identifier for the electronic or paper report. This number is used to construct PDF URLs to the original document.
  --page: int # For paginating through results, starting at page 1 (format: int32, default: 1)
...
export def "election-dates get" [
  ...
  --election-party: list #  Party, if applicable.
  --election-type-id: list #  Election type id
  --page: int # For paginating through results, starting at page 1 (format: int32, default: 1)
...
export def "legal-search get" [
  ...
  --case-statutory-citation: list #  Statutory citations
  ...
  --api-key: string #  API key for https://api.data.gov. Get one at https://api.data.gov/signup.  (default: DEMO_KEY)
  --af-name: list #  Admin fine committee name
  --ao-requestor-type: list #  Code of the advisory opinion requestor type.
  --ao-statutory-citation: list #  Statutory citations
  --ao-entity-name: list #  Name of commenter or representative
  ...
  --case-no: list #  Enforcement matter case number
...
export def "operations-log get" [
  ...
  --report-type: list # Name of report where the underlying data comes from:     - 10D Pre-Election     - 10G Pre-General     - 10P Pre-Primary     - 10R Pre-Run-Off     - 10S Pre-Special     - 12C Pre-Convention     - 12G Pre-General     - 12P Pre-Primary     - 12R Pre-Run-Off     - 12S Pre-Special     - 30D Post-Election     - 30G Post-General     - 30P Post-Primary     - 30R Post-Run-Off     - 30S Post-Special     - 60D Post-Convention     - M1  January Monthly     - M10 October Monthly     - M11 November Monthly     - M12 December Monthly     - M2  February Monthly     - M3  March Monthly     - M4  April Monthly     - M5  May Monthly     - M6  June Monthly     - M7  July Monthly     - M8  August Monthly     - M9  September Monthly     - MY  Mid-Year Report     - Q1  April Quarterly     - Q2  July Quarterly     - Q3  October Quarterly     - TER Termination Report     - YE  Year-End     - ADJ COMP ADJUST AMEND     - CA  COMPREHENSIVE AMEND     - 90S Post Inaugural Supplement     - 90D Post Inaugural     - 48  48 Hour Notification     - 24  24 Hour Notification     - M7S July Monthly/Semi-Annual     - MSA Monthly Semi-Annual (MY)     - MYS Monthly Year End/Semi-Annual     - Q2S July Quarterly/Semi-Annual     - QSA Quarterly Semi-Annual (MY)     - QYS Quarterly Year End/Semi-Annual     - QYE Quarterly Semi-Annual (YE)     - QMS Quarterly Mid-Year/ Semi-Annual     - MSY Monthly Semi-Annual (YE)
  --report-year: list #  Forms with coverage date -      year from the coverage ending date. Forms without coverage date -      year from the receipt date.
  --status-num: list #  Status of the transactional report.     -0- Transaction is entered            into the system.           But not verified.     -1- Transaction is verified.
...
export def "schedules-schedule-a list" [
  ...
  --recipient-committee-type: list # The one-letter type code of the organization:         - C communication cost         - D delegate         - E electioneering communication         - H House         - I independent expenditure filer (not a committee)         - N PAC - nonqualified         - O independent expenditure-only (super PACs)         - P presidential         - Q PAC - qualified         - S Senate         - U single candidate independent expenditure         - V PAC with non-contribution account, nonqualified         - W PAC with non-contribution account, qualified         - X party, nonqualified         - Y party, qualified         - Z national party non-federal account
  --per-page: int # The number of results returned per page. Defaults to 20. (format: int32, default: 20)
  --contributor-zip: list # Zip code of contributor
  ...
  --contributor-id: list # The FEC identifier should be represented here if the contributor is registered with the FEC.
  --recipient-committee-org-type: list # The one-letter code for the kind for organization:         - C corporation         - L labor organization         - M membership organization         - T trade association         - V cooperative         - W corporation without capital stock
  --contributor-state: list # State of contributor
  --qp-sort: string # Provide a field to sort by. Use `-` for descending order.  (default: -contribution_receipt_date)
  --two-year-transaction-period: list #  This is a two-year period that is derived from the year a transaction took place in the Itemized Schedule A and Schedule B tables. In cases where we have the date of the transaction (contribution_receipt_date in schedules/schedule_a, disbursement_date in schedules/schedule_b) the two_year_transaction_period is named after the ending, even-numbered year. If we do not have the date  of the transaction, we fall back to using the report year (report_year in both tables) instead,  making the same cycle adjustment as necessary. If no transaction year is specified, the results default to the most current cycle.
  --min-date: string # Minimum date (format: date)
  --committee-id: list #  A unique identifier assigned to each committee or filer registered with the FEC. In general committee id's begin with the letter C which is followed by eight digits.
  --contributor-employer: list # Employer of contributor, filers need to make an effort to gather this information
...
export def "schedules-schedule-b list" [
  ...
  --per-page: int # The number of results returned per page. Defaults to 20. (format: int32, default: 20)
  --last-index: int # Index of last result from previous page (format: int32)
  --spender-committee-type: list # The one-letter type code of the organization:         - C communication cost         - D delegate         - E electioneering communication         - H House         - I independent expenditure filer (not a committee)         - N PAC - nonqualified         - O independent expenditure-only (super PACs)         - P presidential         - Q PAC - qualified         - S Senate         - U single candidate independent expenditure         - V PAC with non-contribution account, nonqualified         - W PAC with non-contribution account, qualified         - X party, nonqualified         - Y party, qualified         - Z national party non-federal account
  --qp-sort: string # Provide a field to sort by. Use `-` for descending order.  (default: -disbursement_date)
  --two-year-transaction-period: list #  This is a two-year period that is derived from the year a transaction took place in the Itemized Schedule A and Schedule B tables. In cases where we have the date of the transaction (contribution_receipt_date in schedules/schedule_a, disbursement_date in schedules/schedule_b) the two_year_transaction_period is named after the ending, even-numbered year. If we do not have the date  of the transaction, we fall back to using the report year (report_year in both tables) instead,  making the same cycle adjustment as necessary. If no transaction year is specified, the results default to the most current cycle.
  --min-date: string # Minimum date (format: date)
  --committee-id: list #  A unique identifier assigned to each committee or filer registered with the FEC. In general committee id's begin with the letter C which is followed by eight digits.
  --api-key: string #  API key for https://api.data.gov. Get one at https://api.data.gov/signup.  (default: DEMO_KEY)
  --disbursement-purpose-category: list # Disbursement purpose category
...
export def "schedules-schedule-c list" [
  ...
  --per-page: int # The number of results returned per page. Defaults to 20. (format: int32, default: 20)
  --last-index: int # Index of last result from previous page (format: int32)
  --loan-source-name: list # Source of the loan (i.e., bank loan, brokerage account, credit card, home equity line of credit,               other line of credit, or personal funds of the candidate
  --page: int # For paginating through results, starting at page 1 (format: int32, default: 1)
...
export def "schedules-schedule-e get" [
  ...
  --min-date: string # Minimum date (format: date)
  --candidate-party: list # Three-letter code for the party affiliated with a candidate or committee. For example, DEM for Democratic Party and REP for Republican Party.
  --committee-id: list #  A unique identifier assigned to each committee or filer registered with the FEC. In general committee id's begin with the letter C which is followed by eight digits.
  --min-image-number: string # Minium image number of the page where the schedule item is reported
...
export def "schedules-schedule-e-efile get" [
  ...
  --candidate-id: list #  A unique identifier assigned to each candidate registered with the FEC. If a person runs for several offices, that person will have separate candidate IDs for each office.
  --candidate-office-state: list # US state or territory where a candidate runs for office
...
export def "totals get" [
  ...
  --committee-state: list # US state or territory
  --committee-type: list # The one-letter type code of the organization:         - C communication cost         - D delegate         - E electioneering communication         - H House         - I independent expenditure filer (not a committee)         - N PAC - nonqualified         - O independent expenditure-only (super PACs)         - P presidential         - Q PAC - qualified         - S Senate         - U single candidate independent expenditure         - V PAC with non-contribution account, nonqualified         - W PAC with non-contribution account, qualified         - X party, nonqualified         - Y party, qualified         - Z national party non-federal account
  --page: int # For paginating through results, starting at page 1 (format: int32, default: 1)
