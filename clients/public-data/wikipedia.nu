...
def accept-completer-2 [] { ["application/json; charset=utf-8; profile="https://www.mediawiki.org/wiki/Specs/Summary/1.4.2"" "application/problem+json"] }
def accept-completer-3 [] { ["application/json; charset=utf-8; profile="https://www.mediawiki.org/wiki/Specs/Media/1.3.1"" "application/problem+json"] }
def accept-completer-4 [] { ["application/problem+json" "text/html; charset=utf-8; profile="https://www.mediawiki.org/wiki/Specs/Mobile-HTML/1.2.2""] }
def accept-completer-5 [] { ["application/json; charset=utf-8; profile="https://www.mediawiki.org/wiki/Specs/Mobile-HTML-Offline-Resources/1.2.1"" "application/problem+json"] }
def accept-completer-6 [] { ["application/json; charset=utf-8; profile="https://www.mediawiki.org/wiki/Specs/Talk/0.1.0"" "application/problem+json"] }
def accept-completer-7 [] { ["application/problem+json" "text/plain; charset=utf-8; profile="https://www.mediawiki.org/wiki/Specs/wikitext/1.0.0""] }
def accept-completer-8 [] { ["application/problem+json" "text/html; charset=utf-8; profile="https://www.mediawiki.org/wiki/Specs/HTML/2.1.0""] }
def output-mode-completer [] { ["content" "contentAndReferences" "editPreview" "references"] }
def accept-completer-9 [] { ["application/problem+json" "text/html; charset=utf-8; profile="https://www.mediawiki.org/wiki/Specs/Mobile-HTML/1.0.0""] }
def accept-completer-10 [] { ["application/mathml+xml" "application/problem+json" "image/svg+xml"] }
def accept-completer-11 [] { ["application/json; charset=utf-8;" "application/x-bibtex; charset=utf-8"] }
def accept-completer-12 [] { ["application/json; charset=utf-8" "application/problem+json"] }
def sort-completer [] { ["name" "updated"] }
def accept-completer-13 [] { ["application/json; charset=utf-8; profile="https://www.mediawiki.org/wiki/Specs/Lists/0.1"" "application/problem+json"] }
def accept-completer-14 [] { ["application/json; charset=utf-8; profile="https://www.mediawiki.org/wiki/Specs/CSS/1.0.0"" "application/problem+json"] }
def accept-completer-15 [] { ["application/json; charset=utf-8; profile="https://www.mediawiki.org/wiki/Specs/JavaScript/1.0.0"" "application/problem+json"] }
def accept-completer-16 [] { ["application/json; charset=utf-8; profile="https://www.mediawiki.org/wiki/Specs/i18n/0.0.1"" "application/problem+json"] }
...
export def "page-summary get" [
  ...
  let full_url = (build-url $base $"/page/summary/($title)" $qp)
  let extra_headers = {"Accept-Language": $Accept_Language} | compact
  let auth = ($auth | update headers ($auth.headers | merge $extra_headers))
...
export def "page-media-list list" [
  title: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
...
export def "page-media-list get" [
  title: string
  revision: int
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
...
export def "page-mobile-html list" [
  title: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
...
export def "page-mobile-html get" [
  title: string
  revision: int
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
...
#
# GET /page/mobile-html-offline-resources/{title}
export def "page-mobile-html-offline-resources list" [
  title: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
...
export def "page-mobile-html-offline-resources get" [
  title: string
  revision: int
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
...
export def "transform-wikitext-to-mobile-html transformWikitextToMobileHtml" [
  title: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let full_url = (build-url $base $"/transform/wikitext/to/mobile-html/($title)")
  let body = {wikitext: $wikitext} | compact
  let body = if ($input | describe | str starts-with "record") { $input | merge deep ($body | default {}) } else { $body }
  let extra_headers = {"Accept-Language": $Accept_Language, "output-mode": $output_mode} | compact
  let auth = ($auth | update headers ($auth.headers | merge $extra_headers))
...
export def "data-citation get" [
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let full_url = (build-url $base $"/data/citation/($format)/($query)")
  let extra_headers = {"Accept-Language": $Accept_Language} | compact
  let auth = ($auth | update headers ($auth.headers | merge $extra_headers))
...
#
# GET /data/recommendation/article/creation/translation/{from_lang}
export def "data-recommendation-article-creation-translation list" [
  from_lang: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
...
# Recommend articles for translation.
#
# GET /data/recommendation/article/creation/translation/{from_lang}/{seed_article}
export def "data-recommendation-article-creation-translation get" [
  from_lang: string
  seed_article: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
...
#
# GET /data/recommendation/article/creation/morelike/{seed_article}
export def "data-recommendation-article-creation-morelike get" [
  seed_article: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
...
export def "data-css-mobile get" [
  type: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
...
#
# GET /data/javascript/mobile/{type}
export def "data-javascript-mobile get" [
  type: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
