# Auto-generated client for windowsesu v2019-09-16-preview
# Source: https://api.apis.guru/v2/specs/azure.com/windowsesu/2019-09-16-preview/swagger.json
# Auth: --token flag or $env.WINDOWSESU_TOKEN
...
def build-auth [token?: string, auth_scheme?: string]: nothing -> record {
  let token_val = if ($token | is-not-empty) { $token } else { $env | get -o WINDOWSESU_TOKEN | default "" }
...
export def "providers-microsoft-windows-esu-operations list" [
  ...
  let full_url = (build-url $base "/providers/Microsoft.WindowsESU/operations" $qp $auth.query)
...
export def "subscriptions-providers-microsoft-windows-esu-multiple-activation-keys list" [
  ...
  let qp = [(serialize-qp "api-version" $api_version "scalar")] | flatten | str join "&"
  let full_url = (build-url $base ({subscription_id: (encode-path-segment $subscription_id)} | format pattern "/subscriptions/{subscription_id}/providers/Microsoft.WindowsESU/multipleActivationKeys") $qp $auth.query)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "get"
...
export def "subscriptions-resource-groups-providers-microsoft-windows-esu-multiple-activation-keys list" [
  ...
  let qp = [(serialize-qp "api-version" $api_version "scalar")] | flatten | str join "&"
  let full_url = (build-url $base ({subscription_id: (encode-path-segment $subscription_id), resource_group_name: (encode-path-segment $resource_group_name)} | format pattern "/subscriptions/{subscription_id}/resourceGroups/{resource_group_name}/providers/Microsoft.WindowsESU/multipleActivationKeys") $qp $auth.query)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "get"
...
export def "subscriptions-resource-groups-providers-microsoft-windows-esu-multiple-activation-keys delete" [
  ...
  if ($subscription_id | is-empty) { error make --unspanned { msg: "path parameter 'subscriptionId' must be non-empty" } }
  if ($resource_group_name | is-empty) { error make --unspanned { msg: "path parameter 'resourceGroupName' must be non-empty" } }
  if ($multiple_activation_key_name | is-empty) { error make --unspanned { msg: "path parameter 'multipleActivationKeyName' must be non-empty" } }
  let qp = [(serialize-qp "api-version" $api_version "scalar")] | flatten | str join "&"
  let full_url = (build-url $base ({subscription_id: (encode-path-segment $subscription_id), resource_group_name: (encode-path-segment $resource_group_name), multiple_activation_key_name: (encode-path-segment $multiple_activation_key_name)} | format pattern "/subscriptions/{subscription_id}/resourceGroups/{resource_group_name}/providers/Microsoft.WindowsESU/multipleActivationKeys/{multiple_activation_key_name}") $qp $auth.query)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "delete"
...
export def "subscriptions-resource-groups-providers-microsoft-windows-esu-multiple-activation-keys get" [
  ...
  --dry-run(-n) # Return the request that would be sent without executing it
  --api-version: string # The API version to use for this operation.
]: nothing -> record<properties: record<agreementNumber: string, expirationDate: string, installedServerNumber: int, isEligible: bool, multipleActivationKey: string, osType: string, provisioningState: string, supportType: string>> {
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  if ($subscription_id | is-empty) { error make --unspanned { msg: "path parameter 'subscriptionId' must be non-empty" } }
  if ($resource_group_name | is-empty) { error make --unspanned { msg: "path parameter 'resourceGroupName' must be non-empty" } }
...
]: any -> record<properties: record<agreementNumber: string, expirationDate: string, installedServerNumber: int, isEligible: bool, multipleActivationKey: string, osType: string, provisioningState: string, supportType: string>> {
  let input = $in
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  if ($subscription_id | is-empty) { error make --unspanned { msg: "path parameter 'subscriptionId' must be non-empty" } }
...
export def "subscriptions-resource-groups-providers-microsoft-windows-esu-multiple-activation-keys create" [
  ...
  --dry-run(-n) # Return the request that would be sent without executing it
  --api-version: string # The API version to use for this operation.
  --properties: record # MAK key specific properties. — shape: {agreementNumber?: string, installedServerNumber?: int, isEligible?: bool, osType?: "Windows7"|"WindowsServer2008"|"WindowsServer2008R2", supportType?: "SupplementalServicing"|"PremiumAssurance"}
