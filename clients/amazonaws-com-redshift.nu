...
def build-auth [token?: string, auth_scheme?: string]: nothing -> record {
  let token_val = if ($token | is-not-empty) { $token } else { $env | get -o AMAZON_REDSHIFT_TOKEN | default "" }
...
export def "api get-accept-reserved-node-exchange" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"ReservedNodeId": $reserved_node_id, "TargetReservedNodeOfferingId": $target_reserved_node_offering_id, "Action": $action, "Version": $version} | compact)
...
export def "api get-create-partner" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"AccountId": $account_id, "ClusterIdentifier": $cluster_identifier, "DatabaseName": $database_name, "PartnerName": $partner_name, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-associate-data-share-consumer" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"DataShareArn": $data_share_arn, "AssociateEntireAccount": $associate_entire_account, "ConsumerArn": $consumer_arn, "ConsumerRegion": $consumer_region, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-authorize-security-group-ingress" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"ClusterSecurityGroupName": $cluster_security_group_name, "CIDRIP": $cidrip, "EC2SecurityGroupName": $ec2_security_group_name, "EC2SecurityGroupOwnerId": $ec2_security_group_owner_id, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-authorize-data-share" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"DataShareArn": $data_share_arn, "ConsumerIdentifier": $consumer_identifier, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-authorize-endpoint-access" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"ClusterIdentifier": $cluster_identifier, "Account": $account, "VpcIds": $vpc_ids, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-authorize-snapshot-access" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"SnapshotIdentifier": $snapshot_identifier, "SnapshotArn": $snapshot_arn, "SnapshotClusterIdentifier": $snapshot_cluster_identifier, "AccountWithRestoreAccess": $account_with_restore_access, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-batch-delete-snapshots" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"Identifiers": $identifiers, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-batch-modify-snapshots" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"SnapshotIdentifierList": $snapshot_identifier_list, "ManualSnapshotRetentionPeriod": $manual_snapshot_retention_period, "Force": $force, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-cancel-resize" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"ClusterIdentifier": $cluster_identifier, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-copy-snapshot" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"SourceSnapshotIdentifier": $source_snapshot_identifier, "SourceSnapshotClusterIdentifier": $source_snapshot_cluster_identifier, "TargetSnapshotIdentifier": $target_snapshot_identifier, "ManualSnapshotRetentionPeriod": $manual_snapshot_retention_period, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-create-authentication-profile" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"AuthenticationProfileName": $authentication_profile_name, "AuthenticationProfileContent": $authentication_profile_content, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-create-parameter-group" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"ParameterGroupName": $parameter_group_name, "ParameterGroupFamily": $parameter_group_family, "Description": $description, "Tags": $tags, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-create-security-group" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"ClusterSecurityGroupName": $cluster_security_group_name, "Description": $description, "Tags": $tags, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-create-snapshot" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"SnapshotIdentifier": $snapshot_identifier, "ClusterIdentifier": $cluster_identifier, "ManualSnapshotRetentionPeriod": $manual_snapshot_retention_period, "Tags": $tags, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-create-subnet-group" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"ClusterSubnetGroupName": $cluster_subnet_group_name, "Description": $description, "SubnetIds": $subnet_ids, "Tags": $tags, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-create-endpoint-access" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"ClusterIdentifier": $cluster_identifier, "ResourceOwner": $resource_owner, "EndpointName": $endpoint_name, "SubnetGroupName": $subnet_group_name, "VpcSecurityGroupIds": $vpc_security_group_ids, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-create-event-subscription" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"SubscriptionName": $subscription_name, "SnsTopicArn": $sns_topic_arn, "SourceType": $source_type, "SourceIds": $source_ids, "EventCategories": $event_categories, "Severity": $severity, "Enabled": $enabled, "Tags": $tags, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-create-hsm-client-certificate" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"HsmClientCertificateIdentifier": $hsm_client_certificate_identifier, "Tags": $tags, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-create-hsm-configuration" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"HsmConfigurationIdentifier": $hsm_configuration_identifier, "Description": $description, "HsmIpAddress": $hsm_ip_address, "HsmPartitionName": $hsm_partition_name, "HsmPartitionPassword": $hsm_partition_password, "HsmServerPublicCertificate": $hsm_server_public_certificate, "Tags": $tags, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-create-scheduled-action" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"ScheduledActionName": $scheduled_action_name, "TargetAction": $target_action, "Schedule": $schedule, "IamRole": $iam_role, "ScheduledActionDescription": $scheduled_action_description, "StartTime": $start_time, "EndTime": $end_time, "Enable": $enable, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-create-snapshot-copy-grant" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"SnapshotCopyGrantName": $snapshot_copy_grant_name, "KmsKeyId": $kms_key_id, "Tags": $tags, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-create-snapshot-schedule" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"ScheduleDefinitions": $schedule_definitions, "ScheduleIdentifier": $schedule_identifier, "ScheduleDescription": $schedule_description, "Tags": $tags, "DryRun": $qp_dry_run, "NextInvocations": $next_invocations, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-create-tags" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"ResourceName": $resource_name, "Tags": $tags, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-create-usage-limit" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"ClusterIdentifier": $cluster_identifier, "FeatureType": $feature_type, "LimitType": $limit_type, "Amount": $amount, "Period": $period, "BreachAction": $breach_action, "Tags": $tags, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-delete-authentication-profile" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"AuthenticationProfileName": $authentication_profile_name, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-delete" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"ClusterIdentifier": $cluster_identifier, "SkipFinalClusterSnapshot": $skip_final_cluster_snapshot, "FinalClusterSnapshotIdentifier": $final_cluster_snapshot_identifier, "FinalClusterSnapshotRetentionPeriod": $final_cluster_snapshot_retention_period, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-delete-parameter-group" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"ParameterGroupName": $parameter_group_name, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-delete-security-group" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"ClusterSecurityGroupName": $cluster_security_group_name, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-delete-snapshot" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"SnapshotIdentifier": $snapshot_identifier, "SnapshotClusterIdentifier": $snapshot_cluster_identifier, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-delete-subnet-group" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"ClusterSubnetGroupName": $cluster_subnet_group_name, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-delete-endpoint-access" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"EndpointName": $endpoint_name, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-delete-event-subscription" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"SubscriptionName": $subscription_name, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-delete-hsm-client-certificate" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"HsmClientCertificateIdentifier": $hsm_client_certificate_identifier, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-delete-hsm-configuration" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"HsmConfigurationIdentifier": $hsm_configuration_identifier, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-delete-scheduled-action" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"ScheduledActionName": $scheduled_action_name, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-delete-snapshot-copy-grant" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"SnapshotCopyGrantName": $snapshot_copy_grant_name, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-delete-snapshot-schedule" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"ScheduleIdentifier": $schedule_identifier, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-delete-tags" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"ResourceName": $resource_name, "TagKeys": $tag_keys, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-delete-usage-limit" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"UsageLimitId": $usage_limit_id, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-account-attributes" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"AttributeNames": $attribute_names, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-db-revisions" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"ClusterIdentifier": $cluster_identifier, "MaxRecords": $max_records, "Marker": $marker, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api create-get-db-revisions" [
  ...
  let req = {
    method: "post"
    url: $full_url
    query: ({"MaxRecords": $max_records, "Marker": $marker, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: $req_body
    content_type: "text/xml"
    timeout: ($max_time | default 30min)
...
export def "api get-parameter-groups" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"ParameterGroupName": $parameter_group_name, "MaxRecords": $max_records, "Marker": $marker, "TagKeys": $tag_keys, "TagValues": $tag_values, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-parameters" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"ParameterGroupName": $parameter_group_name, "Source": $qp_source, "MaxRecords": $max_records, "Marker": $marker, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-security-groups" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"ClusterSecurityGroupName": $cluster_security_group_name, "MaxRecords": $max_records, "Marker": $marker, "TagKeys": $tag_keys, "TagValues": $tag_values, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-snapshots" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"ClusterIdentifier": $cluster_identifier, "SnapshotIdentifier": $snapshot_identifier, "SnapshotArn": $snapshot_arn, "SnapshotType": $snapshot_type, "StartTime": $start_time, "EndTime": $end_time, "MaxRecords": $max_records, "Marker": $marker, "OwnerAccount": $owner_account, "TagKeys": $tag_keys, "TagValues": $tag_values, "ClusterExists": $cluster_exists, "SortingEntities": $sorting_entities, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-subnet-groups" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"ClusterSubnetGroupName": $cluster_subnet_group_name, "MaxRecords": $max_records, "Marker": $marker, "TagKeys": $tag_keys, "TagValues": $tag_values, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-tracks" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"MaintenanceTrackName": $maintenance_track_name, "MaxRecords": $max_records, "Marker": $marker, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-versions" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"ClusterVersion": $cluster_version, "ClusterParameterGroupFamily": $cluster_parameter_group_family, "MaxRecords": $max_records, "Marker": $marker, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-clusters" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"ClusterIdentifier": $cluster_identifier, "MaxRecords": $max_records, "Marker": $marker, "TagKeys": $tag_keys, "TagValues": $tag_values, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-data-shares" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"DataShareArn": $data_share_arn, "MaxRecords": $max_records, "Marker": $marker, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-data-shares-for-consumer" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"ConsumerArn": $consumer_arn, "Status": $status, "MaxRecords": $max_records, "Marker": $marker, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-data-shares-for-producer" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"ProducerArn": $producer_arn, "Status": $status, "MaxRecords": $max_records, "Marker": $marker, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-default-parameters" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"ParameterGroupFamily": $parameter_group_family, "MaxRecords": $max_records, "Marker": $marker, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-endpoint-access" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"ClusterIdentifier": $cluster_identifier, "ResourceOwner": $resource_owner, "EndpointName": $endpoint_name, "VpcId": $vpc_id, "MaxRecords": $max_records, "Marker": $marker, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-endpoint-authorization" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"ClusterIdentifier": $cluster_identifier, "Account": $account, "Grantee": $grantee, "MaxRecords": $max_records, "Marker": $marker, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-event-categories" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"SourceType": $source_type, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-event-subscriptions" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"SubscriptionName": $subscription_name, "MaxRecords": $max_records, "Marker": $marker, "TagKeys": $tag_keys, "TagValues": $tag_values, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-events" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"SourceIdentifier": $source_identifier, "SourceType": $source_type, "StartTime": $start_time, "EndTime": $end_time, "Duration": $duration, "MaxRecords": $max_records, "Marker": $marker, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-hsm-client-certificates" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"HsmClientCertificateIdentifier": $hsm_client_certificate_identifier, "MaxRecords": $max_records, "Marker": $marker, "TagKeys": $tag_keys, "TagValues": $tag_values, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-hsm-configurations" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"HsmConfigurationIdentifier": $hsm_configuration_identifier, "MaxRecords": $max_records, "Marker": $marker, "TagKeys": $tag_keys, "TagValues": $tag_values, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-node-configuration-options" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"ActionType": $action_type, "ClusterIdentifier": $cluster_identifier, "SnapshotIdentifier": $snapshot_identifier, "SnapshotArn": $snapshot_arn, "OwnerAccount": $owner_account, "Filter": $filter, "Marker": $marker, "MaxRecords": $max_records, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-orderable-options" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"ClusterVersion": $cluster_version, "NodeType": $node_type, "MaxRecords": $max_records, "Marker": $marker, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-reserved-node-exchange-status" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"ReservedNodeId": $reserved_node_id, "ReservedNodeExchangeRequestId": $reserved_node_exchange_request_id, "MaxRecords": $max_records, "Marker": $marker, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-reserved-node-offerings" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"ReservedNodeOfferingId": $reserved_node_offering_id, "MaxRecords": $max_records, "Marker": $marker, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-reserved-nodes" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"ReservedNodeId": $reserved_node_id, "MaxRecords": $max_records, "Marker": $marker, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-scheduled-actions" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"ScheduledActionName": $scheduled_action_name, "TargetActionType": $target_action_type, "StartTime": $start_time, "EndTime": $end_time, "Active": $active, "Filters": $filters, "Marker": $marker, "MaxRecords": $max_records, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-snapshot-copy-grants" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"SnapshotCopyGrantName": $snapshot_copy_grant_name, "MaxRecords": $max_records, "Marker": $marker, "TagKeys": $tag_keys, "TagValues": $tag_values, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-snapshot-schedules" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"ClusterIdentifier": $cluster_identifier, "ScheduleIdentifier": $schedule_identifier, "TagKeys": $tag_keys, "TagValues": $tag_values, "Marker": $marker, "MaxRecords": $max_records, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-table-restore-status" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"ClusterIdentifier": $cluster_identifier, "TableRestoreRequestId": $table_restore_request_id, "MaxRecords": $max_records, "Marker": $marker, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-tags" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"ResourceName": $resource_name, "ResourceType": $resource_type, "MaxRecords": $max_records, "Marker": $marker, "TagKeys": $tag_keys, "TagValues": $tag_values, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-usage-limits" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"UsageLimitId": $usage_limit_id, "ClusterIdentifier": $cluster_identifier, "FeatureType": $feature_type, "MaxRecords": $max_records, "Marker": $marker, "TagKeys": $tag_keys, "TagValues": $tag_values, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-disassociate-data-share-consumer" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"DataShareArn": $data_share_arn, "DisassociateEntireAccount": $disassociate_entire_account, "ConsumerArn": $consumer_arn, "ConsumerRegion": $consumer_region, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-enable-logging" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"ClusterIdentifier": $cluster_identifier, "BucketName": $bucket_name, "S3KeyPrefix": $s3_key_prefix, "LogDestinationType": $log_destination_type, "LogExports": $log_exports, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-enable-snapshot-copy" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"ClusterIdentifier": $cluster_identifier, "DestinationRegion": $destination_region, "RetentionPeriod": $retention_period, "SnapshotCopyGrantName": $snapshot_copy_grant_name, "ManualSnapshotRetentionPeriod": $manual_snapshot_retention_period, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-credentials" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"DbUser": $db_user, "DbName": $db_name, "ClusterIdentifier": $cluster_identifier, "DurationSeconds": $duration_seconds, "AutoCreate": $auto_create, "DbGroups": $db_groups, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-credentials-with-iam" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"DbName": $db_name, "ClusterIdentifier": $cluster_identifier, "DurationSeconds": $duration_seconds, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-reserved-node-exchange-configuration-options" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"ActionType": $action_type, "ClusterIdentifier": $cluster_identifier, "SnapshotIdentifier": $snapshot_identifier, "MaxRecords": $max_records, "Marker": $marker, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-modify-aqua-configuration" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"ClusterIdentifier": $cluster_identifier, "AquaConfigurationStatus": $aqua_configuration_status, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-modify-db-revision" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"ClusterIdentifier": $cluster_identifier, "RevisionTarget": $revision_target, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-modify-iam-roles" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"ClusterIdentifier": $cluster_identifier, "AddIamRoles": $add_iam_roles, "RemoveIamRoles": $remove_iam_roles, "DefaultIamRoleArn": $default_iam_role_arn, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-modify-parameter-group" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"ParameterGroupName": $parameter_group_name, "Parameters": $parameters, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-modify-snapshot" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"SnapshotIdentifier": $snapshot_identifier, "ManualSnapshotRetentionPeriod": $manual_snapshot_retention_period, "Force": $force, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-modify-snapshot-schedule" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"ClusterIdentifier": $cluster_identifier, "ScheduleIdentifier": $schedule_identifier, "DisassociateSchedule": $disassociate_schedule, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-modify-subnet-group" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"ClusterSubnetGroupName": $cluster_subnet_group_name, "Description": $description, "SubnetIds": $subnet_ids, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-modify-endpoint-access" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"EndpointName": $endpoint_name, "VpcSecurityGroupIds": $vpc_security_group_ids, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-modify-event-subscription" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"SubscriptionName": $subscription_name, "SnsTopicArn": $sns_topic_arn, "SourceType": $source_type, "SourceIds": $source_ids, "EventCategories": $event_categories, "Severity": $severity, "Enabled": $enabled, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-modify-snapshot-copy-retention-period" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"ClusterIdentifier": $cluster_identifier, "RetentionPeriod": $retention_period, "Manual": $manual, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-modify-snapshot-schedule-1" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"ScheduleIdentifier": $schedule_identifier, "ScheduleDefinitions": $schedule_definitions, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-modify-usage-limit" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"UsageLimitId": $usage_limit_id, "Amount": $amount, "BreachAction": $breach_action, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-purchase-reserved-node-offering" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"ReservedNodeOfferingId": $reserved_node_offering_id, "NodeCount": $node_count, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-reject-data-share" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"DataShareArn": $data_share_arn, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-reset-parameter-group" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"ParameterGroupName": $parameter_group_name, "ResetAllParameters": $reset_all_parameters, "Parameters": $parameters, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-resize-1" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"ClusterIdentifier": $cluster_identifier, "ClusterType": $cluster_type, "NodeType": $node_type, "NumberOfNodes": $number_of_nodes, "Classic": $classic, "ReservedNodeId": $reserved_node_id, "TargetReservedNodeOfferingId": $target_reserved_node_offering_id, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-restore-table-from-snapshot" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"ClusterIdentifier": $cluster_identifier, "SnapshotIdentifier": $snapshot_identifier, "SourceDatabaseName": $source_database_name, "SourceSchemaName": $source_schema_name, "SourceTableName": $source_table_name, "TargetDatabaseName": $target_database_name, "TargetSchemaName": $target_schema_name, "NewTableName": $new_table_name, "EnableCaseSensitiveIdentifier": $enable_case_sensitive_identifier, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-delete-endpoint-access-1" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"ClusterIdentifier": $cluster_identifier, "Account": $account, "VpcIds": $vpc_ids, "Force": $force, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-update-partner-status" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"AccountId": $account_id, "ClusterIdentifier": $cluster_identifier, "DatabaseName": $database_name, "PartnerName": $partner_name, "Status": $status, "StatusMessage": $status_message, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
