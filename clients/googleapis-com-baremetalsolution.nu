# Auto-generated client for Bare Metal Solution API vv2
# Source: https://api.apis.guru/v2/specs/googleapis.com/baremetalsolution/v2/openapi.json
# Auth: --token flag or $env.BARE_METAL_SOLUTION_API_TOKEN
...
def build-auth [token?: string, auth_scheme?: string]: nothing -> record {
  let token_val = if ($token | is-not-empty) { $token } else { $env | get -o BARE_METAL_SOLUTION_API_TOKEN | default "" }
...
def base-url-completer [] { ["https://baremetalsolution.googleapis.com"] }
def auth-scheme-completer [] { ["bearer"] }

# Completers for enum parameters
def xgafv-completer [] { ["1" "2"] }
def alt-completer [] { ["json" "media" "proto"] }
def performance-tier-completer [] { ["VOLUME_PERFORMANCE_TIER_ASSIGNED" "VOLUME_PERFORMANCE_TIER_HT" "VOLUME_PERFORMANCE_TIER_SHARED" "VOLUME_PERFORMANCE_TIER_UNSPECIFIED"] }
def snapshot-auto-delete-behavior-completer [] { ["DISABLED" "NEWEST_FIRST" "OLDEST_FIRST" "SNAPSHOT_AUTO_DELETE_BEHAVIOR_UNSPECIFIED"] }
def state-completer [] { ["COOL_OFF" "CREATING" "DELETING" "READY" "STATE_UNSPECIFIED" "UPDATING"] }
def storage-type-completer [] { ["HDD" "SSD" "STORAGE_TYPE_UNSPECIFIED"] }
def workload-profile-completer [] { ["GENERIC" "HANA" "WORKLOAD_PROFILE_UNSPECIFIED"] }
def workload-profile-completer-1 [] { ["WORKLOAD_PROFILE_GENERIC" "WORKLOAD_PROFILE_HANA" "WORKLOAD_PROFILE_UNSPECIFIED"] }
...
export def "projects create-detach-lun" [
  ...
  --skip-reboot: oneof<nothing, bool> # If true, performs lun unmapping without instance reboot.
  ...
  let input = $in
  let auth = (merge-auth [(build-auth ($token_oauth2 | default ($env | get -o BARE_METAL_SOLUTION_API_OAUTH2_TOKEN | default "")) "bearer") (build-auth ($token_oauth2c | default ($env | get -o BARE_METAL_SOLUTION_API_OAUTH2C_TOKEN | default "")) "bearer")])
  ...
  let full_url = (build-url $base ({instance: (encode-path-segment $instance)} | format pattern "/v2/{instance}:detachLun") $qp $auth.query)
...
export def "instance-provisioning-settings-fetch get" [
  ...
  --upload-protocol: string # Upload protocol for media (e.g. "raw", "multipart").
  --upload-type: string # Legacy upload protocol for media (e.g. "media", "multipart").
]: nothing -> record<images: table<applicableInstanceTypes: list, code: string, description: string, name: string, supportedNetworkTemplates: list>> {
  let auth = (merge-auth [(build-auth ($token_oauth2 | default ($env | get -o BARE_METAL_SOLUTION_API_OAUTH2_TOKEN | default "")) "bearer") (build-auth ($token_oauth2c | default ($env | get -o BARE_METAL_SOLUTION_API_OAUTH2C_TOKEN | default "")) "bearer")])
  let base = ($base_url | default $BASE_URL)
  if ($location | is-empty) { error make --unspanned { msg: "path parameter 'location' must be non-empty" } }
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $pretty_print "scalar") (serialize-qp "quotaUser" $quota_user "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $upload_type "scalar")] | flatten | str join "&"
  let full_url = (build-url $base ({location: (encode-path-segment $location)} | format pattern "/v2/{location}/instanceProvisioningSettings:fetch") $qp $auth.query)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "get"
...
export def "networks-list-network-usage list" [
  ...
  --upload-protocol: string # Upload protocol for media (e.g. "raw", "multipart").
  --upload-type: string # Legacy upload protocol for media (e.g. "media", "multipart").
]: nothing -> record<networks: table<network: record, usedIps: list>> {
  let auth = (merge-auth [(build-auth ($token_oauth2 | default ($env | get -o BARE_METAL_SOLUTION_API_OAUTH2_TOKEN | default "")) "bearer") (build-auth ($token_oauth2c | default ($env | get -o BARE_METAL_SOLUTION_API_OAUTH2C_TOKEN | default "")) "bearer")])
  let base = ($base_url | default $BASE_URL)
  if ($location | is-empty) { error make --unspanned { msg: "path parameter 'location' must be non-empty" } }
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $pretty_print "scalar") (serialize-qp "quotaUser" $quota_user "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $upload_type "scalar")] | flatten | str join "&"
  let full_url = (build-url $base ({location: (encode-path-segment $location)} | format pattern "/v2/{location}/networks:listNetworkUsage") $qp $auth.query)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "get"
...
export def "projects get" [
  ...
  --upload-protocol: string # Upload protocol for media (e.g. "raw", "multipart").
  --upload-type: string # Legacy upload protocol for media (e.g. "media", "multipart").
]: nothing -> record<createTime: string, description: string, id: string, name: string, storageVolume: string, type: string> {
  let auth = (merge-auth [(build-auth ($token_oauth2 | default ($env | get -o BARE_METAL_SOLUTION_API_OAUTH2_TOKEN | default "")) "bearer") (build-auth ($token_oauth2c | default ($env | get -o BARE_METAL_SOLUTION_API_OAUTH2C_TOKEN | default "")) "bearer")])
  let base = ($base_url | default $BASE_URL)
  if ($name | is-empty) { error make --unspanned { msg: "path parameter 'name' must be non-empty" } }
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $pretty_print "scalar") (serialize-qp "quotaUser" $quota_user "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $upload_type "scalar")] | flatten | str join "&"
...
export def "projects update" [
  ...
  --upload-protocol: string # Upload protocol for media (e.g. "raw", "multipart").
  --upload-type: string # Legacy upload protocol for media (e.g. "media", "multipart").
  --update-mask: string # The list of fields to update. The only currently supported fields are: 'labels'
  --auto-grown-size-gib: string # The size, in GiB, that this storage volume has expanded as a result of an auto grow policy. In the absence of auto-grow, the value is 0. (format: int64)
  --current-size-gib: string # The current size of this storage volume, in GiB, including space reserved for snapshots. This size might be different than the requested size if the storage volume has been configured with auto grow or auto shrink. (format: int64)
  --emergency-size-gib: string # Additional emergency size that was requested for this Volume, in GiB. current_size_gib includes this value. (format: int64)
  --id: string # An identifier for the `Volume`, generated by the backend.
  --labels: record # Labels as key value pairs.
  --max-size-gib: string # Maximum size volume can be expanded to in case of evergency, in GiB. (format: int64)
  --notes: string # Input only. User-specified notes for new Volume. Used to provision Volumes that require manual intervention.
  --originally-requested-size-gib: string # Originally requested size, in GiB. (format: int64)
  --performance-tier: string@performance-tier-completer # Immutable. Performance tier of the Volume. Default is SHARED.
  --pod: string # Immutable. Pod name.
  --remaining-space-gib: string # The space remaining in the storage volume for new LUNs, in GiB, excluding space reserved for snapshots. (format: int64)
  --requested-size-gib: string # The requested size of this storage volume, in GiB. (format: int64)
  --snapshot-auto-delete-behavior: string@snapshot-auto-delete-behavior-completer # The behavior to use when snapshot reserved space is full.
  --snapshot-enabled: oneof<nothing, bool> # Whether snapshots are enabled.
  --snapshot-reservation-detail: record # Details about snapshot space reservation and usage on the storage volume. — shape: {reservedSpaceGib?: string, reservedSpacePercent?: int, reservedSpaceRemainingGib?: string, reservedSpaceUsedPercent?: int}
  --snapshot-schedule-policy: string # The name of the snapshot schedule policy in use for this volume, if any.
  --state: string@state-completer # The state of this storage volume.
  --storage-aggregate-pool: string # Input only. Name of the storage aggregate pool to allocate the volume in. Can be used only for VOLUME_PERFORMANCE_TIER_ASSIGNED volumes.
  --storage-type: string@storage-type-completer # The storage type for this volume.
  --workload-profile: string@workload-profile-completer # The workload profile for the volume.
]: any -> record<done: bool, error: record<code: int, details: list<record>, message: string>, metadata: record, name: string, response: record> {
  let input = $in
  let auth = (merge-auth [(build-auth ($token_oauth2 | default ($env | get -o BARE_METAL_SOLUTION_API_OAUTH2_TOKEN | default "")) "bearer") (build-auth ($token_oauth2c | default ($env | get -o BARE_METAL_SOLUTION_API_OAUTH2C_TOKEN | default "")) "bearer")])
  let base = ($base_url | default $BASE_URL)
...
export def "projects disable-interactive-serial-console" [
  ...
  if ($name | is-empty) { error make --unspanned { msg: "path parameter 'name' must be non-empty" } }
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $pretty_print "scalar") (serialize-qp "quotaUser" $quota_user "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $upload_type "scalar")] | flatten | str join "&"
  let full_url = (build-url $base ({name: (encode-path-segment $name)} | format pattern "/v2/{name}:disableInteractiveSerialConsole") $qp $auth.query)
  let req_body = $body
  let req_body = if ($input | describe | str starts-with "record") { $input | merge deep ($req_body | default {}) } else { $req_body }
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
...
export def "projects enable-interactive-serial-console" [
  ...
  if ($name | is-empty) { error make --unspanned { msg: "path parameter 'name' must be non-empty" } }
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $pretty_print "scalar") (serialize-qp "quotaUser" $quota_user "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $upload_type "scalar")] | flatten | str join "&"
  let full_url = (build-url $base ({name: (encode-path-segment $name)} | format pattern "/v2/{name}:enableInteractiveSerialConsole") $qp $auth.query)
  let req_body = $body
  let req_body = if ($input | describe | str starts-with "record") { $input | merge deep ($req_body | default {}) } else { $req_body }
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
...
export def "projects create-evict" [
  ...
  if ($name | is-empty) { error make --unspanned { msg: "path parameter 'name' must be non-empty" } }
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $pretty_print "scalar") (serialize-qp "quotaUser" $quota_user "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $upload_type "scalar")] | flatten | str join "&"
  let full_url = (build-url $base ({name: (encode-path-segment $name)} | format pattern "/v2/{name}:evict") $qp $auth.query)
  let req_body = $body
  let req_body = if ($input | describe | str starts-with "record") { $input | merge deep ($req_body | default {}) } else { $req_body }
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
...
export def "projects rename" [
  ...
  --upload-protocol: string # Upload protocol for media (e.g. "raw", "multipart").
  --upload-type: string # Legacy upload protocol for media (e.g. "media", "multipart").
  --new-volume-id: string # Required. The new `id` of the volume.
]: any -> record<attached: bool, autoGrownSizeGib: string, bootVolume: bool, currentSizeGib: string, emergencySizeGib: string, expireTime: string, id: string, instances: list<string>, labels: record, maxSizeGib: string, name: string, notes: string, originallyRequestedSizeGib: string, performanceTier: string, pod: string, protocol: string, remainingSpaceGib: string, requestedSizeGib: string, snapshotAutoDeleteBehavior: string, snapshotEnabled: bool, snapshotReservationDetail: record<reservedSpaceGib: string, reservedSpacePercent: int, reservedSpaceRemainingGib: string, reservedSpaceUsedPercent: int>, snapshotSchedulePolicy: string, state: string, storageAggregatePool: string, storageType: string, workloadProfile: string> {
  let input = $in
  let auth = (merge-auth [(build-auth ($token_oauth2 | default ($env | get -o BARE_METAL_SOLUTION_API_OAUTH2_TOKEN | default "")) "bearer") (build-auth ($token_oauth2c | default ($env | get -o BARE_METAL_SOLUTION_API_OAUTH2C_TOKEN | default "")) "bearer")])
  let base = ($base_url | default $BASE_URL)
  if ($name | is-empty) { error make --unspanned { msg: "path parameter 'name' must be non-empty" } }
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $pretty_print "scalar") (serialize-qp "quotaUser" $quota_user "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $upload_type "scalar")] | flatten | str join "&"
  let full_url = (build-url $base ({name: (encode-path-segment $name)} | format pattern "/v2/{name}:rename") $qp $auth.query)
...
export def "projects reset" [
  ...
  if ($name | is-empty) { error make --unspanned { msg: "path parameter 'name' must be non-empty" } }
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $pretty_print "scalar") (serialize-qp "quotaUser" $quota_user "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $upload_type "scalar")] | flatten | str join "&"
  let full_url = (build-url $base ({name: (encode-path-segment $name)} | format pattern "/v2/{name}:reset") $qp $auth.query)
  let req_body = $body
  let req_body = if ($input | describe | str starts-with "record") { $input | merge deep ($req_body | default {}) } else { $req_body }
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
...
export def "projects start" [
  ...
  if ($name | is-empty) { error make --unspanned { msg: "path parameter 'name' must be non-empty" } }
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $pretty_print "scalar") (serialize-qp "quotaUser" $quota_user "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $upload_type "scalar")] | flatten | str join "&"
  let full_url = (build-url $base ({name: (encode-path-segment $name)} | format pattern "/v2/{name}:start") $qp $auth.query)
  let req_body = $body
  let req_body = if ($input | describe | str starts-with "record") { $input | merge deep ($req_body | default {}) } else { $req_body }
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
...
export def "projects stop" [
  ...
  if ($name | is-empty) { error make --unspanned { msg: "path parameter 'name' must be non-empty" } }
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $pretty_print "scalar") (serialize-qp "quotaUser" $quota_user "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $upload_type "scalar")] | flatten | str join "&"
  let full_url = (build-url $base ({name: (encode-path-segment $name)} | format pattern "/v2/{name}:stop") $qp $auth.query)
  let req_body = $body
  let req_body = if ($input | describe | str starts-with "record") { $input | merge deep ($req_body | default {}) } else { $req_body }
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
...
export def "instances list" [
  ...
  --page-size: int # Requested page size. Server may return fewer items than requested. If unspecified, the server will pick an appropriate default.
  --page-token: string # A token identifying a page of results from the server.
]: nothing -> record<instances: table<createTime: string, firmwareVersion: string, hyperthreadingEnabled: bool, id: string, interactiveSerialConsoleEnabled: bool, labels: record, logicalInterfaces: list, loginInfo: string, luns: list, machineType: string, name: string, networkTemplate: string, networks: list, osImage: string, pod: string, state: string, updateTime: string, volumes: list, workloadProfile: string>, nextPageToken: string, unreachable: list<string>> {
  let auth = (merge-auth [(build-auth ($token_oauth2 | default ($env | get -o BARE_METAL_SOLUTION_API_OAUTH2_TOKEN | default "")) "bearer") (build-auth ($token_oauth2c | default ($env | get -o BARE_METAL_SOLUTION_API_OAUTH2C_TOKEN | default "")) "bearer")])
  let base = ($base_url | default $BASE_URL)
...
export def "instances create" [
  ...
  --upload-protocol: string # Upload protocol for media (e.g. "raw", "multipart").
  --upload-type: string # Legacy upload protocol for media (e.g. "media", "multipart").
  --hyperthreading-enabled: oneof<nothing, bool> # True if you enable hyperthreading for the server, otherwise false. The default value is false.
  --labels: record # Labels as key value pairs.
  --logical-interfaces: list # List of logical interfaces for the instance. The number of logical interfaces will be the same as number of hardware bond/nic on the chosen network template. For the non-multivlan configurations (for eg, existing servers) that use existing default network template (bondaa-bondaa), both the Instance.networks field and the Instance.logical_interfaces fields will be filled to ensure backward compatibility. For the others, only Instance.logical_interfaces will be filled. — item shape: {interfaceIndex?: int, logicalNetworkInterfaces?: list, name?: string}
  --luns: list # Immutable. List of LUNs associated with this server. — item shape: {bootLun?: bool, id?: string, multiprotocolType?: "MULTIPROTOCOL_TYPE_UNSPECIFIED"|"LINUX", shareable?: bool, sizeGb?: string, state?: "STATE_UNSPECIFIED"|"CREATING"|"UPDATING"|"READY"|"DELETING"|"COOL_OFF", storageType?: "STORAGE_TYPE_UNSPECIFIED"|"SSD"|"HDD", storageVolume?: string, wwid?: string}
  --machine-type: string # Immutable. The server type. [Available server types](https://cloud.google.com/bare-metal/docs/bms-planning#server_configurations)
...
export def "luns list" [
  ...
  --upload-protocol: string # Upload protocol for media (e.g. "raw", "multipart").
  --upload-type: string # Legacy upload protocol for media (e.g. "media", "multipart").
  --page-size: int # Requested page size. The server might return fewer items than requested. If unspecified, server will pick an appropriate default.
  --page-token: string # A token identifying a page of results from the server.
]: nothing -> record<luns: table<bootLun: bool, expireTime: string, id: string, instances: list, multiprotocolType: string, name: string, shareable: bool, sizeGb: string, state: string, storageType: string, storageVolume: string, wwid: string>, nextPageToken: string, unreachable: list<string>> {
  let auth = (merge-auth [(build-auth ($token_oauth2 | default ($env | get -o BARE_METAL_SOLUTION_API_OAUTH2_TOKEN | default "")) "bearer") (build-auth ($token_oauth2c | default ($env | get -o BARE_METAL_SOLUTION_API_OAUTH2C_TOKEN | default "")) "bearer")])
  let base = ($base_url | default $BASE_URL)
  if ($parent | is-empty) { error make --unspanned { msg: "path parameter 'parent' must be non-empty" } }
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $pretty_print "scalar") (serialize-qp "quotaUser" $quota_user "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $upload_type "scalar") (serialize-qp "pageSize" $page_size "scalar") (serialize-qp "pageToken" $page_token "scalar")] | flatten | str join "&"
  let full_url = (build-url $base ({parent: (encode-path-segment $parent)} | format pattern "/v2/{parent}/luns") $qp $auth.query)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "get"
...
export def "networks list" [
  ...
  --page-size: int # Requested page size. The server might return fewer items than requested. If unspecified, server will pick an appropriate default.
  --page-token: string # A token identifying a page of results from the server.
]: nothing -> record<networks: table<cidr: string, gatewayIp: string, id: string, ipAddress: string, jumboFramesEnabled: bool, labels: record, macAddress: list, mountPoints: list, name: string, pod: string, reservations: list, servicesCidr: string, state: string, type: string, vlanId: string, vrf: record>, nextPageToken: string, unreachable: list<string>> {
  let auth = (merge-auth [(build-auth ($token_oauth2 | default ($env | get -o BARE_METAL_SOLUTION_API_OAUTH2_TOKEN | default "")) "bearer") (build-auth ($token_oauth2c | default ($env | get -o BARE_METAL_SOLUTION_API_OAUTH2C_TOKEN | default "")) "bearer")])
  let base = ($base_url | default $BASE_URL)
  if ($parent | is-empty) { error make --unspanned { msg: "path parameter 'parent' must be non-empty" } }
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $pretty_print "scalar") (serialize-qp "quotaUser" $quota_user "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $upload_type "scalar") (serialize-qp "filter" $filter "scalar") (serialize-qp "pageSize" $page_size "scalar") (serialize-qp "pageToken" $page_token "scalar")] | flatten | str join "&"
  let full_url = (build-url $base ({parent: (encode-path-segment $parent)} | format pattern "/v2/{parent}/networks") $qp $auth.query)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "get"
...
export def "nfs-shares list" [
  ...
  --page-size: int # Requested page size. The server might return fewer items than requested. If unspecified, server will pick an appropriate default.
  --page-token: string # A token identifying a page of results from the server.
]: nothing -> record<nextPageToken: string, nfsShares: table<allowedClients: list, id: string, labels: record, name: string, nfsShareId: string, requestedSizeGib: string, state: string, storageType: string, volume: string>, unreachable: list<string>> {
  let auth = (merge-auth [(build-auth ($token_oauth2 | default ($env | get -o BARE_METAL_SOLUTION_API_OAUTH2_TOKEN | default "")) "bearer") (build-auth ($token_oauth2c | default ($env | get -o BARE_METAL_SOLUTION_API_OAUTH2C_TOKEN | default "")) "bearer")])
  let base = ($base_url | default $BASE_URL)
  if ($parent | is-empty) { error make --unspanned { msg: "path parameter 'parent' must be non-empty" } }
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $pretty_print "scalar") (serialize-qp "quotaUser" $quota_user "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $upload_type "scalar") (serialize-qp "filter" $filter "scalar") (serialize-qp "pageSize" $page_size "scalar") (serialize-qp "pageToken" $page_token "scalar")] | flatten | str join "&"
  let full_url = (build-url $base ({parent: (encode-path-segment $parent)} | format pattern "/v2/{parent}/nfsShares") $qp $auth.query)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "get"
...
export def "nfs-shares create" [
  ...
  --upload-protocol: string # Upload protocol for media (e.g. "raw", "multipart").
  --upload-type: string # Legacy upload protocol for media (e.g. "media", "multipart").
  --allowed-clients: list # List of allowed access points. — item shape: {allowDev?: bool, allowSuid?: bool, allowedClientsCidr?: string, mountPermissions?: "MOUNT_PERMISSIONS_UNSPECIFIED"|"READ"|"READ_WRITE", network?: string, noRootSquash?: bool}
  --labels: record # Labels as key value pairs.
  --name: string # Immutable. The name of the NFS share.
  --requested-size-gib: string # The requested size, in GiB. (format: int64)
  --storage-type: string@storage-type-completer # Immutable. The storage type of the underlying volume.
]: any -> record<done: bool, error: record<code: int, details: list<record>, message: string>, metadata: record, name: string, response: record> {
  let input = $in
  let auth = (merge-auth [(build-auth ($token_oauth2 | default ($env | get -o BARE_METAL_SOLUTION_API_OAUTH2_TOKEN | default "")) "bearer") (build-auth ($token_oauth2c | default ($env | get -o BARE_METAL_SOLUTION_API_OAUTH2C_TOKEN | default "")) "bearer")])
  let base = ($base_url | default $BASE_URL)
...
export def "provisioning-configs create" [
  ...
  --custom-id: string # Optional. The user-defined identifier of the provisioning config.
  --email-body: string # Email provided to send a confirmation with provisioning config to. Deprecated in favour of email field in request messages. (body field)
  --handover-service-account: string # A service account to enable customers to access instance credentials upon handover.
  --instances: list # Instances to be created. — item shape: {accountNetworksEnabled?: bool, clientNetwork?: record, hyperthreading?: bool, id?: string, instanceType?: string, logicalInterfaces?: list, networkConfig?: "NETWORKCONFIG_UNSPECIFIED"|"SINGLE_VLAN"|"MULTI_VLAN", networkTemplate?: string, osImage?: string, privateNetwork?: record, userNote?: string}
  ...
  let full_url = (build-url $base ({parent: (encode-path-segment $parent)} | format pattern "/v2/{parent}/provisioningConfigs") $qp $auth.query)
  let req_body = {"customId": $custom_id, "email": $email_body, "handoverServiceAccount": $handover_service_account, "instances": $instances, "location": $location, "networks": $networks, "statusMessage": $status_message, "ticketId": $ticket_id, "volumes": $volumes, "vpcScEnabled": $vpc_sc_enabled} | compact
  let req_body = if ($input | describe | str starts-with "record") { $input | merge deep ($req_body | default {}) } else { $req_body }
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
...
export def "provisioning-configs-submit submit" [
  ...
  --upload-type: string # Legacy upload protocol for media (e.g. "media", "multipart").
  --email: string # Optional. Email provided to send a confirmation with provisioning config to.
  --provisioning-config: record # A provisioning configuration. — shape: {customId?: string, email?: string, handoverServiceAccount?: string, instances?: list, location?: string, networks?: list, statusMessage?: string, ticketId?: string, volumes?: list, vpcScEnabled?: bool}
]: any -> record<provisioningConfig: record<cloudConsoleUri: string, customId: string, email: string, handoverServiceAccount: string, instances: list<record>, location: string, name: string, networks: list<record>, state: string, statusMessage: string, ticketId: string, updateTime: string, volumes: list<record>, vpcScEnabled: bool>> {
  let input = $in
  let auth = (merge-auth [(build-auth ($token_oauth2 | default ($env | get -o BARE_METAL_SOLUTION_API_OAUTH2_TOKEN | default "")) "bearer") (build-auth ($token_oauth2c | default ($env | get -o BARE_METAL_SOLUTION_API_OAUTH2C_TOKEN | default "")) "bearer")])
  let base = ($base_url | default $BASE_URL)
  if ($parent | is-empty) { error make --unspanned { msg: "path parameter 'parent' must be non-empty" } }
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $pretty_print "scalar") (serialize-qp "quotaUser" $quota_user "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $upload_type "scalar")] | flatten | str join "&"
  let full_url = (build-url $base ({parent: (encode-path-segment $parent)} | format pattern "/v2/{parent}/provisioningConfigs:submit") $qp $auth.query)
...
export def "provisioning-quotas list" [
  ...
  --upload-protocol: string # Upload protocol for media (e.g. "raw", "multipart").
  --upload-type: string # Legacy upload protocol for media (e.g. "media", "multipart").
  --page-size: int # Requested page size. The server might return fewer items than requested. If unspecified, server will pick an appropriate default. Notice that page_size field is not supported and won't be respected in the API request for now, will be updated when pagination is supported.
  --page-token: string # A token identifying a page of results from the server.
]: nothing -> record<nextPageToken: string, provisioningQuotas: table<assetType: string, availableCount: int, gcpService: string, instanceQuota: record, location: string, name: string, networkBandwidth: string, serverCount: string, storageGib: string>> {
  let auth = (merge-auth [(build-auth ($token_oauth2 | default ($env | get -o BARE_METAL_SOLUTION_API_OAUTH2_TOKEN | default "")) "bearer") (build-auth ($token_oauth2c | default ($env | get -o BARE_METAL_SOLUTION_API_OAUTH2C_TOKEN | default "")) "bearer")])
  let base = ($base_url | default $BASE_URL)
  if ($parent | is-empty) { error make --unspanned { msg: "path parameter 'parent' must be non-empty" } }
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $pretty_print "scalar") (serialize-qp "quotaUser" $quota_user "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $upload_type "scalar") (serialize-qp "pageSize" $page_size "scalar") (serialize-qp "pageToken" $page_token "scalar")] | flatten | str join "&"
  let full_url = (build-url $base ({parent: (encode-path-segment $parent)} | format pattern "/v2/{parent}/provisioningQuotas") $qp $auth.query)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "get"
...
export def "snapshots list" [
  ...
  --page-size: int # Requested page size. The server might return fewer items than requested. If unspecified, server will pick an appropriate default.
  --page-token: string # A token identifying a page of results from the server.
]: nothing -> record<nextPageToken: string, unreachable: list<string>, volumeSnapshots: table<createTime: string, description: string, id: string, name: string, storageVolume: string, type: string>> {
  let auth = (merge-auth [(build-auth ($token_oauth2 | default ($env | get -o BARE_METAL_SOLUTION_API_OAUTH2_TOKEN | default "")) "bearer") (build-auth ($token_oauth2c | default ($env | get -o BARE_METAL_SOLUTION_API_OAUTH2C_TOKEN | default "")) "bearer")])
  let base = ($base_url | default $BASE_URL)
  if ($parent | is-empty) { error make --unspanned { msg: "path parameter 'parent' must be non-empty" } }
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $pretty_print "scalar") (serialize-qp "quotaUser" $quota_user "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $upload_type "scalar") (serialize-qp "pageSize" $page_size "scalar") (serialize-qp "pageToken" $page_token "scalar")] | flatten | str join "&"
  let full_url = (build-url $base ({parent: (encode-path-segment $parent)} | format pattern "/v2/{parent}/snapshots") $qp $auth.query)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "get"
...
]: any -> record<createTime: string, description: string, id: string, name: string, storageVolume: string, type: string> {
  let input = $in
  let auth = (merge-auth [(build-auth ($token_oauth2 | default ($env | get -o BARE_METAL_SOLUTION_API_OAUTH2_TOKEN | default "")) "bearer") (build-auth ($token_oauth2c | default ($env | get -o BARE_METAL_SOLUTION_API_OAUTH2C_TOKEN | default "")) "bearer")])
  let base = ($base_url | default $BASE_URL)
  if ($parent | is-empty) { error make --unspanned { msg: "path parameter 'parent' must be non-empty" } }
...
]: nothing -> record<nextPageToken: string, sshKeys: table<name: string, publicKey: string>> {
  let auth = (merge-auth [(build-auth ($token_oauth2 | default ($env | get -o BARE_METAL_SOLUTION_API_OAUTH2_TOKEN | default "")) "bearer") (build-auth ($token_oauth2c | default ($env | get -o BARE_METAL_SOLUTION_API_OAUTH2C_TOKEN | default "")) "bearer")])
  let base = ($base_url | default $BASE_URL)
  if ($parent | is-empty) { error make --unspanned { msg: "path parameter 'parent' must be non-empty" } }
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $pretty_print "scalar") (serialize-qp "quotaUser" $quota_user "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $upload_type "scalar") (serialize-qp "pageSize" $page_size "scalar") (serialize-qp "pageToken" $page_token "scalar")] | flatten | str join "&"
  let full_url = (build-url $base ({parent: (encode-path-segment $parent)} | format pattern "/v2/{parent}/sshKeys") $qp $auth.query)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "get"
...
export def "ssh-keys create" [
  ...
  --upload-protocol: string # Upload protocol for media (e.g. "raw", "multipart").
  --upload-type: string # Legacy upload protocol for media (e.g. "media", "multipart").
  --ssh-key-id: string # Required. The ID to use for the key, which will become the final component of the key's resource name. This value must match the regex: [a-zA-Z0-9@.\-_]{1,64}
  --public-key: string # The public SSH key. This must be in OpenSSH .authorized_keys format.
]: any -> record<name: string, publicKey: string> {
  let input = $in
  let auth = (merge-auth [(build-auth ($token_oauth2 | default ($env | get -o BARE_METAL_SOLUTION_API_OAUTH2_TOKEN | default "")) "bearer") (build-auth ($token_oauth2c | default ($env | get -o BARE_METAL_SOLUTION_API_OAUTH2C_TOKEN | default "")) "bearer")])
  let base = ($base_url | default $BASE_URL)
  if ($parent | is-empty) { error make --unspanned { msg: "path parameter 'parent' must be non-empty" } }
  ...
  let req = {
    method: "post"
    url: $full_url
    query: ({"$.xgafv": $xgafv, "access_token": $access_token, "alt": $alt, "callback": $callback, "fields": $fields, "key": $key, "oauth_token": $oauth_token, "prettyPrint": $pretty_print, "quotaUser": $quota_user, "upload_protocol": $upload_protocol, "uploadType": $upload_type, "sshKeyId": $ssh_key_id} | compact)
    headers: $auth.headers
    body: $req_body
    content_type: "application/json"
    timeout: ($max_time | default 30min)
...
export def "volumes list" [
  ...
  --page-size: int # Requested page size. The server might return fewer items than requested. If unspecified, server will pick an appropriate default.
  --page-token: string # A token identifying a page of results from the server.
]: nothing -> record<nextPageToken: string, unreachable: list<string>, volumes: table<attached: bool, autoGrownSizeGib: string, bootVolume: bool, currentSizeGib: string, emergencySizeGib: string, expireTime: string, id: string, instances: list, labels: record, maxSizeGib: string, name: string, notes: string, originallyRequestedSizeGib: string, performanceTier: string, pod: string, protocol: string, remainingSpaceGib: string, requestedSizeGib: string, snapshotAutoDeleteBehavior: string, snapshotEnabled: bool, snapshotReservationDetail: record, snapshotSchedulePolicy: string, state: string, storageAggregatePool: string, storageType: string, workloadProfile: string>> {
  let auth = (merge-auth [(build-auth ($token_oauth2 | default ($env | get -o BARE_METAL_SOLUTION_API_OAUTH2_TOKEN | default "")) "bearer") (build-auth ($token_oauth2c | default ($env | get -o BARE_METAL_SOLUTION_API_OAUTH2C_TOKEN | default "")) "bearer")])
  let base = ($base_url | default $BASE_URL)
  if ($parent | is-empty) { error make --unspanned { msg: "path parameter 'parent' must be non-empty" } }
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $pretty_print "scalar") (serialize-qp "quotaUser" $quota_user "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $upload_type "scalar") (serialize-qp "filter" $filter "scalar") (serialize-qp "pageSize" $page_size "scalar") (serialize-qp "pageToken" $page_token "scalar")] | flatten | str join "&"
  let full_url = (build-url $base ({parent: (encode-path-segment $parent)} | format pattern "/v2/{parent}/volumes") $qp $auth.query)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "get"
...
export def "projects create-restore-volume-snapshot" [
  ...
  let auth = (merge-auth [(build-auth ($token_oauth2 | default ($env | get -o BARE_METAL_SOLUTION_API_OAUTH2_TOKEN | default "")) "bearer") (build-auth ($token_oauth2c | default ($env | get -o BARE_METAL_SOLUTION_API_OAUTH2C_TOKEN | default "")) "bearer")])
  let base = ($base_url | default $BASE_URL)
  if ($volume_snapshot | is-empty) { error make --unspanned { msg: "path parameter 'volumeSnapshot' must be non-empty" } }
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $pretty_print "scalar") (serialize-qp "quotaUser" $quota_user "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $upload_type "scalar")] | flatten | str join "&"
  let full_url = (build-url $base ({volume_snapshot: (encode-path-segment $volume_snapshot)} | format pattern "/v2/{volume_snapshot}:restoreVolumeSnapshot") $qp $auth.query)
  let req_body = $body
  let req_body = if ($input | describe | str starts-with "record") { $input | merge deep ($req_body | default {}) } else { $req_body }
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
...
export def "projects resize" [
  ...
  --upload-protocol: string # Upload protocol for media (e.g. "raw", "multipart").
  --upload-type: string # Legacy upload protocol for media (e.g. "media", "multipart").
  --size-gib: string # New Volume size, in GiB. (format: int64)
]: any -> record<done: bool, error: record<code: int, details: list<record>, message: string>, metadata: record, name: string, response: record> {
  let input = $in
  let auth = (merge-auth [(build-auth ($token_oauth2 | default ($env | get -o BARE_METAL_SOLUTION_API_OAUTH2_TOKEN | default "")) "bearer") (build-auth ($token_oauth2c | default ($env | get -o BARE_METAL_SOLUTION_API_OAUTH2C_TOKEN | default "")) "bearer")])
  let base = ($base_url | default $BASE_URL)
  if ($volume | is-empty) { error make --unspanned { msg: "path parameter 'volume' must be non-empty" } }
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $pretty_print "scalar") (serialize-qp "quotaUser" $quota_user "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $upload_type "scalar")] | flatten | str join "&"
  let full_url = (build-url $base ({volume: (encode-path-segment $volume)} | format pattern "/v2/{volume}:resize") $qp $auth.query)
