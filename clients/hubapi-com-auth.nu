# Auto-generated client for  vv1
# Source: https://api.apis.guru/v2/specs/hubapi.com/auth/v1/openapi.json
...
export def commands []: nothing -> table {
  ...
  let mod_name = (scope modules | where { $in.commands | any { $in.name == "oauth-access-tokens get-{token}-get" } } | get name | first)
...
export def "oauth-access-tokens get-{token}-get" [
  token_arg: string
...
export def "oauth-refresh-tokens get-{token}-get" [
  token_arg: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
...
export def "oauth-token create-create" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
