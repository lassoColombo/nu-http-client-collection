# Auto-generated client for CISCE v3.0.0
# Source: https://api.apis.guru/v2/specs/apisetu.gov.in/cisce/3.0.0/openapi.json
# Auth: --token flag or $env.CISCE_TOKEN

const BASE_URL = "https://apisetu.gov.in/cisce/v3"
const DEFAULT_AUTH = "x-apisetu-apikey"

# Build auth: returns {headers: record, query: string}
def build-auth [token?: string, auth_scheme?: string]: nothing -> record {
  let token_val = if ($token != null) and ($token | is-not-empty) { $token } else { $env | get -o CISCE_TOKEN | default "" }
...
def base-url-completer [] { ["https://apisetu.gov.in/cisce/v3"] }
...
export def "hpcer-certificate hpcer" [
  ...
  --certificate-parameters: record # shape: {CUID: string, DOB: string, FullName: string, IDXN: string, UID: string, YOE: string}
