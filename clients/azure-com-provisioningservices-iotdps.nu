...
export def "subscriptions-resource-groups-providers-microsoft-devices-provisioning-services-certificates delete-dps" [
  ...
  do-request "delete" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors $full "application/json" null {query: ({"certificate.name": $certificate_name, "certificate.rawBytes": $certificate_raw_bytes, "certificate.isVerified": $certificate_is_verified, "certificate.purpose": $certificate_purpose, "certificate.created": $certificate_created, "certificate.lastUpdated": $certificate_last_updated, "certificate.hasPrivateKey": $certificate_has_private_key, "certificate.nonce": $certificate_nonce, "api-version": $api_version} | compact), body: null}
}
...
export def "subscriptions-resource-groups-providers-microsoft-devices-provisioning-services-certificates-generate-verification-code generate-dps" [
  ...
  let extra_headers = {"If-Match": $if_match} | compact
  let auth = ($auth | update headers ($auth.headers | merge $extra_headers))
  do-request "post" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors $full "application/json" null {query: ({"certificate.name": $certificate_name, "certificate.rawBytes": $certificate_raw_bytes, "certificate.isVerified": $certificate_is_verified, "certificate.purpose": $certificate_purpose, "certificate.created": $certificate_created, "certificate.lastUpdated": $certificate_last_updated, "certificate.hasPrivateKey": $certificate_has_private_key, "certificate.nonce": $certificate_nonce, "api-version": $api_version} | compact), body: null}
}
...
export def "subscriptions-resource-groups-providers-microsoft-devices-provisioning-services-certificates-verify verify-dps" [
  ...
  let extra_headers = {"If-Match": $if_match} | compact
  let auth = ($auth | update headers ($auth.headers | merge $extra_headers))
  do-request "post" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors $full "application/json" $req_body {query: ({"certificate.name": $certificate_name, "certificate.rawBytes": $certificate_raw_bytes, "certificate.isVerified": $certificate_is_verified, "certificate.purpose": $certificate_purpose, "certificate.created": $certificate_created, "certificate.lastUpdated": $certificate_last_updated, "certificate.hasPrivateKey": $certificate_has_private_key, "certificate.nonce": $certificate_nonce, "api-version": $api_version} | compact), body: $req_body}
}
...
export def "subscriptions-resource-groups-providers-microsoft-devices-provisioning-services-operationresults get-iot-dps-operation-result" [
  ...
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "get" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors $full "application/json" null {query: ({"asyncinfo": $asyncinfo, "api-version": $api_version} | compact), body: null}
}
