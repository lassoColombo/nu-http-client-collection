...
def build-auth [token?: string, auth_scheme?: string]: nothing -> record {
  let token_val = if ($token | is-not-empty) { $token } else { $env | get -o KEYSERV_TOKEN | default "" }
...
export def "keys-api-current get" [
  ...
  let full_url = (build-url $base ({serial: (encode-path-segment $serial)} | format pattern "/v1/KeysApi/Current/{serial}") $auth.query)
...
export def "keys-api-custom get" [
  ...
  let base = ($base_url | default $BASE_URL)
  if ($serial | is-empty) { error make --unspanned { msg: "path parameter 'serial' must be non-empty" } }
  let full_url = (build-url $base ({serial: (encode-path-segment $serial)} | format pattern "/v1/KeysApi/Custom/{serial}") $auth.query)
...
export def "keys-api-expiry get" [
  ...
  let base = ($base_url | default $BASE_URL)
  if ($serial | is-empty) { error make --unspanned { msg: "path parameter 'serial' must be non-empty" } }
  let full_url = (build-url $base ({serial: (encode-path-segment $serial)} | format pattern "/v1/KeysApi/Expiry/{serial}") $auth.query)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "get"
...
export def "keys-api-find find" [
  ...
  let base = ($base_url | default $BASE_URL)
  if ($serial | is-empty) { error make --unspanned { msg: "path parameter 'serial' must be non-empty" } }
  let full_url = (build-url $base ({serial: (encode-path-segment $serial)} | format pattern "/v1/KeysApi/Find/{serial}") $auth.query)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "get"
...
export def "products-api update" [
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let full_url = (build-url $base "/v1/ProductsApi" $auth.query)
...
export def "products-api-count create" [
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let full_url = (build-url $base "/v1/ProductsApi/Count" $auth.query)
...
export def "products-api-find find" [
  ...
  let full_url = (build-url $base "/v1/ProductsApi/Find" $qp $auth.query)
...
export def "products-api-list list" [
  ...
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "page" $page "scalar")] | flatten | str join "&"
  let full_url = (build-url $base "/v1/ProductsApi/List" $qp $auth.query)
  let req_body = {"key": $key} | compact
  let req_body = if ($input | describe | str starts-with "record") { $input | merge deep ($req_body | default {}) } else { $req_body }
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
...
export def "products-api-save create" [
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let full_url = (build-url $base "/v1/ProductsApi/Save" $auth.query)
  let req_body = {"custom": $custom, "key": $key, "name": $name, "serial": $serial} | compact
  let req_body = if ($input | describe | str starts-with "record") { $input | merge deep ($req_body | default {}) } else { $req_body }
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
...
export def "products-api delete" [
  ...
  let base = ($base_url | default $BASE_URL)
  if ($serial | is-empty) { error make --unspanned { msg: "path parameter 'serial' must be non-empty" } }
  let full_url = (build-url $base ({serial: (encode-path-segment $serial)} | format pattern "/v1/ProductsApi/{serial}") $auth.query)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
...
export def "subscriptions-api update-subscription2" [
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let full_url = (build-url $base "/v1/SubscriptionsApi" $auth.query)
...
export def "subscriptions-api-count create" [
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let full_url = (build-url $base "/v1/SubscriptionsApi/Count" $auth.query)
  let req_body = {"key": $key, "serial": $serial} | compact
  let req_body = if ($input | describe | str starts-with "record") { $input | merge deep ($req_body | default {}) } else { $req_body }
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
...
export def "subscriptions-api-disable disable" [
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let full_url = (build-url $base "/v1/SubscriptionsApi/Disable" $auth.query)
  let req_body = {"key": $key, "serial": $serial} | compact
  let req_body = if ($input | describe | str starts-with "record") { $input | merge deep ($req_body | default {}) } else { $req_body }
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
...
export def "subscriptions-api-enable enable" [
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let full_url = (build-url $base "/v1/SubscriptionsApi/Enable" $auth.query)
  let req_body = {"key": $key, "serial": $serial} | compact
  let req_body = if ($input | describe | str starts-with "record") { $input | merge deep ($req_body | default {}) } else { $req_body }
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
...
export def "subscriptions-api-find find" [
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let full_url = (build-url $base "/v1/SubscriptionsApi/Find" $auth.query)
  let req_body = {"key": $key, "serial": $serial} | compact
  let req_body = if ($input | describe | str starts-with "record") { $input | merge deep ($req_body | default {}) } else { $req_body }
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
...
export def "subscriptions-api-list list" [
  ...
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "page" $page "scalar")] | flatten | str join "&"
  let full_url = (build-url $base "/v1/SubscriptionsApi/List" $qp $auth.query)
  let req_body = {"key": $key, "serial": $serial} | compact
  let req_body = if ($input | describe | str starts-with "record") { $input | merge deep ($req_body | default {}) } else { $req_body }
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
...
export def "subscriptions-api-save create" [
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let full_url = (build-url $base "/v1/SubscriptionsApi/Save" $auth.query)
  let req_body = {"action": $action, "callbackOnModify": $callback_on_modify, "callbackUrl": $callback_url, "custom": $custom, "frequency": $frequency, "key": $key, "name": $name, "serial": $serial, "startFrom": $start_from} | compact
  let req_body = if ($input | describe | str starts-with "record") { $input | merge deep ($req_body | default {}) } else { $req_body }
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
...
export def "subscriptions-api delete" [
  ...
  let full_url = (build-url $base ({serial: (encode-path-segment $serial)} | format pattern "/v1/SubscriptionsApi/{serial}") $qp $auth.query)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let extra_headers = {"X-Api-Key": $x_api_key} | compact
  let auth = ($auth | update headers ($auth.headers | merge $extra_headers))
