# Auto-generated client for TokenJay API services v1.0.0
# Source: https://api.apis.guru/v2/specs/tokenjay.app/1.0.0/openapi.json
# Auth: --token flag or $env.TOKENJAY_API_SERVICES_TOKEN

const BASE_URL = "https://api.tokenjay.app"
