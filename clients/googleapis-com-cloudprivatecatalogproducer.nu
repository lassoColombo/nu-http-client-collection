...
def build-auth [token?: string, auth_scheme?: string]: nothing -> record {
  let token_val = if ($token | is-not-empty) { $token } else { $env | get -o CLOUD_PRIVATE_CATALOG_PRODUCER_TOKEN | default "" }
...
export def "v1beta1-catalogs list" [
...
]: nothing -> record<catalogs: table<createTime: string, description: string, displayName: string, name: string, parent: string, updateTime: string>, nextPageToken: string> {
  let auth = (merge-auth [(build-auth ($token_oauth2 | default ($env | get -o CLOUD_PRIVATE_CATALOG_PRODUCER_OAUTH2_TOKEN | default "")) "bearer") (build-auth ($token_oauth2c | default ($env | get -o CLOUD_PRIVATE_CATALOG_PRODUCER_OAUTH2C_TOKEN | default "")) "bearer")])
  ...
  let full_url = (build-url $base "/v1beta1/catalogs" $qp $auth.query)
  let accept_val = "*/*"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "get"
    url: $full_url
    query: ({"alt": $alt, "key": $key, "access_token": $access_token, "upload_protocol": $upload_protocol, "prettyPrint": $pretty_print, "quotaUser": $quota_user, "fields": $fields, "uploadType": $upload_type, "$.xgafv": $xgafv, "oauth_token": $oauth_token, "callback": $callback, "pageSize": $page_size, "pageToken": $page_token, "parent": $parent} | compact)
...
export def "v1beta1-catalogs create" [
  ...
  let req = {
    method: "post"
    url: $full_url
    query: ({"alt": $alt, "key": $key, "access_token": $access_token, "upload_protocol": $upload_protocol, "prettyPrint": $pretty_print, "quotaUser": $quota_user, "fields": $fields, "uploadType": $upload_type, "$.xgafv": $xgafv, "oauth_token": $oauth_token, "callback": $callback} | compact)
    headers: $auth.headers
    body: $req_body
...
export def "v1beta1-operations list" [
  ...
  let full_url = (build-url $base "/v1beta1/operations" $qp $auth.query)
  let accept_val = "*/*"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "get"
    url: $full_url
    query: ({"alt": $alt, "key": $key, "access_token": $access_token, "upload_protocol": $upload_protocol, "prettyPrint": $pretty_print, "quotaUser": $quota_user, "fields": $fields, "uploadType": $upload_type, "$.xgafv": $xgafv, "oauth_token": $oauth_token, "callback": $callback, "filter": $filter, "name": $name, "pageSize": $page_size, "pageToken": $page_token} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "v1beta1 delete" [
  ...
  let req = {
    method: "delete"
    url: $full_url
    query: ({"alt": $alt, "key": $key, "access_token": $access_token, "upload_protocol": $upload_protocol, "prettyPrint": $pretty_print, "quotaUser": $quota_user, "fields": $fields, "uploadType": $upload_type, "$.xgafv": $xgafv, "oauth_token": $oauth_token, "callback": $callback, "force": $force} | compact)
    headers: $auth.headers
    body: null
    content_type: "application/json"
    timeout: ($max_time | default 30min)
...
export def "v1beta1 get" [
  ...
  --oauth-token: string # OAuth 2.0 token for the current user.
  --callback: string # JSONP
]: nothing -> record<asset: record, createTime: string, description: string, name: string, originalAsset: record, updateTime: string> {
  let auth = (merge-auth [(build-auth ($token_oauth2 | default ($env | get -o CLOUD_PRIVATE_CATALOG_PRODUCER_OAUTH2_TOKEN | default "")) "bearer") (build-auth ($token_oauth2c | default ($env | get -o CLOUD_PRIVATE_CATALOG_PRODUCER_OAUTH2C_TOKEN | default "")) "bearer")])
  let base = ($base_url | default $BASE_URL)
  if ($name | is-empty) { error make --unspanned { msg: "path parameter 'name' must be non-empty" } }
  let qp = [(serialize-qp "alt" $alt "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "prettyPrint" $pretty_print "scalar") (serialize-qp "quotaUser" $quota_user "scalar") (serialize-qp "fields" $fields "scalar") (serialize-qp "uploadType" $upload_type "scalar") (serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "callback" $callback "scalar")] | flatten | str join "&"
...
export def "v1beta1 update" [
...
]: any -> record<asset: record, createTime: string, description: string, name: string, originalAsset: record, updateTime: string> {
  let input = $in
  let auth = (merge-auth [(build-auth ($token_oauth2 | default ($env | get -o CLOUD_PRIVATE_CATALOG_PRODUCER_OAUTH2_TOKEN | default "")) "bearer") (build-auth ($token_oauth2c | default ($env | get -o CLOUD_PRIVATE_CATALOG_PRODUCER_OAUTH2C_TOKEN | default "")) "bearer")])
  let base = ($base_url | default $BASE_URL)
  if ($name | is-empty) { error make --unspanned { msg: "path parameter 'name' must be non-empty" } }
  ...
  let req = {
    method: "patch"
    url: $full_url
    query: ({"alt": $alt, "key": $key, "access_token": $access_token, "upload_protocol": $upload_protocol, "prettyPrint": $pretty_print, "quotaUser": $quota_user, "fields": $fields, "uploadType": $upload_type, "$.xgafv": $xgafv, "oauth_token": $oauth_token, "callback": $callback, "updateMask": $update_mask} | compact)
    headers: $auth.headers
    body: $req_body
    content_type: "application/json"
    timeout: ($max_time | default 30min)
...
export def "v1beta1 copy" [
  ...
  if ($name | is-empty) { error make --unspanned { msg: "path parameter 'name' must be non-empty" } }
  let qp = [(serialize-qp "alt" $alt "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "prettyPrint" $pretty_print "scalar") (serialize-qp "quotaUser" $quota_user "scalar") (serialize-qp "fields" $fields "scalar") (serialize-qp "uploadType" $upload_type "scalar") (serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "callback" $callback "scalar")] | flatten | str join "&"
  let full_url = (build-url $base ({name: (encode-path-segment $name)} | format pattern "/v1beta1/{name}:copy") $qp $auth.query)
...
export def "v1beta1 create-undelete" [
  ...
  --callback: string # JSONP
  --body: record
]: any -> record<createTime: string, description: string, displayName: string, name: string, parent: string, updateTime: string> {
  let input = $in
  let auth = (merge-auth [(build-auth ($token_oauth2 | default ($env | get -o CLOUD_PRIVATE_CATALOG_PRODUCER_OAUTH2_TOKEN | default "")) "bearer") (build-auth ($token_oauth2c | default ($env | get -o CLOUD_PRIVATE_CATALOG_PRODUCER_OAUTH2C_TOKEN | default "")) "bearer")])
  let base = ($base_url | default $BASE_URL)
  if ($name | is-empty) { error make --unspanned { msg: "path parameter 'name' must be non-empty" } }
...
]: nothing -> record<associations: table<createTime: string, name: string, resource: string>, nextPageToken: string> {
  let auth = (merge-auth [(build-auth ($token_oauth2 | default ($env | get -o CLOUD_PRIVATE_CATALOG_PRODUCER_OAUTH2_TOKEN | default "")) "bearer") (build-auth ($token_oauth2c | default ($env | get -o CLOUD_PRIVATE_CATALOG_PRODUCER_OAUTH2C_TOKEN | default "")) "bearer")])
  let base = ($base_url | default $BASE_URL)
  if ($parent | is-empty) { error make --unspanned { msg: "path parameter 'parent' must be non-empty" } }
  let qp = [(serialize-qp "alt" $alt "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "prettyPrint" $pretty_print "scalar") (serialize-qp "quotaUser" $quota_user "scalar") (serialize-qp "fields" $fields "scalar") (serialize-qp "uploadType" $upload_type "scalar") (serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "pageSize" $page_size "scalar") (serialize-qp "pageToken" $page_token "scalar")] | flatten | str join "&"
  let full_url = (build-url $base ({parent: (encode-path-segment $parent)} | format pattern "/v1beta1/{parent}/associations") $qp $auth.query)
  let accept_val = "*/*"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "get"
    url: $full_url
    query: ({"alt": $alt, "key": $key, "access_token": $access_token, "upload_protocol": $upload_protocol, "prettyPrint": $pretty_print, "quotaUser": $quota_user, "fields": $fields, "uploadType": $upload_type, "$.xgafv": $xgafv, "oauth_token": $oauth_token, "callback": $callback, "pageSize": $page_size, "pageToken": $page_token} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
]: any -> record<createTime: string, name: string, resource: string> {
  let input = $in
  let auth = (merge-auth [(build-auth ($token_oauth2 | default ($env | get -o CLOUD_PRIVATE_CATALOG_PRODUCER_OAUTH2_TOKEN | default "")) "bearer") (build-auth ($token_oauth2c | default ($env | get -o CLOUD_PRIVATE_CATALOG_PRODUCER_OAUTH2C_TOKEN | default "")) "bearer")])
  let base = ($base_url | default $BASE_URL)
  if ($parent | is-empty) { error make --unspanned { msg: "path parameter 'parent' must be non-empty" } }
...
export def "v1beta1-products list" [
  ...
  let full_url = (build-url $base ({parent: (encode-path-segment $parent)} | format pattern "/v1beta1/{parent}/products") $qp $auth.query)
  let accept_val = "*/*"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "get"
    url: $full_url
    query: ({"alt": $alt, "key": $key, "access_token": $access_token, "upload_protocol": $upload_protocol, "prettyPrint": $pretty_print, "quotaUser": $quota_user, "fields": $fields, "uploadType": $upload_type, "$.xgafv": $xgafv, "oauth_token": $oauth_token, "callback": $callback, "filter": $filter, "pageSize": $page_size, "pageToken": $page_token} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
]: any -> record<assetType: string, createTime: string, displayMetadata: record, iconUri: string, name: string, updateTime: string> {
  let input = $in
  let auth = (merge-auth [(build-auth ($token_oauth2 | default ($env | get -o CLOUD_PRIVATE_CATALOG_PRODUCER_OAUTH2_TOKEN | default "")) "bearer") (build-auth ($token_oauth2c | default ($env | get -o CLOUD_PRIVATE_CATALOG_PRODUCER_OAUTH2C_TOKEN | default "")) "bearer")])
  let base = ($base_url | default $BASE_URL)
  if ($parent | is-empty) { error make --unspanned { msg: "path parameter 'parent' must be non-empty" } }
...
]: nothing -> record<nextPageToken: string, versions: table<asset: record, createTime: string, description: string, name: string, originalAsset: record, updateTime: string>> {
  let auth = (merge-auth [(build-auth ($token_oauth2 | default ($env | get -o CLOUD_PRIVATE_CATALOG_PRODUCER_OAUTH2_TOKEN | default "")) "bearer") (build-auth ($token_oauth2c | default ($env | get -o CLOUD_PRIVATE_CATALOG_PRODUCER_OAUTH2C_TOKEN | default "")) "bearer")])
  let base = ($base_url | default $BASE_URL)
  if ($parent | is-empty) { error make --unspanned { msg: "path parameter 'parent' must be non-empty" } }
  let qp = [(serialize-qp "alt" $alt "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "prettyPrint" $pretty_print "scalar") (serialize-qp "quotaUser" $quota_user "scalar") (serialize-qp "fields" $fields "scalar") (serialize-qp "uploadType" $upload_type "scalar") (serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "pageSize" $page_size "scalar") (serialize-qp "pageToken" $page_token "scalar")] | flatten | str join "&"
...
export def "v1beta1-icons-upload upload" [
  ...
  let qp = [(serialize-qp "alt" $alt "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "prettyPrint" $pretty_print "scalar") (serialize-qp "quotaUser" $quota_user "scalar") (serialize-qp "fields" $fields "scalar") (serialize-qp "uploadType" $upload_type "scalar") (serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "callback" $callback "scalar")] | flatten | str join "&"
  let full_url = (build-url $base ({product: (encode-path-segment $product)} | format pattern "/v1beta1/{product}/icons:upload") $qp $auth.query)
...
export def "v1beta1 get-iam-policy" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"alt": $alt, "key": $key, "access_token": $access_token, "upload_protocol": $upload_protocol, "prettyPrint": $pretty_print, "quotaUser": $quota_user, "fields": $fields, "uploadType": $upload_type, "$.xgafv": $xgafv, "oauth_token": $oauth_token, "callback": $callback, "options.requestedPolicyVersion": $options_requested_policy_version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
