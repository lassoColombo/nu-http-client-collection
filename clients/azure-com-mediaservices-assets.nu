# Auto-generated client for Azure Media Services v2018-06-01-preview
# Source: https://api.apis.guru/v2/specs/azure.com/mediaservices-Assets/2018-06-01-preview/swagger.json
...
export def "subscriptions-resource-groups-providers-microsoft-media-media-services-assets-get-encryption-key get" [
  ...
  --dry-run(-n) # Return the request that would be sent without executing it
  --api-version: string # The Version of the API to be used with the client request.
]: nothing -> record<storageEncryptionKey: string> {
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "api-version" $api_version "scalar")] | flatten | str join "&"
