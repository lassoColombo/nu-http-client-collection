...
export def "connections connection" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
...
export def "connections-test connection" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
...
export def "connections connection-by-connection_id" [
...
export def "connections connection-by-connection_id-1" [
  connection_id: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
...
export def "connections connection-by-connection_id-2" [
  connection_id: any
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
...
export def "dag-warnings warnings" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
...
# GET /dags/{dag_id}
# operationId: get_dag
export def "dags dag-by-dag_id-1" [
  dag_id: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
...
# --tags item shape: {name?: string}
export def "dags dag-by-dag_id-2" [
  dag_id: any
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
...
export def "dags-clear-task-instances instances" [
  dag_id: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
...
export def "dags-dag-runs runs" [
  ...
  --state: list # The value can be repeated to retrieve multiple matching values (OR condition).
  --order-by: string # The name of the field to order the results by. Prefix a field name with `-` to reverse the sort order.  *New in version 2.1.0*
]: nothing -> record {
  let auth = (build-auth $token ($auth_scheme | default "basic"))
  let base = ($base_url | default $BASE_URL)
...
export def "dags-dag-runs run-by-dag_id" [
  dag_id: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
...
export def "dags-dag-runs run-by-dag_id-dag_run_id" [
  dag_id: string
  dag_run_id: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
...
export def "dags-dag-runs run-by-dag_id-dag_run_id-1" [
  dag_id: string
  dag_run_id: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
...
export def "dags-dag-runs state" [
  dag_id: string
  dag_run_id: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
...
export def "dags-dag-runs-clear run" [
  dag_id: string
  dag_run_id: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
...
export def "dags-dag-runs-set-note note" [
  dag_id: string
  dag_run_id: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
...
export def "dags-dag-runs-task-instances instances" [
  dag_id: any
  dag_run_id: any
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
...
export def "dags-dag-runs-task-instances instance-by-dag_id-dag_run_id-task_id" [
  dag_id: string
  dag_run_id: string
  task_id: string
  --base-url(-b): string@base-url-completer # API base URL
...
export def "dags-dag-runs-task-instances instance-by-dag_id-dag_run_id-task_id-1" [
  dag_id: string
  dag_run_id: string
  task_id: string
  --base-url(-b): string@base-url-completer # API base URL
...
export def "dags-dag-runs-task-instances-links links" [
  dag_id: string
  dag_run_id: string
  task_id: string
  --base-url(-b): string@base-url-completer # API base URL
...
export def "dags-dag-runs-task-instances-list-mapped instances" [
  dag_id: any
  dag_run_id: any
  task_id: any
  --base-url(-b): string@base-url-completer # API base URL
  ...
  --state: list # The value can be repeated to retrieve multiple matching values (OR condition).
  --pool: list # The value can be repeated to retrieve multiple matching values (OR condition).
  --queue: list # The value can be repeated to retrieve multiple matching values (OR condition).
  --order-by: string # The name of the field to order the results by. Prefix a field name with `-` to reverse the sort order.  *New in version 2.1.0*
]: nothing -> record {
  let auth = (build-auth $token ($auth_scheme | default "basic"))
  let base = ($base_url | default $BASE_URL)
...
# operationId: get_log
export def "dags-dag-runs-task-instances-logs log" [
  dag_id: string
  dag_run_id: string
  task_id: string
  task_try_number: int
...
export def "dags-dag-runs-task-instances-set-note note-by-dag_id-dag_run_id-task_id" [
  dag_id: string
  dag_run_id: string
  task_id: string
  --base-url(-b): string@base-url-completer # API base URL
...
export def "dags-dag-runs-task-instances-xcom-entries entries" [
  dag_id: any
  dag_run_id: any
  task_id: any
  --base-url(-b): string@base-url-completer # API base URL
...
export def "dags-dag-runs-task-instances-xcom-entries entry" [
  dag_id: string
  dag_run_id: string
  task_id: string
  xcom_key: string
...
export def "dags-dag-runs-task-instances instance-by-dag_id-dag_run_id-task_id-map_index" [
  dag_id: string
  dag_run_id: string
  task_id: string
  map_index: int
...
export def "dags-dag-runs-task-instances instance-by-dag_id-dag_run_id-task_id-map_index-1" [
  dag_id: string
  dag_run_id: string
  task_id: string
  map_index: int
...
export def "dags-dag-runs-task-instances-set-note note-by-dag_id-dag_run_id-task_id-map_index" [
  dag_id: string
  dag_run_id: string
  task_id: string
  map_index: int
...
export def "dags-dag-runs-upstream-dataset-events events" [
  dag_id: string
  dag_run_id: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
...
export def "dags-details details" [
  dag_id: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
...
export def "dags-update-task-instances-state state" [
  dag_id: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
...
export def "dags-dag-runs-list batch" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
  ...
  --start-date-lte: string # Returns objects less or equal the specified date.  This can be combined with start_date_gte parameter to receive only the selected period  (format: date-time)
  --states: list # Return objects with specific states. The value can be repeated to retrieve multiple matching values (OR condition).
]: any -> record {
  let input = $in
  let auth = (build-auth $token ($auth_scheme | default "basic"))
  let base = ($base_url | default $BASE_URL)
...
export def "dags-dag-runs-task-instances-list batch" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
...
export def "datasets-events events" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
...
export def "import-errors errors" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
...
export def "import-errors error" [
  import_error_id: int
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
...
export def "pools pool-by-pool_name" [
  pool_name: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
...
export def "pools pool-by-pool_name-1" [
  pool_name: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
...
export def "pools pool-by-pool_name-2" [
  pool_name: any
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
...
export def "roles role-by-role_name" [
  role_name: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
...
export def "roles role-by-role_name-1" [
  role_name: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
...
# --actions item shape: {action?: record, resource?: record}
export def "roles role-by-role_name-2" [
  role_name: any
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
...
export def "users user-by-username" [
  username: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
...
export def "users user-by-username-1" [
  username: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
...
# --roles item shape: {name?: string}
export def "users user-by-username-2" [
  username: any
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
...
export def "variables variable-by-variable_key" [
  variable_key: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
...
export def "variables variable-by-variable_key-1" [
  variable_key: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
...
export def "variables variable-by-variable_key-2" [
  variable_key: any
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
