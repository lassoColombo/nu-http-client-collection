...
export def commands []: nothing -> table {
  ...
  let mod_name = (scope modules | where { $in.commands | any { $in.name == "providers-microsoft-subscription-operations list" } } | get name | first)
...
export def "providers-microsoft-subscription-operations list" [
