...
# Source: https://api.apis.guru/v2/specs/azure.com/streamanalytics-inputs/2016-03-01/swagger.json
...
def build-auth [token?: string, auth_scheme?: string]: nothing -> record {
  let token_val = if ($token | is-not-empty) { $token } else { $env | get -o STREAMANALYTICSMANAGEMENTCLIENT_TOKEN | default "" }
...
export def commands []: nothing -> table {
  ...
  let mod_name = (scope modules | where { $in.commands | any { $in.name == "subscriptions-resourcegroups-providers-microsoft-stream-analytics-streamingjobs-inputs list-by-streaming-job" } } | get name | first)
...
export def "subscriptions-resourcegroups-providers-microsoft-stream-analytics-streamingjobs-inputs list-by-streaming-job" [
  ...
  let full_url = (build-url $base ({subscription_id: (encode-path-segment $subscription_id), resource_group_name: (encode-path-segment $resource_group_name), job_name: (encode-path-segment $job_name)} | format pattern "/subscriptions/{subscription_id}/resourcegroups/{resource_group_name}/providers/Microsoft.StreamAnalytics/streamingjobs/{job_name}/inputs") $qp $auth.query)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "get"
    url: $full_url
    query: ({"$select": $select, "api-version": $api_version} | compact)
...
export def "subscriptions-resourcegroups-providers-microsoft-stream-analytics-streamingjobs-inputs delete" [
  subscription_id: string
  resource_group_name: string
  job_name: string
  input_name: string
  ...
  let full_url = (build-url $base ({subscription_id: (encode-path-segment $subscription_id), resource_group_name: (encode-path-segment $resource_group_name), job_name: (encode-path-segment $job_name), input_name: (encode-path-segment $input_name)} | format pattern "/subscriptions/{subscription_id}/resourcegroups/{resource_group_name}/providers/Microsoft.StreamAnalytics/streamingjobs/{job_name}/inputs/{input_name}") $qp $auth.query)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "delete"
...
export def "subscriptions-resourcegroups-providers-microsoft-stream-analytics-streamingjobs-inputs get" [
  subscription_id: string
  resource_group_name: string
  job_name: string
  input_name: string
  ...
  --dry-run(-n) # Return the request that would be sent without executing it
  --api-version: string # Client Api Version.
]: nothing -> record<properties: record<diagnostics: record<conditions: list>, etag: string, serialization: record<type: string>, type: string>, id: string, name: string, type: string> {
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  if ($subscription_id | is-empty) { error make --unspanned { msg: "path parameter 'subscriptionId' must be non-empty" } }
  if ($resource_group_name | is-empty) { error make --unspanned { msg: "path parameter 'resourceGroupName' must be non-empty" } }
...
# --properties shape: {diagnostics?: any, serialization?: any, type: string}
export def "subscriptions-resourcegroups-providers-microsoft-stream-analytics-streamingjobs-inputs update" [
  subscription_id: string
  resource_group_name: string
  job_name: string
  input_name: string
  ...
  --properties: any # The properties that are associated with an input. — shape: {diagnostics?: any, serialization?: any, type: string}
  --name: string # Resource name
]: any -> record<properties: record<diagnostics: record<conditions: list>, etag: string, serialization: record<type: string>, type: string>, id: string, name: string, type: string> {
  let input = $in
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  if ($subscription_id | is-empty) { error make --unspanned { msg: "path parameter 'subscriptionId' must be non-empty" } }
...
# --properties shape: {diagnostics?: any, serialization?: any, type: string}
export def "subscriptions-resourcegroups-providers-microsoft-stream-analytics-streamingjobs-inputs create-or-update" [
  subscription_id: string
  resource_group_name: string
  job_name: string
  input_name: string
...
# --properties shape: {diagnostics?: any, serialization?: any, type: string}
export def "subscriptions-resourcegroups-providers-microsoft-stream-analytics-streamingjobs-inputs-test test" [
  subscription_id: string
  resource_group_name: string
  job_name: string
  input_name: string
