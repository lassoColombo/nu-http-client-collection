...
export def commands []: nothing -> table {
  ...
  let mod_name = (scope modules | where { $in.commands | any { $in.name == "subscriptions-providers-microsoft-network-azure-firewall-fqdn-tags ListAll" } } | get name | first)
...
export def "subscriptions-providers-microsoft-network-azure-firewall-fqdn-tags ListAll" [
  ...
  let full_url = (build-url $base $"/subscriptions/($subscriptionId)/providers/Microsoft.Network/azureFirewallFqdnTags" $qp)
