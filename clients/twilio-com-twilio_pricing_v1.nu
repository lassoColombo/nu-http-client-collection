...
# Source: https://api.apis.guru/v2/specs/twilio.com/twilio_pricing_v1/1.42.0/openapi.json
...
export def "messaging-countries list-country" [
  ...
  let full_url = (build-url $base "/v1/Messaging/Countries" $qp $auth.query)
...
export def "messaging-countries get-country" [
  ...
  let full_url = (build-url $base ({iso_country: (encode-path-segment $iso_country)} | format pattern "/v1/Messaging/Countries/{iso_country}") $auth.query)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "get"
...
export def "phone-numbers-countries list-country" [
  ...
  let base = ($base_url | default "https://pricing.twilio.com")
  let qp = [(serialize-qp "PageSize" $page_size "scalar") (serialize-qp "Page" $page "scalar") (serialize-qp "PageToken" $page_token "scalar")] | flatten | str join "&"
  let full_url = (build-url $base "/v1/PhoneNumbers/Countries" $qp $auth.query)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "get"
...
export def "phone-numbers-countries get-country" [
  ...
  let base = ($base_url | default "https://pricing.twilio.com")
  if ($iso_country | is-empty) { error make --unspanned { msg: "path parameter 'IsoCountry' must be non-empty" } }
  let full_url = (build-url $base ({iso_country: (encode-path-segment $iso_country)} | format pattern "/v1/PhoneNumbers/Countries/{iso_country}") $auth.query)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "get"
...
export def "voice-countries list-country" [
  ...
  let base = ($base_url | default "https://pricing.twilio.com")
  let qp = [(serialize-qp "PageSize" $page_size "scalar") (serialize-qp "Page" $page "scalar") (serialize-qp "PageToken" $page_token "scalar")] | flatten | str join "&"
  let full_url = (build-url $base "/v1/Voice/Countries" $qp $auth.query)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "get"
...
export def "voice-countries get-country" [
  ...
  let base = ($base_url | default "https://pricing.twilio.com")
  if ($iso_country | is-empty) { error make --unspanned { msg: "path parameter 'IsoCountry' must be non-empty" } }
  let full_url = (build-url $base ({iso_country: (encode-path-segment $iso_country)} | format pattern "/v1/Voice/Countries/{iso_country}") $auth.query)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "get"
...
export def "voice-numbers get" [
  ...
  let full_url = (build-url $base ({number: (encode-path-segment $number)} | format pattern "/v1/Voice/Numbers/{number}") $auth.query)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "get"
