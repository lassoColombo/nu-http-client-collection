...
export def "appstore-application-charges-json create" [
  ...
  let full_url = (build-url $base "/appstore/v1/application_charges.json" $auth.query)
...
export def "appstore-installation-json delete" [
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let full_url = (build-url $base "/appstore/v1/installation.json" $auth.query)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "delete"
...
export def "appstore-recurring-application-charges-usage-charges-json create" [
  ...
  let full_url = (build-url $base ({recurring_application_charge_id: (encode-path-segment $recurring_application_charge_id)} | format pattern "/appstore/v1/recurring_application_charges/{recurring_application_charge_id}/usage_charges.json") $auth.query)
...
export def "appstore-script-tags-json get-shop" [
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let full_url = (build-url $base "/appstore/v1/script_tags.json" $auth.query)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "get"
...
export def "appstore-script-tags delete" [
  ...
  let full_url = (build-url $base ({script_tag_id: (encode-path-segment $script_tag_id)} | format pattern "/appstore/v1/script_tags/{script_tag_id}.json") $auth.query)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "delete"
...
export def "inline-script-tags-json get" [
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let full_url = (build-url $base "/v1/inline_script_tags.json" $auth.query)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "get"
...
export def "inline-script-tags delete" [
  ...
  let full_url = (build-url $base ({inline_script_tag_id: (encode-path-segment $inline_script_tag_id)} | format pattern "/v1/inline_script_tags/{inline_script_tag_id}.json") $auth.query)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "delete"
...
export def "script-tags-json get" [
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let full_url = (build-url $base "/v1/script_tags.json" $auth.query)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "get"
...
export def "script-tags delete" [
  ...
  let base = ($base_url | default $BASE_URL)
  if ($script_tag_id | is-empty) { error make --unspanned { msg: "path parameter 'scriptTagId' must be non-empty" } }
  let full_url = (build-url $base ({script_tag_id: (encode-path-segment $script_tag_id)} | format pattern "/v1/script_tags/{script_tag_id}.json") $auth.query)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "delete"
