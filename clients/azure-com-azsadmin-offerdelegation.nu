...
export def "subscriptions-resourcegroups-providers-microsoft-subscriptions-admin-offers-offer-delegations List" [
  ...
  let full_url = (build-url $base $"/subscriptions/($subscriptionId)/resourcegroups/($resourceGroupName)/providers/Microsoft.Subscriptions.Admin/offers/($offer)/offerDelegations" $qp)
...
export def "subscriptions-resourcegroups-providers-microsoft-subscriptions-admin-offers-offer-delegations Delete" [
  ...
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "api-version" $api_version "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/subscriptions/($subscriptionId)/resourcegroups/($resourceGroupName)/providers/Microsoft.Subscriptions.Admin/offers/($offer)/offerDelegations/($offerDelegationName)" $qp)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
...
export def "subscriptions-resourcegroups-providers-microsoft-subscriptions-admin-offers-offer-delegations CreateOrUpdate" [
  subscriptionId: string
  resourceGroupName: string
  offer: string
  offerDelegationName: string
