...
export def "subscriptions-resourcegroups-providers-microsoft-subscriptions-admin-offers-offer-delegations list" [
  ...
  let full_url = (build-url $base ({subscription_id: $subscription_id, resource_group_name: $resource_group_name, offer: $offer} | format pattern "/subscriptions/{subscription_id}/resourcegroups/{resource_group_name}/providers/Microsoft.Subscriptions.Admin/offers/{offer}/offerDelegations") $qp)
...
export def "subscriptions-resourcegroups-providers-microsoft-subscriptions-admin-offers-offer-delegations delete" [
  ...
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "api-version" $api_version "scalar")] | flatten | str join "&"
  let full_url = (build-url $base ({subscription_id: $subscription_id, resource_group_name: $resource_group_name, offer: $offer, offer_delegation_name: $offer_delegation_name} | format pattern "/subscriptions/{subscription_id}/resourcegroups/{resource_group_name}/providers/Microsoft.Subscriptions.Admin/offers/{offer}/offerDelegations/{offer_delegation_name}") $qp)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
