...
def build-auth [token?: string, auth_scheme?: string]: nothing -> record {
  let token_val = if ($token != null) and ($token | is-not-empty) { $token } else { $env | get -o MICROSOFTSERIALCONSOLECLIENT_TOKEN | default "" }
...
export def "providers-microsoft-serial-console-operations list" [
  ...
  let full_url = (build-url $base "/providers/Microsoft.SerialConsole/operations" $qp)
...
export def "subscriptions-providers-microsoft-serial-console-console-services get-status" [
  ...
  let qp = [(serialize-qp "api-version" $api_version "scalar")] | flatten | str join "&"
  let full_url = (build-url $base ({subscription_id: (encode-path-segment $subscription_id), default: (encode-path-segment $default)} | format pattern "/subscriptions/{subscription_id}/providers/Microsoft.SerialConsole/consoleServices/{default}") $qp)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "get" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors $full "application/json" null {query: ({"api-version": $api_version} | compact), body: null}
}
...
export def "subscriptions-providers-microsoft-serial-console-console-services-disable-console disable" [
  ...
  if ($default | is-empty) { error make --unspanned { msg: "path parameter 'default' must be non-empty" } }
  let qp = [(serialize-qp "api-version" $api_version "scalar")] | flatten | str join "&"
  let full_url = (build-url $base ({subscription_id: (encode-path-segment $subscription_id), default: (encode-path-segment $default)} | format pattern "/subscriptions/{subscription_id}/providers/Microsoft.SerialConsole/consoleServices/{default}/disableConsole") $qp)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
...
export def "subscriptions-providers-microsoft-serial-console-console-services-enable-console enable" [
  ...
  if ($default | is-empty) { error make --unspanned { msg: "path parameter 'default' must be non-empty" } }
  let qp = [(serialize-qp "api-version" $api_version "scalar")] | flatten | str join "&"
  let full_url = (build-url $base ({subscription_id: (encode-path-segment $subscription_id), default: (encode-path-segment $default)} | format pattern "/subscriptions/{subscription_id}/providers/Microsoft.SerialConsole/consoleServices/{default}/enableConsole") $qp)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "post" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors $full "application/json" null {query: ({"api-version": $api_version} | compact), body: null}
}
