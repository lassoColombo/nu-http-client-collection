# Auto-generated client for CyCAT.org API v0.9
# Source: https://api.apis.guru/v2/specs/cycat.org/0.9/swagger.json
# Auth: --token flag or $env.CYCAT_ORG_API_TOKEN
...
def build-auth [token?: string, auth_scheme?: string]: nothing -> record {
  let token_val = if ($token | is-not-empty) { $token } else { $env | get -o CYCAT_ORG_API_TOKEN | default "" }
...
export def "child get" [
  ...
  let full_url = (build-url $base ({uuid: (encode-path-segment $uuid)} | format pattern "/child/{uuid}") $auth.query)
...
export def "generate-uuid get" [
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let full_url = (build-url $base "/generate/uuid" $auth.query)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "get"
...
export def "list-project get" [
  ...
  let full_url = (build-url $base ({start: (encode-path-segment $start), end: (encode-path-segment $end)} | format pattern "/list/project/{start}/{end}") $auth.query)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "get"
...
export def "list-publisher get" [
  ...
  if ($start | is-empty) { error make --unspanned { msg: "path parameter 'start' must be non-empty" } }
  if ($end | is-empty) { error make --unspanned { msg: "path parameter 'end' must be non-empty" } }
  let full_url = (build-url $base ({start: (encode-path-segment $start), end: (encode-path-segment $end)} | format pattern "/list/publisher/{start}/{end}") $auth.query)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "get"
...
export def "lookup get" [
  ...
  let base = ($base_url | default $BASE_URL)
  if ($uuid | is-empty) { error make --unspanned { msg: "path parameter 'uuid' must be non-empty" } }
  let full_url = (build-url $base ({uuid: (encode-path-segment $uuid)} | format pattern "/lookup/{uuid}") $auth.query)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "get"
...
export def "namespace-finduuid get-namespacefinduuid" [
  ...
  if ($namespaceid | is-empty) { error make --unspanned { msg: "path parameter 'namespaceid' must be non-empty" } }
  let full_url = (build-url $base ({namespace: (encode-path-segment $namespace), namespaceid: (encode-path-segment $namespaceid)} | format pattern "/namespace/finduuid/{namespace}/{namespaceid}") $auth.query)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "get"
...
export def "namespace-getall get-namespacegetall" [
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let full_url = (build-url $base "/namespace/getall" $auth.query)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "get"
...
export def "namespace-getid get-namespacegetid" [
  ...
  let base = ($base_url | default $BASE_URL)
  if ($namespace | is-empty) { error make --unspanned { msg: "path parameter 'namespace' must be non-empty" } }
  let full_url = (build-url $base ({namespace: (encode-path-segment $namespace)} | format pattern "/namespace/getid/{namespace}") $auth.query)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "get"
...
export def "parent get" [
  ...
  let base = ($base_url | default $BASE_URL)
  if ($uuid | is-empty) { error make --unspanned { msg: "path parameter 'uuid' must be non-empty" } }
  let full_url = (build-url $base ({uuid: (encode-path-segment $uuid)} | format pattern "/parent/{uuid}") $auth.query)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "get"
...
export def "propose create" [
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let full_url = (build-url $base "/propose" $auth.query)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "post"
...
export def "relationships-expanded get-relationshipsexpanded" [
  ...
  let base = ($base_url | default $BASE_URL)
  if ($uuid | is-empty) { error make --unspanned { msg: "path parameter 'uuid' must be non-empty" } }
  let full_url = (build-url $base ({uuid: (encode-path-segment $uuid)} | format pattern "/relationships/expanded/{uuid}") $auth.query)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "get"
...
export def "relationships get" [
  ...
  let base = ($base_url | default $BASE_URL)
  if ($uuid | is-empty) { error make --unspanned { msg: "path parameter 'uuid' must be non-empty" } }
  let full_url = (build-url $base ({uuid: (encode-path-segment $uuid)} | format pattern "/relationships/{uuid}") $auth.query)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "get"
...
export def "search get" [
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  if ($searchquery | is-empty) { error make --unspanned { msg: "path parameter 'searchquery' must be non-empty" } }
  let full_url = (build-url $base ({searchquery: (encode-path-segment $searchquery)} | format pattern "/search/{searchquery}") $auth.query)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "get"
