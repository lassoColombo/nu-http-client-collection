...
export def "subscriptions-resource-groups-providers-microsoft-media-media-services-content-key-policies List" [
  ...
  let full_url = (build-url $base $"/subscriptions/($subscriptionId)/resourceGroups/($resourceGroupName)/providers/Microsoft.Media/mediaServices/($accountName)/contentKeyPolicies" $qp)
...
export def "subscriptions-resource-groups-providers-microsoft-media-media-services-content-key-policies Delete" [
  ...
  let full_url = (build-url $base $"/subscriptions/($subscriptionId)/resourceGroups/($resourceGroupName)/providers/Microsoft.Media/mediaServices/($accountName)/contentKeyPolicies/($contentKeyPolicyName)" $qp)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
...
# --properties shape: {description?: string, options: list}
export def "subscriptions-resource-groups-providers-microsoft-media-media-services-content-key-policies CreateOrUpdate" [
  subscriptionId: string
  resourceGroupName: string
  accountName: string
  contentKeyPolicyName: string
...
export def "subscriptions-resource-groups-providers-microsoft-media-media-services-content-key-policies-get-policy-properties-with-secrets GetPolicyPropertiesWithSecrets" [
  subscriptionId: string
  resourceGroupName: string
  accountName: string
  contentKeyPolicyName: string
  ...
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "api-version" $api_version "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/subscriptions/($subscriptionId)/resourceGroups/($resourceGroupName)/providers/Microsoft.Media/mediaServices/($accountName)/contentKeyPolicies/($contentKeyPolicyName)/getPolicyPropertiesWithSecrets" $qp)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
