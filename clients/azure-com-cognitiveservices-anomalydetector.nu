...
export def commands []: nothing -> table {
  ...
  let mod_name = (scope modules | where { $in.commands | any { $in.name == "timeseries-change-point-detect post" } } | get name | first)
...
export def "timeseries-change-point-detect post" [
  ...
  let body = {"customInterval": $custom_interval, "granularity": $granularity, "period": $period, "series": $series, "stableTrendWindow": $stable_trend_window, "threshold": $threshold} | compact
