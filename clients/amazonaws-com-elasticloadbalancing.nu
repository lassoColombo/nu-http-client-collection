...
def build-auth [token?: string, auth_scheme?: string]: nothing -> record {
  let token_val = if ($token | is-not-empty) { $token } else { $env | get -o ELASTIC_LOAD_BALANCING_TOKEN | default "" }
...
export def "api get-create-tags" [
  ...
  --load-balancer-names: list # The name of the load balancer. You can specify one load balancer only.
  --tags: list # The tags.
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"LoadBalancerNames": $load_balancer_names, "Tags": $tags, "Action": $action, "Version": $version} | compact)
...
export def "api get-apply-security-groups-to-load-balancer" [
  ...
  --full(-F) # Return full response record {status, headers, body} while still raising on 4xx/5xx
  --dry-run(-n) # Return the request that would be sent without executing it
  --load-balancer-name: string # The name of the load balancer.
  --security-groups: list # The IDs of the security groups to associate with the load balancer. Note that you cannot specify the name of the security group.
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"LoadBalancerName": $load_balancer_name, "SecurityGroups": $security_groups, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api create-apply-security-groups-to-load-balancer" [
  ...
  --x-amz-signed-headers: string
  --body: any
]: any -> record<SecurityGroups: record> {
  let input = $in
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "Action" $action "scalar") (serialize-qp "Version" $version "scalar")] | flatten | str join "&"
...
export def "api get-attach-load-balancer-to-subnets" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"LoadBalancerName": $load_balancer_name, "Subnets": $subnets, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-configure-health-check" [
  ...
  --dry-run(-n) # Return the request that would be sent without executing it
  --load-balancer-name: string # The name of the load balancer.
  --health-check: record # The configuration information.
  ...
  --x-amz-signature: string
  --x-amz-signed-headers: string
]: nothing -> record<HealthCheck: record<Target: record, Interval: record, Timeout: record, UnhealthyThreshold: record, HealthyThreshold: record>> {
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"LoadBalancerName": $load_balancer_name, "HealthCheck": $health_check, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api create-configure-health-check" [
  ...
  --x-amz-signed-headers: string
  --body: any
]: any -> record<HealthCheck: record<Target: record, Interval: record, Timeout: record, UnhealthyThreshold: record, HealthyThreshold: record>> {
  let input = $in
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "Action" $action "scalar") (serialize-qp "Version" $version "scalar")] | flatten | str join "&"
...
export def "api get-create-app-cookie-stickiness-policy" [
  ...
  --dry-run(-n) # Return the request that would be sent without executing it
  --load-balancer-name: string # The name of the load balancer.
  --policy-name: string # The name of the policy being created. Policy names must consist of alphanumeric characters and dashes (-). This name must be unique within the set of policies for this load balancer.
  --cookie-name: string # The name of the application cookie used for stickiness.
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"LoadBalancerName": $load_balancer_name, "PolicyName": $policy_name, "CookieName": $cookie_name, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-create-lb-cookie-stickiness-policy" [
  ...
  --load-balancer-name: string # The name of the load balancer.
  --policy-name: string # The name of the policy being created. Policy names must consist of alphanumeric characters and dashes (-). This name must be unique within the set of policies for this load balancer.
  --cookie-expiration-period: int # The time period, in seconds, after which the cookie should be considered stale. If you do not specify this parameter, the default value is 0, which indicates that the sticky session should last for the duration of the browser session.
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"LoadBalancerName": $load_balancer_name, "PolicyName": $policy_name, "CookieExpirationPeriod": $cookie_expiration_period, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-create-load-balancer" [
  ...
  --full(-F) # Return full response record {status, headers, body} while still raising on 4xx/5xx
  --dry-run(-n) # Return the request that would be sent without executing it
  --load-balancer-name: string # The name of the load balancer. This name must be unique within your set of load balancers for the region, must have a maximum of 32 characters, must contain only alphanumeric characters or hyphens, and cannot begin or end with a hyphen.
  --listeners: list # The listeners. For more information, see Listeners for Your Classic Load Balancer (https://docs.aws.amazon.com/elasticloadbalancing/latest/classic/elb-listener-config.html) in the Classic Load Balancers Guide.
  --availability-zones: list # One or more Availability Zones from the same region as the load balancer. You must specify at least one Availability Zone. You can add more Availability Zones after you create the load balancer using EnableAvailabilityZonesForLoadBalancer.
  --subnets: list # The IDs of the subnets in your VPC to attach to the load balancer. Specify one subnet per Availability Zone specified in AvailabilityZones.
  --security-groups: list # The IDs of the security groups to assign to the load balancer.
  ...
  --tags: list # A list of tags to assign to the load balancer. For more information about tagging your load balancer, see Tag Your Classic Load Balancer (https://docs.aws.amazon.com/elasticloadbalancing/latest/classic/add-remove-tags.html) in the Classic Load Balancers Guide.
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"LoadBalancerName": $load_balancer_name, "Listeners": $listeners, "AvailabilityZones": $availability_zones, "Subnets": $subnets, "SecurityGroups": $security_groups, "Scheme": $scheme, "Tags": $tags, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-create-load-balancer-list-eners" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"LoadBalancerName": $load_balancer_name, "Listeners": $listeners, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-create-load-balancer-policy" [
  ...
  --dry-run(-n) # Return the request that would be sent without executing it
  --load-balancer-name: string # The name of the load balancer.
  --policy-name: string # The name of the load balancer policy to be created. This name must be unique within the set of policies for this load balancer.
  --policy-type-name: string # The name of the base policy type. To get the list of policy types, use DescribeLoadBalancerPolicyTypes.
  --policy-attributes: list # The policy attributes.
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"LoadBalancerName": $load_balancer_name, "PolicyName": $policy_name, "PolicyTypeName": $policy_type_name, "PolicyAttributes": $policy_attributes, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-delete-load-balancer" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"LoadBalancerName": $load_balancer_name, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-delete-load-balancer-list-eners" [
  ...
  --dry-run(-n) # Return the request that would be sent without executing it
  --load-balancer-name: string # The name of the load balancer.
  --load-balancer-ports: list # The client port numbers of the listeners.
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"LoadBalancerName": $load_balancer_name, "LoadBalancerPorts": $load_balancer_ports, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-delete-load-balancer-policy" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"LoadBalancerName": $load_balancer_name, "PolicyName": $policy_name, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-deregister-instances-from-load-balancer" [
  ...
  --x-amz-signature: string
  --x-amz-signed-headers: string
]: nothing -> record<Instances: record> {
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"LoadBalancerName": $load_balancer_name, "Instances": $instances, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-account-limits" [
  ...
  --x-amz-signature: string
  --x-amz-signed-headers: string
]: nothing -> record<Limits: record, NextMarker: record> {
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"Marker": $marker, "PageSize": $page_size, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api create-get-account-limits" [
  ...
  --x-amz-signed-headers: string
  --body: any
]: any -> record<Limits: record, NextMarker: record> {
  let input = $in
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "Action" $action "scalar") (serialize-qp "Version" $version "scalar")] | flatten | str join "&"
...
export def "api get-instance-health" [
  ...
  --x-amz-signature: string
  --x-amz-signed-headers: string
]: nothing -> record<InstanceStates: record> {
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "LoadBalancerName" $load_balancer_name "scalar") (serialize-qp "Instances" $instances "multi") (serialize-qp "Action" $action "scalar") (serialize-qp "Version" $version "scalar")] | flatten | str join "&"
  let full_url = (build-url $base "/" $qp $auth.query)
...
export def "api create-get-instance-health" [
  ...
  --x-amz-signed-headers: string
  --body: any
]: any -> record<InstanceStates: record> {
  let input = $in
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "Action" $action "scalar") (serialize-qp "Version" $version "scalar")] | flatten | str join "&"
...
export def "api get-load-balancer-attributes" [
  ...
  --x-amz-signature: string
  --x-amz-signed-headers: string
]: nothing -> record<LoadBalancerAttributes: record<CrossZoneLoadBalancing: record<Enabled: record>, AccessLog: record<Enabled: record, S3BucketName: record, EmitInterval: record, S3BucketPrefix: record>, ConnectionDraining: record<Enabled: record, Timeout: record>, ConnectionSettings: record<IdleTimeout: record>, AdditionalAttributes: record>> {
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "LoadBalancerName" $load_balancer_name "scalar") (serialize-qp "Action" $action "scalar") (serialize-qp "Version" $version "scalar")] | flatten | str join "&"
  let full_url = (build-url $base "/" $qp $auth.query)
...
export def "api create-get-load-balancer-attributes" [
  ...
  --x-amz-signed-headers: string
  --body: any
]: any -> record<LoadBalancerAttributes: record<CrossZoneLoadBalancing: record<Enabled: record>, AccessLog: record<Enabled: record, S3BucketName: record, EmitInterval: record, S3BucketPrefix: record>, ConnectionDraining: record<Enabled: record, Timeout: record>, ConnectionSettings: record<IdleTimeout: record>, AdditionalAttributes: record>> {
  let input = $in
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "Action" $action "scalar") (serialize-qp "Version" $version "scalar")] | flatten | str join "&"
...
export def "api get-load-balancer-policies" [
  ...
  --dry-run(-n) # Return the request that would be sent without executing it
  --load-balancer-name: string # The name of the load balancer.
  --policy-names: list # The names of the policies.
  ...
  --x-amz-signature: string
  --x-amz-signed-headers: string
]: nothing -> record<PolicyDescriptions: record> {
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"LoadBalancerName": $load_balancer_name, "PolicyNames": $policy_names, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api create-get-load-balancer-policies" [
  ...
  --x-amz-signed-headers: string
  --body: any
]: any -> record<PolicyDescriptions: record> {
  let input = $in
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "Action" $action "scalar") (serialize-qp "Version" $version "scalar")] | flatten | str join "&"
...
export def "api get-load-balancer-policy-types" [
  ...
  --full(-F) # Return full response record {status, headers, body} while still raising on 4xx/5xx
  --dry-run(-n) # Return the request that would be sent without executing it
  --policy-type-names: list # The names of the policy types. If no names are specified, describes all policy types defined by Elastic Load Balancing.
  ...
  --x-amz-signature: string
  --x-amz-signed-headers: string
]: nothing -> record<PolicyTypeDescriptions: record> {
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"PolicyTypeNames": $policy_type_names, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api create-get-load-balancer-policy-types" [
  ...
  --x-amz-signed-headers: string
  --body: any
]: any -> record<PolicyTypeDescriptions: record> {
  let input = $in
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "Action" $action "scalar") (serialize-qp "Version" $version "scalar")] | flatten | str join "&"
...
export def "api get-load-balancers" [
  ...
  --full(-F) # Return full response record {status, headers, body} while still raising on 4xx/5xx
  --dry-run(-n) # Return the request that would be sent without executing it
  --load-balancer-names: list # The names of the load balancers.
  --marker: string # The marker for the next set of results. (You received this marker from a previous call.)
  --page-size: int # The maximum number of results to return with this call (a number from 1 to 400). The default is 400.
  ...
  --x-amz-signature: string
  --x-amz-signed-headers: string
]: nothing -> record<LoadBalancerDescriptions: record, NextMarker: record> {
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"LoadBalancerNames": $load_balancer_names, "Marker": $marker, "PageSize": $page_size, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api create-get-load-balancers" [
  ...
  --x-amz-signed-headers: string
  --body: any
]: any -> record<LoadBalancerDescriptions: record, NextMarker: record> {
  let input = $in
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  ...
  let req = {
    method: "post"
    url: $full_url
    query: ({"Marker": $marker, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: $req_body
    content_type: "text/xml"
    timeout: ($max_time | default 30min)
...
export def "api get-tags" [
  ...
  --x-amz-signature: string
  --x-amz-signed-headers: string
]: nothing -> record<TagDescriptions: record> {
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"LoadBalancerNames": $load_balancer_names, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api create-get-tags" [
  ...
  --x-amz-signed-headers: string
  --body: any
]: any -> record<TagDescriptions: record> {
  let input = $in
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "Action" $action "scalar") (serialize-qp "Version" $version "scalar")] | flatten | str join "&"
...
export def "api get-disable-availability-zones-for-load-balancer" [
  ...
  --dry-run(-n) # Return the request that would be sent without executing it
  --load-balancer-name: string # The name of the load balancer.
  --availability-zones: list # The Availability Zones.
  ...
  --x-amz-signature: string
  --x-amz-signed-headers: string
]: nothing -> record<AvailabilityZones: record> {
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"LoadBalancerName": $load_balancer_name, "AvailabilityZones": $availability_zones, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api create-disable-availability-zones-for-load-balancer" [
  ...
  --x-amz-signed-headers: string
  --body: any
]: any -> record<AvailabilityZones: record> {
  let input = $in
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "Action" $action "scalar") (serialize-qp "Version" $version "scalar")] | flatten | str join "&"
...
export def "api get-enable-availability-zones-for-load-balancer" [
  ...
  --dry-run(-n) # Return the request that would be sent without executing it
  --load-balancer-name: string # The name of the load balancer.
  --availability-zones: list # The Availability Zones. These must be in the same region as the load balancer.
...
export def "api get-modify-load-balancer-attributes" [
  ...
  --dry-run(-n) # Return the request that would be sent without executing it
  --load-balancer-name: string # The name of the load balancer.
  --load-balancer-attributes: record # The attributes for the load balancer.
  ...
  --x-amz-signature: string
  --x-amz-signed-headers: string
]: nothing -> record<LoadBalancerName: record, LoadBalancerAttributes: record<CrossZoneLoadBalancing: record<Enabled: record>, AccessLog: record<Enabled: record, S3BucketName: record, EmitInterval: record, S3BucketPrefix: record>, ConnectionDraining: record<Enabled: record, Timeout: record>, ConnectionSettings: record<IdleTimeout: record>, AdditionalAttributes: record>> {
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"LoadBalancerName": $load_balancer_name, "LoadBalancerAttributes": $load_balancer_attributes, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-delete-tags" [
  ...
  --full(-F) # Return full response record {status, headers, body} while still raising on 4xx/5xx
  --dry-run(-n) # Return the request that would be sent without executing it
  --load-balancer-names: list # The name of the load balancer. You can specify a maximum of one load balancer name.
...
export def "api get-update-load-balancer-listener-ssl-certificate" [
  ...
  --dry-run(-n) # Return the request that would be sent without executing it
  --load-balancer-name: string # The name of the load balancer.
  --load-balancer-port: int # The port that uses the specified SSL certificate.
  --ssl-certificate-id: string # The Amazon Resource Name (ARN) of the SSL certificate.
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"LoadBalancerName": $load_balancer_name, "LoadBalancerPort": $load_balancer_port, "SSLCertificateId": $ssl_certificate_id, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-update-load-balancer-policies-for-backend-server" [
  ...
  --dry-run(-n) # Return the request that would be sent without executing it
  --load-balancer-name: string # The name of the load balancer.
  --instance-port: int # The port number associated with the EC2 instance.
  --policy-names: list # The names of the policies. If the list is empty, then all current polices are removed from the EC2 instance.
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"LoadBalancerName": $load_balancer_name, "InstancePort": $instance_port, "PolicyNames": $policy_names, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-update-load-balancer-policies-of-listener" [
  ...
  --dry-run(-n) # Return the request that would be sent without executing it
  --load-balancer-name: string # The name of the load balancer.
  --load-balancer-port: int # The external port of the load balancer.
  --policy-names: list # The names of the policies. This list must include all policies to be enabled. If you omit a policy that is currently enabled, it is disabled. If the list is empty, all current policies are disabled.
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"LoadBalancerName": $load_balancer_name, "LoadBalancerPort": $load_balancer_port, "PolicyNames": $policy_names, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
