...
def build-auth [token?: string, auth_scheme?: string]: nothing -> record {
  let token_val = if ($token | is-not-empty) { $token } else { $env | get -o GEOCODER_REST_API_TOKEN | default "" }
...
export def "intersections-near-output-format get" [
  ...
  let full_url = (build-url $base ({output_format: (encode-path-segment $output_format)} | format pattern "/intersections/near.{output_format}") $qp $auth.query)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "get"
    url: $full_url
    query: ({"point": $point, "maxDistance": $max_distance, "outputSRS": $output_srs, "maxResults": $max_results, "minDegree": $min_degree, "maxDegree": $max_degree} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "intersections-nearest-output-format get" [
  ...
  let full_url = (build-url $base ({output_format: (encode-path-segment $output_format)} | format pattern "/intersections/nearest.{output_format}") $qp $auth.query)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "get"
    url: $full_url
    query: ({"point": $point, "maxDistance": $max_distance, "outputSRS": $output_srs, "minDegree": $min_degree, "maxDegree": $max_degree} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "intersections-within-output-format get" [
  ...
  let full_url = (build-url $base ({output_format: (encode-path-segment $output_format)} | format pattern "/intersections/within.{output_format}") $qp $auth.query)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "get"
    url: $full_url
    query: ({"bbox": $bbox, "outputSRS": $output_srs, "maxResults": $max_results, "minDegree": $min_degree, "maxDegree": $max_degree} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "intersections get" [
  ...
  let full_url = (build-url $base ({intersection_id: (encode-path-segment $intersection_id), output_format: (encode-path-segment $output_format)} | format pattern "/intersections/{intersection_id}.{output_format}") $qp $auth.query)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "get"
    url: $full_url
    query: ({"outputSRS": $output_srs} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "occupants-addresses-output-format get" [
  ...
  let full_url = (build-url $base ({output_format: (encode-path-segment $output_format)} | format pattern "/occupants/addresses.{output_format}") $qp $auth.query)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "get"
    url: $full_url
    query: ({"addressString": $address_string, "tags": $tags, "locationDescriptor": $location_descriptor, "maxResults": $max_results, "interpolation": $interpolation, "echo": $echo, "brief": $brief, "autoComplete": $auto_complete, "setBack": $set_back, "outputSRS": $output_srs, "minScore": $min_score, "matchPrecision": $match_precision, "matchPrecisionNot": $match_precision_not, "siteName": $site_name, "unitDesignator": $unit_designator, "unitNumber": $unit_number, "unitNumberSuffix": $unit_number_suffix, "civicNumber": $civic_number, "civicNumberSuffix": $civic_number_suffix, "streetName": $street_name, "streetType": $street_type, "streetDirection": $street_direction, "streetQualifier": $street_qualifier, "localityName": $locality_name, "provinceCode": $province_code, "localities": $localities, "notLocalities": $not_localities, "bbox": $bbox, "centre": $centre, "maxDistance": $max_distance, "extrapolate": $extrapolate, "parcelPoint": $parcel_point} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "occupants-near-output-format get" [
  ...
  let full_url = (build-url $base ({output_format: (encode-path-segment $output_format)} | format pattern "/occupants/near.{output_format}") $qp $auth.query)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "get"
    url: $full_url
    query: ({"point": $point, "tags": $tags, "maxDistance": $max_distance, "outputSRS": $output_srs, "maxResults": $max_results, "locationDescriptor": $location_descriptor, "brief": $brief, "setBack": $set_back} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "occupants-nearest-output-format get" [
  ...
  let full_url = (build-url $base ({output_format: (encode-path-segment $output_format)} | format pattern "/occupants/nearest.{output_format}") $qp $auth.query)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "get"
    url: $full_url
    query: ({"point": $point, "maxDistance": $max_distance, "tags": $tags, "outputSRS": $output_srs, "locationDescriptor": $location_descriptor, "brief": $brief, "setBack": $set_back} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "occupants-within-output-format get" [
  ...
  let full_url = (build-url $base ({output_format: (encode-path-segment $output_format)} | format pattern "/occupants/within.{output_format}") $qp $auth.query)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "get"
    url: $full_url
    query: ({"bbox": $bbox, "tags": $tags, "outputSRS": $output_srs, "maxResults": $max_results, "locationDescriptor": $location_descriptor, "brief": $brief, "setBack": $set_back} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "occupants get" [
  ...
  let full_url = (build-url $base ({occupant_id: (encode-path-segment $occupant_id), output_format: (encode-path-segment $output_format)} | format pattern "/occupants/{occupant_id}.{output_format}") $qp $auth.query)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "get"
    url: $full_url
    query: ({"outputSRS": $output_srs, "locationDescriptor": $location_descriptor, "brief": $brief, "setBack": $set_back} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "parcels-pids get" [
  ...
  if ($output_format | is-empty) { error make --unspanned { msg: "path parameter 'outputFormat' must be non-empty" } }
  let full_url = (build-url $base ({site_id: (encode-path-segment $site_id), output_format: (encode-path-segment $output_format)} | format pattern "/parcels/pids/{site_id}.{output_format}") $auth.query)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "get"
...
export def "sites-near-output-format get" [
  ...
  let full_url = (build-url $base ({output_format: (encode-path-segment $output_format)} | format pattern "/sites/near.{output_format}") $qp $auth.query)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "get"
    url: $full_url
    query: ({"point": $point, "maxDistance": $max_distance, "outputSRS": $output_srs, "maxResults": $max_results, "locationDescriptor": $location_descriptor, "setBack": $set_back, "brief": $brief, "excludeUnits": $exclude_units, "onlyCivic": $only_civic} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "sites-nearest-output-format get" [
  ...
  let full_url = (build-url $base ({output_format: (encode-path-segment $output_format)} | format pattern "/sites/nearest.{output_format}") $qp $auth.query)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "get"
    url: $full_url
    query: ({"point": $point, "maxDistance": $max_distance, "outputSRS": $output_srs, "locationDescriptor": $location_descriptor, "setBack": $set_back, "brief": $brief, "excludeUnits": $exclude_units, "onlyCivic": $only_civic} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "sites-within-output-format get" [
  ...
  let full_url = (build-url $base ({output_format: (encode-path-segment $output_format)} | format pattern "/sites/within.{output_format}") $qp $auth.query)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "get"
    url: $full_url
    query: ({"bbox": $bbox, "outputSRS": $output_srs, "maxResults": $max_results, "locationDescriptor": $location_descriptor, "setBack": $set_back, "brief": $brief, "excludeUnits": $exclude_units, "onlyCivic": $only_civic} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "sites get" [
  ...
  if ($output_format | is-empty) { error make --unspanned { msg: "path parameter 'outputFormat' must be non-empty" } }
  let qp = [(serialize-qp "outputSRS" $output_srs "scalar") (serialize-qp "locationDescriptor" $location_descriptor "scalar") (serialize-qp "brief" $brief "scalar") (serialize-qp "setBack" $set_back "scalar")] | flatten | str join "&"
  let full_url = (build-url $base ({site_id: (encode-path-segment $site_id), output_format: (encode-path-segment $output_format)} | format pattern "/sites/{site_id}.{output_format}") $qp $auth.query)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "get"
...
export def "sites-subsites-output-format get" [
  ...
  if ($output_format | is-empty) { error make --unspanned { msg: "path parameter 'outputFormat' must be non-empty" } }
  let qp = [(serialize-qp "outputSRS" $output_srs "scalar") (serialize-qp "locationDescriptor" $location_descriptor "scalar") (serialize-qp "brief" $brief "scalar") (serialize-qp "setBack" $set_back "scalar")] | flatten | str join "&"
  let full_url = (build-url $base ({site_id: (encode-path-segment $site_id), output_format: (encode-path-segment $output_format)} | format pattern "/sites/{site_id}/subsites.{output_format}") $qp $auth.query)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "get"
