...
export def "translate Translate" [
  ...
  --includeAlignment: string@bool-completer # Specifies whether to include alignment projection from source text to translated text. Possible values are- `true` or `false` (default).
  --includeSentenceLength: string@bool-completer # Specifies whether to include sentence boundaries for the input text and the translated text. Possible values are- `true` or `false` (default).
