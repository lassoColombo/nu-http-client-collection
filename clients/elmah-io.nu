...
def build-auth [token?: string, auth_scheme?: string]: nothing -> record {
  let token_val = if ($token | is-not-empty) { $token } else { $env | get -o ELMAH_IO_API_TOKEN | default "" }
...
export def "deployments get-list" [
  ...
  let full_url = (build-url $base "/v3/deployments" $auth.query)
...
export def "deployments delete" [
  ...
  let full_url = (build-url $base ({id: (encode-path-segment $id)} | format pattern "/v3/deployments/{id}") $auth.query)
...
export def "heartbeats create" [
  ...
  if ($id | is-empty) { error make --unspanned { msg: "path parameter 'id' must be non-empty" } }
  let full_url = (build-url $base ({log_id: (encode-path-segment $log_id), id: (encode-path-segment $id)} | format pattern "/v3/heartbeats/{log_id}/{id}") $auth.query)
...
export def "logs get-list" [
  ...
  let auth = (build-auth $token ($auth_scheme | default "query-api_key"))
  let base = ($base_url | default $BASE_URL)
  let full_url = (build-url $base "/v3/logs" $auth.query)
  let accept_val = ($accept | default "application/json")
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "get"
...
export def "logs get" [
  ...
  let base = ($base_url | default $BASE_URL)
  if ($id | is-empty) { error make --unspanned { msg: "path parameter 'id' must be non-empty" } }
  let full_url = (build-url $base ({id: (encode-path-segment $id)} | format pattern "/v3/logs/{id}") $auth.query)
  let accept_val = ($accept | default "application/json")
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "get"
...
export def "logs-diagnose logs" [
  ...
  let base = ($base_url | default $BASE_URL)
  if ($id | is-empty) { error make --unspanned { msg: "path parameter 'id' must be non-empty" } }
  let full_url = (build-url $base ({id: (encode-path-segment $id)} | format pattern "/v3/logs/{id}/_diagnose") $auth.query)
  let accept_val = ($accept | default "application/json")
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "get"
...
export def "logs-disable logs" [
  ...
  let base = ($base_url | default $BASE_URL)
  if ($id | is-empty) { error make --unspanned { msg: "path parameter 'id' must be non-empty" } }
  let full_url = (build-url $base ({id: (encode-path-segment $id)} | format pattern "/v3/logs/{id}/_disable") $auth.query)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "post"
...
export def "logs-enable logs" [
  ...
  let base = ($base_url | default $BASE_URL)
  if ($id | is-empty) { error make --unspanned { msg: "path parameter 'id' must be non-empty" } }
  let full_url = (build-url $base ({id: (encode-path-segment $id)} | format pattern "/v3/logs/{id}/_enable") $auth.query)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "post"
...
export def "messages delete-list" [
  ...
  let base = ($base_url | default $BASE_URL)
  if ($log_id | is-empty) { error make --unspanned { msg: "path parameter 'logId' must be non-empty" } }
  let full_url = (build-url $base ({log_id: (encode-path-segment $log_id)} | format pattern "/v3/messages/{log_id}") $auth.query)
...
export def "messages get-list" [
  ...
  let full_url = (build-url $base ({log_id: (encode-path-segment $log_id)} | format pattern "/v3/messages/{log_id}") $qp $auth.query)
  let accept_val = ($accept | default "application/json")
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "get"
    url: $full_url
    query: ({"pageIndex": $page_index, "pageSize": $page_size, "query": $query, "from": $qp_from, "to": $qp_to, "includeHeaders": $include_headers} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "messages-bulk create" [
  ...
  let base = ($base_url | default $BASE_URL)
  if ($log_id | is-empty) { error make --unspanned { msg: "path parameter 'logId' must be non-empty" } }
  let full_url = (build-url $base ({log_id: (encode-path-segment $log_id)} | format pattern "/v3/messages/{log_id}/_bulk") $auth.query)
  let req_body = $body
...
export def "messages-fix list" [
  ...
  let base = ($base_url | default $BASE_URL)
  if ($log_id | is-empty) { error make --unspanned { msg: "path parameter 'logId' must be non-empty" } }
  let full_url = (build-url $base ({log_id: (encode-path-segment $log_id)} | format pattern "/v3/messages/{log_id}/_fix") $auth.query)
  let req_body = {"from": $body_from, "query": $query, "to": $body_to} | compact
  let req_body = if ($input | describe | str starts-with "record") { $input | merge deep ($req_body | default {}) } else { $req_body }
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
...
export def "messages delete" [
  ...
  if ($log_id | is-empty) { error make --unspanned { msg: "path parameter 'logId' must be non-empty" } }
  if ($id | is-empty) { error make --unspanned { msg: "path parameter 'id' must be non-empty" } }
  let full_url = (build-url $base ({log_id: (encode-path-segment $log_id), id: (encode-path-segment $id)} | format pattern "/v3/messages/{log_id}/{id}") $auth.query)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "delete"
...
export def "messages-fix create" [
  ...
  let full_url = (build-url $base ({log_id: (encode-path-segment $log_id), id: (encode-path-segment $id)} | format pattern "/v3/messages/{log_id}/{id}/_fix") $qp $auth.query)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "post"
    url: $full_url
    query: ({"markAllAsFixed": $mark_all_as_fixed} | compact)
    headers: $auth.headers
    body: null
    content_type: "application/json"
    timeout: ($max_time | default 30min)
...
export def "messages-hide create" [
  ...
  if ($log_id | is-empty) { error make --unspanned { msg: "path parameter 'logId' must be non-empty" } }
  if ($id | is-empty) { error make --unspanned { msg: "path parameter 'id' must be non-empty" } }
  let full_url = (build-url $base ({log_id: (encode-path-segment $log_id), id: (encode-path-segment $id)} | format pattern "/v3/messages/{log_id}/{id}/_hide") $auth.query)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "post"
...
export def "sourcemaps create-source-maps-or-update" [
  ...
  let base = ($base_url | default $BASE_URL)
  if ($log_id | is-empty) { error make --unspanned { msg: "path parameter 'logId' must be non-empty" } }
  let full_url = (build-url $base ({log_id: (encode-path-segment $log_id)} | format pattern "/v3/sourcemaps/{log_id}") $auth.query)
...
export def "uptimechecks get-uptime-checks-list" [
  ...
  let auth = (build-auth $token ($auth_scheme | default "query-api_key"))
  let base = ($base_url | default $BASE_URL)
  let full_url = (build-url $base "/v3/uptimechecks" $auth.query)
  let accept_val = ($accept | default "application/json")
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "get"
