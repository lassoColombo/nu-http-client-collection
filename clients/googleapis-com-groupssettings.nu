...
export def "groups get" [
  ...
  let full_url = (build-url $base ({group_unique_id: (encode-path-segment $group_unique_id)} | format pattern "/{group_unique_id}") $qp)
...
export def "groups update-by-groupUniqueId" [
  group_unique_id: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
...
export def "groups update-by-groupUniqueId-1" [
  group_unique_id: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
