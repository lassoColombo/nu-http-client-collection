...
def base-url-completer [] { ["https://vtex.local" "https://api.vtex.com/{accountName}" "https://api.vtex.com/DefaultParameterValue/pricing" "https://api.vtex.com/{account}/pricing"] }
