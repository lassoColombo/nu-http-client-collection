...
export def "api get-create-listener-certificates" [
...
]: nothing -> record<Certificates: record> {
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"ListenerArn": $listener_arn, "Certificates": $certificates, "Action": $action, "Version": $version} | compact)
...
export def "api get-create-tags" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"ResourceArns": $resource_arns, "Tags": $tags, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-create-listener" [
  ...
  --x-amz-signature: string
  --x-amz-signed-headers: string
]: nothing -> record<Listeners: record> {
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"LoadBalancerArn": $load_balancer_arn, "Protocol": $protocol, "Port": $port, "SslPolicy": $ssl_policy, "Certificates": $certificates, "DefaultActions": $default_actions, "AlpnPolicy": $alpn_policy, "Tags": $tags, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-create-load-balancer" [
  ...
  --x-amz-signature: string
  --x-amz-signed-headers: string
]: nothing -> record<LoadBalancers: record> {
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"Name": $name, "Subnets": $subnets, "SubnetMappings": $subnet_mappings, "SecurityGroups": $security_groups, "Scheme": $scheme, "Tags": $tags, "Type": $type, "IpAddressType": $ip_address_type, "CustomerOwnedIpv4Pool": $customer_owned_ipv4_pool, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api create-load-balancer" [
  ...
  --x-amz-signed-headers: string
  --body: any
]: any -> record<LoadBalancers: record> {
  let input = $in
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "Action" $action "scalar") (serialize-qp "Version" $version "scalar")] | flatten | str join "&"
...
export def "api get-create-rule" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"ListenerArn": $listener_arn, "Conditions": $conditions, "Priority": $priority, "Actions": $actions, "Tags": $tags, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-create-target-group" [
  ...
  --x-amz-signature: string
  --x-amz-signed-headers: string
]: nothing -> record<TargetGroups: record> {
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
...
export def "api create-target-group" [
  ...
  --x-amz-signed-headers: string
  --body: any
]: any -> record<TargetGroups: record> {
  let input = $in
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "Action" $action "scalar") (serialize-qp "Version" $version "scalar")] | flatten | str join "&"
...
export def "api get-delete-listener" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"ListenerArn": $listener_arn, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-delete-load-balancer" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"LoadBalancerArn": $load_balancer_arn, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-delete-rule" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"RuleArn": $rule_arn, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-delete-target-group" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"TargetGroupArn": $target_group_arn, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-deregister-targets" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"TargetGroupArn": $target_group_arn, "Targets": $targets, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-listener-certificates" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"ListenerArn": $listener_arn, "Marker": $marker, "PageSize": $page_size, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api create-get-listener-certificates" [
  ...
  --x-amz-signed-headers: string
  --body: any
]: any -> record<Certificates: record, NextMarker: record> {
  let input = $in
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "Action" $action "scalar") (serialize-qp "Version" $version "scalar")] | flatten | str join "&"
...
export def "api get-list-eners" [
  ...
  --x-amz-signature: string
  --x-amz-signed-headers: string
]: nothing -> record<Listeners: record, NextMarker: record> {
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"LoadBalancerArn": $load_balancer_arn, "ListenerArns": $listener_arns, "Marker": $marker, "PageSize": $page_size, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api create-get-list-eners" [
  ...
  --x-amz-signed-headers: string
  --body: any
]: any -> record<Listeners: record, NextMarker: record> {
  let input = $in
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
...
export def "api get-load-balancers" [
  ...
  --x-amz-signature: string
  --x-amz-signed-headers: string
]: nothing -> record<LoadBalancers: record, NextMarker: record> {
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"LoadBalancerArns": $load_balancer_arns, "Names": $names, "Marker": $marker, "PageSize": $page_size, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api create-get-load-balancers" [
  ...
  --x-amz-signed-headers: string
  --body: any
]: any -> record<LoadBalancers: record, NextMarker: record> {
  let input = $in
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "Marker" $marker "scalar") (serialize-qp "Action" $action "scalar") (serialize-qp "Version" $version "scalar")] | flatten | str join "&"
...
export def "api get-rules" [
  ...
  --x-amz-signature: string
  --x-amz-signed-headers: string
]: nothing -> record<Rules: record, NextMarker: record> {
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"ListenerArn": $listener_arn, "RuleArns": $rule_arns, "Marker": $marker, "PageSize": $page_size, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api create-get-rules" [
  ...
  --x-amz-signed-headers: string
  --body: any
]: any -> record<Rules: record, NextMarker: record> {
  let input = $in
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "Action" $action "scalar") (serialize-qp "Version" $version "scalar")] | flatten | str join "&"
...
export def "api get-ssl-policies" [
  ...
  --x-amz-signature: string
  --x-amz-signed-headers: string
]: nothing -> record<SslPolicies: record, NextMarker: record> {
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"Names": $names, "Marker": $marker, "PageSize": $page_size, "LoadBalancerType": $load_balancer_type, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api create-get-ssl-policies" [
  ...
  --x-amz-signed-headers: string
  --body: any
]: any -> record<SslPolicies: record, NextMarker: record> {
  let input = $in
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "Action" $action "scalar") (serialize-qp "Version" $version "scalar")] | flatten | str join "&"
...
export def "api get-tags" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"ResourceArns": $resource_arns, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-target-groups" [
  ...
  --x-amz-signature: string
  --x-amz-signed-headers: string
]: nothing -> record<TargetGroups: record, NextMarker: record> {
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"LoadBalancerArn": $load_balancer_arn, "TargetGroupArns": $target_group_arns, "Names": $names, "Marker": $marker, "PageSize": $page_size, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api create-get-target-groups" [
  ...
  --x-amz-signed-headers: string
  --body: any
]: any -> record<TargetGroups: record, NextMarker: record> {
  let input = $in
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "Marker" $marker "scalar") (serialize-qp "Action" $action "scalar") (serialize-qp "Version" $version "scalar")] | flatten | str join "&"
...
export def "api get-target-health" [
  ...
  --x-amz-signature: string
  --x-amz-signed-headers: string
]: nothing -> record<TargetHealthDescriptions: record> {
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "TargetGroupArn" $target_group_arn "scalar") (serialize-qp "Targets" $targets "multi") (serialize-qp "Action" $action "scalar") (serialize-qp "Version" $version "scalar")] | flatten | str join "&"
  let full_url = (build-url $base "/" $qp $auth.query)
...
export def "api create-get-target-health" [
  ...
  --x-amz-signed-headers: string
  --body: any
]: any -> record<TargetHealthDescriptions: record> {
  let input = $in
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "Action" $action "scalar") (serialize-qp "Version" $version "scalar")] | flatten | str join "&"
...
export def "api get-modify-listener" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"ListenerArn": $listener_arn, "Port": $port, "Protocol": $protocol, "SslPolicy": $ssl_policy, "Certificates": $certificates, "DefaultActions": $default_actions, "AlpnPolicy": $alpn_policy, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-modify-load-balancer-attributes" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"LoadBalancerArn": $load_balancer_arn, "Attributes": $attributes, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-modify-rule" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"RuleArn": $rule_arn, "Conditions": $conditions, "Actions": $actions, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-modify-target-group" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"TargetGroupArn": $target_group_arn, "HealthCheckProtocol": $health_check_protocol, "HealthCheckPort": $health_check_port, "HealthCheckPath": $health_check_path, "HealthCheckEnabled": $health_check_enabled, "HealthCheckIntervalSeconds": $health_check_interval_seconds, "HealthCheckTimeoutSeconds": $health_check_timeout_seconds, "HealthyThresholdCount": $healthy_threshold_count, "UnhealthyThresholdCount": $unhealthy_threshold_count, "Matcher": $matcher, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-modify-target-group-attributes" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"TargetGroupArn": $target_group_arn, "Attributes": $attributes, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-delete-tags" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"ResourceArns": $resource_arns, "TagKeys": $tag_keys, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-update-ip-address-type" [
  ...
  --x-amz-signature: string
  --x-amz-signed-headers: string
]: nothing -> record<IpAddressType: record> {
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"LoadBalancerArn": $load_balancer_arn, "IpAddressType": $ip_address_type, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api create-update-ip-address-type" [
  ...
  --x-amz-signed-headers: string
  --body: any
]: any -> record<IpAddressType: record> {
  let input = $in
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "Action" $action "scalar") (serialize-qp "Version" $version "scalar")] | flatten | str join "&"
...
export def "api get-update-rule-priorities" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"RulePriorities": $rule_priorities, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-update-security-groups" [
  ...
  --x-amz-signature: string
  --x-amz-signed-headers: string
]: nothing -> record<SecurityGroupIds: record> {
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"LoadBalancerArn": $load_balancer_arn, "SecurityGroups": $security_groups, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api create-update-security-groups" [
  ...
  --x-amz-signed-headers: string
  --body: any
]: any -> record<SecurityGroupIds: record> {
  let input = $in
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "Action" $action "scalar") (serialize-qp "Version" $version "scalar")] | flatten | str join "&"
...
export def "api get-update-subnets" [
  ...
  --x-amz-signature: string
  --x-amz-signed-headers: string
]: nothing -> record<AvailabilityZones: record, IpAddressType: record> {
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"LoadBalancerArn": $load_balancer_arn, "Subnets": $subnets, "SubnetMappings": $subnet_mappings, "IpAddressType": $ip_address_type, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api create-update-subnets" [
  ...
  --x-amz-signed-headers: string
  --body: any
]: any -> record<AvailabilityZones: record, IpAddressType: record> {
  let input = $in
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "Action" $action "scalar") (serialize-qp "Version" $version "scalar")] | flatten | str join "&"
