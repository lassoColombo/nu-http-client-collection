...
# Source: https://api.apis.guru/v2/specs/azure.com/network-operation/2019-07-01/swagger.json
...
export def commands []: nothing -> table {
  ...
  let mod_name = (scope modules | where { $in.commands | any { $in.name == "providers-microsoft-network-operations list" } } | get name | first)
...
export def "providers-microsoft-network-operations list" [
  ...
  let full_url = (build-url $base "/providers/Microsoft.Network/operations" $qp $auth.query)
