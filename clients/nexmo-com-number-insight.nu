...
export def "advanced-async get-number-insight" [
  ...
  do-request "get" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors $full "application/json" null {query: ({"callback": $callback, "number": $number, "country": $country, "cnam": $cnam, "ip": $ip} | compact), body: null}
}
...
export def "advanced get-number-insight" [
  ...
  let accept_val = ($accept | default "application/json")
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "get" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors $full "application/json" null {query: ({"real_time_data": $real_time_data, "number": $number, "country": $country, "cnam": $cnam, "ip": $ip} | compact), body: null}
}
...
export def "basic get-number-insight" [
  ...
  let accept_val = ($accept | default "application/json")
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "get" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors $full "application/json" null {query: ({"number": $number, "country": $country} | compact), body: null}
}
...
export def "standard get-number-insight" [
  ...
  let accept_val = ($accept | default "application/json")
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "get" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors $full "application/json" null {query: ({"number": $number, "country": $country, "cnam": $cnam} | compact), body: null}
}
