...
export def commands []: nothing -> table {
  ...
  let mod_name = (scope modules | where { $in.commands | any { $in.name == "payments-aspsps post" } } | get name | first)
...
export def "payments-aspsps post" [
...
export def "payments-consents-raw post" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
...
export def "payments-cross-border-credit-transfers post" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
...
# --requestInfo shape: {aspspId: string, flags?: list, merchant?: record, tppRedirectURI: string, xRequestId: string}
export def "payments-cross-border-credit-transfers-consents post" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
...
# --requestInfo shape: {aspspId: string, consentId: string, merchant?: record, xRequestId: string}
export def "payments-cross-border-credit-transfers-payment-status post" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
...
# --requestInfo shape: {aspspId: string, authorization: string, merchant?: record, xRequestId: string}
export def "payments-domestic-credit-transfers post" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
...
# --requestInfo shape: {aspspId: string, flags?: list, merchant?: record, tppRedirectURI: string, xRequestId: string}
export def "payments-domestic-credit-transfers-consents post" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
...
# --requestInfo shape: {aspspId: string, consentId: string, merchant?: record, xRequestId: string}
export def "payments-domestic-credit-transfers-payment-status post" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
...
# --requestInfo shape: {aspspId: string, authorization: string, merchant?: record, xRequestId: string}
export def "payments-sepa-credit-transfers post" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
...
# --requestInfo shape: {aspspId: string, flags?: list, merchant?: record, tppRedirectURI: string, xRequestId: string}
export def "payments-sepa-credit-transfers-consents post" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
...
# --requestInfo shape: {aspspId: string, consentId: string, merchant?: record, xRequestId: string}
export def "payments-sepa-credit-transfers-payment-status post" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
