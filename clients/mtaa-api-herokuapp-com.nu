# Auto-generated client for Mtaa API Documentation v1.0
# Source: https://api.apis.guru/v2/specs/mtaa-api.herokuapp.com/1.0/openapi.json
# Auth: --token flag or $env.MTAA_API_DOCUMENTATION_TOKEN

const BASE_URL = "https://mtaa-api.herokuapp.com/api"

# Build auth: returns {scheme: string, headers: record, query: string, location: string}.
# `location` is "header" | "query" | "cookie" | "none" and tells dry-run callers
# where the token went without inspecting headers/query themselves.
def build-auth [token?: string, auth_scheme?: string]: nothing -> record {
  let token_val = if ($token != null) and ($token | is-not-empty) { $token } else { $env | get -o MTAA_API_DOCUMENTATION_TOKEN | default "" }
...
def base-url-completer [] { ["https://mtaa-api.herokuapp.com/api"] }
...
export def "wards-in-a-district get" [
  ...
  if ($country | is-empty) { error make --unspanned { msg: "path parameter 'country' must be non-empty" } }
  if ($region | is-empty) { error make --unspanned { msg: "path parameter 'region' must be non-empty" } }
  if ($district | is-empty) { error make --unspanned { msg: "path parameter 'district' must be non-empty" } }
...
export def "streets-in-a-ward get" [
  ...
  if ($region | is-empty) { error make --unspanned { msg: "path parameter 'region' must be non-empty" } }
  if ($district | is-empty) { error make --unspanned { msg: "path parameter 'district' must be non-empty" } }
  if ($ward | is-empty) { error make --unspanned { msg: "path parameter 'ward' must be non-empty" } }
...
export def "neighborhood-in-a-street get" [
  ...
  if ($district | is-empty) { error make --unspanned { msg: "path parameter 'district' must be non-empty" } }
  if ($ward | is-empty) { error make --unspanned { msg: "path parameter 'ward' must be non-empty" } }
  if ($street | is-empty) { error make --unspanned { msg: "path parameter 'street' must be non-empty" } }
