...
def deploymentState-completer [] { ["DEPLOYED" "DEPLOYMENT_STATE_UNSPECIFIED" "UNDEPLOYED"] }

# List all available API commands with their parameters
export def commands []: nothing -> table {
  let builtin_flags = ["base-url" "token" "auth-scheme" "insecure" "max-time" "raw" "allow-errors" "dry-run" "accept" "help"]
  let mod_name = (scope modules | where { $in.commands | any { $in.name == "v1beta1 automlprojectslocationsoperationsdelete" } } | get name | first)
...
export def "v1beta1 automlprojectslocationsoperationsdelete" [
  name: string
...
export def "v1beta1 automlprojectslocationsoperationsget" [
  name: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar") (serialize-qp "fieldMask" $fieldMask "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v1beta1/($name)" $qp)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
...
export def "v1beta1 automlprojectslocationsdatasetstableSpecscolumnSpecspatch" [
  name: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  ...
  --dataStats: record # The data statistics of a series of values that share the same DataType. — shape: {arrayStats?: record, categoryStats?: record, distinctValueCount?: string, float64Stats?: record, nullValueCount?: string, stringStats?: record, structStats?: record, timestampStats?: record, validValueCount?: string}
  --dataType: record # Indicated the type of data that can be stored in a structured data entity (e.g. a table). — shape: {listElementType?: record, nullable?: bool, structType?: record, timeFormat?: string, typeCode?: "TYPE_CODE_UNSPECIFIED"|"FLOAT64"|"TIMESTAMP"|"STRING"|"ARRAY"|"STRUCT"|"CATEGORY"}
  ...
  --topCorrelatedColumns: list # Deprecated. — item shape: {columnSpecId?: string, correlationStats?: record}
  ...
  let full_url = (build-url $base $"/v1beta1/($name)" $qp)
  let body = {dataStats: $dataStats, dataType: $dataType, displayName: $displayName, etag: $etag, name: $body_name, topCorrelatedColumns: $topCorrelatedColumns} | compact
...
export def "v1beta1-locations automlprojectslocationslist" [
  name: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
...
export def "v1beta1-operations automlprojectslocationsoperationslist" [
  name: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
...
export def "v1beta1 automlprojectslocationsmodelsbatchPredict" [
  name: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  ...
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v1beta1/($name):batchPredict" $qp)
  let body = {inputConfig: $inputConfig, outputConfig: $outputConfig, params: $params} | compact
  let body = if ($input | describe | str starts-with "record") { $input | merge deep ($body | default {}) } else { $body }
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
...
export def "v1beta1 automlprojectslocationsoperationscancel" [
  name: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
...
export def "v1beta1 automlprojectslocationsmodelsdeploy" [
  name: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  ...
  --upload-protocol: string # Upload protocol for media (e.g. "raw", "multipart").
  --uploadType: string # Legacy upload protocol for media (e.g. "media", "multipart").
  --imageClassificationModelDeploymentMetadata: record # Model deployment metadata specific to Image Classification. — shape: {nodeCount?: string}
  --imageObjectDetectionModelDeploymentMetadata: record # Model deployment metadata specific to Image Object Detection. — shape: {nodeCount?: string}
]: any -> record<done: bool, error: record<code: int, details: list<record>, message: string>, metadata: record, name: string, response: record> {
  let input = $in
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v1beta1/($name):deploy" $qp)
  let body = {imageClassificationModelDeploymentMetadata: $imageClassificationModelDeploymentMetadata, imageObjectDetectionModelDeploymentMetadata: $imageObjectDetectionModelDeploymentMetadata} | compact
  let body = if ($input | describe | str starts-with "record") { $input | merge deep ($body | default {}) } else { $body }
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "post" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json" $body
...
export def "v1beta1 automlprojectslocationsmodelsexport" [
  name: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  ...
  --upload-protocol: string # Upload protocol for media (e.g. "raw", "multipart").
  --uploadType: string # Legacy upload protocol for media (e.g. "media", "multipart").
  --outputConfig: record # Output configuration for ModelExport Action. — shape: {gcrDestination?: record, gcsDestination?: record, modelFormat?: string, params?: record}
]: any -> record<done: bool, error: record<code: int, details: list<record>, message: string>, metadata: record, name: string, response: record> {
  let input = $in
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
...
# --outputConfig shape: {bigqueryDestination?: record, gcsDestination?: record}
export def "v1beta1 automlprojectslocationsdatasetsexportData" [
  name: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
...
export def "v1beta1 automlprojectslocationsmodelsexportEvaluatedExamples" [
  name: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
...
export def "v1beta1 automlprojectslocationsdatasetsimportData" [
  name: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
...
export def "v1beta1 automlprojectslocationsmodelspredict" [
  name: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  ...
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v1beta1/($name):predict" $qp)
  let body = {params: $params, payload: $payload} | compact
  let body = if ($input | describe | str starts-with "record") { $input | merge deep ($body | default {}) } else { $body }
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "post" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json" $body
...
export def "v1beta1 automlprojectslocationsmodelsundeploy" [
  name: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  ...
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v1beta1/($name):undeploy" $qp)
  let body = if ($input | describe | str starts-with "record") { $input | merge deep ($body | default {}) } else { $body }
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "post" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json" $body
...
export def "v1beta1 automlprojectslocationsoperationswait" [
  name: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  ...
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v1beta1/($name):wait" $qp)
...
export def "v1beta1-column-specs automlprojectslocationsdatasetstableSpecscolumnSpecslist" [
  parent: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  ...
  --pageSize: int # Requested page size. The server can return fewer results than requested. If unspecified, the server will pick a default size.
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar") (serialize-qp "fieldMask" $fieldMask "scalar") (serialize-qp "filter" $filter "scalar") (serialize-qp "pageSize" $pageSize "scalar") (serialize-qp "pageToken" $pageToken "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v1beta1/($parent)/columnSpecs" $qp)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "get" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json"
}
...
export def "v1beta1-datasets automlprojectslocationsdatasetslist" [
  parent: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  ...
  --pageSize: int # Requested page size. Server may return fewer results than requested. If unspecified, server will pick a default size.
...
export def "v1beta1-datasets automlprojectslocationsdatasetscreate" [
  parent: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  ...
  --upload-protocol: string # Upload protocol for media (e.g. "raw", "multipart").
  --uploadType: string # Legacy upload protocol for media (e.g. "media", "multipart").
  --createTime: string # Output only. Timestamp when this dataset was created. (format: google-datetime)
  ...
  --etag: string # Used to perform consistent read-modify-write updates. If not set, a blind "overwrite" update happens.
  --exampleCount: int # Output only. The number of examples in the dataset. (format: int32)
  --imageClassificationDatasetMetadata: record # Dataset metadata that is specific to image classification. — shape: {classificationType?: "CLASSIFICATION_TYPE_UNSPECIFIED"|"MULTICLASS"|"MULTILABEL"}
  --imageObjectDetectionDatasetMetadata: record # Dataset metadata specific to image object detection.
  ...
  --tablesDatasetMetadata: record # Metadata for a dataset used for AutoML Tables. — shape: {mlUseColumnSpecId?: string, primaryTableSpecId?: string, statsUpdateTime?: string, targetColumnCorrelations?: record, targetColumnSpecId?: string, weightColumnSpecId?: string}
  --textClassificationDatasetMetadata: record # Dataset metadata for classification. — shape: {classificationType?: "CLASSIFICATION_TYPE_UNSPECIFIED"|"MULTICLASS"|"MULTILABEL"}
  --textExtractionDatasetMetadata: record # Dataset metadata that is specific to text extraction
  --textSentimentDatasetMetadata: record # Dataset metadata for text sentiment. — shape: {sentimentMax?: int}
  --translationDatasetMetadata: record # Dataset metadata that is specific to translation. — shape: {sourceLanguageCode?: string, targetLanguageCode?: string}
  --videoClassificationDatasetMetadata: record # Dataset metadata specific to video classification. All Video Classification datasets are treated as multi label.
  --videoObjectTrackingDatasetMetadata: record # Dataset metadata specific to video object tracking.
  ...
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v1beta1/($parent)/datasets" $qp)
  let body = {createTime: $createTime, description: $description, displayName: $displayName, etag: $etag, exampleCount: $exampleCount, imageClassificationDatasetMetadata: $imageClassificationDatasetMetadata, imageObjectDetectionDatasetMetadata: $imageObjectDetectionDatasetMetadata, name: $name, tablesDatasetMetadata: $tablesDatasetMetadata, textClassificationDatasetMetadata: $textClassificationDatasetMetadata, textExtractionDatasetMetadata: $textExtractionDatasetMetadata, textSentimentDatasetMetadata: $textSentimentDatasetMetadata, translationDatasetMetadata: $translationDatasetMetadata, videoClassificationDatasetMetadata: $videoClassificationDatasetMetadata, videoObjectTrackingDatasetMetadata: $videoObjectTrackingDatasetMetadata} | compact
  let body = if ($input | describe | str starts-with "record") { $input | merge deep ($body | default {}) } else { $body }
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "post" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json" $body
...
export def "v1beta1-model-evaluations automlprojectslocationsmodelsmodelEvaluationslist" [
  parent: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  ...
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar") (serialize-qp "filter" $filter "scalar") (serialize-qp "pageSize" $pageSize "scalar") (serialize-qp "pageToken" $pageToken "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v1beta1/($parent)/modelEvaluations" $qp)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "get" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json"
}
...
export def "v1beta1-models automlprojectslocationsmodelslist" [
  parent: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  ...
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar") (serialize-qp "filter" $filter "scalar") (serialize-qp "pageSize" $pageSize "scalar") (serialize-qp "pageToken" $pageToken "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v1beta1/($parent)/models" $qp)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "get" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json"
}
...
export def "v1beta1-models automlprojectslocationsmodelscreate" [
  parent: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  ...
  --upload-protocol: string # Upload protocol for media (e.g. "raw", "multipart").
  --uploadType: string # Legacy upload protocol for media (e.g. "media", "multipart").
  --createTime: string # Output only. Timestamp when the model training finished and can be used for prediction. (format: google-datetime)
  ...
  --deploymentState: string@deploymentState-completer # Output only. Deployment state of the model. A model can only serve prediction requests after it gets deployed.
  ...
  --imageClassificationModelMetadata: record # Model metadata for image classification. — shape: {baseModelId?: string, modelType?: string, nodeCount?: string, nodeQps?: float, stopReason?: string, trainBudget?: string, trainCost?: string}
  --imageObjectDetectionModelMetadata: record # Model metadata specific to image object detection. — shape: {modelType?: string, nodeCount?: string, nodeQps?: float, stopReason?: string, trainBudgetMilliNodeHours?: string, trainCostMilliNodeHours?: string}
  --name: string # Output only. Resource name of the model. Format: `projects/{project_id}/locations/{location_id}/models/{model_id}`
  --tablesModelMetadata: record # Model metadata specific to AutoML Tables. — shape: {disableEarlyStopping?: bool, inputFeatureColumnSpecs?: list, optimizationObjective?: string, optimizationObjectivePrecisionValue?: float, optimizationObjectiveRecallValue?: float, tablesModelColumnInfo?: list, targetColumnSpec?: record, trainBudgetMilliNodeHours?: string, trainCostMilliNodeHours?: string}
  --textClassificationModelMetadata: record # Model metadata that is specific to text classification. — shape: {classificationType?: "CLASSIFICATION_TYPE_UNSPECIFIED"|"MULTICLASS"|"MULTILABEL"}
  --textExtractionModelMetadata: record # Model metadata that is specific to text extraction. — shape: {modelHint?: string}
  --textSentimentModelMetadata: record # Model metadata that is specific to text sentiment.
  --translationModelMetadata: record # Model metadata that is specific to translation. — shape: {baseModel?: string, sourceLanguageCode?: string, targetLanguageCode?: string}
  --updateTime: string # Output only. Timestamp when this model was last updated. (format: google-datetime)
  --videoClassificationModelMetadata: record # Model metadata specific to video classification.
  --videoObjectTrackingModelMetadata: record # Model metadata specific to video object tracking.
]: any -> record<done: bool, error: record<code: int, details: list<record>, message: string>, metadata: record, name: string, response: record> {
  let input = $in
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v1beta1/($parent)/models" $qp)
  let body = {createTime: $createTime, datasetId: $datasetId, deploymentState: $deploymentState, displayName: $displayName, imageClassificationModelMetadata: $imageClassificationModelMetadata, imageObjectDetectionModelMetadata: $imageObjectDetectionModelMetadata, name: $name, tablesModelMetadata: $tablesModelMetadata, textClassificationModelMetadata: $textClassificationModelMetadata, textExtractionModelMetadata: $textExtractionModelMetadata, textSentimentModelMetadata: $textSentimentModelMetadata, translationModelMetadata: $translationModelMetadata, updateTime: $updateTime, videoClassificationModelMetadata: $videoClassificationModelMetadata, videoObjectTrackingModelMetadata: $videoObjectTrackingModelMetadata} | compact
  let body = if ($input | describe | str starts-with "record") { $input | merge deep ($body | default {}) } else { $body }
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "post" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json" $body
...
export def "v1beta1-table-specs automlprojectslocationsdatasetstableSpecslist" [
  parent: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  ...
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar") (serialize-qp "fieldMask" $fieldMask "scalar") (serialize-qp "filter" $filter "scalar") (serialize-qp "pageSize" $pageSize "scalar") (serialize-qp "pageToken" $pageToken "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v1beta1/($parent)/tableSpecs" $qp)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "get" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json"
}
...
export def "v1beta1 automlprojectslocationsmodelsgetIamPolicy" [
  resource: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
...
export def "v1beta1 automlprojectslocationsmodelssetIamPolicy" [
  resource: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
...
export def "v1beta1 automlprojectslocationstestIamPermissions" [
  resource: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
