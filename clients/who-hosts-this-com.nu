# Auto-generated client for Who Hosts This API v0.0.1
# Source: https://api.apis.guru/v2/specs/who-hosts-this.com/0.0.1/swagger.json
# Auth: --token flag or $env.WHO_HOSTS_THIS_API_TOKEN

const BASE_URL = "https://www.who-hosts-this.com/APIEndpoint"
const DEFAULT_AUTH = "query-key"

# Build auth: returns {headers: record, query: string}
def build-auth [token?: string, auth_scheme?: string]: nothing -> record {
  let token_val = if ($token != null) and ($token | is-not-empty) { $token } else { $env | get -o WHO_HOSTS_THIS_API_TOKEN | default "" }
...
def base-url-completer [] { ["https://www.who-hosts-this.com/APIEndpoint"] }
...
export def "detect get" [
  ...
  --qp-url: string # The url of the page to check
]: nothing -> any {
