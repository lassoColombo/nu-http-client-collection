...
export def "encoded-full-hashes get" [
  ...
  if ($encoded_request | is-empty) { error make --unspanned { msg: "path parameter 'encodedRequest' must be non-empty" } }
