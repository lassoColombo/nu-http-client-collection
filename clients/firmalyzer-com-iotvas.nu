# Auto-generated client for IoTVAS API v1.0
# Source: https://api.apis.guru/v2/specs/firmalyzer.com/iotvas/1.0/openapi.json
# Auth: --token flag or $env.IOTVAS_API_TOKEN
...
def build-auth [token?: string, auth_scheme?: string]: nothing -> record {
  let token_val = if ($token | is-not-empty) { $token } else { $env | get -o IOTVAS_API_TOKEN | default "" }
...
export def "device-detect create" [
  ...
  --ftp-banner: string # default: 
  --hostname: string # default: 
  --http-response: string # default: 
  --https-response: string # default: 
  --nic-mac: string # default: 
  --snmp-sysdescr: string # default: 
  --snmp-sysoid: string # default: 
  --telnet-banner: string # default: 
  --upnp-response: string # default: 
]: any -> record<cve_list: table<cve_id: string, cvss: float>, device_type: string, firmware_info: record<download_url: string, name: string, release_date: string, sha2: string, version: string>, firmware_version: string, is_discontinued: bool, latest_firmware_info: record<download_url: string, name: string, release_date: string, sha2: string, version: string>, manufacturer: string, model_name: string> {
  let input = $in
  let auth = (build-auth $token ($auth_scheme | default "x-api-key"))
  let base = ($base_url | default $BASE_URL)
  let full_url = (build-url $base "/device/detect" $auth.query)
...
export def "firmware-accounts get" [
  ...
  let auth = (build-auth $token ($auth_scheme | default "x-api-key"))
  let base = ($base_url | default $BASE_URL)
  if ($firmware_hash | is-empty) { error make --unspanned { msg: "path parameter 'firmware_hash' must be non-empty" } }
  let full_url = (build-url $base ({firmware_hash: (encode-path-segment $firmware_hash)} | format pattern "/firmware/{firmware_hash}/accounts") $auth.query)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "get"
...
export def "firmware-config-issues get" [
  ...
  let base = ($base_url | default $BASE_URL)
  if ($firmware_hash | is-empty) { error make --unspanned { msg: "path parameter 'firmware_hash' must be non-empty" } }
  let full_url = (build-url $base ({firmware_hash: (encode-path-segment $firmware_hash)} | format pattern "/firmware/{firmware_hash}/config-issues") $auth.query)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "get"
...
export def "firmware-expired-certs get" [
  ...
  let base = ($base_url | default $BASE_URL)
  if ($firmware_hash | is-empty) { error make --unspanned { msg: "path parameter 'firmware_hash' must be non-empty" } }
  let full_url = (build-url $base ({firmware_hash: (encode-path-segment $firmware_hash)} | format pattern "/firmware/{firmware_hash}/expired-certs") $auth.query)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "get"
...
export def "firmware-private-keys get" [
  ...
  let base = ($base_url | default $BASE_URL)
  if ($firmware_hash | is-empty) { error make --unspanned { msg: "path parameter 'firmware_hash' must be non-empty" } }
  let full_url = (build-url $base ({firmware_hash: (encode-path-segment $firmware_hash)} | format pattern "/firmware/{firmware_hash}/private-keys") $auth.query)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "get"
...
export def "firmware-risk get" [
  ...
  let base = ($base_url | default $BASE_URL)
  if ($firmware_hash | is-empty) { error make --unspanned { msg: "path parameter 'firmware_hash' must be non-empty" } }
  let full_url = (build-url $base ({firmware_hash: (encode-path-segment $firmware_hash)} | format pattern "/firmware/{firmware_hash}/risk") $auth.query)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "get"
...
export def "firmware-weak-certs get" [
  ...
  let base = ($base_url | default $BASE_URL)
  if ($firmware_hash | is-empty) { error make --unspanned { msg: "path parameter 'firmware_hash' must be non-empty" } }
  let full_url = (build-url $base ({firmware_hash: (encode-path-segment $firmware_hash)} | format pattern "/firmware/{firmware_hash}/weak-certs") $auth.query)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "get"
...
export def "firmware-weak-keys get" [
  ...
  let base = ($base_url | default $BASE_URL)
  if ($firmware_hash | is-empty) { error make --unspanned { msg: "path parameter 'firmware_hash' must be non-empty" } }
  let full_url = (build-url $base ({firmware_hash: (encode-path-segment $firmware_hash)} | format pattern "/firmware/{firmware_hash}/weak-keys") $auth.query)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "get"
