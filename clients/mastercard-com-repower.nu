...
export def commands []: nothing -> table {
  ...
  let mod_name = (scope modules | where { $in.commands | any { $in.name == "repower-repower repowerPost2" } } | get name | first)
...
export def "repower-repower repowerPost2" [
...
export def "repower-repowerreversal repowerReversalPost2" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
