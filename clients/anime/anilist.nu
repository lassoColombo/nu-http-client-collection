...
export def "query activity" [
  ...
  if $dry_run or $raw or $allow_errors { $result } else { unwrap-graphql $result "Activity" }
}
...
export def "query activity-reply" [
  ...
  if $dry_run or $raw or $allow_errors { $result } else { unwrap-graphql $result "ActivityReply" }
}
...
export def "query following" [
  ...
  if $dry_run or $raw or $allow_errors { $result } else { unwrap-graphql $result "Following" }
}
...
export def "query follower" [
  ...
  if $dry_run or $raw or $allow_errors { $result } else { unwrap-graphql $result "Follower" }
}
...
export def "query thread" [
  ...
  if $dry_run or $raw or $allow_errors { $result } else { unwrap-graphql $result "Thread" }
}
...
export def "query thread-comment" [
  ...
  if $dry_run or $raw or $allow_errors { $result } else { unwrap-graphql $result "ThreadComment" }
}
...
export def "query recommendation" [
  ...
  if $dry_run or $raw or $allow_errors { $result } else { unwrap-graphql $result "Recommendation" }
}
...
export def "query like" [
  ...
  if $dry_run or $raw or $allow_errors { $result } else { unwrap-graphql $result "Like" }
}
...
export def "query markdown" [
  ...
  if $dry_run or $raw or $allow_errors { $result } else { unwrap-graphql $result "Markdown" }
}
...
export def "query ani-chart-user" [
  ...
  if $dry_run or $raw or $allow_errors { $result } else { unwrap-graphql $result "AniChartUser" }
}
...
export def "query site-statistics" [
  ...
  if $dry_run or $raw or $allow_errors { $result } else { unwrap-graphql $result "SiteStatistics" }
}
...
export def "query external-link-source-collection" [
  ...
  if $dry_run or $raw or $allow_errors { $result } else { unwrap-graphql $result "ExternalLinkSourceCollection" }
}
...
export def "mutation toggle-follow" [
  ...
  if $dry_run or $raw or $allow_errors { $result } else { unwrap-graphql $result "ToggleFollow" }
}
...
export def "mutation toggle-favourite" [
  ...
  if $dry_run or $raw or $allow_errors { $result } else { unwrap-graphql $result "ToggleFavourite" }
}
...
export def "mutation update-favourite-order" [
  ...
  if $dry_run or $raw or $allow_errors { $result } else { unwrap-graphql $result "UpdateFavouriteOrder" }
}
...
export def "mutation save-review" [
  ...
  if $dry_run or $raw or $allow_errors { $result } else { unwrap-graphql $result "SaveReview" }
}
...
export def "mutation delete-review" [
  ...
  if $dry_run or $raw or $allow_errors { $result } else { unwrap-graphql $result "DeleteReview" }
}
...
export def "mutation rate-review" [
  ...
  if $dry_run or $raw or $allow_errors { $result } else { unwrap-graphql $result "RateReview" }
}
...
export def "mutation save-recommendation" [
  ...
  if $dry_run or $raw or $allow_errors { $result } else { unwrap-graphql $result "SaveRecommendation" }
}
...
export def "mutation save-thread" [
  ...
  if $dry_run or $raw or $allow_errors { $result } else { unwrap-graphql $result "SaveThread" }
}
...
export def "mutation delete-thread" [
  ...
  if $dry_run or $raw or $allow_errors { $result } else { unwrap-graphql $result "DeleteThread" }
}
...
export def "mutation toggle-thread-subscription" [
  ...
  if $dry_run or $raw or $allow_errors { $result } else { unwrap-graphql $result "ToggleThreadSubscription" }
}
...
export def "mutation save-thread-comment" [
  ...
  if $dry_run or $raw or $allow_errors { $result } else { unwrap-graphql $result "SaveThreadComment" }
}
...
export def "mutation delete-thread-comment" [
  ...
  if $dry_run or $raw or $allow_errors { $result } else { unwrap-graphql $result "DeleteThreadComment" }
}
...
export def "mutation update-ani-chart-settings" [
  ...
  if $dry_run or $raw or $allow_errors { $result } else { unwrap-graphql $result "UpdateAniChartSettings" }
}
...
export def "mutation update-ani-chart-highlights" [
  ...
  if $dry_run or $raw or $allow_errors { $result } else { unwrap-graphql $result "UpdateAniChartHighlights" }
}
