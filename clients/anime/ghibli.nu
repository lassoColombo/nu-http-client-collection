# Auto-generated client for Studio Ghibli API v1.0.1
# Source: https://ghibliapi.vercel.app/swagger.yaml
# Auth: --token flag or $env.STUDIO_GHIBLI_API_TOKEN
...
def build-auth [token?: string, auth_scheme?: string]: nothing -> record {
  let token_val = if ($token != null) and ($token | is-not-empty) { $token } else { $env | get -o STUDIO_GHIBLI_API_TOKEN | default "" }
...
def base-url-completer [] { ["https://ghibliapi.vercel.app"] }
