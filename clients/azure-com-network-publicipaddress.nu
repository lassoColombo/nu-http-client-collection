...
export def commands []: nothing -> table {
  ...
  let mod_name = (scope modules | where { $in.commands | any { $in.name == "subscriptions-providers-microsoft-network-public-ip-addresses list" } } | get name | first)
...
export def "subscriptions-resource-groups-providers-microsoft-network-public-ip-addresses update-tags" [
  subscription_id: string
  resource_group_name: string
  public_ip_address_name: string
  --base-url(-b): string@base-url-completer # API base URL
