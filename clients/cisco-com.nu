...
def build-auth [token?: string, auth_scheme?: string]: nothing -> record {
  let token_val = if ($token | is-not-empty) { $token } else { $env | get -o CISCO_PSIRT_OPENVULN_API_TOKEN | default "" }
...
export def "security-advisories-cvrf-advisory get" [
  ...
  let full_url = (build-url $base ({advisory_id: (encode-path-segment $advisory_id)} | format pattern "/security/advisories/cvrf/advisory/{advisory_id}") $auth.query)
...
export def "security-advisories-cvrf-all get" [
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let full_url = (build-url $base "/security/advisories/cvrf/all" $auth.query)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "get"
...
export def "security-advisories-cvrf-cve get" [
  ...
  let full_url = (build-url $base ({cve_id: (encode-path-segment $cve_id)} | format pattern "/security/advisories/cvrf/cve/{cve_id}") $auth.query)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "get"
...
export def "security-advisories-cvrf-latest get" [
  ...
  let full_url = (build-url $base ({number: (encode-path-segment $number)} | format pattern "/security/advisories/cvrf/latest/{number}") $auth.query)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "get"
...
export def "security-advisories-cvrf-product get" [
  ...
  let full_url = (build-url $base "/security/advisories/cvrf/product" $qp $auth.query)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "get"
    url: $full_url
    query: ({"product": $product} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "security-advisories-cvrf-severity get" [
  ...
  let full_url = (build-url $base ({severity: (encode-path-segment $severity)} | format pattern "/security/advisories/cvrf/severity/{severity}") $auth.query)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "get"
...
export def "security-advisories-cvrf-severity-firstpublished get" [
  ...
  let full_url = (build-url $base ({severity: (encode-path-segment $severity)} | format pattern "/security/advisories/cvrf/severity/{severity}/firstpublished") $qp $auth.query)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "get"
...
export def "security-advisories-cvrf-severity-lastpublished get" [
  ...
  if ($severity | is-empty) { error make --unspanned { msg: "path parameter 'severity' must be non-empty" } }
  let qp = [(serialize-qp "startDate" $start_date "scalar") (serialize-qp "endDate" $end_date "scalar")] | flatten | str join "&"
  let full_url = (build-url $base ({severity: (encode-path-segment $severity)} | format pattern "/security/advisories/cvrf/severity/{severity}/lastpublished") $qp $auth.query)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "get"
...
export def "security-advisories-cvrf-year get" [
  ...
  let full_url = (build-url $base ({year: (encode-path-segment $year)} | format pattern "/security/advisories/cvrf/year/{year}") $auth.query)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "get"
...
export def "security-advisories-ios get" [
  ...
  let full_url = (build-url $base "/security/advisories/ios" $qp $auth.query)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "get"
...
export def "security-advisories-iosxe get" [
  ...
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "version" $version "scalar")] | flatten | str join "&"
  let full_url = (build-url $base "/security/advisories/iosxe" $qp $auth.query)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "get"
...
export def "security-advisories-oval-advisory get" [
  ...
  let base = ($base_url | default $BASE_URL)
  if ($advisory_id | is-empty) { error make --unspanned { msg: "path parameter 'advisory_id' must be non-empty" } }
  let full_url = (build-url $base ({advisory_id: (encode-path-segment $advisory_id)} | format pattern "/security/advisories/oval/advisory/{advisory_id}") $auth.query)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "get"
...
export def "security-advisories-oval-all get" [
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let full_url = (build-url $base "/security/advisories/oval/all" $auth.query)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "get"
...
export def "security-advisories-oval-cve get" [
  ...
  let base = ($base_url | default $BASE_URL)
  if ($cve_id | is-empty) { error make --unspanned { msg: "path parameter 'cve_id' must be non-empty" } }
  let full_url = (build-url $base ({cve_id: (encode-path-segment $cve_id)} | format pattern "/security/advisories/oval/cve/{cve_id}") $auth.query)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "get"
...
export def "security-advisories-oval-latest get" [
  ...
  let base = ($base_url | default $BASE_URL)
  if ($number | is-empty) { error make --unspanned { msg: "path parameter 'number' must be non-empty" } }
  let full_url = (build-url $base ({number: (encode-path-segment $number)} | format pattern "/security/advisories/oval/latest/{number}") $auth.query)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "get"
...
export def "security-advisories-oval-product get" [
  ...
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "product" $product "scalar")] | flatten | str join "&"
  let full_url = (build-url $base "/security/advisories/oval/product" $qp $auth.query)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "get"
...
export def "security-advisories-oval-severity get" [
  ...
  let base = ($base_url | default $BASE_URL)
  if ($severity | is-empty) { error make --unspanned { msg: "path parameter 'severity' must be non-empty" } }
  let full_url = (build-url $base ({severity: (encode-path-segment $severity)} | format pattern "/security/advisories/oval/severity/{severity}") $auth.query)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "get"
...
export def "security-advisories-oval-severity-firstpublished get" [
  ...
  if ($severity | is-empty) { error make --unspanned { msg: "path parameter 'severity' must be non-empty" } }
  let qp = [(serialize-qp "startDate" $start_date "scalar") (serialize-qp "endDate" $end_date "scalar")] | flatten | str join "&"
  let full_url = (build-url $base ({severity: (encode-path-segment $severity)} | format pattern "/security/advisories/oval/severity/{severity}/firstpublished") $qp $auth.query)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "get"
...
export def "security-advisories-oval-severity-lastpublished get" [
  ...
  if ($severity | is-empty) { error make --unspanned { msg: "path parameter 'severity' must be non-empty" } }
  let qp = [(serialize-qp "startDate" $start_date "scalar") (serialize-qp "endDate" $end_date "scalar")] | flatten | str join "&"
  let full_url = (build-url $base ({severity: (encode-path-segment $severity)} | format pattern "/security/advisories/oval/severity/{severity}/lastpublished") $qp $auth.query)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "get"
