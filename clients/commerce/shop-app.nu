...
export def commands []: nothing -> table {
  ...
  let mod_name = (scope modules | where { $in.commands | any { $in.name == "openai-details details" } } | get name | first)
...
# GET /openai/details
# operationId: details
export def "openai-details details" [
...
# GET /openai/search
# operationId: search
export def "openai-search search" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
