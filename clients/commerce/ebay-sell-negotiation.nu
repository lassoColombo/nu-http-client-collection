...
export def commands []: nothing -> table {
  ...
  let mod_name = (scope modules | where { $in.commands | any { $in.name == "find-eligible-items findEligibleItems" } } | get name | first)
...
export def "find-eligible-items findEligibleItems" [
