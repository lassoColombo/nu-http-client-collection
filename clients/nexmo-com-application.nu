...
export def "api get-applications" [
  ...
  do-request "get" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors $full "application/json" null {query: ({"api_key": $api_key, "api_secret": $api_secret, "page_size": $page_size, "page_index": $page_index} | compact), body: null}
}
