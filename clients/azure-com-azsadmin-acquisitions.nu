...
# Source: https://api.apis.guru/v2/specs/azure.com/azsadmin-acquisitions/2019-08-08-preview/swagger.json
...
export def "subscriptions-providers-microsoft-storage-admin-locations-acquisitions list" [
...
]: nothing -> record<value: table<acquisitionid: string, blob: string, container: string, filePath: string, filePathUnc: string, maximumblobsize: int, status: string, storageaccount: string, susbcriptionid: string>> {
  ...
  let full_url = (build-url $base ({subscription_id: (encode-path-segment $subscription_id), location: (encode-path-segment $location)} | format pattern "/subscriptions/{subscription_id}/providers/Microsoft.Storage.Admin/locations/{location}/acquisitions") $qp $auth.query)
