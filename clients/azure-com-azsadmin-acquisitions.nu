...
export def "subscriptions-providers-microsoft-storage-admin-locations-acquisitions list" [
  ...
  let full_url = (build-url $base ({subscription_id: $subscription_id, location: $location} | format pattern "/subscriptions/{subscription_id}/providers/Microsoft.Storage.Admin/locations/{location}/acquisitions") $qp)
