...
export def "things-jobs get-execution" [
  ...
  do-request "get" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors $full "application/json" null {query: ({"includeJobDocument": $include_job_document, "executionNumber": $execution_number} | compact), body: null}
}
