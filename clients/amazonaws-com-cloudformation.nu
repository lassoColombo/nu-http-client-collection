...
def build-auth [token?: string, auth_scheme?: string]: nothing -> record {
  let token_val = if ($token | is-not-empty) { $token } else { $env | get -o AWS_CLOUDFORMATION_TOKEN | default "" }
...
export def "api get-activate-type" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"Type": $type, "PublicTypeArn": $public_type_arn, "PublisherId": $publisher_id, "TypeName": $type_name, "TypeNameAlias": $type_name_alias, "AutoUpdate": $auto_update, "LoggingConfig": $logging_config, "ExecutionRoleArn": $execution_role_arn, "VersionBump": $version_bump, "MajorVersion": $major_version, "Action": $action, "Version": $version} | compact)
...
export def "api get-batch-type-configurations" [
  ...
  --x-amz-signature: string
  --x-amz-signed-headers: string
]: nothing -> record<Errors: record, UnprocessedTypeConfigurations: record, TypeConfigurations: record> {
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"TypeConfigurationIdentifiers": $type_configuration_identifiers, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api create-batch-get-type-configurations" [
  ...
  --x-amz-signed-headers: string
  --body: any
]: any -> record<Errors: record, UnprocessedTypeConfigurations: record, TypeConfigurations: record> {
  let input = $in
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "Action" $action "scalar") (serialize-qp "Version" $version "scalar")] | flatten | str join "&"
...
export def "api get-cancel-update-stack" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"StackName": $stack_name, "ClientRequestToken": $client_request_token, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-continue-update-rollback" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"StackName": $stack_name, "RoleARN": $role_arn, "ResourcesToSkip": $resources_to_skip, "ClientRequestToken": $client_request_token, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-create-change-update" [
  ...
  --x-amz-signature: string
  --x-amz-signed-headers: string
]: nothing -> record<Id: record, StackId: record> {
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"StackName": $stack_name, "TemplateBody": $template_body, "TemplateURL": $template_url, "UsePreviousTemplate": $use_previous_template, "Parameters": $parameters, "Capabilities": $capabilities, "ResourceTypes": $resource_types, "RoleARN": $role_arn, "RollbackConfiguration": $rollback_configuration, "NotificationARNs": $notification_ar_ns, "Tags": $tags, "ChangeSetName": $change_set_name, "ClientToken": $client_token, "Description": $description, "ChangeSetType": $change_set_type, "ResourcesToImport": $resources_to_import, "IncludeNestedStacks": $include_nested_stacks, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api create-change-update" [
  ...
  --x-amz-signed-headers: string
  --body: any
]: any -> record<Id: record, StackId: record> {
  let input = $in
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "Action" $action "scalar") (serialize-qp "Version" $version "scalar")] | flatten | str join "&"
...
export def "api get-create-stack-instances" [
  ...
  --x-amz-signature: string
  --x-amz-signed-headers: string
]: nothing -> record<OperationId: record> {
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"StackSetName": $stack_set_name, "Accounts": $accounts, "DeploymentTargets": $deployment_targets, "Regions": $regions, "ParameterOverrides": $parameter_overrides, "OperationPreferences": $operation_preferences, "OperationId": $operation_id, "CallAs": $call_as, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-create-stack-update" [
  ...
  --x-amz-signature: string
  --x-amz-signed-headers: string
]: nothing -> record<StackSetId: record> {
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
...
export def "api get-deactivate-type" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"TypeName": $type_name, "Type": $type, "Arn": $arn, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-delete-change-update" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"ChangeSetName": $change_set_name, "StackName": $stack_name, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-delete-stack" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"StackName": $stack_name, "RetainResources": $retain_resources, "RoleARN": $role_arn, "ClientRequestToken": $client_request_token, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-delete-stack-instances" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"StackSetName": $stack_set_name, "Accounts": $accounts, "DeploymentTargets": $deployment_targets, "Regions": $regions, "OperationPreferences": $operation_preferences, "RetainStacks": $retain_stacks, "OperationId": $operation_id, "CallAs": $call_as, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-delete-stack-update" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"StackSetName": $stack_set_name, "CallAs": $call_as, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-deregister-type" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"Arn": $arn, "Type": $type, "TypeName": $type_name, "VersionId": $version_id, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-account-limits" [
  ...
  --x-amz-signature: string
  --x-amz-signed-headers: string
]: nothing -> record<AccountLimits: record, NextToken: record> {
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"NextToken": $next_token, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api create-get-account-limits" [
  ...
  --x-amz-signed-headers: string
  --body: any
]: any -> record<AccountLimits: record, NextToken: record> {
  let input = $in
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "NextToken" $next_token "scalar") (serialize-qp "Action" $action "scalar") (serialize-qp "Version" $version "scalar")] | flatten | str join "&"
...
export def "api get-change-update" [
  ...
  --x-amz-signature: string
  --x-amz-signed-headers: string
]: nothing -> record<ChangeSetName: record, ChangeSetId: record, StackId: record, StackName: record, Description: record, Parameters: record, CreationTime: record, ExecutionStatus: record, Status: record, StatusReason: record, NotificationARNs: record, RollbackConfiguration: record<RollbackTriggers: record, MonitoringTimeInMinutes: record>, Capabilities: record, Tags: record, Changes: record, NextToken: record, IncludeNestedStacks: record, ParentChangeSetId: record, RootChangeSetId: record> {
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"ChangeSetName": $change_set_name, "StackName": $stack_name, "NextToken": $next_token, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api create-get-change-update" [
  ...
  --x-amz-signed-headers: string
  --body: any
]: any -> record<ChangeSetName: record, ChangeSetId: record, StackId: record, StackName: record, Description: record, Parameters: record, CreationTime: record, ExecutionStatus: record, Status: record, StatusReason: record, NotificationARNs: record, RollbackConfiguration: record<RollbackTriggers: record, MonitoringTimeInMinutes: record>, Capabilities: record, Tags: record, Changes: record, NextToken: record, IncludeNestedStacks: record, ParentChangeSetId: record, RootChangeSetId: record> {
  let input = $in
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "Action" $action "scalar") (serialize-qp "Version" $version "scalar")] | flatten | str join "&"
...
export def "api get-change-update-hooks" [
  ...
  --x-amz-signature: string
  --x-amz-signed-headers: string
]: nothing -> record<ChangeSetId: record, ChangeSetName: record, Hooks: record, Status: record, NextToken: record, StackId: record, StackName: record> {
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"ChangeSetName": $change_set_name, "StackName": $stack_name, "NextToken": $next_token, "LogicalResourceId": $logical_resource_id, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api create-get-change-update-hooks" [
  ...
  --x-amz-signed-headers: string
  --body: any
]: any -> record<ChangeSetId: record, ChangeSetName: record, Hooks: record, Status: record, NextToken: record, StackId: record, StackName: record> {
  let input = $in
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "Action" $action "scalar") (serialize-qp "Version" $version "scalar")] | flatten | str join "&"
...
export def "api get-publisher" [
  ...
  --x-amz-signature: string
  --x-amz-signed-headers: string
]: nothing -> record<PublisherId: record, PublisherStatus: record, IdentityProvider: record, PublisherProfile: record> {
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"PublisherId": $publisher_id, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api create-get-publisher" [
  ...
  --x-amz-signed-headers: string
  --body: any
]: any -> record<PublisherId: record, PublisherStatus: record, IdentityProvider: record, PublisherProfile: record> {
  let input = $in
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "Action" $action "scalar") (serialize-qp "Version" $version "scalar")] | flatten | str join "&"
...
export def "api get-stack-drift-detection-status" [
  ...
  --x-amz-signature: string
  --x-amz-signed-headers: string
]: nothing -> record<StackId: record, StackDriftDetectionId: record, StackDriftStatus: record, DetectionStatus: record, DetectionStatusReason: record, DriftedStackResourceCount: record, Timestamp: record> {
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"StackDriftDetectionId": $stack_drift_detection_id, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api create-get-stack-drift-detection-status" [
  ...
  --x-amz-signed-headers: string
  --body: any
]: any -> record<StackId: record, StackDriftDetectionId: record, StackDriftStatus: record, DetectionStatus: record, DetectionStatusReason: record, DriftedStackResourceCount: record, Timestamp: record> {
  let input = $in
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "Action" $action "scalar") (serialize-qp "Version" $version "scalar")] | flatten | str join "&"
...
export def "api get-stack-events" [
  ...
  --x-amz-signature: string
  --x-amz-signed-headers: string
]: nothing -> record<StackEvents: record, NextToken: record> {
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"StackName": $stack_name, "NextToken": $next_token, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api create-get-stack-events" [
  ...
  --x-amz-signed-headers: string
  --body: any
]: any -> record<StackEvents: record, NextToken: record> {
  let input = $in
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "NextToken" $next_token "scalar") (serialize-qp "Action" $action "scalar") (serialize-qp "Version" $version "scalar")] | flatten | str join "&"
...
export def "api get-stack-instance" [
  ...
  --x-amz-signature: string
  --x-amz-signed-headers: string
]: nothing -> record<StackInstance: record<StackSetId: record, Region: record, Account: record, StackId: record, ParameterOverrides: record, Status: record, StackInstanceStatus: record<DetailedStatus: record>, StatusReason: record, OrganizationalUnitId: record, DriftStatus: record, LastDriftCheckTimestamp: record, LastOperationId: record>> {
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"StackSetName": $stack_set_name, "StackInstanceAccount": $stack_instance_account, "StackInstanceRegion": $stack_instance_region, "CallAs": $call_as, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api create-get-stack-instance" [
  ...
  --x-amz-signed-headers: string
  --body: any
]: any -> record<StackInstance: record<StackSetId: record, Region: record, Account: record, StackId: record, ParameterOverrides: record, Status: record, StackInstanceStatus: record<DetailedStatus: record>, StatusReason: record, OrganizationalUnitId: record, DriftStatus: record, LastDriftCheckTimestamp: record, LastOperationId: record>> {
  let input = $in
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "Action" $action "scalar") (serialize-qp "Version" $version "scalar")] | flatten | str join "&"
...
export def "api get-stack-resource" [
  ...
  --x-amz-signature: string
  --x-amz-signed-headers: string
]: nothing -> record<StackResourceDetail: record<StackName: record, StackId: record, LogicalResourceId: record, PhysicalResourceId: record, ResourceType: record, LastUpdatedTimestamp: record, ResourceStatus: record, ResourceStatusReason: record, Description: record, Metadata: record, DriftInformation: record<StackResourceDriftStatus: record, LastCheckTimestamp: record>, ModuleInfo: record<TypeHierarchy: record, LogicalIdHierarchy: record>>> {
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"StackName": $stack_name, "LogicalResourceId": $logical_resource_id, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api create-get-stack-resource" [
  ...
  --x-amz-signed-headers: string
  --body: any
]: any -> record<StackResourceDetail: record<StackName: record, StackId: record, LogicalResourceId: record, PhysicalResourceId: record, ResourceType: record, LastUpdatedTimestamp: record, ResourceStatus: record, ResourceStatusReason: record, Description: record, Metadata: record, DriftInformation: record<StackResourceDriftStatus: record, LastCheckTimestamp: record>, ModuleInfo: record<TypeHierarchy: record, LogicalIdHierarchy: record>>> {
  let input = $in
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "Action" $action "scalar") (serialize-qp "Version" $version "scalar")] | flatten | str join "&"
...
export def "api get-stack-resource-drifts" [
  ...
  --x-amz-signature: string
  --x-amz-signed-headers: string
]: nothing -> record<StackResourceDrifts: record, NextToken: record> {
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"StackName": $stack_name, "StackResourceDriftStatusFilters": $stack_resource_drift_status_filters, "NextToken": $next_token, "MaxResults": $max_results, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api create-get-stack-resource-drifts" [
  ...
  --x-amz-signed-headers: string
  --body: any
]: any -> record<StackResourceDrifts: record, NextToken: record> {
  let input = $in
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  ...
  let req = {
    method: "post"
    url: $full_url
    query: ({"MaxResults": $max_results, "NextToken": $next_token, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: $req_body
    content_type: "text/xml"
    timeout: ($max_time | default 30min)
...
export def "api get-stack-resources" [
  ...
  --x-amz-signature: string
  --x-amz-signed-headers: string
]: nothing -> record<StackResources: record> {
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"StackName": $stack_name, "LogicalResourceId": $logical_resource_id, "PhysicalResourceId": $physical_resource_id, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api create-get-stack-resources" [
  ...
  --x-amz-signed-headers: string
  --body: any
]: any -> record<StackResources: record> {
  let input = $in
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "Action" $action "scalar") (serialize-qp "Version" $version "scalar")] | flatten | str join "&"
...
export def "api get-stack-update" [
  ...
  --x-amz-signature: string
  --x-amz-signed-headers: string
]: nothing -> record<StackSet: record<StackSetName: record, StackSetId: record, Description: record, Status: record, TemplateBody: record, Parameters: record, Capabilities: record, Tags: record, StackSetARN: record, AdministrationRoleARN: record, ExecutionRoleName: record, StackSetDriftDetectionDetails: record<DriftStatus: record, DriftDetectionStatus: record, LastDriftCheckTimestamp: record, TotalStackInstancesCount: record, DriftedStackInstancesCount: record, InSyncStackInstancesCount: record, InProgressStackInstancesCount: record, FailedStackInstancesCount: record>, AutoDeployment: record<Enabled: record, RetainStacksOnAccountRemoval: record>, PermissionModel: record, OrganizationalUnitIds: record, ManagedExecution: record<Active: record>, Regions: list<string>>> {
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "StackSetName" $stack_set_name "scalar") (serialize-qp "CallAs" $call_as "scalar") (serialize-qp "Action" $action "scalar") (serialize-qp "Version" $version "scalar")] | flatten | str join "&"
  let full_url = (build-url $base "/" $qp $auth.query)
...
export def "api create-get-stack-update" [
  ...
  --x-amz-signed-headers: string
  --body: any
]: any -> record<StackSet: record<StackSetName: record, StackSetId: record, Description: record, Status: record, TemplateBody: record, Parameters: record, Capabilities: record, Tags: record, StackSetARN: record, AdministrationRoleARN: record, ExecutionRoleName: record, StackSetDriftDetectionDetails: record<DriftStatus: record, DriftDetectionStatus: record, LastDriftCheckTimestamp: record, TotalStackInstancesCount: record, DriftedStackInstancesCount: record, InSyncStackInstancesCount: record, InProgressStackInstancesCount: record, FailedStackInstancesCount: record>, AutoDeployment: record<Enabled: record, RetainStacksOnAccountRemoval: record>, PermissionModel: record, OrganizationalUnitIds: record, ManagedExecution: record<Active: record>, Regions: list<string>>> {
  let input = $in
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "Action" $action "scalar") (serialize-qp "Version" $version "scalar")] | flatten | str join "&"
...
export def "api get-stack-update-operation" [
  ...
  --x-amz-signature: string
  --x-amz-signed-headers: string
]: nothing -> record<StackSetOperation: record<OperationId: record, StackSetId: record, Action: record, Status: record, OperationPreferences: record<RegionConcurrencyType: record, RegionOrder: record, FailureToleranceCount: record, FailureTolerancePercentage: record, MaxConcurrentCount: record, MaxConcurrentPercentage: record>, RetainStacks: record, AdministrationRoleARN: record, ExecutionRoleName: record, CreationTimestamp: record, EndTimestamp: record, DeploymentTargets: record<Accounts: record, AccountsUrl: record, OrganizationalUnitIds: record, AccountFilterType: record>, StackSetDriftDetectionDetails: record<DriftStatus: record, DriftDetectionStatus: record, LastDriftCheckTimestamp: record, TotalStackInstancesCount: record, DriftedStackInstancesCount: record, InSyncStackInstancesCount: record, InProgressStackInstancesCount: record, FailedStackInstancesCount: record>, StatusReason: record, StatusDetails: record<FailedStackInstancesCount: record>>> {
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"StackSetName": $stack_set_name, "OperationId": $operation_id, "CallAs": $call_as, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api create-get-stack-update-operation" [
  ...
  --x-amz-signed-headers: string
  --body: any
]: any -> record<StackSetOperation: record<OperationId: record, StackSetId: record, Action: record, Status: record, OperationPreferences: record<RegionConcurrencyType: record, RegionOrder: record, FailureToleranceCount: record, FailureTolerancePercentage: record, MaxConcurrentCount: record, MaxConcurrentPercentage: record>, RetainStacks: record, AdministrationRoleARN: record, ExecutionRoleName: record, CreationTimestamp: record, EndTimestamp: record, DeploymentTargets: record<Accounts: record, AccountsUrl: record, OrganizationalUnitIds: record, AccountFilterType: record>, StackSetDriftDetectionDetails: record<DriftStatus: record, DriftDetectionStatus: record, LastDriftCheckTimestamp: record, TotalStackInstancesCount: record, DriftedStackInstancesCount: record, InSyncStackInstancesCount: record, InProgressStackInstancesCount: record, FailedStackInstancesCount: record>, StatusReason: record, StatusDetails: record<FailedStackInstancesCount: record>>> {
  let input = $in
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "Action" $action "scalar") (serialize-qp "Version" $version "scalar")] | flatten | str join "&"
...
export def "api get-stacks" [
  ...
  --x-amz-signature: string
  --x-amz-signed-headers: string
]: nothing -> record<Stacks: record, NextToken: record> {
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "StackName" $stack_name "scalar") (serialize-qp "NextToken" $next_token "scalar") (serialize-qp "Action" $action "scalar") (serialize-qp "Version" $version "scalar")] | flatten | str join "&"
  let full_url = (build-url $base "/" $qp $auth.query)
...
export def "api get-type" [
  ...
  --x-amz-signature: string
  --x-amz-signed-headers: string
]: nothing -> record<Arn: record, Type: record, TypeName: record, DefaultVersionId: record, IsDefaultVersion: record, TypeTestsStatus: record, TypeTestsStatusDescription: record, Description: record, Schema: record, ProvisioningType: record, DeprecatedStatus: record, LoggingConfig: record<LogRoleArn: record, LogGroupName: record>, RequiredActivatedTypes: record, ExecutionRoleArn: record, Visibility: record, SourceUrl: record, DocumentationUrl: record, LastUpdated: record, TimeCreated: record, ConfigurationSchema: record, PublisherId: record, OriginalTypeName: record, OriginalTypeArn: record, PublicVersionNumber: record, LatestPublicVersion: record, IsActivated: record, AutoUpdate: record> {
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"Type": $type, "TypeName": $type_name, "Arn": $arn, "VersionId": $version_id, "PublisherId": $publisher_id, "PublicVersionNumber": $public_version_number, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api create-get-type" [
  ...
  --x-amz-signed-headers: string
  --body: any
]: any -> record<Arn: record, Type: record, TypeName: record, DefaultVersionId: record, IsDefaultVersion: record, TypeTestsStatus: record, TypeTestsStatusDescription: record, Description: record, Schema: record, ProvisioningType: record, DeprecatedStatus: record, LoggingConfig: record<LogRoleArn: record, LogGroupName: record>, RequiredActivatedTypes: record, ExecutionRoleArn: record, Visibility: record, SourceUrl: record, DocumentationUrl: record, LastUpdated: record, TimeCreated: record, ConfigurationSchema: record, PublisherId: record, OriginalTypeName: record, OriginalTypeArn: record, PublicVersionNumber: record, LatestPublicVersion: record, IsActivated: record, AutoUpdate: record> {
  let input = $in
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "Action" $action "scalar") (serialize-qp "Version" $version "scalar")] | flatten | str join "&"
...
export def "api get-type-registration" [
  ...
  --x-amz-signature: string
  --x-amz-signed-headers: string
]: nothing -> record<ProgressStatus: record, Description: record, TypeArn: record, TypeVersionArn: record> {
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"RegistrationToken": $registration_token, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api create-get-type-registration" [
  ...
  --x-amz-signed-headers: string
  --body: any
]: any -> record<ProgressStatus: record, Description: record, TypeArn: record, TypeVersionArn: record> {
  let input = $in
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "Action" $action "scalar") (serialize-qp "Version" $version "scalar")] | flatten | str join "&"
...
export def "api get-detect-stack-drift" [
  ...
  --x-amz-signature: string
  --x-amz-signed-headers: string
]: nothing -> record<StackDriftDetectionId: record> {
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"StackName": $stack_name, "LogicalResourceIds": $logical_resource_ids, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api create-detect-stack-drift" [
  ...
  --x-amz-signed-headers: string
  --body: any
]: any -> record<StackDriftDetectionId: record> {
  let input = $in
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "Action" $action "scalar") (serialize-qp "Version" $version "scalar")] | flatten | str join "&"
...
export def "api get-detect-stack-resource-drift" [
  ...
  --x-amz-signature: string
  --x-amz-signed-headers: string
]: nothing -> record<StackResourceDrift: record<StackId: record, LogicalResourceId: record, PhysicalResourceId: record, PhysicalResourceIdContext: record, ResourceType: record, ExpectedProperties: record, ActualProperties: record, PropertyDifferences: record, StackResourceDriftStatus: record, Timestamp: record, ModuleInfo: record<TypeHierarchy: record, LogicalIdHierarchy: record>>> {
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "StackName" $stack_name "scalar") (serialize-qp "LogicalResourceId" $logical_resource_id "scalar") (serialize-qp "Action" $action "scalar") (serialize-qp "Version" $version "scalar")] | flatten | str join "&"
  let full_url = (build-url $base "/" $qp $auth.query)
...
export def "api create-detect-stack-resource-drift" [
  ...
  --x-amz-signed-headers: string
  --body: any
]: any -> record<StackResourceDrift: record<StackId: record, LogicalResourceId: record, PhysicalResourceId: record, PhysicalResourceIdContext: record, ResourceType: record, ExpectedProperties: record, ActualProperties: record, PropertyDifferences: record, StackResourceDriftStatus: record, Timestamp: record, ModuleInfo: record<TypeHierarchy: record, LogicalIdHierarchy: record>>> {
  let input = $in
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "Action" $action "scalar") (serialize-qp "Version" $version "scalar")] | flatten | str join "&"
...
export def "api get-detect-stack-update-drift" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"StackSetName": $stack_set_name, "OperationPreferences": $operation_preferences, "OperationId": $operation_id, "CallAs": $call_as, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-estimate-template-cost" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"TemplateBody": $template_body, "TemplateURL": $template_url, "Parameters": $parameters, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-execute-change-update" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"ChangeSetName": $change_set_name, "StackName": $stack_name, "ClientRequestToken": $client_request_token, "DisableRollback": $disable_rollback, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-stack-policy" [
  ...
  --x-amz-signature: string
  --x-amz-signed-headers: string
]: nothing -> record<StackPolicyBody: record> {
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"StackName": $stack_name, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api create-get-stack-policy" [
  ...
  --x-amz-signed-headers: string
  --body: any
]: any -> record<StackPolicyBody: record> {
  let input = $in
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "Action" $action "scalar") (serialize-qp "Version" $version "scalar")] | flatten | str join "&"
...
export def "api get-template" [
  ...
  --x-amz-signature: string
  --x-amz-signed-headers: string
]: nothing -> record<TemplateBody: record, StagesAvailable: record> {
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"StackName": $stack_name, "ChangeSetName": $change_set_name, "TemplateStage": $template_stage, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api create-get-template" [
  ...
  --x-amz-signed-headers: string
  --body: any
]: any -> record<TemplateBody: record, StagesAvailable: record> {
  let input = $in
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "Action" $action "scalar") (serialize-qp "Version" $version "scalar")] | flatten | str join "&"
...
export def "api get-template-summary" [
  ...
  --x-amz-signature: string
  --x-amz-signed-headers: string
]: nothing -> record<Parameters: record, Description: record, Capabilities: record, CapabilitiesReason: record, ResourceTypes: record, Version: record, Metadata: record, DeclaredTransforms: record, ResourceIdentifierSummaries: record> {
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"TemplateBody": $template_body, "TemplateURL": $template_url, "StackName": $stack_name, "StackSetName": $stack_set_name, "CallAs": $call_as, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api create-get-template-summary" [
  ...
  --x-amz-signed-headers: string
  --body: any
]: any -> record<Parameters: record, Description: record, Capabilities: record, CapabilitiesReason: record, ResourceTypes: record, Version: record, Metadata: record, DeclaredTransforms: record, ResourceIdentifierSummaries: record> {
  let input = $in
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "Action" $action "scalar") (serialize-qp "Version" $version "scalar")] | flatten | str join "&"
...
export def "api get-import-stacks-to-stack-update" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"StackSetName": $stack_set_name, "StackIds": $stack_ids, "StackIdsUrl": $stack_ids_url, "OrganizationalUnitIds": $organizational_unit_ids, "OperationPreferences": $operation_preferences, "OperationId": $operation_id, "CallAs": $call_as, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-list-exports" [
  ...
  --x-amz-signature: string
  --x-amz-signed-headers: string
]: nothing -> record<Exports: record, NextToken: record> {
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "NextToken" $next_token "scalar") (serialize-qp "Action" $action "scalar") (serialize-qp "Version" $version "scalar")] | flatten | str join "&"
  let full_url = (build-url $base "/" $qp $auth.query)
...
export def "api create-list-exports" [
  ...
  --x-amz-signed-headers: string
  --body: any
]: any -> record<Exports: record, NextToken: record> {
  let input = $in
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "NextToken" $next_token "scalar") (serialize-qp "Action" $action "scalar") (serialize-qp "Version" $version "scalar")] | flatten | str join "&"
...
export def "api get-list-imports" [
  ...
  --x-amz-signature: string
  --x-amz-signed-headers: string
]: nothing -> record<Imports: record, NextToken: record> {
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"ExportName": $export_name, "NextToken": $next_token, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-list-stack-instances" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"StackSetName": $stack_set_name, "NextToken": $next_token, "MaxResults": $max_results, "Filters": $filters, "StackInstanceAccount": $stack_instance_account, "StackInstanceRegion": $stack_instance_region, "CallAs": $call_as, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-list-stack-resources" [
  ...
  --x-amz-signature: string
  --x-amz-signed-headers: string
]: nothing -> record<StackResourceSummaries: record, NextToken: record> {
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "StackName" $stack_name "scalar") (serialize-qp "NextToken" $next_token "scalar") (serialize-qp "Action" $action "scalar") (serialize-qp "Version" $version "scalar")] | flatten | str join "&"
  let full_url = (build-url $base "/" $qp $auth.query)
...
export def "api create-list-stack-resources" [
  ...
  --x-amz-signed-headers: string
  --body: any
]: any -> record<StackResourceSummaries: record, NextToken: record> {
  let input = $in
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "NextToken" $next_token "scalar") (serialize-qp "Action" $action "scalar") (serialize-qp "Version" $version "scalar")] | flatten | str join "&"
...
export def "api get-list-stack-update-operation-results" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"StackSetName": $stack_set_name, "OperationId": $operation_id, "NextToken": $next_token, "MaxResults": $max_results, "CallAs": $call_as, "Filters": $filters, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-list-stack-update-operations" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"StackSetName": $stack_set_name, "NextToken": $next_token, "MaxResults": $max_results, "CallAs": $call_as, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-list-stack-sets" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"NextToken": $next_token, "MaxResults": $max_results, "Status": $status, "CallAs": $call_as, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-list-stacks" [
  ...
  --x-amz-signature: string
  --x-amz-signed-headers: string
]: nothing -> record<StackSummaries: record, NextToken: record> {
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"NextToken": $next_token, "StackStatusFilter": $stack_status_filter, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api create-list-stacks" [
  ...
  --x-amz-signed-headers: string
  --body: any
]: any -> record<StackSummaries: record, NextToken: record> {
  let input = $in
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "NextToken" $next_token "scalar") (serialize-qp "Action" $action "scalar") (serialize-qp "Version" $version "scalar")] | flatten | str join "&"
...
export def "api get-list-type-registrations" [
  ...
  --x-amz-signature: string
  --x-amz-signed-headers: string
]: nothing -> record<RegistrationTokenList: record, NextToken: record> {
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"Type": $type, "TypeName": $type_name, "TypeArn": $type_arn, "RegistrationStatusFilter": $registration_status_filter, "MaxResults": $max_results, "NextToken": $next_token, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api create-list-type-registrations" [
  ...
  --x-amz-signed-headers: string
  --body: any
]: any -> record<RegistrationTokenList: record, NextToken: record> {
  let input = $in
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "MaxResults" $max_results "scalar") (serialize-qp "NextToken" $next_token "scalar") (serialize-qp "Action" $action "scalar") (serialize-qp "Version" $version "scalar")] | flatten | str join "&"
...
export def "api get-list-type-versions" [
  ...
  --x-amz-signature: string
  --x-amz-signed-headers: string
]: nothing -> record<TypeVersionSummaries: record, NextToken: record> {
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"Type": $type, "TypeName": $type_name, "Arn": $arn, "MaxResults": $max_results, "NextToken": $next_token, "DeprecatedStatus": $deprecated_status, "PublisherId": $publisher_id, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api create-list-type-versions" [
  ...
  --x-amz-signed-headers: string
  --body: any
]: any -> record<TypeVersionSummaries: record, NextToken: record> {
  let input = $in
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "MaxResults" $max_results "scalar") (serialize-qp "NextToken" $next_token "scalar") (serialize-qp "Action" $action "scalar") (serialize-qp "Version" $version "scalar")] | flatten | str join "&"
...
export def "api get-list-types" [
  ...
  --x-amz-signature: string
  --x-amz-signed-headers: string
]: nothing -> record<TypeSummaries: record, NextToken: record> {
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"Visibility": $visibility, "ProvisioningType": $provisioning_type, "DeprecatedStatus": $deprecated_status, "Type": $type, "Filters": $filters, "MaxResults": $max_results, "NextToken": $next_token, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api create-list-types" [
  ...
  --x-amz-signed-headers: string
  --body: any
]: any -> record<TypeSummaries: record, NextToken: record> {
  let input = $in
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "MaxResults" $max_results "scalar") (serialize-qp "NextToken" $next_token "scalar") (serialize-qp "Action" $action "scalar") (serialize-qp "Version" $version "scalar")] | flatten | str join "&"
...
export def "api get-publish-type" [
  ...
  --x-amz-signature: string
  --x-amz-signed-headers: string
]: nothing -> record<PublicTypeArn: record> {
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"Type": $type, "Arn": $arn, "TypeName": $type_name, "PublicVersionNumber": $public_version_number, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api create-publish-type" [
  ...
  --x-amz-signed-headers: string
  --body: any
]: any -> record<PublicTypeArn: record> {
  let input = $in
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "Action" $action "scalar") (serialize-qp "Version" $version "scalar")] | flatten | str join "&"
...
export def "api get-record-handler-progress" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"BearerToken": $bearer_token, "OperationStatus": $operation_status, "CurrentOperationStatus": $current_operation_status, "StatusMessage": $status_message, "ErrorCode": $error_code, "ResourceModel": $resource_model, "ClientRequestToken": $client_request_token, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-create-publisher" [
  ...
  --x-amz-signature: string
  --x-amz-signed-headers: string
]: nothing -> record<PublisherId: record> {
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"AcceptTermsAndConditions": $accept_terms_and_conditions, "ConnectionArn": $connection_arn, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-create-type" [
  ...
  --x-amz-signature: string
  --x-amz-signed-headers: string
]: nothing -> record<RegistrationToken: record> {
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"Type": $type, "TypeName": $type_name, "SchemaHandlerPackage": $schema_handler_package, "LoggingConfig": $logging_config, "ExecutionRoleArn": $execution_role_arn, "ClientRequestToken": $client_request_token, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api create-type" [
  ...
  --x-amz-signed-headers: string
  --body: any
]: any -> record<RegistrationToken: record> {
  let input = $in
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "Action" $action "scalar") (serialize-qp "Version" $version "scalar")] | flatten | str join "&"
...
export def "api get-rollback-stack" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"StackName": $stack_name, "RoleARN": $role_arn, "ClientRequestToken": $client_request_token, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-update-stack-policy" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"StackName": $stack_name, "StackPolicyBody": $stack_policy_body, "StackPolicyURL": $stack_policy_url, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-update-type-configuration" [
  ...
  --x-amz-signature: string
  --x-amz-signed-headers: string
]: nothing -> record<ConfigurationArn: record> {
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"TypeArn": $type_arn, "Configuration": $configuration, "ConfigurationAlias": $configuration_alias, "TypeName": $type_name, "Type": $type, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api create-update-type-configuration" [
  ...
  --x-amz-signed-headers: string
  --body: any
]: any -> record<ConfigurationArn: record> {
  let input = $in
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "Action" $action "scalar") (serialize-qp "Version" $version "scalar")] | flatten | str join "&"
...
export def "api get-signal-resource" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"StackName": $stack_name, "LogicalResourceId": $logical_resource_id, "UniqueId": $unique_id, "Status": $status, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-test-type" [
  ...
  --x-amz-signature: string
  --x-amz-signed-headers: string
]: nothing -> record<TypeVersionArn: record> {
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"Arn": $arn, "Type": $type, "TypeName": $type_name, "VersionId": $version_id, "LogDeliveryBucket": $log_delivery_bucket, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api create-test-type" [
  ...
  --x-amz-signed-headers: string
  --body: any
]: any -> record<TypeVersionArn: record> {
  let input = $in
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "Action" $action "scalar") (serialize-qp "Version" $version "scalar")] | flatten | str join "&"
...
export def "api get-update-stack" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"StackName": $stack_name, "TemplateBody": $template_body, "TemplateURL": $template_url, "UsePreviousTemplate": $use_previous_template, "StackPolicyDuringUpdateBody": $stack_policy_during_update_body, "StackPolicyDuringUpdateURL": $stack_policy_during_update_url, "Parameters": $parameters, "Capabilities": $capabilities, "ResourceTypes": $resource_types, "RoleARN": $role_arn, "RollbackConfiguration": $rollback_configuration, "StackPolicyBody": $stack_policy_body, "StackPolicyURL": $stack_policy_url, "NotificationARNs": $notification_ar_ns, "Tags": $tags, "DisableRollback": $disable_rollback, "ClientRequestToken": $client_request_token, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-update-termination-protection" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"EnableTerminationProtection": $enable_termination_protection, "StackName": $stack_name, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api get-validate-template" [
  ...
  --x-amz-signature: string
  --x-amz-signed-headers: string
]: nothing -> record<Parameters: record, Description: record, Capabilities: record, CapabilitiesReason: record, DeclaredTransforms: record> {
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"TemplateBody": $template_body, "TemplateURL": $template_url, "Action": $action, "Version": $version} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "api create-validate-template" [
  ...
  --x-amz-signed-headers: string
  --body: any
]: any -> record<Parameters: record, Description: record, Capabilities: record, CapabilitiesReason: record, DeclaredTransforms: record> {
  let input = $in
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "Action" $action "scalar") (serialize-qp "Version" $version "scalar")] | flatten | str join "&"
