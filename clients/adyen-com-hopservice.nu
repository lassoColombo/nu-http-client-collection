# Auto-generated client for Hosted onboarding API v6
# Source: https://api.apis.guru/v2/specs/adyen.com/HopService/6/openapi.json
# Auth: --token flag or $env.HOSTED_ONBOARDING_API_TOKEN

const BASE_URL = "https://cal-test.adyen.com/cal/services/Hop/v6"
const DEFAULT_AUTH = "x-api-key"

# Build auth: returns {headers: record, query: string}
def build-auth [token?: string, auth_scheme?: string]: nothing -> record {
  let token_val = if ($token != null) and ($token | is-not-empty) { $token } else { $env | get -o HOSTED_ONBOARDING_API_TOKEN | default "" }
