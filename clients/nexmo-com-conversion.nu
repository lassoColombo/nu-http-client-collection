...
def build-auth [token?: string, auth_scheme?: string]: nothing -> record {
  ...
  match $scheme {
    ...
    "query-api_secret" => { {headers: {}, query: $"(encode-path-segment "api_secret")=(encode-path-segment $token_val)"} }
    "query-sig" => { {headers: {}, query: $"(encode-path-segment "sig")=(encode-path-segment $token_val)"} }
    "none" => { {headers: {}, query: ""} }
