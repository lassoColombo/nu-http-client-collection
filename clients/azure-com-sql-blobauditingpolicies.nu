...
export def commands []: nothing -> table {
  ...
  let mod_name = (scope modules | where { $in.commands | any { $in.name == "subscriptions-resource-groups-providers-microsoft-sql-servers-databases-auditing-settings get-blob-policies" } } | get name | first)
...
# --properties shape: {auditActionsAndGroups?: list<string>, isStorageSecondaryKeyInUse?: bool, retentionDays?: int, state: "Enabled"|"Disabled", storageAccountAccessKey?: string, storageAccountSubscriptionId?: string, storageEndpoint?: string}
export def "subscriptions-resource-groups-providers-microsoft-sql-servers-databases-auditing-settings create-blob-policies-or-update" [
  ...
  --dry-run(-n) # Return the request that would be sent without executing it
  --api-version: string # The API version to use for the request.
  --properties: record # Properties of a database blob auditing policy. — shape: {auditActionsAndGroups?: list<string>, isStorageSecondaryKeyInUse?: bool, retentionDays?: int, state: "Enabled"|"Disabled", storageAccountAccessKey?: string, storageAccountSubscriptionId?: string, storageEndpoint?: string}
