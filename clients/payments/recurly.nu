...
export def "accounts accounts" [
  ...
  --subscriber: string@bool-completer # Filter for accounts with or without a subscription in the `active`, `canceled`, or `future` state.
...
export def "accounts account" [
  ...
  --tax-exempt: string@bool-completer # The tax status of the account. `true` exempts tax on the account, `false` applies tax on the account.
...
export def "accounts-billing-info info-by-account_id-1" [
  ...
  --primary-payment-method: string@bool-completer # The `primary_payment_method` field is used to designate the primary billing info on the account. The first billing info created on an account will always become primary. Adding additional billing infos provides the flexibility to mark another billing info as primary, or adding additional non-primary billing infos. This can be accomplished by passing the `primary_payment_method` with a value of `true`. When adding billing infos via the billing_info and /accounts endpoints, this value is not permitted, and will return an error if provided.
  --backup-payment-method: string@bool-completer # The `backup_payment_method` field is used to designate a billing info as a backup on the account that will be tried if the initial billing info used for an invoice is declined. All payment methods, including the billing info marked `primary_payment_method` can be set as a backup. An account can have a maximum of 1 backup, if a user sets a different payment method as a backup, the existing backup will no longer be marked as such.
...
export def "accounts-line-items item" [
  ...
  --tax-inclusive: string@bool-completer # Determines whether or not tax is included in the unit amount. The Tax Inclusive Pricing feature (separate from the Mixed Tax Pricing feature) must be enabled to use this flag. (default: false)
  ...
  --tax-exempt: string@bool-completer # `true` exempts tax on charges, `false` applies tax on charges. If not defined, then defaults to the Plan and Site settings. This attribute does not work for credits (negative line items). Credits are always applied post-tax. Pre-tax discounts should use the Coupons feature.
...
export def "coupons coupon" [
  ...
  --applies-to-non-plan-charges: string@bool-completer # The coupon is valid for one-time, non-plan charges if true. (default: false)
  --applies-to-all-plans: string@bool-completer # The coupon is valid for all plans if true. If false then `plans` will list the applicable plans. (default: true)
  --applies-to-all-items: string@bool-completer # To apply coupon to Items in your Catalog, include a list of `item_codes` in the request that the coupon will apply to. Or set value to true to apply to all Items in your Catalog. The following values are not permitted when `applies_to_all_items` is included: `free_trial_amount` and `free_trial_unit`.  (default: false)
...
export def "items item" [
  ...
  --tax-exempt: string@bool-completer # `true` exempts tax on the item, `false` applies tax on the item.
  --custom-fields: list # The custom fields will only be altered when they are included in a request. Sending an empty array will not remove any existing values. To remove a field send the name with a null or empty value. — item shape: {name: string, value: string, source_record_type?: "account"|"plan"|"product"|"subscription"}
...
export def "external-subscriptions subscription" [
  ...
  --auto-renew: string@bool-completer # An indication of whether or not the external subscription will auto-renew at the expiration date. (default: false)
  ...
  --imported: string@bool-completer # An indication of whether or not the external subscription was being created by a historical data import. (default: false)
...
export def "invoices-recovery retry" [
  ...
  --external-recovery-eligible: string@bool-completer # Must be set to `true` to acknowledge that the invoice is eligible for external recovery. Requests with `false`, omitted, or non-boolean values will be rejected.
...
export def "plans plan" [
  ...
  --trial-requires-billing-info: string@bool-completer # Allow free trial subscriptions to be created without billing info. Should not be used if billing info is needed for initial invoice due to existing uninvoiced charges or setup fee. (default: true)
  ...
  --allow-any-item-on-subscriptions: string@bool-completer # Used to determine whether items can be assigned as add-ons to individual subscriptions. If `true`, items can be assigned as add-ons to individual subscription add-ons. If `false`, only plan add-ons can be used.
...
export def "subscriptions subscription" [
  ...
  --auto-renew: string@bool-completer # Whether the subscription renews at the end of its term. (default: true)
  ...
  --bulk: string@bool-completer # Optional field to be used only when needing to bypass the 60 second limit on creating subscriptions. Should only be used when creating subscriptions in bulk from the API. (default: false)
...
export def "subscriptions subscription-by-subscription_id-1" [
  ...
  --tax-inclusive: string@bool-completer # This field is deprecated. Please do not use it. (DEPRECATED, default: false)
...
export def "gift-cards card" [
  ...
  currency: string # 3-letter ISO 4217 currency code.
  --tax-service-opt-out: string@bool-completer # Set to `true` to bypass sending the purchase to your configured tax service. Defaults to `false`.
