...
export def commands []: nothing -> table {
  ...
  let mod_name = (scope modules | where { $in.commands | any { $in.name == "messages get-raw-message-content" } } | get name | first)
...
export def "messages get-raw-message-content" [
  message_id: string
...
export def "messages update-raw-message-content" [
  message_id: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
