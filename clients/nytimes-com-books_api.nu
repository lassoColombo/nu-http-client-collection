...
export def "lists-format get" [
  ...
  let full_url = (build-url $base ({format: (encode-path-segment $format)} | format pattern "/lists.{format}") $qp $auth.query)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "get"
    url: $full_url
    query: ({"list": $list, "weeks-on-list": $weeks_on_list, "bestsellers-date": $bestsellers_date, "date": $date, "isbn": $isbn, "published-date": $published_date, "rank": $rank, "rank-last-week": $rank_last_week, "offset": $offset, "sort-order": $sort_order} | compact)
...
export def "lists-best-sellers-history-json get" [
  ...
  let full_url = (build-url $base "/lists/best-sellers/history.json" $qp $auth.query)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "get"
    url: $full_url
    query: ({"age-group": $age_group, "author": $author, "contributor": $contributor, "isbn": $isbn, "price": $price, "publisher": $publisher, "title": $title} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "lists-names-format get" [
  ...
  let full_url = (build-url $base ({format: (encode-path-segment $format)} | format pattern "/lists/names.{format}") $qp $auth.query)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "get"
    url: $full_url
    query: ({"api-key": $api_key} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "lists-overview-format get" [
  ...
  let full_url = (build-url $base ({format: (encode-path-segment $format)} | format pattern "/lists/overview.{format}") $qp $auth.query)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "get"
    url: $full_url
    query: ({"published_date": $published_date, "api-key": $api_key} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "lists get-json" [
  ...
  if ($list | is-empty) { error make --unspanned { msg: "path parameter 'list' must be non-empty" } }
  ...
  let full_url = (build-url $base ({date: (encode-path-segment $date), list: (encode-path-segment $list)} | format pattern "/lists/{date}/{list}.json") $qp $auth.query)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "get"
    url: $full_url
    query: ({"isbn": $isbn, "list-name": $list_name, "published-date": $published_date, "bestsellers-date": $bestsellers_date, "weeks-on-list": $weeks_on_list, "rank": $rank, "rank-last-week": $rank_last_week, "offset": $offset, "sort-order": $sort_order} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "reviews-format get" [
  ...
  let full_url = (build-url $base ({format: (encode-path-segment $format)} | format pattern "/reviews.{format}") $qp $auth.query)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "get"
    url: $full_url
    query: ({"isbn": $isbn, "title": $title, "author": $author, "api-key": $api_key} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
