...
def build-auth [token?: string, auth_scheme?: string]: nothing -> record {
  let token_val = if ($token | is-not-empty) { $token } else { $env | get -o SMS77_IO_API_TOKEN | default "" }
...
export def "analytics get" [
  ...
  let full_url = (build-url $base "/analytics" $qp $auth.query)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "get"
    url: $full_url
    query: ({"start": $start, "end": $end, "label": $label, "subaccounts": $subaccounts, "group_by": $group_by} | compact)
...
export def "contacts get" [
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"action": $action, "json": $json} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "contacts create" [
  ...
  let req = {
    method: "post"
    url: $full_url
    query: ({"action": $action, "json": $json, "id": $id, "nick": $nick, "empfaenger": $empfaenger, "email": $email} | compact)
    headers: $auth.headers
    body: null
...
export def "hooks create" [
  ...
  let req = {
    method: "post"
    url: $full_url
    query: ({"action": $action, "id": $id, "target_url": $target_url, "event_type": $event_type, "request_method": $request_method} | compact)
    headers: $auth.headers
    body: null
    content_type: "application/json"
    timeout: ($max_time | default 30min)
...
export def "lookup create" [
  ...
  let req = {
    method: "post"
    url: $full_url
    query: ({"type": $type, "number": $number, "json": $json} | compact)
    headers: $auth.headers
    body: null
    content_type: "application/json"
    timeout: ($max_time | default 30min)
...
export def "lookup-cnam create" [
  ...
  let full_url = (build-url $base "/lookup/cnam" $qp $auth.query)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "post"
    url: $full_url
    query: ({"number": $number} | compact)
    headers: $auth.headers
    body: null
    content_type: "application/json"
    timeout: ($max_time | default 30min)
...
export def "lookup-format create" [
  ...
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "number" $number "csv")] | flatten | str join "&"
  let full_url = (build-url $base "/lookup/format" $qp $auth.query)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "post"
...
export def "lookup-hlr create" [
  ...
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "number" $number "csv")] | flatten | str join "&"
  let full_url = (build-url $base "/lookup/hlr" $qp $auth.query)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "post"
...
export def "lookup-mnp create" [
  ...
  let full_url = (build-url $base "/lookup/mnp" $qp $auth.query)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "post"
    url: $full_url
    query: ({"number": $number, "json": $json} | compact)
    headers: $auth.headers
    body: null
    content_type: "application/json"
    timeout: ($max_time | default 30min)
...
export def "pricing get" [
  ...
  let full_url = (build-url $base "/pricing" $qp $auth.query)
  let accept_val = ($accept | default "application/json")
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "get"
    url: $full_url
    query: ({"country": $country, "format": $format} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "sms create" [
  ...
  let full_url = (build-url $base "/sms" $qp $auth.query)
  let accept_val = ($accept | default "application/json")
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "post"
    url: $full_url
    query: ({"text": $text, "to": $qp_to, "from": $qp_from, "foreign_id": $foreign_id, "label": $label, "udh": $udh, "delay": $delay, "debug": $debug, "no_reload": $no_reload, "unicode": $unicode, "flash": $flash, "utf8": $utf8, "details": $details, "return_msg_id": $return_msg_id, "json": $json, "performance_tracking": $performance_tracking} | compact)
    headers: $auth.headers
    body: null
    content_type: "application/json"
    timeout: ($max_time | default 30min)
...
export def "validate-for-voice validate" [
  ...
  let full_url = (build-url $base "/validate_for_voice" $qp $auth.query)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "post"
    url: $full_url
    query: ({"number": $number, "callback": $callback} | compact)
    headers: $auth.headers
    body: null
    content_type: "application/json"
    timeout: ($max_time | default 30min)
...
export def "voice create" [
  ...
  let full_url = (build-url $base "/voice" $qp $auth.query)
  let accept_val = "text/plain"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "post"
    url: $full_url
    query: ({"to": $qp_to, "text": $text, "xml": $xml, "from": $qp_from} | compact)
    headers: $auth.headers
    body: null
    content_type: "application/json"
    timeout: ($max_time | default 30min)
