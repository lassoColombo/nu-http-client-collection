...
const DEFAULT_AUTH = "advicement api key"
...
def build-auth [token?: string, auth_scheme?: string]: nothing -> record {
  ...
  match $scheme {
    "advicement api key" => { {headers: {ADVICEment API Key: $token_val}, query: ""} }
    "rapidapi.com api key" => { {headers: {RapidAPI.com API Key: $token_val}, query: ""} }
    "none" => { {headers: {}, query: ""} }
...
export def commands []: nothing -> table {
  ...
  let mod_name = (scope modules | where { $in.commands | any { $in.name == "templates-compile compile" } } | get name | first)
...
# operationId: compile
export def "templates-compile compile" [
