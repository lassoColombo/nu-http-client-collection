...
export def "2015-02-01-access-points get" [
  ...
  let extra_headers = {"X-Amz-Content-Sha256": $x_amz_content_sha256, "X-Amz-Date": $x_amz_date, "X-Amz-Algorithm": $x_amz_algorithm, "X-Amz-Credential": $x_amz_credential, "X-Amz-Security-Token": $x_amz_security_token, "X-Amz-Signature": $x_amz_signature, "X-Amz-SignedHeaders": $x_amz_signed_headers} | compact
  let auth = ($auth | update headers ($auth.headers | merge $extra_headers))
  do-request "get" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors $full "application/json" null {query: ({"MaxResults": $max_results, "NextToken": $next_token, "AccessPointId": $access_point_id, "FileSystemId": $file_system_id} | compact), body: null}
}
...
export def "2015-02-01-file-systems get" [
  ...
  let extra_headers = {"X-Amz-Content-Sha256": $x_amz_content_sha256, "X-Amz-Date": $x_amz_date, "X-Amz-Algorithm": $x_amz_algorithm, "X-Amz-Credential": $x_amz_credential, "X-Amz-Security-Token": $x_amz_security_token, "X-Amz-Signature": $x_amz_signature, "X-Amz-SignedHeaders": $x_amz_signed_headers} | compact
  let auth = ($auth | update headers ($auth.headers | merge $extra_headers))
  do-request "get" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors $full "application/json" null {query: ({"MaxItems": $max_items, "Marker": $marker, "CreationToken": $creation_token, "FileSystemId": $file_system_id} | compact), body: null}
}
...
export def "2015-02-01-mount-targets get" [
  ...
  let extra_headers = {"X-Amz-Content-Sha256": $x_amz_content_sha256, "X-Amz-Date": $x_amz_date, "X-Amz-Algorithm": $x_amz_algorithm, "X-Amz-Credential": $x_amz_credential, "X-Amz-Security-Token": $x_amz_security_token, "X-Amz-Signature": $x_amz_signature, "X-Amz-SignedHeaders": $x_amz_signed_headers} | compact
  let auth = ($auth | update headers ($auth.headers | merge $extra_headers))
  do-request "get" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors $full "application/json" null {query: ({"MaxItems": $max_items, "Marker": $marker, "FileSystemId": $file_system_id, "MountTargetId": $mount_target_id, "AccessPointId": $access_point_id} | compact), body: null}
}
...
export def "2015-02-01-file-systems-replication-configuration create" [
  ...
  let full_url = (build-url $base ({source_file_system_id: (encode-path-segment $source_file_system_id)} | format pattern "/2015-02-01/file-systems/{source_file_system_id}/replication-configuration"))
...
export def "2015-02-01-create-tags create" [
  ...
  let full_url = (build-url $base ({file_system_id: (encode-path-segment $file_system_id)} | format pattern "/2015-02-01/create-tags/{file_system_id}"))
...
export def "2015-02-01-access-points delete" [
  ...
  let full_url = (build-url $base ({access_point_id: (encode-path-segment $access_point_id)} | format pattern "/2015-02-01/access-points/{access_point_id}"))
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let extra_headers = {"X-Amz-Content-Sha256": $x_amz_content_sha256, "X-Amz-Date": $x_amz_date, "X-Amz-Algorithm": $x_amz_algorithm, "X-Amz-Credential": $x_amz_credential, "X-Amz-Security-Token": $x_amz_security_token, "X-Amz-Signature": $x_amz_signature, "X-Amz-SignedHeaders": $x_amz_signed_headers} | compact
  let auth = ($auth | update headers ($auth.headers | merge $extra_headers))
...
export def "2015-02-01-file-systems delete" [
  ...
  let base = ($base_url | default $BASE_URL)
  if ($file_system_id | is-empty) { error make --unspanned { msg: "path parameter 'FileSystemId' must be non-empty" } }
  let full_url = (build-url $base ({file_system_id: (encode-path-segment $file_system_id)} | format pattern "/2015-02-01/file-systems/{file_system_id}"))
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let extra_headers = {"X-Amz-Content-Sha256": $x_amz_content_sha256, "X-Amz-Date": $x_amz_date, "X-Amz-Algorithm": $x_amz_algorithm, "X-Amz-Credential": $x_amz_credential, "X-Amz-Security-Token": $x_amz_security_token, "X-Amz-Signature": $x_amz_signature, "X-Amz-SignedHeaders": $x_amz_signed_headers} | compact
  let auth = ($auth | update headers ($auth.headers | merge $extra_headers))
...
export def "2015-02-01-file-systems-policy delete" [
  ...
  let base = ($base_url | default $BASE_URL)
  if ($file_system_id | is-empty) { error make --unspanned { msg: "path parameter 'FileSystemId' must be non-empty" } }
  let full_url = (build-url $base ({file_system_id: (encode-path-segment $file_system_id)} | format pattern "/2015-02-01/file-systems/{file_system_id}/policy"))
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let extra_headers = {"X-Amz-Content-Sha256": $x_amz_content_sha256, "X-Amz-Date": $x_amz_date, "X-Amz-Algorithm": $x_amz_algorithm, "X-Amz-Credential": $x_amz_credential, "X-Amz-Security-Token": $x_amz_security_token, "X-Amz-Signature": $x_amz_signature, "X-Amz-SignedHeaders": $x_amz_signed_headers} | compact
  let auth = ($auth | update headers ($auth.headers | merge $extra_headers))
...
export def "2015-02-01-mount-targets delete" [
  ...
  let full_url = (build-url $base ({mount_target_id: (encode-path-segment $mount_target_id)} | format pattern "/2015-02-01/mount-targets/{mount_target_id}"))
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let extra_headers = {"X-Amz-Content-Sha256": $x_amz_content_sha256, "X-Amz-Date": $x_amz_date, "X-Amz-Algorithm": $x_amz_algorithm, "X-Amz-Credential": $x_amz_credential, "X-Amz-Security-Token": $x_amz_security_token, "X-Amz-Signature": $x_amz_signature, "X-Amz-SignedHeaders": $x_amz_signed_headers} | compact
  let auth = ($auth | update headers ($auth.headers | merge $extra_headers))
...
export def "2015-02-01-delete-tags delete" [
  ...
  let base = ($base_url | default $BASE_URL)
  if ($file_system_id | is-empty) { error make --unspanned { msg: "path parameter 'FileSystemId' must be non-empty" } }
  let full_url = (build-url $base ({file_system_id: (encode-path-segment $file_system_id)} | format pattern "/2015-02-01/delete-tags/{file_system_id}"))
...
export def "2015-02-01-file-systems-backup-policy get" [
  ...
  let base = ($base_url | default $BASE_URL)
  if ($file_system_id | is-empty) { error make --unspanned { msg: "path parameter 'FileSystemId' must be non-empty" } }
  let full_url = (build-url $base ({file_system_id: (encode-path-segment $file_system_id)} | format pattern "/2015-02-01/file-systems/{file_system_id}/backup-policy"))
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let extra_headers = {"X-Amz-Content-Sha256": $x_amz_content_sha256, "X-Amz-Date": $x_amz_date, "X-Amz-Algorithm": $x_amz_algorithm, "X-Amz-Credential": $x_amz_credential, "X-Amz-Security-Token": $x_amz_security_token, "X-Amz-Signature": $x_amz_signature, "X-Amz-SignedHeaders": $x_amz_signed_headers} | compact
  let auth = ($auth | update headers ($auth.headers | merge $extra_headers))
...
export def "2015-02-01-file-systems-lifecycle-configuration get" [
  ...
  let base = ($base_url | default $BASE_URL)
  if ($file_system_id | is-empty) { error make --unspanned { msg: "path parameter 'FileSystemId' must be non-empty" } }
  let full_url = (build-url $base ({file_system_id: (encode-path-segment $file_system_id)} | format pattern "/2015-02-01/file-systems/{file_system_id}/lifecycle-configuration"))
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let extra_headers = {"X-Amz-Content-Sha256": $x_amz_content_sha256, "X-Amz-Date": $x_amz_date, "X-Amz-Algorithm": $x_amz_algorithm, "X-Amz-Credential": $x_amz_credential, "X-Amz-Security-Token": $x_amz_security_token, "X-Amz-Signature": $x_amz_signature, "X-Amz-SignedHeaders": $x_amz_signed_headers} | compact
  let auth = ($auth | update headers ($auth.headers | merge $extra_headers))
...
export def "2015-02-01-mount-targets-security-groups get" [
  ...
  let base = ($base_url | default $BASE_URL)
  if ($mount_target_id | is-empty) { error make --unspanned { msg: "path parameter 'MountTargetId' must be non-empty" } }
  let full_url = (build-url $base ({mount_target_id: (encode-path-segment $mount_target_id)} | format pattern "/2015-02-01/mount-targets/{mount_target_id}/security-groups"))
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let extra_headers = {"X-Amz-Content-Sha256": $x_amz_content_sha256, "X-Amz-Date": $x_amz_date, "X-Amz-Algorithm": $x_amz_algorithm, "X-Amz-Credential": $x_amz_credential, "X-Amz-Security-Token": $x_amz_security_token, "X-Amz-Signature": $x_amz_signature, "X-Amz-SignedHeaders": $x_amz_signed_headers} | compact
  let auth = ($auth | update headers ($auth.headers | merge $extra_headers))
...
export def "2015-02-01-file-systems-replication-configurations get" [
  ...
  let extra_headers = {"X-Amz-Content-Sha256": $x_amz_content_sha256, "X-Amz-Date": $x_amz_date, "X-Amz-Algorithm": $x_amz_algorithm, "X-Amz-Credential": $x_amz_credential, "X-Amz-Security-Token": $x_amz_security_token, "X-Amz-Signature": $x_amz_signature, "X-Amz-SignedHeaders": $x_amz_signed_headers} | compact
  let auth = ($auth | update headers ($auth.headers | merge $extra_headers))
  do-request "get" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors $full "application/json" null {query: ({"FileSystemId": $file_system_id, "NextToken": $next_token, "MaxResults": $max_results} | compact), body: null}
}
...
export def "2015-02-01-tags get" [
  ...
  let full_url = (build-url $base ({file_system_id: (encode-path-segment $file_system_id)} | format pattern "/2015-02-01/tags/{file_system_id}/") $qp)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let extra_headers = {"X-Amz-Content-Sha256": $x_amz_content_sha256, "X-Amz-Date": $x_amz_date, "X-Amz-Algorithm": $x_amz_algorithm, "X-Amz-Credential": $x_amz_credential, "X-Amz-Security-Token": $x_amz_security_token, "X-Amz-Signature": $x_amz_signature, "X-Amz-SignedHeaders": $x_amz_signed_headers} | compact
  let auth = ($auth | update headers ($auth.headers | merge $extra_headers))
...
export def "2015-02-01-resource-tags list" [
  ...
  let full_url = (build-url $base ({resource_id: (encode-path-segment $resource_id)} | format pattern "/2015-02-01/resource-tags/{resource_id}") $qp)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let extra_headers = {"X-Amz-Content-Sha256": $x_amz_content_sha256, "X-Amz-Date": $x_amz_date, "X-Amz-Algorithm": $x_amz_algorithm, "X-Amz-Credential": $x_amz_credential, "X-Amz-Security-Token": $x_amz_security_token, "X-Amz-Signature": $x_amz_signature, "X-Amz-SignedHeaders": $x_amz_signed_headers} | compact
  let auth = ($auth | update headers ($auth.headers | merge $extra_headers))
...
export def "2015-02-01-resource-tags tag" [
  ...
  let base = ($base_url | default $BASE_URL)
  if ($resource_id | is-empty) { error make --unspanned { msg: "path parameter 'ResourceId' must be non-empty" } }
  let full_url = (build-url $base ({resource_id: (encode-path-segment $resource_id)} | format pattern "/2015-02-01/resource-tags/{resource_id}"))
  let req_body = {"Tags": $tags} | compact
  let req_body = if ($input | describe | str starts-with "record") { $input | merge deep ($req_body | default {}) } else { $req_body }
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
