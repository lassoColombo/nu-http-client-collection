...
export def commands []: nothing -> table {
  ...
  let mod_name = (scope modules | where { $in.commands | any { $in.name == "games-v1configuration-achievements gamesConfigurationachievementConfigurationsdelete" } } | get name | first)
