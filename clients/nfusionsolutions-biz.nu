...
def build-auth [token?: string, auth_scheme?: string]: nothing -> record {
  let token_val = if ($token | is-not-empty) { $token } else { $env | get -o NFUSION_SOLUTIONS_MARKET_DATA_API_TOKEN | default "" }
...
export def "currencies-history get" [
  ...
  let full_url = (build-url $base "/api/v1/Currencies/history" $qp $auth.query)
  let accept_val = ($accept | default "application/json")
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "get"
    url: $full_url
    query: ({"pairs": $pairs, "start": $start, "end": $end, "interval": $interval, "format": $format} | compact)
...
export def "currencies-history-supported get" [
  ...
  let full_url = (build-url $base "/api/v1/Currencies/history/supported" $qp $auth.query)
  let accept_val = ($accept | default "application/json")
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "get"
...
export def "currencies-rate get" [
  ...
  let full_url = (build-url $base "/api/v1/Currencies/rate" $qp $auth.query)
  let accept_val = ($accept | default "application/json")
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "get"
    url: $full_url
    query: ({"pairs": $pairs, "format": $format} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "currencies-rate-supported get" [
  ...
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "format" $format "scalar")] | flatten | str join "&"
  let full_url = (build-url $base "/api/v1/Currencies/rate/supported" $qp $auth.query)
  let accept_val = ($accept | default "application/json")
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "get"
...
export def "currencies-summary get" [
  ...
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "pairs" $pairs "scalar") (serialize-qp "format" $format "scalar")] | flatten | str join "&"
  let full_url = (build-url $base "/api/v1/Currencies/summary" $qp $auth.query)
  let accept_val = ($accept | default "application/json")
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "get"
...
export def "currencies-summary-supported get" [
  ...
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "format" $format "scalar")] | flatten | str join "&"
  let full_url = (build-url $base "/api/v1/Currencies/summary/supported" $qp $auth.query)
  let accept_val = ($accept | default "application/json")
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "get"
...
export def "metals-benchmark-history get" [
  ...
  let full_url = (build-url $base "/api/v1/Metals/benchmark/history" $qp $auth.query)
  let accept_val = ($accept | default "application/json")
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "get"
    url: $full_url
    query: ({"metals": $metals, "start": $start, "end": $end, "interval": $interval, "historicalfx": $historicalfx, "currency": $currency, "unitofmeasure": $unitofmeasure, "format": $format} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "metals-benchmark-summary get" [
  ...
  let full_url = (build-url $base "/api/v1/Metals/benchmark/summary" $qp $auth.query)
  let accept_val = ($accept | default "application/json")
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "get"
    url: $full_url
    query: ({"metals": $metals, "currency": $currency, "unitofmeasure": $unitofmeasure, "format": $format} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "metals-benchmark-supported get" [
  ...
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "format" $format "scalar")] | flatten | str join "&"
  let full_url = (build-url $base "/api/v1/Metals/benchmark/supported" $qp $auth.query)
  let accept_val = ($accept | default "application/json")
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "get"
...
export def "metals-spot-history get" [
  ...
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "metals" $metals "scalar") (serialize-qp "start" $start "scalar") (serialize-qp "end" $end "scalar") (serialize-qp "interval" $interval "scalar") (serialize-qp "historicalfx" $historicalfx "scalar") (serialize-qp "currency" $currency "scalar") (serialize-qp "unitofmeasure" $unitofmeasure "scalar") (serialize-qp "format" $format "scalar")] | flatten | str join "&"
  let full_url = (build-url $base "/api/v1/Metals/spot/history" $qp $auth.query)
  let accept_val = ($accept | default "application/json")
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "get"
...
export def "metals-spot-performance get-historical" [
  ...
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "metals" $metals "scalar") (serialize-qp "currency" $currency "scalar") (serialize-qp "unitofmeasure" $unitofmeasure "scalar") (serialize-qp "format" $format "scalar")] | flatten | str join "&"
  let full_url = (build-url $base "/api/v1/Metals/spot/performance" $qp $auth.query)
  let accept_val = ($accept | default "application/json")
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "get"
...
export def "metals-spot-performance-annual get-historical" [
  ...
  let full_url = (build-url $base "/api/v1/Metals/spot/performance/annual" $qp $auth.query)
  let accept_val = ($accept | default "application/json")
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "get"
    url: $full_url
    query: ({"metals": $metals, "currency": $currency, "unitofmeasure": $unitofmeasure, "format": $format, "years": $years} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "metals-spot-ratio-history get" [
  ...
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "pairs" $pairs "scalar") (serialize-qp "start" $start "scalar") (serialize-qp "end" $end "scalar") (serialize-qp "interval" $interval "scalar") (serialize-qp "format" $format "scalar")] | flatten | str join "&"
  let full_url = (build-url $base "/api/v1/Metals/spot/ratio/history" $qp $auth.query)
  let accept_val = ($accept | default "application/json")
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "get"
...
export def "metals-spot-ratio-summary get" [
  ...
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "pairs" $pairs "scalar") (serialize-qp "format" $format "scalar")] | flatten | str join "&"
  let full_url = (build-url $base "/api/v1/Metals/spot/ratio/summary" $qp $auth.query)
  let accept_val = ($accept | default "application/json")
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "get"
...
export def "metals-spot-summary get" [
  ...
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "metals" $metals "scalar") (serialize-qp "currency" $currency "scalar") (serialize-qp "unitofmeasure" $unitofmeasure "scalar") (serialize-qp "format" $format "scalar")] | flatten | str join "&"
  let full_url = (build-url $base "/api/v1/Metals/spot/summary" $qp $auth.query)
  let accept_val = ($accept | default "application/json")
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "get"
...
export def "metals-spot-supported get" [
  ...
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "format" $format "scalar")] | flatten | str join "&"
  let full_url = (build-url $base "/api/v1/Metals/spot/supported" $qp $auth.query)
  let accept_val = ($accept | default "application/json")
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "get"
...
export def "metals-supported-currency get-currencies" [
  ...
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "format" $format "scalar")] | flatten | str join "&"
  let full_url = (build-url $base "/api/v1/Metals/supported/currency" $qp $auth.query)
  let accept_val = ($accept | default "application/json")
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "get"
