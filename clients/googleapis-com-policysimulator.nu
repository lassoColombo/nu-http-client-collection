# Auto-generated client for Policy Simulator API vv1beta
# Source: https://api.apis.guru/v2/specs/googleapis.com/policysimulator/v1beta/openapi.json
# Auth: --token flag or $env.POLICY_SIMULATOR_API_TOKEN
...
def build-auth [token?: string, auth_scheme?: string]: nothing -> record {
  let token_val = if ($token | is-not-empty) { $token } else { $env | get -o POLICY_SIMULATOR_API_TOKEN | default "" }
...
def base-url-completer [] { ["https://policysimulator.googleapis.com"] }
...
export def "v1beta list" [
  ...
  let auth = (merge-auth [(build-auth ($token_oauth2 | default ($env | get -o POLICY_SIMULATOR_API_OAUTH2_TOKEN | default "")) "bearer") (build-auth ($token_oauth2c | default ($env | get -o POLICY_SIMULATOR_API_OAUTH2C_TOKEN | default "")) "bearer")])
