...
export def commands []: nothing -> table {
  ...
  let mod_name = (scope modules | where { $in.commands | any { $in.name == "subscriptions-resource-groups-providers-microsoft-api-management-service-authorization-servers ListByService" } } | get name | first)
...
export def "subscriptions-resource-groups-providers-microsoft-api-management-service-authorization-servers ListByService" [
  ...
  let full_url = (build-url $base $"/subscriptions/($subscriptionId)/resourceGroups/($resourceGroupName)/providers/Microsoft.ApiManagement/service/($serviceName)/authorizationServers" $qp)
...
export def "subscriptions-resource-groups-providers-microsoft-api-management-service-authorization-servers Delete" [
  ...
  let full_url = (build-url $base $"/subscriptions/($subscriptionId)/resourceGroups/($resourceGroupName)/providers/Microsoft.ApiManagement/service/($serviceName)/authorizationServers/($authsid)" $qp)
...
export def "subscriptions-resource-groups-providers-microsoft-api-management-service-authorization-servers GetEntityTag" [
  resourceGroupName: string
  serviceName: string
  authsid: string
  subscriptionId: string
...
# --properties shape: {authorizationEndpoint: string, clientId: string, clientRegistrationEndpoint: string, clientSecret?: string, displayName: string, grantTypes: list, authorizationMethods?: list, bearerTokenSendingMethods?: list, clientAuthenticationMethod?: list, defaultScope?: string, description?: string, resourceOwnerPassword?: string, resourceOwnerUsername?: string, supportState?: bool, tokenBodyParameters?: list, tokenEndpoint?: string}
export def "subscriptions-resource-groups-providers-microsoft-api-management-service-authorization-servers CreateOrUpdate" [
  resourceGroupName: string
  serviceName: string
  authsid: string
  subscriptionId: string
...
export def "subscriptions-resource-groups-providers-microsoft-api-management-service-authorization-servers-list-secrets ListSecrets" [
  resourceGroupName: string
  serviceName: string
  authsid: string
  subscriptionId: string
  ...
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "api-version" $api_version "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/subscriptions/($subscriptionId)/resourceGroups/($resourceGroupName)/providers/Microsoft.ApiManagement/service/($serviceName)/authorizationServers/($authsid)/listSecrets" $qp)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
