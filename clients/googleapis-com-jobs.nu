...
export def "v3p1beta1 jobsprojectsjobsdelete" [
  ...
  let full_url = (build-url $base ({name: $name} | format pattern "/v3p1beta1/{name}") $qp)
...
export def "v3p1beta1 jobsprojectsjobspatch" [
  ...
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $pretty_print "scalar") (serialize-qp "quotaUser" $quota_user "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $upload_type "scalar")] | flatten | str join "&"
  let full_url = (build-url $base ({name: $name} | format pattern "/v3p1beta1/{name}") $qp)
  let body = {"job": $job, "updateMask": $update_mask} | compact
...
export def "v3p1beta1 jobsprojectscomplete" [
  ...
  let full_url = (build-url $base ({name: $name} | format pattern "/v3p1beta1/{name}:complete") $qp)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "get" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json"
}
...
export def "v3p1beta1-client-events jobsprojectsclientEventscreate" [
  ...
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $pretty_print "scalar") (serialize-qp "quotaUser" $quota_user "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $upload_type "scalar")] | flatten | str join "&"
  let full_url = (build-url $base ({parent: $parent} | format pattern "/v3p1beta1/{parent}/clientEvents") $qp)
  let body = {"clientEvent": $client_event} | compact
  let body = if ($input | describe | str starts-with "record") { $input | merge deep ($body | default {}) } else { $body }
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
...
export def "v3p1beta1-companies jobsprojectscompanieslist" [
  ...
  let full_url = (build-url $base ({parent: $parent} | format pattern "/v3p1beta1/{parent}/companies") $qp)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "get" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json"
}
...
export def "v3p1beta1-jobs jobsprojectsjobslist" [
  ...
  let full_url = (build-url $base ({parent: $parent} | format pattern "/v3p1beta1/{parent}/jobs") $qp)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "get" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json"
}
...
export def "v3p1beta1-jobs-batch-delete jobsprojectsjobsbatchDelete" [
  ...
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $pretty_print "scalar") (serialize-qp "quotaUser" $quota_user "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $upload_type "scalar")] | flatten | str join "&"
  let full_url = (build-url $base ({parent: $parent} | format pattern "/v3p1beta1/{parent}/jobs:batchDelete") $qp)
...
export def "v3p1beta1-jobs-search jobsprojectsjobssearch" [
  ...
  --histogram-facets: record # Input only. Histogram facets to be specified in SearchJobsRequest. — shape: {compensationHistogramFacets?: list, customAttributeHistogramFacets?: list, simpleHistogramFacets?: list}
  ...
  --job-query: record # Input only. The query required to perform a search query. — shape: {commuteFilter?: record, companyDisplayNames?: list, companyNames?: list, compensationFilter?: record, customAttributeFilter?: string, disableSpellCheck?: bool, employmentTypes?: list, excludedJobs?: list, jobCategories?: list, languageCodes?: list, locationFilters?: list, publishTimeRange?: record, query?: string, queryLanguageCode?: string}
...
export def "v3p1beta1-jobs-search-for-alert jobsprojectsjobssearchForAlert" [
  ...
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $pretty_print "scalar") (serialize-qp "quotaUser" $quota_user "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $upload_type "scalar")] | flatten | str join "&"
  let full_url = (build-url $base ({parent: $parent} | format pattern "/v3p1beta1/{parent}/jobs:searchForAlert") $qp)
  let body = {"customRankingInfo": $custom_ranking_info, "disableKeywordMatch": $disable_keyword_match, "diversificationLevel": $diversification_level, "enableBroadening": $enable_broadening, "histogramFacets": $histogram_facets, "histogramQueries": $histogram_queries, "jobQuery": $job_query, "jobView": $job_view, "offset": $offset, "orderBy": $order_by, "pageSize": $page_size, "pageToken": $page_token, "requestMetadata": $request_metadata, "requirePreciseResultSize": $require_precise_result_size, "searchMode": $search_mode} | compact
  let body = if ($input | describe | str starts-with "record") { $input | merge deep ($body | default {}) } else { $body }
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
