...
def jobView-completer [] { ["JOB_VIEW_FULL" "JOB_VIEW_ID_ONLY" "JOB_VIEW_MINIMAL" "JOB_VIEW_SMALL" "JOB_VIEW_UNSPECIFIED"] }
def diversificationLevel-completer [] { ["DISABLED" "DIVERSIFICATION_LEVEL_UNSPECIFIED" "SIMPLE"] }
def searchMode-completer [] { ["FEATURED_JOB_SEARCH" "JOB_SEARCH" "SEARCH_MODE_UNSPECIFIED"] }

# List all available API commands with their parameters
export def commands []: nothing -> table {
  let builtin_flags = ["base-url" "token" "auth-scheme" "insecure" "max-time" "raw" "allow-errors" "dry-run" "accept" "help"]
  let mod_name = (scope modules | where { $in.commands | any { $in.name == "v3p1beta1 jobsprojectsjobsdelete" } } | get name | first)
...
export def "v3p1beta1 jobsprojectsjobsdelete" [
  name: string
  ...
  let full_url = (build-url $base $"/v3p1beta1/($name)" $qp)
...
export def "v3p1beta1 jobsprojectsoperationsget" [
  name: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
...
# --job shape: {addresses?: list, applicationInfo?: record, companyDisplayName?: string, companyName?: string, compensationInfo?: record, customAttributes?: record, degreeTypes?: list, department?: string, derivedInfo?: record, description?: string, employmentTypes?: list, incentives?: string, jobBenefits?: list, jobEndTime?: string, jobLevel?: "JOB_LEVEL_UNSPECIFIED"|"ENTRY_LEVEL"|"EXPERIENCED"|"MANAGER"|"DIRECTOR"|"EXECUTIVE", jobStartTime?: string, languageCode?: string, name?: string, postingCreateTime?: string, postingExpireTime?: string, postingPublishTime?: string, postingRegion?: "POSTING_REGION_UNSPECIFIED"|"ADMINISTRATIVE_AREA"|"NATION"|"TELECOMMUTE", postingUpdateTime?: string, processingOptions?: record, promotionValue?: int, qualifications?: string, requisitionId?: string, responsibilities?: string, title?: string, visibility?: "VISIBILITY_UNSPECIFIED"|"ACCOUNT_ONLY"|"SHARED_WITH_GOOGLE"|"SHARED_WITH_PUBLIC"}
export def "v3p1beta1 jobsprojectsjobspatch" [
  name: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  ...
  --upload-protocol: string # Upload protocol for media (e.g. "raw", "multipart").
  --uploadType: string # Legacy upload protocol for media (e.g. "media", "multipart").
  --job: record # A Job resource represents a job posting (also referred to as a "job listing" or "job requisition"). A job belongs to a Company, which is the hiring entity responsible for the job. — shape: {addresses?: list, applicationInfo?: record, companyDisplayName?: string, companyName?: string, compensationInfo?: record, customAttributes?: record, degreeTypes?: list, department?: string, derivedInfo?: record, description?: string, employmentTypes?: list, incentives?: string, jobBenefits?: list, jobEndTime?: string, jobLevel?: "JOB_LEVEL_UNSPECIFIED"|"ENTRY_LEVEL"|"EXPERIENCED"|"MANAGER"|"DIRECTOR"|"EXECUTIVE", jobStartTime?: string, languageCode?: string, name?: string, postingCreateTime?: string, postingExpireTime?: string, postingPublishTime?: string, postingRegion?: "POSTING_REGION_UNSPECIFIED"|"ADMINISTRATIVE_AREA"|"NATION"|"TELECOMMUTE", postingUpdateTime?: string, processingOptions?: record, promotionValue?: int, qualifications?: string, requisitionId?: string, responsibilities?: string, title?: string, visibility?: "VISIBILITY_UNSPECIFIED"|"ACCOUNT_ONLY"|"SHARED_WITH_GOOGLE"|"SHARED_WITH_PUBLIC"}
  ...
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $qp_fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v3p1beta1/($name)" $qp)
  let body = {job: $job, updateMask: $updateMask} | compact
...
export def "v3p1beta1 jobsprojectscomplete" [
  name: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  ...
  --languageCodes: list # Optional. The list of languages of the query. This is the BCP-47 language code, such as "en-US" or "sr-Latn". For more information, see [Tags for Identifying Languages](https://tools.ietf.org/html/bcp47). For CompletionType.JOB_TITLE type, only open jobs with the same language_codes are returned. For CompletionType.COMPANY_NAME type, only companies having open jobs with the same language_codes are returned. For CompletionType.COMBINED type, only open jobs with the same language_codes or companies having open jobs with the same language_codes are returned. The maximum number of allowed characters is 255.
  --pageSize: int # Required. Completion result count. The maximum allowed page size is 10.
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $qp_fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar") (serialize-qp "companyName" $companyName "scalar") (serialize-qp "languageCode" $languageCode "scalar") (serialize-qp "languageCodes" $languageCodes "multi") (serialize-qp "pageSize" $pageSize "scalar") (serialize-qp "query" $qp_query "scalar") (serialize-qp "scope" $scope "scalar") (serialize-qp "type" $type "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v3p1beta1/($name):complete" $qp)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "get" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json"
}
...
export def "v3p1beta1-client-events jobsprojectsclientEventscreate" [
  parent: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  ...
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $qp_fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v3p1beta1/($parent)/clientEvents" $qp)
  let body = {clientEvent: $clientEvent} | compact
  let body = if ($input | describe | str starts-with "record") { $input | merge deep ($body | default {}) } else { $body }
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
...
export def "v3p1beta1-companies jobsprojectscompanieslist" [
  parent: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  ...
  --upload-protocol: string # Upload protocol for media (e.g. "raw", "multipart").
  --uploadType: string # Legacy upload protocol for media (e.g. "media", "multipart").
  --pageSize: int # Optional. The maximum number of companies to be returned, at most 100. Default is 100 if a non-positive number is provided.
  --pageToken: string # Optional. The starting indicator from which to return results.
  --requireOpenJobs: oneof<nothing, bool> # Optional. Set to true if the companies requested must have open jobs. Defaults to false. If true, at most page_size of companies are fetched, among which only those with open jobs are returned.
...
# --company shape: {careerSiteUri?: string, derivedInfo?: record, displayName?: string, eeoText?: string, externalId?: string, headquartersAddress?: string, hiringAgency?: bool, imageUri?: string, keywordSearchableJobCustomAttributes?: list, name?: string, size?: "COMPANY_SIZE_UNSPECIFIED"|"MINI"|"SMALL"|"SMEDIUM"|"MEDIUM"|"BIG"|"BIGGER"|"GIANT", suspended?: bool, websiteUri?: string}
export def "v3p1beta1-companies jobsprojectscompaniescreate" [
  parent: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
...
export def "v3p1beta1-jobs jobsprojectsjobslist" [
  parent: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  ...
  --jobView: string@jobView-completer # Optional. The desired job attributes returned for jobs in the search response. Defaults to JobView.JOB_VIEW_FULL if no value is specified.
  --pageSize: int # Optional. The maximum number of jobs to be returned per page of results. If job_view is set to JobView.JOB_VIEW_ID_ONLY, the maximum allowed page size is 1000. Otherwise, the maximum allowed page size is 100. Default is 100 if empty or a number < 1 is specified.
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $qp_fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar") (serialize-qp "filter" $filter "scalar") (serialize-qp "jobView" $jobView "scalar") (serialize-qp "pageSize" $pageSize "scalar") (serialize-qp "pageToken" $pageToken "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v3p1beta1/($parent)/jobs" $qp)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "get" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json"
}
...
# --job shape: {addresses?: list, applicationInfo?: record, companyDisplayName?: string, companyName?: string, compensationInfo?: record, customAttributes?: record, degreeTypes?: list, department?: string, derivedInfo?: record, description?: string, employmentTypes?: list, incentives?: string, jobBenefits?: list, jobEndTime?: string, jobLevel?: "JOB_LEVEL_UNSPECIFIED"|"ENTRY_LEVEL"|"EXPERIENCED"|"MANAGER"|"DIRECTOR"|"EXECUTIVE", jobStartTime?: string, languageCode?: string, name?: string, postingCreateTime?: string, postingExpireTime?: string, postingPublishTime?: string, postingRegion?: "POSTING_REGION_UNSPECIFIED"|"ADMINISTRATIVE_AREA"|"NATION"|"TELECOMMUTE", postingUpdateTime?: string, processingOptions?: record, promotionValue?: int, qualifications?: string, requisitionId?: string, responsibilities?: string, title?: string, visibility?: "VISIBILITY_UNSPECIFIED"|"ACCOUNT_ONLY"|"SHARED_WITH_GOOGLE"|"SHARED_WITH_PUBLIC"}
export def "v3p1beta1-jobs jobsprojectsjobscreate" [
  parent: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
...
export def "v3p1beta1-jobs-batch-delete jobsprojectsjobsbatchDelete" [
  parent: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  ...
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $qp_fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v3p1beta1/($parent)/jobs:batchDelete" $qp)
...
# --histogramFacets shape: {compensationHistogramFacets?: list, customAttributeHistogramFacets?: list, simpleHistogramFacets?: list}
# --histogramQueries item shape: {histogramQuery?: string}
# --jobQuery shape: {commuteFilter?: record, companyDisplayNames?: list, companyNames?: list, compensationFilter?: record, customAttributeFilter?: string, disableSpellCheck?: bool, employmentTypes?: list, excludedJobs?: list, jobCategories?: list, languageCodes?: list, locationFilters?: list, publishTimeRange?: record, query?: string, queryLanguageCode?: string}
# --requestMetadata shape: {deviceInfo?: record, domain?: string, sessionId?: string, userId?: string}
export def "v3p1beta1-jobs-search jobsprojectsjobssearch" [
  parent: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  ...
  --upload-protocol: string # Upload protocol for media (e.g. "raw", "multipart").
  --uploadType: string # Legacy upload protocol for media (e.g. "media", "multipart").
  --customRankingInfo: record # Input only. Custom ranking information for SearchJobsRequest. — shape: {importanceLevel?: "IMPORTANCE_LEVEL_UNSPECIFIED"|"NONE"|"LOW"|"MILD"|"MEDIUM"|"HIGH"|"EXTREME", rankingExpression?: string}
  --disableKeywordMatch: oneof<nothing, bool> # Optional. Controls whether to disable exact keyword match on Job.job_title, Job.description, Job.company_display_name, Job.locations, Job.qualifications. When disable keyword match is turned off, a keyword match returns jobs that do not match given category filters when there are matching keywords. For example, the query "program manager," a result is returned even if the job posting has the title "software developer," which does not fall into "program manager" ontology, but does have "program manager" appearing in its description. For queries like "cloud" that does not contain title or location specific ontology, jobs with "cloud" keyword matches are returned regardless of this flag's value. Please use Company.keyword_searchable_custom_fields or Company.keyword_searchable_custom_attributes if company specific globally matched custom field/attribute string values is needed. Enabling keyword match improves recall of subsequent search requests. Defaults to false.
  --diversificationLevel: string@diversificationLevel-completer # Optional. Controls whether highly similar jobs are returned next to each other in the search results. Jobs are identified as highly similar based on their titles, job categories, and locations. Highly similar results are clustered so that only one representative job of the cluster is displayed to the job seeker higher up in the results, with the other jobs being displayed lower down in the results. Defaults to DiversificationLevel.SIMPLE if no value is specified.
  --enableBroadening: oneof<nothing, bool> # Optional. Controls whether to broaden the search when it produces sparse results. Broadened queries append results to the end of the matching results list. Defaults to false.
  --histogramFacets: record # Input only. Histogram facets to be specified in SearchJobsRequest. — shape: {compensationHistogramFacets?: list, customAttributeHistogramFacets?: list, simpleHistogramFacets?: list}
  --histogramQueries: list # Optional. Expression based histogram requests for jobs matching JobQuery. — item shape: {histogramQuery?: string}
  --jobQuery: record # Input only. The query required to perform a search query. — shape: {commuteFilter?: record, companyDisplayNames?: list, companyNames?: list, compensationFilter?: record, customAttributeFilter?: string, disableSpellCheck?: bool, employmentTypes?: list, excludedJobs?: list, jobCategories?: list, languageCodes?: list, locationFilters?: list, publishTimeRange?: record, query?: string, queryLanguageCode?: string}
  --jobView: string@jobView-completer # Optional. The desired job attributes returned for jobs in the search response. Defaults to JobView.SMALL if no value is specified.
  ...
  --pageSize: int # Optional. A limit on the number of jobs returned in the search results. Increasing this value above the default value of 10 can increase search response time. The value can be between 1 and 100. (format: int32)
  --pageToken: string # Optional. The token specifying the current offset within search results. See SearchJobsResponse.next_page_token for an explanation of how to obtain the next set of query results.
  --requestMetadata: record # Input only. Meta information related to the job searcher or entity conducting the job search. This information is used to improve the performance of the service. — shape: {deviceInfo?: record, domain?: string, sessionId?: string, userId?: string}
  --requirePreciseResultSize: oneof<nothing, bool> # This field is deprecated.
  --searchMode: string@searchMode-completer # Optional. Mode of a search. Defaults to SearchMode.JOB_SEARCH.
  ...
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $qp_fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v3p1beta1/($parent)/jobs:search" $qp)
  let body = {customRankingInfo: $customRankingInfo, disableKeywordMatch: $disableKeywordMatch, diversificationLevel: $diversificationLevel, enableBroadening: $enableBroadening, histogramFacets: $histogramFacets, histogramQueries: $histogramQueries, jobQuery: $jobQuery, jobView: $jobView, offset: $offset, orderBy: $orderBy, pageSize: $pageSize, pageToken: $pageToken, requestMetadata: $requestMetadata, requirePreciseResultSize: $requirePreciseResultSize, searchMode: $searchMode} | compact
  let body = if ($input | describe | str starts-with "record") { $input | merge deep ($body | default {}) } else { $body }
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "post" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json" $body
...
# --jobQuery shape: {commuteFilter?: record, companyDisplayNames?: list, companyNames?: list, compensationFilter?: record, customAttributeFilter?: string, disableSpellCheck?: bool, employmentTypes?: list, excludedJobs?: list, jobCategories?: list, languageCodes?: list, locationFilters?: list, publishTimeRange?: record, query?: string, queryLanguageCode?: string}
# --requestMetadata shape: {deviceInfo?: record, domain?: string, sessionId?: string, userId?: string}
export def "v3p1beta1-jobs-search-for-alert jobsprojectsjobssearchForAlert" [
  parent: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  ...
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $qp_fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v3p1beta1/($parent)/jobs:searchForAlert" $qp)
  let body = {customRankingInfo: $customRankingInfo, disableKeywordMatch: $disableKeywordMatch, diversificationLevel: $diversificationLevel, enableBroadening: $enableBroadening, histogramFacets: $histogramFacets, histogramQueries: $histogramQueries, jobQuery: $jobQuery, jobView: $jobView, offset: $offset, orderBy: $orderBy, pageSize: $pageSize, pageToken: $pageToken, requestMetadata: $requestMetadata, requirePreciseResultSize: $requirePreciseResultSize, searchMode: $searchMode} | compact
  let body = if ($input | describe | str starts-with "record") { $input | merge deep ($body | default {}) } else { $body }
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
