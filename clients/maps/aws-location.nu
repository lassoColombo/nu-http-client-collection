...
export def "routes-calculators-calculate-route CalculateRoute" [
  ...
  --IncludeLegGeometry: string@bool-completer # <p>Set to include the geometry details in the result for each path between a pair of positions.</p> <p>Default Value: <code>false</code> </p> <p>Valid Values: <code>false</code> | <code>true</code> </p>
...
export def "metadata-keys CreateKey" [
  ...
  --NoExpiry: string@bool-completer # Optionally set to <code>true</code> to set no expiration time for the API key. One of <code>NoExpiry</code> or <code>ExpireTime</code> must be set.
