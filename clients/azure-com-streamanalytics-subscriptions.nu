...
export def "subscriptions-providers-microsoft-stream-analytics-locations-quotas list" [
  ...
  let full_url = (build-url $base ({subscription_id: $subscription_id, location: $location} | format pattern "/subscriptions/{subscription_id}/providers/Microsoft.StreamAnalytics/locations/{location}/quotas") $qp)
