# Auto-generated client for Network Management API vv1beta1
# Source: https://api.apis.guru/v2/specs/googleapis.com/networkmanagement/v1beta1/openapi.json
# Auth: --token flag or $env.NETWORK_MANAGEMENT_API_TOKEN
...
def build-auth [token?: string, auth_scheme?: string]: nothing -> record {
  let token_val = if ($token != null) and ($token | is-not-empty) { $token } else { $env | get -o NETWORK_MANAGEMENT_API_TOKEN | default "" }
...
def base-url-completer [] { ["https://networkmanagement.googleapis.com"] }
...
export def commands []: nothing -> table {
  ...
  let mod_name = (scope modules | where { $in.commands | any { $in.name == "v1beta1 networkmanagementprojectslocationsglobaloperationsdelete" } } | get name | first)
...
export def "v1beta1 networkmanagementprojectslocationsglobaloperationsdelete" [
  name: string
...
export def "v1beta1 networkmanagementprojectslocationsglobaloperationsget" [
  name: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
...
# --destination shape: {appEngineVersion?: record, cloudFunction?: record, cloudRunRevision?: record, cloudSqlInstance?: string, forwardingRule?: string, gkeMasterCluster?: string, instance?: string, ipAddress?: string, network?: string, networkType?: "NETWORK_TYPE_UNSPECIFIED"|"GCP_NETWORK"|"NON_GCP_NETWORK", port?: int, projectId?: string}
...
export def "v1beta1 networkmanagementprojectslocationsglobalconnectivityTestspatch" [
  name: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  ...
  --destination: record # Source or destination of the Connectivity Test. — shape: {appEngineVersion?: record, cloudFunction?: record, cloudRunRevision?: record, cloudSqlInstance?: string, forwardingRule?: string, gkeMasterCluster?: string, instance?: string, ipAddress?: string, network?: string, networkType?: "NETWORK_TYPE_UNSPECIFIED"|"GCP_NETWORK"|"NON_GCP_NETWORK", port?: int, projectId?: string}
  --labels: record # Resource labels to represent user-provided metadata.
  --body-name: string # Required. Unique name of the resource using the form: `projects/{project_id}/locations/global/connectivityTests/{test}`
  --probingDetails: record # Results of active probing from the last run of the test. — shape: {abortCause?: "PROBING_ABORT_CAUSE_UNSPECIFIED"|"PERMISSION_DENIED"|"NO_SOURCE_LOCATION", destinationEgressLocation?: record, endpointInfo?: record, error?: record, probingLatency?: record, result?: "PROBING_RESULT_UNSPECIFIED"|"REACHABLE"|"UNREACHABLE"|"REACHABILITY_INCONSISTENT"|"UNDETERMINED", sentProbeCount?: int, successfulProbeCount?: int, verifyTime?: string}
  --protocol: string # IP Protocol of the test. When not provided, "TCP" is assumed.
  --reachabilityDetails: record # Results of the configuration analysis from the last run of the test. — shape: {error?: record, result?: "RESULT_UNSPECIFIED"|"REACHABLE"|"UNREACHABLE"|"AMBIGUOUS"|"UNDETERMINED", traces?: list, verifyTime?: string}
  --relatedProjects: list # Other projects that may be relevant for reachability analysis. This is applicable to scenarios where a test can cross project boundaries.
  --body-source: record # Source or destination of the Connectivity Test. — shape: {appEngineVersion?: record, cloudFunction?: record, cloudRunRevision?: record, cloudSqlInstance?: string, forwardingRule?: string, gkeMasterCluster?: string, instance?: string, ipAddress?: string, network?: string, networkType?: "NETWORK_TYPE_UNSPECIFIED"|"GCP_NETWORK"|"NON_GCP_NETWORK", port?: int, projectId?: string}
  ...
  let full_url = (build-url $base $"/v1beta1/($name)" $qp)
  let body = {description: $description, destination: $destination, labels: $labels, name: $body_name, probingDetails: $probingDetails, protocol: $protocol, reachabilityDetails: $reachabilityDetails, relatedProjects: $relatedProjects, source: $body_source} | compact
...
export def "v1beta1-locations networkmanagementprojectslocationslist" [
  name: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
...
export def "v1beta1-operations networkmanagementprojectslocationsglobaloperationslist" [
  name: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
...
export def "v1beta1 networkmanagementprojectslocationsglobaloperationscancel" [
  name: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
...
export def "v1beta1 networkmanagementprojectslocationsglobalconnectivityTestsrerun" [
  name: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  ...
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $qp_fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v1beta1/($name):rerun" $qp)
  let body = if ($input | describe | str starts-with "record") { $input | merge deep ($body | default {}) } else { $body }
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "post" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json" $body
...
export def "v1beta1-connectivity-tests networkmanagementprojectslocationsglobalconnectivityTestslist" [
  parent: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  ...
  --pageSize: int # Number of `ConnectivityTests` to return.
  --pageToken: string # Page token from an earlier query, as returned in `next_page_token`.
]: nothing -> record<nextPageToken: string, resources: table<createTime: string, description: string, destination: record, displayName: string, labels: record, name: string, probingDetails: record, protocol: string, reachabilityDetails: record, relatedProjects: list, source: record, updateTime: string>, unreachable: list<string>> {
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  ...
  let full_url = (build-url $base $"/v1beta1/($parent)/connectivityTests" $qp)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "get" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json"
}
...
#
# POST /v1beta1/{parent}/connectivityTests
# operationId: networkmanagement.projects.locations.global.connectivityTests.create
# --destination shape: {appEngineVersion?: record, cloudFunction?: record, cloudRunRevision?: record, cloudSqlInstance?: string, forwardingRule?: string, gkeMasterCluster?: string, instance?: string, ipAddress?: string, network?: string, networkType?: "NETWORK_TYPE_UNSPECIFIED"|"GCP_NETWORK"|"NON_GCP_NETWORK", port?: int, projectId?: string}
# --probingDetails shape: {abortCause?: "PROBING_ABORT_CAUSE_UNSPECIFIED"|"PERMISSION_DENIED"|"NO_SOURCE_LOCATION", destinationEgressLocation?: record, endpointInfo?: record, error?: record, probingLatency?: record, result?: "PROBING_RESULT_UNSPECIFIED"|"REACHABLE"|"UNREACHABLE"|"REACHABILITY_INCONSISTENT"|"UNDETERMINED", sentProbeCount?: int, successfulProbeCount?: int, verifyTime?: string}
# --reachabilityDetails shape: {error?: record, result?: "RESULT_UNSPECIFIED"|"REACHABLE"|"UNREACHABLE"|"AMBIGUOUS"|"UNDETERMINED", traces?: list, verifyTime?: string}
# --source shape: {appEngineVersion?: record, cloudFunction?: record, cloudRunRevision?: record, cloudSqlInstance?: string, forwardingRule?: string, gkeMasterCluster?: string, instance?: string, ipAddress?: string, network?: string, networkType?: "NETWORK_TYPE_UNSPECIFIED"|"GCP_NETWORK"|"NON_GCP_NETWORK", port?: int, projectId?: string}
export def "v1beta1-connectivity-tests networkmanagementprojectslocationsglobalconnectivityTestscreate" [
  parent: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $qp_fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar") (serialize-qp "testId" $testId "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v1beta1/($parent)/connectivityTests" $qp)
  let body = {description: $description, destination: $destination, labels: $labels, name: $name, probingDetails: $probingDetails, protocol: $protocol, reachabilityDetails: $reachabilityDetails, relatedProjects: $relatedProjects, source: $body_source} | compact
  let body = if ($input | describe | str starts-with "record") { $input | merge deep ($body | default {}) } else { $body }
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "post" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json" $body
...
export def "v1beta1 networkmanagementprojectslocationsglobalconnectivityTestsgetIamPolicy" [
  resource: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
...
export def "v1beta1 networkmanagementprojectslocationsglobalconnectivityTestssetIamPolicy" [
  resource: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
...
export def "v1beta1 networkmanagementprojectslocationsglobalconnectivityTeststestIamPermissions" [
  resource: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
