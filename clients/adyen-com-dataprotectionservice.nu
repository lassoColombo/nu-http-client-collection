...
export def commands []: nothing -> table {
  ...
  let mod_name = (scope modules | where { $in.commands | any { $in.name == "request-subject-erasure post-requestSubjectErasure" } } | get name | first)
...
export def "request-subject-erasure post-requestSubjectErasure" [
