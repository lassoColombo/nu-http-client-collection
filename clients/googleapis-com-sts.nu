...
export def "v1beta-token ststoken" [
  ...
  let body = {"audience": $audience, "grantType": $grant_type, "options": $options, "requestedTokenType": $requested_token_type, "scope": $scope, "subjectToken": $subject_token, "subjectTokenType": $subject_token_type} | compact
