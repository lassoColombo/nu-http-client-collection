# Auto-generated client for Commerce API vv2
# Source: https://api.apis.guru/v2/specs/ticketmaster.com/commerce/v2/swagger.json
# Auth: --token flag or $env.COMMERCE_API_TOKEN

const BASE_URL = "https://www.ticketmaster.com/commerce/v2"
...
def base-url-completer [] { ["https://www.ticketmaster.com/commerce/v2"] }
...
export def commands []: nothing -> table {
  ...
  let mod_name = (scope modules | where { $in.commands | any { $in.name == "commerce-events-offers get" } } | get name | first)
...
export def "commerce-events-offers get" [
  ...
  let full_url = (build-url $base ({event_id: (encode-path-segment $event_id)} | format pattern "/commerce/v2/events/{event_id}/offers") $qp $auth.query)
  ...
  let req = {
    method: "get"
    url: $full_url
    query: ({"access_token": $access_token, "api-key": $api_key} | compact)
