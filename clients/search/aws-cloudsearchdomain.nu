...
def qparser-completer [] { ["dismax" "lucene" "simple" "structured"] }
...
export def commands []: nothing -> table {
  ...
  let mod_name = (scope modules | where { $in.commands | any { $in.name == "2013-01-01-searchformatsdkprettytrueq Search" } } | get name | first)
...
# operationId: Search
export def "2013-01-01-searchformatsdkprettytrueq Search" [
...
# operationId: Suggest
export def "2013-01-01-suggestformatsdkprettytrueqsuggester Suggest" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
...
export def "2013-01-01-documents-batchformatsdk-content-type UploadDocuments" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
  ...
  --X-Amz-Signature: string
  --X-Amz-SignedHeaders: string
  --Content-Type: string@Content-Type-completer # <p>The format of the batch you are uploading. Amazon CloudSearch supports two document batch formats:</p> <ul> <li>application/json</li> <li>application/xml</li> </ul>
