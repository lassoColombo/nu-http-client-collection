...
export def "accounts-search-query query" [
  ...
  --skipSpellCheck: oneof<nothing, bool> # If true the query will skip spell checking.
  ...
  --ignoreQueryRules: oneof<nothing, bool> # When set to true, ignores any Query Rules that would otherwise affect the results. Defaults to false.
...
export def "accounts-search-vertical-query verticalQuery" [
  ...
  --retrieveFacets: oneof<nothing, bool> # Whether facets should be computed for this vertical query.
