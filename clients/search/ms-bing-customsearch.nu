...
export def "search Search" [
  ...
  let qp = [(serialize-qp "customConfig" $customConfig "scalar") (serialize-qp "cc" $cc "scalar") (serialize-qp "count" $count "scalar") (serialize-qp "mkt" $mkt "scalar") (serialize-qp "offset" $offset "scalar") (serialize-qp "q" $q "scalar") (serialize-qp "safeSearch" $safeSearch "scalar") (serialize-qp "setLang" $setLang "scalar") (serialize-qp "textDecorations" $textDecorations "scalar") (serialize-qp "textFormat" $textFormat "scalar")] | flatten | str join "&"
