...
# --source shape: {chart?: string, directory?: record, helm?: record, kustomize?: record, name?: string, path?: string, plugin?: record, ref?: string, repoURL?: string, targetRevision?: string}
# --sourceHydrator shape: {drySource?: record, hydrateTo?: record, syncSource?: record}
# --sources item shape: {chart?: string, directory?: record, helm?: record, kustomize?: record, name?: string, path?: string, plugin?: record, ref?: string, repoURL?: string, targetRevision?: string}
...
export def "applications-spec UpdateSpec" [
  ...
  --body-source: record # shape: {chart?: string, directory?: record, helm?: record, kustomize?: record, name?: string, path?: string, plugin?: record, ref?: string, repoURL?: string, targetRevision?: string}
