...
export def "subscriptions-providers-microsoft-healthcare-apis-check-name-availability CheckNameAvailability" [
  ...
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "api-version" $api_version "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/subscriptions/($subscriptionId)/providers/Microsoft.HealthcareApis/checkNameAvailability" $qp)
...
export def "subscriptions-resource-groups-providers-microsoft-healthcare-apis-services ListByResourceGroup" [
  subscriptionId: string
...
export def "subscriptions-resource-groups-providers-microsoft-healthcare-apis-services CreateOrUpdate" [
  subscriptionId: string
  resourceGroupName: string
  resourceName: string
  --base-url(-b): string@base-url-completer # API base URL
