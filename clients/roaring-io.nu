...
def build-auth [token?: string, auth_scheme?: string]: nothing -> record {
  let token_val = if ($token | is-not-empty) { $token } else { $env | get -o COMPANYAPI_TOKEN | default "" }
...
export def "company-board-members get" [
  ...
  let full_url = (build-url $base "/company-board-members" $qp $auth.query)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "get"
    url: $full_url
    query: ({"countryCode": $country_code, "companyId": $company_id} | compact)
...
export def "company-board-members create" [
  ...
  let req = {
    method: "post"
    url: $full_url
    query: ({"countryCode": $country_code} | compact)
    headers: $auth.headers
    body: $req_body
...
export def "company-credit-decision get" [
  ...
  let full_url = (build-url $base "/company-credit-decision" $qp $auth.query)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "get"
    url: $full_url
    query: ({"countryCode": $country_code, "companyId": $company_id, "template": $template} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
...
export def "company-economy-overview get" [
  ...
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "countryCode" $country_code "scalar") (serialize-qp "companyId" $company_id "scalar")] | flatten | str join "&"
  let full_url = (build-url $base "/company-economy-overview" $qp $auth.query)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "get"
...
export def "company-event create" [
  ...
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "countryCode" $country_code "scalar")] | flatten | str join "&"
  let full_url = (build-url $base "/company-event" $qp $auth.query)
...
export def "company-overview get" [
  ...
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "countryCode" $country_code "scalar") (serialize-qp "companyId" $company_id "scalar")] | flatten | str join "&"
  let full_url = (build-url $base "/company-overview" $qp $auth.query)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "get"
...
export def "company-signatory get" [
  ...
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "countryCode" $country_code "scalar") (serialize-qp "companyId" $company_id "scalar")] | flatten | str join "&"
  let full_url = (build-url $base "/company-signatory" $qp $auth.query)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "get"
...
export def "company-simple-search get" [
  ...
  let full_url = (build-url $base "/company-simple-search" $qp $auth.query)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  let req = {
    method: "get"
    url: $full_url
    query: ({"countryCode": $country_code, "companyName": $company_name, "town": $town} | compact)
    headers: $auth.headers
    body: null
    content_type: null
    timeout: ($max_time | default 30min)
