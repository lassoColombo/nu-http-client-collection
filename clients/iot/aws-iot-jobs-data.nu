...
export def "things-jobs DescribeJobExecution" [
  ...
  --includeJobDocument: string@bool-completer # Optional. When set to true, the response contains the job document. The default is false.
...
export def "things-jobs UpdateJobExecution" [
  ...
  --includeJobExecutionState: string@bool-completer # Optional. When included and set to true, the response contains the JobExecutionState data. The default is false.
  --includeJobDocument: string@bool-completer # Optional. When set to true, the response contains the job document. The default is false.
