...
export def "subscriptions-providers-microsoft-io-t-central-io-t-apps ListBySubscription" [
...
export def "subscriptions-providers-microsoft-io-t-central-app-templates ListTemplates" [
  subscriptionId: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
...
export def "subscriptions-providers-microsoft-io-t-central-check-name-availability CheckNameAvailability" [
  subscriptionId: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  ...
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "api-version" $api_version "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/subscriptions/($subscriptionId)/providers/Microsoft.IoTCentral/checkNameAvailability" $qp)
...
export def "subscriptions-providers-microsoft-io-t-central-check-subdomain-availability CheckSubdomainAvailability" [
  subscriptionId: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  ...
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "api-version" $api_version "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/subscriptions/($subscriptionId)/providers/Microsoft.IoTCentral/checkSubdomainAvailability" $qp)
  let body = {name: $name, type: $type} | compact
  let body = if ($input | describe | str starts-with "record") { $input | merge deep ($body | default {}) } else { $body }
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
...
export def "subscriptions-resource-groups-providers-microsoft-io-t-central-io-t-apps ListByResourceGroup" [
  subscriptionId: string
...
export def "subscriptions-resource-groups-providers-microsoft-io-t-central-io-t-apps CreateOrUpdate" [
  subscriptionId: string
  resourceGroupName: string
  resourceName: string
  --base-url(-b): string@base-url-completer # API base URL
