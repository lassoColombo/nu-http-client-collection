...
def entityStatus-completer [] { ["ENTITY_STATUS_ACTIVE" "ENTITY_STATUS_ARCHIVED" "ENTITY_STATUS_DRAFT" "ENTITY_STATUS_PAUSED" "ENTITY_STATUS_SCHEDULED_FOR_DELETION" "ENTITY_STATUS_UNSPECIFIED"] }
def creativeType-completer [] { ["CREATIVE_TYPE_AUDIO" "CREATIVE_TYPE_EXPANDABLE" "CREATIVE_TYPE_LIGHTBOX" "CREATIVE_TYPE_NATIVE" "CREATIVE_TYPE_NATIVE_APP_INSTALL" "CREATIVE_TYPE_NATIVE_APP_INSTALL_SQUARE" "CREATIVE_TYPE_NATIVE_SITE_SQUARE" "CREATIVE_TYPE_NATIVE_VIDEO" "CREATIVE_TYPE_PUBLISHER_HOSTED" "CREATIVE_TYPE_STANDARD" "CREATIVE_TYPE_TEMPLATED_APP_INSTALL" "CREATIVE_TYPE_TEMPLATED_APP_INSTALL_INTERSTITIAL" "CREATIVE_TYPE_TEMPLATED_APP_INSTALL_VIDEO" "CREATIVE_TYPE_UNSPECIFIED" "CREATIVE_TYPE_VIDEO"] }
def expandingDirection-completer [] { ["EXPANDING_DIRECTION_ANY_DIAGONAL" "EXPANDING_DIRECTION_DOWN" "EXPANDING_DIRECTION_DOWN_AND_LEFT" "EXPANDING_DIRECTION_DOWN_AND_RIGHT" "EXPANDING_DIRECTION_LEFT" "EXPANDING_DIRECTION_LEFT_OR_RIGHT" "EXPANDING_DIRECTION_NONE" "EXPANDING_DIRECTION_RIGHT" "EXPANDING_DIRECTION_UNSPECIFIED" "EXPANDING_DIRECTION_UP" "EXPANDING_DIRECTION_UP_AND_LEFT" "EXPANDING_DIRECTION_UP_AND_RIGHT" "EXPANDING_DIRECTION_UP_OR_DOWN"] }
def hostingSource-completer [] { ["HOSTING_SOURCE_CM" "HOSTING_SOURCE_HOSTED" "HOSTING_SOURCE_RICH_MEDIA" "HOSTING_SOURCE_THIRD_PARTY" "HOSTING_SOURCE_UNSPECIFIED"] }
def billableOutcome-completer [] { ["BILLABLE_OUTCOME_PAY_PER_CLICK" "BILLABLE_OUTCOME_PAY_PER_IMPRESSION" "BILLABLE_OUTCOME_PAY_PER_VIEWABLE_IMPRESSION" "BILLABLE_OUTCOME_UNSPECIFIED"] }
def insertionOrderType-completer [] { ["INSERTION_ORDER_TYPE_UNSPECIFIED" "OVER_THE_TOP" "RTB"] }
def loiSapinInvoiceType-completer [] { ["LOI_SAPIN_INVOICE_TYPE_MEDIA" "LOI_SAPIN_INVOICE_TYPE_PLATFORM" "LOI_SAPIN_INVOICE_TYPE_UNSPECIFIED"] }
def lineItemType-completer [] { ["LINE_ITEM_TYPE_AUDIO_DEFAULT" "LINE_ITEM_TYPE_DISPLAY_DEFAULT" "LINE_ITEM_TYPE_DISPLAY_MOBILE_APP_INSTALL" "LINE_ITEM_TYPE_DISPLAY_MOBILE_APP_INVENTORY" "LINE_ITEM_TYPE_UNSPECIFIED" "LINE_ITEM_TYPE_VIDEO_DEFAULT" "LINE_ITEM_TYPE_VIDEO_MOBILE_APP_INSTALL" "LINE_ITEM_TYPE_VIDEO_MOBILE_APP_INVENTORY" "LINE_ITEM_TYPE_VIDEO_OVER_THE_TOP" "LINE_ITEM_TYPE_YOUTUBE_AND_PARTNERS_ACTION" "LINE_ITEM_TYPE_YOUTUBE_AND_PARTNERS_AUDIO" "LINE_ITEM_TYPE_YOUTUBE_AND_PARTNERS_NON_SKIPPABLE" "LINE_ITEM_TYPE_YOUTUBE_AND_PARTNERS_NON_SKIPPABLE_OVER_THE_TOP" "LINE_ITEM_TYPE_YOUTUBE_AND_PARTNERS_REACH" "LINE_ITEM_TYPE_YOUTUBE_AND_PARTNERS_REACH_OVER_THE_TOP" "LINE_ITEM_TYPE_YOUTUBE_AND_PARTNERS_SIMPLE" "LINE_ITEM_TYPE_YOUTUBE_AND_PARTNERS_SIMPLE_OVER_THE_TOP" "LINE_ITEM_TYPE_YOUTUBE_AND_PARTNERS_TARGET_FREQUENCY" "LINE_ITEM_TYPE_YOUTUBE_AND_PARTNERS_VIDEO_SEQUENCE"] }
def locationType-completer [] { ["TARGETING_LOCATION_TYPE_PROXIMITY" "TARGETING_LOCATION_TYPE_REGIONAL" "TARGETING_LOCATION_TYPE_UNSPECIFIED"] }
def customBiddingAlgorithmType-completer [] { ["ADS_DATA_HUB_BASED" "CUSTOM_BIDDING_ALGORITHM_TYPE_UNSPECIFIED" "GOAL_BUILDER_BASED" "SCRIPT_BASED"] }
def audienceType-completer [] { ["ACTIVITY_BASED" "AUDIENCE_TYPE_UNSPECIFIED" "CUSTOMER_MATCH_CONTACT_INFO" "CUSTOMER_MATCH_DEVICE_ID" "CUSTOMER_MATCH_USER_ID" "FREQUENCY_CAP" "LICENSED" "TAG_BASED" "YOUTUBE_USERS"] }
def firstAndThirdPartyAudienceType-completer [] { ["FIRST_AND_THIRD_PARTY_AUDIENCE_TYPE_FIRST_PARTY" "FIRST_AND_THIRD_PARTY_AUDIENCE_TYPE_THIRD_PARTY" "FIRST_AND_THIRD_PARTY_AUDIENCE_TYPE_UNSPECIFIED"] }
...
def deliveryMethod-completer [] { ["INVENTORY_SOURCE_DELIVERY_METHOD_PROGRAMMATIC" "INVENTORY_SOURCE_DELIVERY_METHOD_TAG" "INVENTORY_SOURCE_DELIVERY_METHOD_UNSPECIFIED"] }
def inventorySourceType-completer [] { ["INVENTORY_SOURCE_TYPE_AUCTION_PACKAGE" "INVENTORY_SOURCE_TYPE_PRIVATE" "INVENTORY_SOURCE_TYPE_UNSPECIFIED"] }
...
export def commands []: nothing -> table {
  ...
  let mod_name = (scope modules | where { $in.commands | any { $in.name == "download displayvideomediadownload" } } | get name | first)
...
export def "download displayvideomediadownload" [
  resourceName: string
  ...
  let full_url = (build-url $base $"/download/($resourceName)" $qp)
...
export def "media displayvideomediaupload" [
  resourceName: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  ...
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $qp_fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/media/($resourceName)" $qp)
...
export def "advertisers displayvideoadvertiserslist" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
  ...
  --pageSize: int # Requested page size. Must be between `1` and `200`. If unspecified will default to `100`.
...
export def "advertisers displayvideoadvertiserscreate" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
  ...
  --upload-protocol: string # Upload protocol for media (e.g. "raw", "multipart").
  --uploadType: string # Legacy upload protocol for media (e.g. "media", "multipart").
  --adServerConfig: record # Ad server related settings of an advertiser. — shape: {cmHybridConfig?: record, thirdPartyOnlyConfig?: record}
  --billingConfig: record # Billing related settings of an advertiser. — shape: {billingProfileId?: string}
  --creativeConfig: record # Creatives related settings of an advertiser. — shape: {dynamicCreativeEnabled?: bool, iasClientId?: string, obaComplianceDisabled?: bool, videoCreativeDataSharingAuthorized?: bool}
  --dataAccessConfig: record # Settings that control how advertiser related data may be accessed. — shape: {sdfConfig?: record}
  --displayName: string # Required. The display name of the advertiser. Must be UTF-8 encoded with a maximum size of 240 bytes.
  --entityStatus: string@entityStatus-completer # Required. Controls whether or not insertion orders and line items of the advertiser can spend their budgets and bid on inventory. * Accepted values are `ENTITY_STATUS_ACTIVE`, `ENTITY_STATUS_PAUSED` and `ENTITY_STATUS_SCHEDULED_FOR_DELETION`. * If set to `ENTITY_STATUS_SCHEDULED_FOR_DELETION`, the advertiser will be deleted 30 days from when it was first scheduled for deletion.
  --generalConfig: record # General settings of an advertiser. — shape: {currencyCode?: string, domainUrl?: string}
  --integrationDetails: record # Integration details of an entry. — shape: {details?: string, integrationCode?: string}
  --partnerId: string # Required. Immutable. The unique ID of the partner that the advertiser belongs to. (format: int64)
  --prismaEnabled: oneof<nothing, bool> # Whether integration with Mediaocean (Prisma) is enabled. By enabling this, you agree to the following: On behalf of my company, I authorize Mediaocean (Prisma) to send budget segment plans to Google, and I authorize Google to send corresponding reporting and invoices from DV360 to Mediaocean for the purposes of budget planning, billing, and reconciliation for this advertiser.
  --servingConfig: record # Targeting settings related to ad serving of an advertiser. — shape: {exemptTvFromViewabilityTargeting?: bool}
  ...
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $qp_fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar")] | flatten | str join "&"
  let full_url = (build-url $base "/v2/advertisers" $qp)
  let body = {adServerConfig: $adServerConfig, billingConfig: $billingConfig, creativeConfig: $creativeConfig, dataAccessConfig: $dataAccessConfig, displayName: $displayName, entityStatus: $entityStatus, generalConfig: $generalConfig, integrationDetails: $integrationDetails, partnerId: $partnerId, prismaEnabled: $prismaEnabled, servingConfig: $servingConfig} | compact
  let body = if ($input | describe | str starts-with "record") { $input | merge deep ($body | default {}) } else { $body }
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
...
export def "advertisers displayvideoadvertisersdelete" [
  advertiserId: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  ...
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $qp_fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v2/advertisers/($advertiserId)" $qp)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
...
export def "advertisers displayvideoadvertisersget" [
  advertiserId: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
...
# --integrationDetails shape: {details?: string, integrationCode?: string}
# --servingConfig shape: {exemptTvFromViewabilityTargeting?: bool}
export def "advertisers displayvideoadvertiserspatch" [
  advertiserId: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
...
export def "advertisers-assets displayvideoadvertisersassetsupload" [
  advertiserId: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  ...
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $qp_fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v2/advertisers/($advertiserId)/assets" $qp)
  let body = if ($input | describe | str starts-with "record") { $input | merge deep ($body | default {}) } else { $body }
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "post" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/octet-stream" $body
...
export def "advertisers-campaigns displayvideoadvertiserscampaignslist" [
  advertiserId: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  ...
  let full_url = (build-url $base $"/v2/advertisers/($advertiserId)/campaigns" $qp)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "get" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json"
}
...
export def "advertisers-campaigns displayvideoadvertiserscampaignscreate" [
  advertiserId: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  ...
  --upload-protocol: string # Upload protocol for media (e.g. "raw", "multipart").
  --uploadType: string # Legacy upload protocol for media (e.g. "media", "multipart").
  --campaignBudgets: list # The list of budgets available to this campaign. If this field is not set, the campaign uses an unlimited budget. — item shape: {budgetAmountMicros?: string, budgetId?: string, budgetUnit?: "BUDGET_UNIT_UNSPECIFIED"|"BUDGET_UNIT_CURRENCY"|"BUDGET_UNIT_IMPRESSIONS", dateRange?: record, displayName?: string, externalBudgetId?: string, externalBudgetSource?: "EXTERNAL_BUDGET_SOURCE_UNSPECIFIED"|"EXTERNAL_BUDGET_SOURCE_NONE"|"EXTERNAL_BUDGET_SOURCE_MEDIA_OCEAN", invoiceGroupingId?: string, prismaConfig?: record}
  --campaignFlight: record # Settings that track the planned spend and duration of a campaign. — shape: {plannedDates?: record, plannedSpendAmountMicros?: string}
  --campaignGoal: record # Settings that control the goal of a campaign. — shape: {campaignGoalType?: "CAMPAIGN_GOAL_TYPE_UNSPECIFIED"|"CAMPAIGN_GOAL_TYPE_APP_INSTALL"|"CAMPAIGN_GOAL_TYPE_BRAND_AWARENESS"|"CAMPAIGN_GOAL_TYPE_OFFLINE_ACTION"|"CAMPAIGN_GOAL_TYPE_ONLINE_ACTION", performanceGoal?: record}
  --displayName: string # Required. The display name of the campaign. Must be UTF-8 encoded with a maximum size of 240 bytes.
  --entityStatus: string@entityStatus-completer # Required. Controls whether or not the insertion orders under this campaign can spend their budgets and bid on inventory. * Accepted values are `ENTITY_STATUS_ACTIVE`, `ENTITY_STATUS_ARCHIVED`, and `ENTITY_STATUS_PAUSED`. * For CreateCampaign method, `ENTITY_STATUS_ARCHIVED` is not allowed.
  --frequencyCap: record # Settings that control the number of times a user may be shown with the same ad during a given time period. — shape: {maxImpressions?: int, maxViews?: int, timeUnit?: "TIME_UNIT_UNSPECIFIED"|"TIME_UNIT_LIFETIME"|"TIME_UNIT_MONTHS"|"TIME_UNIT_WEEKS"|"TIME_UNIT_DAYS"|"TIME_UNIT_HOURS"|"TIME_UNIT_MINUTES", timeUnitCount?: int, unlimited?: bool}
  ...
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $qp_fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v2/advertisers/($advertiserId)/campaigns" $qp)
  let body = {campaignBudgets: $campaignBudgets, campaignFlight: $campaignFlight, campaignGoal: $campaignGoal, displayName: $displayName, entityStatus: $entityStatus, frequencyCap: $frequencyCap} | compact
  let body = if ($input | describe | str starts-with "record") { $input | merge deep ($body | default {}) } else { $body }
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "post" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json" $body
...
export def "advertisers-campaigns displayvideoadvertiserscampaignsdelete" [
  advertiserId: string
  campaignId: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  ...
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $qp_fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v2/advertisers/($advertiserId)/campaigns/($campaignId)" $qp)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "delete" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json"
}
...
export def "advertisers-campaigns displayvideoadvertiserscampaignsget" [
  advertiserId: string
  campaignId: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
...
# --campaignGoal shape: {campaignGoalType?: "CAMPAIGN_GOAL_TYPE_UNSPECIFIED"|"CAMPAIGN_GOAL_TYPE_APP_INSTALL"|"CAMPAIGN_GOAL_TYPE_BRAND_AWARENESS"|"CAMPAIGN_GOAL_TYPE_OFFLINE_ACTION"|"CAMPAIGN_GOAL_TYPE_ONLINE_ACTION", performanceGoal?: record}
# --frequencyCap shape: {maxImpressions?: int, maxViews?: int, timeUnit?: "TIME_UNIT_UNSPECIFIED"|"TIME_UNIT_LIFETIME"|"TIME_UNIT_MONTHS"|"TIME_UNIT_WEEKS"|"TIME_UNIT_DAYS"|"TIME_UNIT_HOURS"|"TIME_UNIT_MINUTES", timeUnitCount?: int, unlimited?: bool}
export def "advertisers-campaigns displayvideoadvertiserscampaignspatch" [
  advertiserId: string
  campaignId: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
...
export def "advertisers-campaigns-targeting-types-assigned-targeting-options displayvideoadvertiserscampaignstargetingTypesassignedTargetingOptionslist" [
  advertiserId: string
  campaignId: string
  ...
  --pageSize: int # Requested page size. Must be between `1` and `5000`. If unspecified will default to `100`. Returns error code `INVALID_ARGUMENT` if an invalid value is specified.
  ...
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $qp_fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar") (serialize-qp "filter" $filter "scalar") (serialize-qp "orderBy" $orderBy "scalar") (serialize-qp "pageSize" $pageSize "scalar") (serialize-qp "pageToken" $pageToken "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v2/advertisers/($advertiserId)/campaigns/($campaignId)/targetingTypes/($targetingType)/assignedTargetingOptions" $qp)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "get" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json"
}
...
export def "advertisers-campaigns-targeting-types-assigned-targeting-options displayvideoadvertiserscampaignstargetingTypesassignedTargetingOptionsget" [
  advertiserId: string
  campaignId: string
  targetingType: string
  ...
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $qp_fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v2/advertisers/($advertiserId)/campaigns/($campaignId)/targetingTypes/($targetingType)/assignedTargetingOptions/($assignedTargetingOptionId)" $qp)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "get" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json"
}
...
export def "advertisers-campaigns displayvideoadvertiserscampaignslistAssignedTargetingOptions" [
  advertiserId: string
  campaignId: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  ...
  --pageSize: int # Requested page size. The size must be an integer between `1` and `5000`. If unspecified, the default is `5000`. Returns error code `INVALID_ARGUMENT` if an invalid value is specified.
  ...
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $qp_fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar") (serialize-qp "filter" $filter "scalar") (serialize-qp "orderBy" $orderBy "scalar") (serialize-qp "pageSize" $pageSize "scalar") (serialize-qp "pageToken" $pageToken "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v2/advertisers/($advertiserId)/campaigns/($campaignId):listAssignedTargetingOptions" $qp)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "get" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json"
}
...
export def "advertisers-channels displayvideoadvertiserschannelslist" [
  advertiserId: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  ...
  --pageSize: int # Requested page size. Must be between `1` and `200`. If unspecified will default to `100`. Returns error code `INVALID_ARGUMENT` if an invalid value is specified.
  ...
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $qp_fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar") (serialize-qp "filter" $filter "scalar") (serialize-qp "orderBy" $orderBy "scalar") (serialize-qp "pageSize" $pageSize "scalar") (serialize-qp "pageToken" $pageToken "scalar") (serialize-qp "partnerId" $partnerId "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v2/advertisers/($advertiserId)/channels" $qp)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "get" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json"
}
...
export def "advertisers-channels displayvideoadvertiserschannelscreate" [
  advertiserId: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  ...
  --body-advertiserId: string # The ID of the advertiser that owns the channel. (format: int64)
  --displayName: string # Required. The display name of the channel. Must be UTF-8 encoded with a maximum length of 240 bytes.
  --partnerId: string # The ID of the partner that owns the channel. (format: int64)
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $qp_fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar") (serialize-qp "partnerId" $partnerId "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v2/advertisers/($advertiserId)/channels" $qp)
  let body = {advertiserId: $body_advertiserId, displayName: $displayName, partnerId: $partnerId} | compact
  let body = if ($input | describe | str starts-with "record") { $input | merge deep ($body | default {}) } else { $body }
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "post" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json" $body
...
export def "advertisers-channels displayvideoadvertiserschannelspatch" [
  advertiserId: string
  channelId: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $qp_fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar") (serialize-qp "partnerId" $partnerId "scalar") (serialize-qp "updateMask" $updateMask "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v2/advertisers/($advertiserId)/channels/($channelId)" $qp)
  let body = {advertiserId: $body_advertiserId, displayName: $displayName, partnerId: $partnerId} | compact
  let body = if ($input | describe | str starts-with "record") { $input | merge deep ($body | default {}) } else { $body }
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
...
export def "advertisers-channels-sites displayvideoadvertiserschannelssiteslist" [
  advertiserId: string
  channelId: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  ...
  --pageSize: int # Requested page size. Must be between `1` and `10000`. If unspecified will default to `100`. Returns error code `INVALID_ARGUMENT` if an invalid value is specified.
  ...
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $qp_fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar") (serialize-qp "filter" $filter "scalar") (serialize-qp "orderBy" $orderBy "scalar") (serialize-qp "pageSize" $pageSize "scalar") (serialize-qp "pageToken" $pageToken "scalar") (serialize-qp "partnerId" $partnerId "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v2/advertisers/($advertiserId)/channels/($channelId)/sites" $qp)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "get" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json"
}
...
export def "advertisers-channels-sites displayvideoadvertiserschannelssitesdelete" [
  advertiserId: string
  channelId: string
  urlOrAppId: string
  --base-url(-b): string@base-url-completer # API base URL
  ...
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $qp_fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar") (serialize-qp "partnerId" $partnerId "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v2/advertisers/($advertiserId)/channels/($channelId)/sites/($urlOrAppId)" $qp)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "delete" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json"
}
...
export def "advertisers-channels-sites-bulk-edit displayvideoadvertiserschannelssitesbulkEdit" [
  advertiserId: string
  channelId: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  ...
  --upload-protocol: string # Upload protocol for media (e.g. "raw", "multipart").
  --uploadType: string # Legacy upload protocol for media (e.g. "media", "multipart").
  --body-advertiserId: string # The ID of the advertiser that owns the parent channel. (format: int64)
  --createdSites: list # The sites to create in batch, specified as a list of Sites. — item shape: {urlOrAppId?: string}
  --deletedSites: list # The sites to delete in batch, specified as a list of site url_or_app_ids.
  --partnerId: string # The ID of the partner that owns the parent channel. (format: int64)
]: any -> record<sites: table<name: string, urlOrAppId: string>> {
  let input = $in
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $qp_fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v2/advertisers/($advertiserId)/channels/($channelId)/sites:bulkEdit" $qp)
  let body = {advertiserId: $body_advertiserId, createdSites: $createdSites, deletedSites: $deletedSites, partnerId: $partnerId} | compact
  let body = if ($input | describe | str starts-with "record") { $input | merge deep ($body | default {}) } else { $body }
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "post" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json" $body
...
export def "advertisers-channels-sites-replace displayvideoadvertiserschannelssitesreplace" [
  advertiserId: string
  channelId: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  ...
  --uploadType: string # Legacy upload protocol for media (e.g. "media", "multipart").
  --body-advertiserId: string # The ID of the advertiser that owns the parent channel. (format: int64)
  --newSites: list # The sites that will replace the existing sites assigned to the channel, specified as a list of Sites. — item shape: {urlOrAppId?: string}
  --partnerId: string # The ID of the partner that owns the parent channel. (format: int64)
]: any -> record<sites: table<name: string, urlOrAppId: string>> {
  let input = $in
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $qp_fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v2/advertisers/($advertiserId)/channels/($channelId)/sites:replace" $qp)
  let body = {advertiserId: $body_advertiserId, newSites: $newSites, partnerId: $partnerId} | compact
  let body = if ($input | describe | str starts-with "record") { $input | merge deep ($body | default {}) } else { $body }
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "post" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json" $body
...
export def "advertisers-creatives displayvideoadvertiserscreativeslist" [
  advertiserId: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  ...
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $qp_fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar") (serialize-qp "filter" $filter "scalar") (serialize-qp "orderBy" $orderBy "scalar") (serialize-qp "pageSize" $pageSize "scalar") (serialize-qp "pageToken" $pageToken "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v2/advertisers/($advertiserId)/creatives" $qp)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "get" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json"
}
...
export def "advertisers-creatives displayvideoadvertiserscreativescreate" [
  advertiserId: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  ...
  --entityStatus: string@entityStatus-completer # Required. Controls whether or not the creative can serve. Accepted values are: * `ENTITY_STATUS_ACTIVE` * `ENTITY_STATUS_ARCHIVED` * `ENTITY_STATUS_PAUSED`
  --exitEvents: list # Required. Exit events for this creative. An exit (also known as a click tag) is any area in your creative that someone can click or tap to open an advertiser's landing page. Every creative must include at least one exit. You can add an exit to your creative in any of the following ways: * Use Google Web Designer's tap area. * Define a JavaScript variable called "clickTag". * Use the Enabler (Enabler.exit()) to track exits in rich media formats. — item shape: {name?: string, reportingName?: string, type?: "EXIT_EVENT_TYPE_UNSPECIFIED"|"EXIT_EVENT_TYPE_DEFAULT"|"EXIT_EVENT_TYPE_BACKUP", url?: string}
  --expandOnHover: oneof<nothing, bool> # Optional. Indicates the creative will automatically expand on hover. Optional and only valid for third-party expandable creatives. Third-party expandable creatives are creatives with following hosting source: * `HOSTING_SOURCE_THIRD_PARTY` combined with following creative_type: * `CREATIVE_TYPE_EXPANDABLE`
  --expandingDirection: string@expandingDirection-completer # Optional. Specifies the expanding direction of the creative. Required and only valid for third-party expandable creatives. Third-party expandable creatives are creatives with following hosting source: * `HOSTING_SOURCE_THIRD_PARTY` combined with following creative_type: * `CREATIVE_TYPE_EXPANDABLE`
  --hostingSource: string@hostingSource-completer # Required. Indicates where the creative is hosted.
  --iasCampaignMonitoring: oneof<nothing, bool> # Indicates whether Integral Ad Science (IAS) campaign monitoring is enabled. To enable this for the creative, make sure the Advertiser.creative_config.ias_client_id has been set to your IAS client ID.
  ...
  --jsTrackerUrl: string # JavaScript measurement URL from supported third-party verification providers (ComScore, DoubleVerify, IAS, Moat). HTML script tags are not supported. This field is only writeable in following creative_type: * `CREATIVE_TYPE_NATIVE` * `CREATIVE_TYPE_NATIVE_SITE_SQUARE` * `CREATIVE_TYPE_NATIVE_VIDEO`
  --notes: string # User notes for this creative. Must be UTF-8 encoded with a length of no more than 20,000 characters.
  --obaIcon: record # OBA Icon for a Creative — shape: {clickTrackingUrl?: string, dimensions?: record, landingPageUrl?: string, position?: "OBA_ICON_POSITION_UNSPECIFIED"|"OBA_ICON_POSITION_UPPER_RIGHT"|"OBA_ICON_POSITION_UPPER_LEFT"|"OBA_ICON_POSITION_LOWER_RIGHT"|"OBA_ICON_POSITION_LOWER_LEFT", program?: string, resourceMimeType?: string, resourceUrl?: string, viewTrackingUrl?: string}
  --progressOffset: record # The length an audio or a video has been played. — shape: {percentage?: string, seconds?: string}
  --requireHtml5: oneof<nothing, bool> # Optional. Indicates that the creative relies on HTML5 to render properly. Optional and only valid for third-party tag creatives. Third-party tag creatives are creatives with following hosting_source: * `HOSTING_SOURCE_THIRD_PARTY` combined with following creative_type: * `CREATIVE_TYPE_STANDARD` * `CREATIVE_TYPE_EXPANDABLE`
  --requireMraid: oneof<nothing, bool> # Optional. Indicates that the creative requires MRAID (Mobile Rich Media Ad Interface Definitions system). Set this if the creative relies on mobile gestures for interactivity, such as swiping or tapping. Optional and only valid for third-party tag creatives. Third-party tag creatives are creatives with following hosting_source: * `HOSTING_SOURCE_THIRD_PARTY` combined with following creative_type: * `CREATIVE_TYPE_STANDARD` * `CREATIVE_TYPE_EXPANDABLE`
  --requirePingForAttribution: oneof<nothing, bool> # Optional. Indicates that the creative will wait for a return ping for attribution. Only valid when using a Campaign Manager 360 tracking ad with a third-party ad server parameter and the ${DC_DBM_TOKEN} macro. Optional and only valid for third-party tag creatives or third-party VAST tag creatives. Third-party tag creatives are creatives with following hosting_source: * `HOSTING_SOURCE_THIRD_PARTY` combined with following creative_type: * `CREATIVE_TYPE_STANDARD` * `CREATIVE_TYPE_EXPANDABLE` Third-party VAST tag creatives are creatives with following hosting_source: * `HOSTING_SOURCE_THIRD_PARTY` combined with following creative_type: * `CREATIVE_TYPE_AUDIO` * `CREATIVE_TYPE_VIDEO`
  --reviewStatus: record # Review statuses for the creative. — shape: {approvalStatus?: "APPROVAL_STATUS_UNSPECIFIED"|"APPROVAL_STATUS_PENDING_NOT_SERVABLE"|"APPROVAL_STATUS_PENDING_SERVABLE"|"APPROVAL_STATUS_APPROVED_SERVABLE"|"APPROVAL_STATUS_REJECTED_NOT_SERVABLE", contentAndPolicyReviewStatus?: "REVIEW_STATUS_UNSPECIFIED"|"REVIEW_STATUS_APPROVED"|"REVIEW_STATUS_REJECTED"|"REVIEW_STATUS_PENDING", creativeAndLandingPageReviewStatus?: "REVIEW_STATUS_UNSPECIFIED"|"REVIEW_STATUS_APPROVED"|"REVIEW_STATUS_REJECTED"|"REVIEW_STATUS_PENDING", exchangeReviewStatuses?: list, publisherReviewStatuses?: list}
  --skipOffset: record # The length an audio or a video has been played. — shape: {percentage?: string, seconds?: string}
  ...
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $qp_fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v2/advertisers/($advertiserId)/creatives" $qp)
  let body = {additionalDimensions: $additionalDimensions, appendedTag: $appendedTag, assets: $assets, cmTrackingAd: $cmTrackingAd, companionCreativeIds: $companionCreativeIds, counterEvents: $counterEvents, creativeType: $creativeType, dimensions: $dimensions, displayName: $displayName, entityStatus: $entityStatus, exitEvents: $exitEvents, expandOnHover: $expandOnHover, expandingDirection: $expandingDirection, hostingSource: $hostingSource, iasCampaignMonitoring: $iasCampaignMonitoring, integrationCode: $integrationCode, jsTrackerUrl: $jsTrackerUrl, notes: $notes, obaIcon: $obaIcon, progressOffset: $progressOffset, requireHtml5: $requireHtml5, requireMraid: $requireMraid, requirePingForAttribution: $requirePingForAttribution, reviewStatus: $reviewStatus, skipOffset: $skipOffset, skippable: $skippable, thirdPartyTag: $thirdPartyTag, thirdPartyUrls: $thirdPartyUrls, timerEvents: $timerEvents, trackerUrls: $trackerUrls, universalAdId: $universalAdId, vastTagUrl: $vastTagUrl} | compact
  let body = if ($input | describe | str starts-with "record") { $input | merge deep ($body | default {}) } else { $body }
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "post" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json" $body
...
export def "advertisers-creatives displayvideoadvertiserscreativesdelete" [
  advertiserId: string
  creativeId: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  ...
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $qp_fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v2/advertisers/($advertiserId)/creatives/($creativeId)" $qp)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "delete" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json"
}
...
export def "advertisers-creatives displayvideoadvertiserscreativesget" [
  advertiserId: string
  creativeId: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
...
# --transcodes item shape: {audioBitRateKbps?: string, audioSampleRateHz?: string, bitRateKbps?: string, dimensions?: record, fileSizeBytes?: string, frameRate?: float, mimeType?: string, name?: string, transcoded?: bool}
# --universalAdId shape: {id?: string, registry?: "UNIVERSAL_AD_REGISTRY_UNSPECIFIED"|"UNIVERSAL_AD_REGISTRY_OTHER"|"UNIVERSAL_AD_REGISTRY_AD_ID"|"UNIVERSAL_AD_REGISTRY_CLEARCAST"|"UNIVERSAL_AD_REGISTRY_DV360"|"UNIVERSAL_AD_REGISTRY_CM"}
export def "advertisers-creatives displayvideoadvertiserscreativespatch" [
  advertiserId: string
  creativeId: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
...
export def "advertisers-insertion-orders displayvideoadvertisersinsertionOrderslist" [
  advertiserId: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  ...
  --orderBy: string # Field by which to sort the list. Acceptable values are: * "displayName" (default) * "entityStatus" * "updateTime" The default sorting order is ascending. To specify descending order for a field, a suffix "desc" should be added to the field name. Example: `displayName desc`.
  --pageSize: int # Requested page size. Must be between `1` and `100`. If unspecified will default to `100`. Returns error code `INVALID_ARGUMENT` if an invalid value is specified.
  ...
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $qp_fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar") (serialize-qp "filter" $filter "scalar") (serialize-qp "orderBy" $orderBy "scalar") (serialize-qp "pageSize" $pageSize "scalar") (serialize-qp "pageToken" $pageToken "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v2/advertisers/($advertiserId)/insertionOrders" $qp)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "get" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json"
}
...
export def "advertisers-insertion-orders displayvideoadvertisersinsertionOrderscreate" [
  ...
  --upload-protocol: string # Upload protocol for media (e.g. "raw", "multipart").
  --uploadType: string # Legacy upload protocol for media (e.g. "media", "multipart").
  --bidStrategy: record # Settings that control the bid strategy. Bid strategy determines the bid price. — shape: {fixedBid?: record, maximizeSpendAutoBid?: record, performanceGoalAutoBid?: record}
  --billableOutcome: string@billableOutcome-completer # Immutable. The billable outcome of the insertion order.
  ...
  --campaignId: string # Required. Immutable. The unique ID of the campaign that the insertion order belongs to. (format: int64)
  ...
  --entityStatus: string@entityStatus-completer # Required. Controls whether or not the insertion order can spend its budget and bid on inventory. * For CreateInsertionOrder method, only `ENTITY_STATUS_DRAFT` is allowed. To activate an insertion order, use UpdateInsertionOrder method and update the status to `ENTITY_STATUS_ACTIVE` after creation. * An insertion order cannot be changed back to `ENTITY_STATUS_DRAFT` status from any other status. * An insertion order cannot be set to `ENTITY_STATUS_ACTIVE` if its parent campaign is not active.
  --frequencyCap: record # Settings that control the number of times a user may be shown with the same ad during a given time period. — shape: {maxImpressions?: int, maxViews?: int, timeUnit?: "TIME_UNIT_UNSPECIFIED"|"TIME_UNIT_LIFETIME"|"TIME_UNIT_MONTHS"|"TIME_UNIT_WEEKS"|"TIME_UNIT_DAYS"|"TIME_UNIT_HOURS"|"TIME_UNIT_MINUTES", timeUnitCount?: int, unlimited?: bool}
  --insertionOrderType: string@insertionOrderType-completer # The type of insertion order. If this field is unspecified in creation, the value defaults to `RTB`.
  --integrationDetails: record # Integration details of an entry. — shape: {details?: string, integrationCode?: string}
  ...
  --partnerCosts: list # The partner costs associated with the insertion order. If absent or empty in CreateInsertionOrder method, the newly created insertion order will inherit partner costs from the partner settings. — item shape: {costType?: "PARTNER_COST_TYPE_UNSPECIFIED"|"PARTNER_COST_TYPE_ADLOOX"|"PARTNER_COST_TYPE_ADLOOX_PREBID"|"PARTNER_COST_TYPE_ADSAFE"|"PARTNER_COST_TYPE_ADXPOSE"|"PARTNER_COST_TYPE_AGGREGATE_KNOWLEDGE"|"PARTNER_COST_TYPE_AGENCY_TRADING_DESK"|"PARTNER_COST_TYPE_DV360_FEE"|"PARTNER_COST_TYPE_COMSCORE_VCE"|"PARTNER_COST_TYPE_DATA_MANAGEMENT_PLATFORM"|"PARTNER_COST_TYPE_DEFAULT"|"PARTNER_COST_TYPE_DOUBLE_VERIFY"|"PARTNER_COST_TYPE_DOUBLE_VERIFY_PREBID"|"PARTNER_COST_TYPE_EVIDON"|"PARTNER_COST_TYPE_INTEGRAL_AD_SCIENCE_VIDEO"|"PARTNER_COST_TYPE_INTEGRAL_AD_SCIENCE_PREBID"|"PARTNER_COST_TYPE_MEDIA_COST_DATA"|"PARTNER_COST_TYPE_MOAT_VIDEO"|"PARTNER_COST_TYPE_NIELSEN_DAR"|"PARTNER_COST_TYPE_SHOP_LOCAL"|"PARTNER_COST_TYPE_TERACENT"|"PARTNER_COST_TYPE_THIRD_PARTY_AD_SERVER"|"PARTNER_COST_TYPE_TRUST_METRICS"|"PARTNER_COST_TYPE_VIZU"|"PARTNER_COST_TYPE_ADLINGO_FEE"|"PARTNER_COST_TYPE_CUSTOM_FEE_1"|"PARTNER_COST_TYPE_CUSTOM_FEE_2"|"PARTNER_COST_TYPE_CUSTOM_FEE_3"|"PARTNER_COST_TYPE_CUSTOM_FEE_4"|"PARTNER_COST_TYPE_CUSTOM_FEE_5", feeAmount?: string, feePercentageMillis?: string, feeType?: "PARTNER_COST_FEE_TYPE_UNSPECIFIED"|"PARTNER_COST_FEE_TYPE_CPM_FEE"|"PARTNER_COST_FEE_TYPE_MEDIA_FEE", invoiceType?: "PARTNER_COST_INVOICE_TYPE_UNSPECIFIED"|"PARTNER_COST_INVOICE_TYPE_DV360"|"PARTNER_COST_INVOICE_TYPE_PARTNER"}
  --performanceGoal: record # Settings that control the performance goal of a campaign or insertion order. — shape: {performanceGoalAmountMicros?: string, performanceGoalPercentageMicros?: string, performanceGoalString?: string, performanceGoalType?: "PERFORMANCE_GOAL_TYPE_UNSPECIFIED"|"PERFORMANCE_GOAL_TYPE_CPM"|"PERFORMANCE_GOAL_TYPE_CPC"|"PERFORMANCE_GOAL_TYPE_CPA"|"PERFORMANCE_GOAL_TYPE_CTR"|"PERFORMANCE_GOAL_TYPE_VIEWABILITY"|"PERFORMANCE_GOAL_TYPE_CPIAVC"|"PERFORMANCE_GOAL_TYPE_CPE"|"PERFORMANCE_GOAL_TYPE_CLICK_CVR"|"PERFORMANCE_GOAL_TYPE_IMPRESSION_CVR"|"PERFORMANCE_GOAL_TYPE_VCPM"|"PERFORMANCE_GOAL_TYPE_VTR"|"PERFORMANCE_GOAL_TYPE_AUDIO_COMPLETION_RATE"|"PERFORMANCE_GOAL_TYPE_VIDEO_COMPLETION_RATE"|"PERFORMANCE_GOAL_TYPE_OTHER"}
  ...
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $qp_fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v2/advertisers/($advertiserId)/insertionOrders" $qp)
  let body = {bidStrategy: $bidStrategy, billableOutcome: $billableOutcome, budget: $budget, campaignId: $campaignId, displayName: $displayName, entityStatus: $entityStatus, frequencyCap: $frequencyCap, insertionOrderType: $insertionOrderType, integrationDetails: $integrationDetails, pacing: $pacing, partnerCosts: $partnerCosts, performanceGoal: $performanceGoal} | compact
  let body = if ($input | describe | str starts-with "record") { $input | merge deep ($body | default {}) } else { $body }
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "post" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json" $body
...
export def "advertisers-insertion-orders displayvideoadvertisersinsertionOrdersdelete" [
  advertiserId: string
  ...
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $qp_fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v2/advertisers/($advertiserId)/insertionOrders/($insertionOrderId)" $qp)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "delete" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json"
}
...
export def "advertisers-insertion-orders displayvideoadvertisersinsertionOrdersget" [
  advertiserId: string
  insertionOrderId: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
...
# --partnerCosts item shape: {costType?: "PARTNER_COST_TYPE_UNSPECIFIED"|"PARTNER_COST_TYPE_ADLOOX"|"PARTNER_COST_TYPE_ADLOOX_PREBID"|"PARTNER_COST_TYPE_ADSAFE"|"PARTNER_COST_TYPE_ADXPOSE"|"PARTNER_COST_TYPE_AGGREGATE_KNOWLEDGE"|"PARTNER_COST_TYPE_AGENCY_TRADING_DESK"|"PARTNER_COST_TYPE_DV360_FEE"|"PARTNER_COST_TYPE_COMSCORE_VCE"|"PARTNER_COST_TYPE_DATA_MANAGEMENT_PLATFORM"|"PARTNER_COST_TYPE_DEFAULT"|"PARTNER_COST_TYPE_DOUBLE_VERIFY"|"PARTNER_COST_TYPE_DOUBLE_VERIFY_PREBID"|"PARTNER_COST_TYPE_EVIDON"|"PARTNER_COST_TYPE_INTEGRAL_AD_SCIENCE_VIDEO"|"PARTNER_COST_TYPE_INTEGRAL_AD_SCIENCE_PREBID"|"PARTNER_COST_TYPE_MEDIA_COST_DATA"|"PARTNER_COST_TYPE_MOAT_VIDEO"|"PARTNER_COST_TYPE_NIELSEN_DAR"|"PARTNER_COST_TYPE_SHOP_LOCAL"|"PARTNER_COST_TYPE_TERACENT"|"PARTNER_COST_TYPE_THIRD_PARTY_AD_SERVER"|"PARTNER_COST_TYPE_TRUST_METRICS"|"PARTNER_COST_TYPE_VIZU"|"PARTNER_COST_TYPE_ADLINGO_FEE"|"PARTNER_COST_TYPE_CUSTOM_FEE_1"|"PARTNER_COST_TYPE_CUSTOM_FEE_2"|"PARTNER_COST_TYPE_CUSTOM_FEE_3"|"PARTNER_COST_TYPE_CUSTOM_FEE_4"|"PARTNER_COST_TYPE_CUSTOM_FEE_5", feeAmount?: string, feePercentageMillis?: string, feeType?: "PARTNER_COST_FEE_TYPE_UNSPECIFIED"|"PARTNER_COST_FEE_TYPE_CPM_FEE"|"PARTNER_COST_FEE_TYPE_MEDIA_FEE", invoiceType?: "PARTNER_COST_INVOICE_TYPE_UNSPECIFIED"|"PARTNER_COST_INVOICE_TYPE_DV360"|"PARTNER_COST_INVOICE_TYPE_PARTNER"}
# --performanceGoal shape: {performanceGoalAmountMicros?: string, performanceGoalPercentageMicros?: string, performanceGoalString?: string, performanceGoalType?: "PERFORMANCE_GOAL_TYPE_UNSPECIFIED"|"PERFORMANCE_GOAL_TYPE_CPM"|"PERFORMANCE_GOAL_TYPE_CPC"|"PERFORMANCE_GOAL_TYPE_CPA"|"PERFORMANCE_GOAL_TYPE_CTR"|"PERFORMANCE_GOAL_TYPE_VIEWABILITY"|"PERFORMANCE_GOAL_TYPE_CPIAVC"|"PERFORMANCE_GOAL_TYPE_CPE"|"PERFORMANCE_GOAL_TYPE_CLICK_CVR"|"PERFORMANCE_GOAL_TYPE_IMPRESSION_CVR"|"PERFORMANCE_GOAL_TYPE_VCPM"|"PERFORMANCE_GOAL_TYPE_VTR"|"PERFORMANCE_GOAL_TYPE_AUDIO_COMPLETION_RATE"|"PERFORMANCE_GOAL_TYPE_VIDEO_COMPLETION_RATE"|"PERFORMANCE_GOAL_TYPE_OTHER"}
export def "advertisers-insertion-orders displayvideoadvertisersinsertionOrderspatch" [
  advertiserId: string
  insertionOrderId: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
...
export def "advertisers-insertion-orders-targeting-types-assigned-targeting-options displayvideoadvertisersinsertionOrderstargetingTypesassignedTargetingOptionslist" [
  advertiserId: string
  insertionOrderId: string
  targetingType: string
  --base-url(-b): string@base-url-completer # API base URL
  ...
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $qp_fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar") (serialize-qp "filter" $filter "scalar") (serialize-qp "orderBy" $orderBy "scalar") (serialize-qp "pageSize" $pageSize "scalar") (serialize-qp "pageToken" $pageToken "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v2/advertisers/($advertiserId)/insertionOrders/($insertionOrderId)/targetingTypes/($targetingType)/assignedTargetingOptions" $qp)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "get" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json"
}
...
export def "advertisers-insertion-orders-targeting-types-assigned-targeting-options displayvideoadvertisersinsertionOrderstargetingTypesassignedTargetingOptionscreate" [
  advertiserId: string
  insertionOrderId: string
  targetingType: string
  --base-url(-b): string@base-url-completer # API base URL
  ...
  --upload-protocol: string # Upload protocol for media (e.g. "raw", "multipart").
  --uploadType: string # Legacy upload protocol for media (e.g. "media", "multipart").
  --ageRangeDetails: record # Represents a targetable age range. This will be populated in the details field of an AssignedTargetingOption when targeting_type is `TARGETING_TYPE_AGE_RANGE`. — shape: {ageRange?: "AGE_RANGE_UNSPECIFIED"|"AGE_RANGE_18_24"|"AGE_RANGE_25_34"|"AGE_RANGE_35_44"|"AGE_RANGE_45_54"|"AGE_RANGE_55_64"|"AGE_RANGE_65_PLUS"|"AGE_RANGE_UNKNOWN"|"AGE_RANGE_18_20"|"AGE_RANGE_21_24"|"AGE_RANGE_25_29"|"AGE_RANGE_30_34"|"AGE_RANGE_35_39"|"AGE_RANGE_40_44"|"AGE_RANGE_45_49"|"AGE_RANGE_50_54"|"AGE_RANGE_55_59"|"AGE_RANGE_60_64"}
  --appCategoryDetails: record # Details for assigned app category targeting option. This will be populated in the app_category_details field of an AssignedTargetingOption when targeting_type is `TARGETING_TYPE_APP_CATEGORY`. — shape: {negative?: bool, targetingOptionId?: string}
  --appDetails: record # Details for assigned app targeting option. This will be populated in the details field of an AssignedTargetingOption when targeting_type is `TARGETING_TYPE_APP`. — shape: {appId?: string, appPlatform?: "APP_PLATFORM_UNSPECIFIED"|"APP_PLATFORM_IOS"|"APP_PLATFORM_ANDROID"|"APP_PLATFORM_ROKU"|"APP_PLATFORM_AMAZON_FIRETV"|"APP_PLATFORM_PLAYSTATION"|"APP_PLATFORM_APPLE_TV"|"APP_PLATFORM_XBOX"|"APP_PLATFORM_SAMSUNG_TV"|"APP_PLATFORM_ANDROID_TV"|"APP_PLATFORM_GENERIC_CTV", negative?: bool}
  --audienceGroupDetails: record # Assigned audience group targeting option details. This will be populated in the details field of an AssignedTargetingOption when targeting_type is `TARGETING_TYPE_AUDIENCE_GROUP`. The relation between each group is UNION, except for excluded_first_and_third_party_audience_group and excluded_google_audience_group, of which COMPLEMENT is used as an INTERSECTION with other groups. — shape: {excludedFirstAndThirdPartyAudienceGroup?: record, excludedGoogleAudienceGroup?: record, includedCombinedAudienceGroup?: record, includedCustomListGroup?: record, includedFirstAndThirdPartyAudienceGroups?: list, includedGoogleAudienceGroup?: record}
  --audioContentTypeDetails: record # Details for audio content type assigned targeting option. This will be populated in the audio_content_type_details field when targeting_type is `TARGETING_TYPE_AUDIO_CONTENT_TYPE`. Explicitly targeting all options is not supported. Remove all audio content type targeting options to achieve this effect. — shape: {audioContentType?: "AUDIO_CONTENT_TYPE_UNSPECIFIED"|"AUDIO_CONTENT_TYPE_UNKNOWN"|"AUDIO_CONTENT_TYPE_MUSIC"|"AUDIO_CONTENT_TYPE_BROADCAST"|"AUDIO_CONTENT_TYPE_PODCAST"}
  --authorizedSellerStatusDetails: record # Represents an assigned authorized seller status. This will be populated in the details field of an AssignedTargetingOption when targeting_type is `TARGETING_TYPE_AUTHORIZED_SELLER_STATUS`. — shape: {targetingOptionId?: string}
  --browserDetails: record # Details for assigned browser targeting option. This will be populated in the details field of an AssignedTargetingOption when targeting_type is `TARGETING_TYPE_BROWSER`. — shape: {negative?: bool, targetingOptionId?: string}
  --businessChainDetails: record # Details for assigned Business chain targeting option. This will be populated in the details field of an AssignedTargetingOption when targeting_type is `TARGETING_TYPE_BUSINESS_CHAIN`. — shape: {proximityRadiusAmount?: float, proximityRadiusUnit?: "DISTANCE_UNIT_UNSPECIFIED"|"DISTANCE_UNIT_MILES"|"DISTANCE_UNIT_KILOMETERS", targetingOptionId?: string}
  --carrierAndIspDetails: record # Details for assigned carrier and ISP targeting option. This will be populated in the details field of an AssignedTargetingOption when targeting_type is `TARGETING_TYPE_CARRIER_AND_ISP`. — shape: {negative?: bool, targetingOptionId?: string}
  --categoryDetails: record # Assigned category targeting option details. This will be populated in the category_details field when targeting_type is `TARGETING_TYPE_CATEGORY`. — shape: {negative?: bool, targetingOptionId?: string}
  --channelDetails: record # Details for assigned channel targeting option. This will be populated in the details field of an AssignedTargetingOption when targeting_type is `TARGETING_TYPE_CHANNEL`. — shape: {channelId?: string, negative?: bool}
  --contentDurationDetails: record # Details for content duration assigned targeting option. This will be populated in the content_duration_details field when targeting_type is `TARGETING_TYPE_CONTENT_DURATION`. Explicitly targeting all options is not supported. Remove all content duration targeting options to achieve this effect. — shape: {targetingOptionId?: string}
  --contentGenreDetails: record # Details for content genre assigned targeting option. This will be populated in the content_genre_details field when targeting_type is `TARGETING_TYPE_CONTENT_GENRE`. Explicitly targeting all options is not supported. Remove all content genre targeting options to achieve this effect. — shape: {negative?: bool, targetingOptionId?: string}
  --contentInstreamPositionDetails: record # Assigned content instream position targeting option details. This will be populated in the content_instream_position_details field when targeting_type is `TARGETING_TYPE_CONTENT_INSTREAM_POSITION`. — shape: {contentInstreamPosition?: "CONTENT_INSTREAM_POSITION_UNSPECIFIED"|"CONTENT_INSTREAM_POSITION_PRE_ROLL"|"CONTENT_INSTREAM_POSITION_MID_ROLL"|"CONTENT_INSTREAM_POSITION_POST_ROLL"|"CONTENT_INSTREAM_POSITION_UNKNOWN"}
  --contentOutstreamPositionDetails: record # Assigned content outstream position targeting option details. This will be populated in the content_outstream_position_details field when targeting_type is `TARGETING_TYPE_CONTENT_OUTSTREAM_POSITION`. — shape: {contentOutstreamPosition?: "CONTENT_OUTSTREAM_POSITION_UNSPECIFIED"|"CONTENT_OUTSTREAM_POSITION_UNKNOWN"|"CONTENT_OUTSTREAM_POSITION_IN_ARTICLE"|"CONTENT_OUTSTREAM_POSITION_IN_BANNER"|"CONTENT_OUTSTREAM_POSITION_IN_FEED"|"CONTENT_OUTSTREAM_POSITION_INTERSTITIAL"}
  --contentStreamTypeDetails: record # Details for content stream type assigned targeting option. This will be populated in the content_stream_type_details field when targeting_type is `TARGETING_TYPE_CONTENT_STREAM_TYPE`. Explicitly targeting all options is not supported. Remove all content stream type targeting options to achieve this effect. — shape: {targetingOptionId?: string}
  --dayAndTimeDetails: record # Representation of a segment of time defined on a specific day of the week and with a start and end time. The time represented by `start_hour` must be before the time represented by `end_hour`. — shape: {dayOfWeek?: "DAY_OF_WEEK_UNSPECIFIED"|"MONDAY"|"TUESDAY"|"WEDNESDAY"|"THURSDAY"|"FRIDAY"|"SATURDAY"|"SUNDAY", endHour?: int, startHour?: int, timeZoneResolution?: "TIME_ZONE_RESOLUTION_UNSPECIFIED"|"TIME_ZONE_RESOLUTION_END_USER"|"TIME_ZONE_RESOLUTION_ADVERTISER"}
  --deviceMakeModelDetails: record # Assigned device make and model targeting option details. This will be populated in the device_make_model_details field when targeting_type is `TARGETING_TYPE_DEVICE_MAKE_MODEL`. — shape: {negative?: bool, targetingOptionId?: string}
  --deviceTypeDetails: record # Targeting details for device type. This will be populated in the details field of an AssignedTargetingOption when targeting_type is `TARGETING_TYPE_DEVICE_TYPE`. — shape: {deviceType?: "DEVICE_TYPE_UNSPECIFIED"|"DEVICE_TYPE_COMPUTER"|"DEVICE_TYPE_CONNECTED_TV"|"DEVICE_TYPE_SMART_PHONE"|"DEVICE_TYPE_TABLET"}
  --digitalContentLabelExclusionDetails: record # Targeting details for digital content label. This will be populated in the details field of an AssignedTargetingOption when targeting_type is `TARGETING_TYPE_DIGITAL_CONTENT_LABEL_EXCLUSION`. — shape: {excludedContentRatingTier?: "CONTENT_RATING_TIER_UNSPECIFIED"|"CONTENT_RATING_TIER_UNRATED"|"CONTENT_RATING_TIER_GENERAL"|"CONTENT_RATING_TIER_PARENTAL_GUIDANCE"|"CONTENT_RATING_TIER_TEENS"|"CONTENT_RATING_TIER_MATURE"|"CONTENT_RATING_TIER_FAMILIES"}
  --environmentDetails: record # Assigned environment targeting option details. This will be populated in the details field of an AssignedTargetingOption when targeting_type is `TARGETING_TYPE_ENVIRONMENT`. — shape: {environment?: "ENVIRONMENT_UNSPECIFIED"|"ENVIRONMENT_WEB_OPTIMIZED"|"ENVIRONMENT_WEB_NOT_OPTIMIZED"|"ENVIRONMENT_APP"}
  --exchangeDetails: record # Details for assigned exchange targeting option. This will be populated in the details field of an AssignedTargetingOption when targeting_type is `TARGETING_TYPE_EXCHANGE`. — shape: {exchange?: "EXCHANGE_UNSPECIFIED"|"EXCHANGE_GOOGLE_AD_MANAGER"|"EXCHANGE_APPNEXUS"|"EXCHANGE_BRIGHTROLL"|"EXCHANGE_ADFORM"|"EXCHANGE_ADMETA"|"EXCHANGE_ADMIXER"|"EXCHANGE_ADSMOGO"|"EXCHANGE_ADSWIZZ"|"EXCHANGE_BIDSWITCH"|"EXCHANGE_BRIGHTROLL_DISPLAY"|"EXCHANGE_CADREON"|"EXCHANGE_DAILYMOTION"|"EXCHANGE_FIVE"|"EXCHANGE_FLUCT"|"EXCHANGE_FREEWHEEL"|"EXCHANGE_GENIEE"|"EXCHANGE_GUMGUM"|"EXCHANGE_IMOBILE"|"EXCHANGE_IBILLBOARD"|"EXCHANGE_IMPROVE_DIGITAL"|"EXCHANGE_INDEX"|"EXCHANGE_KARGO"|"EXCHANGE_MICROAD"|"EXCHANGE_MOPUB"|"EXCHANGE_NEND"|"EXCHANGE_ONE_BY_AOL_DISPLAY"|"EXCHANGE_ONE_BY_AOL_MOBILE"|"EXCHANGE_ONE_BY_AOL_VIDEO"|"EXCHANGE_OOYALA"|"EXCHANGE_OPENX"|"EXCHANGE_PERMODO"|"EXCHANGE_PLATFORMONE"|"EXCHANGE_PLATFORMID"|"EXCHANGE_PUBMATIC"|"EXCHANGE_PULSEPOINT"|"EXCHANGE_REVENUEMAX"|"EXCHANGE_RUBICON"|"EXCHANGE_SMARTCLIP"|"EXCHANGE_SMARTRTB"|"EXCHANGE_SMARTSTREAMTV"|"EXCHANGE_SOVRN"|"EXCHANGE_SPOTXCHANGE"|"EXCHANGE_STROER"|"EXCHANGE_TEADSTV"|"EXCHANGE_TELARIA"|"EXCHANGE_TVN"|"EXCHANGE_UNITED"|"EXCHANGE_YIELDLAB"|"EXCHANGE_YIELDMO"|"EXCHANGE_UNRULYX"|"EXCHANGE_OPEN8"|"EXCHANGE_TRITON"|"EXCHANGE_TRIPLELIFT"|"EXCHANGE_TABOOLA"|"EXCHANGE_INMOBI"|"EXCHANGE_SMAATO"|"EXCHANGE_AJA"|"EXCHANGE_SUPERSHIP"|"EXCHANGE_NEXSTAR_DIGITAL"|"EXCHANGE_WAZE"|"EXCHANGE_SOUNDCAST"|"EXCHANGE_SHARETHROUGH"|"EXCHANGE_FYBER"|"EXCHANGE_RED_FOR_PUBLISHERS"|"EXCHANGE_MEDIANET"|"EXCHANGE_TAPJOY"|"EXCHANGE_VISTAR"|"EXCHANGE_DAX"|"EXCHANGE_JCD"|"EXCHANGE_PLACE_EXCHANGE"|"EXCHANGE_APPLOVIN"|"EXCHANGE_CONNATIX"|"EXCHANGE_RESET_DIGITAL"|"EXCHANGE_HIVESTACK"}
  --genderDetails: record # Details for assigned gender targeting option. This will be populated in the details field of an AssignedTargetingOption when targeting_type is `TARGETING_TYPE_GENDER`. — shape: {gender?: "GENDER_UNSPECIFIED"|"GENDER_MALE"|"GENDER_FEMALE"|"GENDER_UNKNOWN"}
  --geoRegionDetails: record # Details for assigned geographic region targeting option. This will be populated in the details field of an AssignedTargetingOption when targeting_type is `TARGETING_TYPE_GEO_REGION`. — shape: {negative?: bool, targetingOptionId?: string}
  --householdIncomeDetails: record # Details for assigned household income targeting option. This will be populated in the details field of an AssignedTargetingOption when targeting_type is `TARGETING_TYPE_HOUSEHOLD_INCOME`. — shape: {householdIncome?: "HOUSEHOLD_INCOME_UNSPECIFIED"|"HOUSEHOLD_INCOME_UNKNOWN"|"HOUSEHOLD_INCOME_LOWER_50_PERCENT"|"HOUSEHOLD_INCOME_TOP_41_TO_50_PERCENT"|"HOUSEHOLD_INCOME_TOP_31_TO_40_PERCENT"|"HOUSEHOLD_INCOME_TOP_21_TO_30_PERCENT"|"HOUSEHOLD_INCOME_TOP_11_TO_20_PERCENT"|"HOUSEHOLD_INCOME_TOP_10_PERCENT"}
  --inventorySourceDetails: record # Targeting details for inventory source. This will be populated in the details field of an AssignedTargetingOption when targeting_type is `TARGETING_TYPE_INVENTORY_SOURCE`. — shape: {inventorySourceId?: string}
  --inventorySourceGroupDetails: record # Targeting details for inventory source group. This will be populated in the details field of an AssignedTargetingOption when targeting_type is `TARGETING_TYPE_INVENTORY_SOURCE_GROUP`. — shape: {inventorySourceGroupId?: string}
  --keywordDetails: record # Details for assigned keyword targeting option. This will be populated in the details field of an AssignedTargetingOption when targeting_type is `TARGETING_TYPE_KEYWORD`. — shape: {keyword?: string, negative?: bool}
  --languageDetails: record # Details for assigned language targeting option. This will be populated in the details field of an AssignedTargetingOption when targeting_type is `TARGETING_TYPE_LANGUAGE`. — shape: {negative?: bool, targetingOptionId?: string}
  --nativeContentPositionDetails: record # Details for native content position assigned targeting option. This will be populated in the native_content_position_details field when targeting_type is `TARGETING_TYPE_NATIVE_CONTENT_POSITION`. Explicitly targeting all options is not supported. Remove all native content position targeting options to achieve this effect. — shape: {contentPosition?: "NATIVE_CONTENT_POSITION_UNSPECIFIED"|"NATIVE_CONTENT_POSITION_UNKNOWN"|"NATIVE_CONTENT_POSITION_IN_ARTICLE"|"NATIVE_CONTENT_POSITION_IN_FEED"|"NATIVE_CONTENT_POSITION_PERIPHERAL"|"NATIVE_CONTENT_POSITION_RECOMMENDATION"}
  --negativeKeywordListDetails: record # Targeting details for negative keyword list. This will be populated in the details field of an AssignedTargetingOption when targeting_type is `TARGETING_TYPE_NEGATIVE_KEYWORD_LIST`. — shape: {negativeKeywordListId?: string}
  --omidDetails: record # Represents a targetable Open Measurement enabled inventory type. This will be populated in the details field of an AssignedTargetingOption when targeting_type is `TARGETING_TYPE_OMID`. — shape: {omid?: "OMID_UNSPECIFIED"|"OMID_FOR_MOBILE_DISPLAY_ADS"}
  --onScreenPositionDetails: record # On screen position targeting option details. This will be populated in the on_screen_position_details field when targeting_type is `TARGETING_TYPE_ON_SCREEN_POSITION`. — shape: {targetingOptionId?: string}
  --operatingSystemDetails: record # Assigned operating system targeting option details. This will be populated in the operating_system_details field when targeting_type is `TARGETING_TYPE_OPERATING_SYSTEM`. — shape: {negative?: bool, targetingOptionId?: string}
  --parentalStatusDetails: record # Details for assigned parental status targeting option. This will be populated in the details field of an AssignedTargetingOption when targeting_type is `TARGETING_TYPE_PARENTAL_STATUS`. — shape: {parentalStatus?: "PARENTAL_STATUS_UNSPECIFIED"|"PARENTAL_STATUS_PARENT"|"PARENTAL_STATUS_NOT_A_PARENT"|"PARENTAL_STATUS_UNKNOWN"}
  --poiDetails: record # Details for assigned POI targeting option. This will be populated in the details field of an AssignedTargetingOption when targeting_type is `TARGETING_TYPE_POI`. — shape: {proximityRadiusAmount?: float, proximityRadiusUnit?: "DISTANCE_UNIT_UNSPECIFIED"|"DISTANCE_UNIT_MILES"|"DISTANCE_UNIT_KILOMETERS", targetingOptionId?: string}
  ...
  --regionalLocationListDetails: record # Targeting details for regional location list. This will be populated in the details field of an AssignedTargetingOption when targeting_type is `TARGETING_TYPE_REGIONAL_LOCATION_LIST`. — shape: {negative?: bool, regionalLocationListId?: string}
  --sensitiveCategoryExclusionDetails: record # Targeting details for sensitive category. This will be populated in the details field of an AssignedTargetingOption when targeting_type is `TARGETING_TYPE_SENSITIVE_CATEGORY_EXCLUSION`. — shape: {excludedSensitiveCategory?: "SENSITIVE_CATEGORY_UNSPECIFIED"|"SENSITIVE_CATEGORY_ADULT"|"SENSITIVE_CATEGORY_DEROGATORY"|"SENSITIVE_CATEGORY_DOWNLOADS_SHARING"|"SENSITIVE_CATEGORY_WEAPONS"|"SENSITIVE_CATEGORY_GAMBLING"|"SENSITIVE_CATEGORY_VIOLENCE"|"SENSITIVE_CATEGORY_SUGGESTIVE"|"SENSITIVE_CATEGORY_PROFANITY"|"SENSITIVE_CATEGORY_ALCOHOL"|"SENSITIVE_CATEGORY_DRUGS"|"SENSITIVE_CATEGORY_TOBACCO"|"SENSITIVE_CATEGORY_POLITICS"|"SENSITIVE_CATEGORY_RELIGION"|"SENSITIVE_CATEGORY_TRAGEDY"|"SENSITIVE_CATEGORY_TRANSPORTATION_ACCIDENTS"|"SENSITIVE_CATEGORY_SENSITIVE_SOCIAL_ISSUES"|"SENSITIVE_CATEGORY_SHOCKING"|"SENSITIVE_CATEGORY_EMBEDDED_VIDEO"|"SENSITIVE_CATEGORY_LIVE_STREAMING_VIDEO"}
  --sessionPositionDetails: record # Details for session position assigned targeting option. This will be populated in the session_position_details field when targeting_type is `TARGETING_TYPE_SESSION_POSITION`. — shape: {sessionPosition?: "SESSION_POSITION_UNSPECIFIED"|"SESSION_POSITION_FIRST_IMPRESSION"}
  --subExchangeDetails: record # Details for assigned sub-exchange targeting option. This will be populated in the details field of an AssignedTargetingOption when targeting_type is `TARGETING_TYPE_SUB_EXCHANGE`. — shape: {targetingOptionId?: string}
  --thirdPartyVerifierDetails: record # Assigned third party verifier targeting option details. This will be populated in the details field of an AssignedTargetingOption when targeting_type is `TARGETING_TYPE_THIRD_PARTY_VERIFIER`. — shape: {adloox?: record, doubleVerify?: record, integralAdScience?: record}
  --urlDetails: record # Details for assigned URL targeting option. This will be populated in the details field of an AssignedTargetingOption when targeting_type is `TARGETING_TYPE_URL`. — shape: {negative?: bool, url?: string}
  --userRewardedContentDetails: record # User rewarded content targeting option details. This will be populated in the user_rewarded_content_details field when targeting_type is `TARGETING_TYPE_USER_REWARDED_CONTENT`. — shape: {targetingOptionId?: string}
  --videoPlayerSizeDetails: record # Video player size targeting option details. This will be populated in the video_player_size_details field when targeting_type is `TARGETING_TYPE_VIDEO_PLAYER_SIZE`. Explicitly targeting all options is not supported. Remove all video player size targeting options to achieve this effect. — shape: {videoPlayerSize?: "VIDEO_PLAYER_SIZE_UNSPECIFIED"|"VIDEO_PLAYER_SIZE_SMALL"|"VIDEO_PLAYER_SIZE_LARGE"|"VIDEO_PLAYER_SIZE_HD"|"VIDEO_PLAYER_SIZE_UNKNOWN"}
  --viewabilityDetails: record # Assigned viewability targeting option details. This will be populated in the viewability_details field of an AssignedTargetingOption when targeting_type is `TARGETING_TYPE_VIEWABILITY`. — shape: {viewability?: "VIEWABILITY_UNSPECIFIED"|"VIEWABILITY_10_PERCENT_OR_MORE"|"VIEWABILITY_20_PERCENT_OR_MORE"|"VIEWABILITY_30_PERCENT_OR_MORE"|"VIEWABILITY_40_PERCENT_OR_MORE"|"VIEWABILITY_50_PERCENT_OR_MORE"|"VIEWABILITY_60_PERCENT_OR_MORE"|"VIEWABILITY_70_PERCENT_OR_MORE"|"VIEWABILITY_80_PERCENT_OR_MORE"|"VIEWABILITY_90_PERCENT_OR_MORE"}
  --youtubeChannelDetails: record # Details for YouTube channel assigned targeting option. This will be populated in the youtube_channel_details field when targeting_type is `TARGETING_TYPE_YOUTUBE_CHANNEL`. — shape: {channelId?: string, negative?: bool}
  --youtubeVideoDetails: record # Details for YouTube video assigned targeting option. This will be populated in the youtube_video_details field when targeting_type is `TARGETING_TYPE_YOUTUBE_VIDEO`. — shape: {negative?: bool, videoId?: string}
  ...
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $qp_fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v2/advertisers/($advertiserId)/insertionOrders/($insertionOrderId)/targetingTypes/($targetingType)/assignedTargetingOptions" $qp)
  let body = {ageRangeDetails: $ageRangeDetails, appCategoryDetails: $appCategoryDetails, appDetails: $appDetails, audienceGroupDetails: $audienceGroupDetails, audioContentTypeDetails: $audioContentTypeDetails, authorizedSellerStatusDetails: $authorizedSellerStatusDetails, browserDetails: $browserDetails, businessChainDetails: $businessChainDetails, carrierAndIspDetails: $carrierAndIspDetails, categoryDetails: $categoryDetails, channelDetails: $channelDetails, contentDurationDetails: $contentDurationDetails, contentGenreDetails: $contentGenreDetails, contentInstreamPositionDetails: $contentInstreamPositionDetails, contentOutstreamPositionDetails: $contentOutstreamPositionDetails, contentStreamTypeDetails: $contentStreamTypeDetails, dayAndTimeDetails: $dayAndTimeDetails, deviceMakeModelDetails: $deviceMakeModelDetails, deviceTypeDetails: $deviceTypeDetails, digitalContentLabelExclusionDetails: $digitalContentLabelExclusionDetails, environmentDetails: $environmentDetails, exchangeDetails: $exchangeDetails, genderDetails: $genderDetails, geoRegionDetails: $geoRegionDetails, householdIncomeDetails: $householdIncomeDetails, inventorySourceDetails: $inventorySourceDetails, inventorySourceGroupDetails: $inventorySourceGroupDetails, keywordDetails: $keywordDetails, languageDetails: $languageDetails, nativeContentPositionDetails: $nativeContentPositionDetails, negativeKeywordListDetails: $negativeKeywordListDetails, omidDetails: $omidDetails, onScreenPositionDetails: $onScreenPositionDetails, operatingSystemDetails: $operatingSystemDetails, parentalStatusDetails: $parentalStatusDetails, poiDetails: $poiDetails, proximityLocationListDetails: $proximityLocationListDetails, regionalLocationListDetails: $regionalLocationListDetails, sensitiveCategoryExclusionDetails: $sensitiveCategoryExclusionDetails, sessionPositionDetails: $sessionPositionDetails, subExchangeDetails: $subExchangeDetails, thirdPartyVerifierDetails: $thirdPartyVerifierDetails, urlDetails: $urlDetails, userRewardedContentDetails: $userRewardedContentDetails, videoPlayerSizeDetails: $videoPlayerSizeDetails, viewabilityDetails: $viewabilityDetails, youtubeChannelDetails: $youtubeChannelDetails, youtubeVideoDetails: $youtubeVideoDetails} | compact
  let body = if ($input | describe | str starts-with "record") { $input | merge deep ($body | default {}) } else { $body }
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "post" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json" $body
...
export def "advertisers-insertion-orders-targeting-types-assigned-targeting-options displayvideoadvertisersinsertionOrderstargetingTypesassignedTargetingOptionsdelete" [
  advertiserId: string
  insertionOrderId: string
  targetingType: string
  assignedTargetingOptionId: string
  ...
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $qp_fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v2/advertisers/($advertiserId)/insertionOrders/($insertionOrderId)/targetingTypes/($targetingType)/assignedTargetingOptions/($assignedTargetingOptionId)" $qp)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "delete" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json"
}
...
export def "advertisers-insertion-orders-targeting-types-assigned-targeting-options displayvideoadvertisersinsertionOrderstargetingTypesassignedTargetingOptionsget" [
  advertiserId: string
  insertionOrderId: string
  targetingType: string
  assignedTargetingOptionId: string
...
export def "advertisers-insertion-orders displayvideoadvertisersinsertionOrderslistAssignedTargetingOptions" [
  advertiserId: string
  insertionOrderId: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  ...
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $qp_fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar") (serialize-qp "filter" $filter "scalar") (serialize-qp "orderBy" $orderBy "scalar") (serialize-qp "pageSize" $pageSize "scalar") (serialize-qp "pageToken" $pageToken "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v2/advertisers/($advertiserId)/insertionOrders/($insertionOrderId):listAssignedTargetingOptions" $qp)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "get" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json"
}
...
export def "advertisers-invoices displayvideoadvertisersinvoiceslist" [
  advertiserId: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  ...
  --loiSapinInvoiceType: string@loiSapinInvoiceType-completer # Select type of invoice to retrieve for Loi Sapin advertisers. Only applicable to Loi Sapin advertisers. Will be ignored otherwise.
  --pageSize: int # Requested page size. Must be between `1` and `200`. If unspecified will default to `100`. Returns error code `INVALID_ARGUMENT` if an invalid value is specified.
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $qp_fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar") (serialize-qp "issueMonth" $issueMonth "scalar") (serialize-qp "loiSapinInvoiceType" $loiSapinInvoiceType "scalar") (serialize-qp "pageSize" $pageSize "scalar") (serialize-qp "pageToken" $pageToken "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v2/advertisers/($advertiserId)/invoices" $qp)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "get" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json"
}
...
export def "advertisers-invoices-lookup-invoice-currency displayvideoadvertisersinvoiceslookupInvoiceCurrency" [
  advertiserId: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $qp_fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar") (serialize-qp "invoiceMonth" $invoiceMonth "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v2/advertisers/($advertiserId)/invoices:lookupInvoiceCurrency" $qp)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "get" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json"
}
...
export def "advertisers-line-items displayvideoadvertiserslineItemslist" [
  advertiserId: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  ...
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $qp_fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar") (serialize-qp "filter" $filter "scalar") (serialize-qp "orderBy" $orderBy "scalar") (serialize-qp "pageSize" $pageSize "scalar") (serialize-qp "pageToken" $pageToken "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v2/advertisers/($advertiserId)/lineItems" $qp)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "get" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json"
}
...
# --youtubeAndPartnersSettings shape: {biddingStrategy?: record, contentCategory?: "YOUTUBE_AND_PARTNERS_CONTENT_CATEGORY_UNSPECIFIED"|"YOUTUBE_AND_PARTNERS_CONTENT_CATEGORY_STANDARD"|"YOUTUBE_AND_PARTNERS_CONTENT_CATEGORY_EXPANDED"|"YOUTUBE_AND_PARTNERS_CONTENT_CATEGORY_LIMITED", inventorySourceSettings?: record, leadFormId?: string, linkedMerchantId?: string, relatedVideoIds?: list, targetFrequency?: record, thirdPartyMeasurementSettings?: record, videoAdSequenceSettings?: record, viewFrequencyCap?: record}
export def "advertisers-line-items displayvideoadvertiserslineItemscreate" [
  advertiserId: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  ...
  --conversionCounting: record # Settings that control how conversions are counted. All post-click conversions will be counted. A percentage value can be set for post-view conversions counting. — shape: {floodlightActivityConfigs?: list, postViewCountPercentageMillis?: string}
  --creativeIds: list # The IDs of the creatives associated with the line item.
  --displayName: string # Required. The display name of the line item. Must be UTF-8 encoded with a maximum size of 240 bytes.
  --entityStatus: string@entityStatus-completer # Required. Controls whether or not the line item can spend its budget and bid on inventory. * For CreateLineItem method, only `ENTITY_STATUS_DRAFT` is allowed. To activate a line item, use UpdateLineItem method and update the status to `ENTITY_STATUS_ACTIVE` after creation. * A line item cannot be changed back to `ENTITY_STATUS_DRAFT` status from any other status. * If the line item's parent insertion order is not active, the line item can't spend its budget even if its own status is `ENTITY_STATUS_ACTIVE`.
  --excludeNewExchanges: oneof<nothing, bool> # Whether to exclude new exchanges from automatically being targeted by the line item. This field is false by default.
  ...
  --frequencyCap: record # Settings that control the number of times a user may be shown with the same ad during a given time period. — shape: {maxImpressions?: int, maxViews?: int, timeUnit?: "TIME_UNIT_UNSPECIFIED"|"TIME_UNIT_LIFETIME"|"TIME_UNIT_MONTHS"|"TIME_UNIT_WEEKS"|"TIME_UNIT_DAYS"|"TIME_UNIT_HOURS"|"TIME_UNIT_MINUTES", timeUnitCount?: int, unlimited?: bool}
  --insertionOrderId: string # Required. Immutable. The unique ID of the insertion order that the line item belongs to. (format: int64)
  --integrationDetails: record # Integration details of an entry. — shape: {details?: string, integrationCode?: string}
  --lineItemType: string@lineItemType-completer # Required. Immutable. The type of the line item.
  --mobileApp: record # A mobile app promoted by a mobile app install line item. — shape: {appId?: string}
  --pacing: record # Settings that control the rate at which a budget is spent. — shape: {dailyMaxImpressions?: string, dailyMaxMicros?: string, pacingPeriod?: "PACING_PERIOD_UNSPECIFIED"|"PACING_PERIOD_DAILY"|"PACING_PERIOD_FLIGHT", pacingType?: "PACING_TYPE_UNSPECIFIED"|"PACING_TYPE_AHEAD"|"PACING_TYPE_ASAP"|"PACING_TYPE_EVEN"}
  --partnerCosts: list # The partner costs associated with the line item. If absent or empty in CreateLineItem method, the newly created line item will inherit partner costs from its parent insertion order. — item shape: {costType?: "PARTNER_COST_TYPE_UNSPECIFIED"|"PARTNER_COST_TYPE_ADLOOX"|"PARTNER_COST_TYPE_ADLOOX_PREBID"|"PARTNER_COST_TYPE_ADSAFE"|"PARTNER_COST_TYPE_ADXPOSE"|"PARTNER_COST_TYPE_AGGREGATE_KNOWLEDGE"|"PARTNER_COST_TYPE_AGENCY_TRADING_DESK"|"PARTNER_COST_TYPE_DV360_FEE"|"PARTNER_COST_TYPE_COMSCORE_VCE"|"PARTNER_COST_TYPE_DATA_MANAGEMENT_PLATFORM"|"PARTNER_COST_TYPE_DEFAULT"|"PARTNER_COST_TYPE_DOUBLE_VERIFY"|"PARTNER_COST_TYPE_DOUBLE_VERIFY_PREBID"|"PARTNER_COST_TYPE_EVIDON"|"PARTNER_COST_TYPE_INTEGRAL_AD_SCIENCE_VIDEO"|"PARTNER_COST_TYPE_INTEGRAL_AD_SCIENCE_PREBID"|"PARTNER_COST_TYPE_MEDIA_COST_DATA"|"PARTNER_COST_TYPE_MOAT_VIDEO"|"PARTNER_COST_TYPE_NIELSEN_DAR"|"PARTNER_COST_TYPE_SHOP_LOCAL"|"PARTNER_COST_TYPE_TERACENT"|"PARTNER_COST_TYPE_THIRD_PARTY_AD_SERVER"|"PARTNER_COST_TYPE_TRUST_METRICS"|"PARTNER_COST_TYPE_VIZU"|"PARTNER_COST_TYPE_ADLINGO_FEE"|"PARTNER_COST_TYPE_CUSTOM_FEE_1"|"PARTNER_COST_TYPE_CUSTOM_FEE_2"|"PARTNER_COST_TYPE_CUSTOM_FEE_3"|"PARTNER_COST_TYPE_CUSTOM_FEE_4"|"PARTNER_COST_TYPE_CUSTOM_FEE_5", feeAmount?: string, feePercentageMillis?: string, feeType?: "PARTNER_COST_FEE_TYPE_UNSPECIFIED"|"PARTNER_COST_FEE_TYPE_CPM_FEE"|"PARTNER_COST_FEE_TYPE_MEDIA_FEE", invoiceType?: "PARTNER_COST_INVOICE_TYPE_UNSPECIFIED"|"PARTNER_COST_INVOICE_TYPE_DV360"|"PARTNER_COST_INVOICE_TYPE_PARTNER"}
  --partnerRevenueModel: record # Settings that control how partner revenue is calculated. — shape: {markupAmount?: string, markupType?: "PARTNER_REVENUE_MODEL_MARKUP_TYPE_UNSPECIFIED"|"PARTNER_REVENUE_MODEL_MARKUP_TYPE_CPM"|"PARTNER_REVENUE_MODEL_MARKUP_TYPE_MEDIA_COST_MARKUP"|"PARTNER_REVENUE_MODEL_MARKUP_TYPE_TOTAL_MEDIA_COST_MARKUP"}
  --targetingExpansion: record # Settings that control the targeting expansion of the line item. Targeting expansion allows the line item to reach a larger audience based on the original audience list and the targeting expansion level. Beginning **March 25, 2023**, these settings may represent the [optimized targeting feature](//support.google.com/displayvideo/answer/12060859) in place of targeting expansion. This feature will be rolled out to all partners by early May 2023. — shape: {excludeFirstPartyAudience?: bool, targetingExpansionLevel?: "TARGETING_EXPANSION_LEVEL_UNSPECIFIED"|"NO_EXPANSION"|"LEAST_EXPANSION"|"SOME_EXPANSION"|"BALANCED_EXPANSION"|"MORE_EXPANSION"|"MOST_EXPANSION"}
  --youtubeAndPartnersSettings: record # Settings for YouTube and Partners line items. — shape: {biddingStrategy?: record, contentCategory?: "YOUTUBE_AND_PARTNERS_CONTENT_CATEGORY_UNSPECIFIED"|"YOUTUBE_AND_PARTNERS_CONTENT_CATEGORY_STANDARD"|"YOUTUBE_AND_PARTNERS_CONTENT_CATEGORY_EXPANDED"|"YOUTUBE_AND_PARTNERS_CONTENT_CATEGORY_LIMITED", inventorySourceSettings?: record, leadFormId?: string, linkedMerchantId?: string, relatedVideoIds?: list, targetFrequency?: record, thirdPartyMeasurementSettings?: record, videoAdSequenceSettings?: record, viewFrequencyCap?: record}
  ...
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $qp_fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v2/advertisers/($advertiserId)/lineItems" $qp)
  let body = {bidStrategy: $bidStrategy, budget: $budget, conversionCounting: $conversionCounting, creativeIds: $creativeIds, displayName: $displayName, entityStatus: $entityStatus, excludeNewExchanges: $excludeNewExchanges, flight: $flight, frequencyCap: $frequencyCap, insertionOrderId: $insertionOrderId, integrationDetails: $integrationDetails, lineItemType: $lineItemType, mobileApp: $mobileApp, pacing: $pacing, partnerCosts: $partnerCosts, partnerRevenueModel: $partnerRevenueModel, targetingExpansion: $targetingExpansion, youtubeAndPartnersSettings: $youtubeAndPartnersSettings} | compact
  let body = if ($input | describe | str starts-with "record") { $input | merge deep ($body | default {}) } else { $body }
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "post" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json" $body
...
export def "advertisers-line-items displayvideoadvertiserslineItemsdelete" [
  advertiserId: string
  lineItemId: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  ...
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $qp_fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v2/advertisers/($advertiserId)/lineItems/($lineItemId)" $qp)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "delete" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json"
}
...
export def "advertisers-line-items displayvideoadvertiserslineItemsget" [
  advertiserId: string
  lineItemId: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
...
# --targetingExpansion shape: {excludeFirstPartyAudience?: bool, targetingExpansionLevel?: "TARGETING_EXPANSION_LEVEL_UNSPECIFIED"|"NO_EXPANSION"|"LEAST_EXPANSION"|"SOME_EXPANSION"|"BALANCED_EXPANSION"|"MORE_EXPANSION"|"MOST_EXPANSION"}
# --youtubeAndPartnersSettings shape: {biddingStrategy?: record, contentCategory?: "YOUTUBE_AND_PARTNERS_CONTENT_CATEGORY_UNSPECIFIED"|"YOUTUBE_AND_PARTNERS_CONTENT_CATEGORY_STANDARD"|"YOUTUBE_AND_PARTNERS_CONTENT_CATEGORY_EXPANDED"|"YOUTUBE_AND_PARTNERS_CONTENT_CATEGORY_LIMITED", inventorySourceSettings?: record, leadFormId?: string, linkedMerchantId?: string, relatedVideoIds?: list, targetFrequency?: record, thirdPartyMeasurementSettings?: record, videoAdSequenceSettings?: record, viewFrequencyCap?: record}
export def "advertisers-line-items displayvideoadvertiserslineItemspatch" [
  advertiserId: string
  lineItemId: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
...
export def "advertisers-line-items-targeting-types-assigned-targeting-options displayvideoadvertiserslineItemstargetingTypesassignedTargetingOptionslist" [
  advertiserId: string
  lineItemId: string
  targetingType: string
  --base-url(-b): string@base-url-completer # API base URL
  ...
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $qp_fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar") (serialize-qp "filter" $filter "scalar") (serialize-qp "orderBy" $orderBy "scalar") (serialize-qp "pageSize" $pageSize "scalar") (serialize-qp "pageToken" $pageToken "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v2/advertisers/($advertiserId)/lineItems/($lineItemId)/targetingTypes/($targetingType)/assignedTargetingOptions" $qp)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "get" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json"
}
...
# --youtubeChannelDetails shape: {channelId?: string, negative?: bool}
# --youtubeVideoDetails shape: {negative?: bool, videoId?: string}
export def "advertisers-line-items-targeting-types-assigned-targeting-options displayvideoadvertiserslineItemstargetingTypesassignedTargetingOptionscreate" [
  advertiserId: string
  lineItemId: string
  targetingType: string
  --base-url(-b): string@base-url-completer # API base URL
...
export def "advertisers-line-items-targeting-types-assigned-targeting-options displayvideoadvertiserslineItemstargetingTypesassignedTargetingOptionsdelete" [
  advertiserId: string
  lineItemId: string
  targetingType: string
  assignedTargetingOptionId: string
  ...
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $qp_fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v2/advertisers/($advertiserId)/lineItems/($lineItemId)/targetingTypes/($targetingType)/assignedTargetingOptions/($assignedTargetingOptionId)" $qp)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "delete" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json"
}
...
export def "advertisers-line-items-targeting-types-assigned-targeting-options displayvideoadvertiserslineItemstargetingTypesassignedTargetingOptionsget" [
  advertiserId: string
  lineItemId: string
  targetingType: string
  assignedTargetingOptionId: string
...
export def "advertisers-line-items displayvideoadvertiserslineItemsduplicate" [
  advertiserId: string
  lineItemId: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  ...
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $qp_fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v2/advertisers/($advertiserId)/lineItems/($lineItemId):duplicate" $qp)
  let body = {targetDisplayName: $targetDisplayName} | compact
  let body = if ($input | describe | str starts-with "record") { $input | merge deep ($body | default {}) } else { $body }
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "post" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json" $body
...
export def "advertisers-line-items-bulk-edit-assigned-targeting-options displayvideoadvertiserslineItemsbulkEditAssignedTargetingOptions" [
  ...
  --upload-protocol: string # Upload protocol for media (e.g. "raw", "multipart").
  --uploadType: string # Legacy upload protocol for media (e.g. "media", "multipart").
  --createRequests: list # The assigned targeting options to create in batch, specified as a list of CreateAssignedTargetingOptionsRequest. Supported targeting types include: * `TARGETING_TYPE_AGE_RANGE` * `TARGETING_TYPE_APP` * `TARGETING_TYPE_APP_CATEGORY` * `TARGETING_TYPE_AUDIENCE_GROUP` * `TARGETING_TYPE_AUDIO_CONTENT_TYPE` * `TARGETING_TYPE_AUTHORIZED_SELLER_STATUS` * `TARGETING_TYPE_BROWSER` * `TARGETING_TYPE_BUSINESS_CHAIN` * `TARGETING_TYPE_CARRIER_AND_ISP` * `TARGETING_TYPE_CATEGORY` * `TARGETING_TYPE_CHANNEL` * `TARGETING_TYPE_CONTENT_DURATION` * `TARGETING_TYPE_CONTENT_GENRE` * `TARGETING_TYPE_CONTENT_INSTREAM_POSITION` * `TARGETING_TYPE_CONTENT_OUTSTREAM_POSITION` * `TARGETING_TYPE_CONTENT_STREAM_TYPE` * `TARGETING_TYPE_DAY_AND_TIME` * `TARGETING_TYPE_DEVICE_MAKE_MODEL` * `TARGETING_TYPE_DEVICE_TYPE` * `TARGETING_TYPE_DIGITAL_CONTENT_LABEL_EXCLUSION` * `TARGETING_TYPE_ENVIRONMENT` * `TARGETING_TYPE_EXCHANGE` * `TARGETING_TYPE_GENDER` * `TARGETING_TYPE_GEO_REGION` * `TARGETING_TYPE_HOUSEHOLD_INCOME` * `TARGETING_TYPE_INVENTORY_SOURCE` * `TARGETING_TYPE_INVENTORY_SOURCE_GROUP` * `TARGETING_TYPE_KEYWORD` * `TARGETING_TYPE_LANGUAGE` * `TARGETING_TYPE_NATIVE_CONTENT_POSITION` * `TARGETING_TYPE_NEGATIVE_KEYWORD_LIST` * `TARGETING_TYPE_OMID` * `TARGETING_TYPE_ON_SCREEN_POSITION` * `TARGETING_TYPE_OPERATING_SYSTEM` * `TARGETING_TYPE_PARENTAL_STATUS` * `TARGETING_TYPE_POI` * `TARGETING_TYPE_PROXIMITY_LOCATION_LIST` * `TARGETING_TYPE_REGIONAL_LOCATION_LIST` * `TARGETING_TYPE_SENSITIVE_CATEGORY_EXCLUSION` * `TARGETING_TYPE_SUB_EXCHANGE` * `TARGETING_TYPE_THIRD_PARTY_VERIFIER` * `TARGETING_TYPE_URL` * `TARGETING_TYPE_USER_REWARDED_CONTENT` * `TARGETING_TYPE_VIDEO_PLAYER_SIZE` * `TARGETING_TYPE_VIEWABILITY` — item shape: {assignedTargetingOptions?: list, targetingType?: "TARGETING_TYPE_UNSPECIFIED"|"TARGETING_TYPE_CHANNEL"|"TARGETING_TYPE_APP_CATEGORY"|"TARGETING_TYPE_APP"|"TARGETING_TYPE_URL"|"TARGETING_TYPE_DAY_AND_TIME"|"TARGETING_TYPE_AGE_RANGE"|"TARGETING_TYPE_REGIONAL_LOCATION_LIST"|"TARGETING_TYPE_PROXIMITY_LOCATION_LIST"|"TARGETING_TYPE_GENDER"|"TARGETING_TYPE_VIDEO_PLAYER_SIZE"|"TARGETING_TYPE_USER_REWARDED_CONTENT"|"TARGETING_TYPE_PARENTAL_STATUS"|"TARGETING_TYPE_CONTENT_INSTREAM_POSITION"|"TARGETING_TYPE_CONTENT_OUTSTREAM_POSITION"|"TARGETING_TYPE_DEVICE_TYPE"|"TARGETING_TYPE_AUDIENCE_GROUP"|"TARGETING_TYPE_BROWSER"|"TARGETING_TYPE_HOUSEHOLD_INCOME"|"TARGETING_TYPE_ON_SCREEN_POSITION"|"TARGETING_TYPE_THIRD_PARTY_VERIFIER"|"TARGETING_TYPE_DIGITAL_CONTENT_LABEL_EXCLUSION"|"TARGETING_TYPE_SENSITIVE_CATEGORY_EXCLUSION"|"TARGETING_TYPE_ENVIRONMENT"|"TARGETING_TYPE_CARRIER_AND_ISP"|"TARGETING_TYPE_OPERATING_SYSTEM"|"TARGETING_TYPE_DEVICE_MAKE_MODEL"|"TARGETING_TYPE_KEYWORD"|"TARGETING_TYPE_NEGATIVE_KEYWORD_LIST"|"TARGETING_TYPE_VIEWABILITY"|"TARGETING_TYPE_CATEGORY"|"TARGETING_TYPE_INVENTORY_SOURCE"|"TARGETING_TYPE_LANGUAGE"|"TARGETING_TYPE_AUTHORIZED_SELLER_STATUS"|"TARGETING_TYPE_GEO_REGION"|"TARGETING_TYPE_INVENTORY_SOURCE_GROUP"|"TARGETING_TYPE_EXCHANGE"|"TARGETING_TYPE_SUB_EXCHANGE"|"TARGETING_TYPE_POI"|"TARGETING_TYPE_BUSINESS_CHAIN"|"TARGETING_TYPE_CONTENT_DURATION"|"TARGETING_TYPE_CONTENT_STREAM_TYPE"|"TARGETING_TYPE_NATIVE_CONTENT_POSITION"|"TARGETING_TYPE_OMID"|"TARGETING_TYPE_AUDIO_CONTENT_TYPE"|"TARGETING_TYPE_CONTENT_GENRE"|"TARGETING_TYPE_YOUTUBE_VIDEO"|"TARGETING_TYPE_YOUTUBE_CHANNEL"|"TARGETING_TYPE_SESSION_POSITION"}
  --deleteRequests: list # The assigned targeting options to delete in batch, specified as a list of DeleteAssignedTargetingOptionsRequest. Supported targeting types include: * `TARGETING_TYPE_AGE_RANGE` * `TARGETING_TYPE_APP` * `TARGETING_TYPE_APP_CATEGORY` * `TARGETING_TYPE_AUDIENCE_GROUP` * `TARGETING_TYPE_AUDIO_CONTENT_TYPE` * `TARGETING_TYPE_AUTHORIZED_SELLER_STATUS` * `TARGETING_TYPE_BROWSER` * `TARGETING_TYPE_BUSINESS_CHAIN` * `TARGETING_TYPE_CARRIER_AND_ISP` * `TARGETING_TYPE_CATEGORY` * `TARGETING_TYPE_CHANNEL` * `TARGETING_TYPE_CONTENT_DURATION` * `TARGETING_TYPE_CONTENT_GENRE` * `TARGETING_TYPE_CONTENT_INSTREAM_POSITION` * `TARGETING_TYPE_CONTENT_OUTSTREAM_POSITION` * `TARGETING_TYPE_CONTENT_STREAM_TYPE` * `TARGETING_TYPE_DAY_AND_TIME` * `TARGETING_TYPE_DEVICE_MAKE_MODEL` * `TARGETING_TYPE_DEVICE_TYPE` * `TARGETING_TYPE_DIGITAL_CONTENT_LABEL_EXCLUSION` * `TARGETING_TYPE_ENVIRONMENT` * `TARGETING_TYPE_EXCHANGE` * `TARGETING_TYPE_GENDER` * `TARGETING_TYPE_GEO_REGION` * `TARGETING_TYPE_HOUSEHOLD_INCOME` * `TARGETING_TYPE_INVENTORY_SOURCE` * `TARGETING_TYPE_INVENTORY_SOURCE_GROUP` * `TARGETING_TYPE_KEYWORD` * `TARGETING_TYPE_LANGUAGE` * `TARGETING_TYPE_NATIVE_CONTENT_POSITION` * `TARGETING_TYPE_NEGATIVE_KEYWORD_LIST` * `TARGETING_TYPE_OMID` * `TARGETING_TYPE_ON_SCREEN_POSITION` * `TARGETING_TYPE_OPERATING_SYSTEM` * `TARGETING_TYPE_PARENTAL_STATUS` * `TARGETING_TYPE_POI` * `TARGETING_TYPE_PROXIMITY_LOCATION_LIST` * `TARGETING_TYPE_REGIONAL_LOCATION_LIST` * `TARGETING_TYPE_SENSITIVE_CATEGORY_EXCLUSION` * `TARGETING_TYPE_SUB_EXCHANGE` * `TARGETING_TYPE_THIRD_PARTY_VERIFIER` * `TARGETING_TYPE_URL` * `TARGETING_TYPE_USER_REWARDED_CONTENT` * `TARGETING_TYPE_VIDEO_PLAYER_SIZE` * `TARGETING_TYPE_VIEWABILITY` — item shape: {assignedTargetingOptionIds?: list, targetingType?: "TARGETING_TYPE_UNSPECIFIED"|"TARGETING_TYPE_CHANNEL"|"TARGETING_TYPE_APP_CATEGORY"|"TARGETING_TYPE_APP"|"TARGETING_TYPE_URL"|"TARGETING_TYPE_DAY_AND_TIME"|"TARGETING_TYPE_AGE_RANGE"|"TARGETING_TYPE_REGIONAL_LOCATION_LIST"|"TARGETING_TYPE_PROXIMITY_LOCATION_LIST"|"TARGETING_TYPE_GENDER"|"TARGETING_TYPE_VIDEO_PLAYER_SIZE"|"TARGETING_TYPE_USER_REWARDED_CONTENT"|"TARGETING_TYPE_PARENTAL_STATUS"|"TARGETING_TYPE_CONTENT_INSTREAM_POSITION"|"TARGETING_TYPE_CONTENT_OUTSTREAM_POSITION"|"TARGETING_TYPE_DEVICE_TYPE"|"TARGETING_TYPE_AUDIENCE_GROUP"|"TARGETING_TYPE_BROWSER"|"TARGETING_TYPE_HOUSEHOLD_INCOME"|"TARGETING_TYPE_ON_SCREEN_POSITION"|"TARGETING_TYPE_THIRD_PARTY_VERIFIER"|"TARGETING_TYPE_DIGITAL_CONTENT_LABEL_EXCLUSION"|"TARGETING_TYPE_SENSITIVE_CATEGORY_EXCLUSION"|"TARGETING_TYPE_ENVIRONMENT"|"TARGETING_TYPE_CARRIER_AND_ISP"|"TARGETING_TYPE_OPERATING_SYSTEM"|"TARGETING_TYPE_DEVICE_MAKE_MODEL"|"TARGETING_TYPE_KEYWORD"|"TARGETING_TYPE_NEGATIVE_KEYWORD_LIST"|"TARGETING_TYPE_VIEWABILITY"|"TARGETING_TYPE_CATEGORY"|"TARGETING_TYPE_INVENTORY_SOURCE"|"TARGETING_TYPE_LANGUAGE"|"TARGETING_TYPE_AUTHORIZED_SELLER_STATUS"|"TARGETING_TYPE_GEO_REGION"|"TARGETING_TYPE_INVENTORY_SOURCE_GROUP"|"TARGETING_TYPE_EXCHANGE"|"TARGETING_TYPE_SUB_EXCHANGE"|"TARGETING_TYPE_POI"|"TARGETING_TYPE_BUSINESS_CHAIN"|"TARGETING_TYPE_CONTENT_DURATION"|"TARGETING_TYPE_CONTENT_STREAM_TYPE"|"TARGETING_TYPE_NATIVE_CONTENT_POSITION"|"TARGETING_TYPE_OMID"|"TARGETING_TYPE_AUDIO_CONTENT_TYPE"|"TARGETING_TYPE_CONTENT_GENRE"|"TARGETING_TYPE_YOUTUBE_VIDEO"|"TARGETING_TYPE_YOUTUBE_CHANNEL"|"TARGETING_TYPE_SESSION_POSITION"}
  --lineItemIds: list # Required. The ID of the line items whose targeting is being updated.
  ...
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $qp_fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v2/advertisers/($advertiserId)/lineItems:bulkEditAssignedTargetingOptions" $qp)
  let body = {createRequests: $createRequests, deleteRequests: $deleteRequests, lineItemIds: $lineItemIds} | compact
  let body = if ($input | describe | str starts-with "record") { $input | merge deep ($body | default {}) } else { $body }
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "post" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json" $body
...
export def "advertisers-line-items-bulk-list-assigned-targeting-options displayvideoadvertiserslineItemsbulkListAssignedTargetingOptions" [
  advertiserId: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  ...
  --uploadType: string # Legacy upload protocol for media (e.g. "media", "multipart").
  --filter: string # Allows filtering by assigned targeting option properties. Supported syntax: * Filter expressions are made up of one or more restrictions. * Restrictions can be combined by the logical operator `OR` on the same field. * A restriction has the form of `{field} {operator} {value}`. * The operator must be `EQUALS (=)`. * Supported fields: - `targetingType` - `inheritance` Examples: * AssignedTargetingOptions of targeting type TARGETING_TYPE_PROXIMITY_LOCATION_LIST or TARGETING_TYPE_CHANNEL `targetingType="TARGETING_TYPE_PROXIMITY_LOCATION_LIST" OR targetingType="TARGETING_TYPE_CHANNEL"` * AssignedTargetingOptions with inheritance status of NOT_INHERITED or INHERITED_FROM_PARTNER `inheritance="NOT_INHERITED" OR inheritance="INHERITED_FROM_PARTNER"` The length of this field should be no more than 500 characters.
  --lineItemIds: list # Required. The IDs of the line items to list assigned targeting options for.
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $qp_fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar") (serialize-qp "filter" $filter "scalar") (serialize-qp "lineItemIds" $lineItemIds "multi") (serialize-qp "orderBy" $orderBy "scalar") (serialize-qp "pageSize" $pageSize "scalar") (serialize-qp "pageToken" $pageToken "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v2/advertisers/($advertiserId)/lineItems:bulkListAssignedTargetingOptions" $qp)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "get" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json"
}
...
export def "advertisers-line-items-bulk-update displayvideoadvertiserslineItemsbulkUpdate" [
  ...
  --upload-protocol: string # Upload protocol for media (e.g. "raw", "multipart").
  --uploadType: string # Legacy upload protocol for media (e.g. "media", "multipart").
  --lineItemIds: list # Required. IDs of line items to update.
  --targetLineItem: record # A single line item. — shape: {bidStrategy?: record, budget?: record, conversionCounting?: record, creativeIds?: list, displayName?: string, entityStatus?: "ENTITY_STATUS_UNSPECIFIED"|"ENTITY_STATUS_ACTIVE"|"ENTITY_STATUS_ARCHIVED"|"ENTITY_STATUS_DRAFT"|"ENTITY_STATUS_PAUSED"|"ENTITY_STATUS_SCHEDULED_FOR_DELETION", excludeNewExchanges?: bool, flight?: record, frequencyCap?: record, insertionOrderId?: string, integrationDetails?: record, lineItemType?: "LINE_ITEM_TYPE_UNSPECIFIED"|"LINE_ITEM_TYPE_DISPLAY_DEFAULT"|"LINE_ITEM_TYPE_DISPLAY_MOBILE_APP_INSTALL"|"LINE_ITEM_TYPE_VIDEO_DEFAULT"|"LINE_ITEM_TYPE_VIDEO_MOBILE_APP_INSTALL"|"LINE_ITEM_TYPE_DISPLAY_MOBILE_APP_INVENTORY"|"LINE_ITEM_TYPE_VIDEO_MOBILE_APP_INVENTORY"|"LINE_ITEM_TYPE_AUDIO_DEFAULT"|"LINE_ITEM_TYPE_VIDEO_OVER_THE_TOP"|"LINE_ITEM_TYPE_YOUTUBE_AND_PARTNERS_ACTION"|"LINE_ITEM_TYPE_YOUTUBE_AND_PARTNERS_NON_SKIPPABLE"|"LINE_ITEM_TYPE_YOUTUBE_AND_PARTNERS_VIDEO_SEQUENCE"|"LINE_ITEM_TYPE_YOUTUBE_AND_PARTNERS_AUDIO"|"LINE_ITEM_TYPE_YOUTUBE_AND_PARTNERS_REACH"|"LINE_ITEM_TYPE_YOUTUBE_AND_PARTNERS_SIMPLE"|"LINE_ITEM_TYPE_YOUTUBE_AND_PARTNERS_NON_SKIPPABLE_OVER_THE_TOP"|"LINE_ITEM_TYPE_YOUTUBE_AND_PARTNERS_REACH_OVER_THE_TOP"|"LINE_ITEM_TYPE_YOUTUBE_AND_PARTNERS_SIMPLE_OVER_THE_TOP"|"LINE_ITEM_TYPE_YOUTUBE_AND_PARTNERS_TARGET_FREQUENCY", mobileApp?: record, pacing?: record, partnerCosts?: list, partnerRevenueModel?: record, targetingExpansion?: record, youtubeAndPartnersSettings?: record}
  --updateMask: string # Required. A field mask identifying which fields to update. Only the following fields are currently supported: * entityStatus (format: google-fieldmask)
  ...
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $qp_fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v2/advertisers/($advertiserId)/lineItems:bulkUpdate" $qp)
  let body = {lineItemIds: $lineItemIds, targetLineItem: $targetLineItem, updateMask: $updateMask} | compact
  let body = if ($input | describe | str starts-with "record") { $input | merge deep ($body | default {}) } else { $body }
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "post" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json" $body
...
# --mobileApp shape: {appId?: string}
export def "advertisers-line-items-generate-default displayvideoadvertiserslineItemsgenerateDefault" [
  advertiserId: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  ...
  --uploadType: string # Legacy upload protocol for media (e.g. "media", "multipart").
  --displayName: string # Required. The display name of the line item. Must be UTF-8 encoded with a maximum size of 240 bytes.
  --insertionOrderId: string # Required. The unique ID of the insertion order that the line item belongs to. (format: int64)
  --lineItemType: string@lineItemType-completer # Required. The type of the line item.
  --mobileApp: record # A mobile app promoted by a mobile app install line item. — shape: {appId?: string}
]: any -> record<advertiserId: string, bidStrategy: record<fixedBid: record<bidAmountMicros: string>, maximizeSpendAutoBid: record<customBiddingAlgorithmId: string, maxAverageCpmBidAmountMicros: string, performanceGoalType: string, raiseBidForDeals: bool>, performanceGoalAutoBid: record<customBiddingAlgorithmId: string, maxAverageCpmBidAmountMicros: string, performanceGoalAmountMicros: string, performanceGoalType: string>>, budget: record<budgetAllocationType: string, budgetUnit: string, maxAmount: string>, campaignId: string, conversionCounting: record<floodlightActivityConfigs: list<record>, postViewCountPercentageMillis: string>, creativeIds: list<string>, displayName: string, entityStatus: string, excludeNewExchanges: bool, flight: record<dateRange: record<endDate: record, startDate: record>, flightDateType: string>, frequencyCap: record<maxImpressions: int, maxViews: int, timeUnit: string, timeUnitCount: int, unlimited: bool>, insertionOrderId: string, integrationDetails: record<details: string, integrationCode: string>, lineItemId: string, lineItemType: string, mobileApp: record<appId: string, displayName: string, platform: string, publisher: string>, name: string, pacing: record<dailyMaxImpressions: string, dailyMaxMicros: string, pacingPeriod: string, pacingType: string>, partnerCosts: table<costType: string, feeAmount: string, feePercentageMillis: string, feeType: string, invoiceType: string>, partnerRevenueModel: record<markupAmount: string, markupType: string>, reservationType: string, targetingExpansion: record<excludeFirstPartyAudience: bool, targetingExpansionLevel: string>, updateTime: string, warningMessages: list<string>, youtubeAndPartnersSettings: record<biddingStrategy: record<adGroupEffectiveTargetCpaSource: string, adGroupEffectiveTargetCpaValue: string, type: string, value: string>, contentCategory: string, inventorySourceSettings: record<includeYoutubeSearch: bool, includeYoutubeVideoPartners: bool, includeYoutubeVideos: bool>, leadFormId: string, linkedMerchantId: string, relatedVideoIds: list<string>, targetFrequency: record<targetCount: string, timeUnit: string, timeUnitCount: int>, thirdPartyMeasurementSettings: record<brandLiftVendorConfigs: list, brandSafetyVendorConfigs: list, reachVendorConfigs: list, viewabilityVendorConfigs: list>, videoAdSequenceSettings: record<minimumDuration: string, steps: list>, viewFrequencyCap: record<maxImpressions: int, maxViews: int, timeUnit: string, timeUnitCount: int, unlimited: bool>>> {
  let input = $in
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $qp_fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v2/advertisers/($advertiserId)/lineItems:generateDefault" $qp)
  let body = {displayName: $displayName, insertionOrderId: $insertionOrderId, lineItemType: $lineItemType, mobileApp: $mobileApp} | compact
  let body = if ($input | describe | str starts-with "record") { $input | merge deep ($body | default {}) } else { $body }
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "post" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json" $body
...
export def "advertisers-location-lists displayvideoadvertiserslocationListslist" [
  advertiserId: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  ...
  --pageSize: int # Requested page size. Must be between `1` and `200`. Defaults to `100` if not set. Returns error code `INVALID_ARGUMENT` if an invalid value is specified.
  ...
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $qp_fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar") (serialize-qp "filter" $filter "scalar") (serialize-qp "orderBy" $orderBy "scalar") (serialize-qp "pageSize" $pageSize "scalar") (serialize-qp "pageToken" $pageToken "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v2/advertisers/($advertiserId)/locationLists" $qp)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "get" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json"
}
...
export def "advertisers-location-lists displayvideoadvertiserslocationListscreate" [
  advertiserId: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  ...
  --upload-protocol: string # Upload protocol for media (e.g. "raw", "multipart").
  --uploadType: string # Legacy upload protocol for media (e.g. "media", "multipart").
  --body-advertiserId: string # Required. Immutable. The unique ID of the advertiser the location list belongs to. (format: int64)
  --displayName: string # Required. The display name of the location list. Must be UTF-8 encoded with a maximum size of 240 bytes.
  --locationType: string@locationType-completer # Required. Immutable. The type of location. All locations in the list will share this type.
  ...
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $qp_fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v2/advertisers/($advertiserId)/locationLists" $qp)
  let body = {advertiserId: $body_advertiserId, displayName: $displayName, locationType: $locationType} | compact
  let body = if ($input | describe | str starts-with "record") { $input | merge deep ($body | default {}) } else { $body }
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "post" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json" $body
...
export def "advertisers-location-lists displayvideoadvertiserslocationListspatch" [
  advertiserId: string
  ...
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $qp_fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar") (serialize-qp "updateMask" $updateMask "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v2/advertisers/($advertiserId)/locationLists/($locationListId)" $qp)
  let body = {advertiserId: $body_advertiserId, displayName: $displayName, locationType: $locationType} | compact
  let body = if ($input | describe | str starts-with "record") { $input | merge deep ($body | default {}) } else { $body }
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
...
export def "advertisers-location-lists-assigned-locations displayvideoadvertiserslocationListsassignedLocationslist" [
  advertiserId: string
  locationListId: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  ...
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $qp_fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar") (serialize-qp "filter" $filter "scalar") (serialize-qp "orderBy" $orderBy "scalar") (serialize-qp "pageSize" $pageSize "scalar") (serialize-qp "pageToken" $pageToken "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v2/advertisers/($advertiserId)/locationLists/($locationListId)/assignedLocations" $qp)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "get" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json"
}
...
export def "advertisers-location-lists-assigned-locations displayvideoadvertiserslocationListsassignedLocationscreate" [
  advertiserId: string
  locationListId: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  ...
  --upload-protocol: string # Upload protocol for media (e.g. "raw", "multipart").
  --uploadType: string # Legacy upload protocol for media (e.g. "media", "multipart").
  --targetingOptionId: string # Required. The ID of the targeting option assigned to the location list. Must be of type TARGETING_TYPE_GEO_REGION.
  ...
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $qp_fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v2/advertisers/($advertiserId)/locationLists/($locationListId)/assignedLocations" $qp)
  let body = {targetingOptionId: $targetingOptionId} | compact
  let body = if ($input | describe | str starts-with "record") { $input | merge deep ($body | default {}) } else { $body }
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "post" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json" $body
...
export def "advertisers-location-lists-assigned-locations displayvideoadvertiserslocationListsassignedLocationsdelete" [
  advertiserId: string
  locationListId: string
  ...
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $qp_fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v2/advertisers/($advertiserId)/locationLists/($locationListId)/assignedLocations/($assignedLocationId)" $qp)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "delete" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json"
}
...
export def "advertisers-location-lists-assigned-locations-bulk-edit displayvideoadvertiserslocationListsassignedLocationsbulkEdit" [
  advertiserId: string
  locationListId: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  ...
  --upload-protocol: string # Upload protocol for media (e.g. "raw", "multipart").
  --uploadType: string # Legacy upload protocol for media (e.g. "media", "multipart").
  --createdAssignedLocations: list # The assigned locations to create in bulk, specified as a list of AssignedLocations. — item shape: {targetingOptionId?: string}
  --deletedAssignedLocations: list # The IDs of the assigned locations to delete in bulk, specified as a list of assigned_location_ids.
]: any -> record<assignedLocations: table<assignedLocationId: string, name: string, targetingOptionId: string>> {
  let input = $in
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $qp_fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v2/advertisers/($advertiserId)/locationLists/($locationListId)/assignedLocations:bulkEdit" $qp)
  let body = {createdAssignedLocations: $createdAssignedLocations, deletedAssignedLocations: $deletedAssignedLocations} | compact
  let body = if ($input | describe | str starts-with "record") { $input | merge deep ($body | default {}) } else { $body }
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "post" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json" $body
...
export def "advertisers-manual-triggers displayvideoadvertisersmanualTriggerslist" [
  advertiserId: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  ...
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $qp_fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar") (serialize-qp "filter" $filter "scalar") (serialize-qp "orderBy" $orderBy "scalar") (serialize-qp "pageSize" $pageSize "scalar") (serialize-qp "pageToken" $pageToken "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v2/advertisers/($advertiserId)/manualTriggers" $qp)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "get" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json"
}
...
export def "advertisers-manual-triggers displayvideoadvertisersmanualTriggerscreate" [
  advertiserId: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  ...
  --upload-protocol: string # Upload protocol for media (e.g. "raw", "multipart").
  --uploadType: string # Legacy upload protocol for media (e.g. "media", "multipart").
  --activationDurationMinutes: string # Required. The maximum duration of each activation in minutes. Must be between 1 and 360 inclusive. After this duration, the trigger will be automatically deactivated. (format: int64)
  --body-advertiserId: string # Required. Immutable. The unique ID of the advertiser that the manual trigger belongs to. (format: int64)
  ...
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $qp_fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v2/advertisers/($advertiserId)/manualTriggers" $qp)
  let body = {activationDurationMinutes: $activationDurationMinutes, advertiserId: $body_advertiserId, displayName: $displayName} | compact
  let body = if ($input | describe | str starts-with "record") { $input | merge deep ($body | default {}) } else { $body }
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "post" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json" $body
...
export def "advertisers-manual-triggers displayvideoadvertisersmanualTriggersget" [
  advertiserId: string
  triggerId: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  ...
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $qp_fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v2/advertisers/($advertiserId)/manualTriggers/($triggerId)" $qp)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "get" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json"
}
...
export def "advertisers-manual-triggers displayvideoadvertisersmanualTriggerspatch" [
  advertiserId: string
  triggerId: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
...
export def "advertisers-manual-triggers displayvideoadvertisersmanualTriggersactivate" [
  advertiserId: string
  triggerId: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  ...
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $qp_fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v2/advertisers/($advertiserId)/manualTriggers/($triggerId):activate" $qp)
  let body = if ($input | describe | str starts-with "record") { $input | merge deep ($body | default {}) } else { $body }
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "post" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json" $body
...
export def "advertisers-manual-triggers displayvideoadvertisersmanualTriggersdeactivate" [
  advertiserId: string
  triggerId: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  ...
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $qp_fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v2/advertisers/($advertiserId)/manualTriggers/($triggerId):deactivate" $qp)
  let body = if ($input | describe | str starts-with "record") { $input | merge deep ($body | default {}) } else { $body }
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "post" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json" $body
...
export def "advertisers-negative-keyword-lists displayvideoadvertisersnegativeKeywordListslist" [
  advertiserId: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  ...
  let full_url = (build-url $base $"/v2/advertisers/($advertiserId)/negativeKeywordLists" $qp)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "get" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json"
}
...
export def "advertisers-negative-keyword-lists displayvideoadvertisersnegativeKeywordListscreate" [
  advertiserId: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
...
export def "advertisers-negative-keyword-lists displayvideoadvertisersnegativeKeywordListspatch" [
  advertiserId: string
  ...
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $qp_fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar") (serialize-qp "updateMask" $updateMask "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v2/advertisers/($advertiserId)/negativeKeywordLists/($negativeKeywordListId)" $qp)
  let body = {displayName: $displayName} | compact
  let body = if ($input | describe | str starts-with "record") { $input | merge deep ($body | default {}) } else { $body }
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
...
export def "advertisers-negative-keyword-lists-negative-keywords displayvideoadvertisersnegativeKeywordListsnegativeKeywordslist" [
  advertiserId: string
  negativeKeywordListId: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  ...
  --pageSize: int # Requested page size. Must be between `1` and `1000`. If unspecified will default to `100`. Returns error code `INVALID_ARGUMENT` if an invalid value is specified.
  ...
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $qp_fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar") (serialize-qp "filter" $filter "scalar") (serialize-qp "orderBy" $orderBy "scalar") (serialize-qp "pageSize" $pageSize "scalar") (serialize-qp "pageToken" $pageToken "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v2/advertisers/($advertiserId)/negativeKeywordLists/($negativeKeywordListId)/negativeKeywords" $qp)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "get" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json"
}
...
export def "advertisers-negative-keyword-lists-negative-keywords displayvideoadvertisersnegativeKeywordListsnegativeKeywordsdelete" [
  advertiserId: string
  negativeKeywordListId: string
  keywordValue: string
  --base-url(-b): string@base-url-completer # API base URL
  ...
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $qp_fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v2/advertisers/($advertiserId)/negativeKeywordLists/($negativeKeywordListId)/negativeKeywords/($keywordValue)" $qp)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "delete" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json"
}
...
export def "advertisers-negative-keyword-lists-negative-keywords-bulk-edit displayvideoadvertisersnegativeKeywordListsnegativeKeywordsbulkEdit" [
  advertiserId: string
  negativeKeywordListId: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  ...
  --upload-protocol: string # Upload protocol for media (e.g. "raw", "multipart").
  --uploadType: string # Legacy upload protocol for media (e.g. "media", "multipart").
  --createdNegativeKeywords: list # The negative keywords to create in batch, specified as a list of NegativeKeywords. — item shape: {keywordValue?: string}
  --deletedNegativeKeywords: list # The negative keywords to delete in batch, specified as a list of keyword_values.
]: any -> record<negativeKeywords: table<keywordValue: string, name: string>> {
  let input = $in
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $qp_fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v2/advertisers/($advertiserId)/negativeKeywordLists/($negativeKeywordListId)/negativeKeywords:bulkEdit" $qp)
  let body = {createdNegativeKeywords: $createdNegativeKeywords, deletedNegativeKeywords: $deletedNegativeKeywords} | compact
  let body = if ($input | describe | str starts-with "record") { $input | merge deep ($body | default {}) } else { $body }
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "post" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json" $body
...
export def "advertisers-negative-keyword-lists-negative-keywords-replace displayvideoadvertisersnegativeKeywordListsnegativeKeywordsreplace" [
  advertiserId: string
  negativeKeywordListId: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  ...
  --upload-protocol: string # Upload protocol for media (e.g. "raw", "multipart").
  --uploadType: string # Legacy upload protocol for media (e.g. "media", "multipart").
  --newNegativeKeywords: list # The negative keywords that will replace the existing keywords in the negative keyword list, specified as a list of NegativeKeywords. — item shape: {keywordValue?: string}
]: any -> record<negativeKeywords: table<keywordValue: string, name: string>> {
  let input = $in
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $qp_fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v2/advertisers/($advertiserId)/negativeKeywordLists/($negativeKeywordListId)/negativeKeywords:replace" $qp)
  let body = {newNegativeKeywords: $newNegativeKeywords} | compact
  let body = if ($input | describe | str starts-with "record") { $input | merge deep ($body | default {}) } else { $body }
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "post" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json" $body
...
export def "advertisers-targeting-types-assigned-targeting-options displayvideoadvertiserstargetingTypesassignedTargetingOptionslist" [
  advertiserId: string
  targetingType: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  ...
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $qp_fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar") (serialize-qp "filter" $filter "scalar") (serialize-qp "orderBy" $orderBy "scalar") (serialize-qp "pageSize" $pageSize "scalar") (serialize-qp "pageToken" $pageToken "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v2/advertisers/($advertiserId)/targetingTypes/($targetingType)/assignedTargetingOptions" $qp)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "get" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json"
}
...
# --youtubeChannelDetails shape: {channelId?: string, negative?: bool}
# --youtubeVideoDetails shape: {negative?: bool, videoId?: string}
export def "advertisers-targeting-types-assigned-targeting-options displayvideoadvertiserstargetingTypesassignedTargetingOptionscreate" [
  advertiserId: string
  targetingType: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
...
export def "advertisers-targeting-types-assigned-targeting-options displayvideoadvertiserstargetingTypesassignedTargetingOptionsdelete" [
  advertiserId: string
  targetingType: string
  assignedTargetingOptionId: string
  --base-url(-b): string@base-url-completer # API base URL
  ...
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $qp_fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v2/advertisers/($advertiserId)/targetingTypes/($targetingType)/assignedTargetingOptions/($assignedTargetingOptionId)" $qp)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "delete" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json"
}
...
export def "advertisers-targeting-types-assigned-targeting-options displayvideoadvertiserstargetingTypesassignedTargetingOptionsget" [
  advertiserId: string
  targetingType: string
  assignedTargetingOptionId: string
  --base-url(-b): string@base-url-completer # API base URL
...
export def "advertisers-youtube-ad-group-ads displayvideoadvertisersyoutubeAdGroupAdslist" [
  advertiserId: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  ...
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $qp_fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar") (serialize-qp "filter" $filter "scalar") (serialize-qp "orderBy" $orderBy "scalar") (serialize-qp "pageSize" $pageSize "scalar") (serialize-qp "pageToken" $pageToken "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v2/advertisers/($advertiserId)/youtubeAdGroupAds" $qp)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "get" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json"
}
...
export def "advertisers-youtube-ad-group-ads displayvideoadvertisersyoutubeAdGroupAdsget" [
  advertiserId: string
  ...
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $qp_fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v2/advertisers/($advertiserId)/youtubeAdGroupAds/($youtubeAdGroupAdId)" $qp)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "get" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json"
}
...
export def "advertisers-youtube-ad-groups displayvideoadvertisersyoutubeAdGroupslist" [
  advertiserId: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  ...
  --orderBy: string # Field by which to sort the list. Acceptable values are: * `displayName` (default) * `entityStatus` The default sorting order is ascending. To specify descending order for a field, a suffix "desc" should be added to the field name. Example: `displayName desc`.
  --pageSize: int # Requested page size. Must be between `1` and `200`. If unspecified will default to `100`. Returns error code `INVALID_ARGUMENT` if an invalid value is specified.
  --pageToken: string # A token identifying a page of results the server should return. Typically, this is the value of next_page_token returned from the previous call to `ListYoutubeAdGroups` method. If not specified, the first page of results will be returned.
  ...
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $qp_fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar") (serialize-qp "filter" $filter "scalar") (serialize-qp "orderBy" $orderBy "scalar") (serialize-qp "pageSize" $pageSize "scalar") (serialize-qp "pageToken" $pageToken "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v2/advertisers/($advertiserId)/youtubeAdGroups" $qp)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "get" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json"
}
...
export def "advertisers-youtube-ad-groups displayvideoadvertisersyoutubeAdGroupsget" [
  advertiserId: string
  ...
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $qp_fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v2/advertisers/($advertiserId)/youtubeAdGroups/($youtubeAdGroupId)" $qp)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "get" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json"
}
...
export def "advertisers-youtube-ad-groups-targeting-types-assigned-targeting-options displayvideoadvertisersyoutubeAdGroupstargetingTypesassignedTargetingOptionslist" [
  advertiserId: string
  youtubeAdGroupId: string
  targetingType: string
  --base-url(-b): string@base-url-completer # API base URL
  ...
  --orderBy: string # Field by which to sort the list. Acceptable values are: * `assignedTargetingOptionId` (default) The default sorting order is ascending. To specify descending order for a field, a suffix "desc" should be added to the field name. Example: `assignedTargetingOptionId desc`.
  --pageSize: int # Requested page size. Must be between `1` and `5000`. If unspecified will default to `100`. Returns error code `INVALID_ARGUMENT` if an invalid value is specified.
  --pageToken: string # A token identifying a page of results the server should return. Typically, this is the value of next_page_token returned from the previous call to `ListYoutubeAdGroupAssignedTargetingOptions` method. If not specified, the first page of results will be returned.
]: nothing -> record<assignedTargetingOptions: table<ageRangeDetails: record, appCategoryDetails: record, appDetails: record, assignedTargetingOptionId: string, assignedTargetingOptionIdAlias: string, audienceGroupDetails: record, audioContentTypeDetails: record, authorizedSellerStatusDetails: record, browserDetails: record, businessChainDetails: record, carrierAndIspDetails: record, categoryDetails: record, channelDetails: record, contentDurationDetails: record, contentGenreDetails: record, contentInstreamPositionDetails: record, contentOutstreamPositionDetails: record, contentStreamTypeDetails: record, dayAndTimeDetails: record, deviceMakeModelDetails: record, deviceTypeDetails: record, digitalContentLabelExclusionDetails: record, environmentDetails: record, exchangeDetails: record, genderDetails: record, geoRegionDetails: record, householdIncomeDetails: record, inheritance: string, inventorySourceDetails: record, inventorySourceGroupDetails: record, keywordDetails: record, languageDetails: record, name: string, nativeContentPositionDetails: record, negativeKeywordListDetails: record, omidDetails: record, onScreenPositionDetails: record, operatingSystemDetails: record, parentalStatusDetails: record, poiDetails: record, proximityLocationListDetails: record, regionalLocationListDetails: record, sensitiveCategoryExclusionDetails: record, sessionPositionDetails: record, subExchangeDetails: record, targetingType: string, thirdPartyVerifierDetails: record, urlDetails: record, userRewardedContentDetails: record, videoPlayerSizeDetails: record, viewabilityDetails: record, youtubeChannelDetails: record, youtubeVideoDetails: record>, nextPageToken: string> {
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $qp_fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar") (serialize-qp "filter" $filter "scalar") (serialize-qp "orderBy" $orderBy "scalar") (serialize-qp "pageSize" $pageSize "scalar") (serialize-qp "pageToken" $pageToken "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v2/advertisers/($advertiserId)/youtubeAdGroups/($youtubeAdGroupId)/targetingTypes/($targetingType)/assignedTargetingOptions" $qp)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "get" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json"
}
...
export def "advertisers-youtube-ad-groups-targeting-types-assigned-targeting-options displayvideoadvertisersyoutubeAdGroupstargetingTypesassignedTargetingOptionsget" [
  advertiserId: string
  youtubeAdGroupId: string
  targetingType: string
  assignedTargetingOptionId: string
  ...
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $qp_fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v2/advertisers/($advertiserId)/youtubeAdGroups/($youtubeAdGroupId)/targetingTypes/($targetingType)/assignedTargetingOptions/($assignedTargetingOptionId)" $qp)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "get" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json"
}
...
export def "advertisers-youtube-ad-groups-bulk-list-ad-group-assigned-targeting-options displayvideoadvertisersyoutubeAdGroupsbulkListAdGroupAssignedTargetingOptions" [
  advertiserId: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  ...
  --orderBy: string # Field by which to sort the list. Acceptable values are: * `youtubeAdGroupId` (default) * `assignedTargetingOption.targetingType` The default sorting order is ascending. To specify descending order for a field, a suffix "desc" should be added to the field name. Example: `targetingType desc`.
  --pageSize: int # Requested page size. The size must be an integer between `1` and `5000`. If unspecified, the default is `5000`. Returns error code `INVALID_ARGUMENT` if an invalid value is specified.
  --pageToken: string # A token that lets the client fetch the next page of results. Typically, this is the value of next_page_token returned from the previous call to the `BulkListAdGroupAssignedTargetingOptions` method. If not specified, the first page of results will be returned.
  --youtubeAdGroupIds: list # Required. The IDs of the youtube ad groups to list assigned targeting options for.
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $qp_fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar") (serialize-qp "filter" $filter "scalar") (serialize-qp "orderBy" $orderBy "scalar") (serialize-qp "pageSize" $pageSize "scalar") (serialize-qp "pageToken" $pageToken "scalar") (serialize-qp "youtubeAdGroupIds" $youtubeAdGroupIds "multi")] | flatten | str join "&"
  let full_url = (build-url $base $"/v2/advertisers/($advertiserId)/youtubeAdGroups:bulkListAdGroupAssignedTargetingOptions" $qp)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "get" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json"
}
...
export def "advertisers displayvideoadvertisersaudit" [
  advertiserId: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  ...
  let full_url = (build-url $base $"/v2/advertisers/($advertiserId):audit" $qp)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "get" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json"
}
...
# --createRequests item shape: {assignedTargetingOptions?: list, targetingType?: "TARGETING_TYPE_UNSPECIFIED"|"TARGETING_TYPE_CHANNEL"|"TARGETING_TYPE_APP_CATEGORY"|"TARGETING_TYPE_APP"|"TARGETING_TYPE_URL"|"TARGETING_TYPE_DAY_AND_TIME"|"TARGETING_TYPE_AGE_RANGE"|"TARGETING_TYPE_REGIONAL_LOCATION_LIST"|"TARGETING_TYPE_PROXIMITY_LOCATION_LIST"|"TARGETING_TYPE_GENDER"|"TARGETING_TYPE_VIDEO_PLAYER_SIZE"|"TARGETING_TYPE_USER_REWARDED_CONTENT"|"TARGETING_TYPE_PARENTAL_STATUS"|"TARGETING_TYPE_CONTENT_INSTREAM_POSITION"|"TARGETING_TYPE_CONTENT_OUTSTREAM_POSITION"|"TARGETING_TYPE_DEVICE_TYPE"|"TARGETING_TYPE_AUDIENCE_GROUP"|"TARGETING_TYPE_BROWSER"|"TARGETING_TYPE_HOUSEHOLD_INCOME"|"TARGETING_TYPE_ON_SCREEN_POSITION"|"TARGETING_TYPE_THIRD_PARTY_VERIFIER"|"TARGETING_TYPE_DIGITAL_CONTENT_LABEL_EXCLUSION"|"TARGETING_TYPE_SENSITIVE_CATEGORY_EXCLUSION"|"TARGETING_TYPE_ENVIRONMENT"|"TARGETING_TYPE_CARRIER_AND_ISP"|"TARGETING_TYPE_OPERATING_SYSTEM"|"TARGETING_TYPE_DEVICE_MAKE_MODEL"|"TARGETING_TYPE_KEYWORD"|"TARGETING_TYPE_NEGATIVE_KEYWORD_LIST"|"TARGETING_TYPE_VIEWABILITY"|"TARGETING_TYPE_CATEGORY"|"TARGETING_TYPE_INVENTORY_SOURCE"|"TARGETING_TYPE_LANGUAGE"|"TARGETING_TYPE_AUTHORIZED_SELLER_STATUS"|"TARGETING_TYPE_GEO_REGION"|"TARGETING_TYPE_INVENTORY_SOURCE_GROUP"|"TARGETING_TYPE_EXCHANGE"|"TARGETING_TYPE_SUB_EXCHANGE"|"TARGETING_TYPE_POI"|"TARGETING_TYPE_BUSINESS_CHAIN"|"TARGETING_TYPE_CONTENT_DURATION"|"TARGETING_TYPE_CONTENT_STREAM_TYPE"|"TARGETING_TYPE_NATIVE_CONTENT_POSITION"|"TARGETING_TYPE_OMID"|"TARGETING_TYPE_AUDIO_CONTENT_TYPE"|"TARGETING_TYPE_CONTENT_GENRE"|"TARGETING_TYPE_YOUTUBE_VIDEO"|"TARGETING_TYPE_YOUTUBE_CHANNEL"|"TARGETING_TYPE_SESSION_POSITION"}
# --deleteRequests item shape: {assignedTargetingOptionIds?: list, targetingType?: "TARGETING_TYPE_UNSPECIFIED"|"TARGETING_TYPE_CHANNEL"|"TARGETING_TYPE_APP_CATEGORY"|"TARGETING_TYPE_APP"|"TARGETING_TYPE_URL"|"TARGETING_TYPE_DAY_AND_TIME"|"TARGETING_TYPE_AGE_RANGE"|"TARGETING_TYPE_REGIONAL_LOCATION_LIST"|"TARGETING_TYPE_PROXIMITY_LOCATION_LIST"|"TARGETING_TYPE_GENDER"|"TARGETING_TYPE_VIDEO_PLAYER_SIZE"|"TARGETING_TYPE_USER_REWARDED_CONTENT"|"TARGETING_TYPE_PARENTAL_STATUS"|"TARGETING_TYPE_CONTENT_INSTREAM_POSITION"|"TARGETING_TYPE_CONTENT_OUTSTREAM_POSITION"|"TARGETING_TYPE_DEVICE_TYPE"|"TARGETING_TYPE_AUDIENCE_GROUP"|"TARGETING_TYPE_BROWSER"|"TARGETING_TYPE_HOUSEHOLD_INCOME"|"TARGETING_TYPE_ON_SCREEN_POSITION"|"TARGETING_TYPE_THIRD_PARTY_VERIFIER"|"TARGETING_TYPE_DIGITAL_CONTENT_LABEL_EXCLUSION"|"TARGETING_TYPE_SENSITIVE_CATEGORY_EXCLUSION"|"TARGETING_TYPE_ENVIRONMENT"|"TARGETING_TYPE_CARRIER_AND_ISP"|"TARGETING_TYPE_OPERATING_SYSTEM"|"TARGETING_TYPE_DEVICE_MAKE_MODEL"|"TARGETING_TYPE_KEYWORD"|"TARGETING_TYPE_NEGATIVE_KEYWORD_LIST"|"TARGETING_TYPE_VIEWABILITY"|"TARGETING_TYPE_CATEGORY"|"TARGETING_TYPE_INVENTORY_SOURCE"|"TARGETING_TYPE_LANGUAGE"|"TARGETING_TYPE_AUTHORIZED_SELLER_STATUS"|"TARGETING_TYPE_GEO_REGION"|"TARGETING_TYPE_INVENTORY_SOURCE_GROUP"|"TARGETING_TYPE_EXCHANGE"|"TARGETING_TYPE_SUB_EXCHANGE"|"TARGETING_TYPE_POI"|"TARGETING_TYPE_BUSINESS_CHAIN"|"TARGETING_TYPE_CONTENT_DURATION"|"TARGETING_TYPE_CONTENT_STREAM_TYPE"|"TARGETING_TYPE_NATIVE_CONTENT_POSITION"|"TARGETING_TYPE_OMID"|"TARGETING_TYPE_AUDIO_CONTENT_TYPE"|"TARGETING_TYPE_CONTENT_GENRE"|"TARGETING_TYPE_YOUTUBE_VIDEO"|"TARGETING_TYPE_YOUTUBE_CHANNEL"|"TARGETING_TYPE_SESSION_POSITION"}
export def "advertisers displayvideoadvertiserseditAssignedTargetingOptions" [
  advertiserId: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  ...
  --upload-protocol: string # Upload protocol for media (e.g. "raw", "multipart").
  --uploadType: string # Legacy upload protocol for media (e.g. "media", "multipart").
  --createRequests: list # The assigned targeting options to create in batch, specified as a list of `CreateAssignedTargetingOptionsRequest`. Supported targeting types: * `TARGETING_TYPE_CHANNEL` * `TARGETING_TYPE_DIGITAL_CONTENT_LABEL_EXCLUSION` * `TARGETING_TYPE_OMID` * `TARGETING_TYPE_SENSITIVE_CATEGORY_EXCLUSION` — item shape: {assignedTargetingOptions?: list, targetingType?: "TARGETING_TYPE_UNSPECIFIED"|"TARGETING_TYPE_CHANNEL"|"TARGETING_TYPE_APP_CATEGORY"|"TARGETING_TYPE_APP"|"TARGETING_TYPE_URL"|"TARGETING_TYPE_DAY_AND_TIME"|"TARGETING_TYPE_AGE_RANGE"|"TARGETING_TYPE_REGIONAL_LOCATION_LIST"|"TARGETING_TYPE_PROXIMITY_LOCATION_LIST"|"TARGETING_TYPE_GENDER"|"TARGETING_TYPE_VIDEO_PLAYER_SIZE"|"TARGETING_TYPE_USER_REWARDED_CONTENT"|"TARGETING_TYPE_PARENTAL_STATUS"|"TARGETING_TYPE_CONTENT_INSTREAM_POSITION"|"TARGETING_TYPE_CONTENT_OUTSTREAM_POSITION"|"TARGETING_TYPE_DEVICE_TYPE"|"TARGETING_TYPE_AUDIENCE_GROUP"|"TARGETING_TYPE_BROWSER"|"TARGETING_TYPE_HOUSEHOLD_INCOME"|"TARGETING_TYPE_ON_SCREEN_POSITION"|"TARGETING_TYPE_THIRD_PARTY_VERIFIER"|"TARGETING_TYPE_DIGITAL_CONTENT_LABEL_EXCLUSION"|"TARGETING_TYPE_SENSITIVE_CATEGORY_EXCLUSION"|"TARGETING_TYPE_ENVIRONMENT"|"TARGETING_TYPE_CARRIER_AND_ISP"|"TARGETING_TYPE_OPERATING_SYSTEM"|"TARGETING_TYPE_DEVICE_MAKE_MODEL"|"TARGETING_TYPE_KEYWORD"|"TARGETING_TYPE_NEGATIVE_KEYWORD_LIST"|"TARGETING_TYPE_VIEWABILITY"|"TARGETING_TYPE_CATEGORY"|"TARGETING_TYPE_INVENTORY_SOURCE"|"TARGETING_TYPE_LANGUAGE"|"TARGETING_TYPE_AUTHORIZED_SELLER_STATUS"|"TARGETING_TYPE_GEO_REGION"|"TARGETING_TYPE_INVENTORY_SOURCE_GROUP"|"TARGETING_TYPE_EXCHANGE"|"TARGETING_TYPE_SUB_EXCHANGE"|"TARGETING_TYPE_POI"|"TARGETING_TYPE_BUSINESS_CHAIN"|"TARGETING_TYPE_CONTENT_DURATION"|"TARGETING_TYPE_CONTENT_STREAM_TYPE"|"TARGETING_TYPE_NATIVE_CONTENT_POSITION"|"TARGETING_TYPE_OMID"|"TARGETING_TYPE_AUDIO_CONTENT_TYPE"|"TARGETING_TYPE_CONTENT_GENRE"|"TARGETING_TYPE_YOUTUBE_VIDEO"|"TARGETING_TYPE_YOUTUBE_CHANNEL"|"TARGETING_TYPE_SESSION_POSITION"}
  --deleteRequests: list # The assigned targeting options to delete in batch, specified as a list of `DeleteAssignedTargetingOptionsRequest`. Supported targeting types: * `TARGETING_TYPE_CHANNEL` * `TARGETING_TYPE_DIGITAL_CONTENT_LABEL_EXCLUSION` * `TARGETING_TYPE_OMID` * `TARGETING_TYPE_SENSITIVE_CATEGORY_EXCLUSION` — item shape: {assignedTargetingOptionIds?: list, targetingType?: "TARGETING_TYPE_UNSPECIFIED"|"TARGETING_TYPE_CHANNEL"|"TARGETING_TYPE_APP_CATEGORY"|"TARGETING_TYPE_APP"|"TARGETING_TYPE_URL"|"TARGETING_TYPE_DAY_AND_TIME"|"TARGETING_TYPE_AGE_RANGE"|"TARGETING_TYPE_REGIONAL_LOCATION_LIST"|"TARGETING_TYPE_PROXIMITY_LOCATION_LIST"|"TARGETING_TYPE_GENDER"|"TARGETING_TYPE_VIDEO_PLAYER_SIZE"|"TARGETING_TYPE_USER_REWARDED_CONTENT"|"TARGETING_TYPE_PARENTAL_STATUS"|"TARGETING_TYPE_CONTENT_INSTREAM_POSITION"|"TARGETING_TYPE_CONTENT_OUTSTREAM_POSITION"|"TARGETING_TYPE_DEVICE_TYPE"|"TARGETING_TYPE_AUDIENCE_GROUP"|"TARGETING_TYPE_BROWSER"|"TARGETING_TYPE_HOUSEHOLD_INCOME"|"TARGETING_TYPE_ON_SCREEN_POSITION"|"TARGETING_TYPE_THIRD_PARTY_VERIFIER"|"TARGETING_TYPE_DIGITAL_CONTENT_LABEL_EXCLUSION"|"TARGETING_TYPE_SENSITIVE_CATEGORY_EXCLUSION"|"TARGETING_TYPE_ENVIRONMENT"|"TARGETING_TYPE_CARRIER_AND_ISP"|"TARGETING_TYPE_OPERATING_SYSTEM"|"TARGETING_TYPE_DEVICE_MAKE_MODEL"|"TARGETING_TYPE_KEYWORD"|"TARGETING_TYPE_NEGATIVE_KEYWORD_LIST"|"TARGETING_TYPE_VIEWABILITY"|"TARGETING_TYPE_CATEGORY"|"TARGETING_TYPE_INVENTORY_SOURCE"|"TARGETING_TYPE_LANGUAGE"|"TARGETING_TYPE_AUTHORIZED_SELLER_STATUS"|"TARGETING_TYPE_GEO_REGION"|"TARGETING_TYPE_INVENTORY_SOURCE_GROUP"|"TARGETING_TYPE_EXCHANGE"|"TARGETING_TYPE_SUB_EXCHANGE"|"TARGETING_TYPE_POI"|"TARGETING_TYPE_BUSINESS_CHAIN"|"TARGETING_TYPE_CONTENT_DURATION"|"TARGETING_TYPE_CONTENT_STREAM_TYPE"|"TARGETING_TYPE_NATIVE_CONTENT_POSITION"|"TARGETING_TYPE_OMID"|"TARGETING_TYPE_AUDIO_CONTENT_TYPE"|"TARGETING_TYPE_CONTENT_GENRE"|"TARGETING_TYPE_YOUTUBE_VIDEO"|"TARGETING_TYPE_YOUTUBE_CHANNEL"|"TARGETING_TYPE_SESSION_POSITION"}
  ...
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $qp_fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v2/advertisers/($advertiserId):editAssignedTargetingOptions" $qp)
  let body = {createRequests: $createRequests, deleteRequests: $deleteRequests} | compact
  let body = if ($input | describe | str starts-with "record") { $input | merge deep ($body | default {}) } else { $body }
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "post" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json" $body
...
export def "advertisers displayvideoadvertiserslistAssignedTargetingOptions" [
  advertiserId: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  ...
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $qp_fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar") (serialize-qp "filter" $filter "scalar") (serialize-qp "orderBy" $orderBy "scalar") (serialize-qp "pageSize" $pageSize "scalar") (serialize-qp "pageToken" $pageToken "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v2/advertisers/($advertiserId):listAssignedTargetingOptions" $qp)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "get" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json"
}
...
export def "combined-audiences displayvideocombinedAudienceslist" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $qp_fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar") (serialize-qp "advertiserId" $advertiserId "scalar") (serialize-qp "filter" $filter "scalar") (serialize-qp "orderBy" $orderBy "scalar") (serialize-qp "pageSize" $pageSize "scalar") (serialize-qp "pageToken" $pageToken "scalar") (serialize-qp "partnerId" $partnerId "scalar")] | flatten | str join "&"
...
export def "combined-audiences displayvideocombinedAudiencesget" [
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $qp_fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar") (serialize-qp "advertiserId" $advertiserId "scalar") (serialize-qp "partnerId" $partnerId "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v2/combinedAudiences/($combinedAudienceId)" $qp)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "get" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json"
}
...
export def "custom-bidding-algorithms displayvideocustomBiddingAlgorithmslist" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
...
export def "custom-bidding-algorithms displayvideocustomBiddingAlgorithmscreate" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
  ...
  --upload-protocol: string # Upload protocol for media (e.g. "raw", "multipart").
  --uploadType: string # Legacy upload protocol for media (e.g. "media", "multipart").
  --advertiserId: string # Immutable. The unique ID of the advertiser that owns the custom bidding algorithm. (format: int64)
  --customBiddingAlgorithmType: string@customBiddingAlgorithmType-completer # Required. Immutable. The type of custom bidding algorithm.
  ...
  --entityStatus: string@entityStatus-completer # Controls whether or not the custom bidding algorithm can be used as a bidding strategy. Accepted values are: * `ENTITY_STATUS_ACTIVE` * `ENTITY_STATUS_ARCHIVED`
  --partnerId: string # Immutable. The unique ID of the partner that owns the custom bidding algorithm. (format: int64)
  --sharedAdvertiserIds: list # The IDs of the advertisers who have access to this algorithm. If advertiser_id is set, this field will only consist of that value. This field will not be set if the algorithm [`owner`](/display-video/api/reference/rest/v1/customBiddingAlgorithms#CustomBiddingAlgorithm.FIELDS.oneof_owner) is a partner and is being retrieved using an advertiser [`accessor`](/display-video/api/reference/rest/v1/customBiddingAlgorithms/list#body.QUERY_PARAMETERS.oneof_accessor).
  ...
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $qp_fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar")] | flatten | str join "&"
  let full_url = (build-url $base "/v2/customBiddingAlgorithms" $qp)
  let body = {advertiserId: $advertiserId, customBiddingAlgorithmType: $customBiddingAlgorithmType, displayName: $displayName, entityStatus: $entityStatus, partnerId: $partnerId, sharedAdvertiserIds: $sharedAdvertiserIds} | compact
  let body = if ($input | describe | str starts-with "record") { $input | merge deep ($body | default {}) } else { $body }
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "post" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json" $body
...
export def "custom-bidding-algorithms displayvideocustomBiddingAlgorithmsget" [
  ...
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $qp_fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar") (serialize-qp "advertiserId" $advertiserId "scalar") (serialize-qp "partnerId" $partnerId "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v2/customBiddingAlgorithms/($customBiddingAlgorithmId)" $qp)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "get" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json"
}
...
# --modelDetails item shape: {advertiserId?: string, readinessState?: "READINESS_STATE_UNSPECIFIED"|"READINESS_STATE_ACTIVE"|"READINESS_STATE_INSUFFICIENT_DATA"|"READINESS_STATE_TRAINING"|"READINESS_STATE_NO_VALID_SCRIPT"}
export def "custom-bidding-algorithms displayvideocustomBiddingAlgorithmspatch" [
  customBiddingAlgorithmId: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
...
export def "custom-bidding-algorithms-scripts displayvideocustomBiddingAlgorithmsscriptslist" [
  customBiddingAlgorithmId: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $qp_fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar") (serialize-qp "advertiserId" $advertiserId "scalar") (serialize-qp "orderBy" $orderBy "scalar") (serialize-qp "pageSize" $pageSize "scalar") (serialize-qp "pageToken" $pageToken "scalar") (serialize-qp "partnerId" $partnerId "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v2/customBiddingAlgorithms/($customBiddingAlgorithmId)/scripts" $qp)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "get" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json"
}
...
export def "custom-bidding-algorithms-scripts displayvideocustomBiddingAlgorithmsscriptscreate" [
  customBiddingAlgorithmId: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  ...
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $qp_fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar") (serialize-qp "advertiserId" $advertiserId "scalar") (serialize-qp "partnerId" $partnerId "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v2/customBiddingAlgorithms/($customBiddingAlgorithmId)/scripts" $qp)
  let body = {script: $script} | compact
  let body = if ($input | describe | str starts-with "record") { $input | merge deep ($body | default {}) } else { $body }
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "post" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json" $body
...
export def "custom-bidding-algorithms-scripts displayvideocustomBiddingAlgorithmsscriptsget" [
  customBiddingAlgorithmId: string
  ...
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $qp_fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar") (serialize-qp "advertiserId" $advertiserId "scalar") (serialize-qp "partnerId" $partnerId "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v2/customBiddingAlgorithms/($customBiddingAlgorithmId)/scripts/($customBiddingScriptId)" $qp)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "get" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json"
}
...
export def "custom-bidding-algorithms displayvideocustomBiddingAlgorithmsuploadScript" [
  customBiddingAlgorithmId: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  ...
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $qp_fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar") (serialize-qp "advertiserId" $advertiserId "scalar") (serialize-qp "partnerId" $partnerId "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v2/customBiddingAlgorithms/($customBiddingAlgorithmId):uploadScript" $qp)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "get" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json"
}
...
export def "custom-lists displayvideocustomListslist" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
...
export def "custom-lists displayvideocustomListsget" [
  customListId: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $qp_fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar") (serialize-qp "advertiserId" $advertiserId "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v2/customLists/($customListId)" $qp)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "get" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json"
}
...
export def "first-and-third-party-audiences displayvideofirstAndThirdPartyAudienceslist" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
...
# --mobileDeviceIdList shape: {mobileDeviceIds?: list}
export def "first-and-third-party-audiences displayvideofirstAndThirdPartyAudiencescreate" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
  ...
  --audienceType: string@audienceType-completer # The type of the audience.
  --contactInfoList: record # Wrapper message for a list of contact information defining Customer Match audience members. — shape: {contactInfos?: list}
  ...
  --firstAndThirdPartyAudienceType: string@firstAndThirdPartyAudienceType-completer # Whether the audience is a first or third party audience.
  ...
  --mobileDeviceIdList: record # Wrapper message for a list of mobile device IDs defining Customer Match audience members. — shape: {mobileDeviceIds?: list}
  ...
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $qp_fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar") (serialize-qp "advertiserId" $advertiserId "scalar")] | flatten | str join "&"
  let full_url = (build-url $base "/v2/firstAndThirdPartyAudiences" $qp)
  let body = {appId: $appId, audienceType: $audienceType, contactInfoList: $contactInfoList, description: $description, displayName: $displayName, firstAndThirdPartyAudienceType: $firstAndThirdPartyAudienceType, membershipDurationDays: $membershipDurationDays, mobileDeviceIdList: $mobileDeviceIdList} | compact
  let body = if ($input | describe | str starts-with "record") { $input | merge deep ($body | default {}) } else { $body }
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "post" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json" $body
...
export def "first-and-third-party-audiences displayvideofirstAndThirdPartyAudiencesget" [
  ...
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $qp_fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar") (serialize-qp "advertiserId" $advertiserId "scalar") (serialize-qp "partnerId" $partnerId "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v2/firstAndThirdPartyAudiences/($firstAndThirdPartyAudienceId)" $qp)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "get" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json"
}
...
# --contactInfoList shape: {contactInfos?: list}
# --mobileDeviceIdList shape: {mobileDeviceIds?: list}
export def "first-and-third-party-audiences displayvideofirstAndThirdPartyAudiencespatch" [
  firstAndThirdPartyAudienceId: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $qp_fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar") (serialize-qp "advertiserId" $advertiserId "scalar") (serialize-qp "updateMask" $updateMask "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v2/firstAndThirdPartyAudiences/($firstAndThirdPartyAudienceId)" $qp)
  let body = {appId: $appId, audienceType: $audienceType, contactInfoList: $contactInfoList, description: $description, displayName: $displayName, firstAndThirdPartyAudienceType: $firstAndThirdPartyAudienceType, membershipDurationDays: $membershipDurationDays, mobileDeviceIdList: $mobileDeviceIdList} | compact
  let body = if ($input | describe | str starts-with "record") { $input | merge deep ($body | default {}) } else { $body }
  let accept_val = "application/json"
...
# --addedMobileDeviceIdList shape: {mobileDeviceIds?: list}
export def "first-and-third-party-audiences displayvideofirstAndThirdPartyAudienceseditCustomerMatchMembers" [
  firstAndThirdPartyAudienceId: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  ...
  --upload-protocol: string # Upload protocol for media (e.g. "raw", "multipart").
  --uploadType: string # Legacy upload protocol for media (e.g. "media", "multipart").
  --addedContactInfoList: record # Wrapper message for a list of contact information defining Customer Match audience members. — shape: {contactInfos?: list}
  --addedMobileDeviceIdList: record # Wrapper message for a list of mobile device IDs defining Customer Match audience members. — shape: {mobileDeviceIds?: list}
  --advertiserId: string # Required. The ID of the owner advertiser of the updated Customer Match FirstAndThirdPartyAudience. (format: int64)
]: any -> record<firstAndThirdPartyAudienceId: string> {
  let input = $in
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $qp_fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v2/firstAndThirdPartyAudiences/($firstAndThirdPartyAudienceId):editCustomerMatchMembers" $qp)
  let body = {addedContactInfoList: $addedContactInfoList, addedMobileDeviceIdList: $addedMobileDeviceIdList, advertiserId: $advertiserId} | compact
  let body = if ($input | describe | str starts-with "record") { $input | merge deep ($body | default {}) } else { $body }
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "post" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json" $body
...
export def "floodlight-groups displayvideofloodlightGroupsget" [
  ...
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $qp_fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar") (serialize-qp "partnerId" $partnerId "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v2/floodlightGroups/($floodlightGroupId)" $qp)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "get" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json"
}
...
export def "google-audiences displayvideogoogleAudienceslist" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
...
export def "google-audiences displayvideogoogleAudiencesget" [
  ...
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $qp_fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar") (serialize-qp "advertiserId" $advertiserId "scalar") (serialize-qp "partnerId" $partnerId "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v2/googleAudiences/($googleAudienceId)" $qp)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "get" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json"
}
...
export def "guaranteed-orders displayvideoguaranteedOrderslist" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
...
export def "guaranteed-orders displayvideoguaranteedOrderscreate" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
  ...
  --defaultCampaignId: string # The ID of the default campaign that is assigned to the guaranteed order. The default campaign must belong to the default advertiser. (format: int64)
  ...
  --readAccessInherited: oneof<nothing, bool> # Whether all advertisers of read_write_partner_id have read access to the guaranteed order. Only applicable if read_write_partner_id is set. If True, overrides read_advertiser_ids.
  --readAdvertiserIds: list # The IDs of advertisers with read access to the guaranteed order. This field must not include the advertiser assigned to read_write_advertiser_id if it is set. All advertisers in this field must belong to read_write_partner_id or the same partner as read_write_advertiser_id.
  --readWriteAdvertiserId: string # The advertiser with read/write access to the guaranteed order. This is also the default advertiser of the guaranteed order. (format: int64)
  --readWritePartnerId: string # The partner with read/write access to the guaranteed order. (format: int64)
  ...
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $qp_fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar") (serialize-qp "advertiserId" $advertiserId "scalar") (serialize-qp "partnerId" $partnerId "scalar")] | flatten | str join "&"
  let full_url = (build-url $base "/v2/guaranteedOrders" $qp)
  let body = {defaultCampaignId: $defaultCampaignId, displayName: $displayName, exchange: $exchange, publisherName: $publisherName, readAccessInherited: $readAccessInherited, readAdvertiserIds: $readAdvertiserIds, readWriteAdvertiserId: $readWriteAdvertiserId, readWritePartnerId: $readWritePartnerId, status: $status} | compact
  let body = if ($input | describe | str starts-with "record") { $input | merge deep ($body | default {}) } else { $body }
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "post" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json" $body
...
export def "guaranteed-orders displayvideoguaranteedOrdersget" [
  ...
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $qp_fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar") (serialize-qp "advertiserId" $advertiserId "scalar") (serialize-qp "partnerId" $partnerId "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v2/guaranteedOrders/($guaranteedOrderId)" $qp)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "get" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json"
}
...
# --status shape: {entityPauseReason?: string, entityStatus?: "ENTITY_STATUS_UNSPECIFIED"|"ENTITY_STATUS_ACTIVE"|"ENTITY_STATUS_ARCHIVED"|"ENTITY_STATUS_DRAFT"|"ENTITY_STATUS_PAUSED"|"ENTITY_STATUS_SCHEDULED_FOR_DELETION"}
export def "guaranteed-orders displayvideoguaranteedOrderspatch" [
  guaranteedOrderId: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  ...
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $qp_fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar") (serialize-qp "advertiserId" $advertiserId "scalar") (serialize-qp "partnerId" $partnerId "scalar") (serialize-qp "updateMask" $updateMask "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v2/guaranteedOrders/($guaranteedOrderId)" $qp)
  let body = {defaultCampaignId: $defaultCampaignId, displayName: $displayName, exchange: $exchange, publisherName: $publisherName, readAccessInherited: $readAccessInherited, readAdvertiserIds: $readAdvertiserIds, readWriteAdvertiserId: $readWriteAdvertiserId, readWritePartnerId: $readWritePartnerId, status: $status} | compact
  let body = if ($input | describe | str starts-with "record") { $input | merge deep ($body | default {}) } else { $body }
  let accept_val = "application/json"
...
export def "guaranteed-orders displayvideoguaranteedOrderseditGuaranteedOrderReadAccessors" [
  guaranteedOrderId: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  ...
  --upload-protocol: string # Upload protocol for media (e.g. "raw", "multipart").
  --uploadType: string # Legacy upload protocol for media (e.g. "media", "multipart").
  --addedAdvertisers: list # The advertisers to add as read accessors to the guaranteed order.
  --partnerId: string # Required. The partner context in which the change is being made. (format: int64)
  --readAccessInherited: oneof<nothing, bool> # Whether to give all advertisers of the read/write accessor partner read access to the guaranteed order. Only applicable if read_write_partner_id is set in the guaranteed order.
  --removedAdvertisers: list # The advertisers to remove as read accessors to the guaranteed order.
]: any -> record<readAccessInherited: bool, readAdvertiserIds: list<string>> {
  let input = $in
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $qp_fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v2/guaranteedOrders/($guaranteedOrderId):editGuaranteedOrderReadAccessors" $qp)
  let body = {addedAdvertisers: $addedAdvertisers, partnerId: $partnerId, readAccessInherited: $readAccessInherited, removedAdvertisers: $removedAdvertisers} | compact
  let body = if ($input | describe | str starts-with "record") { $input | merge deep ($body | default {}) } else { $body }
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "post" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json" $body
...
export def "inventory-source-groups displayvideoinventorySourceGroupslist" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
...
export def "inventory-source-groups displayvideoinventorySourceGroupscreate" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
...
export def "inventory-source-groups displayvideoinventorySourceGroupsdelete" [
  ...
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $qp_fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar") (serialize-qp "advertiserId" $advertiserId "scalar") (serialize-qp "partnerId" $partnerId "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v2/inventorySourceGroups/($inventorySourceGroupId)" $qp)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "delete" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json"
}
...
export def "inventory-source-groups displayvideoinventorySourceGroupsget" [
  inventorySourceGroupId: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
...
export def "inventory-source-groups-assigned-inventory-sources displayvideoinventorySourceGroupsassignedInventorySourceslist" [
  inventorySourceGroupId: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  ...
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $qp_fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar") (serialize-qp "advertiserId" $advertiserId "scalar") (serialize-qp "filter" $filter "scalar") (serialize-qp "orderBy" $orderBy "scalar") (serialize-qp "pageSize" $pageSize "scalar") (serialize-qp "pageToken" $pageToken "scalar") (serialize-qp "partnerId" $partnerId "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v2/inventorySourceGroups/($inventorySourceGroupId)/assignedInventorySources" $qp)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "get" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json"
}
...
export def "inventory-source-groups-assigned-inventory-sources displayvideoinventorySourceGroupsassignedInventorySourcescreate" [
  inventorySourceGroupId: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  ...
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $qp_fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar") (serialize-qp "advertiserId" $advertiserId "scalar") (serialize-qp "partnerId" $partnerId "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v2/inventorySourceGroups/($inventorySourceGroupId)/assignedInventorySources" $qp)
  let body = {inventorySourceId: $inventorySourceId} | compact
  let body = if ($input | describe | str starts-with "record") { $input | merge deep ($body | default {}) } else { $body }
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "post" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json" $body
...
export def "inventory-source-groups-assigned-inventory-sources displayvideoinventorySourceGroupsassignedInventorySourcesdelete" [
  inventorySourceGroupId: string
  ...
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $qp_fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar") (serialize-qp "advertiserId" $advertiserId "scalar") (serialize-qp "partnerId" $partnerId "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v2/inventorySourceGroups/($inventorySourceGroupId)/assignedInventorySources/($assignedInventorySourceId)" $qp)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "delete" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json"
}
...
export def "inventory-source-groups-assigned-inventory-sources-bulk-edit displayvideoinventorySourceGroupsassignedInventorySourcesbulkEdit" [
  inventorySourceGroupId: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  ...
  --upload-protocol: string # Upload protocol for media (e.g. "raw", "multipart").
  --uploadType: string # Legacy upload protocol for media (e.g. "media", "multipart").
  --advertiserId: string # The ID of the advertiser that owns the parent inventory source group. The parent partner does not have access to these assigned inventory sources. (format: int64)
  --createdAssignedInventorySources: list # The assigned inventory sources to create in bulk, specified as a list of AssignedInventorySources. — item shape: {inventorySourceId?: string}
  --deletedAssignedInventorySources: list # The IDs of the assigned inventory sources to delete in bulk, specified as a list of assigned_inventory_source_ids.
  --partnerId: string # The ID of the partner that owns the inventory source group. Only this partner has write access to these assigned inventory sources. (format: int64)
]: any -> record<assignedInventorySources: table<assignedInventorySourceId: string, inventorySourceId: string, name: string>> {
  let input = $in
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $qp_fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v2/inventorySourceGroups/($inventorySourceGroupId)/assignedInventorySources:bulkEdit" $qp)
  let body = {advertiserId: $advertiserId, createdAssignedInventorySources: $createdAssignedInventorySources, deletedAssignedInventorySources: $deletedAssignedInventorySources, partnerId: $partnerId} | compact
  let body = if ($input | describe | str starts-with "record") { $input | merge deep ($body | default {}) } else { $body }
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "post" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json" $body
...
export def "inventory-sources displayvideoinventorySourceslist" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
...
# --creativeConfigs item shape: {creativeType?: "CREATIVE_TYPE_UNSPECIFIED"|"CREATIVE_TYPE_STANDARD"|"CREATIVE_TYPE_EXPANDABLE"|"CREATIVE_TYPE_VIDEO"|"CREATIVE_TYPE_NATIVE"|"CREATIVE_TYPE_TEMPLATED_APP_INSTALL"|"CREATIVE_TYPE_NATIVE_SITE_SQUARE"|"CREATIVE_TYPE_TEMPLATED_APP_INSTALL_INTERSTITIAL"|"CREATIVE_TYPE_LIGHTBOX"|"CREATIVE_TYPE_NATIVE_APP_INSTALL"|"CREATIVE_TYPE_NATIVE_APP_INSTALL_SQUARE"|"CREATIVE_TYPE_AUDIO"|"CREATIVE_TYPE_PUBLISHER_HOSTED"|"CREATIVE_TYPE_NATIVE_VIDEO"|"CREATIVE_TYPE_TEMPLATED_APP_INSTALL_VIDEO", displayCreativeConfig?: record, videoCreativeConfig?: record}
...
export def "inventory-sources displayvideoinventorySourcescreate" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
  ...
  --creativeConfigs: list # The creative requirements of the inventory source. Not applicable for auction packages. — item shape: {creativeType?: "CREATIVE_TYPE_UNSPECIFIED"|"CREATIVE_TYPE_STANDARD"|"CREATIVE_TYPE_EXPANDABLE"|"CREATIVE_TYPE_VIDEO"|"CREATIVE_TYPE_NATIVE"|"CREATIVE_TYPE_TEMPLATED_APP_INSTALL"|"CREATIVE_TYPE_NATIVE_SITE_SQUARE"|"CREATIVE_TYPE_TEMPLATED_APP_INSTALL_INTERSTITIAL"|"CREATIVE_TYPE_LIGHTBOX"|"CREATIVE_TYPE_NATIVE_APP_INSTALL"|"CREATIVE_TYPE_NATIVE_APP_INSTALL_SQUARE"|"CREATIVE_TYPE_AUDIO"|"CREATIVE_TYPE_PUBLISHER_HOSTED"|"CREATIVE_TYPE_NATIVE_VIDEO"|"CREATIVE_TYPE_TEMPLATED_APP_INSTALL_VIDEO", displayCreativeConfig?: record, videoCreativeConfig?: record}
  ...
  --deliveryMethod: string@deliveryMethod-completer # The delivery method of the inventory source. * For non-guaranteed inventory sources, the only acceptable value is `INVENTORY_SOURCE_DELIVERY_METHOD_PROGRAMMATIC`. * For guaranteed inventory sources, acceptable values are `INVENTORY_SOURCE_DELIVERY_METHOD_TAG` and `INVENTORY_SOURCE_DELIVERY_METHOD_PROGRAMMATIC`.
  ...
  --inventorySourceType: string@inventorySourceType-completer # Denotes the type of the inventory source.
  --publisherName: string # The publisher/seller name of the inventory source.
  --rateDetails: record # The rate related settings of the inventory source. — shape: {inventorySourceRateType?: "INVENTORY_SOURCE_RATE_TYPE_UNSPECIFIED"|"INVENTORY_SOURCE_RATE_TYPE_CPM_FIXED"|"INVENTORY_SOURCE_RATE_TYPE_CPM_FLOOR"|"INVENTORY_SOURCE_RATE_TYPE_CPD"|"INVENTORY_SOURCE_RATE_TYPE_FLAT", minimumSpend?: record, rate?: record, unitsPurchased?: string}
  --readWriteAccessors: record # The partner or advertisers with access to the inventory source. — shape: {advertisers?: record, partner?: record}
  ...
  --subSitePropertyId: string # Immutable. The unique ID of the sub-site property assigned to this inventory source. (format: int64)
  --timeRange: record # A time range. — shape: {endTime?: string, startTime?: string}
  ...
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $qp_fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar") (serialize-qp "advertiserId" $advertiserId "scalar") (serialize-qp "partnerId" $partnerId "scalar")] | flatten | str join "&"
  let full_url = (build-url $base "/v2/inventorySources" $qp)
  let body = {commitment: $commitment, creativeConfigs: $creativeConfigs, dealId: $dealId, deliveryMethod: $deliveryMethod, displayName: $displayName, exchange: $exchange, guaranteedOrderId: $guaranteedOrderId, inventorySourceType: $inventorySourceType, publisherName: $publisherName, rateDetails: $rateDetails, readWriteAccessors: $readWriteAccessors, status: $status, subSitePropertyId: $subSitePropertyId, timeRange: $timeRange} | compact
  let body = if ($input | describe | str starts-with "record") { $input | merge deep ($body | default {}) } else { $body }
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "post" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json" $body
...
export def "inventory-sources displayvideoinventorySourcesget" [
  ...
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $qp_fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar") (serialize-qp "partnerId" $partnerId "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v2/inventorySources/($inventorySourceId)" $qp)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "get" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json"
}
...
# --status shape: {entityPauseReason?: string, entityStatus?: "ENTITY_STATUS_UNSPECIFIED"|"ENTITY_STATUS_ACTIVE"|"ENTITY_STATUS_ARCHIVED"|"ENTITY_STATUS_DRAFT"|"ENTITY_STATUS_PAUSED"|"ENTITY_STATUS_SCHEDULED_FOR_DELETION"}
# --timeRange shape: {endTime?: string, startTime?: string}
export def "inventory-sources displayvideoinventorySourcespatch" [
  inventorySourceId: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
...
# --advertisersUpdate shape: {addedAdvertisers?: list, removedAdvertisers?: list}
export def "inventory-sources displayvideoinventorySourceseditInventorySourceReadWriteAccessors" [
  inventorySourceId: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  ...
  --upload-protocol: string # Upload protocol for media (e.g. "raw", "multipart").
  --uploadType: string # Legacy upload protocol for media (e.g. "media", "multipart").
  --advertisersUpdate: record # Update to the list of advertisers with read/write access to the inventory source. — shape: {addedAdvertisers?: list, removedAdvertisers?: list}
  --assignPartner: oneof<nothing, bool> # Set the partner context as read/write accessor of the inventory source. This will remove all other current read/write advertiser accessors.
  --partnerId: string # Required. The partner context by which the accessors change is being made. (format: int64)
]: any -> record<advertisers: record<advertiserIds: list<string>>, partner: record<partnerId: string>> {
  let input = $in
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $qp_fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v2/inventorySources/($inventorySourceId):editInventorySourceReadWriteAccessors" $qp)
  let body = {advertisersUpdate: $advertisersUpdate, assignPartner: $assignPartner, partnerId: $partnerId} | compact
  let body = if ($input | describe | str starts-with "record") { $input | merge deep ($body | default {}) } else { $body }
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "post" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json" $body
...
export def "partners displayvideopartnerslist" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
...
export def "partners displayvideopartnersget" [
  partnerId: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  ...
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $qp_fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v2/partners/($partnerId)" $qp)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "get" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json"
}
...
export def "partners-channels displayvideopartnerschannelslist" [
  partnerId: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  ...
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $qp_fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar") (serialize-qp "advertiserId" $advertiserId "scalar") (serialize-qp "filter" $filter "scalar") (serialize-qp "orderBy" $orderBy "scalar") (serialize-qp "pageSize" $pageSize "scalar") (serialize-qp "pageToken" $pageToken "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v2/partners/($partnerId)/channels" $qp)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "get" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json"
}
...
export def "partners-channels displayvideopartnerschannelscreate" [
  partnerId: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  ...
  --advertiserId: string # The ID of the advertiser that owns the channel. (format: int64)
  --displayName: string # Required. The display name of the channel. Must be UTF-8 encoded with a maximum length of 240 bytes.
  --body-partnerId: string # The ID of the partner that owns the channel. (format: int64)
]: any -> record<advertiserId: string, channelId: string, displayName: string, name: string, negativelyTargetedLineItemCount: string, partnerId: string, positivelyTargetedLineItemCount: string> {
  let input = $in
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $qp_fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar") (serialize-qp "advertiserId" $advertiserId "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v2/partners/($partnerId)/channels" $qp)
  let body = {advertiserId: $advertiserId, displayName: $displayName, partnerId: $body_partnerId} | compact
  let body = if ($input | describe | str starts-with "record") { $input | merge deep ($body | default {}) } else { $body }
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "post" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json" $body
...
export def "partners-channels displayvideopartnerschannelspatch" [
  partnerId: string
  channelId: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  ...
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $qp_fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar") (serialize-qp "advertiserId" $advertiserId "scalar") (serialize-qp "updateMask" $updateMask "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v2/partners/($partnerId)/channels/($channelId)" $qp)
  let body = {advertiserId: $advertiserId, displayName: $displayName, partnerId: $body_partnerId} | compact
  let body = if ($input | describe | str starts-with "record") { $input | merge deep ($body | default {}) } else { $body }
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
...
export def "partners-channels-sites displayvideopartnerschannelssiteslist" [
  partnerId: string
  channelId: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  ...
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $qp_fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar") (serialize-qp "advertiserId" $advertiserId "scalar") (serialize-qp "filter" $filter "scalar") (serialize-qp "orderBy" $orderBy "scalar") (serialize-qp "pageSize" $pageSize "scalar") (serialize-qp "pageToken" $pageToken "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v2/partners/($partnerId)/channels/($channelId)/sites" $qp)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "get" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json"
}
...
export def "partners-channels-sites displayvideopartnerschannelssitesdelete" [
  partnerId: string
  channelId: string
  urlOrAppId: string
  --base-url(-b): string@base-url-completer # API base URL
  ...
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $qp_fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar") (serialize-qp "advertiserId" $advertiserId "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v2/partners/($partnerId)/channels/($channelId)/sites/($urlOrAppId)" $qp)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "delete" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json"
}
...
# --createdSites item shape: {urlOrAppId?: string}
export def "partners-channels-sites-bulk-edit displayvideopartnerschannelssitesbulkEdit" [
  partnerId: string
  channelId: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  ...
  --upload-protocol: string # Upload protocol for media (e.g. "raw", "multipart").
  --uploadType: string # Legacy upload protocol for media (e.g. "media", "multipart").
  --advertiserId: string # The ID of the advertiser that owns the parent channel. (format: int64)
  --createdSites: list # The sites to create in batch, specified as a list of Sites. — item shape: {urlOrAppId?: string}
  --deletedSites: list # The sites to delete in batch, specified as a list of site url_or_app_ids.
  --body-partnerId: string # The ID of the partner that owns the parent channel. (format: int64)
]: any -> record<sites: table<name: string, urlOrAppId: string>> {
  let input = $in
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $qp_fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v2/partners/($partnerId)/channels/($channelId)/sites:bulkEdit" $qp)
  let body = {advertiserId: $advertiserId, createdSites: $createdSites, deletedSites: $deletedSites, partnerId: $body_partnerId} | compact
  let body = if ($input | describe | str starts-with "record") { $input | merge deep ($body | default {}) } else { $body }
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "post" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json" $body
...
# --newSites item shape: {urlOrAppId?: string}
export def "partners-channels-sites-replace displayvideopartnerschannelssitesreplace" [
  partnerId: string
  channelId: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  ...
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $qp_fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v2/partners/($partnerId)/channels/($channelId)/sites:replace" $qp)
  let body = {advertiserId: $advertiserId, newSites: $newSites, partnerId: $body_partnerId} | compact
  let body = if ($input | describe | str starts-with "record") { $input | merge deep ($body | default {}) } else { $body }
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "post" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json" $body
...
export def "partners-targeting-types-assigned-targeting-options displayvideopartnerstargetingTypesassignedTargetingOptionslist" [
  partnerId: string
  targetingType: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  ...
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $qp_fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar") (serialize-qp "filter" $filter "scalar") (serialize-qp "orderBy" $orderBy "scalar") (serialize-qp "pageSize" $pageSize "scalar") (serialize-qp "pageToken" $pageToken "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v2/partners/($partnerId)/targetingTypes/($targetingType)/assignedTargetingOptions" $qp)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "get" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json"
}
...
# --youtubeChannelDetails shape: {channelId?: string, negative?: bool}
# --youtubeVideoDetails shape: {negative?: bool, videoId?: string}
export def "partners-targeting-types-assigned-targeting-options displayvideopartnerstargetingTypesassignedTargetingOptionscreate" [
  partnerId: string
  targetingType: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
...
export def "partners-targeting-types-assigned-targeting-options displayvideopartnerstargetingTypesassignedTargetingOptionsdelete" [
  partnerId: string
  targetingType: string
  assignedTargetingOptionId: string
  --base-url(-b): string@base-url-completer # API base URL
  ...
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $qp_fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v2/partners/($partnerId)/targetingTypes/($targetingType)/assignedTargetingOptions/($assignedTargetingOptionId)" $qp)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "delete" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json"
}
...
export def "partners-targeting-types-assigned-targeting-options displayvideopartnerstargetingTypesassignedTargetingOptionsget" [
  partnerId: string
  targetingType: string
  assignedTargetingOptionId: string
  --base-url(-b): string@base-url-completer # API base URL
...
# --createRequests item shape: {assignedTargetingOptions?: list, targetingType?: "TARGETING_TYPE_UNSPECIFIED"|"TARGETING_TYPE_CHANNEL"|"TARGETING_TYPE_APP_CATEGORY"|"TARGETING_TYPE_APP"|"TARGETING_TYPE_URL"|"TARGETING_TYPE_DAY_AND_TIME"|"TARGETING_TYPE_AGE_RANGE"|"TARGETING_TYPE_REGIONAL_LOCATION_LIST"|"TARGETING_TYPE_PROXIMITY_LOCATION_LIST"|"TARGETING_TYPE_GENDER"|"TARGETING_TYPE_VIDEO_PLAYER_SIZE"|"TARGETING_TYPE_USER_REWARDED_CONTENT"|"TARGETING_TYPE_PARENTAL_STATUS"|"TARGETING_TYPE_CONTENT_INSTREAM_POSITION"|"TARGETING_TYPE_CONTENT_OUTSTREAM_POSITION"|"TARGETING_TYPE_DEVICE_TYPE"|"TARGETING_TYPE_AUDIENCE_GROUP"|"TARGETING_TYPE_BROWSER"|"TARGETING_TYPE_HOUSEHOLD_INCOME"|"TARGETING_TYPE_ON_SCREEN_POSITION"|"TARGETING_TYPE_THIRD_PARTY_VERIFIER"|"TARGETING_TYPE_DIGITAL_CONTENT_LABEL_EXCLUSION"|"TARGETING_TYPE_SENSITIVE_CATEGORY_EXCLUSION"|"TARGETING_TYPE_ENVIRONMENT"|"TARGETING_TYPE_CARRIER_AND_ISP"|"TARGETING_TYPE_OPERATING_SYSTEM"|"TARGETING_TYPE_DEVICE_MAKE_MODEL"|"TARGETING_TYPE_KEYWORD"|"TARGETING_TYPE_NEGATIVE_KEYWORD_LIST"|"TARGETING_TYPE_VIEWABILITY"|"TARGETING_TYPE_CATEGORY"|"TARGETING_TYPE_INVENTORY_SOURCE"|"TARGETING_TYPE_LANGUAGE"|"TARGETING_TYPE_AUTHORIZED_SELLER_STATUS"|"TARGETING_TYPE_GEO_REGION"|"TARGETING_TYPE_INVENTORY_SOURCE_GROUP"|"TARGETING_TYPE_EXCHANGE"|"TARGETING_TYPE_SUB_EXCHANGE"|"TARGETING_TYPE_POI"|"TARGETING_TYPE_BUSINESS_CHAIN"|"TARGETING_TYPE_CONTENT_DURATION"|"TARGETING_TYPE_CONTENT_STREAM_TYPE"|"TARGETING_TYPE_NATIVE_CONTENT_POSITION"|"TARGETING_TYPE_OMID"|"TARGETING_TYPE_AUDIO_CONTENT_TYPE"|"TARGETING_TYPE_CONTENT_GENRE"|"TARGETING_TYPE_YOUTUBE_VIDEO"|"TARGETING_TYPE_YOUTUBE_CHANNEL"|"TARGETING_TYPE_SESSION_POSITION"}
# --deleteRequests item shape: {assignedTargetingOptionIds?: list, targetingType?: "TARGETING_TYPE_UNSPECIFIED"|"TARGETING_TYPE_CHANNEL"|"TARGETING_TYPE_APP_CATEGORY"|"TARGETING_TYPE_APP"|"TARGETING_TYPE_URL"|"TARGETING_TYPE_DAY_AND_TIME"|"TARGETING_TYPE_AGE_RANGE"|"TARGETING_TYPE_REGIONAL_LOCATION_LIST"|"TARGETING_TYPE_PROXIMITY_LOCATION_LIST"|"TARGETING_TYPE_GENDER"|"TARGETING_TYPE_VIDEO_PLAYER_SIZE"|"TARGETING_TYPE_USER_REWARDED_CONTENT"|"TARGETING_TYPE_PARENTAL_STATUS"|"TARGETING_TYPE_CONTENT_INSTREAM_POSITION"|"TARGETING_TYPE_CONTENT_OUTSTREAM_POSITION"|"TARGETING_TYPE_DEVICE_TYPE"|"TARGETING_TYPE_AUDIENCE_GROUP"|"TARGETING_TYPE_BROWSER"|"TARGETING_TYPE_HOUSEHOLD_INCOME"|"TARGETING_TYPE_ON_SCREEN_POSITION"|"TARGETING_TYPE_THIRD_PARTY_VERIFIER"|"TARGETING_TYPE_DIGITAL_CONTENT_LABEL_EXCLUSION"|"TARGETING_TYPE_SENSITIVE_CATEGORY_EXCLUSION"|"TARGETING_TYPE_ENVIRONMENT"|"TARGETING_TYPE_CARRIER_AND_ISP"|"TARGETING_TYPE_OPERATING_SYSTEM"|"TARGETING_TYPE_DEVICE_MAKE_MODEL"|"TARGETING_TYPE_KEYWORD"|"TARGETING_TYPE_NEGATIVE_KEYWORD_LIST"|"TARGETING_TYPE_VIEWABILITY"|"TARGETING_TYPE_CATEGORY"|"TARGETING_TYPE_INVENTORY_SOURCE"|"TARGETING_TYPE_LANGUAGE"|"TARGETING_TYPE_AUTHORIZED_SELLER_STATUS"|"TARGETING_TYPE_GEO_REGION"|"TARGETING_TYPE_INVENTORY_SOURCE_GROUP"|"TARGETING_TYPE_EXCHANGE"|"TARGETING_TYPE_SUB_EXCHANGE"|"TARGETING_TYPE_POI"|"TARGETING_TYPE_BUSINESS_CHAIN"|"TARGETING_TYPE_CONTENT_DURATION"|"TARGETING_TYPE_CONTENT_STREAM_TYPE"|"TARGETING_TYPE_NATIVE_CONTENT_POSITION"|"TARGETING_TYPE_OMID"|"TARGETING_TYPE_AUDIO_CONTENT_TYPE"|"TARGETING_TYPE_CONTENT_GENRE"|"TARGETING_TYPE_YOUTUBE_VIDEO"|"TARGETING_TYPE_YOUTUBE_CHANNEL"|"TARGETING_TYPE_SESSION_POSITION"}
export def "partners displayvideopartnerseditAssignedTargetingOptions" [
  partnerId: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  ...
  --upload-protocol: string # Upload protocol for media (e.g. "raw", "multipart").
  --uploadType: string # Legacy upload protocol for media (e.g. "media", "multipart").
  --createRequests: list # The assigned targeting options to create in batch, specified as a list of `CreateAssignedTargetingOptionsRequest`. Supported targeting types: * `TARGETING_TYPE_CHANNEL` — item shape: {assignedTargetingOptions?: list, targetingType?: "TARGETING_TYPE_UNSPECIFIED"|"TARGETING_TYPE_CHANNEL"|"TARGETING_TYPE_APP_CATEGORY"|"TARGETING_TYPE_APP"|"TARGETING_TYPE_URL"|"TARGETING_TYPE_DAY_AND_TIME"|"TARGETING_TYPE_AGE_RANGE"|"TARGETING_TYPE_REGIONAL_LOCATION_LIST"|"TARGETING_TYPE_PROXIMITY_LOCATION_LIST"|"TARGETING_TYPE_GENDER"|"TARGETING_TYPE_VIDEO_PLAYER_SIZE"|"TARGETING_TYPE_USER_REWARDED_CONTENT"|"TARGETING_TYPE_PARENTAL_STATUS"|"TARGETING_TYPE_CONTENT_INSTREAM_POSITION"|"TARGETING_TYPE_CONTENT_OUTSTREAM_POSITION"|"TARGETING_TYPE_DEVICE_TYPE"|"TARGETING_TYPE_AUDIENCE_GROUP"|"TARGETING_TYPE_BROWSER"|"TARGETING_TYPE_HOUSEHOLD_INCOME"|"TARGETING_TYPE_ON_SCREEN_POSITION"|"TARGETING_TYPE_THIRD_PARTY_VERIFIER"|"TARGETING_TYPE_DIGITAL_CONTENT_LABEL_EXCLUSION"|"TARGETING_TYPE_SENSITIVE_CATEGORY_EXCLUSION"|"TARGETING_TYPE_ENVIRONMENT"|"TARGETING_TYPE_CARRIER_AND_ISP"|"TARGETING_TYPE_OPERATING_SYSTEM"|"TARGETING_TYPE_DEVICE_MAKE_MODEL"|"TARGETING_TYPE_KEYWORD"|"TARGETING_TYPE_NEGATIVE_KEYWORD_LIST"|"TARGETING_TYPE_VIEWABILITY"|"TARGETING_TYPE_CATEGORY"|"TARGETING_TYPE_INVENTORY_SOURCE"|"TARGETING_TYPE_LANGUAGE"|"TARGETING_TYPE_AUTHORIZED_SELLER_STATUS"|"TARGETING_TYPE_GEO_REGION"|"TARGETING_TYPE_INVENTORY_SOURCE_GROUP"|"TARGETING_TYPE_EXCHANGE"|"TARGETING_TYPE_SUB_EXCHANGE"|"TARGETING_TYPE_POI"|"TARGETING_TYPE_BUSINESS_CHAIN"|"TARGETING_TYPE_CONTENT_DURATION"|"TARGETING_TYPE_CONTENT_STREAM_TYPE"|"TARGETING_TYPE_NATIVE_CONTENT_POSITION"|"TARGETING_TYPE_OMID"|"TARGETING_TYPE_AUDIO_CONTENT_TYPE"|"TARGETING_TYPE_CONTENT_GENRE"|"TARGETING_TYPE_YOUTUBE_VIDEO"|"TARGETING_TYPE_YOUTUBE_CHANNEL"|"TARGETING_TYPE_SESSION_POSITION"}
  --deleteRequests: list # The assigned targeting options to delete in batch, specified as a list of `DeleteAssignedTargetingOptionsRequest`. Supported targeting types: * `TARGETING_TYPE_CHANNEL` — item shape: {assignedTargetingOptionIds?: list, targetingType?: "TARGETING_TYPE_UNSPECIFIED"|"TARGETING_TYPE_CHANNEL"|"TARGETING_TYPE_APP_CATEGORY"|"TARGETING_TYPE_APP"|"TARGETING_TYPE_URL"|"TARGETING_TYPE_DAY_AND_TIME"|"TARGETING_TYPE_AGE_RANGE"|"TARGETING_TYPE_REGIONAL_LOCATION_LIST"|"TARGETING_TYPE_PROXIMITY_LOCATION_LIST"|"TARGETING_TYPE_GENDER"|"TARGETING_TYPE_VIDEO_PLAYER_SIZE"|"TARGETING_TYPE_USER_REWARDED_CONTENT"|"TARGETING_TYPE_PARENTAL_STATUS"|"TARGETING_TYPE_CONTENT_INSTREAM_POSITION"|"TARGETING_TYPE_CONTENT_OUTSTREAM_POSITION"|"TARGETING_TYPE_DEVICE_TYPE"|"TARGETING_TYPE_AUDIENCE_GROUP"|"TARGETING_TYPE_BROWSER"|"TARGETING_TYPE_HOUSEHOLD_INCOME"|"TARGETING_TYPE_ON_SCREEN_POSITION"|"TARGETING_TYPE_THIRD_PARTY_VERIFIER"|"TARGETING_TYPE_DIGITAL_CONTENT_LABEL_EXCLUSION"|"TARGETING_TYPE_SENSITIVE_CATEGORY_EXCLUSION"|"TARGETING_TYPE_ENVIRONMENT"|"TARGETING_TYPE_CARRIER_AND_ISP"|"TARGETING_TYPE_OPERATING_SYSTEM"|"TARGETING_TYPE_DEVICE_MAKE_MODEL"|"TARGETING_TYPE_KEYWORD"|"TARGETING_TYPE_NEGATIVE_KEYWORD_LIST"|"TARGETING_TYPE_VIEWABILITY"|"TARGETING_TYPE_CATEGORY"|"TARGETING_TYPE_INVENTORY_SOURCE"|"TARGETING_TYPE_LANGUAGE"|"TARGETING_TYPE_AUTHORIZED_SELLER_STATUS"|"TARGETING_TYPE_GEO_REGION"|"TARGETING_TYPE_INVENTORY_SOURCE_GROUP"|"TARGETING_TYPE_EXCHANGE"|"TARGETING_TYPE_SUB_EXCHANGE"|"TARGETING_TYPE_POI"|"TARGETING_TYPE_BUSINESS_CHAIN"|"TARGETING_TYPE_CONTENT_DURATION"|"TARGETING_TYPE_CONTENT_STREAM_TYPE"|"TARGETING_TYPE_NATIVE_CONTENT_POSITION"|"TARGETING_TYPE_OMID"|"TARGETING_TYPE_AUDIO_CONTENT_TYPE"|"TARGETING_TYPE_CONTENT_GENRE"|"TARGETING_TYPE_YOUTUBE_VIDEO"|"TARGETING_TYPE_YOUTUBE_CHANNEL"|"TARGETING_TYPE_SESSION_POSITION"}
]: any -> record<createdAssignedTargetingOptions: table<ageRangeDetails: record, appCategoryDetails: record, appDetails: record, assignedTargetingOptionId: string, assignedTargetingOptionIdAlias: string, audienceGroupDetails: record, audioContentTypeDetails: record, authorizedSellerStatusDetails: record, browserDetails: record, businessChainDetails: record, carrierAndIspDetails: record, categoryDetails: record, channelDetails: record, contentDurationDetails: record, contentGenreDetails: record, contentInstreamPositionDetails: record, contentOutstreamPositionDetails: record, contentStreamTypeDetails: record, dayAndTimeDetails: record, deviceMakeModelDetails: record, deviceTypeDetails: record, digitalContentLabelExclusionDetails: record, environmentDetails: record, exchangeDetails: record, genderDetails: record, geoRegionDetails: record, householdIncomeDetails: record, inheritance: string, inventorySourceDetails: record, inventorySourceGroupDetails: record, keywordDetails: record, languageDetails: record, name: string, nativeContentPositionDetails: record, negativeKeywordListDetails: record, omidDetails: record, onScreenPositionDetails: record, operatingSystemDetails: record, parentalStatusDetails: record, poiDetails: record, proximityLocationListDetails: record, regionalLocationListDetails: record, sensitiveCategoryExclusionDetails: record, sessionPositionDetails: record, subExchangeDetails: record, targetingType: string, thirdPartyVerifierDetails: record, urlDetails: record, userRewardedContentDetails: record, videoPlayerSizeDetails: record, viewabilityDetails: record, youtubeChannelDetails: record, youtubeVideoDetails: record>> {
  let input = $in
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $qp_fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v2/partners/($partnerId):editAssignedTargetingOptions" $qp)
  let body = {createRequests: $createRequests, deleteRequests: $deleteRequests} | compact
  let body = if ($input | describe | str starts-with "record") { $input | merge deep ($body | default {}) } else { $body }
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
...
# --idFilter shape: {adGroupAdIds?: list, adGroupIds?: list, campaignIds?: list, insertionOrderIds?: list, lineItemIds?: list, mediaProductIds?: list}
# --inventorySourceFilter shape: {inventorySourceIds?: list}
# --parentEntityFilter shape: {fileType?: list, filterIds?: list, filterType?: "FILTER_TYPE_UNSPECIFIED"|"FILTER_TYPE_NONE"|"FILTER_TYPE_ADVERTISER_ID"|"FILTER_TYPE_CAMPAIGN_ID"|"FILTER_TYPE_MEDIA_PRODUCT_ID"|"FILTER_TYPE_INSERTION_ORDER_ID"|"FILTER_TYPE_LINE_ITEM_ID"}
export def "sdfdownloadtasks displayvideosdfdownloadtaskscreate" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
  ...
  --upload-protocol: string # Upload protocol for media (e.g. "raw", "multipart").
  --uploadType: string # Legacy upload protocol for media (e.g. "media", "multipart").
  --advertiserId: string # The ID of the advertiser to download SDF for. (format: int64)
  --idFilter: record # A filtering option that filters entities by their entity IDs. — shape: {adGroupAdIds?: list, adGroupIds?: list, campaignIds?: list, insertionOrderIds?: list, lineItemIds?: list, mediaProductIds?: list}
  --inventorySourceFilter: record # A filtering option for filtering on Inventory Source entities. — shape: {inventorySourceIds?: list}
  --parentEntityFilter: record # A filtering option that filters on selected file types belonging to a chosen set of filter entities. — shape: {fileType?: list, filterIds?: list, filterType?: "FILTER_TYPE_UNSPECIFIED"|"FILTER_TYPE_NONE"|"FILTER_TYPE_ADVERTISER_ID"|"FILTER_TYPE_CAMPAIGN_ID"|"FILTER_TYPE_MEDIA_PRODUCT_ID"|"FILTER_TYPE_INSERTION_ORDER_ID"|"FILTER_TYPE_LINE_ITEM_ID"}
  --partnerId: string # The ID of the partner to download SDF for. (format: int64)
  ...
  let body = {advertiserId: $advertiserId, idFilter: $idFilter, inventorySourceFilter: $inventorySourceFilter, parentEntityFilter: $parentEntityFilter, partnerId: $partnerId, version: $version} | compact
  let body = if ($input | describe | str starts-with "record") { $input | merge deep ($body | default {}) } else { $body }
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "post" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json" $body
...
export def "targeting-types-targeting-options displayvideotargetingTypestargetingOptionslist" [
  targetingType: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  ...
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $qp_fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar") (serialize-qp "advertiserId" $advertiserId "scalar") (serialize-qp "filter" $filter "scalar") (serialize-qp "orderBy" $orderBy "scalar") (serialize-qp "pageSize" $pageSize "scalar") (serialize-qp "pageToken" $pageToken "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v2/targetingTypes/($targetingType)/targetingOptions" $qp)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "get" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json"
}
...
export def "targeting-types-targeting-options displayvideotargetingTypestargetingOptionsget" [
  targetingType: string
  ...
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $qp_fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar") (serialize-qp "advertiserId" $advertiserId "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v2/targetingTypes/($targetingType)/targetingOptions/($targetingOptionId)" $qp)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "get" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json"
}
...
export def "targeting-types-targeting-options-search displayvideotargetingTypestargetingOptionssearch" [
  targetingType: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  ...
  --upload-protocol: string # Upload protocol for media (e.g. "raw", "multipart").
  --uploadType: string # Legacy upload protocol for media (e.g. "media", "multipart").
  --advertiserId: string # Required. The Advertiser this request is being made in the context of. (format: int64)
  --businessChainSearchTerms: record # Search terms for Business Chain targeting options. At least one of the field should be populated. — shape: {businessChainQuery?: string, regionQuery?: string}
  --geoRegionSearchTerms: record # Search terms for geo region targeting options. — shape: {geoRegionQuery?: string}
  --pageSize: int # Requested page size. Must be between `1` and `200`. If unspecified will default to `100`. Returns error code `INVALID_ARGUMENT` if an invalid value is specified. (format: int32)
  --pageToken: string # A token identifying a page of results the server should return. Typically, this is the value of next_page_token returned from the previous call to `SearchTargetingOptions` method. If not specified, the first page of results will be returned.
  --poiSearchTerms: record # Search terms for POI targeting options. — shape: {poiQuery?: string}
]: any -> record<nextPageToken: string, targetingOptions: table<ageRangeDetails: record, appCategoryDetails: record, audioContentTypeDetails: record, authorizedSellerStatusDetails: record, browserDetails: record, businessChainDetails: record, carrierAndIspDetails: record, categoryDetails: record, contentDurationDetails: record, contentGenreDetails: record, contentInstreamPositionDetails: record, contentOutstreamPositionDetails: record, contentStreamTypeDetails: record, deviceMakeModelDetails: record, deviceTypeDetails: record, digitalContentLabelDetails: record, environmentDetails: record, exchangeDetails: record, genderDetails: record, geoRegionDetails: record, householdIncomeDetails: record, languageDetails: record, name: string, nativeContentPositionDetails: record, omidDetails: record, onScreenPositionDetails: record, operatingSystemDetails: record, parentalStatusDetails: record, poiDetails: record, sensitiveCategoryDetails: record, subExchangeDetails: record, targetingOptionId: string, targetingType: string, userRewardedContentDetails: record, videoPlayerSizeDetails: record, viewabilityDetails: record>> {
  let input = $in
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $qp_fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v2/targetingTypes/($targetingType)/targetingOptions:search" $qp)
  let body = {advertiserId: $advertiserId, businessChainSearchTerms: $businessChainSearchTerms, geoRegionSearchTerms: $geoRegionSearchTerms, pageSize: $pageSize, pageToken: $pageToken, poiSearchTerms: $poiSearchTerms} | compact
  let body = if ($input | describe | str starts-with "record") { $input | merge deep ($body | default {}) } else { $body }
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "post" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json" $body
...
export def "users displayvideouserslist" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
...
export def "users displayvideouserscreate" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
  ...
  --upload-protocol: string # Upload protocol for media (e.g. "raw", "multipart").
  --uploadType: string # Legacy upload protocol for media (e.g. "media", "multipart").
  --assignedUserRoles: list # The assigned user roles. Required in CreateUser. Output only in UpdateUser. Can only be updated through BulkEditAssignedUserRoles. — item shape: {advertiserId?: string, partnerId?: string, userRole?: "USER_ROLE_UNSPECIFIED"|"ADMIN"|"ADMIN_PARTNER_CLIENT"|"STANDARD"|"STANDARD_PLANNER"|"STANDARD_PLANNER_LIMITED"|"STANDARD_PARTNER_CLIENT"|"READ_ONLY"|"REPORTING_ONLY"|"LIMITED_REPORTING_ONLY"|"CREATIVE"|"CREATIVE_ADMIN"}
  ...
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $qp_fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar")] | flatten | str join "&"
  let full_url = (build-url $base "/v2/users" $qp)
  let body = {assignedUserRoles: $assignedUserRoles, displayName: $displayName, email: $email} | compact
  let body = if ($input | describe | str starts-with "record") { $input | merge deep ($body | default {}) } else { $body }
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "post" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json" $body
...
export def "users displayvideousersdelete" [
  userId: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  ...
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $qp_fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v2/users/($userId)" $qp)
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "delete" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json"
}
...
export def "users displayvideousersget" [
  userId: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
...
# --assignedUserRoles item shape: {advertiserId?: string, partnerId?: string, userRole?: "USER_ROLE_UNSPECIFIED"|"ADMIN"|"ADMIN_PARTNER_CLIENT"|"STANDARD"|"STANDARD_PLANNER"|"STANDARD_PLANNER_LIMITED"|"STANDARD_PARTNER_CLIENT"|"READ_ONLY"|"REPORTING_ONLY"|"LIMITED_REPORTING_ONLY"|"CREATIVE"|"CREATIVE_ADMIN"}
export def "users displayvideouserspatch" [
  userId: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
...
export def "users displayvideousersbulkEditAssignedUserRoles" [
  userId: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  ...
  --upload-protocol: string # Upload protocol for media (e.g. "raw", "multipart").
  --uploadType: string # Legacy upload protocol for media (e.g. "media", "multipart").
  --createdAssignedUserRoles: list # The assigned user roles to create in batch, specified as a list of AssignedUserRoles. — item shape: {advertiserId?: string, partnerId?: string, userRole?: "USER_ROLE_UNSPECIFIED"|"ADMIN"|"ADMIN_PARTNER_CLIENT"|"STANDARD"|"STANDARD_PLANNER"|"STANDARD_PLANNER_LIMITED"|"STANDARD_PARTNER_CLIENT"|"READ_ONLY"|"REPORTING_ONLY"|"LIMITED_REPORTING_ONLY"|"CREATIVE"|"CREATIVE_ADMIN"}
  --deletedAssignedUserRoles: list # The assigned user roles to delete in batch, specified as a list of assigned_user_role_ids. The format of assigned_user_role_id is `entityType-entityid`, for example `partner-123`.
]: any -> record<createdAssignedUserRoles: table<advertiserId: string, assignedUserRoleId: string, partnerId: string, userRole: string>> {
  let input = $in
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "$.xgafv" $xgafv "scalar") (serialize-qp "access_token" $access_token "scalar") (serialize-qp "alt" $alt "scalar") (serialize-qp "callback" $callback "scalar") (serialize-qp "fields" $qp_fields "scalar") (serialize-qp "key" $key "scalar") (serialize-qp "oauth_token" $oauth_token "scalar") (serialize-qp "prettyPrint" $prettyPrint "scalar") (serialize-qp "quotaUser" $quotaUser "scalar") (serialize-qp "upload_protocol" $upload_protocol "scalar") (serialize-qp "uploadType" $uploadType "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/v2/users/($userId):bulkEditAssignedUserRoles" $qp)
  let body = {createdAssignedUserRoles: $createdAssignedUserRoles, deletedAssignedUserRoles: $deletedAssignedUserRoles} | compact
  let body = if ($input | describe | str starts-with "record") { $input | merge deep ($body | default {}) } else { $body }
  let accept_val = "application/json"
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "post" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors "application/json" $body
...
export def "sdfdownloadtasks displayvideosdfdownloadtasksoperationsget" [
  name: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
