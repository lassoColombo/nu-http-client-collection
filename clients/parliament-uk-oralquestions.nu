...
export def "early-day-motions-list get" [
  ...
  let accept_val = ($accept | default "application/json")
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "get" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors $full "application/json" null {query: ({"parameters.edmIds": $parameters_edm_ids, "parameters.uINWithAmendmentSuffix": $parameters_u_in_with_amendment_suffix, "parameters.searchTerm": $parameters_search_term, "parameters.currentStatusDateStart": $parameters_current_status_date_start, "parameters.currentStatusDateEnd": $parameters_current_status_date_end, "parameters.isPrayer": $parameters_is_prayer, "parameters.memberId": $parameters_member_id, "parameters.includeSponsoredByMember": $parameters_include_sponsored_by_member, "parameters.tabledStartDate": $parameters_tabled_start_date, "parameters.tabledEndDate": $parameters_tabled_end_date, "parameters.statuses": $parameters_statuses, "parameters.orderBy": $parameters_order_by, "parameters.skip": $parameters_skip, "parameters.take": $parameters_take} | compact), body: null}
}
...
export def "oralquestions-list get-published-oral-question" [
  ...
  let accept_val = ($accept | default "application/json")
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "get" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors $full "application/json" null {query: ({"parameters.answeringDateStart": $parameters_answering_date_start, "parameters.answeringDateEnd": $parameters_answering_date_end, "parameters.questionType": $parameters_question_type, "parameters.oralQuestionTimeId": $parameters_oral_question_time_id, "parameters.askingMemberIds": $parameters_asking_member_ids, "parameters.uINs": $parameters_u_i_ns, "parameters.answeringBodyIds": $parameters_answering_body_ids, "parameters.skip": $parameters_skip, "parameters.take": $parameters_take} | compact), body: null}
}
...
export def "oralquestiontimes-list get-published-oral-question-time" [
  ...
  let accept_val = ($accept | default "application/json")
  let auth = ($auth | update headers ($auth.headers | merge {Accept: $accept_val}))
  do-request "get" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors $full "application/json" null {query: ({"parameters.answeringDateStart": $parameters_answering_date_start, "parameters.answeringDateEnd": $parameters_answering_date_end, "parameters.deadlineDateStart": $parameters_deadline_date_start, "parameters.deadlineDateEnd": $parameters_deadline_date_end, "parameters.oralQuestionTimeId": $parameters_oral_question_time_id, "parameters.answeringBodyIds": $parameters_answering_body_ids, "parameters.skip": $parameters_skip, "parameters.take": $parameters_take} | compact), body: null}
}
