...
export def "subscriptions-providers-microsoft-network-traffic-manager-user-metrics-keys delete" [
  ...
  let full_url = (build-url $base ({subscription_id: (encode-path-segment $subscription_id)} | format pattern "/subscriptions/{subscription_id}/providers/Microsoft.Network/trafficManagerUserMetricsKeys") $qp)
