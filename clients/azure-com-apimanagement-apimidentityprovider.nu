...
export def commands []: nothing -> table {
  ...
  let mod_name = (scope modules | where { $in.commands | any { $in.name == "subscriptions-resource-groups-providers-microsoft-api-management-service-identity-providers ListByService" } } | get name | first)
...
export def "subscriptions-resource-groups-providers-microsoft-api-management-service-identity-providers ListByService" [
  ...
  let full_url = (build-url $base $"/subscriptions/($subscriptionId)/resourceGroups/($resourceGroupName)/providers/Microsoft.ApiManagement/service/($serviceName)/identityProviders" $qp)
...
export def "subscriptions-resource-groups-providers-microsoft-api-management-service-identity-providers Delete" [
  ...
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "api-version" $api_version "scalar")] | flatten | str join "&"
  let full_url = (build-url $base $"/subscriptions/($subscriptionId)/resourceGroups/($resourceGroupName)/providers/Microsoft.ApiManagement/service/($serviceName)/identityProviders/($identityProviderName)" $qp)
...
export def "subscriptions-resource-groups-providers-microsoft-api-management-service-identity-providers GetEntityTag" [
  resourceGroupName: string
  serviceName: string
  identityProviderName: string
  subscriptionId: string
...
# --properties shape: {clientId: string, clientSecret: string, allowedTenants?: list, authority?: string, passwordResetPolicyName?: string, profileEditingPolicyName?: string, signinPolicyName?: string, signinTenant?: string, signupPolicyName?: string, type?: "facebook"|"google"|"microsoft"|"twitter"|"aad"|"aadB2C"}
export def "subscriptions-resource-groups-providers-microsoft-api-management-service-identity-providers CreateOrUpdate" [
  resourceGroupName: string
  serviceName: string
  identityProviderName: string
  subscriptionId: string
