...
# Source: https://api.apis.guru/v2/specs/azure.com/apimanagement-apimidentityprovider/2019-01-01/swagger.json
...
export def commands []: nothing -> table {
  ...
  let mod_name = (scope modules | where { $in.commands | any { $in.name == "subscriptions-resource-groups-providers-microsoft-api-management-service-identity-providers list-by" } } | get name | first)
...
export def "subscriptions-resource-groups-providers-microsoft-api-management-service-identity-providers list-by" [
  ...
  let full_url = (build-url $base ({subscription_id: $subscription_id, resource_group_name: $resource_group_name, service_name: $service_name} | format pattern "/subscriptions/{subscription_id}/resourceGroups/{resource_group_name}/providers/Microsoft.ApiManagement/service/{service_name}/identityProviders") $qp)
...
export def "subscriptions-resource-groups-providers-microsoft-api-management-service-identity-providers delete" [
  ...
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "api-version" $api_version "scalar")] | flatten | str join "&"
  let full_url = (build-url $base ({subscription_id: $subscription_id, resource_group_name: $resource_group_name, service_name: $service_name, identity_provider_name: $identity_provider_name} | format pattern "/subscriptions/{subscription_id}/resourceGroups/{resource_group_name}/providers/Microsoft.ApiManagement/service/{service_name}/identityProviders/{identity_provider_name}") $qp)
...
export def "subscriptions-resource-groups-providers-microsoft-api-management-service-identity-providers get" [
  ...
  --dry-run(-n) # Return the request that would be sent without executing it
  --api-version: string # Version of the API to be used with the client request.
]: nothing -> record<properties: record<clientId: string, clientSecret: string, allowedTenants: list<string>, authority: string, passwordResetPolicyName: string, profileEditingPolicyName: string, signinPolicyName: string, signinTenant: string, signupPolicyName: string, type: string>, id: string, name: string, type: string> {
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "api-version" $api_version "scalar")] | flatten | str join "&"
  let full_url = (build-url $base ({subscription_id: $subscription_id, resource_group_name: $resource_group_name, service_name: $service_name, identity_provider_name: $identity_provider_name} | format pattern "/subscriptions/{subscription_id}/resourceGroups/{resource_group_name}/providers/Microsoft.ApiManagement/service/{service_name}/identityProviders/{identity_provider_name}") $qp)
...
# --properties shape: {clientId?: string, clientSecret?: string, allowedTenants?: list, authority?: string, passwordResetPolicyName?: string, profileEditingPolicyName?: string, signinPolicyName?: string, signinTenant?: string, signupPolicyName?: string, type?: "facebook"|"google"|"microsoft"|"twitter"|"aad"|"aadB2C"}
export def "subscriptions-resource-groups-providers-microsoft-api-management-service-identity-providers update" [
  ...
  --api-version: string # Version of the API to be used with the client request.
  --if-match: string # ETag of the Entity. ETag should match the current entity state from the header response of the GET request or it should be * for unconditional update.
  --properties: any # Parameters supplied to the Update Identity Provider operation. — shape: {clientId?: string, clientSecret?: string, allowedTenants?: list, authority?: string, passwordResetPolicyName?: string, profileEditingPolicyName?: string, signinPolicyName?: string, signinTenant?: string, signupPolicyName?: string, type?: "facebook"|"google"|"microsoft"|"twitter"|"aad"|"aadB2C"}
...
export def "subscriptions-resource-groups-providers-microsoft-api-management-service-identity-providers create-or-update" [
  ...
  --properties: any # The external Identity Providers like Facebook, Google, Microsoft, Twitter or Azure Active Directory which can be used to enable access to the API Management service developer portal for all users. — shape: {clientId: string, clientSecret: string, allowedTenants?: list, authority?: string, passwordResetPolicyName?: string, profileEditingPolicyName?: string, signinPolicyName?: string, signinTenant?: string, signupPolicyName?: string, type?: "facebook"|"google"|"microsoft"|"twitter"|"aad"|"aadB2C"}
]: any -> record<properties: record<clientId: string, clientSecret: string, allowedTenants: list<string>, authority: string, passwordResetPolicyName: string, profileEditingPolicyName: string, signinPolicyName: string, signinTenant: string, signupPolicyName: string, type: string>, id: string, name: string, type: string> {
  let input = $in
  let auth = (build-auth $token ($auth_scheme | default "bearer"))
  let base = ($base_url | default $BASE_URL)
  let qp = [(serialize-qp "api-version" $api_version "scalar")] | flatten | str join "&"
